...
---
# <a name="cc-code-example-creating-a-task-trigger"></a>Exemplo de código C/C++: Criando um gatilho de tarefa

Este exemplo cria um novo gatilho para uma tarefa existente chamada Test Task.
