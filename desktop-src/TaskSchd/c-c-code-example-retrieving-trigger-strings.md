...
---
# <a name="cc-code-example-retrieving-trigger-strings"></a>Exemplo de código C/C++: Recuperando cadeias de caracteres de gatilho

Este exemplo recupera uma cadeia de caracteres de gatilho para todos os gatilhos associados a uma tarefa conhecida.
