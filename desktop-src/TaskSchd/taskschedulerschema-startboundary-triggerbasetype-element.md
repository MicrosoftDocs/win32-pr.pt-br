...
O **&lt; elemento &gt; StartBoundary** é um elemento necessário para gatilhos de tempo e calendário [**&lt; (TimeTrigger &gt;**](taskschedulerschema-timetrigger-triggergroup-element.md) e [**&lt; CalendarTrigger). &gt;**](taskschedulerschema-calendartrigger-triggergroup-element.md)
