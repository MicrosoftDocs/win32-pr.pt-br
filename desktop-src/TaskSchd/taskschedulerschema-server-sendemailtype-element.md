...
keywords:
- Elemento server Agendador de Tarefas
topic_type:
- apiref
api_name:
- Server
...
Para desenvolvimento em C++, consulte [**Propriedade do servidor de IEmailAction**](/windows/desktop/api/taskschd/nf-taskschd-iemailaction-get_server).

Para desenvolvimento de scripts, [**consulte EmailAction.Server**](emailaction-server.md).
