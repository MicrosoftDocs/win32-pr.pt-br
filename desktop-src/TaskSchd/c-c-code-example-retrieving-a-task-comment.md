...
---
# <a name="cc-code-example-retrieving-a-task-comment"></a>Exemplo de código C/C++: Recuperando um comentário de tarefa

Este exemplo recupera a cadeia de caracteres de comentário de uma tarefa conhecida e exibe a cadeia de caracteres de comentário na tela. Este exemplo supõe que a tarefa e a tarefa de teste já existam no computador local.
