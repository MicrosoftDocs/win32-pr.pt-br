...
Para o desenvolvimento de scripts, o limite de tempo de execução é especificado [**usando a propriedadeTrigger.ExecutionTimeLimit**](trigger-executiontimelimit.md) herdada por todos os objetos de gatilho.

Para o desenvolvimento em C++, o limite de tempo de execução é especificado usando a propriedade [**ITrigger::ExecutionTimeLimit**](/windows/desktop/api/taskschd/nf-taskschd-itrigger-get_executiontimelimit) herdada por todas as interfaces de gatilho.
