---
title: Esquema de Agendador de Tarefas
description: O esquema de Agendador de Tarefas define um XML válido usado para registrar tarefas com o serviço de Agendador de Tarefas. Os desenvolvedores podem criar seu próprio XML, validá-lo em relação a esse esquema e registrar tarefas usando o método ITaskFolder RegisterTask.
ms.assetid: 9b1b8e34-c635-413a-a230-79a58017cf21
keywords:
- Agendador de Tarefas Agendador de Tarefas, referência, esquema XML
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "104084313"
---
# <a name="task-scheduler-schema"></a><span data-ttu-id="74817-105">Esquema de Agendador de Tarefas</span><span class="sxs-lookup"><span data-stu-id="74817-105">Task Scheduler Schema</span></span>

<span data-ttu-id="74817-106">O esquema de Agendador de Tarefas define um XML válido usado para registrar tarefas com o serviço de Agendador de Tarefas.</span><span class="sxs-lookup"><span data-stu-id="74817-106">The Task Scheduler schema defines valid XML used to register tasks with the Task Scheduler service.</span></span> <span data-ttu-id="74817-107">Os desenvolvedores podem criar seu próprio XML, validá-lo em relação a esse esquema e registrar tarefas usando o método [**ITaskFolder:: RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) .</span><span class="sxs-lookup"><span data-stu-id="74817-107">Developers can create their own XML, validate it against this schema, and register tasks using the [**ITaskFolder::RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) method.</span></span>

<span data-ttu-id="74817-108">Os tipos e elementos do esquema de Agendador de Tarefas são documentados individualmente nas seções a seguir.</span><span class="sxs-lookup"><span data-stu-id="74817-108">The types and elements of the Task Scheduler schema are individually documented in the following sections.</span></span>

-   [<span data-ttu-id="74817-109">Elementos do esquema de Agendador de Tarefas</span><span class="sxs-lookup"><span data-stu-id="74817-109">Task Scheduler Schema Elements</span></span>](task-scheduler-schema-elements.md)
-   [<span data-ttu-id="74817-110">Tipos simples de esquema de Agendador de Tarefas</span><span class="sxs-lookup"><span data-stu-id="74817-110">Task Scheduler Schema Simple Types</span></span>](task-scheduler-schema-simple-types.md)
-   [<span data-ttu-id="74817-111">Tipos complexos de esquema de Agendador de Tarefas</span><span class="sxs-lookup"><span data-stu-id="74817-111">Task Scheduler Schema Complex Types</span></span>](task-scheduler-schema-complex-types.md)
-   [<span data-ttu-id="74817-112">Agendador de Tarefas grupos de esquema</span><span class="sxs-lookup"><span data-stu-id="74817-112">Task Scheduler Schema Groups</span></span>](task-scheduler-schema-groups.md)

<span data-ttu-id="74817-113">Todo o esquema de Agendador de Tarefas é definido pelo arquivo XSD a seguir.</span><span class="sxs-lookup"><span data-stu-id="74817-113">The entire Task Scheduler schema is defined by the following XSD file.</span></span>
