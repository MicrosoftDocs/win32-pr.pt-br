...
---
# <a name="task-scheduler-schema"></a>Esquema de Agendador de Tarefas

O esquema de Agendador de Tarefas define um XML válido usado para registrar tarefas com o serviço de Agendador de Tarefas. Os desenvolvedores podem criar seu próprio XML, validá-lo em relação a esse esquema e registrar tarefas usando o método [**ITaskFolder:: RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) .

Os tipos e elementos do esquema de Agendador de Tarefas são documentados individualmente nas seções a seguir.

-   [Elementos do esquema de Agendador de Tarefas](task-scheduler-schema-elements.md)
-   [Tipos simples de esquema de Agendador de Tarefas](task-scheduler-schema-simple-types.md)
-   [Tipos complexos de esquema de Agendador de Tarefas](task-scheduler-schema-complex-types.md)
-   [Agendador de Tarefas grupos de esquema](task-scheduler-schema-groups.md)

Todo o esquema de Agendador de Tarefas é definido pelo arquivo XSD a seguir.
