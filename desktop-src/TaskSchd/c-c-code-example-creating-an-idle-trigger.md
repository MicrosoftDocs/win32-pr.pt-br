---
title: Exemplo de código do C/C++ criando um gatilho ocioso
description: Este exemplo cria um gatilho ocioso para uma tarefa existente. Para obter informações sobre condições ociosas, consulte condições de ociosidade da tarefa.
...
---
# <a name="cc-code-example-creating-an-idle-trigger"></a>Exemplo de código C/C++: Criando um gatilho ocioso

Este exemplo cria um gatilho ocioso para uma tarefa existente. Para obter informações sobre condições ociosas, consulte [condições de ociosidade da tarefa](task-idle-conditions.md).
