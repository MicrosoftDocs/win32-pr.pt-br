...
---
# <a name="cc-code-example-enumerating-tasks"></a><span data-ttu-id="0f24a-103">Exemplo de código C/C++: enumerando tarefas</span><span class="sxs-lookup"><span data-stu-id="0f24a-103">C/C++ Code Example: Enumerating Tasks</span></span>

<span data-ttu-id="0f24a-104">Este exemplo enumera todas as tarefas na pasta tarefas agendadas do computador local e imprime o nome de cada tarefa na tela.</span><span class="sxs-lookup"><span data-stu-id="0f24a-104">This example enumerates all the tasks in the Scheduled Tasks folder of the local computer and prints the name of each task on the screen.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="0f24a-105">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="0f24a-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="0f24a-106">Exemplos de Agendador de Tarefas 1,0</span><span class="sxs-lookup"><span data-stu-id="0f24a-106">Task Scheduler 1.0 Examples</span></span>](task-scheduler-1-0-examples.md)
</dt> </dl>
