...
Um ponteiro para dados PRI criados por uma chamada anterior para [_ *MrmCreateResourceFileInMemory* *](mrmcreateresourcefileinmemory.md). Não libere *priData* até terminar de usar o indexador de recursos criado por essa função.
...
Não libere *priData* até terminar de usar o indexador de recursos criado por essa função.
