...
keywords:
- Método Resume
- Método Resume, interface IBackgroundCopyJob
- Interface IBackgroundCopyJob, método Resume
topic_type:
- apiref
api_name:
...
---
# <a name="ibackgroundcopyjobresume-method"></a>Método IBackgroundCopyJob::Resume
...
Quando você cria um trabalho, o trabalho é inicialmente suspenso. Chamar **Retomar** move o trabalho para o estado Transferindo. Observe que o trabalho deve conter um ou mais arquivos antes de chamar esse método.
