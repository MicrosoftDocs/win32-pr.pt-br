...
description: Recupera um ponteiro de interface para um objeto enumerador usado para enumerar downloads existentes.
keywords:
...
Opcional. O nome da propriedade a ser usada como uma categoria a ser enumerada. A `nullptr` passagem recuperará todos os downloads existentes. As propriedades a seguir têm suporte como uma categoria.
...
O endereço de um ponteiro de interface **para IEnumUnknown**, que é usado para enumerar downloads existentes. O conteúdo do enumerador depende do valor da *categoria*. Os downloads incluídos na interface de enumeração são aqueles que foram criados anteriormente pelo mesmo chamador para essa função. 
