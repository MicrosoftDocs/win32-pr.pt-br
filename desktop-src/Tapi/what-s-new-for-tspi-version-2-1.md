...
---
# <a name="whats-new-for-tspi-version-21"></a>O que há de novo na versão 2,1 do TSPI

A partir do TAPI 2,1, as DLLs da interface do usuário do provedor de serviços de telefonia podem ser usadas para gerenciar e exibir caixas de diálogo. A TAPI carrega a DLL no processo de um aplicativo que invoca qualquer uma das funções de provedor de serviço que pode exibir uma caixa de diálogo.
...
As funções e mensagens que foram novas ou alteradas para TSPI versão 2,1 são as seguintes:
...
A DLL da interface do usuário do provedor de serviços de telefonia fornece um meio de permitir a interação do usuário dentro do contexto do aplicativo em vez do próprio provedor de serviços. A versão 2,1 do TSPI forneceu as seguintes novas funções, mensagens e estruturas para implementação:
