...
---
# <a name="tspi_linesetcurrentlocation"></a><span data-ttu-id="a8370-104">TSPI \_ lineSetCurrentLocation</span><span class="sxs-lookup"><span data-stu-id="a8370-104">TSPI\_lineSetCurrentLocation</span></span>

<span data-ttu-id="a8370-105">Esta \_ função TSPI lineSetCurrentLocation está obsoleta.</span><span class="sxs-lookup"><span data-stu-id="a8370-105">This TSPI\_lineSetCurrentLocation function is obsolete.</span></span> <span data-ttu-id="a8370-106">A TAPI chamou essa função quando o usuário (usando a caixa de diálogo **Propriedades de discagem** ) ou um aplicativo (usando a função [**lineSetCurrentLocation**](/windows/win32/api/tapi/nf-tapi-linesetcurrentlocation) ) alterou o local de conversão de endereço.</span><span class="sxs-lookup"><span data-stu-id="a8370-106">TAPI called this function when the user (using the **Dialing Properties** dialog box) or an application (using the [**lineSetCurrentLocation**](/windows/win32/api/tapi/nf-tapi-linesetcurrentlocation) function) changed the address translation location.</span></span>

<span data-ttu-id="a8370-107">Atualmente, uma alteração no local de tradução resulta em uma \_ mensagem DEVSTATE de linha com *dwParam1* definido como LINEDEVSTATE \_ TRANSLATECHANGE.</span><span class="sxs-lookup"><span data-stu-id="a8370-107">Currently, a change in translation location results in a LINE\_DEVSTATE message with *dwParam1* set to LINEDEVSTATE\_TRANSLATECHANGE.</span></span>
