...
---
# <a name="create-a-simple-conference"></a>Criar uma conferência simples

O exemplo de código a seguir demonstra a criação de uma chamada de conferência simples. Para obter informações sobre videoconferência de multimídia de IP, consulte [sobre a reunião de conferência de telefonia IP](about-rendezvous-ip-telephony-conferencing.md).

Antes de usar este exemplo de código, uma chamada deve estar em andamento e você deve executar as operações em [fazer uma chamada](make-a-call.md) ou [receber uma chamada](receive-a-call.md) foi executada.
