...
O método **Get \_ StartPort** Obtém o valor da porta de 16 bits para a primeira porta.
...
| <dl> <dt>**\_ponteiro E**</dt> </dl>     | O parâmetro *pStartPort* não é um ponteiro válido.<br/>   |
