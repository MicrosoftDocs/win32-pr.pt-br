...
---
# <a name="itsdpput_description-method"></a>Método de descrição ITSdp::p UT \_

\[ Os controles e as interfaces da conferência de telefonia IP de reunião não estão disponíveis para uso no Windows Vista, no Windows Server 2008 e nas versões subsequentes do sistema operacional. A API do cliente RTC fornece funcionalidade semelhante.\]

O método de **\_ Descrição Put** define a descrição da sessão.
...
| <dl> <dt>**\_ponteiro E**</dt> </dl>     | O parâmetro *pDescription* não é um ponteiro válido.<br/> |
...
[**ITSdp:: obter \_ Descrição**](itsdp-get-description.md)
</dt> </dl>
