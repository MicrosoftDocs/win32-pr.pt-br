...
---
# <a name="select-an-address"></a>Selecionar um endereço

O exemplo de código a seguir demonstra o uso do objeto TAPI para examinar os recursos de telefonia disponíveis para um endereço que pode manipular um conjunto especificado de requisitos de tipo de mídia. Neste exemplo, áudio e vídeo são a mídia necessária.

Antes de usar este exemplo de código, você deve executar as operações em [inicializar TAPI](initialize-tapi.md).
