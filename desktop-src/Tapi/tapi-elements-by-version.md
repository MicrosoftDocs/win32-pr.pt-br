...
ms.locfileid: "105758111"
---
# <a name="tapi-elements-by-version"></a>Elementos TAPI por versão

As tabelas a seguir são uma lista alfabética de referência rápida de funções e estruturas TAPI, juntamente com as versões TAPI associadas a cada elemento.



Função TAPI

Usar com a (s) versão (ões) TAPI
