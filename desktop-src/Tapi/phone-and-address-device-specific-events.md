...
---
# <a name="phone-and-address-device-specific-events"></a><span data-ttu-id="33fe2-104">Telefone e endereço de eventos específicos do dispositivo</span><span class="sxs-lookup"><span data-stu-id="33fe2-104">Phone and Address Device-specific Events</span></span>

<span data-ttu-id="33fe2-105">O exemplo de código a seguir ilustra um manipulador de eventos para eventos de endereço e dispositivo de telefone.</span><span class="sxs-lookup"><span data-stu-id="33fe2-105">The following code example illustrates an event handler for address and phone device events.</span></span> <span data-ttu-id="33fe2-106">O código para cada evento mostra como criar a interface de evento e como recuperar os dados do evento.</span><span class="sxs-lookup"><span data-stu-id="33fe2-106">The code for each event shows how to create the event interface and how to retrieve the event data.</span></span>
