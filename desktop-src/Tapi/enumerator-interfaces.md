...
ms.locfileid: "117945535"
---
# <a name="enumerator-interfaces"></a>Interfaces do enumerador

As interfaces a seguir enumeram elementos TAPI 3 de acordo com os padrões COM. Essas interfaces constituem objetos autônomos e também são resumidas com seus objetos relacionados.



| Interface                                                                  | Item enumerado                                                                                                                                    |
|----------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
...
| [**IEnumBstr**](/windows/desktop/api/tapi3if/nn-tapi3if-ienumbstr)                                             | Cadeias de caracteres **BSTR,** como aquelas retornadas por [**ITAddressCapabilities::EnumerateDeviceClasses**](/windows/desktop/api/tapi3if/nf-tapi3if-itaddresscapabilities-enumeratedeviceclasses). |
