---
description: A TAPI dá suporte a funções de dispositivo de linha para configurar dispositivos de linha e executar funções de telefonia como reter e encaminhar.
ms.assetid: 74e6300f-0d72-4b0f-8b95-fc1c8d0d0293
title: Funções de dispositivo de linha
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105779455"
---
# <a name="line-device-functions"></a>Funções de dispositivo de linha

A TAPI dá suporte às seguintes funções de dispositivo de linha:
...
Para uma categorização de funções TAPI por nível de serviço e tarefa, consulte [referência de função rápida TAPI](tapi-quick-function-reference.md).
