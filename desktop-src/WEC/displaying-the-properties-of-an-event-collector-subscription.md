...
---
# <a name="display-event-collector-subscription-properties"></a><span data-ttu-id="54281-103">Exibir Propriedades da assinatura do coletor de eventos</span><span class="sxs-lookup"><span data-stu-id="54281-103">Display event collector subscription properties</span></span>

<span data-ttu-id="54281-104">Você pode exibir informações úteis sobre uma assinatura do coletor de eventos e suas origens de eventos recuperando e exibindo as propriedades da assinatura.</span><span class="sxs-lookup"><span data-stu-id="54281-104">You can view useful information about an Event Collector subscription and its event sources by retrieving and displaying the properties of the subscription.</span></span>

> [!Note]
>
> <span data-ttu-id="54281-105">Você pode usar este exemplo para exibir os valores de propriedade de uma assinatura ou pode digitar o seguinte comando no prompt de comando:</span><span class="sxs-lookup"><span data-stu-id="54281-105">You can use this example to display the property values of a subscription or you can type the following command at the command prompt:</span></span>
>
> <span data-ttu-id="54281-106">a *assinatura* de **wecutil GS**</span><span class="sxs-lookup"><span data-stu-id="54281-106">**wecutil gs** *SubscriptionName*</span></span>

 

<span data-ttu-id="54281-107">Para exibir suas propriedades, especifique o nome de uma assinatura.</span><span class="sxs-lookup"><span data-stu-id="54281-107">To display its properties, specify the name of a subscription.</span></span> <span data-ttu-id="54281-108">Para obter mais informações e um exemplo de código em C++ de como listar os nomes das assinaturas atuais em um computador local, consulte [listando assinaturas do coletor de eventos](listing-event-collector-subscriptions.md)ou você pode digitar o seguinte comando no prompt de comando:</span><span class="sxs-lookup"><span data-stu-id="54281-108">For more information and a C++ code example of how to list the names of current subscriptions on a local computer, see [Listing Event Collector Subscriptions](listing-event-collector-subscriptions.md), or you can type the following command at the command prompt:</span></span>

<span data-ttu-id="54281-109">**wecutil es**</span><span class="sxs-lookup"><span data-stu-id="54281-109">**wecutil es**</span></span>

<span data-ttu-id="54281-110">O exemplo de código a seguir segue um procedimento para exibir as propriedades de uma assinatura do coletor de eventos e suas origens de eventos associadas.</span><span class="sxs-lookup"><span data-stu-id="54281-110">The following code example follows a procedure to display the properties of an Event Collector subscription and its associated event sources.</span></span>

<span data-ttu-id="54281-111">**Para exibir as propriedades de uma assinatura do coletor de eventos e suas origens de eventos**</span><span class="sxs-lookup"><span data-stu-id="54281-111">**To display the properties of an Event Collector subscription and its event sources**</span></span>

1.  <span data-ttu-id="54281-112">Abra a assinatura fornecendo o nome da assinatura e os direitos de acesso como parâmetros para a função [**EcOpenSubscription**](/windows/desktop/api/Evcoll/nf-evcoll-ecopensubscription) .</span><span class="sxs-lookup"><span data-stu-id="54281-112">Open the subscription by providing the subscription name and access rights as parameters to the [**EcOpenSubscription**](/windows/desktop/api/Evcoll/nf-evcoll-ecopensubscription) function.</span></span> <span data-ttu-id="54281-113">Para obter mais informações sobre direitos de acesso, consulte as [**constantes do coletor de eventos do Windows**](windows-event-collector-constants.md).</span><span class="sxs-lookup"><span data-stu-id="54281-113">For more information about access rights, see [**Windows Event Collector Constants**](windows-event-collector-constants.md).</span></span>
2.  <span data-ttu-id="54281-114">Obtenha e exiba as propriedades das fontes de assinatura e de evento chamando a função [**EcGetSubscriptionProperty**](/windows/desktop/api/Evcoll/nf-evcoll-ecgetsubscriptionproperty) e a função [**EcGetObjectArrayProperty**](/windows/desktop/api/Evcoll/nf-evcoll-ecgetobjectarrayproperty) .</span><span class="sxs-lookup"><span data-stu-id="54281-114">Get and display the properties of the subscription and event sources by calling the [**EcGetSubscriptionProperty**](/windows/desktop/api/Evcoll/nf-evcoll-ecgetsubscriptionproperty) function and the [**EcGetObjectArrayProperty**](/windows/desktop/api/Evcoll/nf-evcoll-ecgetobjectarrayproperty) function.</span></span> <span data-ttu-id="54281-115">Para obter mais informações sobre as propriedades da assinatura e da origem do evento que podem ser exibidas, consulte a enumeração da [**ID de propriedade da assinatura do EC \_ \_ \_**](/windows/desktop/api/Evcoll/ne-evcoll-ec_subscription_property_id) .</span><span class="sxs-lookup"><span data-stu-id="54281-115">For more information about subscription and event source properties that can be displayed, see the [**EC\_SUBSCRIPTION\_PROPERTY\_ID**](/windows/desktop/api/Evcoll/ne-evcoll-ec_subscription_property_id) enumeration.</span></span>
3.  <span data-ttu-id="54281-116">Feche a assinatura chamando a função [**EcClose**](/windows/desktop/api/Evcoll/nf-evcoll-ecclose) .</span><span class="sxs-lookup"><span data-stu-id="54281-116">Close the subscription by calling the [**EcClose**](/windows/desktop/api/Evcoll/nf-evcoll-ecclose) function.</span></span>

<span data-ttu-id="54281-117">O exemplo de código C++ a seguir mostra como exibir as propriedades de uma assinatura do coletor de eventos.</span><span class="sxs-lookup"><span data-stu-id="54281-117">The following C++ code example shows how to display the properties of an Event Collector subscription.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="54281-118">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="54281-118">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="54281-119">Listando assinaturas do coletor de eventos</span><span class="sxs-lookup"><span data-stu-id="54281-119">Listing Event Collector Subscriptions</span></span>](listing-event-collector-subscriptions.md)
</dt> <dt>

[<span data-ttu-id="54281-120">Referência do coletor de eventos do Windows</span><span class="sxs-lookup"><span data-stu-id="54281-120">Windows Event Collector Reference</span></span>](windows-event-collector-reference.md)
</dt> </dl>
