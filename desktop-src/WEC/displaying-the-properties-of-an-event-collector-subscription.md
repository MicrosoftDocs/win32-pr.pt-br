...
Você pode exibir informações úteis sobre uma assinatura do coletor de eventos e suas origens de eventos recuperando e exibindo as propriedades da assinatura.

> [!Note]
>
> Você pode usar este exemplo para exibir os valores de propriedade de uma assinatura ou pode digitar o seguinte comando no prompt de comando:
>
...
O exemplo de código a seguir segue um procedimento para exibir as propriedades de uma assinatura do coletor de eventos e suas origens de eventos associadas.
...
O exemplo de código C++ a seguir mostra como exibir as propriedades de uma assinatura do coletor de eventos.
