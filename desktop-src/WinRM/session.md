...
| Método                                 | Descrição                                                                                                                 |
|:---------------------------------------|:----------------------------------------------------------------------------------------------------------------------------|
| [**Criar**](session-create.md)       | Cria uma nova instância de um recurso e retorna o URI do novo objeto.<br/>                                      |
| [**Excluir**](session-delete.md)       | Exclui o recurso especificado no URI de recurso.<br/>                                                              |
...
| [**Invoke**](session-invoke.md)       | Invoca um método que retorna os resultados da chamada de método.<br/>                                                    |
...
| [**Ao**](session-error.md)<br/>           | Somente leitura<br/>  | Obtém informações de erro adicionais em um fluxo XML.<br/>                                                                                                                                                              |
