...
keywords:
- Método EnumerationFlagHierarchyShallow Windows Gerenciamento Remoto
- Método EnumerationFlagHierarchyShallow Windows gerenciamento remoto, objeto WSMan
- O objeto WSMan Windows Gerenciamento Remoto, EnumerationFlagHierarchyShallow
topic_type:
- apiref
api_name:
