---
description: Veja a seguir o código-fonte completo do aplicativo auxiliar de IP. A verificação de erros adicional foi adicionada ao código-fonte.
ms.assetid: c0290660-8a18-4d5c-8f0a-df15da1a9167
title: Código-fonte completo do aplicativo auxiliar de IP
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105752870"
---
# <a name="complete-ip-helper-application-source-code"></a><span data-ttu-id="c11f9-104">Código-fonte completo do aplicativo auxiliar de IP</span><span class="sxs-lookup"><span data-stu-id="c11f9-104">Complete IP Helper Application Source Code</span></span>

<span data-ttu-id="c11f9-105">Veja a seguir o código-fonte completo do aplicativo auxiliar de IP.</span><span class="sxs-lookup"><span data-stu-id="c11f9-105">The following is the complete source code for the IP Helper application.</span></span> <span data-ttu-id="c11f9-106">A verificação de erros adicional foi adicionada ao código-fonte.</span><span class="sxs-lookup"><span data-stu-id="c11f9-106">Additional error checking has been added to source code.</span></span>
