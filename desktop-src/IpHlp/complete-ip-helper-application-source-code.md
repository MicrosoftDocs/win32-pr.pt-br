...
ms.locfileid: "120040376"
---
# <a name="complete-ip-helper-application-source-code"></a>Código-fonte completo do aplicativo auxiliar de IP

Veja a seguir o código-fonte completo do aplicativo auxiliar de IP. A verificação de erros adicional foi adicionada ao código-fonte.
