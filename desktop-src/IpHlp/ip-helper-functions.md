...
ms.locfileid: "118389127"
---
# <a name="ip-helper-functions"></a>Funções auxiliares de IP

As funções a seguir recuperam e modificam as definições de configuração para o transporte TCP/IP no computador local. A listagem categórica a seguir pode ajudar a determinar qual coleção de funções é mais adequada para uma determinada tarefa.
...
## <a name="adapter-management"></a>Gerenciamento de adaptador
...
## <a name="address-resolution-protocol-arp-management"></a>Gerenciamento de ARP (protocolo de resolução de endereço)
...
## <a name="interface-conversion"></a>Conversão de interface
...
## <a name="ip-address-string-conversion"></a>Conversão de cadeia de caracteres de endereço IP
...
## <a name="ip-neighbor-address-management"></a>Gerenciamento de endereços IP vizinhos
...
## <a name="security-health"></a>Integridade da segurança
