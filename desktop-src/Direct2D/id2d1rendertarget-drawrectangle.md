...
---
# <a name="id2d1rendertargetdrawrectangle-methods"></a>ID2D1RenderTarget: métodos de rawRectangle de:D

Desenha o contorno de um retângulo que tem as dimensões e o estilo de traço especificados.
...
| Método                                                                                                                                                                   | Descrição                                                                                      |
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------|
| [**DrawRectangle (D2D1 \_ Rect \_ F&, ID2D1Brush \* , float, ID2D1StrokeStyle \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-drawrectangle(constd2d1_rect_f__id2d1brush_float_id2d1strokestyle))  | Desenha o contorno de um retângulo que tem as dimensões e o estilo de traço especificados. <br/> |
| [**DrawRectangle (D2D1 \_ Rect \_ F \* , ID2D1Brush \* , float, ID2D1StrokeStyle \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-drawrectangle(constd2d1_rect_f__id2d1brush_float_id2d1strokestyle)) | Desenha o contorno de um retângulo que tem as dimensões e o estilo de traço especificados. <br/> |
...
Quando esse método falha, ele não retorna um código de erro. Para determinar se um método de desenho (como **DrawRectangle**) falhou, verifique o resultado retornado pelo método [**ID2D1RenderTarget:: EndDraw**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-enddraw) ou [**ID2D1RenderTarget:: flush**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-flush) .
