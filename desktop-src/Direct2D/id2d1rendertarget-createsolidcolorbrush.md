...
Cria um novo [**ID2D1SolidColorBrush**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-createsolidcolorbrush(constd2d1_color_f__constd2d1_brush_properties__id2d1solidcolorbrush)) que pode ser usado para pintar áreas com uma cor sólida.
...
Para obter um exemplo, consulte [como criar um pincel de cor sólida](how-to-create-a-solid-color-brush.md).
...
[Início rápido do Direct2D](getting-started-with-direct2d.md)
</dt> </dl>
