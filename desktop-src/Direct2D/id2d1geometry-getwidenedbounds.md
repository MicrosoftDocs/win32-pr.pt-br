...
Obtém os limites da geometria após ela ter sido ampliada pela largura e pelo estilo do traço especificado e transformada pela matriz especificada.
...
| Método                                                                                                                                                                                                 | Descrição                                                                                                                                           |
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ 3x2 \_ f&, d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__d2d1_rect_f))              | Obtém os limites da geometria após ela ter sido ampliada pela largura e pelo estilo do traço especificado e transformada pela matriz especificada.<br/> |
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ 3x2 \_ f \* , d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_d2d1_rect_f))             | Obtém os limites da geometria após ela ter sido ampliada pela largura e pelo estilo do traço especificado e transformada pela matriz especificada.<br/> |
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ 3x2 \_ f&, float, d2d1 \_ Rect \_ F \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__float_d2d1_rect_f))  | Obtém os limites da geometria após ela ter sido ampliada pela largura e pelo estilo do traço especificado e transformada pela matriz especificada.<br/> |
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ 3x2 \_ f \* , float, d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_float_d2d1_rect_f)) | Obtém os limites da geometria após ela ter sido ampliada pela largura e pelo estilo do traço especificado e transformada pela matriz especificada.<br/> |



## <a name="examples"></a>Exemplos

O código a seguir mostra como usar **GetWidenedBounds** para recuperar os limites da geometria após ela ter sido ampliada pela largura e pelo estilo do traço especificado e transformada pela matriz especificada.
