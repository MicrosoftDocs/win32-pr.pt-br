---
title: Métodos GetBounds ID2D1Geometry (D2d1 \_ 1. h)
description: Recupera os limites da geometria.
ms.assetid: 3932189a-7c6b-4144-9d4a-32d2aba70835
keywords:
- Métodos GetBounds Direct2D
topic_type:
- apiref
api_location:
- D2d1.dll
...
ms.locfileid: "105770111"
---
# <a name="id2d1geometrygetbounds-methods"></a><span data-ttu-id="29c29-104">Métodos ID2D1Geometry:: GetBounds</span><span class="sxs-lookup"><span data-stu-id="29c29-104">ID2D1Geometry::GetBounds methods</span></span>

<span data-ttu-id="29c29-105">Recupera os limites da geometria.</span><span class="sxs-lookup"><span data-stu-id="29c29-105">Retrieves the bounds of the geometry.</span></span>

### <a name="overload-list"></a><span data-ttu-id="29c29-106">Lista de sobrecargas</span><span class="sxs-lookup"><span data-stu-id="29c29-106">Overload list</span></span>



| <span data-ttu-id="29c29-107">Método</span><span class="sxs-lookup"><span data-stu-id="29c29-107">Method</span></span>                                                                                                                   | <span data-ttu-id="29c29-108">Descrição</span><span class="sxs-lookup"><span data-stu-id="29c29-108">Description</span></span>                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| <span data-ttu-id="29c29-109">[**GetBounds (D2D1 \_ Matrix \_ 3X2 \_ F&, D2D \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="29c29-109">[**GetBounds(D2D1\_MATRIX\_3X2\_F&,D2D\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span></span>   | <span data-ttu-id="29c29-110">Recupera os limites da geometria.</span><span class="sxs-lookup"><span data-stu-id="29c29-110">Retrieves the bounds of the geometry.</span></span><br/> |
| <span data-ttu-id="29c29-111">[**GetBounds ( \_ matriz d2d1 \_ 3x2 \_ f \* , d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="29c29-111">[**GetBounds(D2D1\_MATRIX\_3X2\_F\*,D2D1\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span></span> | <span data-ttu-id="29c29-112">Recupera os limites da geometria.</span><span class="sxs-lookup"><span data-stu-id="29c29-112">Retrieves the bounds of the geometry.</span></span><br/> |



## <a name="examples"></a><span data-ttu-id="29c29-113">Exemplos</span><span class="sxs-lookup"><span data-stu-id="29c29-113">Examples</span></span>

<span data-ttu-id="29c29-114">O código a seguir mostra como usar **GetBounds** para recuperar os limites da geometria.</span><span class="sxs-lookup"><span data-stu-id="29c29-114">The following code shows how to use **GetBounds** to retrieve the bounds of the geometry.</span></span>
...
## <a name="requirements"></a><span data-ttu-id="29c29-115">Requisitos</span><span class="sxs-lookup"><span data-stu-id="29c29-115">Requirements</span></span>



| <span data-ttu-id="29c29-116">Requisito</span><span class="sxs-lookup"><span data-stu-id="29c29-116">Requirement</span></span> | <span data-ttu-id="29c29-117">Valor</span><span class="sxs-lookup"><span data-stu-id="29c29-117">Value</span></span> |
|--------------------|--------------------------------------------------------------------------------------|
| <span data-ttu-id="29c29-118">parâmetro</span><span class="sxs-lookup"><span data-stu-id="29c29-118">Header</span></span><br/>  | <dl> <span data-ttu-id="29c29-119"><dt>D2d1 \_ 1. h</dt></span><span class="sxs-lookup"><span data-stu-id="29c29-119"><dt>D2d1\_1.h</dt></span></span> </dl> |
| <span data-ttu-id="29c29-120">Biblioteca</span><span class="sxs-lookup"><span data-stu-id="29c29-120">Library</span></span><br/> | <dl> <span data-ttu-id="29c29-121"><dt>D2d1. lib</dt></span><span class="sxs-lookup"><span data-stu-id="29c29-121"><dt>D2d1.lib</dt></span></span> </dl>  |
| <span data-ttu-id="29c29-122">DLL</span><span class="sxs-lookup"><span data-stu-id="29c29-122">DLL</span></span><br/>     | <dl> <span data-ttu-id="29c29-123"><dt>D2d1.dll</dt></span><span class="sxs-lookup"><span data-stu-id="29c29-123"><dt>D2d1.dll</dt></span></span> </dl>  |



## <a name="see-also"></a><span data-ttu-id="29c29-124">Confira também</span><span class="sxs-lookup"><span data-stu-id="29c29-124">See also</span></span>

<dl> <dt>

[<span data-ttu-id="29c29-125">**ID2D1Geometry**</span><span class="sxs-lookup"><span data-stu-id="29c29-125">**ID2D1Geometry**</span></span>](/windows/win32/api/d2d1/nn-d2d1-id2d1geometry)
</dt> </dl>
