...
| Método                                                                                                                   | Descrição                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| [**GetBounds (D2D1 \_ Matrix \_ 3X2 \_ F&, D2D \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))   | Recupera os limites da geometria.<br/> |
| [**GetBounds ( \_ matriz d2d1 \_ 3x2 \_ f \* , d2d1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f)) | Recupera os limites da geometria.<br/> |



## <a name="examples"></a>Exemplos

O código a seguir mostra como usar **GetBounds** para recuperar os limites da geometria.
