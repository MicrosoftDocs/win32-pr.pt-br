...
---
# <a name="vignette-effect"></a>Efeito de Vignette

Esmaece a imagem de entrada nas bordas para uma cor definida pelo usuário.

O CLSID para esse efeito é CLSID \_ D2D1Vignette.
...
As propriedades para o efeito de Vignette são definidas pela enumeração de [**\_ \_ prop d2d1 Vignette**](/windows/desktop/api/d2d1effects_2/ne-d2d1effects_2-d2d1_vignette_prop) .
