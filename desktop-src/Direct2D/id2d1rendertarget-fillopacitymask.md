...
Para que esse método funcione corretamente, o destino de renderização deve estar usando o modo de suavização ALIAS DE [**\_ MODO ANTIALIAS \_ \_ D2D1.**](/windows/desktop/api/d2d1/ne-d2d1-d2d1_antialias_mode) Você pode definir o modo de aninhamento chamando o [**método ID2D1RenderTarget::SetAntialiasMode.**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-setantialiasmode)
