...
keywords:
- Direct2D métodos de FillRoundedRectangle
topic_type:
- apiref
api_location:
- D2d1.dll
...
| Método                                                                                                                                          | Descrição                                                         |
|:------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------|
| [**FillRoundedRectangle (D2D1 \_ arredondado \_ retangular&, ID2D1Brush \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-fillroundedrectangle(constd2d1_rounded_rect__id2d1brush))  | Pinta o interior do retângulo arredondado especificado. <br/> |
| [**FillRoundedRectangle ( \_ retângulo arredondado d2d1 \_ \* , ID2D1Brush \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-fillroundedrectangle(constd2d1_rounded_rect__id2d1brush)) | Pinta o interior do retângulo arredondado especificado.<br/>  |



## <a name="remarks"></a>Comentários

Esse método não retornará um código de erro se ele falhar. Para determinar se uma operação de desenho (como **FillRoundedRectangle**) falhou, verifique o resultado retornado pelos métodos [**ID2D1RenderTarget:: EndDraw**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-enddraw) ou [**ID2D1RenderTarget:: flush**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-flush) .

## <a name="examples"></a>Exemplos

O exemplo a seguir usa os métodos [**DrawRoundedRectangle**](id2d1rendertarget-drawroundedrectangle.md) e **FillRoundedRectangle** para descrever e preencher um retângulo arredondado. Este exemplo produz a saída mostrada na ilustração a seguir.
