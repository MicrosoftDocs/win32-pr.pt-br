...
Este tópico explora como a criação de protótipos de uma interface do usuário pode ajudar a minimizar falhas de design e garantir uma experiência de usuário bem-sucedida.

## <a name="introduction"></a>Introdução

Às vezes, à medida que um projeto avança, pequenas suposições e bem intencional, mas as decisões ruins se acumulam, transformando horas de trabalho em uma experiência de usuário péssimo. As equipes inteligentes eliminam seus erros antes de serem entregues usando uma técnica chamada protótipo de interface do usuário. Combinados com estudos de usabilidade, os protótipos mantêm as equipes na direção certa.

## <a name="why-prototype"></a>Por que protótipo?

A protótipo é um meio de explorar ideias antes de investir nelas. Todos os craftspeople e engenheiros experientes criam protótipos de seu trabalho antes de criarem qualquer coisa: os arquitetos criam modelos sem papel ou papel, ou com ferramentas de realidade virtual. Os engenheiros de Aeronautic usam túneis de vento. Os construtores de ponte criam modelos de estresse. O software e os designers da Web criam simulações de como os usuários irão interagir com seus designs.

O melhor motivo para o protótipo é economizar tempo e recursos. O valor de um protótipo é que ele é uma fachada, como um conjunto de Hollywood, onde apenas a frente da construção é construída. Em relação ao produto real, os protótipos são fáceis e baratos de criar. Portanto, para um investimento mínimo, podem ser encontrados problemas de usabilidade e de design e a interface do usuário ajustada antes que um investimento substancial seja feito no design e nas tecnologias finais.

Ao examinar as necessidades de um projeto específico, os motivos para criar um protótipo diferente de economizar dinheiro podem ser encontrados. A meta é explorar um novo modelo de interface? Fazer modificações em uma parte do design existente? Investigar uma nova tecnologia? Antes de começar, é importante ficar claro por que você está criando o que está criando. Começar com metas claras ajuda a tornar o esforço direto e eficaz. Os motivos para criar protótipos se enquadram em três categorias básicas:

-   Prova de conceito.

    Entre algumas equipes há desacordos sobre a direção futura de um projeto. Um protótipo pode ser usado para provar que uma abordagem ideia ou nova tem mérito ou valor. Um protótipo pode ajudar a ilustrar que uma ideia funciona, expressar suas qualidades de maneira visual e interativa e/ou motivar os membros da equipe a pensar sobre o problema de outra perspectiva.

-   Exploração de design.

    Se estiver criando um software interativo, a única maneira de explorar como algo será usado é criar uma simulação e interagir com ela. Às vezes, a imitação está vinculada a um estudo de usabilidade, em que partes do protótipo podem ser avaliadas de forma estruturada. Às vezes, é apenas uma maneira de expressar claramente para um desenvolvedor como algo deve funcionar ou parecer. Em muitos casos, um designer pode simplesmente estar experimentando, em um esforço para ter uma noção de qual abordagem pode funcionar. Qualquer pessoa na equipe pode usar protótipos para explorar problemas de design, embora os designers geralmente sejam os mais qualificados. Explorações de design devem ser direcionadas para a tentativa de resolver problemas específicos que são reconhecidos no produto.

-   Exploração técnica.

    Os desenvolvedores que investigam abordagens de implementação para um problema muitas vezes tentam diferentes técnicas de codificação para ver se funcionam bem. O uso de COM+, HTML dinâmico (DHTML), Microsoft Win32 ou abordagens de codificação específicas dentro de cada tecnologia têm compensações diferentes. Às vezes, um protótipo representa uma exploração em qual tecnologia funcionará bem para dar suporte a um determinado recurso da interface do usuário.
...
Para protótipos mais formais por equipes maiores, um desenvolvedor ou gerente de projeto geralmente colaborará com um designer e um engenheiro de usabilidade. Juntos, eles geram ideias, criam um protótipo que representa as melhores ideias e, em seguida, acessam o laboratório para ver quão eficiente ele está Solucionando problemas do usuário. Os desenvolvedores poderão se envolver se puderem reservar tempo ou se sua experiência técnica for necessária. Geralmente, o designer ou o gerente de projeto fará a maior parte da criação de scripts ou codificação para criar o protótipo.

## <a name="when-should-a-prototype-be-built"></a>Quando um protótipo deve ser criado?
...
## <a name="where-should-the-focus-be"></a>Onde o foco deve ser?

Em um protótipo, crie apenas a maior parte do design necessário. Não há problemas em ter botões que não funcionam ou texto que nunca é atualizado. Desde que as interações necessárias possam ser experimentadas, é bom usar fumaça e espelhos para o restante. Aqui estão algumas razões pelas quais os esforços devem ser cuidadosamente concentrados:

-   Custo da criação do protótipo.

    O custo envolvido na criação do protótipo deve ser minimizado. O desafio da criação de protótipos é reconhecer o investimento mínimo necessário para responder efetivamente a perguntas sobre o design. É aí que os estudos de usabilidade são críticos, pois eles claramente identificam as partes da interface do usuário que precisam da maior parte do trabalho. Mesmo sem estudos de usabilidade, defina claramente quais problemas de usuário estão sendo resolvidos ou quais tarefas estão sendo aprimoradas, com o design no protótipo.

-   Tempo de vida limitado.
-   Os protótipos devem ter tempos de vida definidos claramente. O objetivo final é uma apresentação em uma reunião de equipe? Uma reunião de análise executiva? Uma revisão de especificações? Um estudo de usabilidade? Identificar se o design resolve um problema do usuário? Depois que as necessidades desses objetivos específicos forem atendidas, o protótipo deverá ser reservado. A mentalidade básica é que o código ou os bitmaps gerados em um protótipo serão deixados para trás. Pode haver exceções em que o código ou visuais residem no produto, mas a expectativa deve ser que esse não seja o caso.
-   Risco de sobrecarregar a equipe.

    A exibição de protótipos para desenvolvedores e colegas de equipe pode ser complicada. Um protótipo excessivamente complexo ou elaborado, elementos visuais e animação incríveis, pode sobrecarregar as pessoas. Sempre tenha um sentido para a distância e quanto do protótipo deve ser levado a sério.

## <a name="what-is-the-scope"></a>O que é o escopo?

Como o foco do esforço de protótipo é determinado, considere o seguinte:

-   Necessidades do cliente.

    Começando com uma compreensão dos principais problemas ou das necessidades dos usuários (talvez algo que um engenheiro de usabilidade tenha fornecido) fornece uma ideia sobre quais partes do design da interface do usuário garantem a maior exploração.

-   Tarefas de estudo de usabilidade.

    Se estiver criando o protótipo para um estudo de usabilidade, discuta com o engenheiro de usabilidade quais tarefas específicas serão parte do estudo e projete em volta desses elementos.
