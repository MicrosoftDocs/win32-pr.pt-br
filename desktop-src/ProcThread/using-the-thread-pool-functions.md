...
---
# <a name="using-the-thread-pool-functions"></a>Usando as funções do pool de threads

Este exemplo cria um pool de threads personalizado, cria um item de trabalho e um temporizador de pool de threads e os associa a um grupo de limpeza. O pool consiste em um thread persistente. Ele demonstra o uso das seguintes funções de pool de threads:
