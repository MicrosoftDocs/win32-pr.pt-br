...
---
# <a name="modifykvpitems-method-of-the-msvm_virtualsystemmanagementservice-class"></a>Método ModifyKvpItems da \_ classe VirtualSystemManagementService Msvm

Modifica os pares de chave-valor existentes em uma máquina virtual.
...
Uma referência à máquina virtual na qual os pares de chave-valor serão modificados.
...
Uma matriz de pares chave-valor a ser modificada. Cada elemento da matriz é uma instância incorporada da classe [**Msvm \_ KvpExchangeDataItem**](msvm-kvpexchangedataitem.md) . Esse método falhará se qualquer um dos pares chave-valor especificados não existir no sistema de destino. Essa matriz pode conter no máximo 128 elementos.
...
O exemplo de C# a seguir modifica os pares de chave-valor em uma máquina virtual. Os utilitários referenciados podem ser encontrados em [utilitários comuns para os exemplos de virtualização (v2)](common-utilities-for-the-virtualization-samples-v2.md).
...
O exemplo de Visual Basic Scripting Edition (VBScript) a seguir modifica os pares de chave-valor em uma máquina virtual.
