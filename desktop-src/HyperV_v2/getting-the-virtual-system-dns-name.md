---
description: Os exemplos de C# e Visual Basic Scripting Edition (VBScript) a seguir recuperam o nome DNS da máquina virtual.
ms.assetid: 1E1F7E6F-5CF6-475F-8351-6A5F56B4FC8E
title: Obter o nome DNS da máquina virtual
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103837529"
---
# <a name="getting-the-virtual-machine-dns-name"></a><span data-ttu-id="8b982-103">Obter o nome DNS da máquina virtual</span><span class="sxs-lookup"><span data-stu-id="8b982-103">Getting the virtual machine DNS name</span></span>

<span data-ttu-id="8b982-104">Os exemplos de C# e Visual Basic Scripting Edition (VBScript) a seguir recuperam o nome DNS da máquina virtual.</span><span class="sxs-lookup"><span data-stu-id="8b982-104">The following C# and Visual Basic Scripting Edition (VBScript) samples retrieve the DNS name of the virtual machine.</span></span>

<span data-ttu-id="8b982-105">Para executar este código de exemplo, você deve instalar o cliente do Integration Services e o sistema operacional do cliente deve estar em execução.</span><span class="sxs-lookup"><span data-stu-id="8b982-105">To run this sample code, you must install the client integration services and the client operating system must be running.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="8b982-106">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="8b982-106">Related topics</span></span>

[<span data-ttu-id="8b982-107">Utilitários comuns para exemplos de virtualização (v2)</span><span class="sxs-lookup"><span data-stu-id="8b982-107">Common utilities for the virtualization samples (V2)</span></span>](common-utilities-for-the-virtualization-samples-v2.md)

[<span data-ttu-id="8b982-108">**Msvm \_ ComputerSystem**</span><span class="sxs-lookup"><span data-stu-id="8b982-108">**Msvm\_ComputerSystem**</span></span>](msvm-computersystem.md)

[<span data-ttu-id="8b982-109">**Msvm \_ KvpExchangeComponent**</span><span class="sxs-lookup"><span data-stu-id="8b982-109">**Msvm\_KvpExchangeComponent**</span></span>](msvm-kvpexchangecomponent.md)
