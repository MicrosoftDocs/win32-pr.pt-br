...
---
# <a name="getting-the-virtual-machine-dns-name"></a>Obter o nome DNS da máquina virtual

Os exemplos de C# e Visual Basic Scripting Edition (VBScript) a seguir recuperam o nome DNS da máquina virtual.

Para executar este código de exemplo, você deve instalar o cliente do Integration Services e o sistema operacional do cliente deve estar em execução.
...
[Utilitários comuns para exemplos de virtualização (v2)](common-utilities-for-the-virtualization-samples-v2.md)
