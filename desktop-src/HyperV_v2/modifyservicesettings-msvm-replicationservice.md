...
---
# <a name="modifyservicesettings-method-of-the-msvm_replicationservice-class"></a>Método ModifyServiceSettings da \_ classe ReplicationService Msvm

Modifica as configurações para o serviço de réplica do Hyper-V.
