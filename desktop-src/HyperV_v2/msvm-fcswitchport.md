---
description: Representa uma porta na opção de Fibre Channel virtual.
...
Representa uma porta na opção de Fibre Channel virtual.
...
A **classe Msvm \_ FcSwitchPort** tem estes tipos de membros:
...
A **classe Msvm \_ FcSwitchPort** tem esses métodos.
...
| [**RequestStateChange**](msvm-fcswitchport-requeststatechange.md) | solicita uma alteração de estado.<br/>      |
| [**Redefinir**](msvm-fcswitchport-reset.md)                           | Redefine o dispositivo virtual.<br/>    |
...
A **classe Msvm \_ FcSwitchPort** tem essas propriedades.
...
| <span id="Quiesce"></span><span id="quiesce"></span><span id="QUIESCE"></span><dl> <dt>**Quiesce**</dt> <dt>9</dt> </dl>                                                 | O elemento está habilitado, mas em um modo restrito. O comportamento do elemento é semelhante ao estado Habilitado (2), mas ele processa apenas um conjunto restrito de comandos. Todas as outras solicitações estão na fila.<br/> |
