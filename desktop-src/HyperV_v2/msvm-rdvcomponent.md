...
| [**EnableEndPoints**](enableendpoints-msvm-rdvcomponent.md) | Solicita que o dispositivo virtual Serviços de Área de Trabalho Remota inicie uma conexão de pipe com a máquina virtual. Se zero (0) for retornado, a operação foi bem-sucedida. Qualquer outro código de retorno indica uma condição de erro.<br/> |
