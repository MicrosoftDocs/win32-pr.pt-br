...
O número de blocos de memória disponíveis no momento para consumo por máquinas virtuais.
...
O número total de núcleos lógicos do processador neste nó.
...
O número total de núcleos de processador neste nó NUMA. Isso pode ser diferente do número de objetos do [**\_ processador Msvm**](msvm-processor.md) associados a esse nó se cada núcleo do processador der suporte a vários threads de computação.
