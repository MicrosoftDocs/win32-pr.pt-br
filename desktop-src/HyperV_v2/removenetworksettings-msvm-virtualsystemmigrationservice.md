...
---
# <a name="removenetworksettings-method-of-the-msvm_virtualsystemmigrationservice-class"></a>Método RemoveNetworkSettings da \_ classe VirtualSystemMigrationService Msvm

Remove as sub-redes da rede de migração do serviço de migração do sistema virtual.
