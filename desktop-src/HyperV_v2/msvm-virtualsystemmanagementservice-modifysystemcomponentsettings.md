...
---
# <a name="modifysystemcomponentsettings-method-of-the-msvm_virtualsystemmanagementservice-class"></a>Método ModifySystemComponentSettings da \_ classe VirtualSystemManagementService Msvm

Modifica as configurações genéricas do componente do sistema.
...
Uma matriz de configurações de componente para atualizar.
...
Em caso de sucesso, retorna uma matriz de [**Msvm \_ SystemComponentSettingData**](msvm-systemcomponentsettingdata.md) que referencia as configurações de componente resultantes.
