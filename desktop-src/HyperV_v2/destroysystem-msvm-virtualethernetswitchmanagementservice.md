...
---
# <a name="destroysystem-method-of-the-msvm_virtualethernetswitchmanagementservice-class"></a>Método DestroySystem da \_ classe VirtualEthernetSwitchManagementService Msvm

Destrói um comutador virtual.
...
Uma referência a uma instância da classe [**Msvm \_ VirtualEthernetSwitch**](msvm-virtualethernetswitch.md) que representa o comutador virtual que deve ser destruído.
