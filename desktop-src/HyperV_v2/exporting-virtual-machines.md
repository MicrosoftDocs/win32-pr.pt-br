---
description: Os exemplos de C# e Visual Basic Scripting Edition (VBScript) a seguir demonstram a exportação de um instantâneo de uma máquina virtual.
ms.assetid: 4DEC4962-99E1-42BB-81B1-8530BF9C4B92
title: Exportando um instantâneo de uma máquina virtual
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105756766"
---
# <a name="exporting-a-snapshot-of-a-virtual-machine"></a><span data-ttu-id="f4a81-103">Exportando um instantâneo de uma máquina virtual</span><span class="sxs-lookup"><span data-stu-id="f4a81-103">Exporting a snapshot of a virtual machine</span></span>

<span data-ttu-id="f4a81-104">Os exemplos de C# e Visual Basic Scripting Edition (VBScript) a seguir demonstram a exportação de um instantâneo de uma máquina virtual.</span><span class="sxs-lookup"><span data-stu-id="f4a81-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting a snapshot of a virtual machine.</span></span> <span data-ttu-id="f4a81-105">Exemplos que demonstram a exportação de uma máquina virtual podem ser encontrados no tópico [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) .</span><span class="sxs-lookup"><span data-stu-id="f4a81-105">Samples that demonstrate exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) topic.</span></span>

<span data-ttu-id="f4a81-106">Os utilitários C# referenciados podem ser encontrados em [utilitários comuns para os exemplos de virtualização (v2)](common-utilities-for-the-virtualization-samples-v2.md).</span><span class="sxs-lookup"><span data-stu-id="f4a81-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="f4a81-107">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="f4a81-107">Related topics</span></span>

[<span data-ttu-id="f4a81-108">Exportando a configuração de uma máquina virtual</span><span class="sxs-lookup"><span data-stu-id="f4a81-108">Exporting the configuration of a virtual machine</span></span>](exporting-the-configuration-of-a-virtual-machine.md)

[<span data-ttu-id="f4a81-109">**ExportSystemDefinition**</span><span class="sxs-lookup"><span data-stu-id="f4a81-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
