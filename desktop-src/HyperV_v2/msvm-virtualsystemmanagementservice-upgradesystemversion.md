...
Uma referência a um [**computador \_ CIM**](cim-computersystem.md) que representa o sistema de máquina virtual a ser atualizado.

</dd> <dt>

*UpgradeSettingData* \[ no\]
</dt> <dd>

Os dados de configuração de atualização.
