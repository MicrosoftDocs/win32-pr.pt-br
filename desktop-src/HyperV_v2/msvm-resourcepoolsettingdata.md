...
A classe **Msvm \_ ResourcePoolSettingData** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Msvm \_ ResourcePoolSettingData** tem essas propriedades.
...
Especifica a estratégia de alocação a ser usada pelo pool de recursos para balancear o uso de recursos em seus recursos agregados. Esta propriedade é herdada de [**Msvm \_ AbstractResourcePoolSettingData**](msvm-abstractresourcepoolsettingdata.md).
...
<span id="None"></span><span id="none"></span><span id="NONE"></span>**Nenhum** (3)
</dt> <dt>

<span id="Distributed"></span><span id="distributed"></span><span id="DISTRIBUTED"></span>**Distribuído** (4)
</dt> <dt>
...
Especifica se o pool de recursos pode tentar usar outros recursos de host para satisfazer a solicitação de alocação se os recursos desejados não puderem ser alocados. Esta propriedade é herdada de [**Msvm \_ AbstractResourcePoolSettingData**](msvm-abstractresourcepoolsettingdata.md).
...
<span id="Soft_Affinity"></span><span id="soft_affinity"></span><span id="SOFT_AFFINITY"></span>**Afinidade flexível** (4)
</dt> <dt>

<span id="Hard_Affinity"></span><span id="hard_affinity"></span><span id="HARD_AFFINITY"></span>**Afinidade rígida** (5)
</dt> <dt>

<span id="DMTF_Reserved"></span><span id="dmtf_reserved"></span><span id="DMTF_RESERVED"></span>**DMTF reservado** (..)
</dt> <dt>

<span id="Vendor_Reserved_"></span><span id="vendor_reserved_"></span><span id="VENDOR_RESERVED_"></span>**Fornecedor reservado** (32767.. 65535)
</dt> </dl>
...
Especifica a ordem na qual os recursos de host disponíveis por meio desse pool serão selecionados ao tentar atender a uma solicitação de alocação e o recurso de host solicitado não estiver disponível ou nenhum recurso de host for especificado. Esta propriedade é herdada de [**Msvm \_ AbstractResourcePoolSettingData**](msvm-abstractresourcepoolsettingdata.md).
...
Notas fornecidas pelo usuário final que estão relacionadas a esse pool de recursos. Esta propriedade é herdada de [**Msvm \_ AbstractResourcePoolSettingData**](msvm-abstractresourcepoolsettingdata.md).
...
Uma cadeia de caracteres que descreve o tipo de recurso quando um valor bem definido não está disponível e **ResourceType** é definido como 0 (outro). Esta propriedade é herdada de [**Msvm \_ AbstractResourcePoolSettingData**](msvm-abstractresourcepoolsettingdata.md).
...
Um identificador para o pool. Essa propriedade é usada para fornecer correlação entre salvar e restaurar dados de configuração para o armazenamento persistente subjacente. Esta propriedade é herdada de [**Msvm \_ AbstractResourcePoolSettingData**](msvm-abstractresourcepoolsettingdata.md).
...
Uma cadeia de caracteres que descreve um subtipo específico da implementação para este pool. Por exemplo, isso pode ser usado para distinguir modelos diferentes do mesmo tipo de recurso. Esta propriedade é herdada de [**Msvm \_ AbstractResourcePoolSettingData**](msvm-abstractresourcepoolsettingdata.md).
...
O tipo de recurso que esse pool de recursos pode alocar. Esta propriedade é herdada de [**Msvm \_ AbstractResourcePoolSettingData**](msvm-abstractresourcepoolsettingdata.md).
