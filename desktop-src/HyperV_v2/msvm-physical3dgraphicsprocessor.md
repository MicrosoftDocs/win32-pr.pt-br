---
description: Descreve a GPU (unidade de processamento de gráficos) 3D física.
...
Especifica o identificador de índice do adaptador alocado a este dispositivo.
...
**true** se compatível com virtualização; caso contrário, **false.**
...
Especifica a quantidade de memória do sistema, em bytes, dedicada à GPU.
...
Especifica a quantidade de memória de vídeo, em bytes, dedicada à GPU.
...
Especifica a classificação de RemoteFX GPU para este dispositivo. Essa propriedade não é usada no momento.
