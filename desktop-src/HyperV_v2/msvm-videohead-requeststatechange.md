---
description: Método RequestStateChange da classe Msvm_VideoHead - Solicita uma alteração de estado.
ms.assetid: c780c162-3352-4f13-a84a-26eb99f9d380
title: Método RequestStateChange da classe Msvm_VideoHead classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119340406"
---
# <a name="requeststatechange-method-of-the-msvm_videohead-class"></a>Método RequestStateChange da classe VideoHead Msvm \_
...
[**VideoHead do Msvm \_**](msvm-videohead.md)
</dt> </dl>
