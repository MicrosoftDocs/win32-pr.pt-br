---
description: A API de replicação do Hyper-V é usada para controlar a replicação da máquina virtual e a recuperação de failover.
ms.assetid: 2CCD9A38-EABA-45DB-82A5-0DDA7824B0F3
title: API de replicação do Hyper-V
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: c0dc2ef8239052ef556bff1370e90475b1154865
