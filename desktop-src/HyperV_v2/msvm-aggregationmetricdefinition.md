...
Representa os aspectos de definição de uma métrica que é derivada de outro valor de métrica. O objeto **Msvm \_ AggregationMetricDefinition** deve ser associado aos elementos gerenciados aos quais se aplica.
...
A classe **Msvm \_ AggregationMetricDefinition** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Msvm \_ AggregationMetricDefinition** tem essas propriedades.
...
Identifica o cálculo básico executado em uma métrica subjacente para chegar ao valor dessa métrica derivada. Essa propriedade é herdada de **CIM \_ AggregationMetricDefinition** e será um dos valores a seguir.
...
Identifica as unidades de um valor, por exemplo, "megabytes". Essa propriedade é herdada do **CIM \_ BaseMetricDefinition**.
