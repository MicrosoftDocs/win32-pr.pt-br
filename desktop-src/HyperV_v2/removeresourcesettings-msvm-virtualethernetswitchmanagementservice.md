...
---
# <a name="removeresourcesettings-method-of-the-msvm_virtualethernetswitchmanagementservice-class"></a>Método RemoveResourceSettings da \_ classe VirtualEthernetSwitchManagementService Msvm

Remove as configurações de recurso virtual de uma configuração de comutador virtual.
...
Uma matriz de referências a instâncias da classe [**CIM \_ ResourceAllocationSettingData**](/previous-versions/windows/desktop/clushyperv/cim-resourceallocationsettingdata) , em que cada instância representa as configurações de um recurso virtual dentro de uma configuração de comutador virtual que devem ser removidas.
