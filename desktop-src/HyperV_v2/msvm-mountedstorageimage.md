...
O número da porta do endereço SCSI.
...
O tipo de imagem de armazenamento montada.
...
O acesso à classe **Msvm \_ MountedStorageImage** pode ser restringido pela filtragem do UAC. Para obter mais informações, consulte [controle de conta de usuário e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
