...
Representa um dispositivo de mouse PS2. As instâncias dessa classe são dispositivos lógicos que estão sempre presentes em uma máquina virtual e, portanto, não são alocados por meio de um pool de recursos. Uma instância está sempre presente em uma máquina virtual.
...
A classe **Msvm \_ Ps2Mouse** tem estes tipos de membros:
...
A classe **Msvm \_ Ps2Mouse** tem esses métodos.



| Método                                                           | Descrição                                                                                           |
|:-----------------------------------------------------------------|:------------------------------------------------------------------------------------------------------|
| [**ClickButton**](clickbutton-msvm-ps2mouse.md)                 | Simula um clique de botão, uma sequência para baixo, no botão de dispositivo especificado.<br/>              |
| **EnableDevice**                                                 | Não há suporte para o método.<br/>                                                              |
| [**Getbuttonstate**](getbuttonstate-msvm-ps2mouse.md)           | Recupera o estado atual do botão de dispositivo especificado.<br/>                                |
...
| [**SetRelativePosition**](setrelativeposition-msvm-ps2mouse.md) | Desloca a posição do ponteiro do mouse pelos deltas horizontais e verticais especificados.<br/> |
| [**SetScrollPosition**](setscrollposition-msvm-ps2mouse.md)     | Ajusta a coordenada z do controle de roda do dispositivo apontador.<br/>                      |
...
A classe **Msvm \_ Ps2Mouse** tem essas propriedades.
...
Indica se o dispositivo opera em coordenadas absolutas. Se não estiver definido, as coordenadas do dispositivo serão relativas.
...
O estado habilitado ou desabilitado do elemento quando a propriedade [**enabledstate**](msvm-keyboard.md) é definida como 1 (outro). Essa propriedade deve ser definida como **NULL** quando **enabledstate** for qualquer valor diferente de 1. Essa propriedade é herdada do [**CIM \_ EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85)).
...
O tipo do dispositivo apontador. Essa propriedade é herdada do [**CIM \_ PointingDevice**](/windows/desktop/CIMWin32Prov/cim-pointingdevice).
