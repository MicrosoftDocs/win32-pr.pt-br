...
---
# <a name="typectrlaltdel-method-of-the-msvm_keyboard-class"></a>Método TypeCtrlAltDel da classe de \_ teclado Msvm

Simula uma sequência de teclas Ctrl + Alt + Del.
...
Um valor de retorno igual A zero indica êxito. Um valor diferente de zero indica uma falha ao enviar.
