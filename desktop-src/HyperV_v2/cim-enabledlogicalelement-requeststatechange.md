...
---
# <a name="requeststatechange-method-of-the-cim_enabledlogicalelement-class"></a>Método RequestStateChange da \_ classe EnabledLogicalElement do CIM

Solicita que o estado do elemento seja alterado para o valor especificado no parâmetro Requestedstate. Quando a alteração de estado solicitada ocorre, o Enabledstate e o Requestedstate solicitado do elemento serão os mesmos. Invocar o método RequestStateChange várias vezes pode fazer com que as solicitações anteriores fossem substituídas ou perdidas.
