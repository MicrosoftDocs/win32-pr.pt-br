...
---
# <a name="modifyfeaturesettings-method-of-the-msvm_virtualethernetswitchmanagementservice-class"></a>Método ModifyFeatureSettings da \_ classe VirtualEthernetSwitchManagementService Msvm

Modifica as configurações de recurso de uma porta de comutador Ethernet.
...
Uma matriz de cadeias de caracteres que contém uma instância incorporada de uma classe derivada da classe [**Msvm \_ FeatureSettingData**](msvm-featuresettingdata.md) , que descreve as configurações de recurso de porta do comutador a ser modificada.
...
Uma matriz de referências a instâncias da classe [**Msvm \_ FeatureSettingData**](msvm-featuresettingdata.md) que representa as configurações de recurso modificadas.
