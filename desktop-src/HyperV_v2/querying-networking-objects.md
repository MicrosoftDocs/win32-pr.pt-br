---
description: O exemplo de C# a seguir recupera e exibe informações de rede física e virtual para o comutador especificado.
ms.assetid: 679168E2-C79F-4A7A-8C04-A309315CA670
title: Consultando objetos de rede
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105770397"
---
# <a name="querying-networking-objects"></a><span data-ttu-id="ebeea-103">Consultando objetos de rede</span><span class="sxs-lookup"><span data-stu-id="ebeea-103">Querying networking objects</span></span>

<span data-ttu-id="ebeea-104">O exemplo de C# a seguir recupera e exibe informações de rede física e virtual para o comutador especificado.</span><span class="sxs-lookup"><span data-stu-id="ebeea-104">The following C# sample retrieves and displays physical and virtual network information for the specified switch.</span></span> <span data-ttu-id="ebeea-105">Esse código é obtido do [exemplo de rede do Hyper-V](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span><span class="sxs-lookup"><span data-stu-id="ebeea-105">This code is taken from the [Hyper-V networking sample](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span></span>

<span data-ttu-id="ebeea-106">A sintaxe de linha de comando para executar este exemplo é:</span><span class="sxs-lookup"><span data-stu-id="ebeea-106">The command-line syntax to run this sample is:</span></span>

<span data-ttu-id="ebeea-107">**EnumerateSwitch** *SwitchName* NetworkingSamples.exe</span><span class="sxs-lookup"><span data-stu-id="ebeea-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span></span>

<span data-ttu-id="ebeea-108">em que *SwitchName* é o nome do comutador para o qual exibir as informações.</span><span class="sxs-lookup"><span data-stu-id="ebeea-108">where *SwitchName* is the name of the switch to display the information for.</span></span> <span data-ttu-id="ebeea-109">O nome do comutador está contido na propriedade [**Msvm \_ VirtualEthernetSwitch. ElementName**](msvm-virtualethernetswitch.md) .</span><span class="sxs-lookup"><span data-stu-id="ebeea-109">The switch name is contained in the [**Msvm\_VirtualEthernetSwitch.ElementName**](msvm-virtualethernetswitch.md) property.</span></span>
