...
---
# <a name="querying-networking-objects"></a>Consultando objetos de rede

O exemplo de C# a seguir recupera e exibe informações de rede física e virtual para o comutador especificado. Esse código é obtido do [exemplo de rede do Hyper-V](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).

A sintaxe de linha de comando para executar este exemplo é:

**EnumerateSwitch** *SwitchName* NetworkingSamples.exe

em que *SwitchName* é o nome do comutador para o qual exibir as informações. O nome do comutador está contido na propriedade [**Msvm \_ VirtualEthernetSwitch. ElementName**](msvm-virtualethernetswitch.md) .
