...
A classe **Msvm \_ EthernetSwitchBandwidthData** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Msvm \_ EthernetSwitchBandwidthData** tem essas propriedades.
...
A largura de banda máxima disponível no comutador.
...
O nome da classe ou subclasse usada na criação dessa instância.
...
A largura de banda absoluta atual reservada no comutador para o fluxo padrão.
...
A porcentagem atual da largura de banda reservada na opção para o fluxo padrão.
...
O peso atual para o fluxo padrão no comutador.
...
A largura de banda atual reservada no comutador.
...
O nome da classe de criação do sistema de hospedagem. Essa propriedade é herdada [**do \_ serviço CIM**](/windows/desktop/CIMWin32Prov/cim-service).
...
O nome do comutador virtual ao qual a instância de recurso associada está associada.
