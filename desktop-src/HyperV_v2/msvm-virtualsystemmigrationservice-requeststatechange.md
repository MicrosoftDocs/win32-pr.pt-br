---
description: Método RequestStateChange da classe Msvm_VirtualSystemMigrationService - Solicita uma alteração de estado.
ms.assetid: 8355f2d8-d6d1-4bfa-b404-91376c2e2bdd
title: Método RequestStateChange da classe Msvm_VirtualSystemMigrationService classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
