...
Agrega os recursos do processador que podem ser alocados a uma máquina virtual.
...
A classe **Msvm \_ ProcessorPool** tem estes tipos de membros:
...
A classe **Msvm \_ ProcessorPool** tem esses métodos.



| Método                                                                          | Descrição                                           |
|:--------------------------------------------------------------------------------|:------------------------------------------------------|
| [**CalculatePossibleReserve**](calculatepossiblereserve-msvm-processorpool.md) | Usado para encontrar a reserva de processador real.<br/> |
...
A classe **Msvm \_ ProcessorPool** tem essas propriedades.
...
Uma cadeia de caracteres que descreve o tipo de recurso quando um valor bem definido não está disponível e **ResourceType** é definido como 0 ("other"). Essa propriedade é herdada do [**CIM \_ ResourcePool**](/previous-versions//cc136903(v=vs.85))e é definida como **NULL**.
...
O acesso à classe **Msvm \_ ProcessorPool** pode ser restringido pela filtragem do UAC. Para obter mais informações, consulte [controle de conta de usuário e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
