...
Representa uma associação na qual um objeto [**CIM \_ BaseMetricDefinition**](cim-basemetricdefinition.md) define métricas para um elemento gerenciado.
...
A classe **CIM \_ MetricDefForME** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **CIM \_ MetricDefForME** tem essas propriedades.
...
O elemento gerenciado que está associado à definição de métrica.
...
A definição de métrica que está associada ao elemento gerenciado.
