...
---
# <a name="migratevirtualsystemtohost-method-of-the-cim_virtualsystemmigrationservice-class"></a>Método MigrateVirtualSystemToHost da \_ classe VIRTUALSYSTEMMIGRATIONSERVICE CIM

Método para mover, migrar ou realocar um sistema virtual para um host de destino especificado por um nome de rede ou endereço IP.

> [!Note]  
> Esse método destina-se a ser uma solução de transição somente até que a modelagem de suporte a cluster esteja disponível.
...
| <dl> <dt>**Parâmetro inválido**</dt> <dt>4</dt> </dl>                          | Um ou mais parâmetros são formalmente inválidos. Por exemplo, o valor do parâmetro *DestinationHost* poderia ter sido especificado em um formato sem suporte.<br/>                                                                                                                                    |
