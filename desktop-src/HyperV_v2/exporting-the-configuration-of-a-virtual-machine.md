...
---
# <a name="exporting-the-configuration-of-a-virtual-machine"></a>Exportando a configuração de uma máquina virtual

Os exemplos de C# e Visual Basic Scripting Edition (VBScript) a seguir demonstram como exportar a configuração de uma máquina virtual. Exemplos que mostram a exportação de uma máquina virtual podem ser encontrados no [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) e na [exportação de um instantâneo de tópicos de uma máquina virtual](exporting-virtual-machines.md) .

Os utilitários C# referenciados podem ser encontrados em [utilitários comuns para os exemplos de virtualização (v2)](common-utilities-for-the-virtualization-samples-v2.md).
...
[Exportando um instantâneo de uma máquina virtual](exporting-virtual-machines.md)
