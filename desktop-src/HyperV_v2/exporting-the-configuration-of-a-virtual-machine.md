---
description: Os exemplos de C# e Visual Basic Scripting Edition (VBScript) a seguir demonstram como exportar a configuração de uma máquina virtual.
ms.assetid: 0B503B85-7EC0-409A-B610-E1C7FFBF3192
title: Exportando a configuração de uma máquina virtual
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105759880"
---
# <a name="exporting-the-configuration-of-a-virtual-machine"></a><span data-ttu-id="7b732-103">Exportando a configuração de uma máquina virtual</span><span class="sxs-lookup"><span data-stu-id="7b732-103">Exporting the configuration of a virtual machine</span></span>

<span data-ttu-id="7b732-104">Os exemplos de C# e Visual Basic Scripting Edition (VBScript) a seguir demonstram como exportar a configuração de uma máquina virtual.</span><span class="sxs-lookup"><span data-stu-id="7b732-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting the configuration of a virtual machine.</span></span> <span data-ttu-id="7b732-105">Exemplos que mostram a exportação de uma máquina virtual podem ser encontrados no [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) e na [exportação de um instantâneo de tópicos de uma máquina virtual](exporting-virtual-machines.md) .</span><span class="sxs-lookup"><span data-stu-id="7b732-105">Samples that show exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) and [Exporting a snapshot of a virtual machine](exporting-virtual-machines.md) topics.</span></span>

<span data-ttu-id="7b732-106">Os utilitários C# referenciados podem ser encontrados em [utilitários comuns para os exemplos de virtualização (v2)](common-utilities-for-the-virtualization-samples-v2.md).</span><span class="sxs-lookup"><span data-stu-id="7b732-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="7b732-107">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="7b732-107">Related topics</span></span>

[<span data-ttu-id="7b732-108">Exportando um instantâneo de uma máquina virtual</span><span class="sxs-lookup"><span data-stu-id="7b732-108">Exporting a snapshot of a virtual machine</span></span>](exporting-virtual-machines.md)

[<span data-ttu-id="7b732-109">**ExportSystemDefinition**</span><span class="sxs-lookup"><span data-stu-id="7b732-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
