...
ms.locfileid: "117810892"
---
# <a name="msvm_s3displaycontroller-class"></a>Classe Msvm \_ S3DisplayController

Representa o estado do controlador S3 emulado que está presente em cada configuração de máquina virtual. Somente um controlador de exibição pode estar ativo em uma máquina virtual a qualquer momento.

> [!Note]  
> Essa classe só se aplica a máquinas virtuais de geração 1.
...
A **classe Msvm \_ S3DisplayController** tem estes tipos de membros:
...
A **classe Msvm \_ S3DisplayController** tem esses métodos.
...
| [**RequestStateChange**](msvm-s3displaycontroller-requeststatechange.md) | Solicita uma alteração de estado. <br/>     |
| [**Redefinir**](msvm-s3displaycontroller-reset.md)                           | Redefine o dispositivo virtual.<br/>    |
...
A **classe Msvm \_ S3DisplayController** tem essas propriedades.
...
Os elementos gráficos e as funcionalidades 3D do controlador de exibição. Essa propriedade é herdada de [**\_ DisplayController cim.**](/previous-versions//cc136810(v=vs.85))
...
Uma matriz de cadeias de caracteres de forma livre que fornecem explicações mais detalhadas para qualquer um dos recursos do acelerador de vídeo indicados na matriz **AcceleratorCapabilities.** Cada entrada dessa matriz está relacionada à entrada na matriz **AcceleratorCapabilities** localizada no mesmo índice. Essa propriedade é herdada de [**\_ DisplayController cim.**](/previous-versions//cc136810(v=vs.85))
...
O nome da classe ou subclasse usada na criação de uma instância. Essa propriedade é herdada [**de CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)e é sempre definida como "Msvm \_ S3DisplayController".
...
A quantidade máxima de memória com suporte, em bytes. Essa propriedade é herdada de [**\_ DisplayController cim.**](/previous-versions//cc136810(v=vs.85))
...
O número de páginas de vídeo com suporte considerando as resoluções atuais e a memória disponível. Essa propriedade é herdada de [**\_ DisplayController cim**](/previous-versions//cc136810(v=vs.85)).
...
O tipo de memória de vídeo quando a propriedade **VideoMemoryType** da instância é 1 (Outro). Essa propriedade é herdada de [**\_ DisplayController cim**](/previous-versions//cc136810(v=vs.85)).
...
O tipo de memória de vídeo. Essa propriedade é herdada do [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85)).
...
Uma cadeia de caracteres que descreve o controlador/processador de vídeo. Essa propriedade é herdada do [**CIM \_ DisplayController**](/previous-versions//cc136810(v=vs.85)).

</dd> </dl>

## <a name="remarks"></a>Comentários

O acesso à classe **Msvm \_ S3DisplayController** pode ser restringido pela filtragem do UAC. Para obter mais informações, consulte [controle de conta de usuário e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
