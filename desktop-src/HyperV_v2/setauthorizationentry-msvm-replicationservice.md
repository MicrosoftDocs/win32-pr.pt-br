...
---
# <a name="setauthorizationentry-method-of-the-msvm_replicationservice-class"></a>Método SetAuthorizationEntry da \_ classe ReplicationService Msvm
...
Uma referência a uma instância de [**\_ sistema**](/windows/desktop/CIMWin32Prov/cim-computersystem) de computador CIM que representa a máquina virtual para a qual definir a entrada de autorização.
