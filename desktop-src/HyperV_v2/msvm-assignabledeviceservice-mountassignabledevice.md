...
ms.locfileid: "119790306"
---
# <a name="mountassignabledevice-method-of-the-msvm_assignabledeviceservice-class"></a>Método MountAssignableDevice da \_ classe AssignableDeviceService Msvm

Monta o dispositivo PCI especificado para que ele possa ser usado pelo sistema de computador host.
...
*DeviceInstancePath* \[ no\]
</dt> <dd>

Cadeia de caracteres que contém o caminho da instância do dispositivo para um dispositivo.

</dd> <dt>

*DeviceLocationPath* \[ no\]
</dt> <dd>

Cadeia de caracteres que contém o caminho do local do dispositivo para um dispositivo.

</dd> <dt>

*MountedDeviceInstancePath* \[ fora\]
</dt> <dd>

Cadeia de caracteres que contém o caminho da instância do dispositivo para o dispositivo montado.
