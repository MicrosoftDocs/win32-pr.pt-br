...
ms.locfileid: "119682026"
---
# <a name="removememberbyid-method-of-the-msvm_collectionmanagementservice-class"></a>Método RemoveMemberById da \_ classe CollectionManagementService Msvm

Remove o elemento gerenciado especificado como um membro do [**CIM \_ CollectionOfMSEs**](cim-collectionofmses.md) com o identificador fornecido. Isso terá sucesso mesmo se o objeto com esse identificador não estiver presente.
...
A ID da coleção da coleção da qual remover o membro.
