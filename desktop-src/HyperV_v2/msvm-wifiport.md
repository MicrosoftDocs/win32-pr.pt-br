...
Representa um adaptador de rede Wi-Fi (802,11) físico que pode ser associado a um comutador virtual para fornecer conectividade de rede externa a máquinas virtuais.
...
A classe **Msvm \_ WiFiPort** tem estes tipos de membros:
...
A classe **Msvm \_ WiFiPort** tem esses métodos.
...
A classe **Msvm \_ WiFiPort** tem essas propriedades.
...
Indica se o erro relatado em **LastErrorCode** agora está limpo. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
...
Uma cadeia de caracteres que fornece mais informações sobre o erro registrado em **LastErrorCode** e informações sobre as ações corretivas que podem ser executadas. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
...
Uma matriz de cadeias de caracteres de forma livre que fornece explicações e detalhes por trás das entradas na matriz de propriedades **OtherIdentifyingInfo** . Essa propriedade é herdada [**de \_ LogicalDevice CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
...
Especifica se a porta Wi-Fi está associada à arquitetura de rede da máquina virtual. Esse será um dos valores a seguir.



| Valor                                                                                                                                                        | Significado                                                                                 |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| <span id="True"></span><span id="true"></span><span id="TRUE"></span><dl> <dt>**True**</dt> </dl>     | A porta Wi-Fi está associada à arquitetura de rede da máquina virtual. <br/>     |
| <span id="False"></span><span id="false"></span><span id="FALSE"></span><dl> <dt>**For**</dt> </dl> | A porta Wi-Fi não está associada à arquitetura de rede da máquina virtual. <br/> |
...
O último código de erro relatado pelo dispositivo lógico. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
...
Os recursos de gerenciamento de energia do dispositivo. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
...
Indica se o dispositivo pode ser gerenciado por energia. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
...
O número de horas consecutivas em que este dispositivo foi ligado desde seu último ciclo de energia. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
...
O estado atual do dispositivo lógico. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
...
O número total de horas em que este dispositivo foi ligado. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
