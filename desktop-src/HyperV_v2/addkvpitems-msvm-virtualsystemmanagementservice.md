...
---
# <a name="addkvpitems-method-of-the-msvm_virtualsystemmanagementservice-class"></a>Método AddKvpItems da \_ classe VirtualSystemManagementService Msvm

Adiciona pares de chave-valor a uma máquina virtual.
...
Uma referência a um objeto de [**\_ sistema**](/windows/desktop/CIMWin32Prov/cim-computersystem) de computador CIM que representa a máquina virtual na qual os pares de chave-valor serão adicionados.
...
Uma matriz de pares chave-valor a ser adicionada. Cada elemento da matriz é uma instância incorporada da classe [**Msvm \_ KvpExchangeDataItem**](msvm-kvpexchangedataitem.md) . Esse método falhará se qualquer um dos pares chave-valor especificados já existir no sistema de destino. Essa matriz pode conter no máximo 128 elementos.
...
O exemplo de C# a seguir adiciona pares de chave-valor a uma máquina virtual. Os utilitários referenciados podem ser encontrados em [utilitários comuns para os exemplos de virtualização (v2)](common-utilities-for-the-virtualization-samples-v2.md).
...
O exemplo de Visual Basic Scripting Edition (VBScript) a seguir adiciona pares de chave-valor a uma máquina virtual.
