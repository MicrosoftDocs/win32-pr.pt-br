---
description: Os utilitários a seguir são usados por alguns dos exemplos de virtualização do C#.
ms.assetid: EB0F305D-806D-4ACB-8024-3A6FB125629D
title: Utilitários comuns para exemplos de virtualização (v2)
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a><span data-ttu-id="00072-103">Utilitários comuns para exemplos de virtualização (v2)</span><span class="sxs-lookup"><span data-stu-id="00072-103">Common utilities for the virtualization samples (V2)</span></span>

<span data-ttu-id="00072-104">Os utilitários a seguir são usados por alguns dos exemplos de virtualização do C#.</span><span class="sxs-lookup"><span data-stu-id="00072-104">The following utilities are used by some of the C# virtualization samples.</span></span>
