...
Representa uma porta de Fibre Channel externa.
...
Se essa propriedade for **true**, essa Fibre Channel porta poderá ser conectada aos comutadores e, portanto, poderá fornecer conectividade a uma máquina virtual. Se essa propriedade for **false**, essa porta não poderá ser usada pela arquitetura de Fibre Channel da máquina virtual.
...
O WWN (World Wide Name) de nó para esta Fibre Channel porta.
...
O WWN (World Wide Name) de porta para esta porta de Fibre Channel.
