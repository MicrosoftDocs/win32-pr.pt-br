...
| [**Redefinir**](msvm-serialcontroller-reset.md)                           | Redefine o dispositivo.<br/>            |
...
A última vez em que o controlador estava ligado. Essa propriedade é herdada [**do \_ controlador CIM**](/windows/desktop/CIMWin32Prov/cim-controller).
...
O acesso à classe **Msvm \_ SerialController** pode ser restringido pela filtragem do UAC. Para obter mais informações, consulte [controle de conta de usuário e WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
