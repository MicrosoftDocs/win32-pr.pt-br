...
Identifica uma instância de [**CIM \_ managedelement**](cim-managedelement.md) para a qual o método retorna referências a instâncias [**de \_ BaseMetricDefinition CIM**](cim-basemetricdefinition.md) que definem as métricas que estão sendo capturadas para o **CIM \_ managedelement**.
...
Em caso de sucesso, pode conter referências a objetos [**\_ gerenciados CIM**](cim-managedelement.md) para os quais a métrica identificada pelo parâmetro de *definição* está disponível para coleta.
...
Indica se uma métrica está sendo coletada para um elemento gerenciado.
