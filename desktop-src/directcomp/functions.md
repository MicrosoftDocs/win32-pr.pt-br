...
ms.locfileid: "119043334"
---
# <a name="directcomposition-functions"></a>Funções DirectComposition

Esta seção descreve as funções fornecidas pela API do Microsoft DirectComposition.
