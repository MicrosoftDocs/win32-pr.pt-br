---
title: WM_MBUTTONDBLCLK mensagem (Winuser.h)
...
keywords:
- WM_MBUTTONDBLCLK entrada do mouse e teclado da mensagem
topic_type:
- apiref
api_name:
- WM_MBUTTONDBLCLK
...
ms.locfileid: "119451676"
---
# <a name="wm_mbuttondblclk-message"></a>Mensagem WM \_ MBUTTONDBLCLK
...
Somente as janelas que têm o estilo **\_ DBLCLKS** do CS podem receber mensagens **WM \_ MBUTTONDBLCLK,** que o sistema gera quando o usuário pressiona, libera e pressiona novamente o botão do mouse do meio dentro do limite de tempo de clique duplo do sistema. Clicar duas vezes no botão do meio do mouse gera quatro mensagens: [**WM \_ MBUTTONDOWN,**](wm-mbuttondown.md) [**WM \_ MBUTTONUP,**](wm-mbuttonup.md) **WM \_ MBUTTONDBLCLK** e **WM \_ MBUTTONUP** novamente.
