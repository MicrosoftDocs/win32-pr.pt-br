...
description: a estrutura da faixa de Windows de informações usa a infraestrutura de ETW (rastreamento de eventos para Windows) para permitir que os desenvolvedores aprendam como os usuários estão interagindo com a faixa de forma do aplicativo.
ms.assetid: F29A8E41-C902-410E-BD28-653E078320E9
keywords:
- Windows Faixa de, eventos
- Faixa de, eventos
ms.topic: article
ms.date: 05/31/2018
...
a estrutura da faixa de Windows de informações usa a infraestrutura de [ETW (rastreamento de eventos para Windows)](../etw/event-tracing-portal.md) para permitir que os desenvolvedores aprendam como os usuários estão interagindo com a faixa de forma do aplicativo.
...
1.  o aplicativo da faixa de faixas deve registrar um ouvinte [de rastreamento de eventos para Windows (ETW)](../etw/event-tracing-portal.md) para receber notificações de eventos da faixa de faixa.
2.  a estrutura da faixa de chamadas dispara retornos de chamada de evento da interface do usuário em tempo de execução, se o aplicativo tiver registrado um ouvinte [de ETW (rastreamento de eventos para Windows)](../etw/event-tracing-portal.md) .
...
[Windows Guias de desenvolvedor da estrutura da faixa de Ribbon](windowsribbon-guides-entry.md)
</dt> <dt>
