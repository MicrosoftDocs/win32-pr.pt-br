...
keywords:
- Elemento SplitButton Windows Faixa de Opções
topic_type:
- apiref
api_name:
- SplitButton
...
**SplitButton dá** [suporte a modos de](ribbon-applicationmodes.md) aplicativo quando ele é hospedado na coluna esquerda do Menu do Aplicativo.
...
[**SplitButton.MenuGroups**](windowsribbon-element-splitbutton-menugroups.md) deverá ocorrer uma vez se o seguinte não estiver presente como elementos filho de **SplitButton:**
...
Esta seção de código mostra as declarações de Comando [](windowsribbon-element-group.md) **SplitButton,** com um Grupo associado que funciona como o contêiner pai para o **elemento SplitButton.**
