...
> [!Note]  
> Windows 8 e mais recente: imagem do botão de [menu do aplicativo](windowsribbon-controls-applicationmenu.md) alterada para rótulo: **arquivo**. Recomendamos que você não use o arquivo como rótulo para qualquer uma das suas próprias guias.
