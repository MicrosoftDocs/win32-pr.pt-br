...
- Windows SDK (Software Development Kit) (caminho de instalação padrão): %ProgramFiles% SDKs da Microsoft Windows número de versão \\ \\ \\ \[ \] \\ Exemplos \\ winui \\ WindowsRibbon \\ SimpleRibbon
