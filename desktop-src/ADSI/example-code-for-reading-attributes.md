...
---
# <a name="example-code-for-reading-attributes"></a><span data-ttu-id="8497c-104">Exemplo de código para ler atributos</span><span class="sxs-lookup"><span data-stu-id="8497c-104">Example Code for Reading Attributes</span></span>

<span data-ttu-id="8497c-105">O exemplo de código a seguir enumera as propriedades do usuário especificado no domínio atual, pesquisando o usuário e, em seguida, usando [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist) para enumerar suas propriedades.</span><span class="sxs-lookup"><span data-stu-id="8497c-105">The following code example enumerates the properties of the specified user in the current domain, by searching for the user and then using [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist) to enumerate its properties.</span></span> <span data-ttu-id="8497c-106">Lembre-se de que os valores de data e hora, como inteiros grandes, são manipulados e como as cadeias de caracteres de octeto para **objectSid** e **objectGUID** são manipuladas.</span><span class="sxs-lookup"><span data-stu-id="8497c-106">Be aware that time and date values, as large integers, are handled and how octet strings for **objectSID** and **objectGUID** are handled.</span></span>
...
<span data-ttu-id="8497c-107">O exemplo de código a seguir Visual Basic mostra como obter as propriedades de um objeto de usuário.</span><span class="sxs-lookup"><span data-stu-id="8497c-107">The following Visual Basic code example shows how to get the properties of a user object.</span></span> <span data-ttu-id="8497c-108">Para usar este exemplo de código, crie uma referência à biblioteca de tipos active DS e à biblioteca do Microsoft ActiveX Data Objects em seu projeto Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="8497c-108">To use this code example, create a reference to the Active DS Type Library and the Microsoft ActiveX Data Objects Library in your Visual Basic project.</span></span>
