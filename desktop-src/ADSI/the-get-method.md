...
keywords:
- Obter ADSI , usando IADs Get
- ADSI ADSI usando o método GET de IADs
ms.topic: article
ms.date: 05/31/2018
...
Em linguagens de Automação, atributos nomeados também podem ser acessados diretamente usando a notação de ponto. Por exemplo, **objeto . Get("distinguishedName") é** idêntico a **object.distinguishedName.**
