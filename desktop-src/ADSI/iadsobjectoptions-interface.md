...
A interface [**IADsObjectOptions**](/windows/desktop/api/Iads/nn-iads-iadsobjectoptions) permite acesso direto para definir e recuperar opções específicas do provedor.

Uma das opções de objeto de Active Directory é retornar o nome de host de um servidor. O exemplo de código a seguir usa a interface para recuperar o nome do host do servidor de catálogo global.
