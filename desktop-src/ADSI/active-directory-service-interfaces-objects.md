...
| **IDirectoryObject** | Usado para acesso direto ao objeto. A interface [**IDirectoryObject**](/windows/desktop/api/Iads/nn-iads-idirectoryobject) fornece acesso de objeto de baixo nível para clientes que não usam Automação. Essa interface ignora o cache de propriedade do objeto e fornece acesso direto às propriedades do objeto. Para obter mais informações, [consulte As interfaces IADs e IDirectoryObject](the-iads-and-idirectoryobject-interfaces.md). |
