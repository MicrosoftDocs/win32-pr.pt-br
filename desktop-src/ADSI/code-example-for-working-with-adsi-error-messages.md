---
title: Exemplo de código para trabalhar com mensagens de erro ADSI
description: O exemplo de código a seguir mostra como recuperar uma mensagem de erro ADSI.
ms.assetid: c09fea2e-b6c1-4318-a7a6-b1c4c30ef4cb
ms.tgt_platform: multiple
keywords:
- mensagens de erro e código de exemplo para ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103822228"
---
# <a name="code-example-for-working-with-adsi-error-messages"></a><span data-ttu-id="eb210-104">Exemplo de código para trabalhar com mensagens de erro ADSI</span><span class="sxs-lookup"><span data-stu-id="eb210-104">Code Example for Working with ADSI Error Messages</span></span>

<span data-ttu-id="eb210-105">O exemplo de código a seguir mostra como recuperar uma mensagem de erro ADSI.</span><span class="sxs-lookup"><span data-stu-id="eb210-105">The following code example shows how to retrieve an ADSI error message.</span></span>
