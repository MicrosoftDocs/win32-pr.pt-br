...
---
# <a name="object-sid-winnt-provider"></a>SID de objeto (provedor de WinNT)

O SID (identificador de segurança do usuário) pode ser recuperado usando o atributo **objectSid** . O **objectSid** é retornado como uma matriz **variante** de caracteres que formam a cadeia de caracteres Sid.
