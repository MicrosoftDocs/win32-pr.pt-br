...
O método Property da interface [**IADsHold**](/windows/desktop/api/Iads/nn-iads-iadshold) define a propriedade descrita na tabela a seguir. Para obter mais informações, consulte [interface Property Methods](interface-property-methods.md).
...
A quantidade de encargos arrecadados em relação ao usuário para o período em espera enquanto o servidor verifica o saldo da conta do usuário.
...
| IID<br/>                      | IID \_ IADsHold é definido como B3EB3B37-4080-11D1-A3AC-00C04FB950DC<br/>             |
