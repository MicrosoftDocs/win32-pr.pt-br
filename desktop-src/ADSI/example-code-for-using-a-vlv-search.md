...
## <a name="getvlvitemtext-example-function"></a>Função de exemplo GetVLVItemText

O exemplo de código a seguir mostra como usar uma pesquisa VLV para obter o texto de um único item com base em um índice.
