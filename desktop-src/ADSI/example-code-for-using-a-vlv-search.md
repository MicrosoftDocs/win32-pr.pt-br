...
---
# <a name="example-code-for-using-a-vlv-search"></a><span data-ttu-id="3f63d-104">Código de exemplo para usar uma pesquisa VLV</span><span class="sxs-lookup"><span data-stu-id="3f63d-104">Example Code for Using a VLV Search</span></span>

<span data-ttu-id="3f63d-105">Os exemplos de código a seguir usam pesquisas de VLV para obter resultados da pesquisa.</span><span class="sxs-lookup"><span data-stu-id="3f63d-105">The following code examples use VLV searches to obtain search results.</span></span>

-   <span data-ttu-id="3f63d-106">**GetVLVItemCount**</span><span class="sxs-lookup"><span data-stu-id="3f63d-106">**GetVLVItemCount**</span></span>
-   <span data-ttu-id="3f63d-107">**GetVLVItemText**</span><span class="sxs-lookup"><span data-stu-id="3f63d-107">**GetVLVItemText**</span></span>
-   <span data-ttu-id="3f63d-108">**GetVLVItemsByString**</span><span class="sxs-lookup"><span data-stu-id="3f63d-108">**GetVLVItemsByString**</span></span>

## <a name="utility-functions"></a><span data-ttu-id="3f63d-109">Funções de utilitário</span><span class="sxs-lookup"><span data-stu-id="3f63d-109">Utility Functions</span></span>

<span data-ttu-id="3f63d-110">Os exemplos de código a seguir são usados pelas funções de exemplo neste tópico.</span><span class="sxs-lookup"><span data-stu-id="3f63d-110">The following code examples are used by the example functions in this topic.</span></span>
...
## <a name="getvlvitemcount-example-function"></a><span data-ttu-id="3f63d-111">Função de exemplo GetVLVItemCount</span><span class="sxs-lookup"><span data-stu-id="3f63d-111">GetVLVItemCount Example Function</span></span>

<span data-ttu-id="3f63d-112">O exemplo de código a seguir mostra como usar uma pesquisa VLV para obter uma estimativa do número de itens que resultaria da pesquisa.</span><span class="sxs-lookup"><span data-stu-id="3f63d-112">The following code example shows how to use a VLV search to obtain an estimate of the number of items that would result from the search.</span></span>
...
## <a name="getvlvitemtext-example-function"></a><span data-ttu-id="3f63d-113">Função de exemplo GetVLVItemText</span><span class="sxs-lookup"><span data-stu-id="3f63d-113">GetVLVItemText Example Function</span></span>

<span data-ttu-id="3f63d-114">O exemplo de código a seguir mostra como usar uma pesquisa VLV para obter o texto de um único item com base em um índice.</span><span class="sxs-lookup"><span data-stu-id="3f63d-114">The following code example shows how to use a VLV search to obtain the text for a single item based on an index.</span></span>
...
## <a name="getvlvitemsbystring-example-function"></a><span data-ttu-id="3f63d-115">Função de exemplo GetVLVItemsByString</span><span class="sxs-lookup"><span data-stu-id="3f63d-115">GetVLVItemsByString Example Function</span></span>

<span data-ttu-id="3f63d-116">O exemplo de código a seguir mostra como usar uma pesquisa VLV para obter o texto de um número especificado de itens com base em uma cadeia de caracteres.</span><span class="sxs-lookup"><span data-stu-id="3f63d-116">The following code example shows how to use a VLV search to obtain the text for a specified number of items based on a string.</span></span> <span data-ttu-id="3f63d-117">Este exemplo adicionará as classificações recuperadas a uma caixa de listagem.</span><span class="sxs-lookup"><span data-stu-id="3f63d-117">This example will add the sortings retrieved to a list box.</span></span>
