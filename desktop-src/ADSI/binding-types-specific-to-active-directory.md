---
title: Tipos de associação específicos para Active Directory
description: Além das associações LDAP discutidas anteriormente, Active Directory apresenta vários novos conceitos para associação a um objeto.
