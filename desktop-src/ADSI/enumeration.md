...
[Acessar e manipular dados com ADSI](accessing-and-manipulating-data-with-adsi.md) fornece vários exemplos de enumeração. Você também pode enumerar os filhos de objetos de contêiner. Esses filhos são objetos em si, em vez de apenas propriedades em objetos.

O exemplo a seguir usa a interface [**IADsContainer**](/windows/desktop/api/Iads/nn-iads-iadscontainer) para enumerar os filhos do contêiner.
