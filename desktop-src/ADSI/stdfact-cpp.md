---
title: STDFACT. CPP
description: No componente de provedor de exemplo, um exemplo de código que mostra a implementação de IClassFactory padrão está em Stdfact. cpp. Para obter mais informações, consulte IClassFactory.
