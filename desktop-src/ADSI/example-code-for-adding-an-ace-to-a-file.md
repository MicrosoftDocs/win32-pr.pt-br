...
ms.locfileid: "105752986"
---
# <a name="example-code-for-adding-an-ace-to-a-file"></a><span data-ttu-id="773be-104">Exemplo de código para adicionar uma ACE a um arquivo</span><span class="sxs-lookup"><span data-stu-id="773be-104">Example Code for Adding an ACE to a File</span></span>

<span data-ttu-id="773be-105">O exemplo de código a seguir mostra como usar a interface [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) para adicionar uma ACE a um arquivo.</span><span class="sxs-lookup"><span data-stu-id="773be-105">The following code example shows how to use the [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) interface to add an ACE to a file.</span></span>
