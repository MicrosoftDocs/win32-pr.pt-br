...
---
# <a name="example-code-for-reading-a-constructed-attribute"></a><span data-ttu-id="859b5-104">Exemplo de código para ler um atributo construído</span><span class="sxs-lookup"><span data-stu-id="859b5-104">Example Code for Reading a Constructed Attribute</span></span>

<span data-ttu-id="859b5-105">O exemplo de código a seguir mostra um método que pode ser usado para recuperar um valor de atributo que funcionará com todos os tipos de atributos.</span><span class="sxs-lookup"><span data-stu-id="859b5-105">The following code example shows a method that can be used to retrieve an attribute value that will work with all attributes types.</span></span>
