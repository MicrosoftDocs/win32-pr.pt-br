---
title: Estruturas de edição avançadas
description: Estruturas de edição avançadas
...
ms.locfileid: "103837811"
---
# <a name="rich-edit-structures"></a>Estruturas de edição avançadas
...
-   [**\_parâmetros de imagem RichEdit \_**](/windows/win32/api/richedit/ns-richedit-richedit_image_parameters)
