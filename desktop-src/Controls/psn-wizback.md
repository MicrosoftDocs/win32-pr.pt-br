...
---
# <a name="psn_wizback-notification-code"></a>Código de notificação do PSN \_ WIZBACK

Notifica uma página que o usuário clicou no botão **voltar** em um assistente. Esse código de notificação é enviado na forma de uma mensagem de [**\_ notificação do WM**](wm-notify.md) .
