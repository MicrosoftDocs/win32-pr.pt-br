...
Quando o TrackBar é criado, seu intervalo e seu intervalo de seleção são inicializados. O tamanho da página também é definido neste momento.
...
### <a name="create-a-trackbar"></a>Criar um TrackBar

O exemplo a seguir mostra como criar um TrackBar com os estilos de [**\_ tiques**](trackbar-control-styles.md) e [**\_ ENABLESELRANGE**](trackbar-control-styles.md) TBS.
