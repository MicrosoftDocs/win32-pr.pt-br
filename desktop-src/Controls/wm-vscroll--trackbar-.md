...
keywords:
- WM_VSCROLL (Trackbar) código de notificação Windows controles
topic_type:
- apiref
api_name:
- WM_HSCROLL
...
ms.locfileid: "119077650"
---
# <a name="wm_vscroll-trackbar-notification-code"></a>\_Código de notificação do WM VSCROLL (TrackBar)

A mensagem do **WM \_ VSCROLL** é enviada ao proprietário de um controle TrackBar vertical quando o controle deslizante muda de posição.
...
Observe que a mensagem do **WM \_ VSCROLL** transporta apenas 16 bits de dados de posição. Assim, os aplicativos que dependem exclusivamente do **WM \_ VSCROLL** (e do [**WM \_ HSCROLL**](wm-hscroll--trackbar-.md)) para os dados da posição do controle deslizante têm um valor de posição máximo prático de 65.535.
...
[**HSCROLL do WM \_**](wm-hscroll--trackbar-.md)
</dt> </dl>
