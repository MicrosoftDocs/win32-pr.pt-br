...
keywords:
- NM_CUSTOMDRAW de código de notificação (exibição de lista) Windows controles
topic_type:
- apiref
api_name:
- NM_CUSTOMDRAW
...
| <dl> <dt>**doborracha CDRF \_**</dt> </dl>           | Windows Vista. O controle só pintará o plano de fundo. <br/>                                                                                                                                                                                                                                                                                                                                                                                 |
...
| <dl> <dt>**CDRF \_ SKIPPOSTPAINT**</dt> </dl>     | Windows Vista. O controle não desenhará o retângulo de foco. <br/>                                                                                                                                                                                                                                                                                                                                                                                                   |
