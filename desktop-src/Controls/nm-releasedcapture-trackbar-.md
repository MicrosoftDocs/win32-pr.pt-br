...
---
# <a name="nm_releasedcapture-trackbar-notification-code"></a>\_Código de notificação nm RELEASEDCAPTURE (TrackBar)

Notifica uma janela pai do controle TrackBar que o controle está liberando a captura do mouse. Esse código de notificação é enviado na forma de uma mensagem de [**\_ notificação do WM**](wm-notify.md) .
