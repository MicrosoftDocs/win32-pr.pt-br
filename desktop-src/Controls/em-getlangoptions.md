...
| <dl> <dt>**DISABLEAUTOBIDIAUTOKEYBOARD do IMF \_**</dt> </dl> | **Windows 8**: se esse sinalizador for definido, o controle usará a lógica neutra do idioma para alternar automaticamente o teclado. Essa opção é desativada por padrão (0).<br/>                                                                                                                                                                                                                                                            |
