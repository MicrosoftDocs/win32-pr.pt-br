---
title: Macros de Exibição de Árvore
description: Macros de Exibição de Árvore
...
ms.locfileid: "117833075"
---
# <a name="tree-view-macros"></a>Macros de Exibição de Árvore
...
-   [**Selecionar \_ TreeView**](/windows/desktop/api/Commctrl/nf-commctrl-treeview_select)
