...
---
# <a name="flat-scroll-bar-functions"></a>Funções da barra de rolagem simples
...
-   [**FlatSB \_ Addscrollbar**](/windows/desktop/api/Commctrl/nf-commctrl-flatsb_showscrollbar)
