---
title: Funções DLL de segurança RAS
description: Implemente as funções a seguir ao desenvolver uma DLL de segurança RAS.
...
ms.locfileid: "117789482"
---
# <a name="ras-security-dll-functions"></a>Funções DLL de segurança RAS

Implemente as funções a seguir ao desenvolver uma DLL de segurança RAS.
