...
---
# <a name="use-the-route-hold-down-state"></a><span data-ttu-id="ed988-103">Usar o estado de Hold-Down de rota</span><span class="sxs-lookup"><span data-stu-id="ed988-103">Use the Route Hold-Down State</span></span>

<span data-ttu-id="ed988-104">O código de exemplo a seguir mostra como marcar um destino para o estado suspenso e como criar uma enumeração de destino que inclui rotas que estão no estado suspenso.</span><span class="sxs-lookup"><span data-stu-id="ed988-104">The following sample code shows how to mark a destination for the hold-down state, and how to create a destination enumeration that includes routes that are in the hold-down state.</span></span>
