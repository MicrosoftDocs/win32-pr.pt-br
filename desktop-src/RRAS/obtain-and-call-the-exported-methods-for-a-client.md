---
title: Obter e chamar os métodos exportados para um cliente
description: O código de exemplo a seguir mostra como obter uma lista de métodos que um cliente exportou e como invocar um método para esse cliente.
...
ms.locfileid: "104453484"
---
# <a name="obtain-and-call-the-exported-methods-for-a-client"></a><span data-ttu-id="599f1-103">Obter e chamar os métodos exportados para um cliente</span><span class="sxs-lookup"><span data-stu-id="599f1-103">Obtain and Call the Exported Methods for a Client</span></span>

<span data-ttu-id="599f1-104">O código de exemplo a seguir mostra como obter uma lista de métodos que um cliente exportou e como invocar um método para esse cliente.</span><span class="sxs-lookup"><span data-stu-id="599f1-104">The following sample code shows how to obtain a list of methods a client has exported, and how to invoke a method for that client.</span></span>
