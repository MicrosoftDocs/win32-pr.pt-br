---
title: Usando a API MIB de gerenciamento do roteador
description: Esta seção contém exemplos que mostram como usar a API MIB de gerenciamento de roteador para consultar e definir variáveis.
ms.assetid: cbd826c0-4d5c-4661-b1b2-886fe0f8e680
keywords:
- Roteamento, base de informações de gerenciamento, tarefas
- Base de informações de gerenciamento RRAS, tarefas
ms.topic: article
ms.date: 05/31/2018
