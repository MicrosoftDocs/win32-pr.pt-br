---
title: Acessar o ponteiro opaco em um destino
description: O código de exemplo a seguir mostra como acessar o ponteiro opaco em um destino.
...
---
# <a name="access-the-opaque-pointer-in-a-destination"></a><span data-ttu-id="2d265-103">Acessar o ponteiro opaco em um destino</span><span class="sxs-lookup"><span data-stu-id="2d265-103">Access the Opaque Pointer in a Destination</span></span>

<span data-ttu-id="2d265-104">O código de exemplo a seguir mostra como acessar o ponteiro opaco em um destino.</span><span class="sxs-lookup"><span data-stu-id="2d265-104">The following sample code shows how to access the opaque pointer in a destination.</span></span>
