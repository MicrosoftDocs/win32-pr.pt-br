---
title: Registrar para notificação de alteração
description: O código de exemplo a seguir mostra como registrar-se para notificações de alteração na tabela de roteamento. O tópico \ 0034; Usar o retorno de chamada de notificação de evento \ 0034; demonstra como utilizar essas notificações de alteração.
...
ms.locfileid: "120028407"
---
# <a name="register-for-change-notification"></a>Registrar para notificação de alteração

O código de exemplo a seguir mostra como registrar-se para notificações de alteração na tabela de roteamento. O tópico "[usar o retorno de chamada de notificação de evento](use-the-event-notification-callback.md)" demonstra como utilizar essas notificações de alteração.
