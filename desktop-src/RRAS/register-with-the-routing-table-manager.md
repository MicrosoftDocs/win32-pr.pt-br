...
---
# <a name="register-with-the-routing-table-manager"></a><span data-ttu-id="d39ef-103">Registrar com o Gerenciador de tabela de roteamento</span><span class="sxs-lookup"><span data-stu-id="d39ef-103">Register with the Routing Table Manager</span></span>

<span data-ttu-id="d39ef-104">O código de exemplo a seguir mostra como registrar uma nova entidade com o Gerenciador de tabela de roteamento.</span><span class="sxs-lookup"><span data-stu-id="d39ef-104">The following sample code shows how to register a new entity with the routing table manager.</span></span>
