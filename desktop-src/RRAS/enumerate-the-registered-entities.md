...
ms.locfileid: "119798956"
---
# <a name="enumerate-the-registered-entities"></a>Enumerar as entidades registradas

O código de exemplo a seguir mostra como criar uma enumeração de clientes registrados e obter as informações do cliente do Gerenciador de tabela de roteamento.
