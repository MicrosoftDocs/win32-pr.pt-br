---
title: Enumerar as entidades registradas
description: O código de exemplo a seguir mostra como criar uma enumeração de clientes registrados e obter as informações do cliente do Gerenciador de tabela de roteamento.
...
ms.locfileid: "105748557"
---
# <a name="enumerate-the-registered-entities"></a><span data-ttu-id="fd77f-103">Enumerar as entidades registradas</span><span class="sxs-lookup"><span data-stu-id="fd77f-103">Enumerate the Registered Entities</span></span>

<span data-ttu-id="fd77f-104">O código de exemplo a seguir mostra como criar uma enumeração de clientes registrados e obter as informações do cliente do Gerenciador de tabela de roteamento.</span><span class="sxs-lookup"><span data-stu-id="fd77f-104">The following sample code shows how to create an enumeration of registered clients and obtain the client information from the routing table manager.</span></span>
