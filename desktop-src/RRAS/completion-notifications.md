...
-   Ocorrerá um erro. O manipulador recebe uma notificação indicando o erro e o estado da conexão quando o erro ocorreu. O aplicativo cliente RAS pode sair.
