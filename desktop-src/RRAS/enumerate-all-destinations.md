---
title: Enumerar todos os destinos
description: O código de exemplo a seguir mostra como enumerar todos os destinos na tabela de roteamento.
...
---
# <a name="enumerate-all-destinations"></a><span data-ttu-id="b1083-103">Enumerar todos os destinos</span><span class="sxs-lookup"><span data-stu-id="b1083-103">Enumerate All Destinations</span></span>

<span data-ttu-id="b1083-104">O código de exemplo a seguir mostra como enumerar todos os destinos na tabela de roteamento.</span><span class="sxs-lookup"><span data-stu-id="b1083-104">The following sample code shows how to enumerate all destinations in the routing table.</span></span>
