...
ms.locfileid: "120127856"
---
# <a name="enumerate-all-destinations"></a>Enumerar todos os destinos

O código de exemplo a seguir mostra como enumerar todos os destinos na tabela de roteamento.
