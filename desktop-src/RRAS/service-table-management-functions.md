---
title: Funções de gerenciamento de tabela de serviço
description: Use as funções a seguir para rotear protocolos que se registram para tratamento de serviços.
...
---
# <a name="service-table-management-functions"></a>Funções de gerenciamento de tabela de serviço

Use as funções a seguir para rotear protocolos que se registram para tratamento de serviços.
