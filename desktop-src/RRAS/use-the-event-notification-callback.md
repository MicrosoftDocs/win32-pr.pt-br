...
---
# <a name="use-the-event-notification-callback"></a>Usar o retorno de chamada de notificação de evento

O procedimento a seguir descreve as etapas que o cliente deve usar para receber mensagens de notificação de alteração do \_ retorno de chamada do evento RTM \_ . O código de exemplo a seguir mostra como implementar o procedimento.

**Como recuperar as mensagens de notificação de alteração**

1.  Chame [**RtmGetChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetchangeddests) para recuperar um conjunto de alterações.
2.  Processar as alterações.
3.  Libere os destinos usando [**RtmReleaseChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmreleasechangeddests).
4.  Repita as etapas 1, 2 e 3 até que [**RtmGetChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetchangeddests) retorne \_ um erro sem \_ mais \_ itens.

O código de exemplo a seguir mostra como processar um retorno de chamada de [**\_ retorno de \_ chamada de evento RTM**](/windows/win32/api/rtmv2/nc-rtmv2-_event_callback) recebido do Gerenciador de tabela de roteamento.
