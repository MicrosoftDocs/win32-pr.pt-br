...
---
# <a name="remote-access-service-structures"></a>Estruturas de serviço de acesso remoto

Use as seguintes estruturas para implementar a funcionalidade RAS.

[**\_informações de projeção de Ras \_**](/windows/desktop/api/Ras/ns-ras-ras_projection_info)

[**Estatísticas de RAS \_**](/windows/desktop/api/Ras/ns-ras-ras_stats)
...
[**\_Informações de projeção RASIKEV2 \_**](/windows/desktop/api/ras/ns-ras-rasikev2_projection_info)
...
[**\_informações de projeção RASPPP \_**](/windows/desktop/api/Ras/ns-ras-rasppp_projection_info)
...
[**\_tipo de informação rasprojection \_**](/windows/desktop/api/ras/ne-ras-rasprojection_info_type)
