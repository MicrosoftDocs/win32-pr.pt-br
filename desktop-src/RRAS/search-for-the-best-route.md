---
title: Pesquisar a melhor rota
description: O código de exemplo a seguir mostra como Pesquisar a tabela de roteamento para obter a melhor rota.
...
ms.locfileid: "104363734"
---
# <a name="search-for-the-best-route"></a><span data-ttu-id="13099-103">Pesquisar a melhor rota</span><span class="sxs-lookup"><span data-stu-id="13099-103">Search For the Best Route</span></span>

<span data-ttu-id="13099-104">O código de exemplo a seguir mostra como Pesquisar a tabela de roteamento para obter a melhor rota.</span><span class="sxs-lookup"><span data-stu-id="13099-104">The following sample code shows how to search the routing table for the best route.</span></span>
