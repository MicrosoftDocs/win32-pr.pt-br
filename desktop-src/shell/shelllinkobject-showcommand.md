...
Obtém ou define o estado de exibição inicial (dimensionado, minimizado ou maximizado) do comando do link.
...
o estado de exibição do link. Esse valor pode ser um dos seguintes:
...
Ativa e exibe uma janela. Se a janela for minimizada ou maximizada, o sistema a restaurará para seu tamanho e posição originais.
