...
Contém uma representação de cadeia de caracteres do tipo do item.
...
Uma variável do tipo [**BSTR**](/previous-versions/windows/desktop/automat/bstr) que recebe o tipo do item.
