...
Para definir um verbo como estendido, basta adicionar um valor de **\_ sz reg** "estendido" à subchave do verbo. O valor não deve ter nenhum dado associado a ele. A seguinte entrada de registro de exemplo mostra o exemplo da seção anterior, com "doit" definido como um verbo estendido.
