---
description: Demonstra como implementar um controle de árvore de namespace personalizado para um aplicativo.
title: Exemplo de controle de árvore de NameSpace
ms.topic: article
ms.date: 05/31/2018
...
Demonstra como implementar um controle de árvore de namespace personalizado para um aplicativo.
...
Para obter instruções sobre como criar o exemplo, consulte o arquivo Leiame incluído com o exemplo.
