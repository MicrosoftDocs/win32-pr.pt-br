...
1.  navegue até o diretório que contém o ExplorerCommandVerb.dll, usando o prompt de comando ou o gerenciador de Windows. Certifique-se de usar o arquivo DLL de 64 bits em Windows de 64 bits.
2.  Na linha de comando, digite `regsvr32.exe ExplorerCommandVerb.dll` .
3.  Dois novos verbos serão mostrados no menu de contexto quando você clicar com o botão direito do mouse em um arquivo de .txt.
