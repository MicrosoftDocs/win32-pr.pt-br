...
3.  Certifique-se de Desktop.ini arquivo que você criar está no formato Unicode. Isso é necessário para armazenar as cadeias de caracteres localizadas que podem ser exibidas aos usuários.

### <a name="creating-a-desktopini-file"></a>Criando um arquivo Desktop.ini dados

O Desktop.ini arquivo é um arquivo de texto que permite especificar como uma pasta do sistema de arquivos é exibida. O \[ . A seção ShellClassInfo permite personalizar a exibição da pasta \] atribuindo valores a várias entradas:
...
| **NoSharing**     | Sem suporte no Windows Vista ou posterior. De definir essa entrada como 1 para impedir que a pasta seja compartilhada.                                                                                                                                                                                                                                                                       |
