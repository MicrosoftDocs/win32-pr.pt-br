...
Representa a coleção de itens em uma pasta do Shell. Este objeto contém propriedades e métodos que permitem que você recupere informações sobre a coleção.
...
|:----------------------------------------------------------|:---------------------|:--------------------------------------------------------------------------------------------------------------|
| [**Aplicativo**](folderitems-application.md)<br/> | Somente leitura<br/> | Contém o objeto de [**aplicativo**](folderitems-application.md) da coleção de itens de pasta.<br/> |
| [**Contar**](folderitems-count.md)<br/>             | Somente leitura<br/> | Contém o número de itens na coleção.<br/>                                                    |
