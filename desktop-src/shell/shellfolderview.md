...
| Evento                                                        | Descrição                                                                              |
|:-------------------------------------------------------------|:-----------------------------------------------------------------------------------------|
| [**SelectionChanged**](shellfolderview-selectionchanged.md) | Ocorre quando o estado de seleção de qualquer item ou item na exibição foi alterado.<br/> |
...
|:--------------------------------------------------------------|:---------------------|:-------------------------------------------------------------------------------------------------------------|
| [**Aplicativo**](shellfolderview-application.md)<br/> | Somente leitura<br/> | Contém o objeto Application do objeto .<br/>                                                         |
...
| [**Pasta**](shellfolderview-folder.md)<br/>           | Somente leitura<br/> | Obtém [**um objeto**](folder.md) Folder que representa a exibição.<br/>                                  |
...
| [**ViewOptions**](shellfolderview-viewoptions.md)<br/> | Somente leitura<br/> | Obtém um conjunto de sinalizadores que indicam as opções atuais da exibição.<br/>                                |
...
[**Sinalizadores ShellFolderViewOptions**](/windows/desktop/api/Shldisp/ne-shldisp-shellfolderviewoptions)
</dt> </dl>
