...
> [!Note]  
> [**IExplorerCommand**](/windows/desktop/api/shobjidl_core/nn-shobjidl_core-iexplorercommand) é um híbrido entre um verbo estático e dinâmico. **IExplorerCommand** foi declarado no Windows Vista, mas sua capacidade de implementar um verbo em um menu de atalho é nova para o Windows 7.
