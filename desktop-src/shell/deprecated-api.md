...
<td>Preterido. Essa enumeração é usada pela estrutura <a href="/windows/desktop/api/Shdeprecated/ns-shdeprecated-basebrowserdatalh"><strong>BASEBROWSERDATA</strong></a> para indicar o status do ícone de bloqueio do navegador base.<br/></td>
</tr>
<tr class="odd">
...
<td>Não executa nenhuma função. Fornecido para compatibilidade com versões anteriores.<br/></td>
</tr>
<tr class="odd">
...
<td>Cria um perfil de usuário para um usuário especificado. <br/></td>
</tr>
<tr class="odd">
...
<td>Rola a janela enquanto uma imagem está sendo arrastada.<br/></td>
</tr>
<tr class="odd">
...
<td>Determina o local de um recurso com o tipo e o nome especificados no módulo especificado. <br/>
<blockquote>
[!Note]<br />
<a href="findresourcewrapw.md"><strong>FindResourceWrapW</strong></a> é um wrapper para a função <strong>FindResourceW</strong> . Consulte <a href="/windows/desktop/api/winbase/nf-winbase-findresourcea"><strong>FindResource</strong></a> para ver mais observações de uso.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
<td><a href="getdateformatwrapw.md"><strong>GetDateFormatWrapW</strong></a><br/></td>
<td>Formata uma data como uma cadeia de caracteres de data para uma localidade especificada. A função formata uma data especificada ou a data do sistema local. <br/>
<blockquote>
[!Note]<br />
<a href="getdateformatwrapw.md"><strong>GetDateFormatWrapW</strong></a> é um wrapper para a função <strong>GetDateFormatW</strong> . Consulte a página <a href="/windows/desktop/api/datetimeapi/nf-datetimeapi-getdateformata"><strong>GetDateFormat</strong></a> para ver mais observações de uso.
</blockquote>
<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj/nf-shlobj-getfilenamefrombrowse"><strong>GetFileNameFromBrowse</strong></a><br/></td>
<td>Cria uma caixa de diálogo <strong>aberta</strong> para que o usuário possa especificar a unidade, o diretório e o nome de um arquivo a ser aberto.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Shlwapi/nf-shlwapi-getmenuposfromid"><strong>GetMenuPosFromID</strong></a><br/></td>
<td><a href="/windows/desktop/api/Shlwapi/nf-shlwapi-getmenuposfromid"><strong>GetMenuPosFromID</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="even">
<td><a href="gettimeformatwrapw.md"><strong>GetTimeFormatWrapW</strong></a><br/></td>
<td>Formata o tempo como uma cadeia de hora para uma localidade especificada. A função formata uma hora especificada ou a hora do sistema local. <br/>
<blockquote>
[!Note]<br />
<a href="gettimeformatwrapw.md"><strong>GetTimeFormatWrapW</strong></a> é um wrapper para a função <strong>GetTimeFormatW</strong> . Consulte a página <a href="/windows/desktop/api/datetimeapi/nf-datetimeapi-gettimeformata"><strong>GetTimeFormat</strong></a> para ver mais observações de uso.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
<td><a href="guidfromstring.md"><strong>GUIDFromString</strong></a><br/></td>
<td>Converte uma cadeia de caracteres em um GUID.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-illoadfromstream"><strong>ILLoadFromStream</strong></a><br/></td>
<td>Preterido. Carrega uma estrutura <a href="/windows/desktop/api/Shtypes/ns-shtypes-itemidlist"><strong>ITEMIDLIST</strong></a> a partir de um fluxo.<br/></td>
</tr>
<tr class="odd">
...
<td>Essa função pode ser alterada ou indisponível.<br/></td>
</tr>
<tr class="even">
...
<td>Determina se um caractere é um caractere alfabético ou numérico. Essa determinação se baseia na semântica do idioma selecionado pelo usuário durante a instalação ou por meio do painel de controle. <br/>
<blockquote>
[!Note]<br />
<a href="ischaralphanumericwrapw.md"><strong>IsCharAlphaNumericWrapW</strong></a> é um wrapper para a função <strong>IsCharAlphaNumericW</strong> . Consulte a página <a href="/windows/desktop/api/winuser/nf-winuser-ischaralphanumerica"><strong>IsCharAlphaNumeric</strong></a> para ver mais observações de uso.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-isnetdrive"><strong>IsNetDrive</strong></a><br/></td>
<td>Testa se uma unidade é uma unidade de rede.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-isuseranadmin"><strong>IsUserAnAdmin</strong></a><br/></td>
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-isuseranadmin"><strong>IsUserAnAdmin</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shlobj_core/nc-shlobj_core-lpfndfmcallback"><strong>LPFNDFMCALLBACK</strong></a><br/></td>
<td><a href="/windows/desktop/api/shlobj_core/nc-shlobj_core-lpfndfmcallback"><strong>LPFNDFMCALLBACK</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj_core/nc-shlobj_core-lpfnviewcallback"><strong>LPFNVIEWCALLBACK</strong></a><br/></td>
<td>Define o protótipo para a função de retorno de chamada usada pelo objeto de exibição de pasta do sistema. Essa função, essencialmente, duplica a funcionalidade de <a href="/windows/desktop/api/shlobj_core/nn-shlobj_core-ishellfolderviewcb"><strong>IShellFolderViewCB</strong></a>.<br/></td>
</tr>
<tr class="odd">
<td><a href="linkwindow-registerclass.md"><strong>LinkWindow_RegisterClass</strong></a><br/></td>
<td>Registra uma classe de janela que permite que o controle comum <a href="/windows/desktop/Controls/syslink-overview">Syslink</a> seja usado em uma janela.<br/></td>
</tr>
<tr class="even">
<td><a href="linkwindow-unregisterclass.md"><strong>LinkWindow_UnregisterClass</strong></a><br/></td>
<td>Cancela o registro de uma classe de janela registrada por <a href="linkwindow-registerclass.md"><strong>LinkWindow_RegisterClass</strong></a>.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/shell/about-user-profiles"><strong>MLFreeLibrary</strong></a><br/></td>
<td>Cancela o mapeamento de uma DLL de recurso carregada pela função <a href="/windows/desktop/shell/callbacks"><strong>MLLoadLibrary</strong></a> . <br/></td>
</tr>
<tr class="even">
<td><a href="mlhtmlhelp.md"><strong>MLHtmlHelp</strong></a><br/></td>
<td>Exibe uma janela de ajuda que corresponde à configuração de idioma da interface do usuário atual.<br/></td>
</tr>
<tr class="odd">
...
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-openregstream"><strong>OpenRegStream</strong></a> pode ser alterado ou indisponível. Em vez disso, use <a href="/windows/desktop/api/Shlwapi/nf-shlwapi-shopenregstream2a"><strong>SHOpenRegStream2</strong></a> ou <a href="/windows/desktop/api/Shlwapi/nf-shlwapi-shopenregstreama"><strong>SHOpenRegStream</strong></a>.<br/></td>
</tr>
<tr class="even">
<td><a href="outputdebugstringwrapw.md"><strong>OutputDebugStringWrapW</strong></a><br/></td>
<td>Envia uma cadeia de caracteres Unicode para o depurador para exibição.<br/>
<blockquote>
[!Note]<br />
<a href="outputdebugstringwrapw.md"><strong>OutputDebugStringWrapW</strong></a> é um wrapper para a função <strong>OutputDebugStringWna</strong> . Consulte a página <a href="/windows/desktop/api/debugapi/nf-debugapi-outputdebugstringw"><strong>OutputDebugString</strong></a> para ver mais observações de uso.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
<td><a href="parsefield.md"><strong>Parsefield</strong></a><br/></td>
<td>Lê uma linha de setup. inf e extrai o campo especificado da cadeia de caracteres. <br/></td>
</tr>
<tr class="even">
<td><a href="passportwizardrundll.md"><strong>PassportWizardRunDll</strong></a><br/></td>
<td>Inicia o assistente do Passport quando usado com Rundll32.exe.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pathcleanupspec"><strong>PathCleanupSpec</strong></a><br/></td>
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pathcleanupspec"><strong>PathCleanupSpec</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pathgetshortpath"><strong>PathGetShortPath</strong></a><br/></td>
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pathgetshortpath"><strong>PathGetShortPath</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pathisexe"><strong>PathIsExe</strong></a><br/></td>
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pathisexe"><strong>PathIsExe</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Shlobj/nf-shlobj-pathisslowa"><strong>PathIsSlow</strong></a><br/></td>
<td><a href="/windows/desktop/api/Shlobj/nf-shlobj-pathisslowa"><strong>PathIsSlow</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Shlobj/nf-shlobj-pathprocesscommand"><strong>PathProcessCommand</strong></a><br/></td>
<td>Preterido. Processa uma cadeia de caracteres que contém uma linha de comando e gera uma cadeia de caracteres entre aspas adequadamente, com argumentos anexados, se necessário.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pathresolve"><strong>PathResolve</strong></a><br/></td>
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pathresolve"><strong>PathResolve</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Shlobj/nf-shlobj-peruserinit"><strong>PerUserInit</strong></a><br/></td>
<td>Cria <a href="manage.md">meus documentos</a> e outras pastas especiais, inicializa-os conforme necessário e cria o item de menu de atalho <strong>Enviar para</strong> meus documentos. <br/></td>
</tr>
<tr class="even">
<td><a href="/previous-versions/windows/desktop/legacy/bb776773(v=vs.85)"><strong>PFNASYNCICONTASKCALLBACK</strong></a><br/></td>
<td>Define o protótipo para a função de retorno de chamada usada pelo <a href="/previous-versions/windows/desktop/legacy/bb762218(v=vs.85)"><strong>SHMapIDListToImageListIndexAsync</strong></a>. <br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pickicondlg"><strong>PickIconDlg</strong></a><br/></td>
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-pickicondlg"><strong>PickIconDlg</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-readcabinetstate"><strong>ReadCabinetState</strong></a><br/></td>
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-readcabinetstate"><strong>ReadCabinetState</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-realdrivetype"><strong>RealDriveType</strong></a><br/></td>
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-realdrivetype"><strong>RealDriveType</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="even">
...
<td>Adiciona páginas a uma matriz de extensão de folha de propriedades criada por <a href="/windows/desktop/api/Shlobj/nf-shlobj-shcreatepropsheetextarray"><strong>SHCreatePropSheetExtArray</strong></a>.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-shalloc"><strong>SHAlloc</strong></a><br/></td>
<td>Aloca memória a partir do heap do Shell.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Shlwapi/nf-shlwapi-shallocshared"><strong>SHAllocShared</strong></a><br/></td>
<td><a href="/windows/desktop/api/Shlwapi/nf-shlwapi-shallocshared"><strong>SHAllocShared</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Shlwapi/nf-shlwapi-shansitoansi"><strong>SHAnsiToAnsi</strong></a><br/></td>
<td>Copia uma cadeia de caracteres ANSI.<br/></td>
</tr>
<tr class="even">
...
<td>Cria uma nova pasta do sistema de arquivos.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-shcreatedirectoryexa"><strong>SHCreateDirectoryEx</strong></a><br/></td>
<td>Cria uma nova pasta do sistema de arquivos, com atributos de segurança opcionais.<br/></td>
</tr>
<tr class="odd">
...
<td>Libera manipuladores de folha de propriedades que são apontados para uma matriz criada por <a href="/windows/desktop/api/Shlobj/nf-shlobj-shcreatepropsheetextarray"><strong>SHCreatePropSheetExtArray</strong></a>.<br/></td>
</tr>
<tr class="odd">
...
<td>Obtém o caminho de uma pasta e anexa um caminho de subpasta fornecido pelo usuário.<br/></td>
</tr>
<tr class="even">
...
<td>Define limites em caracteres válidos para um controle de edição.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Shlobj/nf-shlobj-shloadole"><strong>SHLoadOLE</strong></a><br/></td>
<td>Preterido. Fornecido para compatibilidade com versões anteriores.<br/></td>
</tr>
<tr class="odd">
...
<td>Envia uma mensagem para todas as janelas de nível superior no sistema.<br/></td>
</tr>
<tr class="odd">
...
<td>Remove o marcador mnemônico de uma cadeia de caracteres.<br/></td>
</tr>
<tr class="odd">
...
<td>Copia uma cadeia de caracteres Unicode.<br/></td>
</tr>
<tr class="odd">
...
<td>Usado para recompactar uma imagem.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/shell/profiles-directory"><strong>MenuBand</strong></a><br/></td>
<td>Dá suporte a bandas de menu do Shell.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/shell/mandatory-user-profiles"><strong>MenuBandSite</strong></a><br/></td>
<td>Obtém ou define as informações do site de faixa do menu.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/shell/roaming-user-profiles"><strong>NewMenu</strong></a><br/></td>
<td>Cria um <strong>novo</strong> menu de contexto para um item de Shell.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/shell/user-profiles"><strong>ShellFldSetExt</strong></a><br/></td>
<td>Cria uma caixa de diálogo de <strong>Opções de pasta</strong> . <br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/shell/local-user-profiles"><strong>ShellFolderBand</strong></a><br/></td>
<td>Gerencia as faixas de pastas. A barra de início rápido é um exemplo de uma faixa de pastas.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/shell/context-menu"><strong>Repositório de Imagens do Shell</strong></a><br/></td>
<td>Cria uma instância de um objeto <a href="/windows/desktop/api/shlobj/nn-shlobj-ishellimagestore"><strong>IShellImageStore</strong></a> .<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Shdeprecated/nn-shdeprecated-ibrowserservice"><strong>IBrowserService</strong></a><br/></td>
<td>Preterido. Os métodos expostos por essa interface são análogos aos métodos protegidos virtual na herança C++ normal. A hierarquia de herança dos objetos abrange várias DLLs. A hierarquia é composta de uma classe base e várias classes derivadas que correspondem a controles, incluindo CLSID_WebBrowser e a área de trabalho do usuário. Os objetos que não estão na hierarquia não devem implementar essa interface nem usar a maioria de seus métodos.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Shdeprecated/nn-shdeprecated-ibrowserservice2"><strong>IBrowserService2</strong></a><br/></td>
<td>Preterido. <a href="/windows/desktop/api/Shdeprecated/nn-shdeprecated-ibrowserservice2"><strong>IBrowserService2</strong></a> estende <a href="/windows/desktop/api/Shdeprecated/nn-shdeprecated-ibrowserservice"><strong>IBrowserService</strong></a>. Os métodos expostos por essa interface são análogos aos métodos protegidos virtual na herança C++ normal. A hierarquia de herança dos objetos abrange várias DLLs. A hierarquia é composta de uma classe base e várias classes derivadas que correspondem a controles, incluindo CLSID_WebBrowser e a área de trabalho do usuário. Os objetos que não estão na hierarquia não devem implementar essa interface nem usar a maioria de seus métodos.<br/></td>
</tr>
<tr class="odd">
...
<td><a href="/windows/desktop/api/Shobjidl/nn-shobjidl-icdburnext"><strong>ICDBurnExt</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="even">
...
<td>Implementado pelo modo de exibição de pasta padrão criado usando <a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-shcreateshellfolderview"><strong>SHCreateShellFolderView</strong></a>. Uma implementação de <a href="/windows/desktop/api/shobjidl_core/nn-shobjidl_core-icontextmenusite"><strong>IContextMenuSite</strong></a> dá suporte a <a href="/windows/desktop/api/shobjidl_core/nf-shobjidl_core-icontextmenu-querycontextmenu"><strong>IContextMenu:: QueryContextMenu</strong></a>, <a href="/windows/desktop/api/shobjidl_core/nf-shobjidl_core-icontextmenu-invokecommand"><strong>IContextMenu:: InvokeCommand</strong></a>e <a href="/windows/desktop/api/winuser/nf-winuser-trackpopupmenu"><strong>TrackPopupMenu</strong></a> e qualquer encaminhamento de mensagem necessário para essa função. O <strong>IContextMenuSite</strong> normalmente também atualiza a barra de status.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj/nn-shlobj-idefviewframe"><strong>IDefViewFrame</strong></a><br/></td>
<td>Usado apenas para sua funcionalidade <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown"><strong>IUnknown</strong></a> . Ele não tem nenhum método próprio.<br/></td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/legacy/bb762074(v=vs.85)"><strong>IDefViewID</strong></a><br/></td>
<td><a href="/previous-versions/windows/desktop/legacy/bb762074(v=vs.85)"><strong>IDefViewID</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="even">
<td><a href="/previous-versions/windows/desktop/legacy/bb762072(v=vs.85)"><strong>IDefViewSafety</strong></a><br/></td>
<td>Preterido. Expõe um método que determina a configuração da zona de conteúdo da Web de uma página antes que a página seja acessada.<br/></td>
</tr>
<tr class="odd">
...
<td>Expõe um método para obter a largura de banda padrão da faixa de escrivaninha.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shobjidl_core/nn-shobjidl_core-ideskbar"><strong>IDeskBar</strong></a><br/></td>
<td>Expõe métodos que permitem a manipulação da barra de escrivaninha.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shlobj/nn-shlobj-idocviewsite"><strong>IDocViewSite</strong></a><br/></td>
<td>Usado como um objeto de site pela interface <a href="/windows/desktop/api/shobjidl_core/nn-shobjidl_core-ishellview"><strong>IShellView</strong></a> .<br/></td>
</tr>
<tr class="even">
<td><a href="/previous-versions/windows/desktop/legacy/bb762022(v=vs.85)"><strong>IDVGetEnum</strong></a><br/></td>
<td>Expõe métodos que permitem que o objeto de exibição de pasta do sistema forneça outro objeto com uma enumeração de itens, sem o segundo objeto que executa uma enumeração redundante em si.<br/></td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/legacy/bb761957(v=vs.85)"><strong>IEnumSyncItems</strong></a><br/></td>
<td>Expõe métodos que fornecem a enumeração de todos os itens em um agendamento de sincronização.<br/></td>
</tr>
<tr class="even">
<td><a href="/previous-versions/windows/desktop/legacy/bb761937(v=vs.85)"><strong>IEnumSyncSchedules</strong></a><br/></td>
<td>Fornece enumeração de todos os agendamentos de sincronização.<br/></td>
</tr>
<tr class="odd">
<td><a href="ienumuseridentity.md"><strong>IEnumUserIdentity</strong></a><br/></td>
<td><a href="ienumuseridentity.md"><strong>IEnumUserIdentity</strong></a> não tem suporte e pode ser alterado ou indisponível no futuro. Em vez disso, use <a href="fastuserswitching.md">contas de usuário com troca rápida de usuário e área de trabalho remota</a>.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Shdeprecated/nn-shdeprecated-iexpdispsupport"><strong>IExpDispSupport</strong></a><br/></td>
<td>Preterido. Expõe métodos que permitem a recuperação de propriedades, tradução de aceleradores de teclado e determinação de um ponto de conexão para determinados eventos.<br/></td>
</tr>
<tr class="odd">
...
<td>O <a href="/windows/desktop/api/Shobjidl/nn-shobjidl-ifolderbandpriv"><strong>IFolderBandPriv</strong></a> está disponível para uso nos sistemas operacionais especificados na seção requisitos. Ele poderá ser alterado ou ficar indisponível em versões subsequentes.<br/></td>
</tr>
<tr class="odd">
<td><a href="iidentitychangenotify.md"><strong>IIdentityChangeNotify</strong></a><br/></td>
<td>Preterido. Fornece notificação de modificações para identidades de usuário no sistema, bem como solicitações de usuário para alternar a identidade do usuário atual.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Shobjidl/nn-shobjidl-iinsertitem"><strong>IInsertItem</strong></a><br/></td>
<td><a href="/windows/desktop/api/Shobjidl/nn-shobjidl-iinsertitem"><strong>IInsertItem</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shobjidl_core/nn-shobjidl_core-imenuband"><strong>IMenuBand</strong></a><br/></td>
<td>Expõe métodos que permitem que um objeto COM Component Object Model (COM) receba e traduza as mensagens apropriadas.<br/></td>
</tr>
<tr class="even">
...
<td>Expõe métodos que recuperam e definem o estado dos itens em um controle de exibição de árvore que tem o sinalizador de <a href="/windows/desktop/Controls/tree-view-control-window-styles"><strong>janela de controle de exibição de árvore</strong></a> definido como conjunto de estilos.<br/></td>
</tr>
<tr class="odd">
...
<td><a href="/windows/desktop/api/shlobj/nn-shlobj-ishellfolderband"><strong>IShellFolderBand</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/shlobj_core/nn-shlobj_core-ishellfolderview"><strong>IShellFolderView</strong></a><br/></td>
<td>Expõe métodos que manipulam exibições de pastas do Shell.<br/></td>
</tr>
<tr class="even">
...
<td><a href="/windows/desktop/api/shlobj_core/nn-shlobj_core-ishelliconoverlaymanager"><strong>IShellIconOverlayManager</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Shimgdata/nn-shimgdata-ishellimagedata"><strong>IShellImageData</strong></a><br/></td>
<td>Expõe métodos e propriedades que exibem, manipulam e descrevem dados de imagem.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/shlobj/nn-shlobj-ishellimagestore"><strong>IShellImageStore</strong></a><br/></td>
<td>Preterido. Expõe métodos que manipulam o cache de imagem.<br/></td>
</tr>
<tr class="odd">
...
<td><a href="/windows/desktop/api/shobjidl_core/nn-shobjidl_core-ishelltaskscheduler"><strong>IShellTaskScheduler</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/legacy/bb774852(v=vs.85)"><strong>IShellTaskScheduler2</strong></a><br/></td>
<td>Estende a funcionalidade do <a href="/windows/desktop/api/shobjidl_core/nn-shobjidl_core-ishelltaskscheduler"><strong>IShellTaskScheduler</strong></a> herdando todos os seus métodos, fornecendo a capacidade de colocar uma tarefa na fila com referência a outras tarefas de sua prioridade e adicionar um método para redefinir a prioridade de uma tarefa.<br/></td>
</tr>
<tr class="even">
<td><a href="/previous-versions/windows/desktop/isync-schedule/bb774693(v=vs.85)"><strong>ISyncSchedule</strong></a><br/></td>
<td>Expõe métodos associados a um agendamento de sincronização individual.<br/></td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/isync-schedule-mgr/bb774672(v=vs.85)"><strong>ISyncScheduleMgr</strong></a><br/></td>
<td>Expõe métodos para configurar e controlar um Agendador de sincronização para o gerenciamento de sincronização.<br/></td>
</tr>
<tr class="even">
...
<td>Preterido. Expõe métodos para identificar, invocar e atualizar um item individual no histórico de viagens do navegador.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Shdeprecated/nn-shdeprecated-itravellog"><strong>ITravelLog</strong></a><br/></td>
<td>Preterido. Expõe métodos que mantêm e manipulam um registro de viagem no navegador.<br/></td>
</tr>
<tr class="odd">
<td><a href="iuseridentity.md"><strong>IUserIdentity</strong></a><br/></td>
<td><a href="iuseridentity.md"><strong>IUserIdentity</strong></a> não tem suporte e pode ser alterado ou indisponível no futuro. Em vez disso, use <a href="fastuserswitching.md">contas de usuário com troca rápida de usuário e área de trabalho remota</a>.<br/></td>
</tr>
<tr class="even">
<td><a href="iuseridentity2.md"><strong>IUserIdentity2</strong></a><br/></td>
<td><a href="iuseridentity2.md"><strong>IUserIdentity2</strong></a> não tem suporte e pode ser alterado ou indisponível no futuro. Em vez disso, use <a href="fastuserswitching.md">contas de usuário com troca rápida de usuário e área de trabalho remota</a>.<br/></td>
</tr>
<tr class="odd">
<td><a href="iuseridentitymanager.md"><strong>IUserIdentityManager</strong></a><br/></td>
<td><a href="iuseridentitymanager.md"><strong>IUserIdentityManager</strong></a> não tem suporte e pode ser alterado ou indisponível no futuro. Em vez disso, use <a href="fastuserswitching.md">contas de usuário com troca rápida de usuário e área de trabalho remota</a>.<br/></td>
</tr>
<tr class="even">
<td><a href="sfvm-diddragdrop.md"><strong>SFVM_DIDDRAGDROP</strong></a><br/></td>
<td><a href="sfvm-diddragdrop.md"><strong>SFVM_DIDDRAGDROP</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="sfvm-getdetailsof.md"><strong>SFVM_GETDETAILSOF</strong></a><br/></td>
<td><a href="sfvm-getdetailsof.md"><strong>SFVM_GETDETAILSOF</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="even">
<td><a href="sfvm-getpane.md"><strong>SFVM_GETPANE</strong></a><br/></td>
<td><a href="sfvm-getpane.md"><strong>SFVM_GETPANE</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="sfvm-getzone.md"><strong>SFVM_GETZONE</strong></a><br/></td>
<td>Permite que o objeto de retorno de chamada forneça informações de zona da Internet. Usado por <a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-ishellfolderviewcb-messagesfvcb"><strong>IShellFolderViewCB:: MessageSFVCB</strong></a>.<br/></td>
</tr>
<tr class="even">
<td><a href="sfvm-queryfsnotify.md"><strong>SFVM_QUERYFSNOTIFY</strong></a><br/></td>
<td><a href="sfvm-queryfsnotify.md"><strong>SFVM_QUERYFSNOTIFY</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
<tr class="odd">
<td><a href="sfvm-setisfv.md"><strong>SFVM_SETISFV</strong></a><br/></td>
<td>Notifica o objeto de retorno de chamada do site de contêiner. Isso é usado somente quando <a href="/previous-versions/windows/internet-explorer/ie-developer/platform-apis/aa768221(v=vs.85)"><strong>IObjectWithSite:: SetSite</strong></a> não tem suporte e <a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-shcreateshellfolderviewex"><strong>SHCreateShellFolderViewEx</strong></a> é usado. Usado por <a href="/windows/desktop/api/shlobj_core/nf-shlobj_core-ishellfolderviewcb-messagesfvcb"><strong>IShellFolderViewCB:: MessageSFVCB</strong></a>.<br/></td>
</tr>
<tr class="even">
<td><a href="sfvm-thisidlist.md"><strong>SFVM_THISIDLIST</strong></a><br/></td>
<td><a href="sfvm-thisidlist.md"><strong>SFVM_THISIDLIST</strong></a> pode ser alterado ou indisponível.<br/></td>
</tr>
</tbody>
</table>
