...
Esse método é implementado e acessado por meio do método [**shell. namespace**](shell-namespace.md) .

## <a name="examples"></a>Exemplos

Os exemplos a seguir mostram o uso do [**namespace**](shell-namespace.md) no JScript, no VBScript e no Visual Basic.
