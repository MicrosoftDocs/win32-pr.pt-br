---
description: As estruturas a seguir são usadas com metaarquivos de formato avançado.
...
As estruturas a seguir são usadas com metaarquivos de formato avançado.
...
[**IDENTIFICADOR de**](/windows/win32/api/wingdi/ns-wingdi-handletable)  
[**PONTO**](/previous-versions//dd162807(v=vs.85))  
[**RECT**](/previous-versions//dd162907(v=vs.85))  
</dl> 

Observe que a estrutura [**EMR**](/windows/win32/api/wingdi/ns-wingdi-emr) é usada como o primeiro membro das estruturas restantes.  
