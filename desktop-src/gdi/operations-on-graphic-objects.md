...
Um aplicativo pode examinar os atributos de um objeto padrão chamando as funções [**GetCurrentObject**](/windows/desktop/api/Wingdi/nf-wingdi-getcurrentobject) e [**GetObject**](/windows/desktop/api/Wingdi/nf-wingdi-getobject) . A função **GetCurrentObject** retorna um identificador que identifica a caneta, o pincel, a paleta, o bitmap ou a fonte atual, e a função **GetObject** Inicializa uma estrutura que contém os atributos desse objeto.
