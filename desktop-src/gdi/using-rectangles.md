...
---
# <a name="using-rectangles-windows-gdi"></a>Usando retângulos (GDI do Windows)

O exemplo nesta seção ilustra como usar as funções de retângulo. Ele consiste no procedimento de janela principal de um aplicativo que permite que o usuário mova e dimensione um bitmap.

Quando o aplicativo é iniciado, ele desenha um bitmap de 32 pixels por 32 pixels no canto superior esquerdo da tela. O usuário pode mover o bitmap arrastando-o. Para dimensionar o bitmap, o usuário cria um retângulo de destino arrastando o mouse e, em seguida, arrasta o bitmap e "descarta" no retângulo de destino. O aplicativo responde copiando o bitmap no retângulo de destino.

O procedimento de janela que permite que o usuário mova e dimensione o bitmap é fornecido no exemplo a seguir.
