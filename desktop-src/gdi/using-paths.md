---
description: Esta seção contém um exemplo de código que permite ao usuário selecionar uma fonte de um determinado tamanho de ponto (usando a caixa de diálogo escolher fonte), selecionar um caminho de clipe (usando o texto desenhado com essa fonte) e, em seguida, exibir o resultado do recorte para o texto.
ms.assetid: 3eb5781b-972b-49a4-94db-9abda96fb195
title: Usando caminhos
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104091503"
---
# <a name="using-paths"></a><span data-ttu-id="1bb1f-103">Usando caminhos</span><span class="sxs-lookup"><span data-stu-id="1bb1f-103">Using Paths</span></span>

<span data-ttu-id="1bb1f-104">Esta seção contém um exemplo de código que permite ao usuário selecionar uma fonte de um determinado tamanho de ponto (usando a caixa de diálogo escolher fonte), selecionar um caminho de clipe (usando o texto desenhado com essa fonte) e, em seguida, exibir o resultado do recorte para o texto.</span><span class="sxs-lookup"><span data-stu-id="1bb1f-104">This section contains a code sample that enables the user to select a font of a particular point size (by using the Choose Font dialog box), select a clip path (by using text drawn with this font), and then view the result of clipping to the text.</span></span>

<span data-ttu-id="1bb1f-105">Este exemplo de código foi usado para criar a ilustração que aparece em [caminhos de clipes](clip-paths.md).</span><span class="sxs-lookup"><span data-stu-id="1bb1f-105">This code sample was used to create the illustration that appears in [Clip Paths](clip-paths.md).</span></span>
