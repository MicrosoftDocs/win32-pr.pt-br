...
---
# <a name="using-paths"></a>Usando caminhos

Esta seção contém um exemplo de código que permite ao usuário selecionar uma fonte de um determinado tamanho de ponto (usando a caixa de diálogo escolher fonte), selecionar um caminho de clipe (usando o texto desenhado com essa fonte) e, em seguida, exibir o resultado do recorte para o texto.

Este exemplo de código foi usado para criar a ilustração que aparece em [caminhos de clipes](clip-paths.md).
