---
description: Esta seção contém um código de exemplo que mostra como gerar um caminho de clipe que consiste em uma cadeia de caracteres. O exemplo cria uma fonte lógica e a usa para desenhar uma cadeia de caracteres em um caminho de clipe e, em seguida, preenche o caminho ao desenhar linhas horizontais e verticais.
ms.assetid: c71727aa-f4a3-409e-b50f-709eb4dbdaab
title: Usando recorte
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104989078"
---
# <a name="using-clipping"></a><span data-ttu-id="bc3c2-104">Usando recorte</span><span class="sxs-lookup"><span data-stu-id="bc3c2-104">Using Clipping</span></span>

<span data-ttu-id="bc3c2-105">Esta seção contém um código de exemplo que mostra como gerar um caminho de clipe que consiste em uma cadeia de caracteres.</span><span class="sxs-lookup"><span data-stu-id="bc3c2-105">This section contains example code that shows how to generate a clip path consisting of a character string.</span></span> <span data-ttu-id="bc3c2-106">O exemplo cria uma fonte lógica e a usa para desenhar uma cadeia de caracteres em um caminho de clipe e, em seguida, preenche o caminho ao desenhar linhas horizontais e verticais.</span><span class="sxs-lookup"><span data-stu-id="bc3c2-106">The example creates a logical font and uses it to draw a string within a clip path, then fills the path by drawing horizontal and vertical lines.</span></span>
...
<span data-ttu-id="bc3c2-107">Para obter um exemplo que demonstra como um aplicativo cria uma região de recorte retangular, consulte [regiões](regions.md).</span><span class="sxs-lookup"><span data-stu-id="bc3c2-107">For an example that demonstrates how an application creates a rectangular clipping region, see [Regions](regions.md).</span></span>
