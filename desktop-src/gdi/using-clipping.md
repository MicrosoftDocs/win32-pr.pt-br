...
ms.locfileid: "119037484"
---
# <a name="using-clipping"></a>Usando recorte

Esta seção contém um código de exemplo que mostra como gerar um caminho de clipe que consiste em uma cadeia de caracteres. O exemplo cria uma fonte lógica e a usa para desenhar uma cadeia de caracteres em um caminho de clipe e, em seguida, preenche o caminho ao desenhar linhas horizontais e verticais.
...
Para obter um exemplo que demonstra como um aplicativo cria uma região de recorte retangular, consulte [regiões](regions.md).
