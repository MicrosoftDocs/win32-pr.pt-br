...
Ao especificar uma cor [RGB explícita,](/windows/desktop/api/Wingdi/nf-wingdi-rgb) o **valor COLORREF** tem a seguinte forma hexadecimal:

`0x00bbggrr`

O byte de ordem baixa contém um valor para a intensidade relativa de vermelho; o segundo byte contém um valor para verde; e o terceiro byte contém um valor para azul. O byte de ordem alta deve ser zero. O valor máximo para um único byte é 0xFF.
...
Exemplo de [Windows exemplos clássicos](https://github.com/microsoft/Windows-classic-samples) em GitHub.
...
[Visão geral de cores](colors.md)
</dt> <dt>
