...
---
# <a name="creating-colored-pens-and-brushes"></a>Criando canetas e pincéis coloridos

Embora você possa especificar qualquer cor para uma caneta ao criá-la, o sistema usa apenas as cores disponíveis no dispositivo. Isso significa que o sistema usa a cor de correspondência mais próxima quando percebe a caneta para desenhar. Ao criar pincéis, o sistema gera uma cor dificada se você especificar uma cor para a qual o dispositivo não dá suporte. Em ambos os casos, você pode usar a macro [**RGB**](/windows/desktop/api/Wingdi/nf-wingdi-rgb) para especificar uma cor ao criar uma caneta ou um pincel.
