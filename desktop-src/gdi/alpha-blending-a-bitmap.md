...
ms.locfileid: "119038294"
---
# <a name="alpha-blending-a-bitmap"></a>Alfa misturando um bitmap

O exemplo de código a seguir divide uma janela em três áreas horizontais. Em seguida, ele desenha um bitmap com combinação alfa em cada uma das áreas da janela da seguinte maneira:

-   Na área superior, a constante alfa = 50%, mas não há alfa de origem.
-   Na área do meio, a constante alfa = 100% (Disabled) e a origem Alfa são 0 (transparente) no meio do bitmap e 0xFF (opaco) em outro lugar.
-   Na área inferior, a constante alfa = 75% e a fonte Alfa são alteradas.
