...
---
# <a name="opening-an-enhanced-metafile-and-displaying-its-contents"></a>Abrindo um metarquivo avançado e exibindo seu conteúdo

Esta seção contém um exemplo que demonstra como um aplicativo abre um metarquivo avançado armazenado em disco e exibe a imagem associada na área do cliente.

O exemplo usa a caixa de diálogo **abrir** comum para permitir que o usuário selecione um metarquivo avançado em uma lista de arquivos existentes. Em seguida, ele passa o nome do arquivo selecionado para a função [**GetEnhMetaFile**](/windows/desktop/api/WinGdi/nf-wingdi-getenhmetafilea) , que retorna um identificador que identifica o arquivo. Esse identificador é passado para a função [**PlayEnhMetaFile**](/windows/desktop/api/Wingdi/nf-wingdi-playenhmetafile) para exibir a imagem.
