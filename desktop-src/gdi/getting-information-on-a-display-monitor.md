---
description: O exemplo de código a seguir mostra como usar o EnumDisplayDevices para obter informações sobre um monitor de exibição.
ms.assetid: 8c2420de-292f-481e-b06b-54cc174a8faf
title: Obtendo informações em um monitor de exibição
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104988810"
---
# <a name="getting-information-on-a-display-monitor"></a><span data-ttu-id="1c2f5-103">Obtendo informações em um monitor de exibição</span><span class="sxs-lookup"><span data-stu-id="1c2f5-103">Getting Information on a Display Monitor</span></span>

<span data-ttu-id="1c2f5-104">O exemplo de código a seguir mostra como usar o [**EnumDisplayDevices**](/windows/desktop/api/Winuser/nf-winuser-enumdisplaydevicesa) para obter informações sobre um monitor de exibição.</span><span class="sxs-lookup"><span data-stu-id="1c2f5-104">The following code sample shows how to use [**EnumDisplayDevices**](/windows/desktop/api/Winuser/nf-winuser-enumdisplaydevicesa) to get information on a display monitor.</span></span>
