...
ms.locfileid: "117886719"
---
# <a name="getting-information-on-a-display-monitor"></a>Obtendo informações em um monitor de exibição

O exemplo de código a seguir mostra como usar o [**EnumDisplayDevices**](/windows/desktop/api/Winuser/nf-winuser-enumdisplaydevicesa) para obter informações sobre um monitor de exibição.
