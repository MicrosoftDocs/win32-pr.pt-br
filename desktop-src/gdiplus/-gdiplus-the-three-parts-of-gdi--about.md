---
description: 'os serviços de Windows GDI+ se enquadram nas três categorias amplas a seguir:'
...
ms.locfileid: "120014646"
---
# <a name="the-three-parts-of-gdi"></a>As três partes do GDI+

os serviços de Windows GDI+ se enquadram nas três categorias amplas a seguir:
...
A tipografia se preocupa com a exibição de texto em uma variedade de fontes, tamanhos e estilos. GDI+ fornece uma quantidade impressionante de suporte para essa tarefa complexa. um dos novos recursos do GDI+ é a anti-aliasing em subpixel, o que dá ao texto renderizado em uma tela de LCD uma aparência mais suave.
