---
description: Este tópico lista os métodos da classe PathGradientBrush. Para obter uma listagem de classe completa, consulte classe PathGradientBrushXX.
...
ms.locfileid: "104988904"
---
# <a name="pathgradientbrush-methods"></a>Métodos PathGradientBrush

Este tópico lista os métodos da classe [**PathGradientBrush**](/windows/desktop/api/gdipluspath/nl-gdipluspath-pathgradientbrush) . Para obter uma listagem de classe completa, consulte **classe PathGradientBrushXX**.

-   [**8i**](/windows/desktop/api/Gdiplusbrush/nf-gdiplusbrush-brush-clone)
...
-   [**GetCenterPoint (ponto \* )**](/windows/win32/api/gdipluspath/nf-gdipluspath-pathgradientbrush-getcenterpoint(outpoint))
...
-   [**SetCenterPoint (ponto&)**](/windows/win32/api/gdipluspath/nf-gdipluspath-pathgradientbrush-setcenterpoint(inconstpoint_))
