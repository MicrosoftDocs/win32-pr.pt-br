...
---
# <a name="rectf-methods"></a>Métodos RectF

Este tópico lista os métodos da classe [**RectF**](/windows/desktop/api/gdiplustypes/nl-gdiplustypes-rectf) . Para obter uma listagem de classe completa, consulte **classe RectF**.

-   [**8i**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rectf-clone)
...
-   [**Contém (REAL, REAL)**](/previous-versions//ms534956(v=vs.85))
-   [**É igual a**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rectf-equals)
...
-   [**Inflar (PointF&)**](/windows/win32/api/gdiplustypes/nf-gdiplustypes-rectf-inflate(inconstpointf_))
-   [**Inflar (REAL, REAL)**](/previous-versions//ms534953(v=vs.85))
...
-   [**Deslocamento (REAL, REAL)**](/windows/win32/api/gdiplustypes/nf-gdiplustypes-rectf-offset(inreal_inreal))
-   [**Unida**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rectf-union)
