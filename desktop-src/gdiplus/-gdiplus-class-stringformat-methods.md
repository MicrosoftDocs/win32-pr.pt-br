---
description: Este tópico lista os métodos da classe StringFormat. Para obter uma listagem de classe completa, consulte classe StringFormat.
...
ms.locfileid: "104967792"
---
# <a name="stringformat-methods"></a>Métodos StringFormat

Este tópico lista os métodos da classe [**StringFormat**](/windows/desktop/api/gdiplusstringformat/nl-gdiplusstringformat-stringformat) . Para obter uma listagem de classe completa, consulte **classe StringFormat**.

-   [**8i**](/windows/desktop/api/Gdiplusstringformat/nf-gdiplusstringformat-stringformat-clone)
...
-   [**Getaparando**](/windows/desktop/api/Gdiplusstringformat/nf-gdiplusstringformat-stringformat-gettrimming)
...
-   [**Setaparando**](/windows/desktop/api/Gdiplusstringformat/nf-gdiplusstringformat-stringformat-settrimming)
