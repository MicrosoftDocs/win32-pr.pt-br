---
description: Este tópico lista os métodos da classe Font. Para obter uma listagem de classe completa, consulte classe Font.
ms.assetid: 4b05c06c-1a67-4dcc-9ff7-b6c8280dc964
title: Métodos de fonte
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104988918"
---
# <a name="font-methods"></a>Métodos de fonte

Este tópico lista os métodos da classe [**Font**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-font) . Para obter uma listagem de classe completa, consulte **classe Font**.

-   [**8i**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-font-clone)
-   [**Getfamily**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-font-getfamily)
-   [**GetHeight (gráficos \* )**](/previous-versions//ms536201(v=vs.85))
