---
description: Este tópico lista os métodos da classe CustomLineCap. Para obter uma listagem de classe completa, consulte classe CustomLineCap.
ms.assetid: f0fc73f2-375b-4d7f-a0ac-1606ba6afeef
title: Métodos CustomLineCap
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104169095"
---
# <a name="customlinecap-methods"></a>Métodos CustomLineCap

Este tópico lista os métodos da classe [**CustomLineCap**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-customlinecap) . Para obter uma listagem de classe completa, consulte **classe CustomLineCap**.

-   [**8i**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-customlinecap-clone)
