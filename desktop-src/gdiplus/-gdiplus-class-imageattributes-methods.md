---
description: Este tópico lista os métodos da classe ImageAttributes. Para obter uma listagem de classes completa, consulte a classe ImageAttributes.
...
Este tópico lista os métodos da classe [**ImageAttributes**](/windows/desktop/api/gdiplusimageattributes/nl-gdiplusimageattributes-imageattributes) . Para obter uma listagem de classes completa, consulte a **classe ImageAttributes**.
...
-   [**Setgama**](/windows/desktop/api/Gdiplusimageattributes/nf-gdiplusimageattributes-imageattributes-setgamma)
...
-   [**Remapeatable**](/windows/desktop/api/Gdiplusimageattributes/nf-gdiplusimageattributes-imageattributes-setremaptable)
