---
description: Este tópico lista os métodos da classe MetafileHeader. Para obter uma listagem de classe completa, consulte classe MetafileHeader.
ms.assetid: 3a42418c-820b-46f6-bb7f-48c82520cd94
title: Métodos MetafileHeader
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104169091"
---
# <a name="metafileheader-methods"></a>Métodos MetafileHeader

Este tópico lista os métodos da classe [**MetafileHeader**](/windows/desktop/api/gdiplusmetaheader/nl-gdiplusmetaheader-metafileheader) . Para obter uma listagem de classe completa, consulte **classe MetafileHeader**.
...
-   [**Obter versão**](/windows/desktop/api/Gdiplusmetaheader/nf-gdiplusmetaheader-metafileheader-getversion)
