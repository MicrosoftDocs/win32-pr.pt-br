---
description: Este tópico lista os métodos da classe Region. Para uma listagem de classe completa, consulte Classe region.
...
ms.locfileid: "118249106"
---
# <a name="region-methods"></a>Métodos de região

Este tópico lista os métodos da [**classe Region.**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-region) Para uma listagem de classe completa, consulte **Classe region**.
...
-   [**Complementar(Região \* )**](/windows/win32/api/gdiplusheaders/nf-gdiplusheaders-region-complement(inconstregion))
...
-   [**Xor(Região \* )**](/windows/win32/api/gdiplusheaders/nf-gdiplusheaders-region-xor(inconstregion))
