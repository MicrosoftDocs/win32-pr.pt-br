---
description: Este tópico lista os métodos da classe Bitmap. Para obter uma listagem de classe completa, consulte bitmap Class.
ms.assetid: e8768602-7ea2-42c2-b2ae-9ef1d7bdd30e
title: Métodos de bitmap
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104505773"
---
# <a name="bitmap-methods"></a>Métodos de bitmap

Este tópico lista os métodos da classe [**bitmap**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-bitmap) . Para obter uma listagem de classe completa, consulte **bitmap Class**.
...
-   [**8i**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-image-clone)
...
-   [**Dofile**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-bitmap-fromfile)
-   [**Dofile**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-image-fromfile)
...
-   [**Gethistograma**](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-bitmap-gethistogram)
...
-   [**Salvar (IStream \* , CLSID \* , EncoderParameters \* )**](/windows/win32/api/gdiplusheaders/nf-gdiplusheaders-image-save(inistream_inconstclsid_inconstencoderparameters))
-   [**Salvar (WCHAR \* , CLSID \* , EncoderParameters \* )**](/previous-versions//ms535407(v=vs.85))
-   [**SaveAdd (EncoderParameters \* )**](/previous-versions//ms535408(v=vs.85))
-   [**SaveAdd (imagem \* , codificador \* )**](/windows/win32/api/gdiplusheaders/nf-gdiplusheaders-image-saveadd(inimage_inconstencoderparameters))
...
-   [**Resolution**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-bitmap-setresolution)
