...
O tópico [desenhando uma linha](-gdiplus-drawing-a-line-use.md) mostra como escrever um aplicativo do Windows que usa o Windows GDI+ para desenhar uma linha. Para desenhar uma cadeia de caracteres, substitua a função **OnPaint** mostrada no tópico pela seguinte função **OnPaint** :
