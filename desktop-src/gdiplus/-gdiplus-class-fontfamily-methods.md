---
description: Este tópico lista os métodos da classe FontFamily. Para obter uma listagem de classe completa, consulte FontFamilyClass.
ms.assetid: 170a2bac-843f-451b-b2fa-6710bf828710
title: Métodos de FontFamily
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104988916"
---
# <a name="fontfamily-methods"></a>Métodos de FontFamily

Este tópico lista os métodos da classe [**FontFamily**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-fontfamily) . Para obter uma listagem de classe completa, consulte **FontFamilyClass**.

-   [**8i**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-fontfamily-clone)
