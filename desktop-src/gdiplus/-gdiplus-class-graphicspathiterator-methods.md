---
description: Este tópico lista os métodos da classe GraphicsPathIterator. Para obter uma listagem de classe completa, consulte classe GraphicsPathIterator.
...
ms.locfileid: "104967813"
---
# <a name="graphicspathiterator-methods"></a>Métodos GraphicsPathIterator

Este tópico lista os métodos da classe [**GraphicsPathIterator**](/windows/desktop/api/gdipluspath/nl-gdipluspath-graphicspathiterator) . Para obter uma listagem de classe completa, consulte **classe GraphicsPathIterator**.
...
-   [**Retrocesso**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspathiterator-rewind)
