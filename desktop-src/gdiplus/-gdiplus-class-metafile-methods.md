---
description: Este tópico lista os métodos da classe Metafile. Para uma listagem de classe completa, consulte Classe metafile.
ms.assetid: 80a57b90-fa62-4cce-a658-f12dcbfd9d24
title: Métodos de metadados
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "119557436"
---
# <a name="metafile-methods"></a>Métodos de metadados

Este tópico lista os métodos da classe [**Metafile.**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-metafile) Para uma listagem de classe completa, consulte **Classe Metafile**.
...
-   [**GetHEN PAGEAFILE**](/windows/desktop/api/gdiplusheaders/nf-gdiplusheaders-metafile-gethenhmetafile)
...
-   [**GetMetafileHeader(HENFILEAFILE, \* MetafileHeader \* )**](/windows/win32/api/gdiplusheaders/nf-gdiplusheaders-metafile-getmetafileheader(inhenhmetafile_outmetafileheader))
