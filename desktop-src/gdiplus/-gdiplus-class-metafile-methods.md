...
---
# <a name="metafile-methods"></a>Métodos de metarquivo

Este tópico lista os métodos da classe [**Metafile**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-metafile) . Para obter uma listagem de classe completa, consulte **classe Metafile**.
