---
description: Windows GDI+ desenha linhas, retângulos e outras figuras em um sistema de coordenadas.
...
quando você usa GDI+ para desenhar uma linha, um retângulo ou uma curva, você fornece determinadas informações de chave sobre o item a ser desenhado. Por exemplo, você pode especificar uma linha fornecendo dois pontos e especificar um retângulo fornecendo um ponto, uma altura e uma largura. GDI+ trabalha em conjunto com o software de driver de vídeo para determinar quais pixels devem ser ativados para mostrar a linha, o retângulo ou a curva. A ilustração a seguir mostra os pixels que são ativados para exibir uma linha do ponto (4, 2) ao ponto (12, 8).
