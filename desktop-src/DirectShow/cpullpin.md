...
2.  Substitua o método [**CBasePin:: CheckConnect**](cbasepin-checkconnect.md) para chamar [**CPullPin:: Connect**](cpullpin-connect.md). Esse método consulta o outro PIN para **IAsyncReader**.
...
| [**Connect**](cpullpin-connect.md)                 | Conclui uma conexão com o pino de saída.                                             |
...
| [**Duration**](cpullpin-duration.md)               | Recupera a duração do fluxo.                                                 |
