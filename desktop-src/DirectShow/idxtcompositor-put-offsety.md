...
---
# <a name="idxtcompositorput_offsety-method"></a>IDxtCompositor: método UT \_ OffsetY:p
...
O `put_OffsetY` método especifica o deslocamento vertical do retângulo de destino.
...
O deslocamento vertical do retângulo de destino, em pixels.
