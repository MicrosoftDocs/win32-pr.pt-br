...
---
# <a name="iamtimelinegetduration2-method"></a>Método IAMTimeline:: GetDuration2
...
O `GetDuration2` método recupera a duração da linha do tempo. Esse método é equivalente a [**IAMTimeline:: getDuration**](iamtimeline-getduration.md), mas usa um parâmetro do tipo **Double**.
...
Recebe a duração da linha do tempo, em segundos fracionários.
