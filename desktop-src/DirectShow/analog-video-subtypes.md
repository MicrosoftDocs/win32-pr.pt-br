---
description: Os subtipos de vídeo análogos a seguir agora estão obsoletos. Em vez disso, use a enumeração AnalogVideoStandard.
ms.assetid: 67db7ee1-88ec-4e4f-be5e-8b4a7a652bca
title: Subtipos de vídeo análogos (Dshow.h)
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "117824722"
---
# <a name="analog-video-subtypes"></a>Subtipos de vídeo análogos

Os subtipos de vídeo análogos a seguir agora estão obsoletos. Em vez disso, use a enumeração [**AnalogVideoStandard.**](/windows/win32/api/strmif/ne-strmif-analogvideostandard)
