...
Os seguintes subtipos de vídeo analógico agora estão obsoletos. Em vez disso, use a enumeração [**AnalogVideoStandard**](/windows/win32/api/strmif/ne-strmif-analogvideostandard) .
