...
---
# <a name="cbasecontrolvideoget_sourceheight-method"></a>CBaseControlVideo. obter \_ método SourceHeight
...
Essa função de membro implementa o método [**IBasicVideo:: get \_ SourceHeight**](/windows/desktop/api/Control/nf-control-ibasicvideo-get_sourceheight) .
