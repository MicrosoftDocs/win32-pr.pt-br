...
---
# <a name="idxtjpegget_replicatex-method"></a>Método IDxtJpeg:: get \_ ReplicateX
...
O `get_ReplicateX` método recupera o número de vezes que o padrão de apagamento é replicado horizontalmente.
...
Recebe o número de vezes que o padrão de apagamento é replicado horizontalmente.
