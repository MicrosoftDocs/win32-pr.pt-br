...
---
# <a name="hong-kong-sar-channel-assignments"></a>Atribuições de canal de Rae de Hong Kong

Este tópico lista as tabelas de frequência usadas para ajuste de TV analógica para RAE de Hong Kong.
