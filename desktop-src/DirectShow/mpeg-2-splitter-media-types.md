...
| Subtype          | **Vídeo do MEDIASUBTYPE \_ MPEG2 \_**           | **Vídeo do MEDIASUBTYPE \_ MPEG2 \_** |
...
|                  | Saída de PES                    | Saída da carga                 |
| Tipo principal       | **MEDIATYPE \_ MPEG2 \_ PES**     | **Áudio de MEDIATYPE \_**           |
| Subtype          | **\_Áudio MEDIASUBTYE MPEG2 \_** | **\_Áudio MEDIASUBTYPE MPEG2 \_** |
| Tipo de formato      | **WaveFormatEx de formato \_**      | **WaveFormatEx de formato \_**       |
...
|                  | Saída de PES                         | Saída da carga                     |
| Tipo principal       | **MEDIATYPE \_ MPEG2 \_ PES**          | **Áudio de MEDIATYPE \_**               |
| Subtype          | **\_áudio MEDIASUBTYPE DVD \_ LPCM \_** | **\_áudio MEDIASUBTYPE DVD \_ LPCM \_** |
| Tipo de formato      | **WaveFormatEx de formato \_**           | **WaveFormatEx de formato \_**           |
| Estrutura de formato | **WAVEFORMATEX**                   | **WAVEFORMATEX**                   |
