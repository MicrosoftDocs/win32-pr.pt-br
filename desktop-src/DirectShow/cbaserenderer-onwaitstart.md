...
O [**método CBaseRenderer::WaitForRenderTime**](cbaserenderer-waitforrendertime.md) chama esse método quando ele começa a aguardar o tempo de apresentação de uma amostra. Esse método não faz nada na classe base, mas a classe derivada pode substituí-la.
