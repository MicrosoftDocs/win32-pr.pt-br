---
description: Defina as propriedades do alocador como parte da gravação de um filtro de transformação. O pino de saída do filtro de transformação seleciona o alocador downstream.
