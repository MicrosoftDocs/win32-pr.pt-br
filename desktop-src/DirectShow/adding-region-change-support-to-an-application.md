---
description: Adicionando suporte a Region-Change a um aplicativo
ms.assetid: 4a5c049d-b59f-4130-9252-bc28662a7931
title: Adicionando suporte a Region-Change a um aplicativo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104163846"
---
# <a name="adding-region-change-support-to-an-application"></a><span data-ttu-id="287fd-103">Adicionando suporte a Region-Change a um aplicativo</span><span class="sxs-lookup"><span data-stu-id="287fd-103">Adding Region-Change Support to an Application</span></span>

<span data-ttu-id="287fd-104">As funções a seguir são fornecidas para os desenvolvedores que desejam integrar o suporte de alteração de região em seus decodificadores ou aplicativos de DVD.</span><span class="sxs-lookup"><span data-stu-id="287fd-104">The following functions are provided for developers who wish to integrate region-change support into their decoders or DVD applications.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="287fd-105">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="287fd-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="287fd-106">Suporte à alteração da região do DVD no Windows</span><span class="sxs-lookup"><span data-stu-id="287fd-106">DVD Region Change Support in Windows</span></span>](dvd-region-change-support-in-windows.md)
</dt> </dl>
