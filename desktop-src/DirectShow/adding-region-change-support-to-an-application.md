...
---
# <a name="adding-region-change-support-to-an-application"></a>Adicionando suporte a Region-Change a um aplicativo

As funções a seguir são fornecidas para os desenvolvedores que desejam integrar o suporte de alteração de região em seus decodificadores ou aplicativos de DVD.
