...
| <span id="MEDIATYPE_File"></span><span id="mediatype_file"></span><span id="MEDIATYPE_FILE"></span><dl> <dt>**\_Arquivo MediaType**</dt> </dl>                                     | Grupo. Substituí<br/>                                                                               |
...
| <span id="MEDIATYPE_Timecode"></span><span id="mediatype_timecode"></span><span id="MEDIATYPE_TIMECODE"></span><dl> <dt>**Código de pamídia de MEDIATYPE \_**</dt> </dl>                     | Dados de código de pafica. Observação: o DirectShow não fornece nenhum filtro que ofereça suporte a esse tipo de mídia.<br/>     |
