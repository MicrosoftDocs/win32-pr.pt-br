...
---
# <a name="ec_dvd_title_set_change"></a>\_alteração de \_ definição de título de DVD do EC \_ \_

Enviado quando o conjunto de títulos de vídeo atual (VTS) é alterado.
...
O novo número do conjunto de título do vídeo (VTSN).
