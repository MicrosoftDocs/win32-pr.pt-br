---
description: O método \_ get BorderColor recupera a cor da borda em torno das bordas do padrão de apagador.
...
O `get_BorderColor` método recupera a cor da borda em torno das bordas do padrão de apagando.
