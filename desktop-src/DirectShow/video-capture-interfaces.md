...
Essas interfaces dão suporte à captura de vídeo, usando os dispositivos WDM (Microsoft® Windows® Driver Model) ou os dispositivos Microsoft® Video para Windows® (VFW) herdados.
