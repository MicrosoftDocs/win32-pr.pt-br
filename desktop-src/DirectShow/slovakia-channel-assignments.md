...
---
# <a name="slovakia-channel-assignments"></a>As atribuições de canal da Eslováquia

Este tópico lista as tabelas de frequência usadas para ajuste de TV analógica para a Eslováquia.
