...
---
# <a name="idxtcompositorput_srcwidth-method"></a>IDxtCompositor: método UT \_ SrcWidth:p
...
O `put_SrcWidth` método especifica a largura do retângulo de origem.
...
A largura do retângulo de origem, em pixels.
