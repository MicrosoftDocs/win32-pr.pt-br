...
O `GetSrcAtTime2` método recupera o objeto de origem mais próximo ao tempo especificado, de acordo com as condições de limite especificadas. Esse método é equivalente a [**IAMTimelineTrack:: GetSrcAtTime**](iamtimelinetrack-getsrcattime.md), mas usa um valor de [**REFTIME**](reftime.md) .
...
Hora de início da pesquisa, em segundos.
