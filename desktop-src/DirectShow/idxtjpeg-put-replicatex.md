...
---
# <a name="idxtjpegput_replicatex-method"></a>IDxtJpeg: método UT \_ ReplicateX:p
...
O `put_ReplicateX` método especifica o número de vezes que o padrão de apagamento é replicado horizontalmente.
...
O número de vezes que o padrão de apagamento é replicado horizontalmente.
