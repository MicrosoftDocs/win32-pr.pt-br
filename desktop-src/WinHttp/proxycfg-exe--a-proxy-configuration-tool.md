...
**HKEY \_ \_computador LOCAL** \\ **SOFTWARE** \\ **Microsoft** \\ **Windows** \\ **CurrentVersion** \\ **Internet Configurações** \\ **conexões** \\ **WinHttpSettings**
