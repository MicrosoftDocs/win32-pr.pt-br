...
Mensagens de erro específicas para as funções do WinHTTP. Essas funções também retornam mensagens de erro do Windows quando apropriado. O valor que corresponde a cada constante é o valor da constante para as funções da API (interface de programação de aplicativo) e os 16 bits inferiores do número do erro para o objeto [**WinHttpRequest**](winhttprequest.md) .
