...
ms.locfileid: "119682906"
---
# <a name="http-server-sample-application"></a>Aplicativo de exemplo do servidor HTTP

O aplicativo de exemplo a seguir mostra como usar a API do servidor HTTP para executar tarefas do lado do servidor. O arquivo "precomp. h" incluído no primeiro exemplo inclui todos os cabeçalhos necessários para executar os exemplos, por exemplo:
...
## <a name="main-and-preliminaries"></a>Principal e etapas preliminares
...
## <a name="cleanup-the-http-server-api"></a>Limpar a API do servidor HTTP
...
## <a name="receive-a-request"></a>Receber uma solicitação
...
## <a name="send-an-http-response"></a>Enviar uma resposta HTTP
...
## <a name="send-an-http-post-response"></a>Enviar uma resposta HTTP POST
