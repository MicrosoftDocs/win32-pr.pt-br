---
title: Excluindo uma reserva
description: O processo para remover uma reserva começa com uma verificação de acesso que é idêntica à descrita acima. A ID de usuário do processo de chamada deve ter direitos de acesso ao nó pai da entrada de reserva que está sendo excluída.
