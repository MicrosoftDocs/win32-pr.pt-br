...
Define a porcentagem de remoção de imagem do lado inferior. Leitura/gravação. **VgNumber**.
...
<v: *Element* cropbottom = " *expressão* " >

**Sintaxe do script**

*Element* . cropbottom = "*expressão*"

*expressão* = de *elemento*. cropbottom
...
Nenhuma imagem será exibida porque a imagem é 100% cortada da parte inferior.
