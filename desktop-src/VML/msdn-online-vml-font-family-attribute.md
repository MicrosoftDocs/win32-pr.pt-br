...
---
# <a name="vml-font-family-attribute"></a>Atributo Font-Family de VML
...
*elemento* . Style. FontFamily = "*expressão*"

*expressão* = de *elemento*. Style. FontFamily

**Comentários**

Define o nome da fonte. Nomes específicos como Arial podem ser usados ou tipos genéricos como serif, sans-serif, cursivo, fantasia ou monospace. Os valores são os mesmos que os atributos de estilo HTML padrão.
