---
title: Notificações comuns da caixa de diálogo
description: . | Notificações comuns da caixa de diálogo
...
ms.locfileid: "117720946"
---
# <a name="common-dialog-box-notifications"></a>Notificações comuns da caixa de diálogo

## <a name="in-this-section"></a>Nesta seção

-   [**\_CDN Fileok**](cdn-fileok.md)
-   [**\_CDN FOLDERCHANGE**](cdn-folderchange.md)
-   [**\_CDN Ajuda**](cdn-help.md)
