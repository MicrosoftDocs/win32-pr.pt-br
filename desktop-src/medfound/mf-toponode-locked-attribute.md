...
---
# <a name="mf_toponode_locked-attribute"></a>\_Atributo TOPONODE MF \_ bloqueado

Especifica se os tipos de mídia podem ser alterados neste nó de topologia.
...
Se o valor desse atributo for diferente de zero, o carregador de topologia não alterará os tipos de mídia. Esse atributo é definido como **true** quando o nó está em uso.
