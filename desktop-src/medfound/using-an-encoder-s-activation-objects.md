---
description: para converter arquivos de mídia em formato ASF, você pode usar Windows codificadores de mídia. Saiba mais sobre como usar objetos de ativação de um codificador.
...
para converter arquivos de mídia em formato ASF, você pode usar Windows codificadores de mídia. Para usar esses codificadores, eles devem ser registrados com o sistema.
...
-   [**MFCreateWMAEncoderActivate**](/windows/desktop/api/wmcontainer/nf-wmcontainer-mfcreatewmaencoderactivate) para instanciar o codificador de áudio de mídia Windows.
-   [**MFCreateWMVEncoderActivate**](/windows/desktop/api/wmcontainer/nf-wmcontainer-mfcreatewmvencoderactivate) para instanciar o codificador de vídeo de mídia Windows.
