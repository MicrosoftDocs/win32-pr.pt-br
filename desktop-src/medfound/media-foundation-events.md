...
| [MEAudioSessionDisconnected](meaudiosessiondisconnected.md)                                 | A sessão de áudio foi desconectada de uma sessão dos serviços de terminal do Windows                                                                              |
...
| [MEAudioSessionGroupingParamChanged](meaudiosessiongroupingparamchanged.md)                 | Os parâmetros de agrupamento foram alterados para a sessão de áudio.                                                                                                   |
...
| [MEAudioSessionServerShutdown](meaudiosessionservershutdown.md)                             | O sistema de servidor de áudio do Windows foi desligado.                                                                                                           |
| [MEAudioSessionVolumeChanged](meaudiosessionvolumechanged.md)                               | O estado de volume ou mudo da sessão de áudio foi alterado                                                                                                    |
| [MEBufferingStarted](mebufferingstarted.md)                                                 | Uma fonte de mídia começou a armazenar dados em buffer.                                                                                                                   |
| [MEBufferingStopped](mebufferingstopped.md)                                                 | Uma origem de mídia parou de armazenar em buffer os dados.                                                                                                                   |
| [MECaptureAudioSessionDeviceRemoved](mecaptureaudiosessiondeviceremoved.md)                 | O dispositivo foi removido.                                                                                                                                  |
| [MECaptureAudioSessionDisconnected](mecaptureaudiosessiondisconnected.md)                   | A sessão de áudio está desconectada porque o usuário fez logoff de uma sessão dos serviços de terminal do Windows (WTS).                                            |
| [MECaptureAudioSessionExclusiveModeOverride](mecaptureaudiosessionexclusivemodeoverride.md) | O usuário abriu um fluxo de áudio em modo exclusivo.                                                                                                       |
| [MECaptureAudioSessionFormatChanged](mecaptureaudiosessionformatchanged.md)                 | O formato de áudio foi alterado.                                                                                                                                |
| [MECaptureAudioSessionServerShutdown](mecaptureaudiosessionservershutdown.md)               | O servidor de sessão de áudio é desligado.                                                                                                                       |
| [MECaptureAudioSessionVolumeChanged](mecaptureaudiosessionvolumechanged.md)                 | O volume foi alterado.                                                                                                                                      |
| [MEConnectEnd](meconnectend.md)                                                             | A origem da rede terminou de abrir uma URL.                                                                                                               |
| [MEConnectStart](meconnectstart.md)                                                         | A origem da rede iniciou a abertura de uma URL.                                                                                                                |
...
| [MEEnablerCompleted](meenablercompleted.md)                                                 | Uma ação do objeto habilitador de conteúdo foi concluída.                                                                                                           |
| [MEEnablerProgress](meenablerprogress.md)                                                   | Sinaliza o progresso de um objeto de habilitador de conteúdo.                                                                                                        |
| [MEEndOfPresentation](meendofpresentation.md)                                               | Gerado por uma origem de mídia quando uma apresentação termina.                                                                                                       |
...
| [MEError](meerror.md)                                                                       | Sinaliza um erro sério.                                                                                                                                 |
...
| [MENewStream](menewstream.md)                                                               | Gerado por uma origem de mídia quando ele inicia um novo fluxo.                                                                                                    |
...
| [MEQualityNotify](mequalitynotify.md)                                                       | Fornece comentários sobre a qualidade de reprodução para o Gerenciador de qualidade.                                                                                         |
| [MEReconnectEnd](mereconnectend.md)                                                         | Gerado por uma origem de mídia no final de uma tentativa de reconexão.                                                                                           |
| [MEReconnectStart](mereconnectstart.md)                                                     | Gerado por uma fonte de mídia no início de uma tentativa de reconexão.                                                                                         |
| [MERendererEvent](merendererevent.md)                                                       | Gerado pelo processador de vídeo avançado (EVR) quando ele recebe um evento de usuário do apresentador.                                                            |
...
| [MESessionEnded](mesessionended.md)                                                         | Gerado pela sessão de mídia quando termina a reprodução da última apresentação na fila de reprodução.                                                    |
