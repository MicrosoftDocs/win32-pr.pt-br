...
---
# <a name="mfnetsource_playeruseragent-property"></a>\_Propriedade MFNETSOURCE PLAYERUSERAGENT

O valor da segunda parte do campo "cs (User-Agent)" que a fonte de rede usa para o registro em log. Os aplicativos podem definir essa propriedade como qualquer valor de cadeia de caracteres.
...
A constante **MFNETSOURCE \_ PLAYERUSERAGENT** define o GUID para essa chave de propriedade. O identificador de propriedade (PID) é zero.
