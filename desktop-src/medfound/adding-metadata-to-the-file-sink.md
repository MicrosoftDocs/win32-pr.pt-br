---
description: Saiba como adicionar metadados ao coletor de arquivos ASF, que um aplicativo pode usar para arquivar dados de mídia ASF em um arquivo.
