...
Gerado pelo processador de áudio quando a sessão de áudio é desconectada de uma sessão dos serviços de terminal do Windows (WTS). O processador de áudio agora é inválido.
