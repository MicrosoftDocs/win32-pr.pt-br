...
---
# <a name="mfpkey_wmaaecma_featr_echo_length-property"></a>\_Propriedade de \_ comprimento de \_ eco \_ do MFPKEY WMAAECMA
...
O valor padrão é 256 milissegundos, o que é suficiente para a maioria dos ambientes domésticos e do Office. Antes de definir essa propriedade, você deve definir a propriedade [ \_ modo de \_ recurso \_ MFPKEY WMAAECMA](mfpkey-wmaaecma-feature-modeproperty.md) como Variant \_ true.
