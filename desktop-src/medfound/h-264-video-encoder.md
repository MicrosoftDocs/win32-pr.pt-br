...
-   Perfil Principal
-   Perfil alto (requer o Windows 8)
...
<li><strong>eAVEncH264VProfile_High</strong> (requer o Windows 8)</li>
</ul></td>
</tr>
<tr class="even">
...
As propriedades a seguir exigem o Windows 8.
...
<td>Define o tamanho do buffer, em bytes, para a codificação de taxa de bits constante (CBR).<br/> O intervalo válido é [1... 2 ³ ² – 1]. <br/> Requer o Windows 8. <br/></td>
</tr>
<tr class="odd">
...
|---------------------------------------|-----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Taxa de bits constante (CBR)               | **eAVEncCommonRateControlMode_CBR**                | O codificador tenta atingir uma taxa de bits constante, usando um modelo de "Bucket de vazamentos". A taxa de bits de destino é fornecida pela propriedade [CODECAPI_AVEncCommonMeanBitRate](../directshow/avenccommonmeanbitrate-property.md) . <br/> Requer o Windows 8. <br/> |
| Taxa de bits de variável restrita (VBR)   | **eAVEncCommonRateControlMode_PeakConstrainedVBR** | O codificador usa um modelo de "Bucket de vazamentos" com uma taxa de bits de pico. A taxa de descarga para o Bucket de vazamento é fornecida pela propriedade [CODECAPI_AVEncCommonMaxBitRate](../directshow/avenccommonmaxbitrate-property.md) . <br/> Requer o Windows 8. <br/>     |
...
Os modos de CBR e VBR restrita exigem o Windows 8.
...
As seguintes propriedades do Windows 8 e Windows 8.1 **ICodecAPI** são necessárias:
...
As seguintes propriedades do Windows 8 e Windows 8.1 **ICodecAPI** são opcionais, mas são testadas em HCK, se houver suporte.
