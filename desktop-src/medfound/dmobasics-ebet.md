...
-   Definir o tipo de saída no DMO para transmitir as características da mídia compactada que são entregues por um codificador DMO e as características da mídia descompactada que são entregues por um DMO.
