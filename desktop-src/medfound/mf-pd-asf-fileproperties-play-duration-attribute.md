...
---
# <a name="mf_pd_asf_fileproperties_play_duration-attribute"></a>\_Atributo de \_ \_ duração de reprodução de arquivo MF PD ASF \_ \_

Especifica o tempo necessário para reproduzir um arquivo ASF (Advanced Systems Format), em unidades de 100 nanossegundos.

Esse valor inclui o tempo de preversão. Para recuperar a duração real da reprodução, obtenha o valor do atributo de [**\_ \_ duração de PD do MF**](mf-pd-duration-attribute.md) . No entanto, se o valor de preroll for maior que a duração da reprodução, o valor da **\_ \_ duração de PD de MF** será zero.
