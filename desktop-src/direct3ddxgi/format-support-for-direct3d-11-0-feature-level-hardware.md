---
description: Esta seção especifica os formatos ([**DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) valores) que têm suporte no hardware do nível de recurso do Direct3D 11,0.
ms.assetid: 735CDA40-557F-4D47-87B7-97A8E120B9D2
title: Suporte de formato para hardware 11.0 do Nível de Recursos do Direct3D
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "117909976"
---
# <a name="format-support-for-direct3d-feature-level-110-hardware"></a>Suporte de formato para hardware 11.0 do Nível de Recursos do Direct3D

Esta seção especifica os formatos ([**DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) valores) que têm suporte no hardware do nível de recurso do Direct3D 11,0.
...
| RenderTarget | ![exigido](images/letter-r.jpg) |
| RenderTarget blendable | \- |
| Operação lógica de fusão de saída | ![opcionais](images/letter-o.jpg) |
| Destino de profundidade/estêncil | \- |
| UAV e SRV brutos | \- |
| UAV estruturado e SRV | \- |
| UAV digitado | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r16g16b16a16_typelesssuppcssup-9"></a>DXGI_FORMAT_R16G16B16A16 \_ <sup>PCS SEM TIPO</sup> (9)
| Destino | Suporte |
| - | - |
...
| Ops bits UAV atômicas | \- |
| UAV Atomic CMP&Store/CMP&Exch | \- |
| Exchange Atomic UAV | ![exigido](images/letter-r.jpg) |
| Mínimo de UAV assinado por Atomic/Max | \- |
| UAV atômico sem sinal mínimo/máximo | \- |
| Bloqueáveis de CPU | ![exigido](images/letter-r.jpg) |
| 4x multiamostrar RenderTarget | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r24g8_typelesssuppcssup-44"></a>DXGI_FORMAT_R24G8 \_ <sup>PCS SEM TIPO</sup> (44)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 32 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r24_unorm_x8_typelesssupfcssup-46"></a>DXGI_FORMAT_R24 FCS SEM TIPO \_ \_ UNORM X8 \_ (46)<sup></sup>
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 32 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r8g8_typelesssuppcssup-48"></a>DXGI_FORMAT_R8G8 \_ <sup>PCS SEM TIPO</sup> (48)
| Destino | Suporte |
| - | - |
...
## <a name="dxgi_format_r8g8_unormsupfcssup-49"></a>DXGI_FORMAT_R8G8 \_ <sup>FCS</sup> UNORM (49)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 16 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_r8g8_snormsupfcssup-51"></a>DXGI_FORMAT_R8G8 \_ <sup>FCS</sup> SNORM (51)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 16 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc1_typelesssuppccsup-70"></a>DXGI_FORMAT_BC1 \_ <sup>PCC</sup> SEM TIPO (70)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 64 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc1_unorm-supfccsup-71"></a>DXGI_FORMAT_BC1 \_ UNORMFC <sup></sup> (71)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 64 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc3_unorm-supfccsup-77"></a>DXGI_FORMAT_BC3 \_ UNORMFC <sup></sup> (77)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 128 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc3_unorm_srgb-supfccsup-78"></a>DXGI_FORMAT_BC3 \_ UNORM \_ SRGB <sup>CANON</sup> (78)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 128 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc4_typelesssuppccsup-79"></a>DXGI_FORMAT_BC4 \_ <sup>PCC</sup> SEM TIPO (79)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 64 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc4_unorm-supfccsup-80"></a>DXGI_FORMAT_BC4 \_ UNORMFC <sup></sup> (80)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 64 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc4_snorm-supfccsup-81"></a>DXGI_FORMAT_BC4 \_ SNORMFC <sup></sup> (81)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 64 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_b5g6r5_unormsupfnssup-85"></a>DXGI_FORMAT_B5G6R5 \_ <sup>FNS</sup> UNORM (85)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 16 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
| RenderTarget 4x Multisample | ![exigido](images/letter-r.jpg) |
| 8x RenderTarget multisample | ![exigido](images/letter-r.jpg) |
| Outros RT de Contagem Multisample | ![exigido](images/letter-r.jpg) |
| Resolução multisample | ![exigido](images/letter-r.jpg) |
| Carregamento de vários exemplos | ![exigido](images/letter-r.jpg) |
| Exibir Scan-Out | \- |
| Cast dentro do layout de bit | \- |
...
## <a name="dxgi_format_bc6h_typelesssuppccsup-94"></a>DXGI_FORMAT_BC6H \_ <sup>PCC</sup> SEM TIPO (94)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 128 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
## <a name="dxgi_format_bc6h_uf16-supfccsup-95"></a>DXGI_FORMAT_BC6H \_ UF16 <sup>LTDA</sup> (95)
| Destino | Suporte |
| - | - |
| Bits por elemento (BPE) | 128 |
| Suporte ao formato | ![exigido](images/letter-r.jpg) |
...
<sup>L:</sup> formato sem tipo
</dt> <dt>

<sup>PCS:</sup> layout parcialmente digitado, castizável e simples
</dt> <dt>

 <sup>FCS:</sup> layout totalmente digitado, castizável e simples
</dt> <dt>

<sup>FNS:</sup> layout totalmente digitado, não castível e simples
</dt> <dt>

<sup>PCC:</sup> layout parcialmente digitado, castizável e complexo
</dt> <dt>

 <sup>DIGIT:</sup> layout totalmente digitado, castizável e complexo
</dt> <dt>

<sup>FNC:</sup> layout totalmente digitado, não castível e complexo
</dt> <dt>
...
[Níveis de recursos de hardware D3D12](../direct3d12/hardware-feature-levels.md)
