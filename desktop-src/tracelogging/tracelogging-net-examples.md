---
title: Exemplos de rastreamento do .NET
description: Este tópico contém um exemplo de Rastreamento de código gerenciado que ilustra como registrar um evento somente quando o nível de detalhes da sessão é detalhado e como registrar dados de evento estruturados.
...
ms.locfileid: "118966515"
---
# <a name="net-tracelogging-examples"></a>Exemplos de rastreamento do .NET

Este tópico contém um exemplo de Rastreamento de código gerenciado que ilustra como registrar um evento somente quando o nível de detalhes da sessão é detalhado e como registrar dados de evento estruturados.
