...
consulte [gravar e exibir eventos do TraceLogging](tracelogging-record-and-display-tracelogging-events.md) para obter informações sobre como capturar e exibir dados do TraceLogging usando as versões internas mais recentes do WPT (ferramentas de desempenho do Windows).
