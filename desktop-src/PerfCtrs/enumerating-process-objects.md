---
description: O exemplo a seguir chama a função PdhEnumObjectItems para enumerar as instâncias e os contadores dos objetos de processo no computador local.
ms.assetid: d7518ba6-a0f1-4985-aa2c-1ca15a0ceb02
title: Enumerando objetos de processo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105783253"
---
# <a name="enumerating-process-objects"></a><span data-ttu-id="1f977-103">Enumerando objetos de processo</span><span class="sxs-lookup"><span data-stu-id="1f977-103">Enumerating Process Objects</span></span>

<span data-ttu-id="1f977-104">O exemplo a seguir chama a função [**PdhEnumObjectItems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) para enumerar as instâncias e os contadores dos objetos de processo no computador local.</span><span class="sxs-lookup"><span data-stu-id="1f977-104">The following example calls the [**PdhEnumObjectItems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) function to enumerate the instances and counters of the process objects on the local computer.</span></span>
