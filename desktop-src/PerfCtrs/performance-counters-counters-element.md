...
Identifica o nó raiz da seção de contadores de um manifesto de instrumentação.
...
O nó pai deste elemento é o elemento de [**Instrumentação**](/windows/desktop/WES/eventmanifestschema-instrumentationtype-complextype) do manifesto.
