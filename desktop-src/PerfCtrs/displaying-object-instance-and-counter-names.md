...
ms.locfileid: "120033916"
---
# <a name="displaying-object-instance-and-counter-names"></a>Exibindo nomes de objeto, instância e contador

Se desejar exibir uma lista de objetos e seus contadores em uma interface do usuário, você deverá recuperar os dados de desempenho. Os dados de desempenho contêm um número variável de objetos de desempenho e suas instâncias e contadores. Para obter informações sobre o formato dos dados de desempenho, consulte [formato de dados de desempenho](performance-data-format.md).

Os dados de desempenho não contêm os nomes de objeto e contador. Em vez disso, os dados contêm valores de índice que você usa para recuperar os nomes dos objetos e contadores, que são armazenados em recursos conhecidos da infraestrutura de contadores de desempenho. No entanto, os nomes de instância são armazenados em dados de desempenho. Para obter um exemplo que lê os nomes de objeto e contador do registro e cria uma tabela de índice para acessar os nomes posteriormente, consulte [recuperando nomes de contador e texto de ajuda](retrieving-counter-names-and-help-text.md).

O exemplo a seguir mostra como recuperar o objeto, a instância e os blocos de contadores dos dados de desempenho. Depois de recuperar os nomes de objeto, nomes de instância e nomes de contadores, o exemplo classifica os objetos por nome e para cada objeto, classifica suas instâncias e contadores por nome. Em seguida, o exemplo imprime as listas classificadas.
