...
---
# <a name="browsing-performance-counters"></a>Procurando contadores de desempenho

O exemplo a seguir mostra como chamar [**PdhBrowseCounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) para procurar contadores de desempenho. O exemplo também mostra como coletar e formatar dados brutos do contador para exibição.
