...
| 0xC0000BDE (PDH \_ inválido \_ SQLDB)                             | Banco de Dados SQL não contém um conjunto válido de tabelas para Perfmon.
| 0xC0000BDF (PDH \_ sem \_ contadores)                               | nenhum contador foi encontrado para este conjunto de logs de SQL Perfmon.
| 0xC0000BE0 ( \_ \_ falha na alocação de SQL de PDH \_ )                         | Falha na chamada para SQLAllocStmt com %1.
| 0xC0000BE1 (PDH \_ SQL \_ ALLOCCON \_ falhou)                      | Falha na chamada para SQLAllocConnect com %1.
| falha de 0xC0000BE2 (PDH \_ SQL \_ EXEC \_ DIRECT \_ )                  | Falha na chamada a SQLExecDirect com %1.
| 0xC0000BE3 ( \_ \_ falha na busca de SQL de PDH \_ )                         | Falha na chamada a SQLFetch com %1.
| 0xC0000BE4 (PDH \_ SQL \_ ROWCOUNT \_ falhou)                      | Falha na chamada a SQLRowCount com %1.
| 0xC0000BE5 (PDH \_ SQL \_ mais \_ resultados \_ com falha)                 | Falha na chamada para SQLMoreResults com %1.
| 0xC0000BE6 ( \_ \_ falha na conexão do PDH SQL \_ )                       | Falha na chamada para SQLConnect com %1.
| 0xC0000BE7 ( \_ \_ falha na associação de SQL de PDH \_ )                          | Falha na chamada para SQLBindCol com %1.
...
| 0xC0000BF5 ( \_ formato de LOG de SQL inválido do PDH \_ \_ \_ )                  | o formato do log de SQL está incorreto. O formato correto é `SQL:<DSN-name>!<LogSet-Name>` .
...
| 0xC0000BFC ( \_ contador de acréscimo sem correspondência de PDH \_ \_ )                 | Ambos os arquivos devem ter contadores idênticos para anexar.
| 0xC0000BFD (PDH \_ SQL ALTER \_ DETAIL \_ \_ FAILED)                 | Não é possível alterar o layout da tabela CounterDetail SQL banco de dados.
| 0xC0000BFE (PDH \_ QUERY \_ PERF \_ DATA \_ TIMEOUT)                 | O sistema está ocupado. Ocorreu um tempo decorrida ao coletar dados do contador. Tentar novamente mais tarde ou aumentar o valor do Registro **CollectTime.**
