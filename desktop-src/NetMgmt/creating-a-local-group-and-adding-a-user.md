...
---
# <a name="creating-a-local-group-and-adding-a-user"></a>Criando um grupo local e adicionando um usuário

Para criar um novo grupo local, chame a função [**NetLocalGroupAdd**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) . Para adicionar um usuário a esse grupo, chame a função [**NetLocalGroupAddMembers**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) .

O programa a seguir permite que você crie um usuário e um grupo local e adicione o usuário ao grupo local.
