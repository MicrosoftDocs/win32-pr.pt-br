...
| [**GetColorProfileFromHandle**](/windows/win32/api/icm/getcolorprofilefromhandle)                         | Recupera o conteúdo do perfil de cor dado um identificador para um perfil de cor aberta.                                                                        |
...
| [**WcsCheckColors**](/windows/win32/api/icm/nf-icm-wcsassociatecolorprofilewithdevice)                                               | Determina se as cores em uma matriz ficam dentro da gama de saída de uma transformação de cor WCS especificada.                                            |
...
| [**WcsGetDefaultRenderingIntent**](/windows/win32/api/icm/nf-icm-wcsgetdefaultrenderingintent) | Retorna o usuário ou a tentativa de processamento em todo o sistema.                                                                                                    |
...
| [**WcsSetCalibrationManagementState**](/windows/win32/api/icm/nf-icm-wcssetcalibrationmanagementstate) | Habilita ou desabilita o gerenciamento do sistema do estado de calibragem de vídeo.                                                                              |
...
| [**WcsSetDefaultRenderingIntent**](/windows/win32/api/icm/nf-icm-wcssetdefaultrenderingintent) | Define o usuário ou a tentativa de renderização em todo o sistema.                                                                                                       |
| [**WcsSetUsePerUserProfiles**](/windows/win32/api/icm/nf-icm-wcssetuseperuserprofiles)                           | Permite que o usuário especifique se deseja ou não usar uma lista de associação de perfil por usuário para o dispositivo especificado.                                       |
