...
consulte o [exemplo de DMO de captura de voz de alta qualidade da Microsoft](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Win7Samples/multimedia/audio/aecmicarray).
