---
description: Saiba mais sobre considerações de implementação para roteamento de fluxo. As APIs implementam o roteamento de fluxo manipulando a alternância de fluxo para um novo ponto de extremidade de áudio padrão.
