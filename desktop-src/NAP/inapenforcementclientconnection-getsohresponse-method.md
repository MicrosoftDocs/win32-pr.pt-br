...
O método **INapEnforcementClientConnection:: GetSoHResponse** obtém o SoH-Response recebido pelo cliente de imposição.
...
Um ponteiro para um ponteiro para uma estrutura [**NetworkSoHResponse**](/windows/win32/api/naptypes/ns-naptypes-networksoh) exclusiva, que é um blob de dados opaco para o aplicador.
...
Um pacote de tamanho de zero byte é válido.
