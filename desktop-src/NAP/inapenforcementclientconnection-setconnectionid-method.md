...
description: É usado para definir a ID exclusiva da conexão e deve ser definido pelo cliente de imposição assim que a conexão for criada.
ms.assetid: 69d1a891-bc86-4c8a-b614-ebcdaa4a9057
keywords:
- NAP do método SetConnectionId
...
O **método INapEnforcementClientConnection::SetConnectionId** é usado para definir a ID exclusiva da conexão e deve ser definido pelo cliente de imposição assim que a conexão for criada.
...
Essa ConnectionID é usada principalmente para fins de registro em log.
