...
description: É usado pelo executor para definir dados privados.
ms.assetid: 56f6fec7-47ec-4b2c-b8c8-a4d519ba0f91
keywords:
- Nap do método SetEnforcerPrivateData
- Método NAP setEnforcerPrivateData, interface INapEnforcementClientConnection
...
O **método INapEnforcementClientConnection::SetEnforcerPrivateData** é usado pelo executor para definir dados privados.
...
Um ponteiro para um blob de dados opaco [**PrivateData**](/windows/win32/api/naptypes/ns-naptypes-privatedata) que somente o executor pode interpretar.
