...
Veja a seguir um exemplo de [programa de configuração de serviço](service-configuration-programs.md).

Ao criar o exemplo, certifique-se de vincular com Kernel32. lib e Advapi32. lib.
