...
ms.locfileid: "119493786"
---
# <a name="glgettexgenfv-function"></a>função glGetTexGenfv

As funções [**glGetTexGendv**](glgettexgendv.md), **glGetTexGenfv** e [**glGetTexGeniv**](glgettexgeniv.md) retornam parâmetros de geração de coordenadas de textura.
