...
description: Especifica a posição de raster para operações de pixel. | Função glRasterPos2fv (Gl.h)
...
Um ponteiro para uma matriz de dois elementos, especificando coordenadas x e y para a posição de raster atual.
