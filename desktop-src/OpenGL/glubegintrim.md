...
As funções **gluBeginTrim** e [**gluEndTrim**](gluendtrim.md) delimitam uma definição de loop de corte de B-spline racional não uniforme ([NURBS](using-nurbs-curves-and-surfaces.md)).
