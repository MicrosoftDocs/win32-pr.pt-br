...
description: A função glLightModeli define parâmetros de modelo de iluminação.
...
ms.locfileid: "119493086"
---
# <a name="gllightmodeli-function"></a>Função glLightModeli

A [**função glLightModeli define**](gllightf.md) parâmetros de modelo de iluminação.
...
A **função glLightModeli define** o parâmetro do modelo de iluminação. O *parâmetro pname* nomeia um parâmetro *e o parâmetro param* fornece o novo valor.o valor ou os valores de parâmetros de fonte de luz individuais.
...
As funções a seguir recuperam informações relacionadas à **função glLightModeli:**
