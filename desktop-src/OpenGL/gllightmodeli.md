...
A função [**glLightModeli**](gllightf.md) define os parâmetros do modelo de iluminação.
...
A função **glLightModeli** define o parâmetro do modelo de iluminação. O parâmetro *pname* nomeia um parâmetro e *param* fornece o novo valor. o valor ou os valores de parâmetros de fonte de luz individuais.
