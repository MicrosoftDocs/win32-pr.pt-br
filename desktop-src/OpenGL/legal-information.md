...
Microsoft, MS-DOS, Windows, Windows NT e Win32 são marcas registradas ou marcas comerciais de Microsoft Corporation no Estados Unidos e/ou em outros países.

TrueType é uma marca registrada da Apple Computer, Inc.

UNIX é uma marca registrada do Grupo Aberto.

Partes da Silicon Graphics, Inc. do Guia *de Programação OpenGL* e do *Manual de Referência do OpenGL.* Reimpresso com permissão da Silicon Graphics, Inc.
