...
---
# <a name="glindexdv-function"></a>função glIndexdv

A função **glIndexdv** define o índice de cores atual.
...
A função **glIndexdv** atualiza o índice de cores atual (de valor único). Ele usa um argumento: o novo valor para o índice de cores atual.
...
O índice atual pode ser atualizado a qualquer momento. Em particular, **glIndexdv** pode ser chamado entre uma chamada para [**glBegin**](/windows/desktop/OpenGL/glbegin) e a chamada correspondente para [**glEnd**](glend.md).

A função a seguir recupera informações relacionadas a **glIndexdv**:
