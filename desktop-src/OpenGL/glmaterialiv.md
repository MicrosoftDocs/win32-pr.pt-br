...
A função **glMaterialiv** especifica os parâmetros materiais para o modelo de iluminação.
...
Os parâmetros de material podem ser atualizados a qualquer momento. Em particular, [**glMaterialiv**](glmaterialf.md) pode ser chamado entre uma chamada para [**glBegin**](glbegin.md) e a chamada correspondente para [**glEnd**](glend.md). Se apenas um parâmetro de material único for alterado por vértice, no entanto, [**glColorMaterial**](glcolormaterial.md) será preferencial em relação a **glMaterialiv**.
