...
---
# <a name="glrasterpos2sv-function"></a>função glRasterPos2sv
...
Um ponteiro para uma matriz de dois elementos, especificando coordenadas x e y para a posição de rasterização atual.
