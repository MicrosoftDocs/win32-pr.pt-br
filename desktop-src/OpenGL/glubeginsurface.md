...
ms.locfileid: "118613041"
---
# <a name="glubeginsurface-function"></a>função gluBeginSurface

As funções **gluBeginSurface** e [**gluEndSurface**](gluendsurface.md) delimitam uma definição de superfície de B-spline racional não uniforme ([NURBS](using-nurbs-curves-and-surfaces.md)).
...
As funções [**gluBeginTrim**](glubegintrim.md), [**gluPwlCurve**](glupwlcurve.md), [**gluNurbsCurve**](glunurbscurve.md)e [**GLUENDTRIM**](gluendtrim.md) dão suporte à remoção de superfícies NURBS.
