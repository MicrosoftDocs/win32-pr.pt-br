...
description: Especifica a posição de raster para operações de pixel. | Função glRasterPos3s (Gl.h)
...
ms.locfileid: "117795067"
---
# <a name="glrasterpos3s-function"></a>Função glRasterPos3s
