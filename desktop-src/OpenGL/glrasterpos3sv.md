...
description: Especifica a posição de raster para operações de pixel. | Função glRasterPos3sv (Gl.h)
...
Um ponteiro para uma matriz de três elementos, especificando coordenadas x, y e z para a posição de raster atual.
