...
ms.locfileid: "119741606"
---
# <a name="glgetmapiv-function"></a>função glGetMapiv

As funções [**glGetMapdv**](glgetmapdv.md), [**glGetMapfv**](glgetmapfv.md)e **glGetMapiv** retornam parâmetros do avaliador.
...
As funções **glGetMap** retornam parâmetros do avaliador. (As funções **glMap1** e **glMap2** definem avaliadores.) O parâmetro de *destino* especifica um mapa, a *consulta* seleciona um parâmetro específico e o *v* aponta para o armazenamento onde os valores serão retornados.
