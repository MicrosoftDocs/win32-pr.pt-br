...
As funções **glEnable** e [**glDisable**](gldisable.md) habilitam ou desabilitam os recursos do OpenGL.
...
As funções **glEnable** e **glDisable** habilitam e desabilitam vários recursos gráficos OpenGL. Use [**glIsEnabled**](glisenabled.md) ou [**glGet**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) para determinar a configuração atual de qualquer recurso.

**GlEnable** e **glDisable** usam um único argumento, *Cap*, que pode assumir um dos seguintes valores:
