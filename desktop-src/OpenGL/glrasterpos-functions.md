---
title: Funções glRasterPos
description: Essas funções especificam a posição da varredura para operações de pixel.
ms.assetid: 2a661893-0818-441d-9399-0103560737c3
keywords:
- OpenGL, funções glRasterPos
- Referência OpenGL, funções glRasterPos
- referência para OpenGL, funções glRasterPos
- OpenGL, funções de varredura
- Referência OpenGL, funções de varredura
- referência para OpenGL, funções de varredura
- funções glRasterPos
- funções de vetor de varredura
- OpenGL, funções de pixel
- Referência OpenGL, funções de pixel
- referência para OpenGL, funções de pixel
- pixels, funções
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119492556"
---
# <a name="glrasterpos-functions"></a>Funções glRasterPos

Essas funções especificam a posição da varredura para operações de pixel:
