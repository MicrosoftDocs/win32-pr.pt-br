...
ms.locfileid: "118359762"
---
# <a name="glgettexlevelparameteriv-function"></a>função glGetTexLevelParameteriv

As funções [**glGetTexLevelParameterfv**](glgettexlevelparameterfv.md) e **glGetTexLevelParameteriv** retornam valores de parâmetro de textura para um nível específico de detalhes.
