...
---
# <a name="glgetlightiv-function"></a>função glGetLightiv

As funções [**glGetLightfv**](glgetlightfv.md) e **glGetLightiv** retornam valores de parâmetro de fonte de luz.
