...
description: Especifica a posição de raster para operações de pixel. | Função glRasterPos2i (Gl.h)
...
ms.locfileid: "119492506"
---
# <a name="glrasterpos2i-function"></a>Função glRasterPos2i
...
Especifica a coordenada X para a posição de raster atual.
...
Especifica a coordenada y para a posição atual do raster.
