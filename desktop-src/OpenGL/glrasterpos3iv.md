...
---
# <a name="glrasterpos3iv-function"></a>função glRasterPos3iv
...
Um ponteiro para uma matriz de três elementos, especificando coordenadas x, y e z para a posição de rasterização atual.
