...
---
# <a name="an-x-window-system-opengl-program"></a>Um programa OpenGL do sistema de janelas X

O programa a seguir é um programa OpenGL do sistema de janelas X com o mesmo código OpenGL usado no AUXEDEMO. Programa de exemplo C fornecido com o SDK da plataforma Microsoft. Compare este programa com o programa OpenGL do Windows no [programa portado para o Windows](the-program-ported-to-win32.md).
