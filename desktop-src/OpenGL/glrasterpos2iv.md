...
description: Especifica a posição de raster para operações de pixel. | Função glRasterPos2iv (Gl.h)
...
ms.locfileid: "119492516"
---
# <a name="glrasterpos2iv-function"></a>Função glRasterPos2iv
