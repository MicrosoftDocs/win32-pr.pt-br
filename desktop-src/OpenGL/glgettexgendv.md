...
ms.locfileid: "119493796"
---
# <a name="glgettexgendv-function"></a>função glGetTexGendv

As funções **glGetTexGendv**, [**glGetTexGenfv**](glgettexgenfv.md)e [**glGetTexGeniv**](glgettexgeniv.md) retornam parâmetros de geração de coordenadas de textura.
