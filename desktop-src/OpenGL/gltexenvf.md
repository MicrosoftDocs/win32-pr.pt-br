...
ms.locfileid: "118613648"
---
# <a name="gltexenvf-function"></a>função glTexEnvf

A função **glTexEnvf** define um parâmetro de ambiente de textura.
...
A função a seguir recupera informações relacionadas a **glTexEnvf**:
