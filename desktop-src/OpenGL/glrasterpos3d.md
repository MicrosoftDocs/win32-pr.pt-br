...
description: Especifica a posição de raster para operações de pixel. | Função glRasterPos3d (Gl.h)
...
ms.locfileid: "119519976"
---
# <a name="glrasterpos3d-function"></a>Função glRasterPos3d
