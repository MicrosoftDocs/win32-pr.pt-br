...
description: Especifica a posição de raster para operações de pixel. | Função glRasterPos3i (Gl.h)
...
ms.locfileid: "118358296"
---
# <a name="glrasterpos3i-function"></a>Função glRasterPos3i
