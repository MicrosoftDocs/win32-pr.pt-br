...
O nome simbólico do parâmetro a ser definido. Seis dos parâmetros de armazenamento afetam o modo como os dados de pixel são retornados à memória do cliente e, portanto, são significativos apenas para comandos [**glReadPixels**](glreadpixels.md) . Eles são os seguintes.
