...
ms.locfileid: "120128196"
---
# <a name="glmultmatrixf-function"></a>função glMultMatrixf

As funções [**glMultMatrixd**](glmultmatrixd.md) e **glMultMatrixf** multiplicam a matriz atual por uma matriz arbitrária.
