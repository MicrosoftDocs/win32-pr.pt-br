...
As funções [**glPushClientAttrib**](glpushclientattrib.md) e **glPopClientAttrib** salvam e restauram grupos de variáveis de estado do cliente na pilha de atributos do cliente.
