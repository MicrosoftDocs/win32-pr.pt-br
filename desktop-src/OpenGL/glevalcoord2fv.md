...
ms.locfileid: "119888356"
---
# <a name="glevalcoord2fv-function"></a>função glEvalCoord2fv

A função **glEvalCoord2fv** avalia os mapas bidimensionais habilitados.
...
A função **glEvalCoord2fv** avalia os mapas bidimensionais habilitados usando dois valores de domínio, *u* e *v*. Defina mapas com [**glMap1**](glmap1.md). Habilite ou desabilite-os com [**glEnable**](glenable.md) e [**glDisable**](gldisable.md).
...
Se a geração normal automática estiver habilitada, **glEvalCoord2fv** chamará [**glEnable**](glenable.md) com o argumento GL \_ automático \_ normal para gerar Normals de superfície de modo analítico, independentemente do conteúdo ou da habilitação do \_ mapa normal do GL map2 \_ . Permitir
...
As funções a seguir recuperam informações relacionadas à função **glEvalCoord2fv** :
