...
---
# <a name="glloadmatrixd-function"></a>função glLoadMatrixd

As funções **glLoadMatrixd** e [**glLoadMatrixf**](glloadmatrixf.md) substituem a matriz atual por uma matriz arbitrária.
