---
title: Função glMap2f (Gl.h)
description: A função glMap2f define um avaliador bidimensional. | função glMap2f (GL. h)
ms.assetid: 804fbf65-98a8-41af-8c39-5b83f3d341b0
keywords:
- função glMap2f OpenGL
topic_type:
- apiref
api_name:
- glMap2f
...
ms.locfileid: "119741376"
---
# <a name="glmap2f-function"></a>função glMap2f

As funções [**glMap2d**](glmap2d.md) e **glMap2f** definem um avaliador bidimensional.
