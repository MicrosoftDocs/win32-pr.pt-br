...
description: Especifica a posição de raster para operações de pixel. | Função glRasterPos2f (Gl.h)
...
ms.locfileid: "119492496"
---
# <a name="glrasterpos2f-function"></a>Função glRasterPos2f
