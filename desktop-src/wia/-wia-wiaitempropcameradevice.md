---
description: Windows Os dispositivos de hardware WIA (Aquisição de Imagem) têm valores de propriedade armazenados no Windows registro. Para obter mais informações, consulte Constantes comuns de propriedade do dispositivo.
ms.assetid: 7893137b-194c-4ea1-b15c-59d2f41f972a
title: Constantes de propriedade do dispositivo da câmera (Wiadef.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "122624192"
---
# <a name="camera-device-property-constants"></a>Constantes de propriedade do dispositivo de câmera

Windows Os dispositivos de hardware WIA (Aquisição de Imagem) têm valores de propriedade armazenados no Windows registro. Para obter mais informações, consulte [**Common Device Property Constants**](-wia-wiaitempropcommondevice.md).

As constantes de propriedade do dispositivo a seguir, com suas cadeias de caracteres associadas, são específicas para câmeras digitais. O prefixo "WIA DPC" indica uma propriedade de dispositivo para câmeras e é a convenção de \_ \_ nomenlagem usada em C/C++. Para fins de script, essas constantes usam o prefixo "CameraDevice" e fazem parte do tipo enumerado [WiaItemPropertyId.](-wia-wiaitempropertyid.md) O nome do membro correspondente dessa enumeração de script aparece entre parênteses ao lado do nome constante C/C++ na lista a seguir.
...
<td >O número de imagens que a câmera fez. O minidriver cria e mantém essa propriedade.<br/> Tipo: <strong>VT_I4</strong>, Acesso: Somente Leitura, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_NONE</a><br/></td>
</tr>
<tr class="even">
...
<td >O número de imagens que podem ser tiradas, considerando as configurações de propriedade atuais. Se essas configurações mudarem e as alterações afetarem o tamanho das imagens que o dispositivo de câmera produz, o minidriver WIA deverá atualizar o número de imagens restantes. O minidriver cria e mantém essa propriedade.<br/> Tipo: <strong>VT_I4</strong>, Acesso: Somente Leitura, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_NONE</a><br/></td>
</tr>
<tr class="odd">
...
<td >Indica o modo de exposição atual da câmera. Um aplicativo altera essa propriedade para controlar o modo de exposição do dispositivo de câmera.<br/> Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a><br/> A tabela a seguir tem as sete constantes que são válidas com essa propriedade.<br/> 
<table>
<thead>
<tr class="header">
...
<td>A velocidade do obturador e a abertura são definidas automaticamente pela câmera.</td>
</tr>
<tr class="odd">
...
<td>A velocidade do obturador e a abertura são definidas automaticamente pela câmera, otimizadas para o assunto ainda.</td>
</tr>
<tr class="even">
<td>EXPOSUREMODE_PROGRAM_ACTION</td>
<td>A velocidade do obturador e a abertura são definidas automaticamente pela câmera, otimizadas para cenas que contêm movimento rápido.</td>
</tr>
<tr class="odd">
<td>EXPOSUREMODE_PORTRAIT</td>
<td>A velocidade do obturador e a abertura são definidas automaticamente pela câmera, otimizadas para fotografia retrato.</td>
</tr>
</tbody>
</table>
...
<td ><p>Permite o ajuste do ponto definido do controle de exposição automática da câmera digital. Por exemplo, uma configuração de zero não altera o nível de exposição automática do conjunto de fábrica. As unidades estão em &quot; &quot; paradas que são dimensionadas por um fator de 1000, para permitir valores de parada fracionária. Uma configuração de 2000 corresponde a duas paradas mais de exposição (quatro vezes mais energia no sensor), ingando imagens mais interessantes. Uma configuração de -1000 corresponde a uma exposição de parada menor (metade da energia no sensor) que produz imagens mais escuras. Os valores de configuração estão em unidades APEX (Sistema Aditivo de Exposição DeSalotiva). Essa propriedade pode ser expressa como uma lista ou um intervalo de valores. Normalmente, essa propriedade é usada somente quando o dispositivo tem a <strong>propriedade WIA_DPC_EXPOSURE_MODE</strong> definida como EXPOSUREMODE_MANUAL.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_RANGE</a> ou WIA_PROP_LIST</p></td>
</tr>
<tr class="odd">
...
<td ><p>Corresponde à velocidade do obturador, em segundos, dimensionada em 10.000. Normalmente, o dispositivo usa essa propriedade somente quando a <strong>propriedade WIA_DPC_EXPOSURE_MODE</strong> é definida como EXPOSUREMODE_MANUAL ou EXPOSUREMODE_SHUTTER_PRIORITY.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_RANGE</a> ou WIA_PROP_LIST</p></td>
</tr>
<tr class="even">
...
<td ><p>Corresponde à abertura da lente, em unidades do número f-stop dimensionado em 100. A configuração dessa propriedade normalmente é válida somente quando a <strong>propriedade WIA_DPC_EXPOSURE_MODE</strong> é definida como EXPOSUREMODE_MANUAL ou EXPOSUREMODE_APERTURE_PRIORITY.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a></p></td>
</tr>
<tr class="odd">
...
<td ><p>Define a configuração de modo flash atual para o dispositivo de câmera. O driver de dispositivo enumera os valores com suporte dessa propriedade. Um aplicativo grava essa propriedade para definir o modo flash para o dispositivo de câmera.</p>
...
<td>O dispositivo de câmera determina as configurações de flash adequadas.</td>
</tr>
<tr class="even">
<td>FLASHMODE_FILL</td>
<td>O dispositivo de câmera está configurado para piscar, independentemente das condições de iluminação atuais.</td>
</tr>
<tr class="odd">
<td>FLASHMODE_OFF</td>
<td>O dispositivo de câmera está configurado <em>para não</em> piscar para nenhuma imagem tirada.</td>
</tr>
<tr class="even">
<td>FLASHMODE_REDEYE_AUTO</td>
<td>O dispositivo de câmera determina as configurações de flash adequadas usando a redução de olho vermelho, independentemente das condições de iluminação atuais.</td>
</tr>
<tr class="odd">
<td>FLASHMODE_REDEYE_FILL</td>
<td>O dispositivo de câmera está configurado para usar redução de olho vermelho e flash, independentemente das condições de iluminação atuais.</td>
</tr>
<tr class="even">
...
<td ><p>Define a configuração de modo de foco atual para o dispositivo de câmera. O driver de dispositivo enumera os valores com suporte dessa propriedade. Um aplicativo grava essa propriedade para definir o modo de foco para o dispositivo de câmera.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a></p>
...
<td ><p>Define a fonte de energia atual para o dispositivo de câmera. Um aplicativo lê essa propriedade para determinar qual fonte de energia a câmera está usando.</p>
...
<td>O dispositivo de câmera está operando na energia da bateria.</td>
</tr>
</tbody>
</table>
...
<td ><p>O percentual de energia da bateria que resta para operar o dispositivo de câmera. Esse valor deve ser um inteiro de 0 a 100. Um aplicativo lê essa propriedade para determinar a vida útil restante da bateria do dispositivo de câmera.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Somente Leitura, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_NONE</a></p></td>
</tr>
<tr class="odd">
...
<td ><p>A largura, em pixels, de uma imagem em miniatura a ser usada para imagens capturadas recentemente. Um aplicativo lê esse valor para obter um tamanho estimado para exibir miniaturas em sua interface do usuário.</p>
<p>Tipo: <strong>VT_I4,</strong>Acesso: Leitura/Gravação (<a href="-wia-property-attributes.md">WIA_PROP_LIST</a>) ou Somente Leitura (WIA_PROP_NONE), Valores válidos: WIA_PROP_LIST ou WIA_PROP_NONE</p></td>
</tr>
<tr class="even">
...
<td ><p>A largura em pixels a ser usada para imagens capturadas recentemente. A lista de valores válidos para essa propriedade tem uma correspondência um-para-um para a lista de valores válidos para a <strong>propriedade WIA_DPC_PICT_HEIGHT.</strong> Se a largura e a altura individuais são linearmente definidas e ortogonais umas com as outras, elas podem ser expressas como um intervalo.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a> ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="even">
...
<td ><p>A altura em pixels a ser usada para imagens capturadas recentemente. A lista de valores válidos para essa propriedade tem uma correspondência um-para-um com a lista de valores válidos para a <strong>WIA_DPC_PICT_WIDTH</strong> propriedade. Se a largura e a altura individuais são linearmente definidas e ortogonais umas com as outras, elas podem ser expressas como um intervalo.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a> ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="odd">
...
<td ><p>Destinado a ser aproximadamente linear em relação à qualidade da imagem percebida em uma ampla gama de conteúdo de cena e contém um intervalo ou uma lista de inteiros. Inteiros menores são usados para representar a qualidade mais baixa (ou seja, compactação máxima), enquanto inteiros maiores são usados para representar maior qualidade (ou seja, compactação mínima). Todas as configurações disponíveis em um dispositivo são relativas somente a esse dispositivo e, portanto, são específicas do dispositivo.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a> ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="odd">
...
<td ><p>O tempo, em milissegundos, entre capturas de imagem em uma operação de captura com tempo de tempo.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_NONE,</a>WIA_PROP_LIST ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="odd">
...
<td ><p>O número de imagens que o dispositivo tenta capturar durante uma captura de tempo de tempo.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_NONE,</a>WIA_PROP_LIST ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="even">
...
<td ><p>O tempo, em milissegundos, entre capturas de imagem durante uma operação de estouro.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_NONE,</a>WIA_PROP_LIST ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="odd">
...
<td ><p>O número de imagens que o dispositivo tenta capturar durante uma operação de estouro.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_NONE,</a>WIA_PROP_LIST ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="even">
...
<td ><p>Especifica o modo de aquisição de imagem especial da câmera.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a></p>
<p>A tabela a seguir tem as três constantes que são válidas com essa propriedade.</p>
...
<td>Capture uma imagem no modo padrão para a câmera.</td>
</tr>
<tr class="even">
<td>EFFECTMODE_BW</td>
...
<td ><p>A sharpness percebida de uma imagem capturada. Essa propriedade pode usar uma lista de valores ou um intervalo de valores. O valor mínimo representa a menor quantidade de sharpness, enquanto o valor máximo representa a sharpness máxima. Normalmente, um valor no meio do intervalo representa a sharpness normal ou padrão.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a> ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="odd">
...
<td ><p>O contraste percebido de uma imagem capturada. Essa propriedade pode conter uma lista de valores ou um intervalo de valores. O valor mínimo com suporte representa a menor quantidade de contraste, enquanto o valor máximo representa o maior contraste. Normalmente, um valor no meio do intervalo representa o contraste normal ou padrão.</p>
<p>Tipo: <strong>VT_I4</strong>, Acesso: Leitura/Gravação, Valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a> ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="even">
...
<td ><p>Define o modo de captura de imagem.</p>
...
<td ><p>Permite a emulação de configurações de velocidade de filme em uma câmera digital. As configurações correspondem às designações ISO (ASA/DIN). Normalmente, um dispositivo dá suporte a valores enumerados discretos, mas o controle contínuo sobre um intervalo de valores é possível. Um valor de 0xFFFF corresponde à configuração automática de ISO.</p>
<p>Tipo: <strong>VT_I4</strong>, Access: leitura/gravação, valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a> ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="odd">
...
<td ><p>Especifica o modo que a câmera usa para ajustar automaticamente a configuração de exposição.</p>
<p>Tipo: <strong>VT_I4</strong>, Access: leitura/gravação, valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a></p>
...
<td ><p>Especifica o modo que a câmera usa para ajustar o foco automaticamente.</p>
<p>Tipo: <strong>VT_I4</strong>, Access: leitura/gravação, valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a></p>
<p>A tabela a seguir tem as duas constantes que são válidas com essa propriedade.</p>
...
<td ><p>A distância, em milímetros, entre o plano de captura de imagem da câmera digital e o ponto de foco. Um valor de 0xFFFF corresponde a uma configuração maior que 655 metros.</p>
<p>Tipo: <strong>VT_I4</strong>, Access: leitura/gravação, valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a> ou WIA_PROP_RANGE</p></td>
</tr>
<tr class="even">
...
<td ><p>O comprimento focal 35mm-equivalente. Os valores dessa propriedade correspondem ao comprimento focal em milímetros multiplicado por 100. O comprimento focal determina o zoom óptico.</p>
...
<td ><p>Uma cadeia de caracteres Unicode terminada em nulo que representa o lucro vermelho, verde e azul aplicado aos dados da imagem, respectivamente. Por exemplo, &quot; 4:25:50 &quot; representa um lucro vermelho de 4, um lucro verde de 25 e um lucro azul de 50.</p>
...
<td ><p>Especifica como a câmera digital pondera os canais de cor.</p>
<p>Tipo: <strong>VT_I4</strong>, Access: leitura/gravação, valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_LIST</a></p>
...
<td ><p>Descreve uma URL. A URL descrita por esse proroperty é aquela que as imagens ou os objetos, depois de serem adquiridos do dispositivo, podem ser carregados para – de acordo com um dos cenários a seguir.</p>
<ul>
...
<td ><p>O nome do proprietário (que é o usuário atual) do dispositivo. O dispositivo usa essa propriedade para popular o campo artista em todas as imagens EXIF capturadas.</p>
<p>Tipo: <strong>VT_BSTR</strong>, Access: leitura/gravação, valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_NONE</a></p></td>
</tr>
<tr class="odd">
...
<td ><p>A notificação de direitos autorais. O dispositivo usa essa propriedade para popular o campo de direitos autorais em cada imagem de EXIF capturada.</p>
<p>Tipo: <strong>VT_BSTR</strong>, Access: leitura/gravação, valores válidos: <a href="-wia-property-attributes.md">WIA_PROP_NONE</a></p></td>
</tr>
</tbody>
</table>
