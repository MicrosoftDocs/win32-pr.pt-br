...
| <span id="WiaItemTypeBurst"></span><span id="wiaitemtypeburst"></span><span id="WIAITEMTYPEBURST"></span><dl> <dt>**WiaItemTypeBurst**</dt> </dl>                                                                                     | Somente para pastas. As imagens nesta pasta foram executadas em uma sequência de tempo contínua. *Não há suporte para essa constante em* Windows Vista *e posterior.*<br/>                                                                                                                                       |
...
| <span id="WiaItemTypeHasAttachments"></span><span id="wiaitemtypehasattachments"></span><span id="WIAITEMTYPEHASATTACHMENTS"></span><dl> <dt>**WiaItemTypeHasAttachments**</dt> </dl>                                                 | O item tem anexos de arquivo. *Não há suporte para essa constante em* Windows Vista *e posterior.*<br/>                                                                                                                                                                                          |
| <span id="WiaItemTypeHPanorama"></span><span id="wiaitemtypehpanorama"></span><span id="WIAITEMTYPEHPANORAMA"></span><dl> <dt>**WiaItemTypeHPanorama**</dt> </dl>                                                                     | O item representa uma imagem panorâmica horizontal. *Não há suporte para essa constante em* Windows Vista *e posterior.*<br/>                                                                                                                                                                       |
...
| <span id="WiaItemTypeVideo"></span><span id="wiaitemtypevideo"></span><span id="WIAITEMTYPEVIDEO"></span><dl> <dt>**WiaItemTypeVideo**</dt> </dl>                                                                                     | O item representa vídeo de streaming. *Essa constante não é suportada por nenhum* Windows Server 2003 *,* Windows Vista *ou posterior.*<br/>                                                                                                                                                      |
| <span id="WiaItemTypeVPanorama"></span><span id="wiaitemtypevpanorama"></span><span id="WIAITEMTYPEVPANORAMA"></span><dl> <dt>**WiaItemTypeVPanorama**</dt> </dl>                                                                     | O item representa uma imagem panorâmica vertical. *Não há suporte para essa constante em* Windows Vista *e posterior.*<br/>                                                                                                                                                                         |
