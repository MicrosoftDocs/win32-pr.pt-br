---
description: Esta seção contém informações de referência para os elementos de API que são fornecidos pela aquisição de imagens do Windows (WIA).
ms.assetid: c06aaff5-f603-4316-81ac-091203e96ad7
title: Interface de programação de aplicativo WIA
ms.topic: article
ms.date: 05/31/2018
