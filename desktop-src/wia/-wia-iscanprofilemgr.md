...
| Método                                                                              | Descrição                                                                                                            |
|:------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------|
| [**CreateProfile**](-wia-iscanprofilemgr-createprofile.md)                         | Cria um perfil de verificação vazio e o associa a um scanner ou outro item WIA 2.0.<br/>                       |
...
| [**DeleteProfile**](-wia-iscanprofilemgr-deleteprofile.md)                         | Exclui o perfil de verificação especificado.<br/>                                                                         |
| [**GetDefaultProfile**](-wia-iscanprofilemgr-getdefaultprofile.md)                 | Obtém o perfil de verificação padrão.<br/>                                                                              |
...
| [**GetProfiles**](-wia-iscanprofilemgr-getprofiles.md)                             | Obtém todos os perfis de verificação disponíveis para o usuário no sistema em que seu aplicativo está sendo executado.<br/>     |
...
| [**Atualizar**](-wia-iscanprofilemgr-refresh.md)                                     | Enumera todos os perfis de verificação no sistema.<br/>                                                          |
