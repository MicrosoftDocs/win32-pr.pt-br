...
---
# <a name="wiaitempropertyid"></a><span data-ttu-id="50567-103">WiaItemPropertyId</span><span class="sxs-lookup"><span data-stu-id="50567-103">WiaItemPropertyId</span></span>

<span data-ttu-id="50567-104">A maioria das constantes da propriedade de aquisição de imagem do Windows (WIA) é agrupada em um tipo de dados enumerado, WiaItemPropertyId para autores de script.</span><span class="sxs-lookup"><span data-stu-id="50567-104">Most of the Windows Image Acquisition (WIA) property constants are grouped in one enumerated data type, WiaItemPropertyId for scripting authors.</span></span>

<span data-ttu-id="50567-105">A tabela a seguir apresenta o mapeamento entre as convenções de nomenclatura usadas em script e C++.</span><span class="sxs-lookup"><span data-stu-id="50567-105">The following table presents the mapping between the naming conventions used in scripting and C++.</span></span> <span data-ttu-id="50567-106">Por exemplo, no script, o prefixo "CameraDevice" mapeia para o prefixo "DPC de WIA \_ " para a constante de C++ correspondente.</span><span class="sxs-lookup"><span data-stu-id="50567-106">For example, in script the "CameraDevice" prefix maps to the "WIA\_DPC" prefix for the corresponding C++ constant.</span></span> <span data-ttu-id="50567-107">Em um exemplo mais específico, a propriedade "CameraDeviceFlashMode" é equivalente à constante "modo de \_ flash DPC WIA \_ \_ " C++.</span><span class="sxs-lookup"><span data-stu-id="50567-107">In a more specific example, the "CameraDeviceFlashMode" property is equivalent to the C++ "WIA\_DPC\_FLASH\_MODE" constant.</span></span> <span data-ttu-id="50567-108">Consulte os tópicos constantes de propriedade correspondente para obter descrições de cada propriedade.</span><span class="sxs-lookup"><span data-stu-id="50567-108">See the corresponding property constant topics for descriptions of each property.</span></span> 

| <span data-ttu-id="50567-109">Prefixo do script</span><span class="sxs-lookup"><span data-stu-id="50567-109">Script Prefix</span></span>  | <span data-ttu-id="50567-110">Tópico do C++ (prefixo)</span><span class="sxs-lookup"><span data-stu-id="50567-110">C++ Topic (prefix)</span></span>                                                                    |
|----------------|---------------------------------------------------------------------------------------|
| <span data-ttu-id="50567-111">Dispositivo</span><span class="sxs-lookup"><span data-stu-id="50567-111">Device</span></span>         | [<span data-ttu-id="50567-112">**Constantes de propriedade de dispositivo comum ( \_ DPA WIA)**</span><span class="sxs-lookup"><span data-stu-id="50567-112">**Common Device Property Constants (WIA\_DPA)**</span></span>](-wia-wiaitempropcommondevice.md)   |
| <span data-ttu-id="50567-113">CameraDevice</span><span class="sxs-lookup"><span data-stu-id="50567-113">CameraDevice</span></span>   | [<span data-ttu-id="50567-114">**Constantes de Propriedade do dispositivo Camera (DPC do WIA \_ )**</span><span class="sxs-lookup"><span data-stu-id="50567-114">**Camera Device Property Constants (WIA\_DPC)**</span></span>](-wia-wiaitempropcameradevice.md)   |
| <span data-ttu-id="50567-115">ScannerDevice</span><span class="sxs-lookup"><span data-stu-id="50567-115">ScannerDevice</span></span>  | [<span data-ttu-id="50567-116">**Constantes de propriedade de dispositivo do scanner (DPS do WIA \_ )**</span><span class="sxs-lookup"><span data-stu-id="50567-116">**Scanner Device Property Constants (WIA\_DPS)**</span></span>](-wia-wiaitempropscannerdevice.md) |
| <span data-ttu-id="50567-117">VideoDevice</span><span class="sxs-lookup"><span data-stu-id="50567-117">VideoDevice</span></span>    | [<span data-ttu-id="50567-118">**Constantes de propriedade de dispositivo WIA de vídeo (WIA \_ DPV)**</span><span class="sxs-lookup"><span data-stu-id="50567-118">**Video WIA Device Property Constants (WIA\_DPV)**</span></span>](-wia-wiaitempropvideodevice.md) |
| <span data-ttu-id="50567-119">Picture</span><span class="sxs-lookup"><span data-stu-id="50567-119">Picture</span></span>        | [<span data-ttu-id="50567-120">**Constantes de propriedade de item WIA comuns (WIA \_ IPA)**</span><span class="sxs-lookup"><span data-stu-id="50567-120">**Common WIA Item Property Constants (WIA\_IPA)**</span></span>](-wia-wiaitempropcommonitem.md)   |
| <span data-ttu-id="50567-121">CameraPicture</span><span class="sxs-lookup"><span data-stu-id="50567-121">CameraPicture</span></span>  | [<span data-ttu-id="50567-122">**Constantes da Propriedade Item WIA da câmera ( \_ IPC WIA)**</span><span class="sxs-lookup"><span data-stu-id="50567-122">**Camera WIA Item Property Constants (WIA\_IPC)**</span></span>](-wia-wiaitempropcameraitem.md)   |
| <span data-ttu-id="50567-123">ScannerPicture</span><span class="sxs-lookup"><span data-stu-id="50567-123">ScannerPicture</span></span> | [<span data-ttu-id="50567-124">**Constantes de propriedade de item do scanner WIA ( \_ IPS WIA)**</span><span class="sxs-lookup"><span data-stu-id="50567-124">**Scanner WIA Item Property Constants (WIA\_IPS)**</span></span>](-wia-wiaitempropscanneritem.md) |



 

<span data-ttu-id="50567-125">O exemplo a seguir fornece o tipo enumerado completo com os nomes correspondentes.</span><span class="sxs-lookup"><span data-stu-id="50567-125">The following example provides the complete enumerated type with the corresponding names.</span></span>
