...
---
# <a name="publisher-configuration-file-schema"></a><span data-ttu-id="08d11-103">Esquema do arquivo de configuração do Publicador</span><span class="sxs-lookup"><span data-stu-id="08d11-103">Publisher Configuration File Schema</span></span>

<span data-ttu-id="08d11-104">A seguir está a lista completa do esquema do arquivo de configuração do Publicador.</span><span class="sxs-lookup"><span data-stu-id="08d11-104">The following is the complete listing of the publisher configuration file schema.</span></span>
