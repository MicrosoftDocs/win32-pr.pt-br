---
description: A seguir está a lista completa do esquema do arquivo de configuração do aplicativo.
ms.assetid: c673dbff-cb64-4e90-88a8-c5f2c259f1d3
title: Esquema do arquivo de configuração de aplicativo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104169833"
---
# <a name="application-configuration-file-schema"></a><span data-ttu-id="f0c05-103">Esquema do arquivo de configuração de aplicativo</span><span class="sxs-lookup"><span data-stu-id="f0c05-103">Application Configuration File Schema</span></span>

<span data-ttu-id="f0c05-104">A seguir está a lista completa do esquema do arquivo de configuração do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="f0c05-104">The following is the complete listing of the application configuration file schema.</span></span>
