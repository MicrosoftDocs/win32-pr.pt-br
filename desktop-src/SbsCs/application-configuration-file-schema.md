...
---
# <a name="application-configuration-file-schema"></a>Esquema do arquivo de configuração de aplicativo

A seguir está a lista completa do esquema do arquivo de configuração do aplicativo.
