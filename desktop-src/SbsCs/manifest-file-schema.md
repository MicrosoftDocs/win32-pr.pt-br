---
description: A seguir está a lista completa do esquema do arquivo de manifesto.
ms.assetid: 5a4040a4-66ed-44ea-a07f-6410f88d1446
title: Esquema do arquivo de manifesto
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105748126"
---
# <a name="manifest-file-schema"></a><span data-ttu-id="58ea7-103">Esquema do arquivo de manifesto</span><span class="sxs-lookup"><span data-stu-id="58ea7-103">Manifest File Schema</span></span>

<span data-ttu-id="58ea7-104">A seguir está a lista completa do esquema do arquivo de manifesto.</span><span class="sxs-lookup"><span data-stu-id="58ea7-104">The following is the complete listing of the manifest file schema.</span></span>
