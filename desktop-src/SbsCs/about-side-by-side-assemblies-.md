---
description: um Windows assembly lado a lado é descrito por manifestos.
...
ms.locfileid: "119142590"
---
# <a name="about-side-by-side-assemblies"></a>Sobre assemblies lado a lado

um Windows assembly lado a lado é descrito por [manifestos](manifests.md). um assembly lado a lado contém uma coleção de recursos — um grupo de DLLs, Windows classes, servidores COM, bibliotecas de tipos ou interfaces — que são sempre fornecidos para aplicativos juntos. Eles são descritos no manifesto do assembly.
