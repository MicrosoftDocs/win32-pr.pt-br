---
description: O exemplo a seguir mostra como consumir dados de evento usando a função TdhGetProperty.
...
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a><span data-ttu-id="861c6-103">Usando TdhGetProperty para consumir dados de evento</span><span class="sxs-lookup"><span data-stu-id="861c6-103">Using TdhGetProperty to Consume Event Data</span></span>

<span data-ttu-id="861c6-104">O exemplo a seguir mostra como consumir dados de evento usando a função [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) .</span><span class="sxs-lookup"><span data-stu-id="861c6-104">The following example shows how to consume event data using the [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) function.</span></span>
