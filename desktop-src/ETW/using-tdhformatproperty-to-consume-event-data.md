---
description: O exemplo a seguir mostra como consumir dados de evento usando a função TdhFormatProperty.
ms.assetid: 5ebd500c-420e-4979-a03a-49b687464b0e
title: Usando TdhFormatProperty para consumir dados de evento
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104967458"
---
# <a name="using-tdhformatproperty-to-consume-event-data"></a><span data-ttu-id="eb98b-103">Usando TdhFormatProperty para consumir dados de evento</span><span class="sxs-lookup"><span data-stu-id="eb98b-103">Using TdhFormatProperty to Consume Event Data</span></span>

<span data-ttu-id="eb98b-104">O exemplo a seguir mostra como consumir dados de evento usando a função [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) .</span><span class="sxs-lookup"><span data-stu-id="eb98b-104">The following example shows how to consume event data using the [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) function.</span></span>
