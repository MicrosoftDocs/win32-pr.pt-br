---
description: O exemplo a seguir mostra como usar as funções auxiliares de dados de rastreamento para recuperar metadados para cada evento.
ms.assetid: 599e0405-b125-4742-b134-964e25413f59
title: Recuperando metadados de evento
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103827161"
---
# <a name="retrieving-event-metadata"></a><span data-ttu-id="a88d6-103">Recuperando metadados de evento</span><span class="sxs-lookup"><span data-stu-id="a88d6-103">Retrieving Event Metadata</span></span>

<span data-ttu-id="a88d6-104">O exemplo a seguir mostra como usar as funções auxiliares de dados de rastreamento para recuperar metadados para cada evento.</span><span class="sxs-lookup"><span data-stu-id="a88d6-104">The following example shows how to use the trace data helper functions to retrieve metadata for each event.</span></span> <span data-ttu-id="a88d6-105">Consulte também os exemplos incluídos nas funções [**TdhQueryProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhqueryproviderfieldinformation) e [**TdhEnumerateProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviderfieldinformation) .</span><span class="sxs-lookup"><span data-stu-id="a88d6-105">Also see the examples included with the [**TdhQueryProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhqueryproviderfieldinformation) and [**TdhEnumerateProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviderfieldinformation) functions.</span></span>
