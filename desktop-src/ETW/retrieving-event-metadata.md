...
---
# <a name="retrieving-event-metadata"></a>Recuperando metadados de evento

O exemplo a seguir mostra como usar as funções auxiliares de dados de rastreamento para recuperar metadados para cada evento. Consulte também os exemplos incluídos nas funções [**TdhQueryProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhqueryproviderfieldinformation) e [**TdhEnumerateProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviderfieldinformation) .
