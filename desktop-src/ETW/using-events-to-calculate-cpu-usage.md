...
---
# <a name="using-events-to-calculate-cpu-usage"></a>Usando eventos para calcular o uso da CPU

O exemplo a seguir mostra como usar eventos para calcular o uso da CPU para um conjunto de instruções. Este exemplo pressupõe que o provedor encapsula o conjunto de instruções com um tipo de evento de início e um tipo de evento de término.
