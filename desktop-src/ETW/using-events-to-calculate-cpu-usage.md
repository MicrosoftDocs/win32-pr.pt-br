---
description: O exemplo a seguir mostra como usar eventos para calcular o uso da CPU para um conjunto de instruções. Este exemplo pressupõe que o provedor encapsula o conjunto de instruções com um tipo de evento de início e um tipo de evento de término.
ms.assetid: 7bc15ed3-d299-40dd-9838-520f896921e3
title: Usando eventos para calcular o uso da CPU
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104967459"
---
# <a name="using-events-to-calculate-cpu-usage"></a><span data-ttu-id="9ddfa-104">Usando eventos para calcular o uso da CPU</span><span class="sxs-lookup"><span data-stu-id="9ddfa-104">Using Events to Calculate CPU Usage</span></span>

<span data-ttu-id="9ddfa-105">O exemplo a seguir mostra como usar eventos para calcular o uso da CPU para um conjunto de instruções.</span><span class="sxs-lookup"><span data-stu-id="9ddfa-105">The following example shows you how to use events to calculate the CPU usage for a set of instructions.</span></span> <span data-ttu-id="9ddfa-106">Este exemplo pressupõe que o provedor encapsula o conjunto de instruções com um tipo de evento de início e um tipo de evento de término.</span><span class="sxs-lookup"><span data-stu-id="9ddfa-106">This example assumes the provider wraps the instruction set with a start event type and an end event type.</span></span>
