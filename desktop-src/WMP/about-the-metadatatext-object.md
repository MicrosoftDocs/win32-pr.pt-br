---
title: Sobre o objeto MetadataText
description: Sobre o objeto MetadataText
ms.assetid: 91d74b16-5a34-4ff3-9099-6590b12ed1cb
keywords:
- Windows Media Player, objeto MetadataText
- Modelo de objeto do Windows Media Player, objeto MetadataText
- modelo de objeto, objeto MetadataText
- Controle ActiveX do Windows Media Player, objeto MetadataText
- Controle ActiveX, objeto MetadataText
- Controle ActiveX móvel do Windows Media Player, objeto MetadataText
- Windows Media Player Mobile, objeto MetadataText
- Objeto MetadataText
ms.topic: article
ms.date: 05/31/2018
