...
keywords:
- Windows Media Player Player. uiMode
topic_type:
- apiref
api_name:
- Player.uiMode
...
| nenhum      | Windows Media Player é inserido sem controles e apenas a janela de vídeo ou visualização é exibida.                                                                                                         | !["nenhum" com áudio](images/uimode-none-audio-v11.png) | !["nenhum" com vídeo](images/uimode-none-video-v11.png) |
| mini-aba      | Windows Media Player é inserido com os controles janela de status, reproduzir/pausar, parar, ativar mudo e volume mostrado além da janela vídeo ou visualização.                                                          | !["mini" com áudio](images/uimode-mini-audio-v11.png) | !["mini" com vídeo](images/uimode-mini-video-v11.png) |
...
Windows Media Player 10 Mobile: essa propriedade só aceita ou retorna valores de "none" ou "full". Em dispositivos Smartphone, somente o status de reprodução e um contador são exibidos quando *UIMODE* é definido como "Full".
