...
keywords:
- Windows Media Player, atributos de playlist
- Windows Media Player Dispositivo móvel, atributos de playlist
- Windows Media Player de objeto, atributos de playlist
- modelo de objeto, atributos de playlist
- ActiveX controle, atributos de playlist
- Windows Media Player ActiveX controle, atributos de playlist
- Windows Media Player Controle de ActiveX dispositivo móvel, atributos de playlist
- referência para modelo de objeto, atributos de playlist
- atributos, playlists
- playlists, atributos
- playlists de metafile, atributos
- Windows Playlists de metadados de mídia, atributos
ms.topic: article
ms.date: 05/31/2018
...
Os atributos a seguir estão disponíveis para itens de mídia recuperados da biblioteca usando [**MediaCollection.getByAttribute("MediaType", "playlist")**](/windows/desktop/WMP/mediacollection-getbyattribute).
...
-   [**Atributo UserPlaycountCountCount**](userplaycountnight-attribute.md)
