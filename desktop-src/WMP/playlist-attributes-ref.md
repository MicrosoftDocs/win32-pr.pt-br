...
Os seguintes atributos estão disponíveis para itens de mídia recuperados da biblioteca usando [**mediacollection. getByAttribute ("MediaType", "playlist")**](/windows/desktop/WMP/mediacollection-getbyattribute).
