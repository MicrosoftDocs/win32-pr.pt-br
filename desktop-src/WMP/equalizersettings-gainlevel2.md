...
description: O atributo gainLevel2 especifica ou recupera o nível de lucro da faixa 2.
...
O atributo **gainLevel2** especifica ou recupera o nível de lucro da faixa 2.
...
Esse atributo ajusta a parte do espectro de frequência de áudio centralizado em 62Hz.
