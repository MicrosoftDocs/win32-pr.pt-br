...
Essa propriedade retornará zero se um arquivo não tiver marcadores ou se o item de mídia não for o mesmo que o especificado em AxWindowsMediaPlayer. currentMedia.
...
O exemplo a seguir usa **markerCount** para recuperar o número de marcadores no item de mídia atual. Esse valor é usado como o limite superior para uma estrutura de loop, que itera na lista de marcadores para recuperar cada nome de marcador e exibi-lo em uma caixa de texto de várias linhas. O objeto **AxWMPLib. AxWindowsMediaPlayer** é representado pela variável chamada Player.
