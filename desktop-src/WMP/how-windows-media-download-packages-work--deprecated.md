...
Depois que os arquivos foram extraídos do pacote de download de mídia Windows, o Windows Media Player localiza uma playlist de metadados de mídia Windows com uma extensão de nome de arquivo .asx entre os arquivos empacotados. Se encontrar uma, o Player criará uma playlist com base no metadado incluído. Os arquivos que contêm conteúdo multimídia são adicionados à biblioteca.
...
A tabela a seguir descreve os três elementos que comem um pacote Windows Download de Mídia.
