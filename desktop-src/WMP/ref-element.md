...
URL para qualquer parte do conteúdo de mídia com suporte pelo Windows Media Player.
...
O uso mais comum desse elemento é para substituição de URL. se Windows Media Player não puder abrir uma parte da mídia definida em um elemento **ref** , ele tentará a URL no próximo elemento **ref** . quando Windows Media Player abre o conteúdo de mídia de uma URL definida no escopo de um elemento de **entrada** , ele ignora as marcas de **referência** subsequentes dentro desse elemento de **entrada** . depois que a parte do conteúdo for executada, Windows Media Player passará para o próximo elemento de **entrada** , se houver.

-   **Importante** quando Windows Media Player estabelece uma conexão com uma parte de conteúdo referenciada, ela ignora todos os outros elementos **REF** nessa **entrada**, independentemente de a conexão ser encerrada normalmente ou de forma anormal.
