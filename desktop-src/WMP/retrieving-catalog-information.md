...
---
# <a name="retrieving-catalog-information"></a><span data-ttu-id="a6511-115">Recuperando Informações do catálogo</span><span class="sxs-lookup"><span data-stu-id="a6511-115">Retrieving Catalog Information</span></span>

<span data-ttu-id="a6511-116">Você pode exibir informações de diagnóstico em um catálogo executando catcomp com a seguinte sintaxe:</span><span class="sxs-lookup"><span data-stu-id="a6511-116">You can display diagnostic information on a catalog by running catcomp with the following syntax:</span></span>
...
<span data-ttu-id="a6511-117">Por exemplo, o comando a seguir exibe informações sobre um catálogo inteiro, incluindo a versão, a localidade e as informações internas em itens de catálogo:</span><span class="sxs-lookup"><span data-stu-id="a6511-117">For example, the following command displays information on an entire catalog, including the version, locale, and internal information on catalog items:</span></span>
...
<span data-ttu-id="a6511-118">A seguir são exibidas informações para o roteiro com a ID 3256:</span><span class="sxs-lookup"><span data-stu-id="a6511-118">The following displays information for the track with ID 3256:</span></span>
