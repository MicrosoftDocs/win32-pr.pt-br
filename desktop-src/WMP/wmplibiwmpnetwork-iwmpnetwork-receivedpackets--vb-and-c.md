...
---
# <a name="iwmpnetworkreceivedpackets-property"></a>Propriedade IWMPNetwork:: receivedPackets

A propriedade **receivedPackets** Obtém o número de pacotes recebidos.
...
Um **System. Int32** que é o número de pacotes recebidos.
...
O exemplo a seguir usa **receivedPackets** para exibir o número de pacotes recebidos. As informações são exibidas em um rótulo em resposta ao evento **PlayStateChange** . O exemplo usa um temporizador com um intervalo de 1 segundo para atualizar a exibição. O objeto **AxWMPLib. AxWindowsMediaPlayer** é representado pela variável chamada Player.
