...
---
# <a name="example-serviceinfo-document-for-a-type-1-online-store"></a><span data-ttu-id="9e5b1-114">Documento de informações de exemplo para uma loja online tipo 1</span><span class="sxs-lookup"><span data-stu-id="9e5b1-114">Example ServiceInfo Document for a Type 1 Online Store</span></span>

<span data-ttu-id="9e5b1-115">O exemplo de código a seguir mostra um documento de ServiceInfo.xml completo.</span><span class="sxs-lookup"><span data-stu-id="9e5b1-115">The following code example shows a complete ServiceInfo.xml document.</span></span> <span data-ttu-id="9e5b1-116">Você pode usar esse XML como um ponto de partida para seu próprio documento do serviceInfo.</span><span class="sxs-lookup"><span data-stu-id="9e5b1-116">You can use this XML as a starting point for your own ServiceInfo document.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="9e5b1-117">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="9e5b1-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="9e5b1-118">**Guia de programação para lojas online do tipo 1**</span><span class="sxs-lookup"><span data-stu-id="9e5b1-118">**Programming Guide for Type 1 Online Stores**</span></span>](programming-guide-for-type-1-online-stores.md)
</dt> <dt>

[<span data-ttu-id="9e5b1-119">**Documento do serviceInfo para uma loja online tipo 1**</span><span class="sxs-lookup"><span data-stu-id="9e5b1-119">**ServiceInfo Document for a Type 1 Online Store**</span></span>](serviceinfo-document-for-a-type-1-online-store.md)
</dt> <dt>

[<span data-ttu-id="9e5b1-120">**Documento do serviceInfo**</span><span class="sxs-lookup"><span data-stu-id="9e5b1-120">**ServiceInfo Document**</span></span>](serviceinfo-document.md)
</dt> </dl>
