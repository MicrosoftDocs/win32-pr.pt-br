...
O exemplo de JScript a seguir usa *playlistcollection*. **getByName** para verificar o objeto **playlistcollection** de uma lista de reprodução chamada "trêslist". Se a lista de reprodução de "três listas" existir, **getByName** definirá "3list" como a playlist atual. O objeto de **jogador** foi criado com a ID = "Player".
