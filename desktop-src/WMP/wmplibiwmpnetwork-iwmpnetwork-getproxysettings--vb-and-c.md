...
- Windows Media Player de interface IWMPNetwork, método getProxySettings
topic_type:
- apiref
api_name:
...
O método **getProxySettings** retorna informações sobre as configurações de proxy para um protocolo.
