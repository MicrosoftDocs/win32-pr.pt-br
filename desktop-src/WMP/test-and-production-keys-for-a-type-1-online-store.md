...
---
# <a name="test-and-production-keys-for-a-type-1-online-store"></a>Chaves de teste e de produção para uma loja online tipo 1
...
Você pode usar seus armazenamentos de teste e produção de qualquer forma que achar útil. Normalmente, no entanto, a distinção é a seguinte:
...
Para obter informações detalhadas sobre onde colocar suas chaves de produção e teste no registro do usuário, consulte [chaves e entradas do registro para uma loja online tipo 1](registry-keys-and-entries-for-a-type-1-online-store.md).
