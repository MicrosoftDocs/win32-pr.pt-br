...
| [Usando anúncios](using-announcements.md)                                                     | Usar um metarquivo para fornecer informações sobre a URL para um fluxo de mídia, incluindo o endereço IP de multicast, a porta, o formato de fluxo e outras configurações de estação. |
| [Usando a substituição de URL e de servidor](using-url-and-server-rollover.md)                                 | Usar listas de reprodução de metarquivo para fornecer um meio de reverter automaticamente para fontes de conteúdo alternativas quando um fluxo não pode ser acessado ou reproduzido.             |
| [Usando parâmetros e comandos personalizados](using-custom-parameters-and-commands.md)                   | Usando o elemento **param** para definir elementos personalizados para fornecer metadados adicionais.                                                                          |
| [Personalizando a entrega de mídia](personalizing-media-delivery.md)                                   | Usando as preferências do usuário para determinar o conteúdo da transmissão.                                                                                                         |
