---
title: Codecs de publicação do Windows Media Player
description: Codecs de publicação do Windows Media Player
ms.assetid: f265065a-525f-4ccf-99b3-231e71b3e0b2
keywords:
- Windows Media Player, codecs de publicação
- Windows Media Player, codecs
- Windows Media Player, WMPlugins. com
- WMPlugins.com
- codecs de publicação
- codecs
ms.topic: article
ms.date: 05/31/2018
