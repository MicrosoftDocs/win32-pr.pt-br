...
Esse método pode ser usado para criar uma consulta genérica para itens de mídia que corresponderem a um valor de um atributo na biblioteca. Isso é útil no caso de atributos definidos pelo usuário. Se o atributo não existir, ocorrerá um erro.
