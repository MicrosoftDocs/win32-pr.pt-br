...
- método remove Windows Media Player, interface IWMPMediaCollection
- Windows Media Player de interface IWMPMediaCollection, método remove
topic_type:
- apiref
api_name:
