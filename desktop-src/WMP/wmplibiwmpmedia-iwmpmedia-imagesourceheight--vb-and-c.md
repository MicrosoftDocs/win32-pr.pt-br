...
---
# <a name="iwmpmediaimagesourceheight-property"></a>Propriedade IWMPMedia:: imageSourceHeight

A propriedade **imageSourceHeight** Obtém a altura do item de mídia atual em pixels.
...
Um **System. Int32** que é a altura do item de mídia.
...
O exemplo a seguir usa **imageSourceHeight** para exibir o tamanho da imagem, em pixels, do item de mídia atual em uma caixa de texto. O objeto **AxWMPLib. AxWindowsMediaPlayer** é representado pela variável chamada Player.
