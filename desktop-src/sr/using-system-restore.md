---
title: Usando a restauração do sistema
description: Os exemplos a seguir demonstram como criar e cancelar pontos de restauração usando a função SRSetRestorePoint.
ms.assetid: 98c79305-3659-4d1a-8165-bb6e451e2d1e
keywords:
- Restauração do sistema, usando
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104366310"
---
# <a name="using-system-restore"></a><span data-ttu-id="57c21-104">Usando a restauração do sistema</span><span class="sxs-lookup"><span data-stu-id="57c21-104">Using System Restore</span></span>

<span data-ttu-id="57c21-105">Os exemplos a seguir demonstram como criar e cancelar pontos de restauração usando a função [**SRSetRestorePoint**](/windows/desktop/api/SRRestorePtAPI/nf-srrestoreptapi-srsetrestorepointa) .</span><span class="sxs-lookup"><span data-stu-id="57c21-105">The following examples demonstrate how to create and cancel restore points using the [**SRSetRestorePoint**](/windows/desktop/api/SRRestorePtAPI/nf-srrestoreptapi-srsetrestorepointa) function.</span></span>

<span data-ttu-id="57c21-106">A primeira etapa para usar o uso da restauração do sistema é configurar as chamadas COM para [**CoInitializeEx**](/windows/win32/api/combaseapi/nf-combaseapi-coinitializeex) e [**CoInitializeSecurity**](/windows/win32/api/combaseapi/nf-combaseapi-coinitializesecurity).</span><span class="sxs-lookup"><span data-stu-id="57c21-106">The first step to using using System Restore is setting up the COM calls to [**CoInitializeEx**](/windows/win32/api/combaseapi/nf-combaseapi-coinitializeex) and [**CoInitializeSecurity**](/windows/win32/api/combaseapi/nf-combaseapi-coinitializesecurity).</span></span> <span data-ttu-id="57c21-107">Isso é necessário para qualquer processo que use a função [**SRSetRestorePoint**](/windows/desktop/api/SRRestorePtAPI/nf-srrestoreptapi-srsetrestorepointa) .</span><span class="sxs-lookup"><span data-stu-id="57c21-107">This is required for any process that uses the [**SRSetRestorePoint**](/windows/desktop/api/SRRestorePtAPI/nf-srrestoreptapi-srsetrestorepointa) function.</span></span> <span data-ttu-id="57c21-108">O NetworkService, o LocalService e o sistema devem ser permitidos para fazer chamadas para o processo.</span><span class="sxs-lookup"><span data-stu-id="57c21-108">The NetworkService, LocalService, and System must be allowed make calls to the process.</span></span> <span data-ttu-id="57c21-109">A seguinte função **InitializeCOMSecurity** é um exemplo de como inicializar a segurança com.</span><span class="sxs-lookup"><span data-stu-id="57c21-109">The following **InitializeCOMSecurity** function is an example of how to initialize COM security.</span></span> <span data-ttu-id="57c21-110">Talvez seja necessário modificar os parâmetros para a função **CoInitializeSecurity** para seu aplicativo.</span><span class="sxs-lookup"><span data-stu-id="57c21-110">You may need to modify the parameters to the **CoInitializeSecurity** function for your application.</span></span>
...
## <a name="example-1-create-a-restore-point"></a><span data-ttu-id="57c21-111">Exemplo 1: criar um ponto de restauração.</span><span class="sxs-lookup"><span data-stu-id="57c21-111">Example 1: Create a restore point.</span></span>
...
## <a name="example-2-create-and-cancel-a-restore-point"></a><span data-ttu-id="57c21-112">Exemplo 2: criar e cancelar um ponto de restauração.</span><span class="sxs-lookup"><span data-stu-id="57c21-112">Example 2: Create and cancel a restore point.</span></span>
