---
description: Acessa elementos de matriz específicos referenciados por linha e coluna da instância atual do XMFLOAT4X4.
ms.assetid: de367692-6974-4e54-9f1e-d8c56b3aa752
title: Operadores do operador XMFLOAT4X4 ()
ms.topic: reference
ms.date: 12/06/2018
topic_type:
- APIRef
...
Acessa elementos de matriz específicos referenciados por linha e coluna da instância atual do `XMFLOAT4X4` .

Acessa elementos de matriz específicos referenciados por linha e coluna da instância atual do [ **XMFLOAT4X4**](/windows/win32/api/directxmath/ns-directxmath-xmfloat4x4)
...
[Operadores XMFLOAT4X4](ovw-xmfloat4x4-operators.md)
</dt> <dt>
