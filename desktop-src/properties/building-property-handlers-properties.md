...
no Windows Vista e posterior, um amplo conjunto de propriedades abrange as especificidades de itens como fotos, música, documentos, mensagens, contatos e arquivos. ISVs (fornecedores independentes de software) podem introduzir suas próprias propriedades para a plataforma se nenhuma propriedade existente atender às suas necessidades.
