---
description: Indica a referência para dar a direção da imagem quando ela foi capturada, (por exemplo, direção real, direção magnética).
...
ms.locfileid: "103922930"
---
# <a name="systemgpsimgdirectionref"></a>System. GPS. ImgDirectionRef

Indica a referência para dar a direção da imagem quando ela foi capturada, (por exemplo, direção real, direção magnética).
