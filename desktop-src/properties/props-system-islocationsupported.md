---
description: Identifica se um local foi indexado (local ou remotamente) no momento em que foi adicionado à biblioteca.
...
ms.locfileid: "104502093"
---
# <a name="systemislocationsupported"></a>System. IsLocationSupported

Identifica se um local foi indexado (local ou remotamente) no momento em que foi adicionado à biblioteca.
