---
description: Indica a referência para a propriedade altitude (por exemplo, acima do nível do mar, abaixo do nível do mar, valor absoluto).
...
ms.locfileid: "105813575"
---
# <a name="systemgpsaltituderef"></a>System. GPS. AltitudeRef

Indica a referência para a propriedade altitude (por exemplo, acima do nível do mar, abaixo do nível do mar, valor absoluto).
