---
description: O nome do sistema de arquivos de um volume. Isso é válido para itens de shell que descrevem um volume.
...
ms.locfileid: "105780386"
---
# <a name="systemvolumefilesystem"></a>System. volume. FileSystem

O nome do sistema de arquivos de um volume. Isso é válido para itens de shell que descrevem um volume.
