---
description: Indica a referência usada para dar a extremidade ao ponto de destino (por exemplo, direção real, direção magnética).
...
ms.locfileid: "120059166"
---
# <a name="systemgpsdestbearingref"></a>System. GPS. DestBearingRef

Indica a referência usada para dar a extremidade ao ponto de destino (por exemplo, direção real, direção magnética).
