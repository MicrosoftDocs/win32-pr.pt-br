---
description: Uma agregação somente leitura de propriedades como de marca para uso na criação de exibições.
...
ms.locfileid: "105764065"
---
# <a name="systemphototagviewaggregate"></a>System. Photo. TagViewAggregate

Uma agregação somente leitura de propriedades como de marca para uso na criação de exibições.
