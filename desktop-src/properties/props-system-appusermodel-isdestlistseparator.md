---
description: Insere um separador na seção tarefas de uma lista de atalhos.
...
ms.locfileid: "103662207"
---
# <a name="systemappusermodelisdestlistseparator"></a>System. AppUserModel. IsDestListSeparator

Insere um separador na seção **tarefas** de uma lista de atalhos. Defina essa propriedade em um objeto [**IShellLink**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishelllinka) e passe-a para [**ICustomDestinationList:: AddUserTasks**](/windows/win32/api/shobjidl_core/nf-shobjidl_core-icustomdestinationlist-addusertasks).
