...
A orientação da foto quando ela foi realizada, conforme especificado nas informações de EXIF (arquivo de imagem intercambiável) e em termos de linhas e colunas. Isso permite que os aplicativos e o Shell orientem a imagem corretamente, em vez de orientar os pixels e persistir a imagem na orientação de exibição solicitada, o que pode resultar em uma perda de fidelidade. Essa propriedade não deve ser exibida na interface do usuário.
