...
---
# <a name="systemcalendarshowtimeas"></a>System. Calendar. extimeas

Indica o status do participante durante o evento. O usuário pode optar por definir o status como livre, ocupado, provisório ou fora do escritório.
