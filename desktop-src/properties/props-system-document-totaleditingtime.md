...
Essa propriedade representa o tempo total entre cada abertura e salvamento, acumulado desde a criação do documento. Isso é medido em unidades de 100ns, não em milissegundos. VT \_ FILETIME para manipuladores IPropertySetStorage (Herdado)
