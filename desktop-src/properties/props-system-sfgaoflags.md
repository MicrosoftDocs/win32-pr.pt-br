---
description: 'Valores de SFGAO como usados em IShellFolder:: GetAttributesOf.'
...
ms.locfileid: "118464786"
---
# <a name="systemsfgaoflags"></a>System. SFGAOFlags

Valores de [**SFGAO**](../shell/sfgao.md) como usados em [**IShellFolder:: GetAttributesOf**](/windows/win32/api/shobjidl_core/nf-shobjidl_core-ishellfolder-getattributesof).
...
Determinados valores de [**SFGAO**](../shell/sfgao.md) que são considerados para causar cálculos lentos ou ausência de contexto são excluídos aqui pelo aplicativo da [* * * * SFGAO \_ PKEYSFGAOMASK *](../shell/sfgao.md) * * * máscara.
