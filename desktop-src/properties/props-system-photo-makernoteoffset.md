---
description: O deslocamento para a nota do criador especificada em System.Photo.MakerNote.
...
ms.locfileid: "119033334"
---
# <a name="systemphotomakernoteoffset"></a>System.Photo.MakerNoteOffset

O deslocamento para a nota do criador especificada [em System.Photo.MakerNote.](./props-system-photo-makernote.md) Confira a especificação do Exchangeable Image File (EXIF) 2.2 para obter mais informações. Essa propriedade não se destina a ser exibida no Shell, mas está disponível programaticamente para aplicativos.
