---
description: A abertura máxima da lente, conforme registrado pela câmera, retirada das informações do EXIF (Exchangeable Image File).
...
ms.locfileid: "118228180"
---
# <a name="systemphotomaxaperture"></a>System.Photo.MaxAperture

A abertura máxima da lente, conforme registrado pela câmera, retirada das informações do EXIF (Exchangeable Image File). Essa propriedade é calculada de [System.Photo.MaxApertureNumerator](./props-system-photo-maxaperturenumerator.md) [e System.Photo.MaxApertureDenominator](./props-system-photo-maxaperturedenominator.md).
