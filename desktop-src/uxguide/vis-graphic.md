...
**Observação:** Diretrizes relacionadas a caixas [de grupo,](ctrl-group-boxes.md) [animações,](vis-animations.md) [ícones](vis-icons.md)e identidade [visual](exper-branding.md) são apresentadas em artigos separados.
