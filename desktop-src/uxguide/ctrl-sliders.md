...
-   **Sempre que for prático, dê comentários imediatos enquanto ou depois que um usuário fizer uma seleção.** Por exemplo, o controle de volume do Microsoft Windows emite um aviso sonoro para indicar o volume de áudio resultante.
