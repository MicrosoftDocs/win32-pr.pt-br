...
Os usuários interagem com texto mais do que com qualquer outro elemento no Microsoft Windows. Segoe UI (pronuncia-se "SEE-go") é a fonte do sistema Windows. O tamanho da fonte padrão foi aumentado para 9 pontos.

![ilustração do alfabeto na fonte da interface do usuário do segoe ](images/vis-fonts-image1.png)

A Segoe UI fonte.

Segoe UI e Segoe não são a mesma fonte. Segoe UI é a fonte do Windows destinada a cadeias de caracteres de texto da interface do usuário. Segoe é uma fonte de identidade visual usada pela Microsoft e por parceiros para produzir material para impressão e publicidade.
...
Para licenciar Segoe UI e outras fontes da Microsoft para distribuição com um programa baseado no Windows, entre em contato com [Monotype](https://www.monotype.com/).
...
Informalmente, as pessoas geralmente usam a fonte no lugar da face de tipo, como feito neste artigo, mas tecnicamente, Segoe UI é uma face de tipo, não uma fonte. Cada combinação de atributos é uma fonte exclusiva (por exemplo, 9 pontos Segoe UI regular, 10 pontos Segoe UI negrito e assim por diante).
...
-   Sempre basee as cores da fonte e as plano de fundo das cores do tema do sistema. Nunca faça suas próprias cores com base em valores RGB fixos (vermelho, verde, azul).
...
|    Uso                                         |    Descrição                            |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Texto da barra de título**<br/> Texto na barra de título que identifica a janela.<br/>                                                                                                                                                                | ![exemplo de fonte de texto de barra de título ](images/vis-fonts-image2.png)<br/>                                                                            |
...
| **Instruções secundárias**<br/> Texto suplementar que explica o que fazer em uma página, janela ou caixa de diálogo. <br/>                                                                                                                            | ![exemplo de fonte de texto de instruções secundárias ](images/vis-fonts-image4.png)<br/>                                                               |
...
| **Texto enfatizado**<br/> O texto em negrito é usado para facilitar a análise do texto e para chamar a atenção para o texto que os usuários devem ler. o texto em itálico é usado para fazer referência a texto literalmente (em vez de aspas) e para enfatizar palavras específicas. <br/> | ![exemplo de fonte de texto enfatizada ](images/vis-fonts-image6.png)<br/>                                                                           |
...
| **Texto desabilitado**<br/> Texto que não se aplica ao contexto atual, como rótulos para controles desabilitados. texto desabilitado indica que os usuários (normalmente) não devem se preocupar em ler o texto. <br/>                                           | ![exemplo de fonte de texto desabilitada ](images/vis-fonts-image8.png)<br/>                                                                             |
| **Links**<br/> Texto usado para navegar para outra página, janela ou tópico da ajuda, ou iniciar um comando. <br/>                                                                                                                                     | ![exemplo de fonte do texto do link ](images/vis-fonts-image9.png)<br/> ![exemplo de fonte de texto de links (focalizar) ](images/vis-fonts-image10.png)<br/> |
| **Cabeçalho do grupo**<br/> Texto usado para agrupar itens em uma exibição de lista. <br/>                                                                                                                                                                          | ![exemplo de fonte de texto de cabeçalho de grupo ](images/vis-fonts-image11.png)<br/>                                                                        |
...
| **Texto do documento**<br/> Texto usado em documentos (em oposição ao texto da interface do usuário). <br/>                                                                                                                                                                  | ![exemplo de fonte de texto do documento ](images/vis-fonts-image13.png)<br/>                                                                            |
| **Títulos de documento**<br/> Texto usado como um cabeçalho dentro de um documento. <br/>                                                                                                                                                                    | ![exemplo de fonte de texto de títulos de documento ](images/vis-fonts-image14.png)<br/>                                                                   |
...
-   **As fontes e cores a seguir são padrões para o Windows Vista e o Windows 7.**



| Padrão | Símbolo de tema | Fonte, cor |
|-----------------------------------------------------------------------------------------------|-----------------------------|------------------------------------------------------------|
| ![exemplo de fonte de texto de barra de título ](images/vis-fonts-image2.png)<br/>                    | CaptionFont<br/>      | 9 pt. preto ( \# 000000) Segoe UI<br/>                 |
| ![exemplo de fonte de texto de instruções principais ](images/vis-fonts-image3.png)<br/>            | MainInstruction<br/>  | 12 pt. azul ( \# 003399) Segoe UI<br/>                 |
...
| ![exemplo de fonte do texto do link ](images/vis-fonts-image9.png)<br/>                         | HyperLinkText<br/>    | 9 pt. Segoe UI azul ( \# 0066CC)<br/>                  |
| ![exemplo de fonte de texto de links (focalizar) ](images/vis-fonts-image10.png)<br/>               | Frequente<br/>              | 9 pt. azul-claro ( \# 3399FF) Segoe UI<br/>            |
| ![exemplo de fonte de texto de cabeçalho de grupo ](images/vis-fonts-image11.png)<br/>                |                             | 11 pt. azul ( \# 003399) Segoe UI<br/>                 |
...
| ![exemplo de fonte de texto do documento ](images/vis-fonts-image13.png)<br/>                    | (nenhum)<br/>           | 9 pt. preto ( \# 000000) Calibri<br/>                  |
| ![exemplo de fonte de texto de títulos de documento ](images/vis-fonts-image14.png)<br/>           | (nenhum)<br/>           | 17 pt. preto ( \# 000000) Calibri<br/>                 |



 

-   **Escolha as fontes e otimize os layouts de janela com base na tecnologia de interface do usuário e na versão de destino do Windows:**



| Tecnologia de interface do usuário | Versão do Windows de destino | Fontes para usar e otimizar para |
|--------------------------------------------|-------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|                                            | Componentes extensíveis ou pré-Windows Vista<br/> | Para direcionar o Windows XP e o Windows 2000, use a pseudo-fonte Dlg 2 do MS Shell de 8 pontos, que mapeia para Tomaoma.<br/> Para direcionar versões anteriores do Windows, use a pseudo-fonte Dlg do MS Shell de 8 pontos, que mapeia para o Toma no Windows 2000 e no Windows XP e para o MS Sans Serif no Windows 95, Windows 98, Windows Millennium Edition e Windows NT 4.0.<br/> |
...
-   **Desenvolvedores:**
    -   Para elementos que usam layout fixo (como modelos de caixa de diálogo do Windows e WinForms), codifica em código a fonte apropriada da tabela anterior.
