...
No modo de Ajuda, o servidor não envia os eventos [**IAgentNotifySink::Click**](iagentnotifysink--click.md), [**IAgentNotifySink::D ragStart**](iagentnotifysink--dragstart.md), [**IAgentNotifySink::D ragComplete e**](iagentnotifysink--dragcomplete.md) [**IAgentNotifySink::Command,**](iagentnotifysink--command.md) a menos que a propriedade [**GetAutoPopupMenu**](https://www.bing.com/search?q=**GetAutoPopupMenu**) retorne **True.** Nesse caso, o servidor enviará o evento **IAgentNotifySink::Click** (não sai do modo ajuda), mas apenas para o botão direito do mouse para permitir que você exibe o menu pop-up.
