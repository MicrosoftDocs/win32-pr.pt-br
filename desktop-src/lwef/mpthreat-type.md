...
keywords:
- recursos do ambiente de Windows herdado de enumeração de MPTHREAT_TYPE
- Windows recursos de ambiente herdados do ponteiro de enumeração PMPTHREAT_TYPE
topic_type:
- apiref
api_name:
- MPTHREAT_TYPE
