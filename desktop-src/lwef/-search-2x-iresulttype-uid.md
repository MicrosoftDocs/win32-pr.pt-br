...
keywords:
- Propriedade UID Herdou Windows Recursos de Ambiente
- Propriedade UID Recursos Windows ambiente herdado, interface IResultType
- Interface IResultType Recursos Windows ambiente herdado, propriedade UID
topic_type:
- apiref
api_name:
- IResultType.UID
...
o endereço do local que contém o uid.
