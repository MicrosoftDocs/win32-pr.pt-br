...
| <span id="18"></span><dl> <dt>**18**</dt> </dl> | Informações de configuração do sistema.<br/>                                                                                |
| <span id="19"></span><dl> <dt>**19**</dt> </dl> | Informações do disco rígido.<br/>                                                                                           |
| <span id="20"></span><dl> <dt>**20**</dt> </dl> | Sistema reconfigurado.<br/>                                                                                             |
| <span id="21"></span><dl> <dt>**21**</dt> </dl> | Erro complexo de CPU incorretável.<br/>                                                                                 |
| <span id="22"></span><dl> <dt>**22**</dt> </dl> | Redefinição ou Desajustado da Área de Log.<br/>                                                                                       |
| <span id="23"></span><dl> <dt>**23**</dt> </dl> | Inicialização do sistema. Se implementada, essa entrada de log tem a garantia de ser a primeira escrita em qualquer inicialização do sistema.<br/>        |
...
Bits de validação usados para indicar a validade dos campos subsequentes. Um valor de 1 (0x1) significa que **o EVENTO SMBIOS \_** é válido.
