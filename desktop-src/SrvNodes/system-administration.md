...
[Política de Grupo](group-policy.md)
</dt> <dd>

Política de Grupo habilita a administração baseada em políticas usando os serviços de diretório do Microsoft Active Directory. O Política de Grupo usa serviços de diretório e Associação de grupo de segurança para fornecer flexibilidade e dar suporte a informações de configuração extensivas.

</dd> <dt>

[Console de Gerenciamento Microsoft (MMC)](microsoft-management-console--mmc-.md)
</dt> <dd>

O MMC (console de gerenciamento Microsoft) fornece uma interface de usuário de administração simples, consistente e integrada e um modelo de administração.

</dd> <dt>

[Provedor de aplicativo de gerenciamento de dispositivo móvel](/previous-versions/windows/desktop/mdmappprov/mobile-device-management-application-provider-portal)
</dt> <dd>

O provedor de aplicativos de MDM (gerenciamento de dispositivo móvel) gerencia aplicativos em dispositivos que são assinados para um serviço de MDM.

</dd> <dt>

[Registro de gerenciamento de dispositivo móvel](/windows/desktop/MDMReg/mobile-device-management-registration-portal)
</dt> <dd>

O registro de MDM registra os dispositivos em um serviço MDM.
...
O NetShell é uma ferramenta baseada em linha de comando que permite aos administradores administrar e configurar remotamente serviços de rede críticos.
...
[Restauração do Sistema](/windows/desktop/sr/system-restore-portal)
</dt> <dd>
...
[Desligamento do sistema](/windows/desktop/Shutdown/system-shutdown)
</dt> <dd>

As funções e mensagens de desligamento do sistema permitem que os aplicativos façam logoff do usuário atual, desligue o sistema ou bloqueiem a estação de trabalho.
...
O Agendador de Tarefas permite que você execute automaticamente tarefas rotineiras em um computador escolhido. O Agendador de Tarefas faz isso monitorando quaisquer critérios escolhidos para iniciar as tarefas (chamadas de gatilhos) e, em seguida, executar as tarefas quando os critérios forem atendidos.
...
[Pastas de trabalho](/previous-versions/windows/desktop/syncshareservermgmt/sync-share-server-management-portal)
</dt> <dd>

As pastas de trabalho permitem que os usuários armazenem e acessem arquivos de trabalho em computadores e dispositivos pessoais.
