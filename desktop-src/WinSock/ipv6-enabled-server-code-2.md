---
description: O código a seguir é o arquivo Server. c independente de IP, que é uma versão habilitada para IPv6 do arquivo simples. c.
ms.assetid: 5e27c731-c9c7-4c49-91bd-6f4dee60460b
title: Código do servidor IPv6-Enabled
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104090382"
---
# <a name="ipv6-enabled-server-code"></a><span data-ttu-id="b0bdd-103">Código do servidor IPv6-Enabled</span><span class="sxs-lookup"><span data-stu-id="b0bdd-103">IPv6-Enabled Server Code</span></span>

<span data-ttu-id="b0bdd-104">O código a seguir é o arquivo Server. c independente de IP, que é uma versão habilitada para IPv6 do arquivo simples. c.</span><span class="sxs-lookup"><span data-stu-id="b0bdd-104">The following code is the IP-agnostic Server.c file, which is an IPv6-enabled version of the Simples.c file.</span></span>
