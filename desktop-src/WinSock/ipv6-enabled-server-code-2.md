...
---
# <a name="ipv6-enabled-server-code"></a>Código do servidor IPv6-Enabled

O código a seguir é o arquivo Server. c independente de IP, que é uma versão habilitada para IPv6 do arquivo simples. c.
