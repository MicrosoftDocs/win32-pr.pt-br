---
description: Esta seção lista a definição de tipo para as informações de camada inferior de banda larga.
ms.assetid: b987dd6b-a611-4297-abaa-fd080cc94f6f
title: Informações da camada inferior de banda larga
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "117741556"
---
# <a name="broadband-lower-layer-information"></a>Informações da camada inferior de banda larga

Esta seção lista a definição de tipo para as informações de camada inferior de banda larga.
