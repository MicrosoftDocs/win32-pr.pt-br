...
ms.locfileid: "104501705"
---
# <a name="broadband-bearer-capability"></a><span data-ttu-id="18c76-103">Recurso portador de banda larga</span><span class="sxs-lookup"><span data-stu-id="18c76-103">Broadband Bearer Capability</span></span>

<span data-ttu-id="18c76-104">Esta seção lista os valores usados para o recurso portador de banda larga.</span><span class="sxs-lookup"><span data-stu-id="18c76-104">This section lists the values used for the broadband bearer capability.</span></span>
