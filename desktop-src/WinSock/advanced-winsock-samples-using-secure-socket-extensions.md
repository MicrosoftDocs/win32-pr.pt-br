...
[Sobre a plataforma de filtragem do Windows](/windows/desktop/FWP/about-windows-filtering-platform)
</dt> <dt>
...
[Funções da API da Windows Filtering Platform](/windows/desktop/FWP/fwp-functions)
</dt> <dt>
