...
no Windows Vista e posterior, um novo método é fornecido para categorizar os provedores de serviços em camadas do Winsock e os aplicativos, de modo que apenas determinados LSPs serão carregados. Há vários motivos para adicionar esses recursos.
