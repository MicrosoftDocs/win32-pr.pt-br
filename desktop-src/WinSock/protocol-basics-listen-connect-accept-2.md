...
title: 'noções básicas de protocolo: escutar, Conexão, aceitar'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119857916"
---
# <a name="protocol-basics-listen-connect-accept"></a>noções básicas de protocolo: escutar, Conexão, aceitar
