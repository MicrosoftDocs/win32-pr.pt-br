---
description: Esta seção contém um exemplo de código-fonte que demonstra como implementar as funções GetXbyY usando as novas funções RNR independentes de protocolo.
ms.assetid: d6246d47-11c2-4e4b-8a2b-17fd9cb041fc
title: Código de exemplo para um provedor de serviços
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103661777"
---
# <a name="sample-code-for-a-service-provider"></a><span data-ttu-id="04990-103">Código de exemplo para um provedor de serviços</span><span class="sxs-lookup"><span data-stu-id="04990-103">Sample Code for a Service Provider</span></span>

<span data-ttu-id="04990-104">Esta seção contém um exemplo de código-fonte que demonstra como implementar as funções **GetXbyY** usando as novas funções RnR independentes de protocolo.</span><span class="sxs-lookup"><span data-stu-id="04990-104">This section contains a source code sample that demonstrates how to implement the **GetXbyY** functions using the new, protocol-independent RNR functions.</span></span> <span data-ttu-id="04990-105">Um desenvolvedor deve implementar essas funções como um ponto de partida.</span><span class="sxs-lookup"><span data-stu-id="04990-105">A developer should implement these functions as a starting point.</span></span> <span data-ttu-id="04990-106">Para atender à especificação do Windows Sockets, muitas outras funções são necessárias.</span><span class="sxs-lookup"><span data-stu-id="04990-106">To comply with the Windows Sockets specification, many more functions are needed.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="04990-107">Não há garantia de que o código a seguir seja compilado.</span><span class="sxs-lookup"><span data-stu-id="04990-107">The following code is not guaranteed to compile.</span></span>
