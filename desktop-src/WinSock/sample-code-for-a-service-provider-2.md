...
ms.locfileid: "119794686"
---
# <a name="sample-code-for-a-service-provider"></a>Código de exemplo para um provedor de serviços

Esta seção contém um exemplo de código-fonte que demonstra como implementar as funções **GetXbyY** usando as novas funções RnR independentes de protocolo. Um desenvolvedor deve implementar essas funções como um ponto de partida. para obedecer à especificação de soquetes de Windows, muitas outras funções são necessárias.

> [!IMPORTANT]
> Não há garantia de que o código a seguir seja compilado.
