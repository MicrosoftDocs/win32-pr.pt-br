...
ms.locfileid: "105772709"
---
# <a name="multicast-programming-sample"></a><span data-ttu-id="4d9fc-103">Exemplo de programação multicast</span><span class="sxs-lookup"><span data-stu-id="4d9fc-103">Multicast Programming Sample</span></span>

<span data-ttu-id="4d9fc-104">O código de exemplo a seguir ilustra como incluir a funcionalidade de multicast para um aplicativo do Windows Sockets usando opções de soquete.</span><span class="sxs-lookup"><span data-stu-id="4d9fc-104">The following sample code illustrates how to include multicast functionality to a Windows Sockets application using socket options.</span></span>
