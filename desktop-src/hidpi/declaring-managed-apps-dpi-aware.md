...
description: Observação Esta página aborda o desenvolvimento WPF herdado para Windows 8.1. se você estiver desenvolvendo aplicativos do WPF para Windows 10, consulte a documentação mais recente em GitHub. .
ms.assetid: 04a36dc7-684f-4846-aeba-970117070b4c
keywords:
- Windows Interface do usuário, aplicativos com reconhecimento de DPI
- Windows Interface do usuário, DPI alto
...
> [!Note]  
> **Esta página aborda o desenvolvimento WPF herdado para Windows 8.1.** se você estiver desenvolvendo aplicativos do WPF para Windows 10, consulte a <a href="https://github.com/microsoft/WPF-Samples/blob/master/PerMonitorDPI/readme.md">documentação mais recente em GitHub.</a>
...
2.  inicie o Microsoft Visual Studio e selecione **arquivo > abrir > Project/Solution**
3.  Navegue até o diretório que contém o exemplo descompactado. vá para o diretório chamado para o exemplo e clique duas vezes no arquivo da solução Visual Studio (. sln)
...
2.  inicie o Visual Studio e selecione **arquivo > abrir > Project/Solution**
3.  navegue até o diretório que contém um aplicativo existente do WPF e clique duas vezes no arquivo da solução Visual Studio (. sln)
4.  clique com o botão direito do mouse em **solução > adicionar > existente Project** ![ uma captura de tela que ilustra a seleção de menu adicionar: projeto existente](images/scrvs-image1.png)
...
9.  Expanda seu projeto de aplicativo WPF, expanda **Propriedades** e abra **AssemblyInfo. cs**. Faça as seguintes adições ao AssemblyInfo. cs
    -   Adicione referência ao sistema. Windows. Mídia na seção de referência (usando System. Windows. Meio
