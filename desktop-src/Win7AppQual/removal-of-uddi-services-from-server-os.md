...
os usuários que implantaram um site dos serviços UDDI do Windows server 2003 ou Windows server 2008 podem optar por não atualizar os servidores que executam os serviços UDDI para Windows Server 2008 R2. eles também podem mover os serviços UDDI para as caixas Windows server 2003 ou Windows server 2008 dedicadas se tiverem que atualizar as caixas de serviços uddi atuais.

## <a name="solution"></a>Solução

a solução recomendada é implantar os serviços UDDI v 3.0 do BizTalk Server 2009 em um computador Windows Server 2008 R2 e, em seguida, migrar o site antigo para o novo site. Os serviços UDDI v 3.0 fornecem compatibilidade com versões anteriores com os serviços UDDI 2,0, de modo que qualquer aplicativo que esteja usando os serviços UDDI não será afetado.

Para fazer isso, execute estas etapas:

1.  configure um novo site dos serviços UDDI v 3.0 em um computador já carregado com o Windows Server 2008 R2. (observação: em uma configuração distribuída, um site do UDDI v 3.0 pode consistir em mais de um computador Windows Server 2008 R2.)
...
4.  desinstale o antigo software de serviços UDDI e, em seguida, atualize essas caixas para Windows Server 2008 R2.
...
-   [download dos serviços UDDI v 3.0 para o Windows Server 2008 R2](https://www.microsoft.com/downloads/details.aspx?FamilyID=e4761835-70f0-4e8d-96c5-64818d54e06e)
