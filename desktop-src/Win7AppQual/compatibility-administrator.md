...
-   Fornecendo uma ferramenta de consulta que permite que você pesquise correções instaladas em seus computadores locais

## <a name="usage"></a>Uso

O fluxograma a seguir ilustra as etapas necessárias no uso do Administrador de Compatibilidade para criar suas correções de compatibilidade, modos de compatibilidade e suas mensagens appHelp.



| &nbsp;    | &nbsp;  |  &nbsp;   | &nbsp;  | &nbsp; | &nbsp;  |  &nbsp;  |
|--------------------------------------------|----------|--------------------------------------------------------------------------------------------|----------|-----------------------------------------------------|----------|-----------------------------------------------------------------------------|
| Criar um novo banco de dados de compatibilidade (.sdb) | **>** | Selecione o aplicativo e, em seguida, selecione as correções de compatibilidade a aplicar ao aplicativo | **>** | Testar o aplicativo com a nova correção de compatibilidade | **>** | Salve o banco de dados de compatibilidade e implante a correção em sua empresa |
