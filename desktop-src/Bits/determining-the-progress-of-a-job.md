...
O BITS mantém as informações de progresso de cada trabalho. Use as informações de progresso para determinar quantos bytes e arquivos foram transferidos.

Para recuperar as informações de progresso do trabalho, chame o método [**método ibackgroundcopyjob:: GetProgress**](/windows/desktop/api/Bits/nf-bits-ibackgroundcopyjob-getprogress) conforme mostrado no exemplo a seguir. O exemplo supõe que o ponteiro de interface [**método ibackgroundcopyjob**](/windows/desktop/api/Bits/nn-bits-ibackgroundcopyjob) é válido.
...
Para recuperar as informações de progresso na parte de resposta de um trabalho de resposta de upload, chame o método [**IBackgroundCopyJob2:: GetReplyProgress**](/windows/desktop/api/Bits1_5/nf-bits1_5-ibackgroundcopyjob2-getreplyprogress) , conforme mostrado no exemplo a seguir. O exemplo supõe que o ponteiro de interface [**método ibackgroundcopyjob**](/windows/desktop/api/Bits/nn-bits-ibackgroundcopyjob) é válido.
