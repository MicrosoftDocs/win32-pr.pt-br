...
O exemplo a seguir mostra como definir as propriedades de extensão do IIS bits usando Windows Host de Script. Se o diretório virtual aponta para um compartilhamento remoto, de definido também as **propriedades UNCUserName** e **UNCPassword** IIS.
