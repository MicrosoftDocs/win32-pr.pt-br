---
title: Métodos IBackgroundCopyCallback (BITS)
description: A interface IBackgroundCopyCallback expõe os métodos a seguir. | Métodos IBackgroundCopyCallback (BITS)
