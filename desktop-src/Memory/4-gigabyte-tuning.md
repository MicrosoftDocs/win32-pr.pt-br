...
**Windows Server 2003 e anterior:** Para habilitar 4GT, adicione a opção **/3GB** ao arquivo de Boot.ini. A opção **/3GB** tem suporte nos seguintes sistemas:
...
Nas edições de 64 bits do Windows, os aplicativos de 32 bits marcados com o sinalizador de [**\_ \_ \_ \_ reconhecimento de endereço grande de arquivo de imagem**](/windows/desktop/api/dbghelp/ns-dbghelp-loaded_image) têm 4 GB de espaço de endereço disponível.

**Edições do Windows Server 2003 no Itanium:** Antes do SP1, os processos de 32 bits têm apenas 2 GB de espaço de endereço disponível.
