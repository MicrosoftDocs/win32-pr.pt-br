...
ms.locfileid: "119963346"
---
# <a name="awe-example"></a>Exemplo de AWE

O programa de exemplo a seguir ilustra as [**extensões de janela de endereço**](address-windowing-extensions.md).
