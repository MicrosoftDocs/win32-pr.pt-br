---
description: O programa de exemplo a seguir ilustra as extensões de janela de endereço.
ms.assetid: 1a67bd2f-afc0-48f4-91f2-34fd2b94910d
title: Exemplo de AWE
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105748605"
---
# <a name="awe-example"></a><span data-ttu-id="8c187-103">Exemplo de AWE</span><span class="sxs-lookup"><span data-stu-id="8c187-103">AWE Example</span></span>

<span data-ttu-id="8c187-104">O programa de exemplo a seguir ilustra as [**extensões de janela de endereço**](address-windowing-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="8c187-104">The following sample program illustrates the [**Address Windowing Extensions**](address-windowing-extensions.md).</span></span>
