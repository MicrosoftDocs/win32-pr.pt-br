...
---
# <a name="etw_heap_event_free-event"></a>\_ \_ Evento gratuito de evento de heap do ETW \_

O **evento \_ \_ \_ gratuito do evento de heap do ETW** é um evento de rastreamento de gerenciamento de memória para uma operação de heap livre.
...
O **evento \_ \_ \_ gratuito do evento de heap do ETW** é registrado em todas as operações livres de heap.
