...
O nome do parâmetro. Ele deve ter entre 1 e 255 caracteres de comprimento e não pode conter um caractere de barra invertida ( \\ ).
...
A VM deve estar em execução e os componentes de integração devem ser instalados quando esse método é invocado. esse método só tem suporte para sistemas operacionais convidados baseados em Windows.
