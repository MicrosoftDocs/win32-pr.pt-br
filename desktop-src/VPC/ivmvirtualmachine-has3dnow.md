...
---
# <a name="ivmvirtualmachinehas3dnow-property"></a>Propriedade IVMVirtualMachine:: Has3DNow
...
**True** se o processador tiver suporte para o conjunto de instruções 3DNow; caso contrário, **false** .
