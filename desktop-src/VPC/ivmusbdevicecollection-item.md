---
title: Propriedade Item IVMUSBDeviceCollection (VPCCOMInterfaces.h)
...
- Propriedade de item Pc Virtual , interface IVMUSBDeviceCollection
- INTERFACE IVMUSBDeviceCollection pc virtual , propriedade Item
topic_type:
- apiref
api_name:
...
| <dl> <dt>E \_ PONTEIRO</dt> <dt>0x80004003</dt> </dl>         | O *parâmetro usbDevice* é **NULL.** <br/>                                             |
