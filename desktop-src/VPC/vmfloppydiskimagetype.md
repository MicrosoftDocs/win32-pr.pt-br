...
Um 720K (formato de baixa densidade).
...
Um formato de baixa densidade de um único lado.
...
Um MSS (tamanho de setor múltiplo) de alta densidade, usado pelo XDF (formato de distribuição estendido).
