...
| <dl> <dt>**VM \_ SOMENTE \_ LEITURA \_ DE \_ ARQUIVO E**</dt> <dt>0XA004067A</dt> </dl>                         | O pai da imagem de disco rígido virtual referenciada por este [**objeto IVMHardDisk**](ivmharddisk.md) é marcado como somente leitura.<br/>                                                                                             |
