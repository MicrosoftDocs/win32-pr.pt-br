...
ms.locfileid: "118123156"
---
# <a name="ivmvirtualmachinehasmmx-property"></a>Propriedade IVMVirtualMachine:: HasMMX
...
**True** se o processador tiver suporte para o conjunto de instruções MMX; caso contrário, **false** .
