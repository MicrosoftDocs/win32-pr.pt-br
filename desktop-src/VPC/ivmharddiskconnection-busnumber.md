...
---
# <a name="ivmharddiskconnectionbusnumber-property"></a>Propriedade IVMHardDiskConnection:: BusNumber

\[O Windows Virtual PC não está mais disponível para uso a partir do Windows 8. Em vez disso, use o [provedor WMI do Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Recupera o número do barramento ao qual a imagem da unidade está anexada.
...
O número do barramento que corresponde a essa conexão.
