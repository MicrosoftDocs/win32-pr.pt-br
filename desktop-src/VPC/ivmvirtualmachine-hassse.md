...
---
# <a name="ivmvirtualmachinehassse-property"></a>Propriedade IVMVirtualMachine:: HasSSE
...
**True** se o processador tiver suporte para o conjunto de instruções SSE; caso contrário, **false** .
