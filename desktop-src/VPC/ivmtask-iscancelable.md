...
---
# <a name="ivmtaskiscancelable-property"></a>Propriedade IVMTask:: iscancelável
...
**True** se a tarefa puder ser cancelada antes da conclusão; caso contrário, retornará **false** .
