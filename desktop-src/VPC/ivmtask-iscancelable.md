---
title: Propriedade IvMTask IsCancelable (VPCCOMInterfaces.h)
description: Determina se a tarefa pode ser cancelada.
ms.assetid: abb8a29a-7f5b-45ba-ae79-d422dfb2f39d
keywords:
- Propriedade IsCancelable Pc Virtual
- Propriedade IsCancelable Pc Virtual, interface IVMTask
- INTERFACE IVMTask Pc Virtual , propriedade IsCancelable
topic_type:
- apiref
api_name:
...
ms.locfileid: "119973786"
---
# <a name="ivmtaskiscancelable-property"></a>Propriedade IVMTask::IsCancelable

\[Windows O PC virtual não está mais disponível para uso a partir Windows 8. Em vez disso, use o provedor WMI do [Hyper-V (V2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Determina se a tarefa pode ser cancelada.
...
**TRUE** se a tarefa puder ser cancelada antes da conclusão e **FALSE,** caso contrário.
