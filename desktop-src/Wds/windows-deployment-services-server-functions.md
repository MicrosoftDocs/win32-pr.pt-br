...
---
# <a name="windows-deployment-services-server-functions"></a>Funções de servidor dos serviços de implantação do Windows

As funções a seguir são usadas com a API do servidor PXE dos serviços de implantação do Windows.
