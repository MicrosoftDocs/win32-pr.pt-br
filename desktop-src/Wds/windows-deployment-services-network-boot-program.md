---
title: Windows Programa de inicialização de rede dos Serviços de Implantação
ms.assetid: 3d3170f5-3a09-4588-a15d-bca15cc2d026
description: 'Saiba mais sobre: Programa Windows Inicialização de Rede dos Serviços de Implantação'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119053244"
---
# <a name="windows-deployment-services-network-boot-program"></a>Windows Programa de inicialização de rede dos Serviços de Implantação

As seguintes funções podem ser usadas para construir pacotes para o programa de inicialização de rede do WDS:
