---
title: Programa de inicialização de rede dos serviços de implantação do Windows
ms.assetid: 3d3170f5-3a09-4588-a15d-bca15cc2d026
description: 'Saiba mais sobre: programa de inicialização de rede dos serviços de implantação do Windows'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105782617"
---
# <a name="windows-deployment-services-network-boot-program"></a>Programa de inicialização de rede dos serviços de implantação do Windows

As funções a seguir podem ser usadas para construir pacotes para o programa de inicialização de rede do WDS:
