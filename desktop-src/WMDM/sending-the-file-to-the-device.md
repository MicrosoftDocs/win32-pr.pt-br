...
keywords:
- Windows Gerenciador de Dispositivos de mídia, enviando arquivos para dispositivos
...
- criando Windows mídia Gerenciador de Dispositivos aplicativos, enviando arquivos para dispositivos
...
O código C++ a seguir demonstra como chamar **Insert3** para gravar um arquivo em um dispositivo. Se o ponteiro *pOperation* passado para **Insert3** for **NULL**, o arquivo será enviado em uma etapa; se esse ponteiro for um ponteiro de interface válido, Windows mídia Gerenciador de Dispositivos chamará o método de retorno de chamada para obter dados em blocos. Para obter detalhes sobre como implementar o **IWMDMOperation**, consulte [manipulando transferências de arquivos manualmente](handling-file-transfers-manually.md).
