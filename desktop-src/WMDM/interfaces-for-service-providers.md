...
| [**IMDServiceProvider**](/windows/desktop/api/mswmdm/nn-mswmdm-imdserviceprovider)       | Fornece ao cliente (geralmente Windows Media Gerenciador de Dispositivos) com um enumerador de dispositivo para os dispositivos aos quais esse provedor de serviços dá suporte.                                                                                                                                                                          |
...
| [**IMDSPDirectTransfer**](/windows/desktop/api/mswmdm/nn-mswmdm-imdspdirecttransfer)     | Permite que o Windows Media Gerenciador de Dispositivos delegue a transferência de conteúdo para o provedor de serviços. Nesse caso, o Windows Media Gerenciador de Dispositivos não realiza nenhum processamento do conteúdo antes de enviá-lo para o provedor de serviços. O provedor de serviços obtém controle total da origem.                                   |
...
[**Interfaces de DRM-Implemented de mídia do Windows**](windows-media-drm-implemented-interfaces.md)
</dt> </dl>
