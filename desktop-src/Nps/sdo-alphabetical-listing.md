...
ms.locfileid: "120074276"
---
# <a name="alphabetical-listing"></a>Lista alfabética

Este tópico lista os tipos de enumeração SDO em ordem alfabética.
...
-   [**TIPO DE \_ AUTENTICAÇÃO**](/windows/desktop/api/SdoIas/ne-sdoias-authentication_type)
...
-   [**TIPO DE \_ IDENTIDADE**](/windows/desktop/api/sdoias/ne-sdoias-identity_type)
...
-   [**NOVA \_ FREQUÊNCIA DO ARQUIVO DE \_ \_ LOG**](/windows/desktop/api/sdoias/ne-sdoias-new_log_file_frequency)
...
-   [**CORREÇÃOSERVIDORESPROPRIEDADES**](/windows/desktop/api/sdoias/ne-sdoias-remediationserversproperties)
-   [**TIPO DE \_ SERVIÇO**](/windows/desktop/api/sdoias/ne-sdoias-service_type)
-   [**TIPO DE \_ COMBINAÇÃO DE SHV \_**](/windows/desktop/api/sdoias/ne-sdoias-shv_combination_type)
