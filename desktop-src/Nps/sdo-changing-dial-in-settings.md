...
---
# <a name="changing-dial-in-settings"></a><span data-ttu-id="50a8f-103">Alterando as configurações de discagem</span><span class="sxs-lookup"><span data-stu-id="50a8f-103">Changing Dial-In Settings</span></span>

<span data-ttu-id="50a8f-104">O seguinte código VBScript define o bit de discagem e o número de retorno de chamada para um usuário.</span><span class="sxs-lookup"><span data-stu-id="50a8f-104">The following VBScript code sets the dial-in bit and callback number for a user.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="50a8f-105">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="50a8f-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="50a8f-106">**CLIENTproperties**</span><span class="sxs-lookup"><span data-stu-id="50a8f-106">**CLIENTPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-clientproperties)
</dt> <dt>

[<span data-ttu-id="50a8f-107">Enumerando objetos em uma coleção</span><span class="sxs-lookup"><span data-stu-id="50a8f-107">Enumerating Objects in a Collection</span></span>](/windows/desktop/Nps/sdo-enumerating-objects-in-a-collection)
</dt> <dt>

[<span data-ttu-id="50a8f-108">**IASPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="50a8f-108">**IASPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iasproperties)
</dt> <dt>

[<span data-ttu-id="50a8f-109">**ISdo**</span><span class="sxs-lookup"><span data-stu-id="50a8f-109">**ISdo**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdo)
</dt> <dt>

[<span data-ttu-id="50a8f-110">**ISdoMachine**</span><span class="sxs-lookup"><span data-stu-id="50a8f-110">**ISdoMachine**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdomachine)
</dt> <dt>

[<span data-ttu-id="50a8f-111">**RADIUSproperties**</span><span class="sxs-lookup"><span data-stu-id="50a8f-111">**RADIUSPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-radiusproperties)
</dt> </dl>
