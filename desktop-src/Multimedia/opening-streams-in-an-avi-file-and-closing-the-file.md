...
---
# <a name="opening-streams-in-an-avi-file-and-closing-the-file"></a>Abrindo fluxos em um arquivo AVI e fechando o arquivo

O exemplo a seguir abre todos os fluxos em um arquivo AVI usando a função [**AVIFileGetStream**](/windows/desktop/api/Vfw/nf-vfw-avifilegetstream) . Se um erro for encontrado, o arquivo será fechado.
