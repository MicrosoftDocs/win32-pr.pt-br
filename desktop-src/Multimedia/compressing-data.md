...
---
# <a name="compressing-data"></a><span data-ttu-id="8aa01-108">Compactando dados</span><span class="sxs-lookup"><span data-stu-id="8aa01-108">Compressing Data</span></span>

<span data-ttu-id="8aa01-109">O exemplo a seguir compacta os dados de imagem para uso em um arquivo AVI.</span><span class="sxs-lookup"><span data-stu-id="8aa01-109">The following example compresses image data for use in an AVI file.</span></span> <span data-ttu-id="8aa01-110">Ele pressupõe que o compressor não dá suporte aos sinalizadores VIDCF de VIDCF ou de demarcações \_ \_ temporais, mas oferece suporte à qualidade de VIDCF \_ .</span><span class="sxs-lookup"><span data-stu-id="8aa01-110">It assumes the compressor does not support the VIDCF\_CRUNCH or VIDCF\_TEMPORAL flags, but it does support VIDCF\_QUALITY.</span></span> <span data-ttu-id="8aa01-111">O exemplo usa a macro [**ICCompressBegin**](/windows/desktop/api/Vfw/nf-vfw-iccompressbegin) , a função [**ICCompress**](/windows/desktop/api/Vfw/nf-vfw-iccompress) e a macro [**ICCompressEnd**](/windows/desktop/api/Vfw/nf-vfw-iccompressend) .</span><span class="sxs-lookup"><span data-stu-id="8aa01-111">The example uses the [**ICCompressBegin**](/windows/desktop/api/Vfw/nf-vfw-iccompressbegin) macro, the [**ICCompress**](/windows/desktop/api/Vfw/nf-vfw-iccompress) function, and the [**ICCompressEnd**](/windows/desktop/api/Vfw/nf-vfw-iccompressend) macro.</span></span>
