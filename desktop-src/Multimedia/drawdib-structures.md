---
title: Estruturas DrawDib
description: Estruturas DrawDib
ms.assetid: dde56eae-2f20-4c76-9d3d-8f8fe84217a9
keywords:
- Multimídia do Windows, estruturas DrawDib
- multimídia, estruturas DrawDib
- Vídeo para Windows (VFW), estruturas DrawDib
- VFW (vídeo para Windows), estruturas DrawDib
- DrawDib, estruturas
- Referência do DrawDib, estruturas
- referência para DrawDib, estruturas
ms.topic: article
ms.date: 05/31/2018
