...
---
# <a name="creating-a-driverproc-function"></a><span data-ttu-id="31bc2-107">Criando uma função DriverProc</span><span class="sxs-lookup"><span data-stu-id="31bc2-107">Creating a DriverProc Function</span></span>

<span data-ttu-id="31bc2-108">Você cria uma função [DriverProc](/windows/win32/api/mmiscapi/nc-mmiscapi-driverproc) praticamente da mesma maneira que cria um procedimento de janela.</span><span class="sxs-lookup"><span data-stu-id="31bc2-108">You create a [DriverProc](/windows/win32/api/mmiscapi/nc-mmiscapi-driverproc) function in much the same way as you create a window procedure.</span></span> <span data-ttu-id="31bc2-109">A função consiste em uma instrução **switch** e cada caso processa uma determinada mensagem de driver, retornando um valor indicando êxito ou falha.</span><span class="sxs-lookup"><span data-stu-id="31bc2-109">The function consists of a **switch** statement, and each case processes a given driver message, returning a value indicating success or failure.</span></span> <span data-ttu-id="31bc2-110">A função **DriverProc** tem o seguinte formato:</span><span class="sxs-lookup"><span data-stu-id="31bc2-110">The **DriverProc** function has the following form:</span></span>
