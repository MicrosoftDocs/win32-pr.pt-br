...
ms.locfileid: "104365846"
---
# <a name="playing-a-compact-disc-track"></a><span data-ttu-id="177c4-104">Reproduzindo uma faixa de CD</span><span class="sxs-lookup"><span data-stu-id="177c4-104">Playing a Compact Disc Track</span></span>

<span data-ttu-id="177c4-105">O exemplo a seguir abre um dispositivo de áudio de CD, reproduz a faixa especificada pelo parâmetro *bTrack* e fecha o dispositivo após a reprodução ser concluída.</span><span class="sxs-lookup"><span data-stu-id="177c4-105">The following example opens a CD audio device, plays the track specified by the *bTrack* parameter, and closes the device after playback is complete.</span></span> <span data-ttu-id="177c4-106">Ele usa a função [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .</span><span class="sxs-lookup"><span data-stu-id="177c4-106">It uses the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
...
<span data-ttu-id="177c4-107">Para especificar uma posição relativa a uma faixa em um CD, você deve usar o formato de hora Track/minuto/segundo/quadro (TMSF).</span><span class="sxs-lookup"><span data-stu-id="177c4-107">To specify a position relative to a track on a compact disc, you must use the track/minute/second/frame (TMSF) time format.</span></span>
