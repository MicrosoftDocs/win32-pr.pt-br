...
---
# <a name="retrieving-a-string-that-describes-a-filter"></a><span data-ttu-id="2c68f-109">Recuperando uma cadeia de caracteres que descreve um filtro</span><span class="sxs-lookup"><span data-stu-id="2c68f-109">Retrieving a String That Describes a Filter</span></span>

<span data-ttu-id="2c68f-110">Um aplicativo geralmente precisa exibir uma cadeia de caracteres que descreve o formato atual.</span><span class="sxs-lookup"><span data-stu-id="2c68f-110">An application often needs to display a string that describes the current format.</span></span> <span data-ttu-id="2c68f-111">Essa tarefa pode ser realizada facilmente com as funções [**acmFilterTagDetails**](/windows/desktop/api/Msacm/nf-msacm-acmfiltertagdetails) e [**acmFilterDetails**](/windows/desktop/api/Msacm/nf-msacm-acmfilterdetails) .</span><span class="sxs-lookup"><span data-stu-id="2c68f-111">This task can be accomplished easily with the [**acmFilterTagDetails**](/windows/desktop/api/Msacm/nf-msacm-acmfiltertagdetails) and [**acmFilterDetails**](/windows/desktop/api/Msacm/nf-msacm-acmfilterdetails) functions.</span></span> <span data-ttu-id="2c68f-112">Essas funções devem ser chamadas com a marca de filtro ou filtro apropriada.</span><span class="sxs-lookup"><span data-stu-id="2c68f-112">These functions must be called with the appropriate filter or filter tag.</span></span> <span data-ttu-id="2c68f-113">O exemplo a seguir mostra como usar essas funções.</span><span class="sxs-lookup"><span data-stu-id="2c68f-113">The following example shows how to use these functions.</span></span>
