...
---
# <a name="reading-from-one-stream-and-writing-to-another"></a><span data-ttu-id="3696b-103">Lendo de um fluxo e gravando em outro</span><span class="sxs-lookup"><span data-stu-id="3696b-103">Reading from One Stream and Writing to Another</span></span>

<span data-ttu-id="3696b-104">O exemplo a seguir lê dados de um fluxo, faz algo com os dados e grava os dados compactados em um fluxo de um novo arquivo.</span><span class="sxs-lookup"><span data-stu-id="3696b-104">The following example reads data from a stream, does something with the data, and writes the compressed data into a stream of a new file.</span></span>
