---
title: Mensagens MCIWnd
description: Mensagens MCIWnd
ms.assetid: 03352b8f-7483-483f-a2bc-af323ab3b9e6
keywords:
- MCI (Interface de Controle de Mídia), mensagens MCIWnd
- Classe de janela MCIWnd, mensagens
- Janela MCIWnd, mensagens
- Referência de MCIWnd, mensagens
- Mensagens MCIWnd
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119783386"
---
# <a name="mciwnd-messages"></a>Mensagens MCIWnd

As mensagens a seguir são usadas com MCIWnd.
...
-   [**JANELA PODE MCIWNDM \_ \_**](mciwndm-can-window.md)
-   [**MCIWNDM \_ CHANGESTYLES**](mciwndm-changestyles.md)
-   [**MCIWNDM \_ EJETO**](mciwndm-eject.md)
...
[Referência de MCIWnd](mciwnd-reference.md)
</dt> </dl>
