---
title: Funções de MIDI
description: Funções de MIDI
ms.assetid: 9aa9fd79-cd9e-4443-8715-142ea72b82c0
keywords:
- áudio multimídia, funções MIDI
- funções de áudio, MIDI
- MIDI (interface digital de instrumento musical), funções
- MIDI (interface digital de instrumentos musicais), funções
- referência para MIDI, funções
- Referência de MIDI, funções
- Funções de MIDI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104084523"
---
# <a name="midi-functions"></a>Funções de MIDI

As funções a seguir são usadas com MIDI.
