---
title: Funções AVIFile
description: Funções AVIFile
...
ms.locfileid: "104453737"
---
# <a name="avifile-functions"></a>Funções AVIFile

As funções a seguir são usadas com AVIFile.
...
[Referência de AVIFile](avifile-reference.md)
</dt> </dl>
