---
title: Macros de compactação de vídeo
description: Macros de compactação de vídeo
ms.assetid: e8ee41fa-180a-432a-933b-b4a525b9df8c
keywords:
- Vídeo para Windows (VFW), macros VCM
- VFW (vídeo para Windows), macros VCM
- VCM (Gerenciador de compactação de vídeo), macros
- VCM (Gerenciador de compactação de vídeo), macros
- Referência do VCM, macros
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104291909"
---
# <a name="video-compression-macros"></a>Macros de compactação de vídeo

As macros a seguir são usadas com a compactação de vídeo.
