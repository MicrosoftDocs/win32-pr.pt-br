...
---
# <a name="opening-the-playback-window"></a><span data-ttu-id="07b0d-104">Abrindo a janela de reprodução</span><span class="sxs-lookup"><span data-stu-id="07b0d-104">Opening the Playback Window</span></span>

<span data-ttu-id="07b0d-105">O exemplo a seguir mostra como usar o comando [**MCI \_ Open**](mci-open.md) para definir uma janela pai e criar um filho dessa janela.</span><span class="sxs-lookup"><span data-stu-id="07b0d-105">The following example shows how to use the [**MCI\_OPEN**](mci-open.md) command to set a parent window and create a child of that window.</span></span>
