...
Depois de determinar quantos dispositivos de entrada ou saída de MIDI estão presentes em um sistema, você pode consultar os recursos de cada dispositivo. O Windows fornece as seguintes funções para determinar os recursos dos dispositivos de áudio.
