---
title: Como tocar um Waveform-Audio arquivo
description: Como tocar um Waveform-Audio arquivo
...
ms.locfileid: "118372647"
---
# <a name="playing-a-waveform-audio-file"></a>Como tocar um Waveform-Audio arquivo

O exemplo a seguir abre um dispositivo waveform-audio e reproduz o arquivo waveform-audio especificado pelo parâmetro *lpszWAVEFileName* usando a [**função mciSendCommand.**](/previous-versions//dd757160(v=vs.85))
