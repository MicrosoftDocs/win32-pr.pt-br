...
---
# <a name="playing-a-waveform-audio-file"></a><span data-ttu-id="1d512-103">Executando um arquivo de Waveform-Audio</span><span class="sxs-lookup"><span data-stu-id="1d512-103">Playing a Waveform-Audio File</span></span>

<span data-ttu-id="1d512-104">O exemplo a seguir abre um dispositivo de wave-áudio e executa o arquivo de formato de onda-áudio especificado pelo parâmetro *lpszWAVEFileName* usando a função [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .</span><span class="sxs-lookup"><span data-stu-id="1d512-104">The following example opens a waveform-audio device and plays the waveform-audio file specified by the *lpszWAVEFileName* parameter using the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
