...
---
# <a name="monitoring-compressor-and-decompressor-progress"></a><span data-ttu-id="cdd44-106">Progresso do monitoramento e do descompactador</span><span class="sxs-lookup"><span data-stu-id="cdd44-106">Monitoring Compressor and Decompressor Progress</span></span>

<span data-ttu-id="cdd44-107">O exemplo a seguir mostra como a função [**ICSetStatusProc**](/windows/desktop/api/Vfw/nf-vfw-icsetstatusproc) é usada para informar o compressor ou o descompactador do endereço da função de retorno de chamada:</span><span class="sxs-lookup"><span data-stu-id="cdd44-107">The following example shows how the [**ICSetStatusProc**](/windows/desktop/api/Vfw/nf-vfw-icsetstatusproc) function is used to inform the compressor or decompressor of the callback function address:</span></span>
...
<span data-ttu-id="cdd44-108">O exemplo a seguir mostra a função de retorno de chamada instalada pelo fragmento anterior:</span><span class="sxs-lookup"><span data-stu-id="cdd44-108">The following example shows the callback function installed by the previous fragment:</span></span>
