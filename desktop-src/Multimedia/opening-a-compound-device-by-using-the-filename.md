...
---
# <a name="opening-a-compound-device-by-using-the-filename"></a><span data-ttu-id="ce365-104">Abrindo um dispositivo composto usando o nome de arquivo</span><span class="sxs-lookup"><span data-stu-id="ce365-104">Opening a Compound Device by Using the Filename</span></span>

<span data-ttu-id="ce365-105">O exemplo a seguir abre o dispositivo de formato de onda-áudio especificando um arquivo de wave-áudio chamado "TIMPANI. WAV "usando a função [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .</span><span class="sxs-lookup"><span data-stu-id="ce365-105">The following example opens the waveform-audio device by specifying a waveform-audio file named "TIMPANI.WAV" using the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
