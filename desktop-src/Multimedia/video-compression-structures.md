---
title: Estruturas de compactação de vídeo
description: Estruturas de compactação de vídeo
ms.assetid: 129a65a7-cac3-47e0-9e9c-6e5a4a260c73
keywords:
- Vídeo para Windows (VFW), estruturas VCM
- VFW (vídeo para Windows), estruturas VCM
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104159503"
---
# <a name="video-compression-structures"></a>Estruturas de compactação de vídeo

As estruturas a seguir são usadas com a compactação de vídeo.
