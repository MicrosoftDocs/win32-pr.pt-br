...
O joystick é um dispositivo de entrada auxiliar para aplicativos que fornecem alternativas ao uso do teclado e do mouse. O joystick fornece informações posicionais em um sistema de coordenadas que tem valores máximos e mínimos absolutos em cada eixo de movimento.
