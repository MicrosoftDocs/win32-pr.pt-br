...
---
# <a name="using-the-editing-functions-and-putting-a-file-on-the-clipboard"></a><span data-ttu-id="a8110-106">Usando as funções de edição e colocando um arquivo na área de transferência</span><span class="sxs-lookup"><span data-stu-id="a8110-106">Using the Editing Functions and Putting a File on the Clipboard</span></span>

<span data-ttu-id="a8110-107">O exemplo a seguir recorta, copia ou exclui segmentos de uma matriz de fluxos.</span><span class="sxs-lookup"><span data-stu-id="a8110-107">The following example cuts, copies, or deletes segments from an array of streams.</span></span> <span data-ttu-id="a8110-108">Os fluxos recortados e copiados são mesclados em um novo arquivo e colocados na área de transferência.</span><span class="sxs-lookup"><span data-stu-id="a8110-108">The cut and copied streams are merged into a new file and placed on the clipboard.</span></span> <span data-ttu-id="a8110-109">As funções usadas incluem [**EditStreamClone**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**EditStreamCopy**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy)e [**EditStreamCut**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).</span><span class="sxs-lookup"><span data-stu-id="a8110-109">The functions used include [**EditStreamClone**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**EditStreamCopy**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy), and [**EditStreamCut**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).</span></span>
