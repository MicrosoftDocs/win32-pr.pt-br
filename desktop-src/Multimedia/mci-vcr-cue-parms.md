...
keywords:
- estrutura de MCI_VCR_CUE_PARMS Windows multimídia
topic_type:
- apiref
api_name:
- MCI_VCR_CUE_PARMS
...
ms.locfileid: "120038236"
---
# <a name="mci_vcr_cue_parms-structure"></a>\_Estrutura de \_ parâmetros de sinalização VCR MCI \_

A estrutura de parâmetros de indicação de VCR do MCI contém parâmetros para o comando de [**\_ indicação MCI**](mci-cue.md) para gravadores de vídeo-fita. **\_ \_ \_**
...
Posição da qual se deve se marcar.
