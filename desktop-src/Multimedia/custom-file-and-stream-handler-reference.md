---
title: Referência de manipulador de arquivo e fluxo personalizado
description: Referência de manipulador de arquivo e fluxo personalizado
ms.assetid: 8b3aa36c-fc82-489e-97aa-91bef1dc5cf6
keywords:
- Vídeo para Windows (VFW), referência de manipulador de arquivo personalizado
- Video for Windows (VFW), referência de manipulador de fluxo personalizado
- Vídeo para Windows (VFW), referência de manipulador de arquivo
- Video for Windows (VFW), referência do manipulador de fluxo
- VFW (vídeo para Windows), referência de manipulador de arquivo personalizado
- VFW (vídeo para Windows), referência de manipulador de fluxo personalizado
- VFW (vídeo para Windows), referência de manipulador de arquivo
- VFW (vídeo para Windows), referência do manipulador de fluxo
ms.topic: article
ms.date: 05/31/2018
