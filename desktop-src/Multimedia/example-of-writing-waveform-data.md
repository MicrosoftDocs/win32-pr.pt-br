...
---
# <a name="example-of-writing-waveform-data"></a>Exemplo de gravação de dados de onda

O exemplo a seguir ilustra as etapas necessárias para alocar e configurar uma estrutura [**WAVEHDR**](/windows/win32/api/mmeapi/ns-mmeapi-wavehdr) e gravar um bloco de dados em um dispositivo de saída de forma de onda.
