---
title: Interfaces de manipulador de arquivo e fluxo personalizadas
description: Interfaces de manipulador de arquivo e fluxo personalizadas
ms.assetid: ced6f7d1-5f27-47f4-a912-8c17ea5fa685
keywords:
- Vídeo para Windows (VFW), interfaces de manipulador de arquivo personalizado
- Vídeo para Windows (VFW), interfaces de manipulador de fluxo personalizado
- Vídeo para Windows (VFW), interfaces de manipulador de arquivo
- Vídeo para Windows (VFW), interfaces de manipulador de fluxo
- VFW (vídeo para Windows), interfaces de manipulador de arquivo personalizado
- VFW (vídeo para Windows), interfaces de manipulador de fluxo personalizado
- VFW (vídeo para Windows), interfaces de manipuladores de arquivo
- VFW (vídeo para Windows), interfaces de manipulador de fluxo
ms.topic: article
ms.date: 05/31/2018
