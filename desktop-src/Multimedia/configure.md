...
---
# <a name="configure-command"></a>Configurar comando

O comando configurar exibe uma caixa de diálogo usada para configurar o dispositivo. Dispositivos de vídeo digital reconhecem este comando.
