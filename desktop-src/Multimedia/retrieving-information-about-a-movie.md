...
---
# <a name="retrieving-information-about-a-movie"></a><span data-ttu-id="16ba1-104">Recuperando informações sobre um filme</span><span class="sxs-lookup"><span data-stu-id="16ba1-104">Retrieving Information About a Movie</span></span>

<span data-ttu-id="16ba1-105">O exemplo a seguir define o formato de hora como quadros e obtém a posição atual se o dispositivo estiver sendo executado usando a função [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .</span><span class="sxs-lookup"><span data-stu-id="16ba1-105">The following example sets the time format to frames and obtains the current position if the device is playing using the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
