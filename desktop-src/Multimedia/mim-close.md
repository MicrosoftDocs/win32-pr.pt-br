...
---
# <a name="mim_close-message"></a>Mensagem de fechamento do MIM \_

A mensagem de **\_ fechamento do mim** é enviada para uma função de retorno de chamada de entrada de Midi quando um dispositivo de entrada MIDI é fechado.
