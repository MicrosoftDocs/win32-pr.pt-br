...
---
# <a name="installing-compressors-and-decompressors"></a><span data-ttu-id="b3362-106">Instalando os compactadores e os descompactadores</span><span class="sxs-lookup"><span data-stu-id="b3362-106">Installing Compressors and Decompressors</span></span>

<span data-ttu-id="b3362-107">O exemplo a seguir mostra como um aplicativo pode instalar uma função como um compactador ou descompactador usando a função [**ICInstall**](/windows/desktop/api/Vfw/nf-vfw-icinstall) .</span><span class="sxs-lookup"><span data-stu-id="b3362-107">The following example shows how an application can install a function as a compressor or decompressor using the [**ICInstall**](/windows/desktop/api/Vfw/nf-vfw-icinstall) function.</span></span>
