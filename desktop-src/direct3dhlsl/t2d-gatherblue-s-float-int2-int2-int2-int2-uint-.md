...
description: Retorna os componentes azuis dos quatro valores de texel que seriam usados em uma operação de filtragem bi-linear, juntamente com o status de mapeamento de peças. | Função Texture2D::GatherBlue(S,float,int2,int2,int2,int2,uint)
...
ms.locfileid: "119852776"
---
# <a name="texture2dgatherbluesfloatint2int2int2int2uint-function"></a>Função Texture2D::GatherBlue(S,float,int2,int2,int2,int2,uint)
