...
Adição de & de multiplicação por componente.
...
| Item                                                            | Descrição                                                                                  |
|-----------------------------------------------------------------|----------------------------------------------------------------------------------------------|
| <span id="dest"></span><span id="DEST"></span>*dest*<br/> | \[no \] resultado da operação.<br/> *dest*  =  *src0* \* *src1*  +  *src2*<br/> |
...
| <span id="src2"></span><span id="SRC2"></span>*src2*<br/> | \[no \] adendo.<br/>                                                                |
