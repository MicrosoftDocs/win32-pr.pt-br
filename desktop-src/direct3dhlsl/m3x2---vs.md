...
Os modificadores swizzle e negação são inválidos para o registro src1. O registro de dest e src0, ou qualquer um dos registros de src1 + i, não pode ser o mesmo.
