...
ms.locfileid: "118507359"
---
# <a name="texture2darraygathercmpgreensfloatfloatint2int2int2int2-function"></a>Função Texture2DArray:: GatherCmpGreen (S, float, float, Int2, Int2, Int2, Int2)
