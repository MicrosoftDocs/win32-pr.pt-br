...
description: Número inteiro sem sinal atômico mínimo para a memória.
...
ms.locfileid: "118516778"
---
# <a name="atomic_umin-sm5---asm"></a>atomic \_ umin (sm5 - asm)

Número inteiro sem sinal atômico mínimo para a memória.
...
Essa instrução executa um único componente de 32 bits sem assinatura mínimo de *src0* de operand em *dst* a 32 bits por endereço de componente *dstAddress*, executado atomicamente.
