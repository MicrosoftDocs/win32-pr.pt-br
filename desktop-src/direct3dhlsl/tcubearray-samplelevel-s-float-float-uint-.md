...
description: Amostra uma textura no nível de mipmap especificado e retorna o status sobre a operação. | Função SampleLevel::SampleLevel(S,float,float,uint)
