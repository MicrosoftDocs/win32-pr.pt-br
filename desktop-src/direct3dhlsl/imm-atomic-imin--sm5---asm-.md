...
---
# <a name="imm_atomic_imin-sm5---asm"></a>\_Imin atômico \_ do IMM (SM5-ASM)

O mínimo de memória do Atomic imediato foi assinado. Retorna o valor na memória antes da operação de máximo.



| IMM \_ Atomic \_ Imin dst0 \[ . \_ \_ máscara de componente único \] , dst1, dstAddress \[ . swizzle \] , \[ \_ componente src0. Select\] |
|--------------------------------------------------------------------------------------------------------------|
...
Essa instrução executa um único componente com sinal de 32 de operando no mínimo *src0* com *dst1* em 32 bits por endereço de componente *dstAddress*.
