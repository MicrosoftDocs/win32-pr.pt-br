---
title: vs_2_0
description: Saiba mais sobre vs_2_0, um sombreador de vértice programável, que é composto de um conjunto de instruções que operam em dados de vértice.
