...
---
# <a name="instructions---vs_2_0"></a>Instruções-vs \_ 2 \_ 0

Esta seção contém informações de referência para as instruções da versão 2 0 do sombreador de vértice \_ .
...
-   Controle de fluxo-essas instruções adicionam recursos de controle de fluxo, como [loop](loop---vs.md)... [ENDLOOP](endloop---vs.md), [If](if-bool---vs.md)... [senão](else---vs.md)... [endif-vs](endif---vs.md)e chamadas de sub-rotina.
...
| [callnz bool-vs](callnz-bool---vs.md)                                       | Chamar uma sub-rotina se um registro booliano não for zero                                                             | 3                 |       |            | x            | x   |
| [CRS-vs](crs---vs.md)                                                       | Produto cruzado                                                                                                   | 2                 |       | x          |              | x   |
| [\_entrada de uso de DCL (SM1, SM2, SM3-vs ASM)](dcl-usage-input-register---vs.md) | Declarar registros de vértice de entrada (consulte [registros-vs. \_ 2 \_ 0](dx9-graphics-reference-asm-vs-registers-vs-2-0.md)) | 0                 | x     |            |              |     |
...
| [else-vs](else---vs.md)                                                     | Iniciar um bloco [else-vs](else---vs.md)                                                                       | 1                 |       |            | x            | x   |
| [endif-vs](endif---vs.md)                                                   | Encerrar um [If bool-vs](if-bool---vs.md)... bloco [else-vs](else---vs.md)                                      | 1                 |       |            | x            | x   |
| [ENDLOOP-vs](endloop---vs.md)                                               | Fim de um bloco de [loop vs](loop---vs.md)                                                                       | 2                 |       |            | x            | x   |
...
| [se bool-vs](if-bool---vs.md)                                               | Iniciar um bloco [bool-vs](if-bool---vs.md) (usando uma condição booliana)                                     | 3                 |       |            | x            | x   |
| [rótulo – vs](label---vs.md)                                                   | Label                                                                                                           | 0                 |       |            | x            | x   |
...
| [Mova-vs](mova---vs.md)                                                     | Mover dados de um ponto flutuante registrar para o registro de endereço (a0)                                           | 1                 |       | x          |              | x   |
