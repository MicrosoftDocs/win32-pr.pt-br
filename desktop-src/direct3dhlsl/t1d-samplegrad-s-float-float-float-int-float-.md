...
ms.locfileid: "117724270"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloat-function-for-texture1d"></a>SampleGrad:: SampleGrad (S, float, float, float, int, float) function para Texture1D
