...
---
# <a name="samplecmpsamplecmpsfloatfloatintfloat-function-for-texture2d"></a>SampleCmp:: SampleCmp (S, float, float, int, float) function para Texture2D

Amostras de um [**Texture2D**](sm5-object-texture2d.md), usando um valor de comparação para rejeitar amostras, com um valor opcional para fixe de exemplo de valores de LOD (nível de detalhe) de amostra para.
