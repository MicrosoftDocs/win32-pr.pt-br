...
ms.locfileid: "119855656"
---
# <a name="shader-model-5-intrinsic-functions"></a>Funções intrínsecas do modelo de sombreador 5

O Shader Model 5 implementa as funções intrínsecas do Shader Model 4 e abaixo (consulte [**funções intrínsecas (DirectX HLSL)**](dx-graphics-hlsl-intrinsic-functions.md) para obter uma lista completa das funções com suporte), bem como as novas funções a seguir:
...
-   [**campo DDX \_ grande**](ddx-coarse.md)
-   [**ddy \_ grande**](ddy-coarse.md)
...
-   [**Interbloqueador**](interlockedor.md)
