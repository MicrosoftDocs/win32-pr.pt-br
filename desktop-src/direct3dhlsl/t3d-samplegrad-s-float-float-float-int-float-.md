...
ms.locfileid: "120118036"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloat-function-for-texture3d"></a>SampleGrad:: SampleGrad (S, float, float, float, int, float) function para Texture3D
