---
title: m4x4 – ps
description: Multiplica um vetor de quatro componentes por uma matriz 4x4. | m4x4 – ps
...
ms.locfileid: "117906845"
---
# <a name="m4x4---ps"></a>m4x4 – ps

Multiplica um vetor de quatro componentes por uma matriz 4x4.
...
Modificadores swizzle e negate são inválidos para o registro src0. Os registros dst e src0 não podem ser os mesmos.
...
O vetor de entrada está no registro src0. A matriz de entrada 4x4 está no registro src1 e os próximos três registros superiores, conforme mostrado na expansão abaixo.

Essa operação geralmente é usada para transformar uma posição por uma matriz de projeção. Essa instrução é implementada como um conjunto de produtos de ponto, conforme mostrado aqui.
