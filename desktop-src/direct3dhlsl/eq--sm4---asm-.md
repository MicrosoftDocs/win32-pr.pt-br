...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | \[no \] componente para comapre para *src1*.<br/>         |
| <span id="src1"></span><span id="SRC1"></span>*src1*<br/> | \[no \] componente para comapre para *src0*.<br/>         |
...
As desnormas são liberadas antes da comparação (registros originais de origem não tocados). + 0 é igual a-0. A comparação com NaN retorna false.
