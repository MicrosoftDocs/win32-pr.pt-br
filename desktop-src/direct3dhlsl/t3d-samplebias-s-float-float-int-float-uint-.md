...
description: Amostra uma textura, depois de aplicar o valor de desvio ao nível de mipmap, com um valor opcional para fixar valores lod (nível de detalhes) de exemplo. | Função SampleBias::SampleBias(S,float,float,int,float,uint) para Texture3D
...
ms.locfileid: "119043444"
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture3d"></a>Função SampleBias::SampleBias(S,float,float,int,float,uint) para Texture3D

Amostra uma textura, depois de aplicar o valor de desvio ao nível de mipmap, com um valor opcional para fixar valores lod (nível de detalhes) de exemplo. Retorna o status sobre a operação.
