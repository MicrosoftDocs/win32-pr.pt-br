...
Os modificadores swizzle e negação são inválidos para o registro src0. Os registros dest e src0 não podem ser iguais.
...
Essa operação é normalmente usada para transformar uma posição por uma matriz de projeção. Essa instrução é implementada como uma série de produtos dot, conforme mostrado aqui.
