...
description: Máximo imediato não assinado atômico na memória. Retorna o valor na memória antes da operação máxima.
...
ms.locfileid: "118986506"
---
# <a name="imm_atomic_umax-sm5---asm"></a>imm \_ atomic \_ umax (sm5 - asm)

Máximo imediato não assinado atômico na memória. Retorna o valor na memória antes da operação máxima.



| imm \_ atomic \_ umax dst0 \[ .single component mask , \_ \_ \] dst1, dstAddress \[ .swizzle \] , src0 \[ \_ .select component\] |
|--------------------------------------------------------------------------------------------------------------|
...
Essa instrução executa um único componente de 32 bits sem assinatura máximo de *src0* de operand com *dst1* a 32 bits por endereço de componente *dstAddress*.
...
O valor na *memória dst1* antes que max seja retornado *para dst0*.
