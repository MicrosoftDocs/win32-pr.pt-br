...
---
# <a name="imm_atomic_umax-sm5---asm"></a>\_Umax atômico \_ do IMM (SM5-ASM)

O máximo de atômica não assinado imediato para memória. Retorna o valor na memória antes da operação de máximo.



| o IMM \_ Atomic \_ Umax dst0 \[ . \_ máscara de componente único \_ \] , dst1, dstAddress \[ . swizzle \] , \[ \_ componente src0. Select\] |
|--------------------------------------------------------------------------------------------------------------|
...
Esta instrução executa um componente único sem sinal de 32 bits de operando no máximo *src0* com *dst1* em 32 bits por endereço de componente *dstAddress*.
