...
---
# <a name="samplecmpsamplecmpsfloatfloatintfloatuint-function-for-texture1darray"></a>Função SampleCmp:: SampleCmp (S, float, float, int, float, uint) para Texture1DArray
