...
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture3d"></a>SampleGrad:: SampleGrad (S, float, float, float, int, float, uint) function para Texture3D
