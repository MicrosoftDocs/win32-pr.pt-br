...
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture1darray"></a>Função SampleBias:: SampleBias (S, float, float, int, float, uint) para Texture1DArray
