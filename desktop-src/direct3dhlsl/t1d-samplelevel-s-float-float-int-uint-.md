...
description: Amostra uma textura no nível de mipmap especificado e retorna o status sobre a operação. Para Texture1D. | Função SampleLevel::SampleLevel(S,float,float,int,uint)
...
ms.locfileid: "120023376"
---
# <a name="samplelevelsamplelevelsfloatfloatintuint-function-for-texture1d"></a>Função SampleLevel::SampleLevel(S,float,float,int,uint) para Texture1D
