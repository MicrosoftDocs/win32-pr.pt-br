...
---
# <a name="samplecmplevelzerosamplecmplevelzerosfloatfloatuint-function-for-texturecubearray"></a>Função SampleCmpLevelZero:: SampleCmpLevelZero (S, float, float, uint) para TextureCubeArray
