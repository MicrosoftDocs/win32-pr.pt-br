...
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture2d"></a>SampleGrad:: SampleGrad (S, float, float, float, int, float, uint) function para Texture2D

Amostras de um [**Texture2D**](sm5-object-texture2d.md), usando um gradiente para influenciar a maneira como o local de exemplo é calculado, com um valor opcional para fixe de exemplo de valores LOD (nível de detalhe) de amostra. Retorna o status sobre a operação.
