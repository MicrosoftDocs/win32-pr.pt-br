...
description: Para quatro valores de texel que seriam usados em uma operação de filtragem bi-linear, retorna uma comparação de seu componente verde em relação a um valor de comparação junto com o status de mapeamento de peça. | Função TextureCubeArray::GatherCmpGreen(S,float,float,uint)
...
ms.locfileid: "118284637"
---
# <a name="texturecubearraygathercmpgreensfloatfloatuint-function"></a>Função TextureCubeArray::GatherCmpGreen(S,float,float,uint)
