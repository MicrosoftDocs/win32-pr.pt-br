...
---
# <a name="atomic_umax-sm5---asm"></a>\_Umax atômico (SM5-ASM)

Inteiro não assinado de Atomic para memória.



| \_dstAddress \[ . swizzle \] , o \[ componente src0. Select \_ da Umax Atomic\] |
|----------------------------------------------------------------------|
...
Essa instrução executa um componente único sem sinal de 32 bits *de operando no* horário de *verão* em 32 bits por endereço de componente *dstAddress*, executado atomicamente.
