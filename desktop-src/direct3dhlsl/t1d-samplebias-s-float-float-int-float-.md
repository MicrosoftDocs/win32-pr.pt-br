...
description: A função SampleBias::SampleBias(S,float,float,int,float) amostra uma textura depois de aplicar o valor de desvio ao nível de mipmap.
...
ms.locfileid: "118285304"
---
# <a name="samplebiassamplebiassfloatfloatintfloat-function-for-texture1d"></a>Função SampleBias::SampleBias(S,float,float,int,float) para Texture1D
