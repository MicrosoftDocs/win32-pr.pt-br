...
---
# <a name="samplecmplevelzerosamplecmplevelzerosfloatfloatintuint-function-for-texture1darray"></a>Função SampleCmpLevelZero:: SampleCmpLevelZero (S, float, float, int, uint) para Texture1DArray
