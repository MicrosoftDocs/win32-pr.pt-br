---
title: add (sm4 – asm)
description: A adoção por componente de dois vetores.
...
A adoção por componente de dois vetores.
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | \[em \] O vetor a ser adicionar *a src1.*<br/>                |
| <span id="src1"></span><span id="SRC1"></span>*src1*<br/> | \[em \] O vetor a ser adicionar *a src0*.<br/>                |
...
A tabela a seguir mostra os resultados obtidos ao executar a instrução com várias classes de números, supondo que nenhum estouro ou estouro ocorra. F significa um número real finito.
