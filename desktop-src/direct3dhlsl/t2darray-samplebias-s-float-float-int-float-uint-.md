...
ms.locfileid: "118507339"
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture2darray"></a>Função SampleBias:: SampleBias (S, float, float, int, float, uint) para Texture2DArray
