...
---
# <a name="atomic_imax-sm5---asm"></a>\_IMAX atômico (SM5-ASM)

Inteiro com sinal atômico de Atomic para memória.



| \_componente Atomic IMAX DST, dstAddress \[ . swizzle \] , src0 \[ . Select \_\] |
|----------------------------------------------------------------------|
...
Esta operação executa um único componente com o máximo de *src0* de operando com assinatura de 32 bits no *DST* em 32 bits por endereço de componente *dstAddress*, executado atomicamente.
