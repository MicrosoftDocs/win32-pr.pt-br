...
Esta seção contém informações de referência para os registros de entrada e saída implementados pelo vertex shader versão 4 \_ 0.
...
| minúscula\#      | Registro de saída | 16    | W   | N/D       | N/D              | 4        | Sim          |
