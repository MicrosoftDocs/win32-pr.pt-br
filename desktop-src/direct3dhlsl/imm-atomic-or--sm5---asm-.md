...
A bit ou a memória atômicas imediatas. Retorna o valor na memória antes do ou.



| IMM \_ Atomic \_ ou dst0 \[ . \_ \_ máscara de componente único \] , dst1, dstAddress \[ . swizzle \] , \[ \_ componente src0. Select\] |
|------------------------------------------------------------------------------------------------------------|
...
| Item                                                                                                           | Descrição                                                                                                                       |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| <span id="dst0"></span><span id="DST0"></span>*dst0*<br/>                                                | \[in \] contém o valor de *dst1* antes de ou.<br/>                                                                   |
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/>                                                | O valor para ou com *dst1*.<br/>                                                                                           |
...
Essa instrução executa um único componente de 32 bits de bit ou de operando *src0* com *dst1* em 32 bits por endereço de componente *dstAddress*.
...
O valor na memória *dst1* antes de ou é retornado para *dst0*.
