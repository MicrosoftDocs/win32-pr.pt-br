...
---
# <a name="atomic_imin-sm5---asm"></a>\_Imin atômico (SM5-ASM)

Inteiro assinado atômica mínimo para memória.
...
Essa instrução executa um único componente com sinal de 32 de operando de *src0* no *DST* em 32 bits por endereço de componente *dstAddress*, executado atomicamente.
