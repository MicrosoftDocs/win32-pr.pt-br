...
Máximo de float de componente.



| máximo \[ \_ SAT \] dest \[ . Mask \] , \[ - \] src0 \[ \_ ABS \] \[ . swizzle \] , \[ - \] src1 \[ \_ ABS \] \[ . swizzle \] , |
|---------------------------------------------------------------------------------------------|
...
NaN tem tratamento especial. Se um operando de origem for NaN, o outro operando de origem será retornado e a escolha será feita por componente. Se ambos forem NaN, qualquer representação NaN será retornada.

As normas são liberadas com Sign preservado antes da comparação. No entanto, o resultado gravado no *dest* pode ou não ser liberado.
