...
<tbody>
<tr class="odd">
<td><span id="Type"></span><span id="type"></span><span id="TYPE"></span><em>Escreva</em><br/></td>
<td>no Uma topologia primitiva de saída, que é um dos seguintes valores: <br/>
<ul>
<li><em>ponto da</em></li>
