...
O objeto **EKUs** representa uma coleção de objetos [**EKU**](eku.md) . Cada objeto [**EKU**](eku.md) representa uma única propriedade EKU (uso estendido de chave) de um certificado.

## <a name="when-to-use"></a>Quando usar

A coleção **EKUs** é usada para executar as seguintes tarefas:

-   Recupere o número de propriedades EKU na coleção.
...
|:---------------------------------------------|:---------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**\_NewEnum**](ekus-newenum.md)<br/> | Somente leitura<br/> | Recupera uma interface [**IEnumVARIANT**](/windows/win32/api/oaidl/nn-oaidl-ienumvariant) em um objeto que pode ser usado para enumerar a coleção. Essa propriedade é oculta em Visual Basic Scripting Edition (VBScript).<br/> |
| [**Contar**](ekus-count.md)<br/>       | Somente leitura<br/> | Recupera o número de objetos [**EKU**](eku.md) na coleção.<br/>                                                                                                                                                |
| [**Item**](ekus-item.md)<br/>         | Somente leitura<br/> | Recupera o objeto [**EKU**](eku.md) que representa a propriedade EKU indexada. Essa é a propriedade padrão.<br/>                                                                                                      |
