---
description: O exemplo a seguir mostra o código do lado do cliente Diffie-Hellman/Schannel típico para criar uma chave mestra.
ms.assetid: 37b35cd6-b3c9-4a75-83a9-129bcf7a84a3
title: Diffie-Hellman o código de cliente para criar a chave mestra
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104297679"
---
# <a name="diffie-hellman-client-code-for-creating-the-master-key"></a><span data-ttu-id="4eefb-103">Diffie-Hellman o código de cliente para criar a chave mestra</span><span class="sxs-lookup"><span data-stu-id="4eefb-103">Diffie-Hellman Client Code for Creating the Master Key</span></span>

<span data-ttu-id="4eefb-104">O exemplo a seguir mostra o código do lado do cliente/Schannel [*Diffie-Hellman*](../secgloss/d-gly.md)típico para criar uma [*chave mestra*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="4eefb-104">The following example shows typical [*Diffie-Hellman*](../secgloss/d-gly.md)/Schannel client-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
