...
---
# <a name="diffie-hellman-client-code-for-creating-the-master-key"></a>Diffie-Hellman o código de cliente para criar a chave mestra

O exemplo a seguir mostra o código do lado do cliente/Schannel [*Diffie-Hellman*](../secgloss/d-gly.md)típico para criar uma [*chave mestra*](../secgloss/m-gly.md).
