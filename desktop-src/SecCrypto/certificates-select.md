...
*DisplayString* \[ in, opcional\]
</dt> <dd>

Cadeia de caracteres que contém o texto de prompt exibido com a caixa de diálogo. O valor padrão é uma cadeia de caracteres vazia ("").

</dd> <dt>

*bMultiSelect* \[ in, opcional\]
</dt> <dd>

Valor booliana que indica se o usuário pode selecionar mais de um certificado. True indica que vários certificados podem ser selecionados usando a tecla CTRL ou SHIFT. O valor padrão é false.

</dd> </dl>

## <a name="return-value"></a>Valor retornado

Um [**objeto Certificates**](certificates.md) que contém os certificados selecionados na caixa de diálogo.

**CAPICOM 2.1:** O [**objeto Certificates**](certificates.md) retornado contém referências aos certificados na coleção da qual a seleção foi feita. Todas as alterações feitas nos certificados no objeto **Certificados** retornado são refletidas nessa coleção.

**CAPICOM 2.0, CAPICOM 2.0.0.1, CAPICOM 2.0.0.2 e CAPICOM 2.0.0.3:** O [**objeto Certificates**](certificates.md) retornado contém cópias dos certificados na coleção da qual a seleção foi feita. As alterações feitas nos certificados no objeto **Certificados** retornado não são refletidas nessa coleção.
