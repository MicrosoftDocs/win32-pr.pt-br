...
---
# <a name="request-sample-in-vbscript"></a>Exemplo de solicitação no VBScript

O código de exemplo do VBScript a seguir mostra como o controle de registro de certificado pode ser usado com o objeto CCertRequest para criar e enviar uma [*solicitação de certificado*](../secgloss/c-gly.md).
