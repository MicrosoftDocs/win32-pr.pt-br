...
title: BLOBs de Chaves do Provedor Base
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="base-provider-key-blobs"></a>BLOBs de Chaves do Provedor Base
...
[*BLOBs de chave*](../secgloss/p-gly.md)pública , tipo **PUBLICKEYBLOB**, são usados para armazenar chaves públicas [*fora*](../secgloss/p-gly.md) de um CSP (provedor de [*serviços de*](../secgloss/c-gly.md) criptografia). BLOBs de chave pública do provedor base têm o seguinte formato.
...
[*BLOBs de chave privada*](../secgloss/p-gly.md), tipo **PRIVATEKEYBLOB**, são usados para armazenar [*chaves privadas*](../secgloss/p-gly.md) fora de um CSP. BLOBs de chave privada do provedor base têm o seguinte formato.
...
[*BLOBs de chaves simples*](../secgloss/s-gly.md), tipo **SIMPLEBLOB**, são usados para armazenar e transportar chaves de sessão fora de um CSP. BLOBs de chave simples do provedor de base são sempre criptografados com uma [*chave pública de troca de chaves*](../secgloss/k-gly.md). O **membro pbData** do **SIMPLEBLOB** é uma sequência de bytes no formato a seguir.
