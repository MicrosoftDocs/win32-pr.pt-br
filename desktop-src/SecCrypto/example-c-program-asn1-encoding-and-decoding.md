---
description: Mostra o uso de CryptEncodeObjectEx e CryptDecodeObjectEx.
ms.assetid: 78108cd5-531e-4d0c-96cf-6f6264b7716c
title: 'Programa de exemplo C: ASN. 1 codificação e decodificação'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104011456"
---
# <a name="example-c-program-asn1-encoding-and-decoding"></a><span data-ttu-id="e8902-103">Programa de exemplo C: ASN. 1 codificação e decodificação</span><span class="sxs-lookup"><span data-stu-id="e8902-103">Example C Program: ASN.1 Encoding and Decoding</span></span>

<span data-ttu-id="e8902-104">O exemplo a seguir mostra o uso de [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) e [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex).</span><span class="sxs-lookup"><span data-stu-id="e8902-104">The following example shows using [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) and [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex).</span></span> <span data-ttu-id="e8902-105">Este exemplo pode ser facilmente modificado para usar [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) e [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).</span><span class="sxs-lookup"><span data-stu-id="e8902-105">This example can easily be modified to use [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) and [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).</span></span>

<span data-ttu-id="e8902-106">Este exemplo também usa uma versão modificada da função [**ByteToStr**](bytetostr.md) para imprimir uma série de octetos codificados de uma precodificação de [*sintaxe*](../secgloss/a-gly.md) (ASN. 1).</span><span class="sxs-lookup"><span data-stu-id="e8902-106">This example also uses a modified version of the function [**ByteToStr**](bytetostr.md) to print an [*Abstract Syntax Notation One*](../secgloss/a-gly.md) (ASN.1) encoded series of octets.</span></span> <span data-ttu-id="e8902-107">Ele também usa [**MyHandleError**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="e8902-107">It also uses [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="e8902-108">O código para essas funções está incluído no exemplo.</span><span class="sxs-lookup"><span data-stu-id="e8902-108">Code for these functions is included with the sample.</span></span>
