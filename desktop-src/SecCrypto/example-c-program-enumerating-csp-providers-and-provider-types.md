...
---
# <a name="example-c-program-enumerating-csp-providers-and-provider-types"></a>Programa de exemplo C: enumerando provedores de CSP e tipos de provedor

O exemplo a seguir lista os CSPs disponíveis em um computador e usa as seguintes funções do [*CryptoAPI*](../secgloss/c-gly.md) :
...
Este exemplo usa a função [**MyHandleError**](myhandleerror.md). O código para essa função está incluído neste exemplo. O código para essa e outras funções auxiliares também está listado em [funções uso geral](general-purpose-functions.md).

O exemplo a seguir mostra a enumeração de CSPs e tipos de provedor.
