...
ms.locfileid: "119006626"
---
# <a name="getsignercert"></a>GetSignerCert

A função **GetSignerCert** passa (enumera) os certificados em um repositório de [*certificados*](../secgloss/c-gly.md) até que um certificado com uma chave de assinatura seja encontrado. Se um certificado for encontrado, um ponteiro para o certificado será retornado. Este código demonstra:

-   Localizando um certificado com uma propriedade de certificado.
-   Verificando essa propriedade.
-   Retornando um ponteiro para [**o \_ contexto de certificado**](/windows/desktop/api/Wincrypt/ns-wincrypt-cert_context) em que o atributo foi encontrado.

Esse código usa um manipulador de erro chamado **MyHandleError**. Para exibir a implementação para esse manipulador de erros, consulte o tópico [**MyHandleError**](myhandleerror.md) .
