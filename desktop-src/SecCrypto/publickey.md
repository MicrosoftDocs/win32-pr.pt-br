---
description: O objeto PublicKey representa uma chave pública em um objeto Certificate.
...
O **objeto PublicKey** representa uma chave pública em um [**objeto Certificate.**](certificate.md)
...
O **objeto PublicKey** não pode ser criado.
