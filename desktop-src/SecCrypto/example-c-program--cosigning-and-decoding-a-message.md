...
---
# <a name="example-c-program-cosigning-and-decoding-a-message"></a>Programa de exemplo C: coatribuindo e decodificando uma mensagem

Você pode usar a função [**CryptSignMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignmessage) para coassinar uma mensagem. Isso é feito chamando [**CryptSignMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignmessage) uma vez para assinar a mensagem original e, em seguida, chamar **CryptSignMessage** novamente para coassinar a mensagem assinada.

Ao verificar a assinatura de uma mensagem coassinado, use a função [**CryptGetMessageSignerCount**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetmessagesignercount) para obter o número de assinantes da mensagem e, em seguida, chame o [**CryptVerifyMessageSignature**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptverifymessagesignature) para cada assinatura. Se todas as assinaturas forem verificadas, você saberá que a mensagem coassinado é válida.

O exemplo a seguir mostra como assinar uma mensagem por mais de uma pessoa (entrar na mensagem), verificar todas as assinaturas e decodificar a mensagem.
