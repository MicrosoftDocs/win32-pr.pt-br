...
ms.locfileid: "119007654"
---
# <a name="example-c-program-encrypting-a-file"></a>Programa C de exemplo: Criptografando um arquivo

O exemplo a seguir criptografa um arquivo de dados. O exemplo solicita interativamente o nome do arquivo que contém o [*texto sem formatação*](../secgloss/p-gly.md) a ser criptografado e o nome de um arquivo em que os dados criptografados serão gravados.

O exemplo solicita ao usuário os nomes de um arquivo de entrada e um arquivo de saída. Ele também solicita ao usuário se uma senha deve ser usada para criar a chave de sessão de criptografia. Se uma senha for usada na criptografia dos dados, a mesma senha deverá ser usada no programa que descriptografa o arquivo. Para obter mais informações, consulte [exemplo C programa: descriptografando um arquivo](example-c-program-decrypting-a-file.md).
