...
ms.locfileid: "119007524"
---
# <a name="example-c-program-setting-and-getting-certificate-store-properties"></a>Programa C de exemplo: Configurando e obtendo propriedades do repositório de certificados

O exemplo a seguir define e obtém uma propriedade de repositório de certificados, o nome do repositório localizado. Esta propriedade não é persistente quando o repositório é fechado.
...
-   Definindo o nome localizado do armazenamento usando [**CertSetStoreProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsetstoreproperty).
-   Recuperando o nome localizado do armazenamento usando [**CertGetStoreProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetstoreproperty).
-   Recuperando o nome do repositório localizado predefinido usando [**CryptFindLocalizedName**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptfindlocalizedname).
-   Salve o repositório de certificados como uma mensagem [*PKCS \# 7*](../secgloss/p-gly.md) em um arquivo usando [**CertSaveStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsavestore).
-   Salve o repositório de certificados em um [*blob*](../secgloss/b-gly.md) de memória usando [**CertSaveStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsavestore).
-   Determine o número de assinantes da mensagem PKCS \# 7 usando [**CryptGetMessageSignercount**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetmessagesignercount).
-   Abra um repositório de certificados de uma \# mensagem PKCS 7 na memória usando [**CryptGetMessageCertificates**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetmessagecertificates).
-   Inicializar o [**\_ \_ identificador de algoritmo cript**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier) e a mensagem de [**\_ hash \_ \_ cript**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_hash_message_para) . para as estruturas de dados necessárias para o [*hash*](../secgloss/h-gly.md) da mensagem
-   O hash e a codificação da mensagem usando [**CryptHashMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-crypthashmessage).
-   Determine se foram feitas alterações em um repositório de certificados aberto e sincronização da loja, se necessário, usando [**CertControlStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certcontrolstore).
-   Fechar um repositório de certificados usando o [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) com o sinalizador de força de armazenamento de fechamento de certificado \_ \_ \_ \_ .
