---
description: O exemplo a seguir demonstra um processo alternativo de codificar uma mensagem assinada, usando essa mensagem assinada como o conteúdo interno de uma mensagem envelopada. Na preparação para a decodificação, o conteúdo interno é testado para determinar seu tipo de conteúdo interno.
...
---
# <a name="alternate-code-for-encoding-an-enveloped-message"></a><span data-ttu-id="c4db2-104">Código alternativo para codificar uma mensagem envelopada</span><span class="sxs-lookup"><span data-stu-id="c4db2-104">Alternate Code for Encoding an Enveloped Message</span></span>

<span data-ttu-id="c4db2-105">O exemplo a seguir demonstra um processo alternativo de codificar uma mensagem assinada, usando essa mensagem assinada como o [*conteúdo interno*](../secgloss/i-gly.md) de uma mensagem envelopada.</span><span class="sxs-lookup"><span data-stu-id="c4db2-105">The following example demonstrates an alternate process of encoding a signed message, using that signed message as the [*inner content*](../secgloss/i-gly.md) for an enveloped message.</span></span> <span data-ttu-id="c4db2-106">Na preparação para a decodificação, o conteúdo interno é testado para determinar seu tipo de conteúdo interno.</span><span class="sxs-lookup"><span data-stu-id="c4db2-106">In preparation for decoding, the inner content is tested to determine its inner-content type.</span></span>

<span data-ttu-id="c4db2-107">Este exemplo ilustra as seguintes funções de CryptoAPI:</span><span class="sxs-lookup"><span data-stu-id="c4db2-107">This example illustrates the following CryptoAPI functions:</span></span>

-   [<span data-ttu-id="c4db2-108">**CryptAcquireContext**</span><span class="sxs-lookup"><span data-stu-id="c4db2-108">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="c4db2-109">**CertOpenSystemStore**</span><span class="sxs-lookup"><span data-stu-id="c4db2-109">**CertOpenSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea)
-   [<span data-ttu-id="c4db2-110">**CryptMsgCalculateEncodedLength**</span><span class="sxs-lookup"><span data-stu-id="c4db2-110">**CryptMsgCalculateEncodedLength**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength)
-   [<span data-ttu-id="c4db2-111">**CryptMsgOpenToEncode**</span><span class="sxs-lookup"><span data-stu-id="c4db2-111">**CryptMsgOpenToEncode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode)
-   [<span data-ttu-id="c4db2-112">**CryptMsgUpdate**</span><span class="sxs-lookup"><span data-stu-id="c4db2-112">**CryptMsgUpdate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate)
-   [<span data-ttu-id="c4db2-113">**CryptMsgGetParam**</span><span class="sxs-lookup"><span data-stu-id="c4db2-113">**CryptMsgGetParam**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam)
-   [<span data-ttu-id="c4db2-114">**CryptMsgOpenToDecode**</span><span class="sxs-lookup"><span data-stu-id="c4db2-114">**CryptMsgOpenToDecode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentodecode)
-   [<span data-ttu-id="c4db2-115">**CertFindCertificateInStore**</span><span class="sxs-lookup"><span data-stu-id="c4db2-115">**CertFindCertificateInStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certfindcertificateinstore)
-   [<span data-ttu-id="c4db2-116">**CryptMsgClose**</span><span class="sxs-lookup"><span data-stu-id="c4db2-116">**CryptMsgClose**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgclose)
-   [<span data-ttu-id="c4db2-117">**CertCloseStore**</span><span class="sxs-lookup"><span data-stu-id="c4db2-117">**CertCloseStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore)
-   [<span data-ttu-id="c4db2-118">**CryptReleaseContext**</span><span class="sxs-lookup"><span data-stu-id="c4db2-118">**CryptReleaseContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptreleasecontext)

<span data-ttu-id="c4db2-119">Este exemplo também usa as funções [**MyHandleError**](myhandleerror.md) e [**GetSignerCert**](getsignercert.md).</span><span class="sxs-lookup"><span data-stu-id="c4db2-119">This example also uses the functions [**MyHandleError**](myhandleerror.md) and [**GetSignerCert**](getsignercert.md).</span></span> <span data-ttu-id="c4db2-120">O código C para essas funções está incluído no exemplo.</span><span class="sxs-lookup"><span data-stu-id="c4db2-120">C code for these functions is included with the example.</span></span> <span data-ttu-id="c4db2-121">Para ver o código que demonstra essas e outras funções auxiliares, consulte [funções de uso geral](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="c4db2-121">For code that demonstrates these and other auxiliary functions, see [General Purpose Functions](general-purpose-functions.md).</span></span>
