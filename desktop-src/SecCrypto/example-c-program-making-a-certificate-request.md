---
description: O exemplo a seguir demonstra o procedimento descrito na seção anterior. Este exemplo cria uma solicitação de certificado simples com um signatário, um único atributo de nome distinto relativo (RDN) e não tem nenhum atributo geral.
ms.assetid: bd3d0259-f0e8-460e-9f18-95d2492da3d8
title: 'Programa de exemplo C: fazendo uma solicitação de certificado'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104506034"
---
# <a name="example-c-program-making-a-certificate-request"></a><span data-ttu-id="c80c3-104">Programa de exemplo C: fazendo uma solicitação de certificado</span><span class="sxs-lookup"><span data-stu-id="c80c3-104">Example C Program: Making a Certificate Request</span></span>

<span data-ttu-id="c80c3-105">O exemplo a seguir demonstra o procedimento descrito na seção anterior.</span><span class="sxs-lookup"><span data-stu-id="c80c3-105">The following example demonstrates the procedure outlined in the previous section.</span></span> <span data-ttu-id="c80c3-106">Este exemplo cria uma [*solicitação de certificado*](../secgloss/c-gly.md) simples com um signatário, um único [*atributo*](../secgloss/a-gly.md)de [*nome distinto relativo*](../secgloss/r-gly.md) (RDN) e não tem nenhum atributo geral.</span><span class="sxs-lookup"><span data-stu-id="c80c3-106">This example creates a simple [*certificate request*](../secgloss/c-gly.md) with one signer, a single [*relative distinguished name*](../secgloss/r-gly.md) (RDN) [*attribute*](../secgloss/a-gly.md), and no general attributes.</span></span>

<span data-ttu-id="c80c3-107">Este exemplo ilustra as seguintes funções de [*CryptoAPI*](../secgloss/c-gly.md) :</span><span class="sxs-lookup"><span data-stu-id="c80c3-107">This example illustrates the following [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   [<span data-ttu-id="c80c3-108">**CryptEncodeObject**</span><span class="sxs-lookup"><span data-stu-id="c80c3-108">**CryptEncodeObject**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject)
-   [<span data-ttu-id="c80c3-109">**CryptAcquireContext**</span><span class="sxs-lookup"><span data-stu-id="c80c3-109">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="c80c3-110">**CryptExportPublicKeyInfo**</span><span class="sxs-lookup"><span data-stu-id="c80c3-110">**CryptExportPublicKeyInfo**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptexportpublickeyinfo)
-   [<span data-ttu-id="c80c3-111">**CryptSignAndEncodeCertificate**</span><span class="sxs-lookup"><span data-stu-id="c80c3-111">**CryptSignAndEncodeCertificate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignandencodecertificate)

<span data-ttu-id="c80c3-112">Este exemplo também usa as funções [**ByteToStr**](bytetostr.md) e [**MyHandleError**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="c80c3-112">This example also uses the functions [**ByteToStr**](bytetostr.md) and [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="c80c3-113">O código para essas funções está incluído no exemplo.</span><span class="sxs-lookup"><span data-stu-id="c80c3-113">Code for these functions is included with the sample.</span></span> <span data-ttu-id="c80c3-114">[Uso geral Functions](general-purpose-functions.md) lista o código para essas e outras funções auxiliares.</span><span class="sxs-lookup"><span data-stu-id="c80c3-114">[General Purpose Functions](general-purpose-functions.md) lists code for these and other auxiliary functions.</span></span>
