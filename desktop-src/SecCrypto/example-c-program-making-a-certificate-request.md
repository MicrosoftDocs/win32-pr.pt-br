...
---
# <a name="example-c-program-making-a-certificate-request"></a>Programa de exemplo C: fazendo uma solicitação de certificado

O exemplo a seguir demonstra o procedimento descrito na seção anterior. Este exemplo cria uma [*solicitação de certificado*](../secgloss/c-gly.md) simples com um signatário, um único [*atributo*](../secgloss/a-gly.md)de [*nome distinto relativo*](../secgloss/r-gly.md) (RDN) e não tem nenhum atributo geral.
...
Este exemplo também usa as funções [**ByteToStr**](bytetostr.md) e [**MyHandleError**](myhandleerror.md). O código para essas funções está incluído no exemplo. [Uso geral Functions](general-purpose-functions.md) lista o código para essas e outras funções auxiliares.
