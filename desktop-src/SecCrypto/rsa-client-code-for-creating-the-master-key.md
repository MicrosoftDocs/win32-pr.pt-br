...
---
# <a name="rsa-client-code-for-creating-the-master-key"></a>Código do cliente RSA para criar a chave mestra

O exemplo a seguir mostra o código do lado do cliente RSA/Schannel típico para criar uma [*chave mestra*](../secgloss/m-gly.md).
