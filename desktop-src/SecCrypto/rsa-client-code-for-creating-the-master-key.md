---
description: O exemplo a seguir mostra o código do lado do cliente RSA/Schannel típico para criar uma chave mestra.
ms.assetid: 9ce4877f-e6e6-4b94-9503-092d2702b31f
title: Código do cliente RSA para criar a chave mestra
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105767823"
---
# <a name="rsa-client-code-for-creating-the-master-key"></a><span data-ttu-id="69735-103">Código do cliente RSA para criar a chave mestra</span><span class="sxs-lookup"><span data-stu-id="69735-103">RSA Client Code for Creating the Master Key</span></span>

<span data-ttu-id="69735-104">O exemplo a seguir mostra o código do lado do cliente RSA/Schannel típico para criar uma [*chave mestra*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="69735-104">The following example shows typical RSA/Schannel client-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
