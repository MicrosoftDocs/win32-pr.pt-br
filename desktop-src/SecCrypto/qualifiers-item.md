...
---
# <a name="qualifiersitem-property"></a>Propriedade Qualifiers. Item
...
A propriedade **Item** recupera um qualificador com base em um índice especificado. Essa é a propriedade padrão.
...
Um objeto de [**qualificador**](qualifier.md) que representa o qualificador indexado da coleção.
