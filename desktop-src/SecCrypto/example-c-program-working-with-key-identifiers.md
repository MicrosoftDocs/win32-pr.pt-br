...
ms.locfileid: "119140759"
---
# <a name="example-c-program-working-with-key-identifiers"></a>Programa de exemplo C: trabalhando com identificadores de chave

O exemplo a seguir demonstra maneiras de trabalhar com identificadores de chave. Este exemplo ilustra as seguintes tarefas e funções de CryptoAPI:

-   Criando um identificador de chave usando [**CryptCreateKeyIdentifierFromCSP**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatekeyidentifierfromcsp).
-   Definindo uma propriedade em um identificador de chave usando [**CryptSetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetkeyidentifierproperty).
-   Recuperando o conteúdo de uma propriedade de identificador de chave usando [**CryptGetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetkeyidentifierproperty).
-   Listando as propriedades de um identificador de chave usando [**CryptEnumKeyIdentifierProperties**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumkeyidentifierproperties).
-   Declarando, definindo e usando uma função de retorno de chamada.
