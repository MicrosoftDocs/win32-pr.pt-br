...
ms.locfileid: "119873966"
---
# <a name="example-c-program-certificate-verification-operations"></a>Programa C de exemplo: operações de verificação de certificado

O exemplo a seguir ilustra essas tarefas e funções de CryptoAPI:

-   Abrir e fechar o repositório do sistema.
-   Localizando um certificado pelo nome da entidade.
-   Usando a função [**CertVerifyTimeValidity**](/windows/desktop/api/Wincrypt/nf-wincrypt-certverifytimevalidity) para verificar a validade da hora do certificado.
