...
title: 'Programa C de exemplo: usando CryptEncryptMessage e CryptDecryptMessage'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104550284"
---
# <a name="example-c-program-using-cryptencryptmessage-and-cryptdecryptmessage"></a><span data-ttu-id="8a7ff-103">Programa C de exemplo: usando CryptEncryptMessage e CryptDecryptMessage</span><span class="sxs-lookup"><span data-stu-id="8a7ff-103">Example C Program: Using CryptEncryptMessage and CryptDecryptMessage</span></span>

<span data-ttu-id="8a7ff-104">[**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage) é a única chamada de função necessária para realizar todas as tarefas listadas em [criptografar uma mensagem](../secauthn/encrypting-a-message.md).</span><span class="sxs-lookup"><span data-stu-id="8a7ff-104">[**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage) is the only function call necessary to accomplish all of the tasks listed in [Encrypting a Message](../secauthn/encrypting-a-message.md).</span></span> <span data-ttu-id="8a7ff-105">A inicialização de estruturas de dados é necessária.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-105">Initialization of data structures is necessary.</span></span> <span data-ttu-id="8a7ff-106">A ilustração a seguir mostra a relação entre os parâmetros de função que apontam para estruturas ou matrizes e seus dados inicializados.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-106">The following illustration shows the relationship between those function parameters that point to structures or arrays and their initialized data.</span></span> <span data-ttu-id="8a7ff-107">Este exemplo também descriptografa a mensagem usando [**CryptDecryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecryptmessage).</span><span class="sxs-lookup"><span data-stu-id="8a7ff-107">This example also decrypts the message using [**CryptDecryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecryptmessage).</span></span>

![mapa de inicialização para uma chamada para cryptencryptmessage](images/crypenc.png)

<span data-ttu-id="8a7ff-109">**Para criptografar dados**</span><span class="sxs-lookup"><span data-stu-id="8a7ff-109">**To encrypt data**</span></span>

1.  <span data-ttu-id="8a7ff-110">Obtenha um ponteiro para o conteúdo a ser criptografado.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-110">Get a pointer to the content to be encrypted.</span></span>
2.  <span data-ttu-id="8a7ff-111">Determine o tamanho do conteúdo a ser criptografado.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-111">Determine the size of the content to be encrypted.</span></span>
3.  <span data-ttu-id="8a7ff-112">Adquirir um identificador para um provedor criptográfico.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-112">Acquire a handle to a cryptographic provider.</span></span>
4.  <span data-ttu-id="8a7ff-113">Abra um [*repositório de certificados*](../secgloss/c-gly.md).</span><span class="sxs-lookup"><span data-stu-id="8a7ff-113">Open a [*certificate store*](../secgloss/c-gly.md).</span></span>
5.  <span data-ttu-id="8a7ff-114">Obtenha o certificado do destinatário.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-114">Get the recipient certificate.</span></span>
6.  <span data-ttu-id="8a7ff-115">Crie a matriz de certificados de destinatário.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-115">Create the recipient certificate array.</span></span>
7.  <span data-ttu-id="8a7ff-116">Inicialize a estrutura do [**\_ \_ identificador do algoritmo cript**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier) .</span><span class="sxs-lookup"><span data-stu-id="8a7ff-116">Initialize the [**CRYPT\_ALGORITHM\_IDENTIFIER**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier) structure.</span></span>
8.  <span data-ttu-id="8a7ff-117">Inicialize a estrutura [**cript \_ criptografar \_ mensagem \_ para**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_encrypt_message_para) .</span><span class="sxs-lookup"><span data-stu-id="8a7ff-117">Initialize the [**CRYPT\_ENCRYPT\_MESSAGE\_PARA**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_encrypt_message_para) structure.</span></span>
9.  <span data-ttu-id="8a7ff-118">Chame [**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage) para criptografar o conteúdo e criar uma mensagem digitalmente envelopada.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-118">Call [**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage) to encrypt the content and create a digitally enveloped message.</span></span>

<span data-ttu-id="8a7ff-119">O exemplo a seguir implementa esse procedimento.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-119">The following example implements this procedure.</span></span>

<span data-ttu-id="8a7ff-120">Comentários relacionam fragmentos de código a cada etapa no procedimento.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-120">Comments relate code fragments to each step in the procedure.</span></span> <span data-ttu-id="8a7ff-121">Para obter mais informações sobre a função, consulte [**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage).</span><span class="sxs-lookup"><span data-stu-id="8a7ff-121">For more information about the function, see [**CryptEncryptMessage**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencryptmessage).</span></span> <span data-ttu-id="8a7ff-122">Para obter mais informações sobre estruturas de dados, [**consulte \_ \_ identificador de algoritmo cript**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier) e [**\_ \_ mensagens \_ criptografadas cript**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_encrypt_message_para).</span><span class="sxs-lookup"><span data-stu-id="8a7ff-122">For more information about the data structures, see [**CRYPT\_ALGORITHM\_IDENTIFIER**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_algorithm_identifier) and [**CRYPT\_ENCRYPT\_MESSAGE\_PARA**](/windows/desktop/api/Wincrypt/ns-wincrypt-crypt_encrypt_message_para).</span></span>

<span data-ttu-id="8a7ff-123">Este exemplo usa as funções [**MyHandleError**](myhandleerror.md) e [**ByteToStr**](bytetostr.md).</span><span class="sxs-lookup"><span data-stu-id="8a7ff-123">This example uses the functions [**MyHandleError**](myhandleerror.md) and [**ByteToStr**](bytetostr.md).</span></span> <span data-ttu-id="8a7ff-124">O código para essa função está incluído no exemplo.</span><span class="sxs-lookup"><span data-stu-id="8a7ff-124">The code for this function is included with the sample.</span></span> <span data-ttu-id="8a7ff-125">O código para essa e outras funções auxiliares também está listado em [funções uso geral](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="8a7ff-125">Code for this and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>
