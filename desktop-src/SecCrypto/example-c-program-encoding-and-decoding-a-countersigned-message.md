---
description: Mostra como codificar e decodificar uma mensagem de assinatura. Este exemplo usa a função de exemplo MyHandleError. O código para a função MyHandleError e outras funções auxiliares também está listado em funções Uso Geral.
ms.assetid: 12930d4d-2ea5-4d95-b9cf-4f0dd351ce05
title: 'Programa C de exemplo: codificando e decodificando uma mensagem de assinatura'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105789496"
---
# <a name="example-c-program-encoding-and-decoding-a-countersigned-message"></a><span data-ttu-id="d5e23-105">Programa C de exemplo: codificando e decodificando uma mensagem de assinatura</span><span class="sxs-lookup"><span data-stu-id="d5e23-105">Example C Program: Encoding and Decoding a Countersigned Message</span></span>

<span data-ttu-id="d5e23-106">O exemplo a seguir mostra como codificar e decodificar uma mensagem de assinatura.</span><span class="sxs-lookup"><span data-stu-id="d5e23-106">The following example shows how to encode and decode a countersigned message.</span></span> <span data-ttu-id="d5e23-107">Este exemplo usa a função de exemplo [**MyHandleError**](myhandleerror.md) .</span><span class="sxs-lookup"><span data-stu-id="d5e23-107">This example uses the [**MyHandleError**](myhandleerror.md) example function.</span></span> <span data-ttu-id="d5e23-108">O código para a função **MyHandleError** e outras funções auxiliares também está listado em [funções uso geral](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="d5e23-108">Code for the **MyHandleError** function and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>
