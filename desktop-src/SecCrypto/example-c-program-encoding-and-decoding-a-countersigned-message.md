...
---
# <a name="example-c-program-encoding-and-decoding-a-countersigned-message"></a>Programa C de exemplo: codificando e decodificando uma mensagem de assinatura

O exemplo a seguir mostra como codificar e decodificar uma mensagem de assinatura. Este exemplo usa a função de exemplo [**MyHandleError**](myhandleerror.md) . O código para a função **MyHandleError** e outras funções auxiliares também está listado em [funções uso geral](general-purpose-functions.md).
