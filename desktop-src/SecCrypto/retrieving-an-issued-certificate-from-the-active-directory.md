...
---
# <a name="retrieving-an-issued-certificate-from-active-directory"></a>Recuperando um certificado emitido de Active Directory

Uma AC ( [*autoridade de certificação*](../secgloss/c-gly.md) ) corporativa publica [*certificados*](../secgloss/c-gly.md) emitidos para a Active Directory; uma autoridade de certificação autônoma também pode publicar certificados emitidos para o Active Directory. O exemplo a seguir mostra como adquirir um [*contexto de certificado*](../secgloss/c-gly.md) para um certificado armazenado no Active Directory. Depois que o contexto de certificado for adquirido, você poderá recuperar o conteúdo do certificado ou executar operações de certificado usando as funções de CryptoAPI.

O exemplo a seguir mostra a recuperação de um certificado de Active Directory.
