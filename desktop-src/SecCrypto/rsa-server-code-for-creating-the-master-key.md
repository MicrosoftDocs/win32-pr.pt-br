...
---
# <a name="rsa-server-code-for-creating-the-master-key"></a>Código do servidor RSA para criar a chave mestra

O exemplo a seguir mostra o código típico do servidor RSA/Schannel para criar uma [*chave mestra*](../secgloss/m-gly.md).
