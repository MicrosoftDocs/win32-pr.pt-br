---
description: O exemplo a seguir mostra o código típico do servidor RSA/Schannel para criar uma chave mestra.
ms.assetid: 617cda1e-0619-4162-85eb-d1f5aa35fd1c
title: Código do servidor RSA para criar a chave mestra
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105796370"
---
# <a name="rsa-server-code-for-creating-the-master-key"></a><span data-ttu-id="0b36e-103">Código do servidor RSA para criar a chave mestra</span><span class="sxs-lookup"><span data-stu-id="0b36e-103">RSA Server Code for Creating the Master Key</span></span>

<span data-ttu-id="0b36e-104">O exemplo a seguir mostra o código típico do servidor RSA/Schannel para criar uma [*chave mestra*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="0b36e-104">The following example shows typical RSA/Schannel server-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
