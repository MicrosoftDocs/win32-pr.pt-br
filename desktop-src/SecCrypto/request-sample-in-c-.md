...
---
# <a name="request-sample-in-c"></a>Exemplo de solicitação em C++

O exemplo a seguir mostra como o controle de registro de certificado pode ser usado com o objeto [**ICertRequest**](/windows/desktop/api/Certcli/nn-certcli-icertrequest) para criar e enviar uma solicitação de certificado.
