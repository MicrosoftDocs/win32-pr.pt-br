---
description: Recupera um valor booliana que indica se a extensão KeyUsage está presente.
ms.assetid: d666049a-4b40-42b6-8c2d-c27a1bb4c48a
title: Propriedade KeyUsage.IsPresent
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119992856"
---
# <a name="keyusageispresent-property"></a>Propriedade KeyUsage.IsPresent
...
A **propriedade IsPresent** recupera um valor booliana que indica se a [**extensão KeyUsage**](keyusage.md) está presente.
...
Se **true**, a extensão KeyUsage estará presente.
