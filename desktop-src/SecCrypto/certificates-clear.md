---
description: Remove todos os objetos de certificado da coleção.
ms.assetid: 7349a9dd-d17b-4f79-b31d-0d79ff7641d1
title: 'Método ICertificates2:: Clear'
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "105747438"
---
# <a name="icertificates2clear-method"></a>Método ICertificates2:: Clear
...
O método **Clear** remove todos os objetos de [**certificado**](certificate.md) da coleção. Esse método é introduzido no CAPICOM 2,0.
