---
description: Enumera os locais do repositório de certificados do sistema, os repositórios de certificados do sistema e os repositórios físicos associados a cada repositório do sistema.
ms.assetid: bc4268ea-f657-4789-9d0a-6e5354508f86
title: 'Programa de exemplo C: listando o sistema e os repositórios físicos'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105784150"
---
# <a name="example-c-program-listing-system-and-physical-stores"></a><span data-ttu-id="5c936-103">Programa de exemplo C: listando o sistema e os repositórios físicos</span><span class="sxs-lookup"><span data-stu-id="5c936-103">Example C Program: Listing System and Physical Stores</span></span>

<span data-ttu-id="5c936-104">O exemplo a seguir enumera os locais do [*repositório de certificados*](../secgloss/c-gly.md) do sistema, os repositórios de certificados do sistema e os repositórios físicos associados a cada repositório do sistema.</span><span class="sxs-lookup"><span data-stu-id="5c936-104">The following example enumerates the system [*certificate store*](../secgloss/c-gly.md) locations, the system certificate stores, and the physical stores associated with each system store.</span></span> <span data-ttu-id="5c936-105">Este exemplo demonstra a criação de funções de retorno de chamada e funções de retorno de chamada que chamam outras funções de retorno de chamada.</span><span class="sxs-lookup"><span data-stu-id="5c936-105">This example demonstrates the creation of callback functions and callback functions that call other callback functions.</span></span>

<span data-ttu-id="5c936-106">Este exemplo ilustra as seguintes funções de [*CryptoAPI*](../secgloss/c-gly.md) :</span><span class="sxs-lookup"><span data-stu-id="5c936-106">This example illustrates the following [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   [<span data-ttu-id="5c936-107">**CertEnumSystemStoreLocation**</span><span class="sxs-lookup"><span data-stu-id="5c936-107">**CertEnumSystemStoreLocation**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstorelocation)
-   [<span data-ttu-id="5c936-108">**CertEnumSystemStore**</span><span class="sxs-lookup"><span data-stu-id="5c936-108">**CertEnumSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstore)

<span data-ttu-id="5c936-109">Este exemplo também usa a função [**MyHandleError**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="5c936-109">This example also uses the function [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="5c936-110">O código para essa função está incluído no exemplo.</span><span class="sxs-lookup"><span data-stu-id="5c936-110">Code for this function is included with the sample.</span></span> <span data-ttu-id="5c936-111">O código para essa e outras funções auxiliares também está listado em [funções uso geral](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="5c936-111">Code for this and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>
