---
description: O exemplo a seguir mostra o código do lado do servidor Diffie-Hellman/Schannel típico para criar uma chave mestra.
ms.assetid: 1ef0a2ea-8684-425c-abfe-9f65d8df7bbd
title: Diffie-Hellman o código do servidor para criar a chave mestra
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105769287"
---
# <a name="diffie-hellman-server-code-for-creating-the-master-key"></a><span data-ttu-id="2b422-103">Diffie-Hellman o código do servidor para criar a chave mestra</span><span class="sxs-lookup"><span data-stu-id="2b422-103">Diffie-Hellman Server Code for Creating the Master Key</span></span>

<span data-ttu-id="2b422-104">O exemplo a seguir mostra o código do lado do servidor/Schannel [*Diffie-Hellman*](../secgloss/d-gly.md)típico para criar uma [*chave mestra*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="2b422-104">The following example shows typical [*Diffie-Hellman*](../secgloss/d-gly.md)/Schannel server-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
