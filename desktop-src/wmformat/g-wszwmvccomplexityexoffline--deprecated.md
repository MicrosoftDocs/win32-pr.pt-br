...
---
# <a name="g_wszwmvccomplexityexoffline"></a><span data-ttu-id="6b809-105">g \_ wszWMVCComplexityExOffline</span><span class="sxs-lookup"><span data-stu-id="6b809-105">g\_wszWMVCComplexityExOffline</span></span>

<span data-ttu-id="6b809-106">Para obter a documentação atual sobre os codecs de mídia do Windows e os processadores de sinal digital, consulte [codec de áudio e vídeo do Windows Media e APIs do DSP.](/previous-versions//dd464626(v=vs.85))</span><span class="sxs-lookup"><span data-stu-id="6b809-106">For current documentation on Windows Media codecs and digital signal processors, see [Windows Media Audio and Video Codec and DSP APIs.](/previous-versions//dd464626(v=vs.85))</span></span>
