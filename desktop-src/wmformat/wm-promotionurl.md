...
description: O atributo WM/PromotionURL contém o endereço de um site da Web que oferece uma promoção relacionada ao conteúdo.
ms.assetid: 0a1514a6-a77a-447c-9de7-fb390bd48b6d
keywords:
- Formato de mídia do Windows do WM/PromotionURL
topic_type:
- apiref
api_name:
- WM/PromotionURL
