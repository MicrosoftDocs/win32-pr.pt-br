...
description: O atributo WM/ToolVersion contém o número de versão do aplicativo usado para criar o arquivo. Se você usar esse atributo, também deverá incluir o nome do aplicativo usando o WM/ToolName.
ms.assetid: c9700b30-7acb-4eb6-8e82-4b0d22345a97
keywords:
- Formato de mídia do Windows do WM/ToolVersion
topic_type:
- apiref
api_name:
- WM/ToolVersion
