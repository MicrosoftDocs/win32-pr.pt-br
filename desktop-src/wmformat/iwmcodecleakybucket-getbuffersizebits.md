...
description: Para obter a documentação atual sobre os codecs de mídia do Windows e os processadores de sinal digital, consulte codec de áudio e vídeo do Windows Media e APIs do DSP. | GetBufferSizeBits
ms.assetid: a7667fea-8bf9-4f87-bae1-6a32c00e753c
keywords:
- Formato de mídia do Windows GetBufferSizeBits
topic_type:
- apiref
api_name:
- GetBufferSizeBits
