...
description: Para ver a documentação atual sobre Windows de mídia e processadores de sinal digital, consulte Windows codec de áudio e vídeo de mídia e APIs DSP. | g_wszWMVCDecoderComplexityRequested (Wmcodecdsp.h)
ms.assetid: 188f13de-6643-4fd9-939b-1afe15aa75e5
keywords:
- g_wszWMVCDecoderComplexityRequested formato de mídia do Windows
topic_type:
- apiref
api_name:
