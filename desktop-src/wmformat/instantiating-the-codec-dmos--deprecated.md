---
title: Instanciando o codec DMOs
description: Para obter a documentação atual sobre os codecs de mídia do Windows e os processadores de sinal digital, consulte codec de áudio e vídeo do Windows Media e APIs do DSP. | Instanciando o codec DMOs
ms.assetid: fa019e41-15d9-48be-abcb-a1e41e089dc8
keywords:
- Instanciando o formato do codec DMOs Windows Media
topic_type:
- apiref
api_name:
...
---
# <a name="instantiating-the-codec-dmos"></a>Instanciando o codec DMOs
