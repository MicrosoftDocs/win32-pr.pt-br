...
---
# <a name="media-sample-encryption-example"></a>Exemplo de criptografia de exemplo de mídia

O exemplo incompleto a seguir demonstra como criptografar um exemplo de mídia usando a criptografia DRM. O algoritmo de criptografia RC4 saiu do exemplo devido a restrições de espaço.
