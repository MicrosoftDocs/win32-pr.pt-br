...
---
# <a name="create-content-key-example"></a><span data-ttu-id="4340e-119">Criar exemplo de chave de conteúdo</span><span class="sxs-lookup"><span data-stu-id="4340e-119">Create Content Key Example</span></span>

<span data-ttu-id="4340e-120">A chave de conteúdo é usada para criptografar amostras de mídia para a importação do DRM do Windows Media.</span><span class="sxs-lookup"><span data-stu-id="4340e-120">The content key is used to encrypt media samples for Windows Media DRM Import.</span></span> <span data-ttu-id="4340e-121">O exemplo de código a seguir demonstra como criar e inicializar uma estrutura de chave de conteúdo.</span><span class="sxs-lookup"><span data-stu-id="4340e-121">The following code example demonstrates how to create and initialize a content key structure.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="4340e-122">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="4340e-122">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="4340e-123">**Exemplos de importação de DRM**</span><span class="sxs-lookup"><span data-stu-id="4340e-123">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
