...
keywords:
- Windows SDK de formato de mídia, parando a indexação em andamento
...
Como o **startIndex** é uma chamada assíncrona, normalmente você precisará chamar **Cancel** de algum outro thread ou manipulador de eventos em seu aplicativo. normalmente, o **cancelamento** será chamado a partir de um procedimento de evento associado a um controle de botão de um aplicativo Windows.
