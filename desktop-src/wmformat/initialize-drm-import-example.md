...
---
# <a name="initialize-drm-import-example"></a><span data-ttu-id="d2810-123">Inicializar exemplo de importação de DRM</span><span class="sxs-lookup"><span data-stu-id="d2810-123">Initialize DRM Import Example</span></span>

<span data-ttu-id="d2810-124">O exemplo de código a seguir ilustra como inicializar um objeto gravador de DRM para a importação DRM:</span><span class="sxs-lookup"><span data-stu-id="d2810-124">The following code example illustrates how to initialize a DRM writer object for DRM Import:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d2810-125">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="d2810-125">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d2810-126">**Criar exemplo de chave de conteúdo**</span><span class="sxs-lookup"><span data-stu-id="d2810-126">**Create Content Key Example**</span></span>](create-content-key-example.md)
</dt> <dt>

[<span data-ttu-id="d2810-127">**Criar exemplo de chave de sessão**</span><span class="sxs-lookup"><span data-stu-id="d2810-127">**Create Session Key Example**</span></span>](create-session-key-example.md)
</dt> <dt>

[<span data-ttu-id="d2810-128">**Exemplos de importação de DRM**</span><span class="sxs-lookup"><span data-stu-id="d2810-128">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
