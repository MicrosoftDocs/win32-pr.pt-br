...
keywords:
- Windows SDK do formato de mídia, comandos de script
...
| [Usando comandos de script com suporte pelo Windows Media Player](using-script-commands-supported-by-windows-media-player.md) | Descreve os comandos de script usados pelo Windows Media Player.  |
...
> [!Note]  
> nas versões anteriores do SDK do formato de mídia Windows, os fluxos de script eram usados para abrir endereços Web correspondentes ao conteúdo de um arquivo ASF. Agora você pode usar fluxos da Web para trabalhar com páginas da Web sincronizadas. Para obter mais informações. consulte [Fluxos Web](web-streams.md).
