---
title: AspectRatioY
description: O atributo AspectRatioY contém o componente de altura da taxa de proporção de pixel para um fluxo de vídeo.
ms.assetid: e5b043d7-8fae-45d0-b140-a34d9bc6d2d8
keywords:
- Formato de mídia do Windows AspectRatioY
topic_type:
- apiref
api_name:
- AspectRatioY
...
O atributo **AspectRatioY** contém o componente de altura da taxa de proporção de pixel para um fluxo de vídeo.

## <a name="global-constant"></a>Constante global

g \_ wszWMAspectRatioY
