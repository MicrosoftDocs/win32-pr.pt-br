...
O atributo **WM/WMADRCPeakReference** contém o nível máximo de volume do arquivo como codificado. Esse valor é usado pelo Windows Media Player para controle de intervalo dinâmico. Esse valor é definido pelo codec e é somente leitura.
