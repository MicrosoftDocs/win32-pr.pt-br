---
description: Um retorno de chamada que notifica o host de que todas as solicitações foram canceladas.
MS-HAID: vspixengine.INewFramesCallback\_CancelAll
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: 'Método INewFramesCallback:: CancelAll'
ms.topic: reference
ms.date: 05/31/2018
...
Um retorno de chamada que notifica o host de que todas as solicitações foram canceladas.
