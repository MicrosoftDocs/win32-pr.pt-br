---
description: Uma função de retorno de chamada usada para notificar o host quando uma carga de histograma é concluída.
...
Uma função de retorno de chamada usada para notificar o host quando uma carga de histograma é concluída.
