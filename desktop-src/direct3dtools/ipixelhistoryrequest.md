---
description: Não usado. Anteriormente uma solicitação de primitivos e interseções de histórico de pixel juntos.
MS-HAID: vspixengine.IPixelHistoryRequest
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: Interface IPixelHistoryRequest
ms.topic: reference
ms.date: 05/31/2018
...
Não usado. Anteriormente uma solicitação de primitivos e interseções de histórico de pixel juntos.

## <a name="members"></a>Membros

A interface **IPixelHistoryRequest** herda da interface [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) . **IPixelHistoryRequest** também tem estes tipos de membros:
