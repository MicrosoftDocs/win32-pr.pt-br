...
Solicitações para obter informações especificadas da tabela de objetos para o evento especificado.
...
*numColumns*   
O número de colunas (campos) de informações a serem obtidas.
