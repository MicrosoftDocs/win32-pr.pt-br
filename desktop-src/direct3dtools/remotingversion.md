...
Um valor que indica que o protocolo remoto do Visual Studio 2015 RTM está sendo usado.

<span id="REMOTING_WIN10"></span><span id="remoting_win10"></span>**WIN10 de comunicação remota \_**  
Um valor que indica que o protocolo de comunicação remota do Windows 10 está sendo usado (a partir do Windows 10, o diagnóstico de gráficos é um componente do sistema operacional)

<span id="REMOTING_WIN10_JAN_2015"></span><span id="remoting_win10_jan_2015"></span>**Comunicação remota \_ WIN10 \_ Jan \_ 2015**  
Um valor que indica que o protocolo de comunicação remota do Windows 10 (janeiro de 2015) está sendo usado.
...
Um valor que indica que o protocolo de comunicação remota do Windows 10 (janeiro de 2015, v1) está sendo usado.
...
Um valor que indica que o protocolo de comunicação remota do Windows 10 (janeiro de 2015, v2) está sendo usado. Esta versão do protocolo introduziu solicitações para visualizar os recursos lado a lado.
...
Um valor que indica que o protocolo de comunicação remota do Windows 10 (janeiro de 2015, v3) está sendo usado. Esta versão do protocolo introduziu IPixEngine7, agora preterida, para verificar o suporte à versão da interface.
...
Um valor que indica que o protocolo de comunicação remota do Windows 10 (janeiro de 2015, v1) está sendo usado. Essa versão do protocolo se afasta da dependência do REMOTINGVERSION para os recursos de protocolo de mediação. O GUID da interface agora é alterado quando int não público
...
Um valor que indica que o protocolo de comunicação remota do Windows 10 (janeiro de 2015, v1) está sendo usado. Esta versão do protocolo apresenta propriedades de informações resumidas com IDs fixas exclusivas.
...
Um valor que indica que o protocolo de comunicação remota do Windows 10 (janeiro de 2015, v1) está sendo usado. Esta versão do protocolo introduziu suporte para a janela de estado DirectX11.
