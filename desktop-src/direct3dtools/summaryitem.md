...
**Nome**  
Uma cadeia de caracteres COM que contém o nome do evento resumido.

**Valor**  
Uma cadeia de caracteres COM que contém um valor relacionado ao evento.
