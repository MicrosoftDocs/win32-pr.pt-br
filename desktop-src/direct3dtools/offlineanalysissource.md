---
description: Uma enumeração usada para indicar a fonte de informações gráficas para análise de quadros.
MS-HAID: vspixengine.OFFLINEANALYSISSOURCE
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: Enumeração OFFLINEANALYSISSOURCE
ms.topic: reference
ms.date: 05/31/2018
...
As informações gráficas vêm de um arquivo de log de gráficos.
