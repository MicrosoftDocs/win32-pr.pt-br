...
ms.locfileid: "119981476"
---
# <a name="span-idvspixengineiframeeventsrequest_requestasync_dword_dword_dword_arr_iframeeventscallback_ptr_dword_dwordspaniframeeventsrequestrequestasync-method"></a><span id="vspixengine.iframeeventsrequest_requestasync_dword_dword_dword_arr_iframeeventscallback_ptr_dword_dword"></span>Método IFrameEventsRequest::RequestAsync

Uma solicitação assíncrona para obter informações especificadas sobre um único quadro especificado.
