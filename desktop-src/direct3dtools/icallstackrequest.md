---
description: Solicitação de dados de pilha de chamadas.
...
A interface **ICallStackRequest** herda da interface [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) . **ICallStackRequest** também tem estes tipos de membros:
