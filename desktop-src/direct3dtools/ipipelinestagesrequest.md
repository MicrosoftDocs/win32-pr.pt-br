...
A interface **IPipeLineStagesRequest** herda da interface [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) . **IPipeLineStagesRequest** também tem estes tipos de membros:
