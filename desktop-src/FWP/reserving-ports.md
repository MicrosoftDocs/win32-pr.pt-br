---
title: Reservando portas
description: O código de exemplo a seguir demonstra como usar as camadas de atribuição de recurso para reservar um intervalo de portas para administradores.
...
ms.locfileid: "104364479"
---
# <a name="reserving-ports"></a><span data-ttu-id="56465-103">Reservando portas</span><span class="sxs-lookup"><span data-stu-id="56465-103">Reserving Ports</span></span>

<span data-ttu-id="56465-104">O código de exemplo a seguir demonstra como usar as camadas de atribuição de recurso para reservar um intervalo de portas para administradores.</span><span class="sxs-lookup"><span data-stu-id="56465-104">The following sample code demonstrates how to use the resource assignment layers to reserve a range of ports for administrators.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="56465-105">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="56465-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="56465-106">**Condições de filtragem disponíveis em cada camada de filtragem**</span><span class="sxs-lookup"><span data-stu-id="56465-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
