---
title: Impedindo a verificação de porta
description: O código de exemplo a seguir demonstra como impedir a verificação de porta usando Descartes e quedas silenciosas.
...
ms.locfileid: "119900786"
---
# <a name="preventing-port-scanning"></a>Impedindo a verificação de porta

O código de exemplo a seguir demonstra como impedir a verificação de porta usando Descartes e quedas silenciosas.
