...
ms.locfileid: "119069306"
---
# <a name="forcing-filter-deletion"></a>Forçando a exclusão do filtro

O código de exemplo a seguir demonstra como tornar um usuário com o privilégio TakeOwnership capaz de excluir um filtro.

> [!Note]  
> Um aplicativo de instalação pode usar esse recurso durante uma desinstalação para garantir que todos os objetos sejam excluídos com êxito.
