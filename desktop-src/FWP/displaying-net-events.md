...
---
# <a name="displaying-net-events"></a><span data-ttu-id="78463-103">Exibindo eventos de rede</span><span class="sxs-lookup"><span data-stu-id="78463-103">Displaying Net Events</span></span>

<span data-ttu-id="78463-104">O código de exemplo a seguir demonstra como um aplicativo de servidor pode localizar eventos líquidos recentes que podem tê-lo afetado.</span><span class="sxs-lookup"><span data-stu-id="78463-104">The following sample code demonstrates how a server application could locate recent net events that might have affected it.</span></span>

> [!Note]  
> <span data-ttu-id="78463-105">As condições de filtro são as mesmas que as suportadas pela API **IsPortAllowed** de nível inferior.</span><span class="sxs-lookup"><span data-stu-id="78463-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
