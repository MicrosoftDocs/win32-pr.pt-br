...
---
# <a name="viewing-current-state"></a><span data-ttu-id="f73f9-103">Exibindo o estado atual</span><span class="sxs-lookup"><span data-stu-id="f73f9-103">Viewing Current State</span></span>

<span data-ttu-id="f73f9-104">O código de exemplo a seguir demonstra como localizar todos os filtros que podem afetar um aplicativo de servidor.</span><span class="sxs-lookup"><span data-stu-id="f73f9-104">The following sample code demonstrates how to find all filters that might affect a server application.</span></span>

> [!Note]  
> <span data-ttu-id="f73f9-105">As condições de filtro são as mesmas que as suportadas pela API **IsPortAllowed** de nível inferior.</span><span class="sxs-lookup"><span data-stu-id="f73f9-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
