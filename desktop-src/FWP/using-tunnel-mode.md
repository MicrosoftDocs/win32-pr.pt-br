...
ms.locfileid: "119535336"
---
# <a name="using-tunnel-mode"></a>usando o modo de Tunnel

o código de exemplo a seguir demonstra como configurar um túnel IPsec ponto a ponto usando a API da Windows filtering Platform (WFP).
