---
title: Usando o modo de túnel
description: O código de exemplo a seguir demonstra como configurar um túnel IPsec ponto a ponto usando a API da Windows Filtering Platform (WFP).
...
---
# <a name="using-tunnel-mode"></a><span data-ttu-id="24f80-103">Usando o modo de túnel</span><span class="sxs-lookup"><span data-stu-id="24f80-103">Using Tunnel Mode</span></span>

<span data-ttu-id="24f80-104">O código de exemplo a seguir demonstra como configurar um túnel IPsec ponto a ponto usando a API da Windows Filtering Platform (WFP).</span><span class="sxs-lookup"><span data-stu-id="24f80-104">The following sample code demonstrates how to configure a point-to-point IPsec tunnel using the Windows Filtering Platform (WFP) API.</span></span>
