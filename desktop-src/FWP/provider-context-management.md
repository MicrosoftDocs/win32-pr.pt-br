...
ms.locfileid: "119900776"
---
# <a name="provider-context-management"></a>Gerenciamento de contexto do provedor

## <a name="in-this-section"></a>Nesta seção

-   [**RETORNO DE CHAMADA DE ALTERAÇÃO DE CONTEXTO DO PROVEDOR \_ FWPM0 \_ \_ \_**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_provider_context_change_callback0)
