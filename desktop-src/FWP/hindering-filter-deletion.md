---
title: Impedindo a exclusão do filtro
description: O código de exemplo a seguir demonstra como tornar um filtro difícil de excluir definindo uma DACL.
...
ms.locfileid: "104292431"
---
# <a name="hindering-filter-deletion"></a><span data-ttu-id="466ee-103">Impedindo a exclusão do filtro</span><span class="sxs-lookup"><span data-stu-id="466ee-103">Hindering Filter Deletion</span></span>

<span data-ttu-id="466ee-104">O código de exemplo a seguir demonstra como tornar um filtro difícil de excluir definindo uma DACL.</span><span class="sxs-lookup"><span data-stu-id="466ee-104">The following example code demonstrates how to make a filter difficult to delete by setting a DACL.</span></span>
