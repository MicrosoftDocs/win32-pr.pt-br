---
title: Impedindo a exclusão de filtro
description: O código de exemplo a seguir demonstra como dificultar a exclusão de um filtro definindo uma DACL.
...
ms.locfileid: "119069106"
---
# <a name="hindering-filter-deletion"></a>Impedindo a exclusão de filtro

O código de exemplo a seguir demonstra como dificultar a exclusão de um filtro definindo uma DACL.
