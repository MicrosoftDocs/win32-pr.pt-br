...
---
# <a name="hindering-filter-deletion"></a>Impedindo a exclusão do filtro

O código de exemplo a seguir demonstra como tornar um filtro difícil de excluir definindo uma DACL.
