---
title: Usando opções de classificação
description: Os exemplos de código a seguir demonstram como usar opções de classificação de filtro para alterar o processo de filtragem.
...
---
# <a name="using-classify-options"></a><span data-ttu-id="89d12-103">Usando opções de classificação</span><span class="sxs-lookup"><span data-stu-id="89d12-103">Using Classify Options</span></span>

<span data-ttu-id="89d12-104">Os exemplos de código a seguir demonstram como usar opções de classificação de filtro para alterar o processo de filtragem.</span><span class="sxs-lookup"><span data-stu-id="89d12-104">The following code samples demonstrate how to use filter classify options in order to alter the filtering process.</span></span>

## <a name="enable-loose-source-mapping-for-a-remote-udp-port"></a><span data-ttu-id="89d12-105">Habilitar o mapeamento de origem flexível para uma porta UDP remota</span><span class="sxs-lookup"><span data-stu-id="89d12-105">Enable Loose Source Mapping for a Remote UDP Port</span></span>
...
## <a name="modify-the-idle-lifetimes-for-ale-flows"></a><span data-ttu-id="89d12-106">Modificar os tempos de vida ociosos para fluxos ALE</span><span class="sxs-lookup"><span data-stu-id="89d12-106">Modify the Idle Lifetimes for ALE Flows</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="89d12-107">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="89d12-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="89d12-108">**Condições de filtragem disponíveis em cada camada de filtragem**</span><span class="sxs-lookup"><span data-stu-id="89d12-108">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
