...
Os exemplos de código a seguir demonstram como usar opções de classificação de filtro para alterar o processo de filtragem.

## <a name="enable-loose-source-mapping-for-a-remote-udp-port"></a>Habilitar o mapeamento de origem flexível para uma porta UDP remota
...
## <a name="modify-the-idle-lifetimes-for-ale-flows"></a>Modificar os tempos de vida ociosos para fluxos ALE
