...
---
# <a name="manual-sa-keying"></a>Chaveamento da SA manual

O código de exemplo a seguir demonstra como criar associações de segurança (SA) usando a plataforma de filtragem do Windows.
