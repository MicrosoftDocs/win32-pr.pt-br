---
title: Chaveamento da SA manual
description: O código de exemplo a seguir demonstra como criar associações de segurança (SA) usando a plataforma de filtragem do Windows.
...
ms.locfileid: "104498592"
---
# <a name="manual-sa-keying"></a><span data-ttu-id="4fbc2-103">Chaveamento da SA manual</span><span class="sxs-lookup"><span data-stu-id="4fbc2-103">Manual SA Keying</span></span>

<span data-ttu-id="4fbc2-104">O código de exemplo a seguir demonstra como criar associações de segurança (SA) usando a plataforma de filtragem do Windows.</span><span class="sxs-lookup"><span data-stu-id="4fbc2-104">The following sample code demonstrates how to create Security Associations (SA) using Windows Filtering Platform.</span></span>
