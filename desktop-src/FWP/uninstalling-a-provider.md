...
ms.locfileid: "119755166"
---
# <a name="uninstalling-a-provider"></a>Desinstalando um provedor

O código de exemplo a seguir demonstra o processo necessário para remover uma instalação do provedor.
