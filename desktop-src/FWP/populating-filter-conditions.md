...
---
# <a name="populating-filter-conditions"></a>Populando condições de filtro

O código de exemplo a seguir demonstra como preencher condições de filtro usadas por um aplicativo de servidor para localizar filtros e eventos que o afetam.

> [!Note]  
> Essas condições são as mesmas que as suportadas pela API **IsPortAllowed** de nível inferior.
