...
O código de exemplo a seguir demonstra como configurar o modo de transporte IPsec usando AuthIP com autenticação de usuário e descoberta de negociação.
