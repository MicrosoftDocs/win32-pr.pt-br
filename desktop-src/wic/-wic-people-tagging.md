---
description: este tópico apresenta o novo esquema XMP (Extensible Metadata Platform) e a propriedade de foto Windows 7. photos. peoples que habilita a marcação de indivíduos em uma foto digital.
...
este tópico apresenta o novo esquema XMP (Extensible Metadata Platform) e a propriedade de foto Windows 7 [. photos. peoples](../properties/props-system-photo-peoplenames.md) que habilita a marcação de indivíduos em uma foto digital. este tópico também aborda como usar a API de WIC (Windows Imaging Component) para ler e gravar os metadados necessários para a marcação de pessoas.
...
| MPRI: regiões          | Região da bolsa | Externo | **obrigatório** : armazena as regiões de marcação de pessoas. Consulte a seção Esquema de Região de Foto da Microsoft a seguir. |
