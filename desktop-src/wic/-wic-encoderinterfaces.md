...
ms.locfileid: "118965115"
---
# <a name="encoder-interfaces"></a>Interfaces do codificador


as tabelas a seguir mostram as interfaces implementadas por codificadores do Windows (componente de geração de imagens) e o diagrama de classe mostra a hierarquia de herança.
...
| [IWICBitmapCodecProgressNotification](-wic-imp-iwicbitmapcodecprogressnotification-encoder.md) | Notificação de progresso & suporte ao cancelamento | Recomendado                                                                |
