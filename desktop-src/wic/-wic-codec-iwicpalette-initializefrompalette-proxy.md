...
---
# <a name="iwicpalette_initializefrompalette_proxy-function"></a>\_Função de \_ proxy IWICPalette InitializeFromPalette

Função de proxy para o método [**InitializeFromPalette**](/windows/desktop/api/Wincodec/nf-wincodec-iwicpalette-initializefrompalette) .
...
Ponteiro para a paleta de origem.
