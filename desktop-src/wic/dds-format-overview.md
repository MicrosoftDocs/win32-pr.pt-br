---
description: fornece informações sobre o codec do DDS nativo disponível por meio do Windows o componente de geração de imagens (WIC).
...
ms.locfileid: "118204472"
---
# <a name="dds-format-overview"></a>Visão geral do formato DDS

este tópico fornece informações sobre o codec do DDS nativo disponível por meio do Windows o componente de geração de imagens (WIC).
