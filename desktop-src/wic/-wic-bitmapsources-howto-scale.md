...
---
# <a name="how-to-scale-a-bitmap-source"></a>Como dimensionar uma fonte de bitmap
...
4.  Crie o [**IWICBitmapScaler**](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapscaler) a ser usado para o dimensionamento de imagem.
...
5.  Inicialize o objeto scaler com os dados da imagem do quadro de bitmap com metade do tamanho.
...
6.  Desenhe ou processe a origem do bitmap em escala.

    A ilustração a seguir demonstra o dimensionamento da imagem. A imagem original à esquerda é 200 x 130 pixels. A imagem à direita é a imagem original dimensionada para metade do tamanho.
