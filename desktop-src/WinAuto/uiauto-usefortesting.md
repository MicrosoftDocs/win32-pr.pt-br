...
| Nome         | Uma cadeia de texto que identifica ou explica a finalidade de um elemento de automação. Ele deve ser usado com cautela porque pode ser localizado. A propriedade Name não é um identificador exclusivo entre irmãos. Para a automação de teste, os clientes devem usar a propriedade AutomationId ou a propriedade runtimeId em vez disso.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
