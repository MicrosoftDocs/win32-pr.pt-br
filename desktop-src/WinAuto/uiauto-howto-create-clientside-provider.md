...
---
# <a name="how-to-create-a-client-side-proxy-ui-automation-provider"></a><span data-ttu-id="40582-103">Como criar um provedor de automação de interface do usuário Client-Side (proxy)</span><span class="sxs-lookup"><span data-stu-id="40582-103">How to Create a Client-Side (Proxy) UI Automation Provider</span></span>

<span data-ttu-id="40582-104">Este tópico contém um código de exemplo que mostra como implementar um provedor de automação da interface do usuário ou proxy do lado do cliente.</span><span class="sxs-lookup"><span data-stu-id="40582-104">This topic contains example code that shows how to implement a client-side, or proxy, Microsoft UI Automation provider.</span></span>

-   [<span data-ttu-id="40582-105">Exemplo 1: enumerando a tabela de fábrica de proxy</span><span class="sxs-lookup"><span data-stu-id="40582-105">Example 1: Enumerating the Proxy Factory Table</span></span>](#example-1-enumerating-the-proxy-factory-table)
-   [<span data-ttu-id="40582-106">Exemplo 2: Implementando um proxy simples para controles de botão</span><span class="sxs-lookup"><span data-stu-id="40582-106">Example 2: Implementing a Simple Proxy for Button Controls</span></span>](#example-2-implementing-a-simple-proxy-for-button-controls)
-   [<span data-ttu-id="40582-107">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="40582-107">Related topics</span></span>](#related-topics)

## <a name="example-1-enumerating-the-proxy-factory-table"></a><span data-ttu-id="40582-108">Exemplo 1: enumerando a tabela de fábrica de proxy</span><span class="sxs-lookup"><span data-stu-id="40582-108">Example 1: Enumerating the Proxy Factory Table</span></span>

<span data-ttu-id="40582-109">O código de exemplo a seguir enumera as entradas na tabela de fábrica de proxy e exibe o nome de classe do controle com suporte.</span><span class="sxs-lookup"><span data-stu-id="40582-109">The following example code enumerates the entries in the proxy factory table and displays the class name of the supported control.</span></span> <span data-ttu-id="40582-110">Para proxies que não são fornecidos com o sistema operacional, o nome da imagem é exibido.</span><span class="sxs-lookup"><span data-stu-id="40582-110">For proxies that are not supplied with the operating system, the image name is displayed.</span></span>
...
## <a name="example-2-implementing-a-simple-proxy-for-button-controls"></a><span data-ttu-id="40582-111">Exemplo 2: Implementando um proxy simples para controles de botão</span><span class="sxs-lookup"><span data-stu-id="40582-111">Example 2: Implementing a Simple Proxy for Button Controls</span></span>

<span data-ttu-id="40582-112">O código de exemplo a seguir implementa um proxy simples para controles que têm o nome de classe "Button" e adiciona uma entrada para o proxy à tabela de fábrica de proxy.</span><span class="sxs-lookup"><span data-stu-id="40582-112">The following example code implements a simple proxy for controls that have the "Button" class name, and adds an entry for the proxy to the proxy factory table.</span></span> <span data-ttu-id="40582-113">Este exemplo usa a caixa de diálogo fonte do bloco de notas para demonstrar o proxy.</span><span class="sxs-lookup"><span data-stu-id="40582-113">This example uses the Font dialog box of Notepad to demonstrate the proxy.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="40582-114">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="40582-114">Related topics</span></span>

<dl> <dt>

<span data-ttu-id="40582-115">**Conceitua**</span><span class="sxs-lookup"><span data-stu-id="40582-115">**Conceptual**</span></span>
</dt> <dt>

[<span data-ttu-id="40582-116">Implementando um provedor de automação de interface do usuário Client-Side</span><span class="sxs-lookup"><span data-stu-id="40582-116">Implementing a Client-Side UI Automation Provider</span></span>](uiauto-serversideprovider.md)
</dt> <dt>

[<span data-ttu-id="40582-117">Tópicos de instruções para provedores de automação de interface do usuário</span><span class="sxs-lookup"><span data-stu-id="40582-117">How-To Topics for UI Automation Providers</span></span>](uiauto-howto-topics-for-uiautomation-providers.md)
</dt> </dl>
