...
> [!NOTE]
> **AccScope** é uma ferramenta herdada. é recomendável usar [Insights de acessibilidade](https://accessibilityinsights.io/) em vez disso.
...
**AccScope** é um aplicativo de área de trabalho, não um aplicativo de Windows Store. você pode usá-lo para examinar qualquer aplicativo que aparece como uma janela, incluindo um aplicativo de área de trabalho ou um aplicativo da loja Windows.
...
- **Layout do elemento:** Verifique cada um desses casos:
    - Verifique se os elementos redundantes não são expostos pelo Narrator. um exemplo de um elemento redundante é o controle de classificações em cada item de bloco de repositório Windows.
