...
---
# <a name="supporting-ui-automation-control-types"></a>Suporte a tipos de controle de automação da interface do usuário

Esta seção contém informações detalhadas sobre a estrutura de árvore, propriedades, padrões de controle e eventos que cada tipo de controle de automação da interface do usuário da Microsoft precisa dar suporte.

## <a name="in-this-section"></a>Nesta seção

-   [Tipo de controle AppBar](uiauto-supportappbarcontroltype.md)
