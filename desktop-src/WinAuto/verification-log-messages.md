---
title: Mensagens de log de verificação
description: Esta seção descreve as mensagens de log de verificação para o AccChecker (verificador de acessibilidade de interface do usuário).
...
ms.locfileid: "105765741"
---
# <a name="verification-log-messages"></a>Mensagens de log de verificação

Esta seção descreve as mensagens de log de verificação para o AccChecker (verificador de acessibilidade de interface do usuário).
...
-   [Erro de tabela de dados do ARIA](aria-table-name-and-header.md)
-   [Aviso da tabela de dados do ARIA](aria-data-table-description.md)
-   [Erro de estrutura de grade do ARIA](aria-grid-structure.md)
-   [Erro de rótulo do ARIA](aria-label.md)
-   [Erro de tabela de apresentação do ARIA](aria-layout-table.md)
...
-   [Erro de função do ARIA para elementos com manipuladores de eventos](aria-role-missing.md)
-   [Erro de TabIndex do ARIA](aria-click-tabindex.md)
...
-   [Os elementos DragPattern/DragDropPattern exigem o nome](dragpattern-dragdroppattern-elements-requires-name-.md)
-   [Os elementos DragPattern/DragDropPattern exigem DropEffect válidos](dragpattern-dragdroppattern-elements-requires-valid-dropeffect.md)
...
-   [Gatherelement](gatheringelement.md)
-   [Inconsistent, inconsistent](inconsistentstate--inconsistentproperties.md)
