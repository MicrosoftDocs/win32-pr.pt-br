...
O Microsoft Acessibilidade Ativa não oferece suporte aos controles comuns listados na tabela a seguir.



| Nome do controle                  | Nome da classe de janela   |
|-------------------------------|---------------------|
| Controles de seletor de data e hora | \_classe DATETIMEPICK |
| Controles de pager                | WC \_ PAGESCROLLER    |
