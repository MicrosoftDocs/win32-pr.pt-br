...
---
# <a name="value-map-annotation-sample"></a><span data-ttu-id="85937-103">Exemplo de anotação de mapa de valor</span><span class="sxs-lookup"><span data-stu-id="85937-103">Value Map Annotation Sample</span></span>

<span data-ttu-id="85937-104">Recorte, Cole e modifique o exemplo de código a seguir para seu próprio uso.</span><span class="sxs-lookup"><span data-stu-id="85937-104">Cut, paste, and modify the following code sample for your own use.</span></span> <span data-ttu-id="85937-105">Siga as instruções em comentários marcados com/ \* todo \* /.</span><span class="sxs-lookup"><span data-stu-id="85937-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
