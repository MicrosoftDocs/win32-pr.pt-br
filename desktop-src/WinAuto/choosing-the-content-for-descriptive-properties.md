...
|-------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Nome**](name-property.md)                   | Um rótulo que descreve brevemente e identifica o objeto dentro de seu contêiner, como o texto em um botão de ação, o nome de um item de menu ou um rótulo exibido ao lado de um controle de edição.                                                                              |
