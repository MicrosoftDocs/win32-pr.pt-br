---
title: Exemplo de anotação do servidor
description: Exemplo de anotação do servidor
...
ms.locfileid: "105812228"
---
# <a name="server-annotation-sample"></a><span data-ttu-id="8da53-103">Exemplo de anotação do servidor</span><span class="sxs-lookup"><span data-stu-id="8da53-103">Server Annotation Sample</span></span>

<span data-ttu-id="8da53-104">Veja a seguir um exemplo de anotação de servidor.</span><span class="sxs-lookup"><span data-stu-id="8da53-104">The following is an example of server annotation.</span></span> <span data-ttu-id="8da53-105">Siga as instruções em comentários marcados com/ \* todo \* /.</span><span class="sxs-lookup"><span data-stu-id="8da53-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
