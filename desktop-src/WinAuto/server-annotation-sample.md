...
ms.locfileid: "117745107"
---
# <a name="server-annotation-sample"></a>Exemplo de anotação do servidor

Veja a seguir um exemplo de anotação de servidor. Siga as instruções em comentários marcados com/ \* todo \* /.
