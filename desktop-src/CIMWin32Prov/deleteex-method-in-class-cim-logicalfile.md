...
O método **DeleteEx** exclui o arquivo lógico (ou diretório) especificado no caminho do objeto. Esse método é uma versão estendida do método [**delete**](delete-method-in-class-cim-logicalfile.md) .
