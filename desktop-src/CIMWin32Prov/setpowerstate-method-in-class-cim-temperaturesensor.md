---
description: O método SetPowerState da classe Cim TemperatureSensor define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser \_ colocado nesse estado.
ms.assetid: 7a46bddd-9dda-4024-bb12-92637e4432e7
ms.tgt_platform: multiple
title: Método SetPowerState da classe CIM_TemperatureSensor classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
