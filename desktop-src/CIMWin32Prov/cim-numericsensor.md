...
---
# <a name="cim_numericsensor-class"></a>\_Classe CIM NumericSensor
...
A classe **CIM \_ NumericSensor** tem esses métodos.
...
A classe **CIM \_ NumericSensor** tem essas propriedades.
...
A classe **CIM \_ NumericSensor** é derivada do [**\_ sensor CIM**](cim-sensor.md).

O WMI não implementa essa classe. Para classes derivadas de **\_ NumericSensor do CIM**, consulte [classes Win32](win32-provider.md).
