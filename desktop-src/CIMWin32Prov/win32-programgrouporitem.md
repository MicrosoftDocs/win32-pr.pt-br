...
---
# <a name="win32_programgrouporitem-class"></a>\_Classe Win32 ProgramGroupOrItem

A [classe WMI](../wmisdk/retrieving-a-class.md) abstrata do **Win32 \_ ProgramGroupOrItem** representa um agrupamento lógico de programas no menu **Iniciar \\ programas** do usuário. Ele contém grupos de programas e itens de grupo de programas.
...
A classe **Win32 \_ ProgramGroupOrItem** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Win32 \_ ProgramGroupOrItem** tem essas propriedades.
...
A classe **Win32 \_ ProgramGroupOrItem** é derivada de [**CIM \_ LogicalElement**](cim-logicalelement.md).
