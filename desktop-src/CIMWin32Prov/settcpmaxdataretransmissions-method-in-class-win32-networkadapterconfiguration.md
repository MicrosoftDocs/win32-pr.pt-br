...
O método estático da [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetTcpMaxDataRetransmissions** é usado para definir o número de vezes que o TCP retransmite um segmento de dados individual antes de abortar a conexão.
...
*TcpMaxDataRetransmissions* \[ no\]
</dt> <dd>

Número de vezes que o TCP retransmite um segmento de dados individual antes de abortar a conexão. Intervalo válido: 0-0xFFFFFFFF.
