...
ms.locfileid: "118675757"
---
# <a name="invoke-method-of-the-cim_copyfileaction-class"></a>Método Invoke da classe CIM \_ CopyValue

O método **Invoke** da classe [**CIM \_ CopyAction**](cim-copyfileaction.md) usa uma ação específica. Os detalhes sobre como o método executa a ação são específicos da implementação. Esse método é herdado [**da \_ ação CIM**](cim-action.md).
...
[**CIM \_ CopyAction**](invoke-method-in-class-cim-copyfileaction.md)
</dt> <dt>
