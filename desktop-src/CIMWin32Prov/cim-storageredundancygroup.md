...
A classe **CIM \_ StorageRedundancyGroup** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **CIM \_ StorageRedundancyGroup** tem essas propriedades.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Grupo de REDUNDÂNCIA DMTF \| 1,2 ")
</dt> </dl>

Algoritmo usado para a redundância e reconstrução de dados. O valor 0 não é válido no esquema CIM, pois ele representa que não existe nenhuma redundância no DMI. Nesse caso, o objeto não deve ser instanciado.
