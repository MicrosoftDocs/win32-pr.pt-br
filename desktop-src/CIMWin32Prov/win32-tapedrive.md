...
---
# <a name="win32_tapedrive-class"></a>\_Classe Win32 TapeDrive

A [classe WMI](../wmisdk/retrieving-a-class.md) **\_ TapeDrive do Win32** representa uma unidade de fita em um sistema de computador que executa o Windows. As unidades de fita são distinguidas principalmente pelo fato de que só podem ser acessadas em sequência.
...
A classe **Win32 \_ TapeDrive** tem estes tipos de membros:
...
A classe **Win32 \_ TapeDrive** tem esses métodos.



| Método            | Descrição                                                                                                                                                                            |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**CIM \_ TapeDrive**](cim-tapedrive.md).<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**CIM \_ TapeDrive**](cim-tapedrive.md).<br/> |
...
A classe **Win32 \_ TapeDrive** tem essas propriedades.
...
Qualificadores: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("indexado"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ([**" \_ CIM MediaAccessDevice**](cim-mediaaccessdevice.md).**Recursos**")
</dt> </dl>

Matriz de cadeias de caracteres de forma livre que fornece explicações mais detalhadas para qualquer recurso de dispositivo de acesso indicado na matriz de **recursos** . Observe que cada entrada dessa matriz está relacionada à entrada na matriz de **recursos** que está localizada no mesmo índice.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| estruturas de backup em fita win32api \| [**fita \_ obter \_ \_ parâmetros de unidade**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| compactação")
</dt> </dl>

Se for **true**, a compactação de dados de hardware será habilitada.
...
Cadeia de caracteres de forma livre que indica o algoritmo ou a ferramenta usada pelo dispositivo para dar suporte à compactação. Se não for possível ou não desejar descrever o esquema de compactação (talvez porque não seja conhecido), use as seguintes palavras: "desconhecido" para representar que não é conhecido se o dispositivo dá suporte a recursos de compactação ou não; "Compactado" para representar que o dispositivo dá suporte a recursos de compactação, mas seu esquema de compactação não é conhecido ou não é divulgado; e "não compactado" para representar que o dispositivo não oferece suporte a recursos de compactação.
...
Qualificadores: [**Key**](../wmisdk/key-qualifier.md), [**override**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| File Functions \| CreateFile")
</dt> </dl>

Identificador exclusivo da unidade de fita com outros dispositivos no sistema.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| estruturas de backup em fita win32api \| [**fita \_ obter \_ \_ parâmetros de unidade**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ECC")
</dt> </dl>

Se **for true**, o dispositivo dará suporte à correção de erro de hardware.
...
Tamanho da zona para o aviso de fim de fita (EOT).

Essa propriedade é herdada do [**CIM \_ TapeDrive**](cim-tapedrive.md).
...
Cadeia de caracteres de forma livre que descreve o tipo de detecção de erros e correção com suporte neste dispositivo.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| estruturas de backup em fita win32api \| [**fita \_ obter \_ \_ parâmetros de unidade**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesHigh")
</dt> </dl>

Ordem superior 32 bits do sinalizador de recursos do dispositivo.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| estruturas de backup em fita win32api \| [**fita \_ obter \_ \_ parâmetros de unidade**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesLow")
</dt> </dl>

Ordem inferior 32 bits do sinalizador de recursos do dispositivo.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| funções de arquivo win32api")
</dt> </dl>

Nome de identificação do fabricante da unidade de CD ROM do Windows.

Exemplo: "PLEXTOR CD-ROM PX-12CS 1, 1"
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Dispositivos de acesso sequencial DMTF \| 1,2 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" kilobytes ")
</dt> </dl>
...
Contagem máxima de partições para a unidade de fita.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \_ unidade de fita de MediaType Win32 TapeDrive \| \| ")
</dt> </dl>

Tipo de mídia usado pelo (ou acessado por) este dispositivo. Nesse caso, ele é definido como "unidade de fita".
...
Número de bytes inseridos entre os blocos em uma mídia de fita.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| estruturas de backup em fita win32api \| [**fita \_ obter \_ \_ parâmetros de unidade**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ReportSetmarks")
</dt> </dl>

Se for **true**, o relatório de setmark será habilitado. O relatório setmark usa um elemento registrado especializado que não contém dados do usuário. Esse elemento registrado é usado para fornecer um esquema de segmentação que é hierarquicamente superior a marcas de File. As marcas de desmarcações fornecem um posicionamento mais rápido em fitas de alta capacidade.
...
A classe **Win32 \_ TapeDrive** é derivada de [**CIM \_ TapeDrive**](cim-tapedrive.md).
