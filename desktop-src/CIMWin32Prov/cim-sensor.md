---
description: A classe sensor CIM representa um dispositivo de hardware capaz de medir as características de uma propriedade física (por exemplo, as características de temperatura ou tensão de um \_ sistema de computador unitário).
...
ms.locfileid: "119919936"
---
# <a name="cim_sensor-class"></a>Classe de sensor CIM \_

A **classe \_ sensor CIM** representa um dispositivo de hardware capaz de medir as características de uma propriedade física (por exemplo, as características de temperatura ou tensão de um sistema de computador unitário).
...
A **classe \_ sensor CIM** tem estes tipos de membros:
...
A **classe \_ sensor CIM** tem esses métodos.
...
A **classe \_ sensor CIM** tem essas propriedades.
...
A **classe \_ sensor CIM** é derivada de CIM [**\_ LogicalDevice**](cim-logicaldevice.md).
