...
Essa propriedade é herdada do [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).
...
A classe **Win32 \_ PCMCIAController** é derivada de [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).
