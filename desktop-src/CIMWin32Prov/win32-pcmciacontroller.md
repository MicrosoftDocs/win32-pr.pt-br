...
ms.locfileid: "117834150"
---
# <a name="win32_pcmciacontroller-class"></a>\_Classe Win32 PCMCIAController

A [classe WMI](../wmisdk/retrieving-a-class.md) **\_ PCMCIAController do Win32** gerencia os recursos de um dispositivo de controlador de placa de memória de computador pessoal (PCMCIA de um PC Card).
...
A classe **Win32 \_ PCMCIAController** tem estes tipos de membros:
...
A classe **Win32 \_ PCMCIAController** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                          |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).<br/> |
...
A classe **Win32 \_ PCMCIAController** tem essas propriedades.
...
Qualificadores: [**override**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**Key**](../wmisdk/key-qualifier.md), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("WMI")
</dt> </dl>

Identificador exclusivo deste dispositivo com outros periféricos usando o Plug and Play BIOS. Essa propriedade é derivada do [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
...
Essa propriedade é herdada [**de CIM \_ PCMCIAController.**](cim-pcmciacontroller.md)
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Porta do Barramento DMTF \| \| 001.2", "MIF. Discos DMTF \| \| 003.3")
</dt> </dl>

Protocolo usado pelo controlador para acessar dispositivos "controlados".

Essa propriedade é herdada do [**Controlador CIM. \_**](cim-controller.md) Os valores são mostrados na lista a seguir.
...
A **classe \_ PCMCIAController win32** é derivada de [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).
