...
---
# <a name="invoke-method-of-the-cim_action-class"></a>Método Invoke da classe de \_ ação CIM

O método **Invoke** da classe [**de \_ ação CIM**](cim-action.md) usa uma ação específica. Os detalhes de como o método executa a ação são específicos da implementação.
...
[Ação de CIM \_](invoke-method-in-class-cim-action.md)
</dt> <dt>
