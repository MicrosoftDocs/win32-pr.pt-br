...
---
# <a name="win32_keyboard-class"></a>\_Classe de teclado Win32

A [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) de **\_ teclado do Win32** representa um teclado instalado em um sistema de computador executando o Windows.
...
A classe de **\_ teclado do Win32** tem estes tipos de membros:
...
A classe de **\_ teclado do Win32** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**\_ teclado CIM**](cim-keyboard.md) para obter a documentação.<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**\_ teclado CIM**](cim-keyboard.md) para obter a documentação.<br/> |
...
A classe de **\_ teclado do Win32** tem essas propriedades.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("DeviceID"), [**chave**](/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>
...
Essa propriedade é herdada [**do \_ teclado CIM**](cim-keyboard.md).
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Segurança de hardware do sistema DMTF \| 1,2 ")
</dt> </dl>

Status da senha no nível de hardware habilitado no teclado (valor = 4), impedindo a entrada local.
...
A classe de **\_ teclado do Win32** é derivada do [**\_ teclado CIM**](cim-keyboard.md).

## <a name="examples"></a>Exemplos

O código do PowerShell a seguir encontra um teclado e mouse sem fio.
