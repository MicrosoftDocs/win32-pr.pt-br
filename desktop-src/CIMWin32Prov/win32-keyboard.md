---
description: A classe \_ WMI de teclado Win32 representa um teclado instalado em um sistema de computador executando Windows.
...
ms.locfileid: "119878636"
---
# <a name="win32_keyboard-class"></a>Classe de teclado Win32 \_

A **classe WMI de \_ teclado Win32** representa um teclado instalado em um sistema de computador executando Windows. [](/windows/desktop/WmiSdk/retrieving-a-class)
...
A **classe \_ Teclado Win32** tem estes tipos de membros:
...
A **classe \_ Teclado Win32** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**Teclado CIM \_ para**](cim-keyboard.md) documentação.<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o [**método SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**Teclado CIM \_ para**](cim-keyboard.md) documentação.<br/> |
...
A **classe \_ Teclado Win32** tem essas propriedades.
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("DeviceId"), [**Chave**](/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>
...
Mais informações sobre o erro registrado **em LastErrorCode** e ações corretivas que podem ser tomadas.
...
Cadeia de caracteres de forma livre que indica o layout do teclado.

Essa propriedade é herdada do [**teclado CIM. \_**](cim-keyboard.md)
...
Status da senha no nível de hardware habilitada no teclado (valor=4), impedindo a entrada local.
...
A **classe \_ teclado Win32** é derivada do [**teclado \_ CIM.**](cim-keyboard.md)

## <a name="examples"></a>Exemplos

O código do PowerShell a seguir localiza um teclado sem fio e mouse.
...
O exemplo de VBScript a seguir lista as propriedades do teclado.
