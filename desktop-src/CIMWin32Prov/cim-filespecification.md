...
A classe **CIM \_ fileespecífication** tem estes tipos de membros:
...
A classe **CIM \_ fileespecífication** tem esses métodos.



| Método                                                         | Descrição                                                      |
|:---------------------------------------------------------------|:-----------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-filespecification.md) | Avalia uma verificação específica. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ fileespecífication** tem essas propriedades.
...
Se for **true**, espera-se que a condição exista no ambiente. Por exemplo, espera-se que um arquivo esteja em um sistema, portanto, o método [**Invoke**](invoke-method-in-class-cim-check.md) deve retornar **true**.

Se for **false**, a condição não deverá existir. Por exemplo, um arquivo não está em um sistema, portanto, o método [**Invoke**](invoke-method-in-class-cim-check.md) deve retornar **false**.
...
Qualificadores: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Assinatura de software DMTF \| 2,4 ")
</dt> </dl>
...
Qualificadores: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Assinatura de software DMTF \| 2,5 ")
</dt> </dl>

Valor de CRC calculado usando o meio 512 KB.
...
Qualificadores: [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Assinatura de software DMTF \| 2,6 ")
</dt> </dl>

Valor de CRC para o meio 512 KB do arquivo, módulo 3.
...
Qualificadores: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (16)
</dt> </dl>

Algoritmo para calcular uma soma de verificação de 128 bits para qualquer arquivo ou objeto. A probabilidade de dois arquivos diferentes que produzem a mesma soma de verificação MD5 é muito pequena (cerca de 1 em 2 ^ 64), e a soma de verificação MD5 de um arquivo pode ser usada para construir um identificador de conteúdo confiável que provavelmente identificará exclusivamente o arquivo. O inverso também é verdadeiro. Se dois arquivos tiverem a mesma soma de verificação MD5, é muito provável que os arquivos sejam idênticos. Para fins de especificação do MOF da propriedade MD5, o algoritmo MD5 sempre gera uma cadeia de caracteres de caractere de 32. Por exemplo, a cadeia de caracteres "abcdefghijklmnopqrstuvwxyz" gera a cadeia de caracteres "c3fcd3d76192e4007dfb496cca67e13b". Para obter mais informações sobre como implementar o algoritmo MD5, consulte [RFC 1321](https://www.ietf.org/rfc/rfc1321.txt).
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) (Name), [**Fixed**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (1024)
</dt> </dl>
...
Este é um identificador para este elemento de software.
...
O WMI não implementa essa classe. Para classes derivadas de **do \_ CIM**, consulte [classes Win32](win32-provider.md).
