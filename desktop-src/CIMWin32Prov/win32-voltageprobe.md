---
description: A classe WMI Win32 \_ VoltageProbe representa as propriedades de um sensor de tensão (medidor eletrônico).
ms.assetid: ca27c1df-fb38-412d-b77c-d9ccf7941c66
ms.tgt_platform: multiple
title: Win32_VoltageProbe classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119079590"
---
# <a name="win32_voltageprobe-class"></a>Classe Win32 \_ VoltageProbe

A classe [WMI](../wmisdk/retrieving-a-class.md) **Win32 \_ VoltageProbe** representa as propriedades de um sensor de tensão (medidor eletrônico).
...
A **classe Win32 \_ VoltageProbe** tem estes tipos de membros:
...
A **classe \_ VoltageProbe win32** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) em [**CIM \_ VoltageSensor**](cim-voltagesensor.md).<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o [**método SetPowerState**](setpowerstate-method-in-class-cim-controller.md) em [**CIM \_ VoltageSensor**](cim-voltagesensor.md).<br/> |
...
A **classe \_ VoltageProbe win32** tem essas propriedades.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Investigação de tensão DMTF \| \| 001,19")
</dt> </dl>

Precisão do sensor para a propriedade medida. O valor de precisão é registrado como mais ou menos centésimos de um percentual. A precisão, juntamente com a resolução e a tolerância, é usada para calcular o valor real da propriedade física medida. A precisão pode variar e depende se o dispositivo é linear ou não em seu intervalo dinâmico.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Investigação de tensão DMTF \| 1,5 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" milivolts ")
</dt> </dl>
...
Identificador exclusivo da investigação de tensão.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Investigação de tensão DMTF \| \| 001,13"), [**Unidades**](../wmisdk/standard-qualifiers.md) ("milivolts")
</dt> </dl>

Os valores de limite do sensor especificam os intervalos (valores mínimo e máximo) para determinar se o sensor está operando em condições normais, não críticas, críticas ou fatais. Se **CurrentReading** estiver entre **LowerThresholdCritical** e **LowerThresholdFatal,** o estado atual será crítico.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Investigação de tensão DMTF \| \| 001,15"), [**Unidades**](../wmisdk/standard-qualifiers.md) ("milivolts")
</dt> </dl>

Os valores de limite do sensor especificam os intervalos (valores mínimo e máximo) para determinar se o sensor está operando em condições normais, não críticas, críticas ou fatais. Se **CurrentReading** estiver abaixo **de LowerThresholdFatal,** o estado atual será fatal.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Investigação de tensão DMTF \| \| 001,11"), [**Unidades**](../wmisdk/standard-qualifiers.md) ("milivolts")
</dt> </dl>

Os valores de limite do sensor especificam os intervalos (valores mínimo e máximo) para determinar se o sensor está operando em condições normais, não críticas, críticas ou fatais. Se **CurrentReading** estiver entre **LowerThresholdNonCritical** e **UpperThresholdNonCritical,** o sensor relatará um valor normal. Se **CurrentReading** estiver entre **LowerThresholdNonCritical** e **LowerThresholdCritical,** o estado atual será nãocrítico.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Investigação de tensão DMTF \| \| 001,9"), [**Unidades**](../wmisdk/standard-qualifiers.md) ("milivolts")
</dt> </dl>

Maior valor da propriedade medida que o sensor numérico pode ler.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Investigação de tensão DMTF \| \| 001,10"), [**Unidades**](../wmisdk/standard-qualifiers.md) ("milivolts")
</dt> </dl>

Menor valor da propriedade medida que o sensor numérico pode ler.
...
Rótulo para um objeto . Quando subclasse, a propriedade pode ser substituído para ser uma propriedade de chave.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Investigação de tensão DMTF \| \| 001,6"), [**Unidades**](../wmisdk/standard-qualifiers.md) ("milivolts")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Investigação de tensão DMTF \| \| 001,7"), [**Unidades**](../wmisdk/standard-qualifiers.md) ("milivolts")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Investigação de tensão DMTF \| \| 001,8"), [**Unidades**](../wmisdk/standard-qualifiers.md) ("milivolts")
</dt> </dl>

Diretrizes para o usuário indicar o intervalo mínimo normal para o sensor numérico.
...
Se **for true**, o dispositivo poderá ser gerenciado por energia, o que significa que ele pode ser colocado no modo de suspensão e assim por diante. A propriedade não indica que os recursos de gerenciamento de energia estão habilitados no momento, mas indica que o dispositivo lógico é capaz de gerenciamento de energia.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Investigação de tensão DMTF \| 1,17 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" décimos de milivolts ")
</dt> </dl>

Capacidade do sensor de resolver diferenças na propriedade medida. Esse valor pode variar e depende se o dispositivo é linear em seu intervalo dinâmico.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Investigação de tensão DMTF \| 1,18 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" milivolts ")
</dt> </dl>

Tolerância do sensor para a propriedade medida. A tolerância, juntamente com a resolução e a precisão, é usada para calcular o valor real da propriedade física medida. A tolerância pode variar e depende se o dispositivo é linear em seu intervalo dinâmico.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Investigação de tensão DMTF \| 1,14 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" milivolts ")
</dt> </dl>

Os valores de limite de sensor especificam os intervalos (valores mínimos e máximos) para determinar se o sensor está operando em condições normais, não críticas, críticas ou fatais. Se **CurrentReading** estiver entre **UpperThresholdCritical** e **UpperThresholdFatal**, o estado atual será crítico.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Investigação de tensão DMTF \| 1,16 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" milivolts ")
</dt> </dl>

Os valores de limite de sensor especificam os intervalos (valores mínimos e máximos) para determinar se o sensor está operando em condições normais, não críticas, críticas ou fatais. Se **CurrentReading** estiver acima de **UpperThresholdFatal**, o estado atual será fatal.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Investigação de tensão DMTF \| 1,12 "), [**unidades**](../wmisdk/standard-qualifiers.md) (" milivolts ")
</dt> </dl>

Os valores de limite de sensor especificam os intervalos (valores mínimos e máximos) para determinar se o sensor está operando em condições normais, não críticas, críticas ou fatais. Se **CurrentReading** estiver entre **LowerThresholdNonCritical** e **UpperThresholdNonCritical**, o sensor estará relatando um valor normal. Se **CurrentReading** estiver entre **UpperThresholdNonCritical** e **UpperThresholdCritical**, o estado atual será não crítico.
...
A classe **Win32 \_ VoltageProbe** é derivada de [**CIM \_ voltagem**](cim-voltagesensor.md).
