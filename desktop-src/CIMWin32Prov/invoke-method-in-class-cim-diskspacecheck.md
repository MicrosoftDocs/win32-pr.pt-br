...
O método **Invoke** da classe [**CIM \_ DiskSpaceCheck**](cim-diskspacecheck.md) avalia uma verificação específica. Os detalhes de como o método avalia uma verificação específica em um contexto CIM são descritos pela subclasse de [**\_ verificação CIM**](cim-check.md) não abstrata.
