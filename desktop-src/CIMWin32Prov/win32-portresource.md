---
description: A \_ classe WMI PortResource do Win32 representa uma porta de e/s em um sistema de computador que executa o Windows.
...
ms.locfileid: "119878576"
---
# <a name="win32_portresource-class"></a>\_Classe Win32 PortResource

A [classe WMI](../wmisdk/retrieving-a-class.md) **\_ PortResource do Win32** representa uma porta de e/s em um sistema de computador que executa o Windows.
...
A classe **Win32 \_ PortResource** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Win32 \_ PortResource** tem essas propriedades.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| Configuration Manager \| informações de e/s de estruturas \_ ")
</dt> </dl>

Se **for true**, essa instância representará um dos intervalos com um alias. Se **for false**, a instância representará um endereço de porta base. Um endereço de porta base é um endereço de porta predeterminado dedicado a um dispositivo ou serviço específico. Um endereço de alias de porta é aquele que um dispositivo responde como se fosse o endereço real de uma porta de e/s.
...
Qualificadores: [**override**](../wmisdk/standard-qualifiers.md) ("StartingAddress"), [**Key**](../wmisdk/key-qualifier.md), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|E/s 1,1 de memória DMTF mapeada \| )
</dt> </dl>
...
A classe **Win32 \_ PortResource** é derivada de [**Win32 \_ SystemMemoryResource**](win32-systemmemoryresource.md).
