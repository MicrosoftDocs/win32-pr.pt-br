---
description: O método SetPowerState da classe Cim PhysicalExtent define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser \_ colocado nesse estado.
ms.assetid: a763c361-9b1a-49fd-8ed2-c1fcfdfd16db
ms.tgt_platform: multiple
title: Método SetPowerState da classe CIM_PhysicalExtent classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
