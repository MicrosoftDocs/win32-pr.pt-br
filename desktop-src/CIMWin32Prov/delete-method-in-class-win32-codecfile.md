...
O método **excluir** [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) exclui o arquivo de codec de áudio ou vídeo lógico (ou diretório) especificado no caminho do objeto.
