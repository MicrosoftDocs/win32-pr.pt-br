...
O método de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetDNSDomain** permite a configuração do domínio DNS.
...
Domínio ao qual o DNS está associado, representado por um nome de organização seguido por um ponto e uma extensão que indica o tipo de organização.
