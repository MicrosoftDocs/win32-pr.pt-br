...
A classe **CIM \_ AggregatePSExtent** tem estes tipos de membros:
...
A classe **CIM \_ AggregatePSExtent** tem esses métodos.



| Método                                                                       | Descrição                                                                                                                                |
|:-----------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-aggregatepsextent.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-aggregatepsextent.md) | Define o estado de energia desejado para um dispositivo lógico e quando o dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ AggregatePSExtent** tem essas propriedades.
...
A classe **CIM \_ AggregatePSExtent** é derivada de [**\_ StorageExtent CIM**](cim-storageextent.md).
