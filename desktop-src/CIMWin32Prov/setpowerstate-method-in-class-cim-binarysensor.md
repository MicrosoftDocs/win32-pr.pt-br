...
title: Método SetPowerState da classe CIM_BinarySensor classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119439646"
---
# <a name="setpowerstate-method-of-the-cim_binarysensor-class"></a>Método SetPowerState da classe \_ BINARySensor CIM
...
Especifica quando o estado de energia deve ser definido, como um valor de data/hora regular ou como um valor de intervalo (em que o intervalo começa quando a invocação do método é recebida). Quando o *parâmetro PowerState* é igual a 5 ("Power Cycle"), o parâmetro *Time* indica quando o dispositivo deve ser a energia novamente. A desligar é imediata.
