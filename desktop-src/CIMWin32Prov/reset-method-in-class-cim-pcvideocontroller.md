...
ms.locfileid: "119701486"
---
# <a name="reset-method-of-the-cim_pcvideocontroller-class"></a>Método Reset da classe CIM \_ PCVideoController

O método **Reset** da classe CIM \_ PCVideoController solicita uma redefinição do dispositivo lógico. Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
