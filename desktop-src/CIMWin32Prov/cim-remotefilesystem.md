...
ms.locfileid: "119920506"
---
# <a name="cim_remotefilesystem-class"></a>\_Classe CIM RemoteFileSystem

A classe **CIM \_ RemoteFileSystem** representa um sistema de arquivos remoto que é acessado por meio de um serviço relacionado à rede. Nesse caso, o armazenamento de arquivos é hospedado por um computador, que atua como um servidor de arquivos. Por exemplo, o armazenamento de arquivos para um sistema de arquivos NFS normalmente não está na mídia controlada localmente de um sistema de computador, nem é acessado diretamente por meio de um driver de dispositivo. As subclasses do **CIM \_ RemoteFileSystem** contêm informações de configuração do lado do cliente relacionadas ao acesso do sistema de arquivos.
...
A classe **CIM \_ RemoteFileSystem** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **CIM \_ RemoteFileSystem** tem essas propriedades.
...
Quantidade de espaço livre para o sistema de arquivos, em bytes. Se for desconhecido, insira 0.
...
Tamanho, em bytes, dos blocos que formam a extensão de armazenamento. Se for desconhecido ou se um conceito de bloco não for válido, (por exemplo, para extensões de agregação, memória ou discos lógicos), insira um 1 (um).
...
Conjuntos de caracteres ou codificação com suporte no sistema de arquivos. Essa propriedade é herdada [**do \_ sistema de arquivos CIM**](cim-filesystem.md).
...
Tamanho total do sistema de arquivos, em bytes. Se for desconhecido, insira 0.
...
Comprimento máximo de um nome de arquivo dentro do sistema de arquivos. Um valor de 0 indica que o comprimento do nome do arquivo é ilimitado.
...
A classe **CIM \_ RemoteFileSystem** é derivada do [**sistema de \_ arquivos CIM**](cim-filesystem.md).
