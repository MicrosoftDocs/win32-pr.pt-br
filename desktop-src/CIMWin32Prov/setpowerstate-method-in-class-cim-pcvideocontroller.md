...
Este método não está implementado no momento pelo WMI. Para usar esse método, você deve implementá-lo em seu próprio provedor. Para classes WMI derivadas do [**CIM \_ PCVideoController**](cim-pcvideocontroller.md), consulte [classes Win32](win32-provider.md).
