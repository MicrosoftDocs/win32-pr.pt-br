...
---
# <a name="cim_pointingdevice-class-cimwin32-wmi-providers"></a>Classe CIM_PointingDevice (provedores WMI CIMWin32)

A classe **CIM \_ PointingDevice** representa um dispositivo que aponta para regiões na exibição. Qualquer dispositivo que manipule um ponteiro ou aponta para regiões em uma exibição Visual é membro dessa classe. Por exemplo, um mouse, uma caneta, um touch pad ou um Tablet.
...
A classe **CIM \_ PointingDevice** tem esses métodos.



| Método                                                                    | Descrição                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-pointingdevice.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pointingdevice.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
Configuração do dispositivo apontador para a operação do lado direito ou esquerdo.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Dispositivo apontador DMTF \| 1,1 ")
</dt> </dl>

Tipo do dispositivo apontador.
...
Qualificadores: [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("contagens por polegada")
</dt> </dl>
...
A classe **CIM \_ PointingDevice** é derivada de [**\_ userdevice do CIM**](cim-userdevice.md).

O WMI não implementa essa classe. Para classes WMI derivadas do **CIM \_ PointingDevice**, consulte [classes Win32](win32-provider.md).
