---
description: O método SetPowerState da classe CIM PointingDevice define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser \_ colocado nesse estado.
ms.assetid: 5ecb3f3a-76b2-4170-8583-b9a53ee23cdf
ms.tgt_platform: multiple
title: Método SetPowerState da classe CIM_PointingDevice classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
