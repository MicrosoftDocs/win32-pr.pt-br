...
ms.locfileid: "119924906"
---
# <a name="cim_controller-class-cimwin32-wmi-providers"></a>Classe CIM_Controller (provedores WMI CIMWin32)

A classe do **\_ controlador CIM** é uma classe pai para agrupar dispositivos diversos relacionados ao controle. Os exemplos de controladores são controladores SCSI, controladores USB e controladores seriais.

A classe de **\_ controlador CIM** é uma abstração de dispositivos com uma pilha de protocolo único, que existe principalmente para comunicação e controle ou redefinição de dispositivos downstream ([**CIM \_ ControlledBy**](cim-controlledby.md)).
...
A classe do **\_ controlador CIM** tem estes tipos de membros:
...
A classe do **\_ controlador CIM** tem esses métodos.



| Método                                                                | Descrição                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Definido**](reset-method-in-class-cim-controller.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe do **\_ controlador CIM** tem essas propriedades.
...
Número máximo de entidades diretamente acessível com suporte por esse controlador. Um valor de 0 deverá ser usado se o número for desconhecido ou ilimitado.
...
O protocolo usado pelo controlador para acessar dispositivos 'controlados'.
...
Data e hora da última redefinição do controlador (desligado ou reinicializado).

</dd> </dl>

## <a name="remarks"></a>Comentários

A classe do **\_ controlador CIM** é derivada [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).

O WMI não implementa essa classe. Para classes derivadas do **\_ controlador CIM**, consulte [classes Win32](win32-provider.md).
