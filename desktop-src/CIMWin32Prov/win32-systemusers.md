...
---
# <a name="win32_systemusers-class"></a>\_Classe Win32 SystemUsers

A [classe WMI](../wmisdk/retrieving-a-class.md) de associação **\_ SystemUsers do Win32** relaciona um sistema de computador e uma conta de usuário nesse sistema.
...
A classe **Win32 \_ SystemUsers** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Win32 \_ SystemUsers** tem essas propriedades.
...
Referência à instância que representa o sistema de computador que contém a conta de usuário.
...
Qualificadores: [**chave**](../wmisdk/key-qualifier.md), [**substituição**](../wmisdk/standard-qualifiers.md) ("PartComponent"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("conta de userwmi \| Win32 \_ ")
</dt> </dl>

Referência à instância que representa a conta de usuário no sistema de computador.

</dd> </dl>

## <a name="remarks"></a>Comentários

A classe **Win32 \_ SystemUsers** é derivada de [**CIM \_ Systemcomponent**](cim-systemcomponent.md).
