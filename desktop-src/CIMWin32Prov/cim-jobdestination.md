...
A classe **CIM \_ JobDestination** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **CIM \_ JobDestination** tem essas propriedades.
...
A classe **CIM \_ JobDestination** é derivada de [**CIM \_ LogicalElement**](cim-logicalelement.md).
