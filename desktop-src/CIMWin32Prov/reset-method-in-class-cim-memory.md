...
---
# <a name="reset-method-of-the-cim_memory-class"></a>Método Reset da classe de \_ memória CIM

O método **Reset** da classe de \_ memória CIM solicita uma redefinição do dispositivo lógico. Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_Memória CIM](reset-method-in-class-cim-memory.md)
</dt> <dt>
