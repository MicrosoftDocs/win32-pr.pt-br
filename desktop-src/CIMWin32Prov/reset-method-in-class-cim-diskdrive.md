...
title: Método reset da classe CIM_DiskDrive dados
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119528366"
---
# <a name="reset-method-of-the-cim_diskdrive-class"></a>Método reset da classe CIM \_ DiskDrive

O **método Reset** da classe CIM \_ DiskDrive solicita uma redefinição do dispositivo lógico. Esse método é herdado [**de CIM \_ LogicalDevice.**](cim-logicaldevice.md)
