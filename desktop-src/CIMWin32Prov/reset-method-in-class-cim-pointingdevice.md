...
---
# <a name="reset-method-of-the-cim_pointingdevice-class"></a>Método Reset da classe CIM \_ PointingDevice

O método **Reset** da classe CIM \_ PointingDevice solicita uma redefinição do dispositivo lógico. Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
