...
---
# <a name="cim_display-class-cimwin32-wmi-providers"></a>Classe CIM_Display (provedores WMI CIMWin32)

A classe de **\_ vídeo CIM** é uma classe pai para agrupar dispositivos de vídeo diversos.
...
A classe de **\_ vídeo CIM** tem estes tipos de membros:
...
A classe de **\_ vídeo CIM** tem esses métodos.
...
A classe de **\_ vídeo CIM** tem essas propriedades.
...
Cadeia de caracteres de forma livre que fornece informações sobre o erro registrado nas ações corretivas da propriedade **LastErrorCode** a serem executadas.
...
A classe de **\_ exibição CIM** é derivada de [**CIM \_ userdevice**](cim-userdevice.md).

O WMI não implementa essa classe. Para classes derivadas da **\_ exibição de CIM**, consulte [classes Win32](win32-provider.md).
