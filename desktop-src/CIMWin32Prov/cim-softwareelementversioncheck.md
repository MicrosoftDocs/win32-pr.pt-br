...
ms.locfileid: "119919206"
---
# <a name="cim_softwareelementversioncheck-class"></a>\_Classe CIM SoftwareElementVersionCheck

A classe **CIM \_ SoftwareElementVersionCheck** representa um tipo de elemento de software que deve existir no ambiente. Essa verificação pode ser para um determinado, mínimo, máximo ou um intervalo de versões. Para especificar uma versão específica, as versões inferior e superior devem ser as mesmas. Para especificar uma versão mínima, especifique apenas a versão inferior. Para especificar uma versão máxima, especifique apenas a versão superior. Para especificar um intervalo, as versões superior e inferior devem ser especificadas. Os detalhes das verificações são comparados com os detalhes correspondentes encontrados em um objeto [**CIM \_ softwareelement**](cim-softwareelement.md) referenciado por uma associação [**\_ InstalledSoftwareElement**](cim-installedsoftwareelement.md) do CIM para o objeto de [**\_ ComputerSystem do CIM**](cim-computersystem.md) . Pelo menos um **CIM \_ softwareelement** precisa satisfazer os detalhes da condição para que a verificação seja satisfeita.
...
A classe **CIM \_ SoftwareElementVersionCheck** tem estes tipos de membros:
...
A classe **CIM \_ SoftwareElementVersionCheck** tem esses métodos.



| Método                                                                   | Descrição                                                   |
|:-------------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-softwareelementversioncheck.md) | Executa uma ação específica. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ SoftwareElementVersionCheck** tem essas propriedades.
...
Identificador usado em conjunto com outras chaves para identificar exclusivamente a verificação.
...
Se for **true**, espera-se que a condição exista no ambiente (por exemplo, se um arquivo estiver em um sistema, o método [**Invoke**](invoke-method-in-class-cim-softwareelementversioncheck.md) deverá retornar **true**). Se for **false**, a condição não deverá existir (por exemplo, se um arquivo não estiver em um sistema, o método **Invoke** deverá retornar **false**).
...
Qualificadores: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ softwareelement**](cim-softwareelement.md).**Version**")
</dt> </dl>

Versão mínima de um elemento de software que está sendo verificado.
...
Nome usado para identificar o elemento de software.
...
Qualificadores: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ softwareelement**](cim-softwareelement.md).**Nome**")
</dt> </dl>

Nome do elemento de software que está sendo verificado.
...
Qualificadores: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ softwareelement**](cim-softwareelement.md).**SoftwareElementState**")
</dt> </dl>

Estado do elemento de software que está sendo verificado.
...
Qualificadores: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ softwareelement**](cim-softwareelement.md).**TargetOperatingSystem**")
</dt> </dl>

Sistema operacional de destino do elemento de software que está sendo verificado.
...
Qualificadores: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ SoftwareElement**](cim-softwareelement.md).**Versão**")
</dt> </dl>

Versão máxima de um elemento de software que está sendo verificado.
...
Qualificadores: [**Propagado**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ SoftwareElement**](cim-softwareelement.md).**Version**"), [**cim \_ key**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**Maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| ComponentID \| 001.3")
</dt> </dl>
...
Essa propriedade é herdada da [**classe CIM \_ Check.**](cim-check.md)
