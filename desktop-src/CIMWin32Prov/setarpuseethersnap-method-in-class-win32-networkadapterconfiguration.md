---
description: O método estático de classe WMI SetArpUseEtherSNAP é usado para permitir que pacotes ethernet usem a codificação SNAP 802.3.
...
ms.locfileid: "119760176"
---
# <a name="setarpuseethersnap-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetArpUseEtherSNAP da classe \_ NetworkAdapterConfiguration do Win32

O método estático de classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetArpUseEtherSNAP** é usado para permitir que pacotes ethernet usem a codificação SNAP 802.3.
...
Se **true** habilita TCP/IP a transmitir pacotes Ethernet usando a codificação SNAP 802.3.
...
Por padrão, a pilha transmite pacotes no formato Ethernet Digital, Intel, Ethernet (DIX). Ele sempre recebe os dois formatos.

## <a name="examples"></a>Exemplos

O exemplo de código Modificar Consultas ARP para Usar [EtherSNAP](https://Gallery.TechNet.Microsoft.Com/2fe24075-fdb1-486d-8c0b-d25075fd8f21) VBScript na Galeria do TechNet usa **SetArpUseEtherSNAP** para configurar os adaptadores de rede em um computador para usar a codificação SNAP 802.3 para pacotes Ethernet.
