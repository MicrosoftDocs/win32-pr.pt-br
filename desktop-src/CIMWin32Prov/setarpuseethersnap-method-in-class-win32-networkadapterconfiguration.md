...
---
# <a name="setarpuseethersnap-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetArpUseEtherSNAP da classe Win32 \_ NetworkAdapterConfiguration

O método estático da [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetArpUseEtherSNAP** é usado para habilitar pacotes Ethernet para usar a codificação de ajuste 802,3.
...
Se **true** , permite que o TCP/IP transmita pacotes Ethernet usando a codificação de ajuste 802,3.
...
Por padrão, a pilha transmite pacotes no formato Ethernet digital, Intel, Xerox (DIX). Ele sempre recebe os dois formatos.
