---
description: A refrigeração Win32 \_ &\# 32; A classe WMI representa as propriedades de um dispositivo de refrigeração.
...
ms.locfileid: "118958895"
---
# <a name="win32_refrigeration-class"></a>Classe de refrigeração Win32 \_

A classe [WMI](../wmisdk/retrieving-a-class.md) de **\_ Refrigeração Win32** representa as propriedades de um dispositivo de refrigeração.
...
A **classe \_ Refrigeration Win32** tem estes tipos de membros:
...
A **classe \_ Refrigeration Win32** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) em [**CIM \_ Refrigeration**](cim-refrigeration.md).<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o [**método SetPowerState**](setpowerstate-method-in-class-cim-controller.md) em [**Cim \_ Refrigeration**](cim-refrigeration.md).<br/> |
...
A **classe \_ Refrigeration Win32** tem essas propriedades.
...
Se **TRUE**, o dispositivo de resfriamento fornece resfriamento ativo, não resfriamento passivo.
...
Identificador exclusivo do dispositivo de refrigeração.
...
A **classe \_ refrigeração Win32** é derivada de [**CIM \_ Refrigeration**](cim-refrigeration.md).
