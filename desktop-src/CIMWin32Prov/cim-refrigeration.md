...
ms.locfileid: "119920646"
---
# <a name="cim_refrigeration-class"></a>\_Classe de refrigeração CIM

A classe de **\_ refrigeração CIM** representa os recursos e o gerenciamento de um dispositivo de resfriamento de refrigeração.
...
A classe de **\_ refrigeração CIM** tem estes tipos de membros:
...
A classe de **\_ refrigeração CIM** tem esses métodos.



| Método                                                                   | Descrição                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Definido**](reset-method-in-class-cim-refrigeration.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-refrigeration.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe de **\_ refrigeração CIM** tem essas propriedades.
...
A classe de **\_ refrigeração CIM** é derivada do [**CIM \_ CoolingDevice**](cim-coolingdevice.md).
