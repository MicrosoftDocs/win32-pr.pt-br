---
description: O método Reset da classe \_ CURRENTSensor cim solicita uma redefinição do dispositivo lógico.
ms.assetid: 4c1f500b-bc8b-428f-8f4e-cbf5a18f9405
ms.tgt_platform: multiple
title: Método reset da classe CIM_CurrentSensor dados
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119701516"
---
# <a name="reset-method-of-the-cim_currentsensor-class"></a>Método de redefinição da \_ classe CurrentSensor cim

O **método Reset** da classe \_ CURRENTSensor cim solicita uma redefinição do dispositivo lógico. Esse método é herdado [**de CIM \_ LogicalDevice.**](cim-logicaldevice.md)
