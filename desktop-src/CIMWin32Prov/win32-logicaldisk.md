...
---
# <a name="win32_logicaldisk-class"></a>Classe do disco lógico do Win32 \_

A [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) do **\_ LogicalDisk do Win32** representa uma fonte de dados que resolve para um dispositivo de armazenamento local real em um sistema de computador que executa o Windows.
...
A classe do disco **\_ lógico do Win32** tem estes tipos de membros:
...
A classe do disco **\_ lógico do Win32** tem esses métodos.



| Método                                                                             | Descrição                                                                                                                                                                                                                 |
|:-----------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Chkdsk**](chkdsk-method-in-class-win32-logicaldisk.md)                         | Invoca a operação [**chkdsk**](chkdsk-method-in-class-win32-logicaldisk.md) no disco.<br/>                                                                                                                    |
| [**ExcludeFromAutochk**](excludefromautochk-method-in-class-win32-logicaldisk.md) | Exclui discos da operação [**chkdsk**](chkdsk-method-in-class-win32-logicaldisk.md) a ser executada na próxima reinicialização.<br/>                                                                                      |
| **Redefinir**                                                                          | Não implementado. Para obter mais informações sobre como implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**\_ LogicalDisk do CIM**](cim-logicaldisk.md) para obter a documentação.<br/> |
| [**ScheduleAutoChk**](scheduleautochk-method-in-class-win32-logicaldisk.md)       | Agenda o [**chkdsk**](chkdsk-method-in-class-win32-logicaldisk.md) a ser executado na próxima reinicialização se o bit sujo tiver sido definido.<br/>                                                                                |
| **SetPowerState**                                                                  | Não implementado. Para obter mais informações sobre como implementar esse método, consulte o método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**\_ LogicalDisk CIM**](cim-logicaldisk.md).<br/>   |
...
A classe do disco **\_ lógico do Win32** tem essas propriedades.
...
Se **for true**, o volume lógico existirá como uma única entidade compactada, como um volume do DoubleSpace. Se a compactação baseada em arquivo tiver suporte, como no NTFS, essa propriedade será **false**.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api \| filefunctions \| GetDriveType")
</dt> </dl>

Valor numérico que corresponde ao tipo de unidade de disco que este disco lógico representa.
...
Comprimento máximo de um componente de nome de arquivo suportado pela unidade do Windows. Um componente de nome de arquivo é a parte de um nome de arquivo entre barras invertidas. O valor pode ser usado para indicar que nomes longos têm suporte pelo sistema de arquivos especificado. Por exemplo, para um sistema de arquivos FAT com suporte a nomes longos, a função armazena o valor 255, em vez do indicador de 8,3 anterior. Os nomes longos também podem ter suporte em sistemas que usam o sistema de arquivos NTFS.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) (" \| funções de entrada e saída de dispositivo do win32api \| DeviceIoControl")
</dt> </dl>

Tipo de mídia atualmente presente na unidade lógica. Esse valor será um dos valores da enumeração de tipo de mídia \_ definida em Winioctl. h. O valor pode não ser exato para unidades removíveis, se atualmente não houver mídia na unidade.

<dt>

<span id="Format_is_unknown"></span><span id="format_is_unknown"></span><span id="FORMAT_IS_UNKNOWN"></span>

<span id="Format_is_unknown"></span><span id="format_is_unknown"></span><span id="FORMAT_IS_UNKNOWN"></span>O **formato é desconhecido** (0)
...
<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>**disquete de 5 polegadas** (1)


</dt> <dd>

Disquete de 5 1/2 polegadas-1,2 MB-512 bytes/setor

</dd> <dt>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (2)


</dt> <dd>

Disquete de 3 1/2 polegadas-1,44 MB-512 bytes/setor

</dd> <dt>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (3)


</dt> <dd>

Disquete de 3 1/2 polegadas-2,88 MB-512 bytes/setor

</dd> <dt>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (4)


</dt> <dd>

Disquete de 3 1/2 polegadas-20,8 MB-512 bytes/setor

</dd> <dt>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (5)


</dt> <dd>

Disquete de 3 1/2 polegadas-720 KB-512 bytes/setor

</dd> <dt>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>**disquete de 5 polegadas** (6)


</dt> <dd>

Disquete de 5 1/2 polegadas-360 KB-512 bytes/setor

</dd> <dt>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>**disquete de 5 polegadas** (7)


</dt> <dd>

Disquete de 5 1/2 polegadas-320 KB-512 bytes/setor

</dd> <dt>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>**disquete de 5 polegadas** (8)


</dt> <dd>

Disquete de 5 1/2 polegadas-320 KB-1024 bytes/setor

</dd> <dt>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>**disquete de 5 polegadas** (9)


</dt> <dd>

Disquete de 5 1/2 polegadas-180 KB-512 bytes/setor

</dd> <dt>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>**disquete de 5 polegadas** (10)


</dt> <dd>

Disquete de 5 1/2 polegadas-160 KB-512 bytes/setor
...
<span id="Removable_media_other_than_floppy"></span><span id="removable_media_other_than_floppy"></span><span id="REMOVABLE_MEDIA_OTHER_THAN_FLOPPY"></span>**Mídia removível diferente do disquete** (11)
...
<span id="Fixed_hard_disk_media"></span><span id="fixed_hard_disk_media"></span><span id="FIXED_HARD_DISK_MEDIA"></span>**Mídia de disco rígido fixa** (12)
...
<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (13)


</dt> <dd>

Disquete de 3 1/2 polegadas-120 MB-512 bytes/setor

</dd> <dt>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (14)


</dt> <dd>

Disquete de 3 1/2 polegadas-640 KB-512 bytes/setor

</dd> <dt>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>**disquete de 5 polegadas** (15)


</dt> <dd>

Disquete de 5 1/2 polegadas-640 KB-512 bytes/setor

</dd> <dt>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>**disquete de 5 polegadas** (16)


</dt> <dd>

Disquete de 5 1/2 polegadas-720 KB-512 bytes/setor

</dd> <dt>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (17)


</dt> <dd>

Disquete de 3 1/2 polegadas-1,2 MB-512 bytes/setor

</dd> <dt>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (18)


</dt> <dd>

Disquete de 3 1/2 polegadas-1,23 MB-1024 bytes/setor

</dd> <dt>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>

<span id="5_-Inch_Floppy_Disk"></span><span id="5_-inch_floppy_disk"></span><span id="5_-INCH_FLOPPY_DISK"></span>**disquete de 5 polegadas** (19)


</dt> <dd>

Disquete de 5 1/2 polegadas-1,23 MB-1024 bytes/setor

</dd> <dt>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (20)


</dt> <dd>

Disquete de 3 1/2 polegadas-128 MB-512 bytes/setor

</dd> <dt>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>

<span id="3_-Inch_Floppy_Disk"></span><span id="3_-inch_floppy_disk"></span><span id="3_-INCH_FLOPPY_DISK"></span>**disquete de 3 polegadas** (21)


</dt> <dd>

Disquete de 3 1/2 polegadas-230 MB-512 bytes/setor

</dd> <dt>

<span id="8-Inch_Floppy_Disk"></span><span id="8-inch_floppy_disk"></span><span id="8-INCH_FLOPPY_DISK"></span>

<span id="8-Inch_Floppy_Disk"></span><span id="8-inch_floppy_disk"></span><span id="8-INCH_FLOPPY_DISK"></span>**disquete de 8 polegadas** (22)
...
Se **for true**, o dispositivo poderá ser gerenciado por energia (pode ser colocado no modo de suspensão e assim por diante). Essa propriedade não indica que os recursos de gerenciamento de energia estão habilitados no momento, apenas que o dispositivo lógico é capaz de gerenciamento de energia.
...
Indica que o gerenciamento de cotas não está habilitado (TRUE) neste sistema.
...
Indica que o gerenciamento de cota foi usado, mas foi desabilitado (**true**). Incompleto refere-se às informações deixadas no sistema de arquivos após o gerenciamento de cotas ter sido desabilitado.
...
Se **for true**, indica que o sistema de arquivos está no processo ativo de compilação de informações e configuração do disco para o gerenciamento de cotas.
...
Se **for true**, esse volume dará suporte a cotas de disco.
...
Se for **true**, a partição de disco lógico dará suporte à compactação baseada em arquivo, como é o caso com o sistema de arquivos NTFS. Essa propriedade será **falsa** quando a propriedade **compactada** for **true**.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("fsctl \_ tem \_ volume \_ sujo")
</dt> </dl>

Se **for true**, o disco exigirá que [**chkdsk**](chkdsk-method-in-class-win32-logicaldisk.md) seja executado na próxima reinicialização. Essa propriedade só é aplicável a essas instâncias de disco lógico que representam um disco físico no computador. Ele não é aplicável a unidades lógicas mapeadas.
...
Restrições: no máximo 32 caracteres.
...
A classe do disco **\_ lógico do Win32** é derivada do [**\_ LogicalDisk CIM**](cim-logicaldisk.md) que deriva do [**CIM \_ StorageExtent**](cim-storageextent.md). A classe **CIM \_ StorageExtent** é derivada do [**\_ LogicalDevice CIM**](cim-logicaldevice.md).

Uma unidade de disco físico é a base de qualquer sistema de gerenciamento de armazenamento. No entanto, após a instalação de uma unidade de disco físico, nem os usuários nem administradores de sistema normalmente lidam com o hardware diretamente. Em vez disso, os usuários e os administradores de sistema interagem com as unidades lógicas que foram criadas no disco.

Uma unidade lógica é uma subdivisão de uma partição que foi atribuída a sua própria letra de unidade. (É possível ter uma partição que não tenha sido atribuída a uma letra de unidade.) Quando você fala sobre a unidade C ou D, está se referindo a uma unidade lógica em vez de uma unidade de disco físico. Da mesma forma, ao salvar um documento na unidade E, você o está salvando na unidade lógica. Discos físicos compõem o hardware que compõe uma unidade, incluindo componentes como cabeçotes, setores e cilindros. Unidades lógicas, por outro lado, têm propriedades como espaço em disco, espaço em disco disponível e letras de unidade.

> [!Note]  
> A classe do **\_ LogicalDisk do Win32** pode ser usada apenas para enumerar as propriedades de unidades de disco locais. No entanto, você pode usar a classe [**Win32 \_ MappedLogicalDisk**](win32-mappedlogicaldisk.md) para enumerar as propriedades de unidades de rede mapeadas.

 

## <a name="examples"></a>Exemplos

Você pode encontrar outros exemplos usando **o \_ LogicalDisk do Win32** para obter dados de disco ou volume no tópico [tarefas do WMI: discos e sistemas de arquivos](/windows/desktop/WmiSdk/wmi-tasks--disks-and-file-systems) .

O exemplo de código VBScript do [recuperador de informações do WMI](https://Gallery.TechNet.Microsoft.Com/e493376c-1286-456b-bd4b-4ac3b0e9bb45) na galeria do TechNet usa a classe do disco **\_ lógico do Win32** para recuperar informações de hardware de vários computadores remotos.

[Obter informações de disco usando WMI/CIM...](https://Gallery.TechNet.Microsoft.Com/Get-Disk-info-using-wmicim-ff0bd352) O exemplo de código do PowerShell na galeria do TechNet usa o **\_ LogicalDisk do Win32** para recuperar o **DeviceID**, o **VolumeName** e o **tamanho** de um dispositivo de destino. Em particular, este exemplo inclui manipulação de exceção rigorosa e retorna um único objeto por computador, em vez de por disco.

O script corporativo geralmente envolve a configuração de hardware e software em computadores remotos; por sua vez, isso exige que você conheça, antecipadamente, o tipo de unidades de disco instaladas em um computador. Por exemplo, um script que instala um aplicativo na unidade E funciona somente se a unidade E for um disco rígido. Se a unidade E representar um disquete ou uma unidade de CD-ROM, o script falhará. O código a seguir identifica as unidades e os tipos de unidade instalados em um computador
