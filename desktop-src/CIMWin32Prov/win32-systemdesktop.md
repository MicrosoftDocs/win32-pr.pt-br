...
---
# <a name="win32_systemdesktop-class"></a>\_Classe Win32 SystemDesktop

A [classe WMI](../wmisdk/retrieving-a-class.md) de associação **\_ SystemDesktop do Win32** relaciona um sistema de computador e sua configuração de desktop.
...
A classe **Win32 \_ SystemDesktop** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Win32 \_ SystemDesktop** tem essas propriedades.
...
Referência à instância que representa o sistema de computador no qual a configuração da área de trabalho existe.
...
Qualificadores: [**override**](../wmisdk/standard-qualifiers.md) ("Setting"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("WMI \| Win32 \_ Desktop")
</dt> </dl>
...
A classe **Win32 \_ SystemDesktop** é derivada de [**Win32 \_ SystemSetting**](win32-systemsetting.md).
