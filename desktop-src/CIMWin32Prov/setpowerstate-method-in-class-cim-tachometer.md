---
description: O método SetPowerState da classe CIM Tachometer define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser \_ colocado nesse estado.
ms.assetid: 9b263049-09c2-4db0-865f-832a6b09066a
ms.tgt_platform: multiple
title: Método SetPowerState da classe CIM_Tachometer classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
