...
title: Método de redefinição da CIM_VolumeSet classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119700606"
---
# <a name="reset-method-of-the-cim_volumeset-class"></a>Método reset da classe CIM \_ VolumeSet

O **método Reset** da classe CIM [**\_ VolumeSet**](cim-volumeset.md) solicita uma redefinição do dispositivo lógico. Esse método é herdado [**de CIM \_ LogicalDevice.**](cim-logicaldevice.md)
