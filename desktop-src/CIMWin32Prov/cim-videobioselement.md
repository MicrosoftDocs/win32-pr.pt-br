...
A classe **CIM \_ VideoBIOSElement** representa o software de nível baixo que é carregado no armazenamento não volátil e usado para configurar e acessar o controlador de vídeo de um sistema de computador e exibi-lo.
...
A classe **CIM \_ VideoBIOSElement** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **CIM \_ VideoBIOSElement** tem essas propriedades.
...
Identificador do fabricante para o elemento de software, como uma SKU (unidade de manutenção de estoque) ou um número de peça.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|BIOS de vídeo DMTF \| 1,5 ")
</dt> </dl>

Se **for true**, o BIOS de vídeo será sombreado.
...
Language Edition do elemento software. Os códigos de idioma definidos no ISO 639 devem ser usados. Quando o elemento software representa uma versão multilíngue ou internacional de um produto, a cadeia de caracteres "multilíngue" deve ser usada.
...
Fabricante do elemento de software essa propriedade é herdada do [**CIM \_ softwareelement**](cim-softwareelement.md).
...
O tipo de fabricante e sistema operacional para um elemento de software quando a propriedade **TargetOperatingSystem** tem um valor de 1 ("other"). Quando a propriedade **TargetOperatingSystem** tem um valor de 1, essa propriedade deve ter um valor não nulo. Para todos os outros valores de **TargetOperatingSystem** , essa propriedade é NULL. Essa propriedade é herdada de [**CIM \_ softwareelement**](cim-softwareelement.md).
...
Identificador para o elemento de software que foi projetado para ser usado em conjunto com outras chaves para criar uma representação exclusiva da classe [**CIM \_ softwareelement**](cim-softwareelement.md) .
...
A classe **CIM \_ VideoBIOSElement** é derivada de [**CIM \_ softwareelement**](cim-softwareelement.md).
