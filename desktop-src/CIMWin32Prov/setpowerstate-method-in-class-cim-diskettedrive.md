...
O WMI não implementa essa classe. Para classes derivadas do [**CIM \_ DisketteDrive**](cim-diskettedrive.md), consulte [classes Win32](win32-provider.md).
