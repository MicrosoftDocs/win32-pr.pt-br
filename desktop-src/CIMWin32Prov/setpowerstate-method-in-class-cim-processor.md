---
description: O método SetPowerState da classe processador CIM define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser \_ colocado nesse estado.
ms.assetid: 562c49c5-b349-402a-a3f0-2d7785a2c1ae
ms.tgt_platform: multiple
title: Método SetPowerState da classe CIM_Processor classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
[Processador \_ CIM](setpowerstate-method-in-class-cim-processor.md)
</dt> <dt>
