...
title: Método Compactar da classe CIM_LogicalFile classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119020704"
---
# <a name="compress-method-of-the-cim_logicalfile-class"></a>Método Compactar da classe \_ LogicalFile CIM

O **método Compress** compacta o arquivo lógico (ou diretório) especificado no caminho do objeto.
