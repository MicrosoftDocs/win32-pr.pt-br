...
ms.locfileid: "119020594"
---
# <a name="copyex-method-of-the-win32_pagefile-class"></a>Método CopyEx da classe de \_ arquivo de paginação Win32

O método de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **CopyEx** copia o arquivo de paginação lógica ou o diretório especificado no caminho do objeto para o local especificado pelo parâmetro *filename* . Esse método é uma versão estendida do método [**Copy**](copy-method-in-class-win32-directory.md) . Não haverá suporte para uma cópia se a substituição de um arquivo lógico existente for necessária.
