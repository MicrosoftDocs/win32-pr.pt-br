...
---
# <a name="startservice-method-of-the-cim_bootservice-class"></a>Método StartService da \_ classe DS do CIM

O método **StartService** coloca o serviço em um estado de "início". Em uma subclasse, o conjunto de códigos de retorno possíveis pode ser especificado usando um qualificador **ValueMap** no método. As cadeias de caracteres nas quais o conteúdo de **ValueMap** são traduzidos também podem ser especificadas na subclasse como um qualificador de matriz de **valores** . Esse método é herdado [**do \_ serviço CIM**](cim-service.md).
...
[\_DS CIM](startservice-method-in-class-cim-bootservice.md)
</dt> <dt>
