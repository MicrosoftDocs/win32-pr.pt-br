...
---
# <a name="compress-method-of-the-win32_pagefile-class"></a>Método compress da classe de \_ arquivo de paginação Win32

O método **compactar** [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) compacta o arquivo de paginação lógica (ou diretório) especificado no caminho do objeto.
