...
A classe **CIM \_ DiskSpaceCheck** tem estes tipos de membros:
...
A classe **CIM \_ DiskSpaceCheck** tem esses métodos.



| Método                                                      | Descrição                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Chame**](invoke-method-in-class-cim-diskspacecheck.md) | Executa uma ação específica. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ DiskSpaceCheck** tem essas propriedades.
...
Qualificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ sistema de arquivos CIM**](cim-filesystem.md).**AvailableSpace** "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" quilobytes ")
</dt> </dl>
