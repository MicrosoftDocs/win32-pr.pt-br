...
\[**Win32 \_ O FloppyController** não está mais disponível para uso a partir do Windows 10 e do Windows Server 2016.\]
...
Identificador de dispositivo do Windows Plug and Play para o dispositivo lógico.
...
A classe **Win32 \_ FloppyController** é derivada do [**\_ controlador CIM**](cim-controller.md) derivado de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
