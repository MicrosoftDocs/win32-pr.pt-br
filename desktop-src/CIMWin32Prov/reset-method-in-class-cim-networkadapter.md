---
description: O método Reset da classe CIM \_ NetworkAdapter solicita uma redefinição do dispositivo lógico.
ms.assetid: ff4493b7-a9e1-4a39-a14a-05da75659d4e
ms.tgt_platform: multiple
title: Método reset da classe CIM_NetworkAdapter dados
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118418986"
---
# <a name="reset-method-of-the-cim_networkadapter-class"></a>Método reset da classe \_ NetworkAdapter cim

O **método Reset** da classe CIM \_ NetworkAdapter solicita uma redefinição do dispositivo lógico. Esse método é herdado [**de CIM \_ LogicalDevice.**](cim-logicaldevice.md)
