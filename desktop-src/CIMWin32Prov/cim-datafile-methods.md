---
description: A classe de DataFile do CIM \_ expõe os métodos a seguir.
ms.assetid: 5BCAB342-B42C-4507-AB90-0C9E79F9D863
ms.tgt_platform: multiple
title: Métodos de CIM_DataFile
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104457042"
---
# <a name="cim_datafile-methods"></a>Métodos de DataFile do CIM \_

A classe de [**\_ DataFile do CIM**](cim-datafile.md) expõe os métodos a seguir.
...
-   [**Método de cópia**](copy-method-in-class-cim-datafile.md)
...
-   [**Renomear método**](rename-method-in-class-cim-datafile.md)
...
-   [**Descompactar método**](uncompress-method-in-class-cim-datafile.md)
