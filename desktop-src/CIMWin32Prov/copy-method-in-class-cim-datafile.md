...
---
# <a name="copy-method-of-the-cim_datafile-class"></a>Método Copy da classe de \_ datafilefiles CIM

O método **Copy** copia o arquivo lógico (ou diretório) que é especificado no caminho do objeto para o local especificado pelo parâmetro de entrada. Não haverá suporte para uma cópia se ela exigir a substituição de um arquivo lógico existente. Esse método é herdado [**do \_ LogicalFile CIM**](cim-logicalfile.md).
...
O método de cópia [**no \_ arquivo**](cim-datafile.md) de **backup** CIM é implementado pelo WMI.
...
[DataFile de CIM \_](copy-method-in-class-cim-datafile.md)
</dt> <dt>
