...
---
# <a name="takeownership-method-of-the-cim_logicalfile-class"></a>Método TakeOwnerShip da classe de \_ LogicalFile CIM

O método **TakeOwnership** Obtém a propriedade do arquivo lógico especificado no caminho do objeto. Se o arquivo lógico for um diretório, esse método agirá recursivamente, assumindo a propriedade de todos os arquivos e subdiretórios contidos no diretório.
