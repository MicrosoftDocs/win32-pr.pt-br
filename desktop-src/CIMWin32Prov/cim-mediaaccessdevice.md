---
description: A classe CIM MediaAccessDevice representa a capacidade de acessar uma ou mais mídias e, em seguida, usar a mídia \_ para armazenar e recuperar dados.
ms.assetid: 224a7b08-1566-4b0b-90d8-9991fa188d93
ms.tgt_platform: multiple
title: CIM_MediaAccessDevice classe (Provedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119548226"
---
# <a name="cim_mediaaccessdevice-class-cimwin32-wmi-providers"></a>CIM_MediaAccessDevice classe (Provedores WMI CIMWin32)
...
Qualificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ MediaAccessDevice**.**Funcionalidades**")
</dt> </dl>
...
Tamanho máximo, em quilobytes, da mídia com suporte neste dispositivo. Quilobytes são interpretados como o número de bytes multiplicado por 1000 (não o número de bytes multiplicado por 1024).
...
A **classe CIM \_ MediaAccessDevice** é derivada de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

O WMI não implementa essa classe. Para classes derivadas de **CIM \_ MediaAccessDevice**, consulte [Classes Win32](win32-provider.md).
