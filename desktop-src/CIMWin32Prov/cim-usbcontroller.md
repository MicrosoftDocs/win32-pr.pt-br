---
description: A classe CIM \_ USBController representa os recursos e o gerenciamento de um controlador USB.
...
ms.locfileid: "118420972"
---
# <a name="cim_usbcontroller-class"></a>Classe CIM \_ USBController

A **classe CIM \_ USBController** representa os recursos e o gerenciamento de um controlador USB.
...
A **classe CIM \_ USBController** tem estes tipos de membros:
...
A **classe CIM \_ USBController** tem esses métodos.



| Método                                                                   | Descrição                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-usbcontroller.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbcontroller.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A **classe CIM \_ USBController** tem essas propriedades.
...
Nome do fabricante do controlador USB.
...
A classe **CIM \_ USBController** é derivada do [**\_ controlador CIM**](cim-controller.md).

O WMI não implementa essa classe. Para classes WMI derivadas do **CIM \_ USBController**, consulte [classes Win32](win32-provider.md).
