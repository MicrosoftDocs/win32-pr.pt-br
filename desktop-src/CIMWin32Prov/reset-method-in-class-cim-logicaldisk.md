...
---
# <a name="reset-method-of-the-cim_logicaldisk-class"></a>Método Reset da classe CIM \_ LogicalDisk

O método **Reset** da classe CIM \_ LogicalDisk solicita uma redefinição do dispositivo lógico. Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_LOGICALDISK CIM](reset-method-in-class-cim-logicaldisk.md)
</dt> <dt>
