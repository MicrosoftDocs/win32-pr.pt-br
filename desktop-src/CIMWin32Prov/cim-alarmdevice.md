...
---
# <a name="cim_alarmdevice-class"></a>\_Classe CIM AlarmDevice

A classe **CIM \_ AlarmDevice** é um dispositivo de alarme que emite indicações audíveis ou visíveis relacionadas a uma situação de problema.
...
A classe **CIM \_ AlarmDevice** tem estes tipos de membros:
...
A classe **CIM \_ AlarmDevice** tem esses métodos.



| Método                                                                 | Descrição                                                                                                                             |
|:-----------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-alarmdevice.md)                 | Solicita uma redefinição de dispositivo lógico. Não implementado pelo WMI.<br/>                                                                     |
| [**SetPowerState**](setpowerstate-method-in-class-cim-alarmdevice.md) | Define o estado de energia desejado para um dispositivo lógico e quando o dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
| [**Seturgência**](seturgency-method-in-class-cim-alarmdevice.md)       | Define o nível de urgência desejado para o alarme. Não implementado pelo WMI.<br/>                                                        |
...
A classe **CIM \_ AlarmDevice** tem essas propriedades.
...
Se for **true**, o alarme será audível.
...
Valor enumerado que indica a frequência relativa na qual o alarme pisca, vibra ou emite tons audíveis.
...
<span id="Non-Critical"></span><span id="non-critical"></span><span id="NON-CRITICAL"></span>**Não crítico** (4)
...
<span id="Unrecoverable"></span><span id="unrecoverable"></span><span id="UNRECOVERABLE"></span>**Irrecuperável** (6)
...
Se for **true**, o alarme ficará visível.

</dd> </dl>

## <a name="remarks"></a>Comentários

A classe **CIM \_ AlarmDevice** é derivada do [**\_ LogicalDevice CIM**](cim-logicaldevice.md).
