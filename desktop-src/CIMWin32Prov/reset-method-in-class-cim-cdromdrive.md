...
---
# <a name="reset-method-of-the-cim_cdromdrive-class"></a>Método Reset da classe CIM \_ CDROMDrive

O método **Reset** da classe CIM \_ CDROMDrive solicita uma redefinição do dispositivo lógico. Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
