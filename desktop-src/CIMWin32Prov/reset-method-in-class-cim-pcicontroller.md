...
title: Método reset da classe CIM_PCIController dados
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119701526"
---
# <a name="reset-method-of-the-cim_pcicontroller-class"></a>Método reset da classe CIM \_ PCIController

O **método Reset** da classe CIM \_ PCIController solicita uma redefinição do dispositivo lógico. Esse método é herdado [**de CIM \_ LogicalDevice.**](cim-logicaldevice.md)
