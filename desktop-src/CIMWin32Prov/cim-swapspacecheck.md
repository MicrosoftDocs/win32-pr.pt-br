...
ms.locfileid: "119919116"
---
# <a name="cim_swapspacecheck-class"></a>\_Classe CIM SwapSpaceCheck

A classe **CIM \_ SwapSpaceCheck** especifica a quantidade de espaço de permuta que deve estar disponível no sistema. O valor é especificado na propriedade **SwapSpaceSize** . Os detalhes dessa verificação são comparados com os detalhes correspondentes encontrados em um objeto de sistema [**\_ operacional CIM**](cim-operatingsystem.md) referenciado pela Associação [**\_ InstalledOS**](cim-installedos.md) do CIM para o objeto de [**\_ ComputerSystem do CIM**](cim-computersystem.md) que descreve o ambiente. Quando o valor da propriedade **TotalSwapSpaceSize** for maior ou igual ao valor especificado na propriedade **SwapSpaceSize** , a condição será satisfeita.
...
A classe **CIM \_ SwapSpaceCheck** tem estes tipos de membros:
...
A classe **CIM \_ SwapSpaceCheck** tem esses métodos.



| Método                                                      | Descrição                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-swapspacecheck.md) | Executa uma ação específica. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ SwapSpaceCheck** tem essas propriedades.
...
Qualificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**sistema \_ operacional CIM**](cim-operatingsystem.md).**TotalSwapSpaceSize**"), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" quilobytes ")
</dt> </dl>

Tamanho mínimo de espaço de permuta, em kilobytes, que deve estar disponível no sistema de destino.
