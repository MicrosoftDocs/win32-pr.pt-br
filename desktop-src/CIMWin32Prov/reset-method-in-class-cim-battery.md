...
ms.locfileid: "120085816"
---
# <a name="reset-method-of-the-cim_battery-class"></a>Método Reset da \_ classe da bateria CIM

O método **Reset** da classe de \_ bateria CIM solicita uma redefinição do dispositivo lógico. Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_Bateria CIM](reset-method-in-class-cim-battery.md)
</dt> <dt>
