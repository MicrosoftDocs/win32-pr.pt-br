...
O método **uncompactar** descompacta o arquivo de dados lógicos (ou diretório) especificado no caminho do objeto. Esse método é herdado [**do \_ LogicalFile CIM**](cim-logicalfile.md).
...
O método **descompactar** no [**\_ arquivo**](cim-datafile.md) de consulta CIM é implementado pelo WMI.
...
[**DataFile de CIM \_**](uncompress-method-in-class-cim-datafile.md)
</dt> <dt>
