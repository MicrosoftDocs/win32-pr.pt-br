...
---
# <a name="win32_motherboarddevice-class"></a>\_Classe Win32 MotherboardDevice

A [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ MotherboardDevice do Win32** representa um dispositivo que contém os componentes centrais do sistema de computador Windows.
...
A classe **Win32 \_ MotherboardDevice** tem estes tipos de membros:
...
A classe **Win32 \_ MotherboardDevice** tem esses métodos.
...
A classe **Win32 \_ MotherboardDevice** tem essas propriedades.
...
Identificador exclusivo desta placa-mãe.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ local \_ Machine descrição de hardware do computador, \\ \\ \\ \\ identificador de \\ \\ MultifunctionAdapter do sistema \\ \\ \| ")
</dt> </dl>

Tipo de barramento primário da placa-mãe.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ local \_ Machine \\ \\ hardware \\ \\ Descrição \\ \\ System")
</dt> </dl>

Número de revisão da placa-mãe.
...
Tipo de barramento secundário da placa-mãe.
...
A classe **Win32 \_ MotherboardDevice** é derivada do [**\_ LogicalDevice CIM**](cim-logicaldevice.md).

## <a name="examples"></a>Exemplos

Os exemplos de código do [JavaScript](https://Gallery.TechNet.Microsoft.Com/05bbadf8-1356-43a6-82fc-fcab40233fe5) e do [PowerShell](https://Gallery.TechNet.Microsoft.Com/cb520044-836e-425c-8c12-a9586d1c0e6e) a seguir recuperam informações da motherboard.

O exemplo de código VBScript a seguir recupera informações da motherboard.
