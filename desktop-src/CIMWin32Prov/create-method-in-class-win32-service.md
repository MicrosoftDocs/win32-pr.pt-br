...
---
# <a name="create-method-of-the-win32_service-class-cimwin32-wmi-providers"></a>Método Create da classe Win32_Service (provedores WMI CIMWin32)
...
O código de controle solicitado não pode ser enviado ao serviço porque o estado do serviço (propriedade **State** da classe [**Win32 \_ BaseService**](win32-baseservice.md) ) é igual a 0, 1 ou 2.
