...
A **classe \_ fileaction do CIM** permite que o autor Localize arquivos que já existem no computador de um usuário e, em seguida, mova ou copie esses arquivos para um novo local.
...
A **classe \_ fileaction do CIM** tem estes tipos de membros:
...
A **classe \_ Fileaction do CIM** tem esses métodos.
...
A **classe \_ Fileaction do CIM** tem essas propriedades.
...
O WMI não implementa essa classe. Para classes derivadas de **\_ fileaction de CIM**, consulte [classes Win32](win32-provider.md).
