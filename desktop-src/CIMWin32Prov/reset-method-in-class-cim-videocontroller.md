...
---
# <a name="reset-method-of-the-cim_videocontroller-class"></a>Método Reset da classe CIM \_ VideoController

O método **Reset** da classe CIM \_ VideoController solicita uma redefinição do dispositivo lógico. Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
