...
ms.locfileid: "118678640"
---
# <a name="cim_pcvideocontroller-class"></a>\_Classe CIM PCVideoController

O **\_ PCVideoController CIM** representa os recursos e o gerenciamento de um controlador de vídeo de computador pessoal, um subtipo de um controlador de vídeo.
...
A classe **CIM \_ PCVideoController** tem estes tipos de membros:
...
A classe **CIM \_ PCVideoController** tem esses métodos.



| Método                                                                       | Descrição                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Definido**](reset-method-in-class-cim-pcvideocontroller.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcvideocontroller.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ PCVideoController** tem essas propriedades.
...
Qualificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Gráficos e recursos 3-D do controlador de vídeo.
...
Qualificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("indexado"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ([**" \_ CIM VideoController**](cim-videocontroller.md).**AcceleratorCapabilities**")
</dt> </dl>

Cadeias de caracteres de forma livre que fornecem explicações detalhadas para os recursos do acelerador de vídeo indicados na matriz **AcceleratorCapabilities** .

> [!Note]  
> Cada entrada de matriz está relacionada à entrada na matriz **AcceleratorCapabilities** que está localizada no mesmo índice.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,12 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" bits ")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,11 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" pixels ")
</dt> </dl>
...
Número de cores com suporte nas resoluções atuais.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,14 ")
</dt> </dl>

Se estiver no modo de caractere, número de colunas para o controlador de vídeo; caso contrário, insira 0.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,13 ")
</dt> </dl>

Se estiver no modo de caractere, número de linhas para este controlador de vídeo; caso contrário, insira 0.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,15 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,8 ")
</dt> </dl>

Modo de verificação atual. Essa propriedade é herdada do [**CIM \_ VideoController**](cim-videocontroller.md).
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,10 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" pixels ")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Porta do barramento DMTF \| 1,9 ")
</dt> </dl>

Número máximo de entidades diretamente endereçáveis com suporte pelo controlador. Um valor de 0 deve ser usado se o número for desconhecido ou ilimitado.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,5 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,4 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>
...
Número atual de planos de cores. Se esse valor não for aplicável para a configuração de vídeo atual, insira 0.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Porta do barramento DMTF \| 1,2 "," MIF. \|Discos DMTF \| 3,3 ")
</dt> </dl>

Protocolo usado pelo controlador para acessar os dispositivos ' controlados '.

Essa propriedade é herdada [**do \_ controlador CIM**](cim-controller.md). Os valores são:
...
Data e hora da última redefinição deste controlador, o que significa que o controlador foi desligado ou reinicializado.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,2 ")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vídeo DMTF \| 3,6 ")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.3")
</dt> </dl>
...
Cadeia de caracteres de forma livre que descreve o processador/controlador de vídeo.

Essa propriedade é herdada do [**\_ VideoController cim.**](cim-videocontroller.md)

</dd> </dl>

## <a name="remarks"></a>Comentários

A **classe CIM \_ PCVideoController** é derivada de [**CIM \_ VideoController.**](cim-videocontroller.md)

O WMI não implementa essa classe. Para classes WMI derivadas de [**\_ PCVideoController CIM**](cim-videocontroller.md), consulte [Classes Win32](win32-provider.md).
