...
---
# <a name="cim_usbhub-class"></a>\_Classe CIM USBHub
...
| Método                                                            | Descrição                                                                                                                              |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Getdescriptor**](getdescriptor-method-in-class-cim-usbhub.md) | Retorna o descritor de dispositivo USB. Não implementado pelo WMI.<br/>                                                                    |
...
Configuração selecionada no momento para o dispositivo. Se esse valor for 0 (zero), o dispositivo não será configurado.
...
Se **for true**, a energia será alternada para todas as portas no Hub simultaneamente. Se for **false**, a energia será alternada individualmente para cada porta.
