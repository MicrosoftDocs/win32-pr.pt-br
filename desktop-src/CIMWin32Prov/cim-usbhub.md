---
description: A classe CIM \_ USBHub representa os recursos e o gerenciamento de um hub USB.
ms.assetid: 33618963-3053-4c01-992e-aa6d9774f84b
ms.tgt_platform: multiple
title: CIM_USBHub classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
api_location:
- CIMWin32.dll
ms.openlocfilehash: e93173f7f7d7960e25bb8ccc7d78419db6fdcf09a0e3cdfd316ebd760804c7a5
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 08/11/2021
ms.locfileid: "119080290"
---
# <a name="cim_usbhub-class"></a>Classe CIM \_ USBHub

A **classe CIM \_ USBHub** representa os recursos e o gerenciamento de um hub USB.
...
A **classe CIM \_ USBHub** tem estes tipos de membros:
...
A **classe CIM \_ USBHub** tem esses métodos.



| Método                                                            | Descrição                                                                                                                              |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**GetDescriptor**](getdescriptor-method-in-class-cim-usbhub.md) | Retorna o descritor do dispositivo USB. Não implementado pelo WMI.<br/>                                                                    |
| [**Redefinir**](reset-method-in-class-cim-usbhub.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbhub.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A **classe CIM \_ USBHub** tem essas propriedades.
...
Código de classe USB.

Essa propriedade é herdada [**de CIM \_ USBDevice**](cim-usbdevice.md).
...
Qualificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ UsbDevice**](cim-usbdevice.md).**CurrentConfigValue**")
</dt> </dl>

Configurações de USB alternativas para cada interface na configuração selecionada no momento (indicada pela propriedade **CurrentConfigValue** ). Essa matriz tem uma entrada para cada interface na configuração. Se a **propriedade CurrentConfigValue** tiver um valor de 0 (zero), que indica que o dispositivo não está configurado, a matriz será indefinida. Para obter mais informações sobre como analisar essa cadeia de caracteres de octeto, consulte a especificação USB.
...
Qualificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ USBDevice**](cim-usbdevice.md).**CurrentAlternateSettings**")
</dt> </dl>

Configuração atualmente selecionada para o dispositivo. Se esse valor for 0 (zero), o dispositivo será desconfigurado.
...
Se **TRUE**, a energia será alternada para todas as portas no hub simultaneamente. Se **FALSE**, a energia será alternada individualmente para cada porta.
...
Número de configurações de dispositivo definidas para o dispositivo.
...
Número de portas downstream no hub, incluindo aquelas inseridas no silício do hub.
...
Win32 Plug and Play identificador de dispositivo lógico do dispositivo lógico.
...
Essa propriedade é herdada do [**CIM \_ UsbDevice**](cim-usbdevice.md).
...
Versão USB mais recente com suporte do dispositivo USB. Essa propriedade é expressa como um decimal codificado em binário (BCD), em que um ponto decimal é implícito entre o segundo e o terceiro dígitos. Por exemplo, um valor de 0x201 indica que a versão 2, 1 tem suporte.
...
A classe **CIM \_ USBHub** é derivada do [**CIM \_ UsbDevice**](cim-usbdevice.md).

O WMI não implementa essa classe. Para classes WMI derivadas de **CIM \_ USBHub**, consulte [classes Win32](win32-provider.md).
