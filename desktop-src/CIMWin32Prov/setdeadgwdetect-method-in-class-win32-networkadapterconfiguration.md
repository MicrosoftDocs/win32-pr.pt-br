...
ms.locfileid: "119760076"
---
# <a name="setdeadgwdetect-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetDeadGWDetect da classe Win32 \_ NetworkAdapterConfiguration

O método estático da [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetDeadGWDetect** é usado para habilitar a detecção de gateway inativo.
...
*DeadGWDetectEnabled* \[ no\]
</dt> <dd>

Se **for true**, a detecção de gateways inativos deverá ser habilitada.
...
Com esse recurso habilitado, o TCP solicita que o IP mude para um gateway de backup se ele retransmitir um segmento várias vezes sem receber uma resposta.

## <a name="examples"></a>Exemplos

A amostra [habilitar a detecção de gateway inativo para todos os adaptadores de rede do](https://Gallery.TechNet.Microsoft.Com/4a24b080-1a8b-4085-9419-58d096ef8437) VBScript na galeria do TechNet usa **SetDeadGWDetect** para configurar todos os adaptadores de rede em um computador para detectar automaticamente gateways inativos.
