...
---
# <a name="geteffectivepermission-method-of-the-win32_shortcutfile-class"></a>Método GetEffectivePermission da \_ classe shortcutfile do Win32

O método de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **GetEffectivePermission** determina se o usuário tem todas as permissões necessárias especificadas no parâmetro *Permissions* para o objeto File, o diretório e o compartilhamento onde o arquivo de atalho está localizado, se o arquivo ou diretório estiver em um compartilhamento.
