---
description: A classe \_ FlatPanel CIM representa os recursos e o gerenciamento do dispositivo lógico de painel simples.
...
ms.locfileid: "119320926"
---
# <a name="cim_flatpanel-class"></a>Classe Cim \_ FlatPanel

A **classe \_ FlatPanel CIM** representa os recursos e o gerenciamento do dispositivo lógico de painel simples.
...
A **classe Cim \_ FlatPanel** tem estes tipos de membros:
...
A **classe \_ FlatPanel cim** tem esses métodos.



| Método                                                               | Descrição                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-flatpanel.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-flatpanel.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A **classe \_ FlatPanel CIM** tem essas propriedades.
...
Enumeração que descreve o tipo de exibição de tela plana.
...
<span id="Passive_Matrix_LCD"></span><span id="passive_matrix_lcd"></span><span id="PASSIVE_MATRIX_LCD"></span>**LCD de matriz passiva** (2)
...
<span id="Active_Matrix_LCD"></span><span id="active_matrix_lcd"></span><span id="ACTIVE_MATRIX_LCD"></span>**LCD de matriz ativa** (3)
...
<span id="Field_Emission_Display"></span><span id="field_emission_display"></span><span id="FIELD_EMISSION_DISPLAY"></span>**Exibição de emissão de campo** (5)
...
<span id="Electro_Luminescent_Display"></span><span id="electro_luminescent_display"></span><span id="ELECTRO_LUMINESCENT_DISPLAY"></span>**Tela de luminescent de eletromagnético** (6)


</dt> <dd>

Luminescent de eletromagnético

</dd> <dt>

<span id="Gas_Plasma"></span><span id="gas_plasma"></span><span id="GAS_PLASMA"></span>

<span id="Gas_Plasma"></span><span id="gas_plasma"></span><span id="GAS_PLASMA"></span>**Plasma de gás** (7)
...
Qualificadores: [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("pixels")
</dt> </dl>
...
Descrição do tipo de iluminação de exibição.
...
Modo de verificação que indica verificação única ou dupla, por exemplo.
...
Se **TRUE**, o painel simples dá suporte à exibição de cores.
...
A **classe \_ FlatPanel CIM** é derivada da [**exibição CIM. \_**](cim-display.md)
