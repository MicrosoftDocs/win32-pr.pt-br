...
---
# <a name="reset-method-of-the-cim_temperaturesensor-class"></a>Método Reset da classe CIM \_ sensor

O método **Reset** da classe CIM \_ sensor solicita uma redefinição do dispositivo lógico. Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[\_Sensor CIM](reset-method-in-class-cim-temperaturesensor.md)
</dt> <dt>
