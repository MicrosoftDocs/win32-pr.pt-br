...
A **classe \_ UserDevice cim** é derivada de CIM [**\_ LogicalDevice**](cim-logicaldevice.md).

O WMI não implementa essa classe. Para classes WMI derivadas de **Cim \_ UserDevice**, consulte [Classes Win32](win32-provider.md).
