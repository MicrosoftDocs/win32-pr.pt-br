...
A classe de **\_ Userdevice do CIM** é derivada do [**\_ LogicalDevice CIM**](cim-logicaldevice.md).

O WMI não implementa essa classe. Para classes WMI derivadas de **\_ userdevice do CIM**, consulte [classes Win32](win32-provider.md).
