...
---
# <a name="reboot-method-of-the-cim_operatingsystem-class"></a>Método reboot da \_ classe CIM OperatingSystem

O método **reboot** solicita uma reinicialização do sistema operacional.
...
Para classes WMI que são derivadas do [**sistema \_ operacional CIM**](cim-operatingsystem.md), consulte [classes Win32](win32-provider.md).
...
[Sistema \_ operacional CIM](reboot-method-in-class-cim-operatingsystem.md)
</dt> <dt>
