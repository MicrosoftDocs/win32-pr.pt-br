...
---
# <a name="geteffectivepermission-method-of-the-cim_logicalfile-class"></a>Método GetEffectivePermission da classe de \_ LogicalFile CIM

O método **GetEffectivePermission** determina se o chamador tem as permissões agregadas no objeto [**\_ LogicalFile do CIM**](cim-logicalfile.md) e o compartilhamento no qual reside o arquivo ou diretório, conforme especificado pelo argumento *Permissions* .
