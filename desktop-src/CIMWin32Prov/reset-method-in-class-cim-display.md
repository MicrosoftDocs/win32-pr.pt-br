...
O método **Reset** da classe de \_ exibição CIM solicita uma redefinição do dispositivo lógico. Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
...
[Exibição de CIM \_](reset-method-in-class-cim-display.md)
</dt> <dt>
