...
A classe **CIM \_ BinarySensor** tem estes tipos de membros:
...
A classe **CIM \_ BinarySensor** tem esses métodos.



| Método                                                                  | Descrição                                                                                                                                |
|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Definido**](reset-method-in-class-cim-binarysensor.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-binarysensor.md) | Define o estado de energia desejado para um dispositivo lógico e quando o dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ BinarySensor** tem essas propriedades.
...
Descrição de um valor ' false ' do sensor binário. Essas informações podem ser exibidas para um usuário.
...
Descrição de um valor ' true ' do sensor binário. Essas informações podem ser exibidas para um usuário.
...
A **classe \_ BINARySensor CIM** é derivada do [**\_ Sensor CIM.**](cim-sensor.md)
