...
---
# <a name="cim_systemresource-class"></a>\_Classe CIM SystemResource

A classe **CIM \_ SystemResource** representa uma entidade gerenciada pelo BIOS ou um sistema operacional que está disponível para uso por software e dispositivos lógicos.
...
O WMI não implementa essa classe. Para classes WMI derivadas do **CIM \_ SystemResource**, consulte [classes Win32](win32-provider.md).
