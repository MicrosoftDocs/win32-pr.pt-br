---
description: A classe CIM WORMDrive representa os recursos e o gerenciamento de uma \_ unidade WORM, um subtipo do dispositivo de acesso à mídia.
...
ms.locfileid: "119505426"
---
# <a name="cim_wormdrive-class"></a>Classe CIM \_ WORMDrive

A **classe CIM \_ WORMDrive** representa os recursos e o gerenciamento de uma unidade WORM, um subtipo do dispositivo de acesso à mídia.
...
A **classe CIM \_ WORMDrive** tem estes tipos de membros:
...
A **classe CIM \_ WORMDrive** tem esses métodos.



| Método                                                               | Descrição                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-wormdrive.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-wormdrive.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A **classe CIM \_ WORMDrive** tem essas propriedades.
...
Cadeias de caracteres de forma livre que fornecem descrições detalhadas para os recursos de dispositivo de acesso indicados na matriz **Recursos.**
...
Tamanho máximo, em quilobytes, da mídia com suporte do dispositivo. Quilobytes são interpretados como o número de bytes multiplicado por 1000 (não o número de bytes multiplicado por 1024).
...
Se **TRUE**, o dispositivo de acesso à mídia precisará ser limpo. Se a limpeza manual ou automática é possível é indicada na **propriedade Matriz de** funcionalidades.
...
Quando o dispositivo de acesso à mídia dá suporte a várias mídias individuais, essa propriedade define o número máximo que pode ser compatível ou inserido.
...
A **classe CIM \_ WORMDrive** é derivada de [**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).
