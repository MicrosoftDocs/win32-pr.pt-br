...
ms.locfileid: "119919176"
---
# <a name="cim_storageextent-class-cimwin32-wmi-providers"></a>Classe CIM_StorageExtent (provedores WMI CIMWin32)

A classe **CIM \_ StorageExtent** representa os recursos e o gerenciamento de várias mídias que existem para armazenar dados e permitir a recuperação de dados. Essa classe pai pode representar os vários componentes de RAID (hardware ou software) ou uma extensão lógica bruta na parte superior da mídia física.
...
A classe **CIM \_ StorageExtent** tem esses métodos.



| Método                                                                   | Descrição                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Definido**](reset-method-in-class-cim-storageextent.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-storageextent.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ StorageExtent** é derivada do [**\_ LogicalDevice CIM**](cim-logicaldevice.md).

O WMI não implementa essa classe. Para classes WMI derivadas do **CIM \_ StorageExtent**, consulte [classes Win32](win32-provider.md).
