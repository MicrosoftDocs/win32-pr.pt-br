---
description: O método SetPowerState da classe CIM UninterruptiblePowerSupply define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser \_ colocado nesse estado.
ms.assetid: 305987cb-930a-4b60-86f3-f94927fb59c4
ms.tgt_platform: multiple
title: Método SetPowerState da classe CIM_UninterruptiblePowerSupply classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
