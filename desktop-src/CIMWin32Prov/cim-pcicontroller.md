...
---
# <a name="cim_pcicontroller-class"></a>\_Classe CIM PCIController

A classe **CIM \_ PCIController** representa as propriedades e o gerenciamento de um controlador PCI. As propriedades nessa classe e suas subclasses são definidas nas várias especificações de PCI publicadas pelo SIG de PCI.
...
Disponibilidade e status do dispositivo. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](cim-logicaldevice.md).
...
O dispositivo não está funcionando, mas pode ser levado para a potência completa ' rapidamente '.
...
A classe **CIM \_ PCIController** é derivada do [**\_ controlador CIM**](cim-controller.md).
