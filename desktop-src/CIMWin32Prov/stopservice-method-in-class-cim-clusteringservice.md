...
---
# <a name="stopservice-method-of-the-cim_clusteringservice-class"></a>Método StopService da \_ classe ClusteringService do CIM

O método **StopService** interrompe o serviço representado pelo objeto derivado de [**CIM \_ ClusteringService**](cim-clusteringservice.md). Esse método é herdado [**do \_ serviço CIM**](cim-service.md).
