...
---
# <a name="cim_logicaldisk-class-cimwin32-wmi-providers"></a>Classe CIM_LogicalDisk (provedores WMI CIMWin32)

A classe de **\_ LogicalDisk CIM** representa um intervalo contíguo de blocos lógicos que é identificável por um sistema de arquivos por meio do campo **DeviceID** (chave) do disco. Por exemplo, em um ambiente do Windows, o campo **DeviceID** contém uma letra da unidade; em um ambiente UNIX, ele contém o caminho de acesso; e em um ambiente do NetWare, ele contém o nome do volume.
...
A classe **CIM \_ LogicalDisk** tem esses métodos.
...
Descreve se a mídia é legível, gravável ou ambas, por exemplo. Essa propriedade é herdada do [**CIM \_ StorageExtent**](cim-storageextent.md).
...
A classe do **\_ LogicalDisk CIM** é derivada do [**CIM \_ StorageExtent**](cim-storageextent.md).

O WMI não implementa essa classe. Para classes derivadas do **\_ LogicalDisk CIM**, consulte [classes Win32](win32-provider.md).
