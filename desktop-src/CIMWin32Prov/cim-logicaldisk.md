---
description: A classe LogicalDisk cim representa um intervalo contíguo de blocos lógicos que é identificável por um sistema de arquivos por meio do campo \_ DeviceID (chave) do disco.
ms.assetid: 1c2fd0bf-a1e3-4706-9f84-5dd4d371a167
ms.tgt_platform: multiple
title: CIM_LogicalDisk classe (Provedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119923341"
---
# <a name="cim_logicaldisk-class-cimwin32-wmi-providers"></a>CIM_LogicalDisk classe (Provedores WMI CIMWin32)

A **classe \_ LogicalDisk cim** representa um intervalo contíguo de blocos lógicos que é identificável por um sistema de arquivos por meio do campo **DeviceID** (chave) do disco. Por exemplo, em um ambiente Windows, o **campo DeviceID** contém uma letra da unidade; em um UNIX, ele contém o caminho de acesso; e em um ambiente do NetWare, ele contém o nome do volume.
...
A **classe \_ LogicalDisk cim** tem estes tipos de membros:
...
A **classe \_ LogicalDisk cim** tem esses métodos.



| Método                                                                 | Descrição                                                                                                                              |
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-logicaldisk.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-logicaldisk.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A **classe \_ LogicalDisk cim** tem essas propriedades.
...
Descreve se a mídia é acessível, pode ser escrita ou ambas, por exemplo. Essa propriedade é herdada de [**Cim \_ StorageExtent.**](cim-storageextent.md)
...
Com suporte para leitura/gravação.
...
Espaço livre disponível, em bytes, no disco lógico.
...
Número total de blocos consecutivos, cada um bloqueia o tamanho do valor contido na propriedade **BlockSize,** que formam a extensão de armazenamento. O tamanho total da extensão de armazenamento pode ser calculado multiplicando o valor da propriedade **BlockSize** pelo valor dessa propriedade. Se o valor da **propriedade BlockSize** for 1, essa propriedade será o tamanho total da extensão de armazenamento.
...
Tamanho do disco lógico, em bytes.
...
A **classe \_ LogicalDisk cim** é derivada de CIM [**\_ StorageExtent.**](cim-storageextent.md)

O WMI não implementa essa classe. Para classes derivadas de **\_ LOGICALDisk cim**, consulte [Classes Win32](win32-provider.md).
