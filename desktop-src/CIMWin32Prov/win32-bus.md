---
description: a \_ classe WMI de barramento Win32 representa um barramento físico como visto por um computador que executa um sistema operacional Windows. qualquer instância de um barramento de Windows é um descendente (ou membro) dessa classe.
...
ms.locfileid: "119020314"
---
# <a name="win32_bus-class"></a>\_Classe de barramento Win32

a [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) de **\_ barramento Win32** representa um barramento físico como visto por um computador que executa um sistema operacional Windows. qualquer instância de um barramento de Windows é um descendente (ou membro) dessa classe.
...
A classe de **\_ barramento Win32** tem estes tipos de membros:
...
A classe de **\_ barramento Win32** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                                      |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**\_ LogicalDevice CIM**](cim-logicaldevice.md) para obter a documentação.<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**\_ LogicalDevice CIM**](cim-logicaldevice.md) para obter a documentação.<br/> |
...
A classe de **\_ barramento Win32** tem essas propriedades.
...
Número lógico atribuído ao barramento físico.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api \| cHwRes \| interface \_ Type")
</dt> </dl>

Tipo do barramento físico. Esse valor será um dos valores na enumeração de **\_ tipo de interface** definida em Bus. h.
...
**Barramento de energia interno** (13)
...
Nome exclusivo que identifica o barramento.
...
A **classe de \_ Barramento Win32** é derivada de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
