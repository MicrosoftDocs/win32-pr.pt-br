...
ms.locfileid: "120064816"
---
# <a name="invoke-method-of-the-cim_removefileaction-class"></a>Método Invoke da classe CIM \_ Removeaction

O método **Invoke** da classe [**CIM \_ removeaction**](cim-removefileaction.md) usa uma ação específica. Os detalhes de como o método executa a ação são específicos da implementação. Esse método é herdado [**da \_ ação CIM**](cim-action.md).
...
[\_RemoveFile CIM](invoke-method-in-class-cim-removefileaction.md)
</dt> <dt>
