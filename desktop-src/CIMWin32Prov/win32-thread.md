...
Processo que criou o thread. O conteúdo dessa propriedade pode ser usado pelos elementos da API (interface de programação de aplicativo) do Windows.
...
1.  Conecte-se à classe de [**\_ processo do Win32**](win32-process.md) e retorne a lista de processos e suas IDs de processo.
