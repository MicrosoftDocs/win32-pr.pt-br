---
description: Representa uma unidade CD-ROM em um sistema de computador executando Windows.
...
ms.locfileid: "118418247"
---
# <a name="win32_cdromdrive-class"></a>Classe WIN32 \_ CDROMDrive

A classe [WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Win32 CDROMDrive** representa uma unidade CD-ROM em um sistema de computador executando Windows.

> [!Note]  
> Esteja ciente de que o nome da unidade não corresponde à letra da unidade lógica atribuída ao dispositivo.
...
A **classe WIN32 \_ CDROMDrive** tem estes tipos de membros:
...
A **classe \_ WIN32 CDROMDrive** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                                |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**CIM \_ CDROMDrive para**](cim-cdromdrive.md) documentação.<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o [**método SetPowerState**](setpowerstate-method-in-class-cim-controller.md) em [**CIM \_ CDROMDrive para**](cim-cdromdrive.md) documentação.<br/> |
...
A **classe \_ CDROMDrive win32** tem essas propriedades.
...
Qualificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexado"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Armazenamento \| Dispositivos 001.9", "MIF. DMTF \| Armazenamento \| Dispositivos 001.11", "MIF. DMTF \| Armazenamento \| Dispositivos 001.12", "MIF. DMTF \| Disks \| 003.7"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**CapabilityDescriptions**")
</dt> </dl>

Matriz de funcionalidades do dispositivo de acesso à mídia. Por exemplo, o dispositivo pode dar suporte a acesso aleatório (3), mídia removível (7) e limpeza automática (9).
...
<span id="Supports_Writing"></span><span id="supports_writing"></span><span id="SUPPORTS_WRITING"></span>**Dá suporte à escrita** (4)
...
<span id="Supports_Removeable_Media"></span><span id="supports_removeable_media"></span><span id="SUPPORTS_REMOVEABLE_MEDIA"></span>**Dá suporte à mídia removêvel** (7)


</dt> <dd>

Dá suporte à mídia removível
...
<span id="Supports_Dual_Sided_Media"></span><span id="supports_dual_sided_media"></span><span id="SUPPORTS_DUAL_SIDED_MEDIA"></span>**Dá suporte à mídia de lado duplo** (11)


</dt> <dd>

Dá suporte Dual-Sided mídia

</dd> <dt>

<span id="Predismount_Eject_Not_Required"></span><span id="predismount_eject_not_required"></span><span id="PREDISMOUNT_EJECT_NOT_REQUIRED"></span>

<span id="Predismount_Eject_Not_Required"></span><span id="predismount_eject_not_required"></span><span id="PREDISMOUNT_EJECT_NOT_REQUIRED"></span>**Ejetar predismount não necessário** (12)
...
Qualificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**Funcionalidades**")
</dt> </dl>

Matriz de explicações mais detalhadas para qualquer um dos recursos de dispositivo de acesso indicados na matriz **Recursos.** Cada entrada dessa matriz está relacionada à entrada na matriz **Recursos** que está localizada no mesmo índice.
...
Algoritmo ou ferramenta usada pelo dispositivo para dar suporte à compactação. Se não for possível ou não desejar descrever o esquema de compactação (talvez porque ele não seja conhecido), use as seguintes palavras: "Desconhecido" para representar que não se sabe se o dispositivo dá suporte a recursos de compactação; "Compactado" para representar que o dispositivo dá suporte a recursos de compactação, mas seu esquema de compactação não é conhecido ou não é divulgado; e "Não Compactado" para representar que o dispositivo não dá suporte a recursos de compactação.
...
Tamanho de bloco padrão, em bytes, para este dispositivo.
...
Qualificadores: [**Key**](/windows/desktop/WmiSdk/key-qualifier), [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("DeviceID"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api \| File Functions \| GetLogicalDriveStrings")
</dt> </dl>

Identificador exclusivo de uma unidade de CD-ROM.
...
Se **for true**, os arquivos poderão ser lidos com precisão do dispositivo de CD. Isso é feito lendo um bloco de dados duas vezes e comparando os dados contra si mesmo.
...
Tipo de detecção de erros e correção com suporte neste dispositivo.
...
Qualificadores: [**preterido**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api de \| funções do sistema de arquivos \| [**GetVolumeInformation**](/windows/desktop/api/fileapi/nf-fileapi-getvolumeinformationa)")
</dt> </dl>

Esta propriedade está obsoleta. No lugar dessa propriedade, use **FileSystemFlagsEx**.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api de \| funções do sistema de arquivos \| [**GetVolumeInformation**](/windows/desktop/api/fileapi/nf-fileapi-getvolumeinformationa)")
</dt> </dl>

sinalizadores do sistema de arquivos associados à unidade de CD-ROM Windows. Esse parâmetro pode ser qualquer combinação de sinalizadores, mas **a \_ \_ compactação de arquivo FS** e o Vol. de **FS são \_ \_ \_ compactados** são mutuamente exclusivos.

<dt>

<span id="Case_Sensitive_Search"></span><span id="case_sensitive_search"></span><span id="CASE_SENSITIVE_SEARCH"></span>

<span id="Case_Sensitive_Search"></span><span id="case_sensitive_search"></span><span id="CASE_SENSITIVE_SEARCH"></span>**Pesquisa com distinção de maiúsculas e minúsculas** (1)


</dt> <dd>

O sistema de arquivos dá suporte a nomes de arquivos que diferenciam maiúsculas de minúsculas

</dd> <dt>

<span id="Case_Preserved_Names"></span><span id="case_preserved_names"></span><span id="CASE_PRESERVED_NAMES"></span>

<span id="Case_Preserved_Names"></span><span id="case_preserved_names"></span><span id="CASE_PRESERVED_NAMES"></span>**Nomes preservados de caso** (2)


</dt> <dd>

O sistema de arquivos preserva o caso de nomes de arquivo quando ele coloca um nome em um disco.

</dd> <dt>

<span id="Unicode_On_Disk"></span><span id="unicode_on_disk"></span><span id="UNICODE_ON_DISK"></span>

<span id="Unicode_On_Disk"></span><span id="unicode_on_disk"></span><span id="UNICODE_ON_DISK"></span>**Unicode em disco** (4)


</dt> <dd>

O sistema de arquivos dá suporte a Unicode em nomes de arquivo conforme eles aparecem no disco.

</dd> <dt>

<span id="Persistent_ACLs"></span><span id="persistent_acls"></span><span id="PERSISTENT_ACLS"></span>

<span id="Persistent_ACLs"></span><span id="persistent_acls"></span><span id="PERSISTENT_ACLS"></span>**ACLs persistentes** (8)


</dt> <dd>

O sistema de arquivos preserva e impõe listas de controle de acesso (ACLs). Por exemplo, o sistema de arquivos NTFS preserva e impõe ACLs e o sistema de arquivos FAT não.

</dd> <dt>

<span id="File_Compression"></span><span id="file_compression"></span><span id="FILE_COMPRESSION"></span>

<span id="File_Compression"></span><span id="file_compression"></span><span id="FILE_COMPRESSION"></span>**Compactação de arquivo** (16)


</dt> <dd>

O sistema de arquivos dá suporte à compactação baseada em arquivo.

</dd> <dt>

<span id="Volume_Quotas"></span><span id="volume_quotas"></span><span id="VOLUME_QUOTAS"></span>

<span id="Volume_Quotas"></span><span id="volume_quotas"></span><span id="VOLUME_QUOTAS"></span>**Cotas de volume** (32)


</dt> <dd>

O sistema de arquivos dá suporte a cotas de disco.

</dd> <dt>

<span id="Supports_Sparse_Files"></span><span id="supports_sparse_files"></span><span id="SUPPORTS_SPARSE_FILES"></span>

<span id="Supports_Sparse_Files"></span><span id="supports_sparse_files"></span><span id="SUPPORTS_SPARSE_FILES"></span>**Dá suporte a arquivos esparsos** (64)


</dt> <dd>

O sistema de arquivos dá suporte a arquivos sobressalentes.

</dd> <dt>

<span id="Supports_Reparse_Points"></span><span id="supports_reparse_points"></span><span id="SUPPORTS_REPARSE_POINTS"></span>

<span id="Supports_Reparse_Points"></span><span id="supports_reparse_points"></span><span id="SUPPORTS_REPARSE_POINTS"></span>**Dá suporte a pontos de nova análise** (128)


</dt> <dd>

O sistema de arquivos dá suporte a pontos de nova análise.

</dd> <dt>

<span id="Supports_Remote_Storage"></span><span id="supports_remote_storage"></span><span id="SUPPORTS_REMOTE_STORAGE"></span>

<span id="Supports_Remote_Storage"></span><span id="supports_remote_storage"></span><span id="SUPPORTS_REMOTE_STORAGE"></span>**dá suporte a Armazenamento remotas** (256)


</dt> <dd>

O sistema de arquivos dá suporte ao armazenamento remoto de arquivos.

</dd> <dt>

<span id="Supports_Long_Names"></span><span id="supports_long_names"></span><span id="SUPPORTS_LONG_NAMES"></span>

<span id="Supports_Long_Names"></span><span id="supports_long_names"></span><span id="SUPPORTS_LONG_NAMES"></span>**Dá suporte a nomes longos** (16384)


</dt> <dd>

O sistema de arquivos dá suporte a nomes de arquivos com mais de oito caracteres.

</dd> <dt>

<span id="Volume_Is_Compressed"></span><span id="volume_is_compressed"></span><span id="VOLUME_IS_COMPRESSED"></span>

<span id="Volume_Is_Compressed"></span><span id="volume_is_compressed"></span><span id="VOLUME_IS_COMPRESSED"></span>O **volume está compactado** (32768)


</dt> <dd>

O volume de disco especificado é um volume compactado, por exemplo, um volume do DoubleSpace.

</dd> <dt>

<span id="Read_Only_Volume"></span><span id="read_only_volume"></span><span id="READ_ONLY_VOLUME"></span>

<span id="Read_Only_Volume"></span><span id="read_only_volume"></span><span id="READ_ONLY_VOLUME"></span>**Volume somente leitura** (524289)
...
<span id="Supports_Object_IDS"></span><span id="supports_object_ids"></span><span id="SUPPORTS_OBJECT_IDS"></span>**Dá suporte a IDs de objeto** (65536)


</dt> <dd>

O sistema de arquivos dá suporte a identificadores de objeto.

</dd> <dt>

<span id="Supports_Encryption"></span><span id="supports_encryption"></span><span id="SUPPORTS_ENCRYPTION"></span>

<span id="Supports_Encryption"></span><span id="supports_encryption"></span><span id="SUPPORTS_ENCRYPTION"></span>**Dá suporte à criptografia** (131072)


</dt> <dd>

O sistema de arquivos dá suporte ao EFS (sistema de arquivos criptografados).

</dd> <dt>

<span id="Supports_Named_Streams"></span><span id="supports_named_streams"></span><span id="SUPPORTS_NAMED_STREAMS"></span>

<span id="Supports_Named_Streams"></span><span id="supports_named_streams"></span><span id="SUPPORTS_NAMED_STREAMS"></span>**dá suporte a Fluxos nomeados** (262144)


</dt> <dd>

O sistema de arquivos dá suporte a fluxos nomeados.
...
Letra da unidade que identifica exclusivamente esta unidade de CD-ROM.
...
fabricante da unidade de CD-ROM Windows.
...
Tamanho máximo do bloco, em bytes, para a mídia acessada por este dispositivo.
...
comprimento máximo de um componente de nome de arquivo com suporte na unidade de CD-ROM Windows. Um componente de nome de arquivo a parte de um nome de arquivo entre barras invertidas. O valor pode ser usado para indicar que nomes longos têm suporte pelo sistema de arquivos especificado. Por exemplo, para um sistema de arquivos FAT com suporte a nomes longos, a função armazena o valor 255, em vez do indicador de 8,3 anterior. Os nomes longos também podem ter suporte em sistemas que usam o sistema de arquivos NTFS.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Dispositivos de acesso sequencial DMTF \| 1,2 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" kilobytes ")
</dt> </dl>

Tamanho máximo, em quilobytes, de mídia com suporte neste dispositivo.
...
Se for **true**, um CD-ROM estará na unidade.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api \| GetDriveType")
</dt> </dl>

Tipo de mídia que pode ser usada ou acessada por este dispositivo. Os valores possíveis são:
...
**Dá suporte à gravação** ("dá suporte à gravação")
...
**Mídia removível** ("mídia removível")
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win2000DDK \| KernelModeDrivers \| [**Storage \_ Device \_ DESCRIPTOR**](/windows/desktop/api/winioctl/ns-winioctl-storage_device_descriptor) \| ProductRevisionOffset")
</dt> </dl>

Nível de revisão de firmware atribuído pelo fabricante.
...
Tamanho mínimo do bloco, em bytes, para a mídia acessada por este dispositivo.
...
Se **for true**, o dispositivo de acesso à mídia precisará de limpeza. Se a limpeza manual ou automática for possível, ela será indicada na propriedade **Capabilities** .
...
Número máximo de mídias que podem ser suportadas ou inseridas, quando o dispositivo de acesso à mídia dá suporte a várias mídias individuais.
...
Se **for true**, o dispositivo poderá ser gerenciado por energia, o que significa que ele pode ser colocado no modo de suspensão e assim por diante. A propriedade não indica que os recursos de gerenciamento de energia estão habilitados no momento, apenas que o dispositivo lógico é capaz de gerenciamento de energia.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| RevisionLevel")
</dt> </dl>

nível de revisão de Firmware da unidade de CD-ROM Windows.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api \| SCSI estruturas \| [**SCSI \_ solicitação \_**](/windows-hardware/drivers/ddi/content/srb/ns-srb-_scsi_request_block) \| PathId")
</dt> </dl>

Número de barramento SCSI para a unidade de disco.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api \| SCSI estruturas SCSI \| [**\_ Request \_**](/windows-hardware/drivers/ddi/content/srb/ns-srb-_scsi_request_block) \| LUN")
</dt> </dl>

LUN (número de unidade lógica) SCSI da unidade de disco. O LUN é usado para designar qual controlador SCSI está sendo acessado em um sistema com mais de um controlador sendo usado. O identificador de dispositivo SCSI é semelhante, mas é a designação para vários dispositivos em um controlador.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api \| SCSI estruturas SCSI \| [**\_ Request \_**](/windows-hardware/drivers/ddi/content/srb/ns-srb-_scsi_request_block) \| ScsiStatus")
</dt> </dl>

Número da porta SCSI da unidade de disco.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api \| DeviceIoControl \| IOCTL \_ SCSI \_ Get \_ endereço")
</dt> </dl>

número de identificador SCSI da unidade de CD-ROM Windows.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) (" \| estruturas de entrada e saída de dispositivo win32api \| [**\_ \_ descritor de dispositivo de armazenamento**](/windows/desktop/api/winioctl/ns-winioctl-storage_device_descriptor) \| SerialNumberOffset")
</dt> </dl>

Número fornecido pelo fabricante que identifica a mídia física. Exemplo: WD-WM3493798728.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api de \| funções de arquivo \| GetDiskFreeSpace"), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("bytes")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Referência de Arquivo Win32API e Referência de \| Tempo"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("quilobytes por segundo")
</dt> </dl>

Taxa de transferência da unidade CD-ROM. Um valor de -1 indica que a taxa não pode ser determinada. Quando isso acontece, o CD não está na unidade.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| File System Functions \| [**GetVolumeInformation**](/windows/desktop/api/fileapi/nf-fileapi-getvolumeinformationa)")
</dt> </dl>

Nome do volume da unidade Windows CD-ROM.
...
Número de série do volume da mídia na unidade CD-ROM.
...
A **classe \_ CDROMDrive win32** é derivada de [**CIM \_ CDROMDrive,**](cim-cdromdrive.md) que deriva de [**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md). A **classe CIM \_ MediaAccessDevice** deriva de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

## <a name="examples"></a>Exemplos

O exemplo de VBScript a seguir determina se um CD está em uma unidade CDROM.
