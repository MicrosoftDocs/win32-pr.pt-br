...
O método **StartService** tenta posicionar o serviço gerenciado pelo driver do sistema em seu estado de inicialização.
...
O código do PowerShell a seguir inicia o serviço "classe de impressora USB da Microsoft".
