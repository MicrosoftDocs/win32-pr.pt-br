...
ms.locfileid: "119972246"
---
# <a name="win32_parallelport-class"></a>\_Classe Win32 ParallelPort

A [classe WMI](../wmisdk/retrieving-a-class.md) **\_ ParallelPort do Win32** representa as propriedades de uma porta paralela em um sistema de computador que executa o Windows.
...
A classe **Win32 \_ ParallelPort** tem estes tipos de membros:
...
A classe **Win32 \_ ParallelPort** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                              |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**CIM \_ ParallelController**](cim-parallelcontroller.md).<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**CIM \_ ParallelController**](cim-parallelcontroller.md).<br/> |
...
A classe **Win32 \_ ParallelPort** tem essas propriedades.
...
Qualificadores: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("indexado"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|As portas paralelas DMTF \| 3,8 "), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Matriz dos recursos do controlador paralelo.

Essa propriedade é herdada do [**CIM \_ ParallelController**](cim-parallelcontroller.md).
...
Qualificadores: [**ArrayType**](../wmisdk/standard-qualifiers.md) ("indexado"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ([**" \_ CIM ParallelController**](cim-parallelcontroller.md).**Recursos**")
</dt> </dl>

Matriz de explicações mais detalhadas para qualquer um dos recursos do controlador paralelo indicados na matriz **Capabilities** . Cada entrada dessa matriz está relacionada à entrada na matriz de **recursos** que está localizada no mesmo índice.
...
Identificador da porta paralela.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Portas paralelas DMTF \| \| 003.7")
</dt> </dl>

Se **TRUE**, a porta paralela dá suporte ao AMD.

Essa propriedade é herdada [**de CIM \_ ParallelController.**](cim-parallelcontroller.md)
...
Se **TRUE**, o erro relatado em **LastErrorCode** será limpo.
...
Mais informações sobre o erro registrado em **LastErrorCode** e informações sobre ações corretivas que podem ser tomadas.
...
Qualificadores: [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. Porta do Barramento DMTF \| \| 001.9")
</dt> </dl>

Número máximo de entidades diretamente acessível com suporte por este controlador. Um valor de 0 (zero) deverá ser usado se o número for desconhecido.
...
Se **TRUE**, a porta paralela foi detectada automaticamente pelo sistema operacional. Se **FALSE**, a porta foi detectada por outros meios (como ser adicionada manualmente por meio do Painel de Controle).
...
Essa propriedade é herdada [**do \_ controlador CIM**](cim-controller.md). Os valores são mostrados na lista a seguir.
...
Data e hora da última redefinição do controlador. Isso pode significar que o controlador foi desligado ou reinicializado.
...
A classe **Win32 \_ ParallelPort** é derivada de [**CIM \_ ParallelController**](cim-parallelcontroller.md).
