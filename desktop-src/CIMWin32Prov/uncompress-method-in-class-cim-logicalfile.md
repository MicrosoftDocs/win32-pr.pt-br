...
---
# <a name="uncompress-method-of-the-cim_logicalfile-class"></a>Descompactar o método da \_ classe LogicalFile do CIM

O método **uncompactar** descompacta o arquivo lógico (ou diretório) especificado no caminho do objeto.
