---
description: O método SetPowerState da classe teclado CIM define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser \_ colocado nesse estado.
ms.assetid: f51cc589-b103-468c-89a5-2bfff4868ff2
ms.tgt_platform: multiple
title: Método SetPowerState da classe CIM_Keyboard classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
