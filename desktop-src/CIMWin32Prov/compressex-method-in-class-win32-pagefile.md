...
O método de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **CompressEx** compacta o arquivo de paginação lógica (ou diretório) especificado no caminho do objeto (esse método é uma versão estendida do método [**compress**](compress-method-in-class-win32-directory.md) ).
...
Nome do arquivo ou diretório em que o método **CompressEx** falhou. Esse parâmetro será **nulo** se o método tiver sucesso.
