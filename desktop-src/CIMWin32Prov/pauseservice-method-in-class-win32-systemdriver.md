...
O método de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **PauseService** tenta colocar o serviço gerenciado pelo driver de sistema lógico no estado em pausa.
