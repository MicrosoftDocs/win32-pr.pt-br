...
ms.locfileid: "119751286"
---
# <a name="win32_heatpipe-class"></a>\_Classe Win32 HeatPipe

A [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ HeatPipe do Win32** representa as propriedades de um dispositivo de resfriamento de tubo de calor.
...
A classe **Win32 \_ HeatPipe** tem estes tipos de membros:
...
A classe **Win32 \_ HeatPipe** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**CIM \_ HeatPipe**](cim-heatpipe.md) para obter a documentação.<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**CIM \_ HeatPipe**](cim-heatpipe.md) para obter a documentação.<br/> |
...
A classe **Win32 \_ HeatPipe** tem essas propriedades.
...
Se **for true**, o dispositivo de resfriamento fornecerá o resfriamento ativo não passivo.
...
Identificador exclusivo do pipe de calor.
...
Mais informações sobre o erro que é registrado em **LastErrorCode** e informações sobre as ações corretivas que podem ser executadas.
...
A classe **Win32 \_ HeatPipe** é derivada de [**CIM \_ HeatPipe**](cim-heatpipe.md).
