---
description: Interrompe o serviço representado pelo objeto derivado de Win32 \_ BaseService.
...
ms.locfileid: "119751896"
---
# <a name="stopservice-method-of-the-win32_baseservice-class"></a>Método StopService da classe BaseService Win32 \_

O método de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **StopService** interrompe o serviço representado pelo objeto derivado de [**Win32 \_ BaseService**](win32-baseservice.md).
...
O serviço não conseguiu encontrar o serviço necessário de um serviço dependente.
