...
---
# <a name="stopservice-method-of-the-win32_baseservice-class"></a>Método StopService da classe Win32 \_ BaseService

O método de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **StopService** interrompe o serviço representado pelo objeto derivado do [**Win32 \_ BaseService**](win32-baseservice.md).
...
O serviço não pôde localizar o serviço necessário de um serviço dependente.
