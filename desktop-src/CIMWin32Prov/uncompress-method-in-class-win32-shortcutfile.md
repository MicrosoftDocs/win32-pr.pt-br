...
---
# <a name="uncompress-method-of-the-win32_shortcutfile-class"></a>Descompactar o método da \_ classe shortcutfile do Win32

O método **uncompactar** [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) descompacta o arquivo de atalho lógico (ou diretório) especificado no caminho do objeto.
