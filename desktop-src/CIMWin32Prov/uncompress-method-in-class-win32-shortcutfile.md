...
title: Método Uncompress da classe Win32_ShortcutFile classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117834511"
---
# <a name="uncompress-method-of-the-win32_shortcutfile-class"></a>Método Uncompress da classe ShortcutFile win32 \_

O método de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Uncompress** descompacta o arquivo de atalho lógico (ou diretório) especificado no caminho do objeto.
