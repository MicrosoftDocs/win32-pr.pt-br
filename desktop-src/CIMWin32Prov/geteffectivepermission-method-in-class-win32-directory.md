...
ms.locfileid: "119760516"
---
# <a name="geteffectivepermission-method-of-the-win32_directory-class"></a>Método GetEffectivePermission da classe do \_ diretório Win32

O método de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) [**GetEffectivePermission**](geteffectivepermission-method-in-class-win32-shortcutfile.md) determina se o usuário tem todas as permissões necessárias especificadas no parâmetro *Permissions* para o objeto de [**\_ diretório do Win32**](win32-directory.md) , diretório e compartilhamento onde o arquivo de entrada de diretório está localizado (se o arquivo ou diretório estiverem em um compartilhamento).
...
<span id="FILE_EXECUTE__file_______FILE_TRAVERSE__directory_"></span><span id="file_execute__file_______file_traverse__directory_"></span><span id="FILE_EXECUTE__FILE_______FILE_TRAVERSE__DIRECTORY_"></span>Do **arquivo \_ EXECUTAR (arquivo) \_ atravessamento do arquivo (diretório)** (32 (0x20))
