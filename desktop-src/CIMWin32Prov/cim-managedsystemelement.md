...
---
# <a name="cim_managedsystemelement-class-cimwin32-wmi-providers"></a>Classe CIM_ManagedSystemElement (provedores WMI CIMWin32)

A classe **CIM \_ ManagedSystemElement** é a classe base para a hierarquia de elementos do sistema. Qualquer componente de sistema diferencial é um candidato para inclusão nessa classe. Os exemplos incluem componentes de software, como arquivos; dispositivos, como unidades de disco e controladores; e componentes físicos, como chips e cartões.
...
O WMI não implementa essa classe. Para classes WMI derivadas dessa classe, consulte [classes Win32](win32-provider.md).
