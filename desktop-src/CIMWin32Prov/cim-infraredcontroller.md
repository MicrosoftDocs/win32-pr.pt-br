...
---
# <a name="cim_infraredcontroller-class"></a>\_Classe CIM InfraredController

A classe **CIM \_ InfraredController** representa os recursos e o gerenciamento de um controlador de infravermelho.
...
A classe **CIM \_ InfraredController** tem estes tipos de membros:
...
A classe **CIM \_ InfraredController** tem esses métodos.
...
A classe **CIM \_ InfraredController** tem essas propriedades.
...
Data e hora da última redefinição do controlador, o que pode significar que o controlador foi desligado ou reinicializado.
...
A classe **CIM \_ InfraredController** é derivada do [**\_ controlador CIM**](cim-controller.md).

O WMI não implementa essa classe. Para classes derivadas do **CIM \_ InfraredController**, consulte [classes Win32](win32-provider.md).
