---
description: A classe \_ Cim DesaloqueadoController representa as funcionalidades e o gerenciamento de um controlador com fio.
...
ms.locfileid: "119438726"
---
# <a name="cim_infraredcontroller-class"></a>Classe \_ Cim EsverdeadaController

A **classe \_ Cim DesaloqueadoController** representa as funcionalidades e o gerenciamento de um controlador com fio.
...
A **classe \_ Cim QuedController** tem estes tipos de membros:
...
A **classe \_ Cim QuedController** tem esses métodos.



| Método                                                                        | Descrição                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-infraredcontroller.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-infraredcontroller.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A **classe \_ Cim QuedController** tem essas propriedades.
...
Data e hora em que o controlador foi redefinido pela última vez, o que pode significar que o controlador foi desligado ou reinicializado.
...
A **classe \_ CimRiveddController** é derivada do [**Controlador CIM. \_**](cim-controller.md)

O WMI não implementa essa classe. Para classes derivadas de **\_ CimRiveddController**, consulte [Classes Win32](win32-provider.md).
