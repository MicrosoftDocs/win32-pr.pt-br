---
description: O método SetPowerState da classe CIM \_ FlatPanel define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado.
ms.assetid: 75f5f588-f3d3-471c-bff4-a511abcee576
ms.tgt_platform: multiple
title: Método SetPowerState da classe CIM_FlatPanel
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
