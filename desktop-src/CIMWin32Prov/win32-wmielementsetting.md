...
Referência à instância que representa o serviço do Windows usando ou identificando propriedades WMI.
...
Referência à instância que representa as configurações de WMI disponíveis para o serviço do Windows.
