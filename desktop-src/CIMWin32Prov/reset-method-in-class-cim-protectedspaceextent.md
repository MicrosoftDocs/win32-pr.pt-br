...
title: Método reset da classe CIM_ProtectedSpaceExtent dados
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119701176"
---
# <a name="reset-method-of-the-cim_protectedspaceextent-class"></a>Método reset da classe CIM \_ ProtectedSpaceExtent

O **método Reset** da classe CIM \_ ProtectedSpaceExtent solicita uma redefinição do dispositivo lógico. Esse método é herdado [**de CIM \_ LogicalDevice.**](cim-logicaldevice.md)
