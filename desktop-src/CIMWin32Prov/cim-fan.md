...
A classe de **\_ ventilador CIM** é derivada do [**CIM \_ CoolingDevice**](cim-coolingdevice.md).

O WMI não implementa essa classe. Para classes derivadas do **\_ ventilador CIM**, consulte [classes Win32](win32-provider.md).
