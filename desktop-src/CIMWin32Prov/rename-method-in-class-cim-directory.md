...
---
# <a name="rename-method-of-the-cim_directory-class"></a>Método Rename da classe de \_ diretório CIM

O método **renomear** renomeia o arquivo lógico (ou diretório) especificado no caminho do objeto. Não haverá suporte para renomear se o destino estiver em outra unidade ou se for necessário substituir um arquivo lógico existente.

Esse método é herdado [**do \_ LogicalFile CIM**](cim-logicalfile.md).
...
[\_Diretório CIM](rename-method-in-class-cim-directory.md)
</dt> <dt>
