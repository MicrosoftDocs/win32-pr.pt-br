...
---
# <a name="win32_session-class"></a>\_Classe de sessão Win32

A classe de **\_ sessão do Win32** define informações de estado sobre a interação entre um usuário e um recurso, como um sistema de computador ou uma sessão de terminal.
...
A classe de **\_ sessão Win32** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe de **\_ sessão Win32** tem essas propriedades.
...
A classe de **\_ sessão Win32** é derivada de [**CIM \_ LogicalElement**](cim-logicalelement.md).
