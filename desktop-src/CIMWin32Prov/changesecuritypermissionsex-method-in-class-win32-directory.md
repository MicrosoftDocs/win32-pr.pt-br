...
ms.locfileid: "119323023"
---
# <a name="changesecuritypermissionsex-method-of-the-win32_directory-class"></a>Método ChangeSecurityPermissionsEx da classe De diretório \_ Win32
...
Se **true**, a alteração de propriedade será aplicada recursivamente a arquivos e diretórios dentro do diretório especificado pela [**instância de \_ LogicalFile cim.**](cim-logicalfile.md) Para instâncias de arquivo, o *parâmetro de entrada recursiva* é ignorado. Esse parâmetro é opcional.
