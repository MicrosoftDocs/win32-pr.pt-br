...
ms.locfileid: "117834737"
---
# <a name="cim_clusteringsap-class"></a>\_Classe CIM ClusteringSAP

A classe **CIM \_ ClusteringSAP** representa os pontos de acesso de um serviço de clustering.
...
A classe **CIM \_ ClusteringSAP** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **CIM \_ ClusteringSAP** tem essas propriedades.
...
A classe **CIM \_ ClusteringSAP** é derivada de [**\_ ServiceAccessPoint CIM**](cim-serviceaccesspoint.md).
