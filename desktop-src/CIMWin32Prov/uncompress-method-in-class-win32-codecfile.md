...
---
# <a name="uncompress-method-of-the-win32_codecfile-class"></a>Descompactar o método da \_ classe de codecs do Win32

O método **uncompactar** [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) descompacta o arquivo de codec lógico (ou diretório) especificado no caminho do objeto.
