...
---
# <a name="enableipfiltersec-method-of-the-win32_networkadapterconfiguration-class"></a>Método EnableIPFilterSec da classe Win32 \_ NetworkAdapterConfiguration

O método estático da [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **EnableIPFilterSec** é usado para habilitar o IPsec (segurança do protocolo Internet) globalmente em todos os adaptadores de rede vinculados por IP.
...
*IPFilterSecurityEnabled* \[ no\]
</dt> <dd>

Se **for true**, o IPSec será habilitado globalmente em todos os adaptadores de rede vinculados por IP. Se **for false**, todo o tráfego de porta e protocolo tem permissão para fluir sem filtro.
...
Com a segurança habilitada, as características de segurança operacional para qualquer adaptador de rede podem ser controladas usando o método [**EnableIPSec**](enableipsec-method-in-class-win32-networkadapterconfiguration.md) específico do adaptador de rede.

## <a name="examples"></a>Exemplos

O código a seguir, extraído do exemplo [habilitar segurança do ipfilter em todos os adaptadores de rede](https://Gallery.TechNet.Microsoft.Com/f8e56021-5a54-4554-b7b6-d76cc40d8d1d) na galeria do TechNet, habilita a segurança de filtro IP para todos os adaptadores de rede instalados em um computador.
