...
A classe **Win32 \_ IRQResource** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Win32 \_ IRQResource** tem essas propriedades.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| IRQ \| 1,2 ")
</dt> </dl>

Disponibilidade do IRQ.

Essa propriedade é herdada [**do \_ IRQ de CIM**](cim-irq.md).
...
Em uso e disponível/compartilhável
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api do \| descritor de recursos de estruturas do sistema \| \_ \| ")
</dt> </dl>

Se for **true**, a interrupção será baseada em hardware ou software. Um IRQ de hardware é um fio físico do periférico para o chip do controlador de interrupção programável (PIC) por meio do qual a CPU pode ser notificada de eventos de tempo crítico. Algumas linhas de IRQ são reservadas para dispositivos Standard, como o teclado, as unidades de disquete e o relógio do sistema. Uma interrupção de software permite que os aplicativos obtenham a atenção do processador.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| IRQ \| 1,1 "), [**chave**](/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>

Parte do valor de chave do objeto.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| IRQ \| 1,4 ")
</dt> </dl>

Se **for true**, o IRQ poderá ser compartilhado.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Informações de IRQ do recurso do sistema DMTF \| 1,3 ")
</dt> </dl>

Nível de gatilho de IRQ que indica se a interrupção é disparada pelo sinal de hardware ficando alta (4) ou baixa (3).
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| IRQ \| 1,3 "," MIF. \|Informações de IRQ do recurso do sistema DMTF \| 1,2 ")
</dt> </dl>

Tipo de gatilho de IRQ indicando se ocorrerem interrupções disparadas por borda (4) ou disparadas por nível (3).
...
A classe **Win32 \_ IRQResource** é derivada de [**\_ IRQ de CIM**](cim-irq.md).
