...
---
# <a name="setpowerstate-method-of-the-cim_cachememory-class"></a>Método SetPowerState da classe CIM \_ CacheMemory

O método **SetPowerState** define o estado de energia desejado para um dispositivo lógico e quando o dispositivo deve ser colocado nesse estado. Em uma subclasse, especifique o conjunto de possíveis códigos de retorno usando um qualificador **ValueMap** no método. As cadeias de caracteres nas quais o conteúdo de **ValueMap** são traduzidos também devem ser especificadas na subclasse como um qualificador de matriz de **valores** . Esse método é herdado [**do \_ LogicalDevice CIM**](cim-logicaldevice.md).
