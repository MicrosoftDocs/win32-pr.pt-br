...
ms.locfileid: "119918956"
---
# <a name="cim_temperaturesensor-class"></a>\_Classe CIM sensor

A classe **CIM \_ sensor** existe para compatibilidade com versões anteriores de definições de esquema CIM. Com adições às classes [**do \_ sensor CIM**](cim-sensor.md) e do [**cim \_ NumericSensor**](cim-numericsensor.md) na versão 2,2, ela não é mais necessária. Um sensor de temperatura pode ser definido definindo a propriedade **SensorType** , herdada **do \_ sensor CIM**, para 2 ("temperatura"). Outras propriedades dessa classe são codificadas como valores constantes que correspondem às definições na hierarquia do sensor.
...
A classe **CIM \_ sensor** tem estes tipos de membros:
...
A classe **CIM \_ sensor** tem esses métodos.



| Método                                                                       | Descrição                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Definido**](reset-method-in-class-cim-temperaturesensor.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-temperaturesensor.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ sensor** tem essas propriedades.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("exatidão"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura de DMTF \| \| 1,19 ")
</dt> </dl>
...
Qualificadores: [**substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("CurrentReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura DMTF \| \| 001,5"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centirade")
</dt> </dl>
...
Qualificadores: [**substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura de DMTF \| \| 001,13"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centígrados")
</dt> </dl>
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura de DMTF \| \| 001,15"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centígrados")
</dt> </dl>
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de Temperatura de DMTF \| \| 001,11"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centígrados")
</dt> </dl>
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("MaxReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de Temperatura DMTF \| \| 001,9"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centirade")
</dt> </dl>
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("MinReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de Temperatura DMTF \| \| 001,10"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centígrados")
</dt> </dl>
...
Qualificadores: [**substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("NominalReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura DMTF \| \| 001,6"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centirade")
</dt> </dl>
...
Qualificadores: [**substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMax"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura de DMTF \| \| 001,7"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centirade")
</dt> </dl>
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMin"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de Temperatura DMTF \| \| 001,8"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centígrados")
</dt> </dl>
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("Resolução"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura de DMTF \| \| 001,17"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("centésimos de graus centígrados")
</dt> </dl>
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("Tolerância"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura de DMTF \| \| 001,18"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centígrados")
</dt> </dl>

Tolerância do sensor para a propriedade medida. Essa propriedade e as **propriedades Resolução** **e** Precisão são usadas para calcular o valor real da propriedade física medida. A tolerância pode variar dependendo se o dispositivo é linear em relação ao seu intervalo dinâmico.
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura DMTF \| \| 001,14"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centígrados")
</dt> </dl>

Valor limite que especifica os intervalos (valores mínimo e máximo) para determinar se o sensor está operando em condições normais, não críticas, críticas ou fatais. Se a **propriedade CurrentReading** estiver entre **UpperThresholdCritical** e **UpperThresholdFatal**, o estado atual será crítico.
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de Temperatura DMTF \| \| 001,16"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centígrados")
</dt> </dl>

Valor limite que especifica os intervalos (valores mínimo e máximo) para determinar se o sensor está operando em condições normais, não críticas, críticas ou fatais. Se a **propriedade CurrentReading** estiver acima **de UpperThresholdFatal,** o estado atual será fatal.
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Investigação de temperatura de DMTF \| \| 001,12"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("décimos de graus centígrados")
</dt> </dl>

Valor limite que especifica os intervalos (valores mínimo e máximo) para determinar se o sensor está operando em condições normais, não críticas, críticas ou fatais. Se a **propriedade CurrentReading** estiver entre **LowerThresholdNonCritical** e **UpperThresholdNonCritical,** o sensor relatará um valor normal. Se a **propriedade CurrentReading** estiver entre **UpperThresholdNonCritical** e **UpperThresholdCritical**, o estado atual será não crítico.
...
A **classe \_ TemperatureSensor CIM** é derivada de CIM [**\_ NumericSensor**](cim-numericsensor.md).

O WMI não implementa essa classe. Para classes WMI derivadas de **\_ TemperatureSensor cim**, consulte [Classes Win32](win32-provider.md).
