...
Se **for true**, o ventilador dará suporte a velocidades de variáveis.
...
A **classe \_ do ventilador do Win32** é derivada do [**\_ ventilador CIM**](cim-fan.md).

## <a name="examples"></a>Exemplos

A amostra do PowerShell [listar informações](https://Gallery.TechNet.Microsoft.Com/d1534503-704f-4450-8dab-f3e760bf818c) sobre o ventilador do computador recupera informações sobre os ventiladores de resfriamento instalados em um computador.
