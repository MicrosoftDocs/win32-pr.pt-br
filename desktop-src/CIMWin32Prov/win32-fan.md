...
ms.locfileid: "120085796"
---
# <a name="win32_fan-class"></a>\_Classe de ventilador Win32

A [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) de **\_ ventilador do Win32** representa as propriedades de um dispositivo de ventilador no sistema de computador. Por exemplo, o ventilador de resfriamento da CPU.
...
A classe de **\_ ventilador do Win32** tem estes tipos de membros:
...
A classe de **\_ ventilador do Win32** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                  |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**\_ ventilador do CIM**](cim-fan.md) para obter a documentação.<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**\_ ventilador do CIM**](cim-fan.md) para obter a documentação.<br/> |
| **SETSPEED**      | Não implementado.<br/>                                                                                                                                                                  |
...
A classe de **\_ ventilador do Win32** tem essas propriedades.
...
Qualificadores: [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("rotações por minuto")
</dt> </dl>

Velocidade do ventilador solicitada no momento, definida em rotações por minuto, quando há suporte para um ventilador de velocidade variável (**variablespeed** é **true**). A velocidade atual é determinada por um sensor ([**\_ tacômetro do CIM**](cim-tachometer.md)) que está associado ao ventilador usando a relação de [**\_ AssociatedSensor do CIM**](cim-associatedsensor.md) .

Essa propriedade é herdada [**do \_ ventilador CIM**](cim-fan.md).
...
Identifica o dispositivo de ventilador. Essa propriedade é herdada [**de \_ LogicalDevice CIM**](cim-logicaldevice.md).
...
Se **True**, o ventilador dá suporte a velocidades variáveis.

Essa propriedade é herdada do [**ventilador CIM. \_**](cim-fan.md)

</dd> </dl>

## <a name="remarks"></a>Comentários

A **classe Win32 \_ Fan** é derivada do [**ventilador \_ CIM.**](cim-fan.md)

## <a name="examples"></a>Exemplos

O [exemplo Listar Informações do](https://Gallery.TechNet.Microsoft.Com/d1534503-704f-4450-8dab-f3e760bf818c) Ventilador do Computador do PowerShell recupera informações sobre os ventiladores de resfriamento instalados em um computador.

O exemplo a seguir recupera informações sobre os ventiladores de resfriamento instalados em um computador.
