---
description: A classe \_ TapeDrive CIM representa uma unidade de fita no sistema. As unidades de fita são diferenciadas principalmente porque só podem ser acessadas sequencialmente.
ms.assetid: 8b7f2277-e37d-4597-81bb-d3c8d4966a81
ms.tgt_platform: multiple
title: CIM_TapeDrive classe (Provedores WMI CIMWin32)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119020834"
---
# <a name="cim_tapedrive-class-cimwin32-wmi-providers"></a>CIM_TapeDrive classe (Provedores WMI CIMWin32)

A **classe \_ TapeDrive CIM** representa uma unidade de fita no sistema. As unidades de fita são diferenciadas principalmente porque só podem ser acessadas sequencialmente.
...
A **classe \_ TapeDrive CIM** tem estes tipos de membros:
...
A **classe \_ TapeDrive cim** tem esses métodos.



| Método                                                               | Descrição                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-tapedrive.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-tapedrive.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A **classe \_ TapeDrive cim** tem essas propriedades.
...
Funcionalidades do dispositivo de acesso à mídia. Essa propriedade é herdada [**de CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).
...
Cadeias de caracteres de forma livre que fornecem explicações detalhadas para os recursos de dispositivo de acesso indicados na matriz **Recursos.** Observe que cada entrada dessa matriz está relacionada à entrada na matriz **Recursos** que está localizada no mesmo índice.
...
Tamanho, em bytes, da área designada como fim da fita. O acesso nessa área gera um aviso de fim de fita.
...
Cadeia de caracteres de forma livre que descreve os tipos de detecção e correção de erros com suporte pelo dispositivo.
...
A **classe \_ TapeDrive CIM** é derivada de CIM [**\_ MediaAccessDevice**](cim-mediaaccessdevice.md).

O WMI não implementa essa classe. Para classes WMI derivadas de **CIM \_ TapeDrive**, consulte [Classes Win32](win32-provider.md).
