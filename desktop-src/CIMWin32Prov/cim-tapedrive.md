...
A classe **CIM \_ TapeDrive** é derivada de [**\_ MediaAccessDevice CIM**](cim-mediaaccessdevice.md).

O WMI não implementa essa classe. Para classes WMI derivadas do **CIM \_ TapeDrive**, consulte [classes Win32](win32-provider.md).
