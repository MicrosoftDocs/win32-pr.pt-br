...
---
# <a name="cim_tapedrive-class-cimwin32-wmi-providers"></a>Classe CIM_TapeDrive (provedores WMI CIMWin32)

A classe **CIM \_ TapeDrive** representa uma unidade de fita no sistema. As unidades de fita são basicamente diferenciadas, pois só podem ser acessadas sequencialmente.
...
A classe **CIM \_ TapeDrive** tem esses métodos.



| Método                                                               | Descrição                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Definido**](reset-method-in-class-cim-tapedrive.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
...
Cadeias de caracteres de forma livre que fornecem explicações detalhadas para os recursos de dispositivo de acesso indicados na matriz de **recursos** . Observe que cada entrada dessa matriz está relacionada à entrada na matriz de **recursos** que está localizada no mesmo índice.
