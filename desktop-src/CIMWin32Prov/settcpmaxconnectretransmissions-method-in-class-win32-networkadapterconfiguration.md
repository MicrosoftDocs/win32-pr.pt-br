...
ms.locfileid: "119020454"
---
# <a name="settcpmaxconnectretransmissions-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetTcpMaxConnectRetransmissions da classe Win32 \_ NetworkAdapterConfiguration

O método estático da [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetTcpMaxConnectRetransmissions** é usado para definir o número de tentativas que o TCP retransmitirá uma solicitação de conexão antes de abortar.
...
*TcpMaxConnectRetransmissions* \[ no\]
</dt> <dd>

Número de tentativas que o TCP retransmitirá uma solicitação de conexão antes de abortar. O intervalo válido para os valores é 0-0xFFFFFFFF.
...
O tempo limite de retransmissão inicial é de três segundos e dobra para cada tentativa sucessiva.

## <a name="examples"></a>Exemplos

A amostra [Modificar o máximo de retransmissões de conexões TCP permitidas](https://Gallery.TechNet.Microsoft.Com/e599c6bc-fa37-457d-b7e3-3c003517ed46) do VBScript configura o número de vezes que o TCP retransmitirá uma tentativa de conexão antes de abandonar o esforço.
...
| Servidor mínimo com suporte<br/> | Windows servidor 2008, Windows server 2008<br/>                                     |
