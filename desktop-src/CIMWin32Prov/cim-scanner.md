...
---
# <a name="cim_scanner-class"></a>\_Classe de scanner CIM
...
A classe de **\_ scanner CIM** tem estes tipos de membros:
...
A classe de **\_ scanner CIM** tem esses métodos.
...
A classe de **\_ scanner CIM** tem essas propriedades.
