...
---
# <a name="compress-method-of-the-win32_shortcutfile-class"></a>Método compress da \_ classe shortcutfile do Win32

O método **compactar** [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) compacta o arquivo de atalho lógico (ou diretório) especificado no caminho do objeto.
