...
---
# <a name="cim_multistatesensor-class"></a>\_Classe CIM MultiStateSensor

A classe **CIM \_ MultiStateSensor** representa um conjunto de vários membros de sensores binários em que cada sensor binário relata um resultado booliano.
...
A classe **CIM \_ MultiStateSensor** tem estes tipos de membros:
...
A classe **CIM \_ MultiStateSensor** tem esses métodos.



| Método                                                                      | Descrição                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-multistatesensor.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-multistatesensor.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ MultiStateSensor** tem essas propriedades.
...
A classe **CIM \_ MultiStateSensor** é derivada do [**\_ sensor CIM**](cim-sensor.md).
