---
description: A classe CIM PCMCIAController representa os recursos e o gerenciamento de um controlador PCMCIA (Associação Internacional de Cartão de Memória de Computador \_ Pessoal).
...
ms.locfileid: "118678836"
---
# <a name="cim_pcmciacontroller-class"></a>Classe CIM \_ PCMCIAController

A **classe CIM \_ PCMCIAController** representa os recursos e o gerenciamento de um controlador PCMCIA (Associação Internacional de Cartão de Memória de Computador Pessoal).
...
A **classe CIM \_ PCMCIAController** tem estes tipos de membros:
...
A **classe CIM \_ PCMCIAController** tem esses métodos.



| Método                                                                      | Descrição                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-pcmciacontroller.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A **classe CIM \_ PCMCIAController** tem essas propriedades.
...
Disponibilidade e status do dispositivo. Essa propriedade é herdada de [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
...
O dispositivo é conhecido por estar em um modo de economia de energia, mas seu status exato nesse modo é desconhecido.
...
O controlador PCMCIA não está disponível.
...
<span id="this_device_is_not_working_properly_because_windows_cannot_load_the_drivers_required_for_this_device."></span><span id="THIS_DEVICE_IS_NOT_WORKING_PROPERLY_BECAUSE_WINDOWS_CANNOT_LOAD_THE_DRIVERS_REQUIRED_FOR_THIS_DEVICE."></span>**Esse dispositivo não está funcionando corretamente porque Windows não pode carregar os drivers necessários para esse dispositivo.** (31)
...
Nome do fabricante do controlador PCMCIA.
...
Funcionalidades específicas relacionadas a energia do dispositivo lógico.
...
Há suporte para o método [**SetPowerState.**](setpowerstate-method-in-class-cim-pcmciacontroller.md)
...
O [**método SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) pode ser invocado com o *parâmetro PowerState* definido como 5 ("Power Cycle").
...
O [**método SetPowerState**](setpowerstate-method-in-class-cim-pcmciacontroller.md) pode ser invocado com o parâmetro *PowerState*  definido como 5 ("Power Cycle") e o parâmetro Time definido como uma data e hora específicas, ou intervalo, para o power-on.
...
Data e hora em que o controlador foi redefinido pela última vez, o que significa que o controlador foi desligado ou reinicializado.
...
A classe **CIM \_ PCMCIAController** é derivada do [**\_ controlador CIM**](cim-controller.md).

O WMI não implementa essa classe. Para classes WMI que são derivadas do **CIM \_ PCMCIAController**, consulte [classes Win32](win32-provider.md).
