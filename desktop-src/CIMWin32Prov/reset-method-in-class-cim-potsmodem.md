...
title: Método de redefinição da CIM_POTSModem classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119701256"
---
# <a name="reset-method-of-the-cim_potsmodem-class"></a>Método reset da classe CIM \_ POTSModem

O **método Reset** da classe CIM \_ POTSModem solicita uma redefinição do dispositivo lógico. Esse método é herdado [**de CIM \_ LogicalDevice.**](cim-logicaldevice.md)
