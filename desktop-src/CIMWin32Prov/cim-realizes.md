...
---
# <a name="cim_realizes-class"></a>O CIM \_ percebe a classe

O **CIM \_ percebe** que a classe representa a associação que define o mapeamento entre um dispositivo lógico e o componente físico que implementa o dispositivo.
...
A classe de **\_ concretizações do CIM** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe de **\_ concretizações do CIM** tem essas propriedades.
...
Um [**\_ físicoelement do CIM**](cim-physicalelement.md) que descreve o componente físico que implementa o dispositivo.
...
O **CIM \_ percebe** que a classe é derivada [**da \_ dependência CIM**](cim-dependency.md).
