...
A classe **Win32 \_ 1394Controller** é derivada do [**\_ controlador CIM**](cim-controller.md).

## <a name="examples"></a>Exemplos

O exemplo de código do PowerShell a seguir recupera as informações do controlador.
