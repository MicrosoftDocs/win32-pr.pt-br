...
ms.locfileid: "119546586"
---
# <a name="win32_1394controller-class"></a>\_Classe Win32 1394Controller

A [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ 1394Controller do Win32** representa os recursos e o gerenciamento de um controlador 1394. O IEEE 1394 é uma especificação para um barramento serial de alta velocidade.
...
A classe **Win32 \_ 1394Controller** tem estes tipos de membros:
...
A classe **Win32 \_ 1394Controller** tem esses métodos.
...
A classe **Win32 \_ 1394Controller** tem essas propriedades.
...
Identificador exclusivo deste controlador.
...
O controlador de data e hora foi redefinido pela última vez. Isso pode significar que o controlador foi desligado ou reinicializado.
...
A **classe Win32 \_ 1394Controller** é derivada do [**Controlador CIM. \_**](cim-controller.md)

## <a name="examples"></a>Exemplos

O exemplo de código do PowerShell a seguir recupera informações do controlador.
