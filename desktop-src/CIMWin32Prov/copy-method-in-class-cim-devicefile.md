...
O método **Copy** copia o arquivo lógico (ou diretório) especificado no caminho do objeto para o local especificado pelo parâmetro de entrada. Não haverá suporte para uma cópia se ela exigir a substituição de um arquivo lógico existente. Esse método é herdado [**do \_ LogicalFile CIM**](cim-logicalfile.md).
...
[\_Dispositivo CIM](copy-method-in-class-cim-devicefile.md)
</dt> <dt>
