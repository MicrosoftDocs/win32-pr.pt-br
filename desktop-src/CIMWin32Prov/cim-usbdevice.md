...
ms.locfileid: "119918796"
---
# <a name="cim_usbdevice-class-cimwin32-wmi-providers"></a>Classe CIM_USBDevice (provedores WMI CIMWin32)

A classe **CIM \_ UsbDevice** representa as características de gerenciamento de um dispositivo USB.
...
| Método                                                               | Descrição                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Getdescriptor**](getdescriptor-method-in-class-cim-usbdevice.md) | Retorna o descritor de dispositivo USB. Não implementado pelo WMI.<br/>                                                                    |
| [**Definido**](reset-method-in-class-cim-usbdevice.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbdevice.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
Configuração selecionada no momento para o dispositivo. Se o valor for 0 (zero), o dispositivo não será configurado.
...
Versão USB mais recente com suporte pelo dispositivo USB. Essa propriedade é expressa como um BCD (decimal codificado em binário) em que um ponto decimal está implícito entre o segundo e o terceiro dígitos. Por exemplo, um valor de 0x201 indica que há suporte para a versão 2.01.

</dd> </dl>

## <a name="remarks"></a>Comentários

A **classe CIM \_ USBDevice** é derivada de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

O WMI não implementa essa classe. Para classes WMI que implementam **CIM \_ USBDevice**, consulte [Classes Win32](win32-provider.md).
