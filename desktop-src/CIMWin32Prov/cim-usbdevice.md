...
| [**Redefinir**](reset-method-in-class-cim-usbdevice.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
...
A classe **CIM \_ UsbDevice** é derivada do [**\_ LogicalDevice CIM**](cim-logicaldevice.md).

O WMI não implementa essa classe. Para classes WMI que implementam **\_ UsbDevice CIM**, consulte [classes Win32](win32-provider.md).
