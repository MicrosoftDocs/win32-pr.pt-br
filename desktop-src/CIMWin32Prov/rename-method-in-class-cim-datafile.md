...
O método **renomear** renomeia o arquivo lógico (ou diretório) que é especificado no caminho do objeto. Não haverá suporte para renomear se o destino estiver em outra unidade ou se for necessário substituir um arquivo lógico existente. Esse método é herdado [**do \_ LogicalFile CIM**](cim-logicalfile.md).
...
O método **Rename** no [**\_ arquivo CIM**](cim-datafile.md) é implementado pelo WMI.
...
[DataFile de CIM \_](rename-method-in-class-cim-datafile.md)
</dt> <dt>
