...
ms.locfileid: "119699526"
---
# <a name="win32_infrareddevice-class"></a>\_Classe Win32 InfraredDevice

A [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ InfraredDevice do Win32** representa os recursos e o gerenciamento de um dispositivo de infravermelho.
...
A classe **Win32 \_ InfraredDevice** tem estes tipos de membros:
...
A classe **Win32 \_ InfraredDevice** tem esses métodos.



| Método            | Descrição                                                                                                                                                                                                                |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Redefinir**         | Não implementado. Para implementar esse método, consulte o método [**Reset**](reset-method-in-class-cim-controller.md) no [**CIM \_ InfraredController**](cim-infraredcontroller.md) para obter a documentação.<br/>                 |
| **SetPowerState** | Não implementado. Para implementar esse método, consulte o método [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) no [**CIM \_ InfraredController**](cim-infraredcontroller.md) para obter a documentação.<br/> |
...
A classe **Win32 \_ InfraredDevice** tem essas propriedades.
...
Identificador exclusivo do dispositivo de infravermelho.
...
Número máximo de entidades diretamente acessível com suporte por este dispositivo. Um valor de 0 (zero) deverá ser usado se o número for desconhecido.
...
A **classe Win32RiveddDevice \_** é derivada de [**CIM Não \_ ControladoController.**](cim-infraredcontroller.md)
