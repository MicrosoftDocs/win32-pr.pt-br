...
---
# <a name="settcpuserfc1122urgentpointer-method-of-the-win32_networkadapterconfiguration-class"></a>Método SetTcpUseRFC1122UrgentPointer da classe Win32 \_ NetworkAdapterConfiguration

O método estático da [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetTcpUseRFC1122UrgentPointer** é usado para especificar se o TCP usa a especificação RFC 1122 para dados urgentes ou o modo usado pelos sistemas derivados do BSD (Berkeley Software Design).
...
*TcpUseRFC1122UrgentPointer* \[ no\]
</dt> <dd>

Se **for true**, o TCP usará a especificação RFC 1122. Se for **falso**, os dados urgentes serão enviados no modo usado por sistemas derivados do BSD.
