...
title: Método TakeOwnerShip da CIM_DataFile classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119751866"
---
# <a name="takeownership-method-of-the-cim_datafile-class"></a>Método TakeOwnerShip da classe CIM \_ DataFile
...
O **método TakeOwnerShip** no [**CIM \_ DataFile**](cim-datafile.md) é implementado pelo WMI.
