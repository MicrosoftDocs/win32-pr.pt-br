...
ms.locfileid: "119924626"
---
# <a name="cim_currentsensor-class"></a>\_Classe CIM CurrentSensor

A classe **CIM \_ CurrentSensor** existe para compatibilidade com versões anteriores de definições de esquema CIM.

As adições [**ao \_ sensor CIM**](cim-sensor.md) e o [**\_ NumericSensor do CIM**](cim-numericsensor.md) na versão 2,2 o tornam não mais necessário. Uma classe **CIM \_ CurrentSensor** pode ser definida definindo a propriedade **SensorType** , herdada do **\_ sensor CIM**, para 4 ("atual"). Outras propriedades dessa classe são embutidas em código para valores constantes, que correspondem às definições na hierarquia do sensor.
...
A classe **CIM \_ CurrentSensor** tem estes tipos de membros:
...
A classe **CIM \_ CurrentSensor** tem esses métodos.



| Método                                                                   | Descrição                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Definido**](reset-method-in-class-cim-currentsensor.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe **CIM \_ CurrentSensor** tem essas propriedades.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("exatidão"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,19 ")
</dt> </dl>
...
O dispositivo está em um modo de economia de energia e ainda está funcionando, mas pode exibir o desempenho degradado.
...
O dispositivo está em um estado de aviso e em um modo de economia de energia.
...
O sensor atual não está disponível.
...
Indica se o dispositivo está usando uma configuração definida pelo usuário.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("CurrentReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,5 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>
...
Se **for true**, o sensor será linear sobre seu intervalo dinâmico.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,13 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>

Valor de limite que especifica se o sensor está operando sob condições críticas. Se a propriedade **CurrentReading** estiver entre **LowerThresholdCritical** e **LowerThresholdFatal**, o estado atual será crítico.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,15 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>

Valor de limite que especifica se o sensor está operando sob condições fatais. Se a propriedade **CurrentReading** estiver abaixo de **LowerThresholdFatal**, o estado atual será fatal.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,11 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>

Valor de limite que especifica se o sensor está operando em condições normais ou não críticas. Se a propriedade **CurrentReading** estiver entre **LowerThresholdNonCritical** e **UpperThresholdNonCritical**, o sensor estará relatando um valor normal. No entanto, se a propriedade **CurrentReading** estiver entre **LowerThresholdNonCritical** e **LowerThresholdCritical**, o estado atual será não crítico.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MaxReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,9 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>

Maior valor da propriedade medida que pode ser lido pelo sensor numérico.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MinReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,10 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>

Menor valor da propriedade medida que pode ser lido pelo sensor numérico.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NominalReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,6 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>

Valor esperado para o sensor numérico.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMax"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,7 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMin"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,8 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>
...
O Win32 Plug and Play identificador de dispositivo do dispositivo lógico.
...
Há suporte para o método [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) .
...
O método [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) pode ser invocado com o parâmetro *PowerState* definido como 5 ("ciclo de energia").
...
O método [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) pode ser invocado com o parâmetro *PowerState* definido como 5 ("ciclo de energia") e o parâmetro de *hora* definido como uma data e hora e um intervalo específicos para o Power-on.
...
Se for **true**, o dispositivo poderá ser gerenciado por energia, ou seja, colocado em um estado de economia de energia. Essa propriedade não indica que os recursos de gerenciamento de energia estão habilitados no momento ou, se habilitado, quais recursos têm suporte. Para obter mais informações, consulte a matriz **PowerManagementCapabilities** .

Se **for false**, o valor inteiro 1, para a cadeia de caracteres "sem suporte", deverá ser a única entrada na matriz **PowerManagementCapabilities** .
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Resolution"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,17 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" décimos de milliamps ")
</dt> </dl>

Capacidade do sensor de resolver diferenças na propriedade medida. Essa propriedade e as propriedades de **precisão** e **tolerância** são usadas para calcular o valor real da propriedade física medida. Esse valor pode variar dependendo se o dispositivo é linear em seu intervalo dinâmico.
...
Propriedade **CreationClassName** do sistema de escopo.
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("tolerância"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,18 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>
...
Qualificadores: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Investigação de corrente elétrica de DMTF \| 1,14 "), [**unidades**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliamps ")
</dt> </dl>

Valor limite que especifica se o sensor está operando em condições críticas. Se a **propriedade CurrentReading** estiver entre **UpperThresholdCritical** e **UpperThresholdFatal**, o estado atual será crítico.
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Sonda atual elétrica \| 001.16"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("miliaps")
</dt> </dl>

Valor limite que especifica se o sensor está operando em condições fatais. Se a **propriedade CurrentReading** estiver acima **de UpperThresholdFatal,** o estado atual será fatal.
...
Qualificadores: [**Substituir**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Electrical Current Probe \| 001.12"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("miliaps")
</dt> </dl>

Valor limite que especifica se o sensor está operando em condições normais ou não críticas. Se a **propriedade CurrentReading** estiver entre **LowerThresholdNonCritical** e **UpperThresholdNonCritical,** o sensor relatará um valor normal. Se a **propriedade CurrentReading,** no entanto, estiver entre **UpperThresholdNonCritical** e **UpperThresholdCritical,** o estado atual não será crítico.
...
A **classe \_ CurrentSensor cim** é derivada de CIM [**\_ NumericSensor**](cim-numericsensor.md).

O WMI não implementa essa classe. Para obter mais informações sobre classes WMI derivadas de **Cim \_ CurrentSensor**, consulte [Classes Win32](win32-provider.md).
