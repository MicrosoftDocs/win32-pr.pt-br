...
ms.locfileid: "119439246"
---
# <a name="cim_bootsap-class"></a>\_Classe CIM BootSAP

A classe **CIM \_ BootSAP** representa os pontos de acesso de um serviço de inicialização.
...
A classe **CIM \_ BootSAP** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **CIM \_ BootSAP** tem essas propriedades.
...
A classe **CIM \_ BootSAP** é derivada de [**\_ ServiceAccessPoint CIM**](cim-serviceaccesspoint.md).
