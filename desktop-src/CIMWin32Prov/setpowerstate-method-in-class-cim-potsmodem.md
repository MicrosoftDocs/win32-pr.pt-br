---
description: O método SetPowerState da classe CIM POTSModem define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser \_ colocado nesse estado.
ms.assetid: 805f03f1-d85b-4e18-b942-0954d07168f4
ms.tgt_platform: multiple
title: Método SetPowerState da classe CIM_POTSModem classe
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
