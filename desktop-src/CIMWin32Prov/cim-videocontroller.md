---
description: A classe CIM \_ VideoController representa os recursos e o gerenciamento do controlador de vídeo.
...
ms.locfileid: "119817496"
---
# <a name="cim_videocontroller-class"></a>Classe CIM \_ VideoController

A **classe CIM \_ VideoController** representa os recursos e o gerenciamento do controlador de vídeo.
...
A **classe CIM \_ VideoController** tem estes tipos de membros:
...
A **classe \_ VIDEOController cim** tem esses métodos.



| Método                                                                     | Descrição                                                                                                                              |
|:---------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-videocontroller.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-videocontroller.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A **classe \_ VideoController cim** tem essas propriedades.
...
Qualificadores: [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ VideoController**.**CapabilityDescriptions**")
</dt> </dl>

Elementos gráficos e recursos 3D do controlador de vídeo.
...
Qualificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexado"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ VideoController**.**AcceleratorCapabilities**")
</dt> </dl>

Cadeias de caracteres de forma livre que fornecem descrições detalhadas para os recursos do acelerador de vídeo indicados na **matriz AcceleratorCapabilities.**

> [!Note]  
> Cada entrada dessa matriz está relacionada à entrada na matriz **AcceleratorCapabilities** localizada no mesmo índice.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.12"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("bits")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.11"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("pixels")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.14")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.13")
</dt> </dl>

Se estiver no modo de caractere, número de linhas para o controlador de vídeo; caso contrário, insira 0.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.15"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.8")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.10"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("pixels")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Porta do Barramento DMTF \| \| 001.9")
</dt> </dl>

Número máximo de entidades diretamente acessível com suporte pelo controlador. Um valor de 0 deverá ser usado se o número for desconhecido ou ilimitado.

Essa propriedade é herdada do [**Controlador CIM. \_**](cim-controller.md)
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.5"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Vídeo DMTF \| \| 003.4"), [**Unidades**](/windows/desktop/WmiSdk/standard-qualifiers) ("hertz")
</dt> </dl>
...
Número de páginas de vídeo com suporte considerando as resoluções atuais e a memória disponível.
...
Windows Plug and Play identificador de dispositivo lógico do dispositivo lógico. Essa propriedade é herdada de [**CIM \_ LogicalDevice.**](cim-logicaldevice.md)
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Porta do Barramento DMTF \| \| 001.2", "MIF. Discos DMTF \| \| 003.3")
</dt> </dl>

Protocolo usado pelo controlador para acessar dispositivos 'controlados'.

Essa propriedade é herdada do [**Controlador CIM. \_**](cim-controller.md) Os valores são:
...
**Protocolo Fibre Channel SCSI** (10)
...
**Protocolo SCSI serial bus-2 (1394)** (12)
...
Data e hora da última redefinição do controlador, o que significa que o controlador foi desligado ou reinicializado.
...
Cadeia de caracteres de forma livre que descreve o controlador ou processador de vídeo.

</dd> </dl>

## <a name="remarks"></a>Comentários

A classe **CIM \_ VideoController** é derivada do [**\_ controlador CIM**](cim-controller.md).

O WMI não implementa essa classe. Para classes WMI derivadas do **CIM \_ VideoController**, consulte [classes Win32](win32-provider.md).
