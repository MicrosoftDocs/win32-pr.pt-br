...
---
# <a name="cim_videocontroller-class"></a>\_Classe CIM VideoController
...
A classe **CIM \_ VideoController** tem esses métodos.
...
A classe **CIM \_ VideoController** tem essas propriedades.
...
Qualificadores: [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("indexado"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) (**" \_ CIM VideoController**.**AcceleratorCapabilities**")
</dt> </dl>
...
> [!Note]  
> Cada entrada dessa matriz está relacionada à entrada na matriz **AcceleratorCapabilities** que está localizada no mesmo índice.
