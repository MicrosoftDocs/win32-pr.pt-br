...
| Método                                                              | Descrição                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Redefinir**](reset-method-in-class-cim-keyboard.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
...
Cadeia de caracteres de forma livre que fornece informações sobre o erro registrado na propriedade **LastErrorCode** e as ações corretivas a serem tomadas.
...
Inteiro que indica se uma senha de nível de hardware está habilitada no teclado para impedir a entrada local.
...
A classe de **\_ teclado CIM** é derivada de [**CIM \_ userdevice**](cim-userdevice.md).

O WMI não implementa essa classe. Para classes derivadas do **\_ teclado CIM**, consulte [classes Win32](win32-provider.md).
