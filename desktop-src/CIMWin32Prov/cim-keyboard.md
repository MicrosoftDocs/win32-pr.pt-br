...
ms.locfileid: "119438446"
---
# <a name="cim_keyboard-class"></a>\_Classe de teclado CIM

A classe de **\_ teclado CIM** representa os recursos e o gerenciamento do dispositivo lógico do teclado.
...
A classe de **\_ teclado CIM** tem estes tipos de membros:
...
A classe de **\_ teclado CIM** tem esses métodos.



| Método                                                              | Descrição                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Definido**](reset-method-in-class-cim-keyboard.md)                 | Solicita uma redefinição do dispositivo lógico. Não implementado pelo WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-keyboard.md) | Define o estado de energia desejado para um dispositivo lógico e quando um dispositivo deve ser colocado nesse estado. Não implementado pelo WMI.<br/> |
...
A classe de **\_ teclado CIM** tem essas propriedades.
...
Cadeia de caracteres de forma livre que fornece informações sobre o erro registrado na propriedade **LastErrorCode** e ações corretivas a ser tomadas.
...
Cadeia de caracteres de forma livre que indica o formato e o layout do teclado.
...
Número de teclas de função no teclado.
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Segurança de hardware do sistema DMTF \| \| 001.2")
</dt> </dl>

Inteiro que indica se uma senha no nível de hardware está habilitada no teclado para impedir a entrada local.
...
A **classe \_ teclado CIM** é derivada de CIM [**\_ UserDevice**](cim-userdevice.md).

O WMI não implementa essa classe. Para classes derivadas do **teclado CIM, \_** consulte [Classes Win32](win32-provider.md).
