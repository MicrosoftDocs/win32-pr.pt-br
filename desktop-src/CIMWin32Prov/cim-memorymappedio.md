---
description: A classe CIM \_ MemoryMappedIO representa a E/S mapeada na memória da arquitetura do computador. Essa classe trata de recursos de E/S de memória e porta.
...
ms.locfileid: "119021054"
---
# <a name="cim_memorymappedio-class"></a>Classe CIM \_ MemoryMappedIO

A **classe CIM \_ MemoryMappedIO representa** a E/S mapeada na memória da arquitetura do computador. Essa classe trata de recursos de E/S de memória e porta.
...
A **classe CIM \_ MemoryMappedIO** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A **classe CIM \_ MemoryMappedIO** tem essas propriedades.
...
Qualificadores: [**propagados**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ ComputerSystem**](cim-computersystem.md).**Nome**"), [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**Chave \_ CIM**](/windows/desktop/WmiSdk/standard-wmi-qualifiers)
</dt> </dl>
...
Qualificadores: [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. E/S mapeada de memória DMTF \| \| 001.2")
</dt> </dl>
...
Qualificadores: [**\_ Chave CIM,**](/windows/desktop/WmiSdk/standard-wmi-qualifiers) [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. E/S mapeada de memória DMTF \| \| 001.1")
</dt> </dl>
...
A **classe CIM \_ MemoryMappedIO** é derivada de [**CIM \_ SystemResource**](cim-systemresource.md).

O WMI não implementa essa classe. Para classes derivadas de **CIM \_ MemoryMappedIO**, consulte [Classes Win32](win32-provider.md).
