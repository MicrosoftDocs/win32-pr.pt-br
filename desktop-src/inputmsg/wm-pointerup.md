...
ms.locfileid: "118756794"
---
# <a name="wm_pointerup-message"></a>Mensagem WM_POINTERUP

Postado quando um ponteiro que fez contato na área do cliente de uma janela quebra o contato. Essa mensagem de entrada visa a janela sobre a qual o ponteiro faz contato e o ponteiro é, nesse ponto, implicitamente capturado para a janela para que a janela continue a receber mensagens de entrada, incluindo a notificação de **WM_POINTERUP** para o ponteiro até que ele interrompa o contato.
...
O exemplo de código a seguir mostra como recuperar a posição x e y do ponteiro associado com esta mensagem.
...
O exemplo de código a seguir mostra como tratar diferentes tipos de ponteiro associados a essa mensagem.
