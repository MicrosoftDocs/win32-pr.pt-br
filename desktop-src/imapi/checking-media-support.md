...
---
# <a name="checking-media-support"></a>Verificando o suporte de mídia

O script a seguir examina as características da mídia carregada no dispositivo de disco. Mais especificamente, ele verifica o tipo de mídia e o estado atual da mídia, bem como o gravador e a compatibilidade de mídia. Esse script pode ser adaptado para verificar a compatibilidade e os problemas de estado antes de usar a mídia.
