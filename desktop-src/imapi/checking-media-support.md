---
title: Verificando o suporte de mídia
description: O script a seguir examina as características da mídia carregada no dispositivo de disco.
...
ms.locfileid: "104159654"
---
# <a name="checking-media-support"></a><span data-ttu-id="63151-103">Verificando o suporte de mídia</span><span class="sxs-lookup"><span data-stu-id="63151-103">Checking Media Support</span></span>

<span data-ttu-id="63151-104">O script a seguir examina as características da mídia carregada no dispositivo de disco.</span><span class="sxs-lookup"><span data-stu-id="63151-104">The following script examines characteristics of the media loaded in the disc device.</span></span> <span data-ttu-id="63151-105">Mais especificamente, ele verifica o tipo de mídia e o estado atual da mídia, bem como o gravador e a compatibilidade de mídia.</span><span class="sxs-lookup"><span data-stu-id="63151-105">More specifically, it checks the media type and the current state of the media, as well as recorder and media compatibility.</span></span> <span data-ttu-id="63151-106">Esse script pode ser adaptado para verificar a compatibilidade e os problemas de estado antes de usar a mídia.</span><span class="sxs-lookup"><span data-stu-id="63151-106">This script can be adapted to verify compatibility and state issues before using the media.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="63151-107">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="63151-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="63151-108">Usando o IMAPi</span><span class="sxs-lookup"><span data-stu-id="63151-108">Using IMAPI</span></span>](using-imapi.md)
</dt> <dt>

[<span data-ttu-id="63151-109">**\_tipo físico de mídia IMAPI \_ \_**</span><span class="sxs-lookup"><span data-stu-id="63151-109">**IMAPI\_MEDIA\_PHYSICAL\_TYPE**</span></span>](/windows/desktop/api/imapi2/ne-imapi2-imapi_media_physical_type)
</dt> <dt>

[<span data-ttu-id="63151-110">**IDiscMaster2**</span><span class="sxs-lookup"><span data-stu-id="63151-110">**IDiscMaster2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscmaster2)
</dt> <dt>

[<span data-ttu-id="63151-111">**IDiscRecorder2**</span><span class="sxs-lookup"><span data-stu-id="63151-111">**IDiscRecorder2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscrecorder2)
</dt> <dt>

[<span data-ttu-id="63151-112">**IDiscFormat2Data**</span><span class="sxs-lookup"><span data-stu-id="63151-112">**IDiscFormat2Data**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscformat2data)
</dt> </dl>
