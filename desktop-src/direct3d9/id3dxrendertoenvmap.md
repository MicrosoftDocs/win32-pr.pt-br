...
| [**End**](id3dxrendertoenvmap--end.md)                         | Restaurar todos os destinos de renderização e, se necessário, compor todas as faces renderizadas na superfície do mapa do ambiente.<br/>                                                                           |
| [**Face**](id3dxrendertoenvmap--face.md)                       | Inicie o desenho de cada face de um mapa de ambiente.<br/>                                                                                                                              |
