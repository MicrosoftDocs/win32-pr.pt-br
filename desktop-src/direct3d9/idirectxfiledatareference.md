...
ms.locfileid: "120095626"
---
# <a name="idirectxfiledatareference-interface"></a>Interface IDirectXFileDataReference

Os aplicativos usam os métodos da interface IDirectXFileDataReference para dar suporte a objetos de referência de dados. Um objeto de referência de dados refere-se a um objeto de dados definido anteriormente no arquivo. Isso permite que você use o mesmo objeto várias vezes sem repeti-lo no arquivo. Preterido.
...
O GUID da interface IDirectXFileDataReference é IID \_ IDirectXFileDataReference.
