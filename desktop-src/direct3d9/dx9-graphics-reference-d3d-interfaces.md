...
---
# <a name="direct3d-interfaces"></a>Interfaces do Direct3D

Esta seção contém informações de referência para as interfaces de Component Object Model (COM) fornecidas pelo Microsoft Direct3D 9.

> [!Note]  
> Os aplicativos da Windows Store do Direct3D não podem usar a API do Direct3D 9. Em vez disso, use a API do Microsoft Direct3D 11 ou posterior com [nível de recurso](../direct3d11/overviews-direct3d-11-devices-downlevel-intro.md) 9 \_ x.

 

As interfaces a seguir são usadas com o Direct3D 9.
...
As interfaces a seguir estão disponíveis somente no Direct3D 9Ex.
