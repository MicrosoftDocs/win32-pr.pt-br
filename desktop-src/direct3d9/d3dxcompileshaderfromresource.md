...
ms.locfileid: "118988672"
---
# <a name="d3dxcompileshaderfromresource-function"></a>Função D3DXCompileShaderFromResource
...
Ponteiro para uma cadeia de caracteres que especifica o nome do recurso.
...
Ponteiro de interface opcional, [**ID3DXInclude**](id3dxinclude.md), a ser usado para manipulação de \# diretivas include. Se esse valor for **NULL**, \# inclusões será respeitado durante a compilação de um arquivo ou ocorrerá um erro quando compilado de um recurso ou memória.
