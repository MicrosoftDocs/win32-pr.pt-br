---
description: Cria uma textura de cubo de um arquivo. Essa é uma função mais avançada do que D3DXCreateCubeTextureFromFile.
...
ms.locfileid: "120027776"
---
# <a name="d3dxcreatecubetexturefromfileex-function"></a>Função D3DXCreateCubeTextureFromFileEx

Cria uma textura de cubo de um arquivo. Essa é uma função mais avançada do [**que D3DXCreateCubeTextureFromFile**](d3dxcreatecubetexturefromfile.md).
...
Uma combinação de uma ou mais constantes [D3DX \_ FILTER,](d3dx-filter.md) controlando como a imagem é filtrada. Especificar D3DX DEFAULT para esse parâmetro é o equivalente a especificar \_ D3DX \_ FILTER \_ TRIANGLE \| D3DX \_ FILTER \_ DITHER.
