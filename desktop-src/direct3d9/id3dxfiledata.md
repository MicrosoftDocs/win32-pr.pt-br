...
| [**Bloqueio**](id3dxfiledata--lock.md)               | Acessa os dados do arquivo. x.<br/>                                                                                |
| [**Automático**](id3dxfiledata--unlock.md)           | Termina o ciclo de vida do ponteiro *ppData* retornado por [**ID3DXFileData:: Lock**](id3dxfiledata--lock.md).<br/> |
