...
ms.locfileid: "119241486"
---
# <a name="d3dxassembleshaderfromfile-function"></a>Função D3DXAssembleShaderFromFile
...
A configuração do compilador também determina a versão da função. Se Unicode for definido, a chamada de função será resolvida para D3DXAssembleShaderFromFileW. Caso contrário, a chamada de função será resolvida para D3DXAssembleShaderFromFileA porque as cadeias de caracteres ANSI estão sendo usadas.
