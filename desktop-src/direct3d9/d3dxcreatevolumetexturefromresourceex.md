...
---
# <a name="d3dxcreatevolumetexturefromresourceex-function"></a>Função D3DXCreateVolumeTextureFromResourceEx

Cria uma textura de volume a partir de um recurso especificado por uma cadeia de caracteres. Essa é uma função mais avançada do que [**D3DXCreateVolumeTextureFromResource**](d3dxcreatevolumetexturefromresource.md).
