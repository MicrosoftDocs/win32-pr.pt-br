...
Ponteiro para uma estrutura [**D3DXVECTOR3**](d3dxvector3.md) que é a matriz projetada do espaço da tela para o espaço de objeto.

## <a name="remarks"></a>Comentários

O valor de retorno para essa função é o mesmo valor retornado no parâmetro *pout* . Dessa forma, a função [**D3DXVec3Unproject**](d3dxvec3unproject.md) pode ser usada como um parâmetro para outra função.
