---
description: Recupera o dispositivo Direct3D associado ao objeto de fonte.
...
ms.locfileid: "119121143"
---
# <a name="id3dxfontgetdevice-method"></a>Método ID3DXFont::GetDevice

Recupera o dispositivo Direct3D associado ao objeto de fonte.
...
Endereço de um ponteiro para uma interface [**IDirect3DDevice9,**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3ddevice9) que representa o objeto de dispositivo Direct3D associado ao objeto de fonte.
