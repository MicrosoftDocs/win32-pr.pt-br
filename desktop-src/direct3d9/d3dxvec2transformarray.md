...
O valor de retorno para essa função é o mesmo valor retornado no parâmetro *pout* . Dessa forma, a função [**D3DXVec2Transform**](d3dxvec2transform.md) pode ser usada como um parâmetro para outra função.
