...
Cria um [**ID3DXEffectCompiler**](id3dxeffectcompiler.md) a partir de uma descrição de efeito ASCII.
...
A configuração do compilador também determina a versão da função. Se o Unicode for definido, a chamada de função será resolvida como D3DXCreateEffectCompilerFromResourceW. Caso contrário, a chamada de função é resolvida como D3DXCreateEffectCompilerFromResourceA porque as cadeias de caracteres ANSI estão sendo usadas.
