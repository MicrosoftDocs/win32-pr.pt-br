...
title: D3DXREGISTER_SET enumeração (D3dx9shader.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
---
# <a name="d3dxregister_set-enumeration"></a>Enumeração D3DXREGISTER \_ SET
...
O registro contém dados de amostra 4D.
