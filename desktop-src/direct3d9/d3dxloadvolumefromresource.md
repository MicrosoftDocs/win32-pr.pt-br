...
ms.locfileid: "119122906"
---
# <a name="d3dxloadvolumefromresource-function"></a>Função D3DXLoadVolumeFromResource
...
Ponteiro para uma cadeia de caracteres que especifica o nome do arquivo da imagem de origem. Se UNICODE ou UNICODE for definido, esse tipo de parâmetro \_ será LPCWSTR; caso contrário, o tipo será LPCSTR.
