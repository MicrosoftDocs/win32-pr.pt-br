...
## <a name="mipmapped-cubic-environment-maps"></a>Mapas de ambiente mipmapped cúbico
...
## <a name="texture-coordinates-for-cubic-environment-maps"></a>Coordenadas de textura para mapas de ambiente cúbico
