...
Retorna um vetor 2D que é composto pelos maiores componentes de dois vetores 2D.
...
Ponteiro para uma estrutura [**D3DXVECTOR2**](d3dxvector2.md) que é composta pelos maiores componentes dos dois vetores.

## <a name="remarks"></a>Comentários

O valor de retorno para essa função é o mesmo valor retornado no parâmetro *pout* . Dessa forma, a função **D3DXVec2Maximize** pode ser usada como um parâmetro para outra função.
