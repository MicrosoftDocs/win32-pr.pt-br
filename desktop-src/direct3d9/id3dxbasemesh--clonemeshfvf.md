---
description: Clona uma malha usando um código FVF (formato de vértice flexível).
...
ms.locfileid: "119121808"
---
# <a name="id3dxbasemeshclonemeshfvf-method"></a>Método ID3DXBaseMesh::CloneMeshFVF

Clona uma malha usando um código FVF (formato de vértice flexível).
...
Combinação de códigos FVF, que especifica o formato de vértice para os vértices na malha de saída. Para os valores dos códigos, consulte [D3DFVF](d3dfvf.md).
