---
description: O D3DX fornece as seguintes funções de texting.
...
ms.locfileid: "119728157"
---
# <a name="texture-functions-in-d3dx-9"></a>Funções de textura no D3DX 9

O D3DX fornece as seguintes funções de texting.
