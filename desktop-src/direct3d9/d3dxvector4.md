...
ms.locfileid: "119952236"
---
# <a name="d3dxvector4-structure-d3dx9mathh"></a>Estrutura D3DXVECTOR4 (D3dx9math. h)

Descreve um vetor de quatro componentes, incluindo sobrecargas de operador e conversões de tipo.
...
### <a name="d3dxvector4-extensions"></a>Extensões D3DXVECTOR4

O D3DXVECTOR4 tem as seguintes extensões C++.
