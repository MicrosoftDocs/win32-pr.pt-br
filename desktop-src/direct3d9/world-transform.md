---
description: A discussão sobre a transformação mundial apresenta conceitos básicos e fornece detalhes sobre como configurar uma transformação de mundo.
ms.assetid: c3d3b247-e482-4750-a6fb-724f81ee2b19
title: Transformação Mundo (Direct3D 9)
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="world-transform-direct3d-9"></a>Transformação Mundo (Direct3D 9)

A discussão sobre a transformação mundial apresenta conceitos básicos e fornece detalhes sobre como configurar uma transformação de mundo.

## <a name="what-is-a-world-transform"></a>O que é uma transformação de mundo?
...
O exemplo a seguir, de uma classe de modelo 3D fictícia escrita em C++, usa as funções auxiliares incluídas na biblioteca do utilitário D3DX para criar uma matriz mundial que inclui três rotações para orientar um modelo e uma tradução para realocá-lo em relação à sua posição no espaço do mundo.
...
Depois de preparar a matriz world, chame o método [**IDirect3DDevice9::SetTransform**](/windows/desktop/api) para defini-la, especificando a macro [**D3DTS \_ WORLD**](d3dts-world.md) para o primeiro parâmetro.
