---
description: O D3DX fornece as seguintes funções de sombreador.
ms.assetid: 541e8988-db05-4e25-84f1-c6799f31e442
title: Funções de sombreador (gráficos do Direct3D 9)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105772678"
---
# <a name="shader-functions-direct3d-9-graphics"></a>Funções de sombreador (gráficos do Direct3D 9)

O D3DX fornece as seguintes funções de sombreador.
