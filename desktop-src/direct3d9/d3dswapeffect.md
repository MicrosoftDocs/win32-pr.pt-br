...
|                                                                                                                                                                                         |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Diferenças entre o Direct3D 9 e o Direct3D 9Ex:<br/> A \_ sobreposição de D3DSWAPEFFECT só está disponível no Direct3D9Ex em execução no Windows 7 (ou mais no sistema operacional atual).<br/> |
...
|                                                                                                                                                                                        |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Diferenças entre o Direct3D 9 e o Direct3D 9Ex:<br/> O D3DSWAPEFFECT \_ FLIPEX só está disponível no Direct3D9Ex em execução no Windows 7 (ou mais no sistema operacional atual).<br/> |
