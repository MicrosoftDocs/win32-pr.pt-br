...
|                                                                                                                                                                                               |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Diferenças entre o Direct3D 9 e o Direct3D 9Ex:<br/> O D3DQUERYTYPE \_ MEMORYPRESSURE só está disponível no Direct3D9Ex em execução no Windows 7 (ou mais no sistema operacional atual).<br/> |
