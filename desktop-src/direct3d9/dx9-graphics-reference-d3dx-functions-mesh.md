...
ms.locfileid: "119856856"
---
# <a name="mesh-functions-direct3d-9-graphics"></a>Funções de malha (gráficos do Direct3D 9)

O D3DX fornece as seguintes funções de malha.
...
[Funções D3DX](dx9-graphics-reference-d3dx-functions.md)
</dt> <dt>
