...
ms.locfileid: "118523397"
---
# <a name="templates-x-file-format-binary-encoding"></a>Modelos (formato de arquivo X, codificação binária)

Um modelo tem a seguinte definição de sintaxe.
