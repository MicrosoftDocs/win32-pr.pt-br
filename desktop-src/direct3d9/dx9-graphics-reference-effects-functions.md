---
description: Há várias funções que ajudam a criar e compilar efeitos.
ms.assetid: 8aa68b19-d248-448a-9364-42913253c55f
title: Funções de efeito
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "120026976"
---
# <a name="effect-functions"></a>Funções de efeito

Há várias funções que ajudam a criar e compilar efeitos.
