...
ms.locfileid: "117731274"
---
# <a name="d3dxshcompressqualitytype-enumeration"></a>Enumeração D3DXSHCOMPRESSQUALITYTYPE

Configuração de compactação esférica harmônica (SH).
...
A compactação de dados é de baixa qualidade, mas é rápida de compactar.
...
A compactação de dados é de alta qualidade, mas é lenta para compactar.

</dd> <dt>

<span id="D3DXSHCQUAL_FORCE_DWORD"></span><span id="d3dxshcqual_force_dword"></span>**D3DXSHCQUAL \_ forçar \_ DWORD**
</dt> <dd>
