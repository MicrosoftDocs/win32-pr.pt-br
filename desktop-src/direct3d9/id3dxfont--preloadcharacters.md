...
---
# <a name="id3dxfontpreloadcharacters-method"></a>ID3DXFont: método reloadCharacters de:P
...
Os caracteres não serão renderizados para o dispositivo; O [**DrawText**](id3dxfont--drawtext.md) ainda deve ser chamado para renderizar os caracteres. No entanto, ao pré-carregar caracteres na memória de vídeo, o **DrawText** usará substancialmente menos recursos de CPU.
