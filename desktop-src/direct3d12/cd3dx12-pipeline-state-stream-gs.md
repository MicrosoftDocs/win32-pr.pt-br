...
---
# <a name="cd3dx12_pipeline_state_stream_gs-structure"></a>\_ \_ \_ Estrutura GS do fluxo de estado do pipeline CD3DX12 \_

Uma estrutura auxiliar usada para descrever um sombreador de geometria como um único objeto adequado para uma descrição de fluxo.
...
**\_Fluxo de estado do pipeline CD3DX12 \_ \_ \_ GS**
</dt> <dd>
...
**\_ \_ \_ Fluxo de estado do pipeline CD3DX12 \_ GS (D3D12 do \_ código de bytes do sombreador do \_ am&i)**
</dt> <dd>
