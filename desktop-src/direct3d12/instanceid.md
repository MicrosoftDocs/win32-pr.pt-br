---
description: O identificador fornecido pelo usuário para a instância na instância da estrutura de aceleração de nível inferior dentro da estrutura de nível superior.
ms.assetid: ''
title: InstanceId
...
ms.locfileid: "118528308"
---
# <a name="instanceid"></a>InstanceId

O identificador fornecido pelo usuário para a instância na instância da estrutura de aceleração de nível inferior dentro da estrutura de nível superior.
