...
---
# <a name="directml-helper-functions"></a>Funções auxiliares DirectML

## <a name="dmlcalcbuffertensorsize"></a>DMLCalcBufferTensorSize

Essa função auxiliar calcula o número mínimo de bytes necessários para armazenar um buffer tensor com o tipo, os tamanhos e os avanços especificados. A fórmula pode ser expressa da seguinte maneira.
...
Em outras palavras, o tamanho mínimo de um tensor é o índice do elemento de um passado ao final, multiplicado pelo tamanho do elemento (por exemplo, 2 bytes para um tensor **FLOAT16** ). Além disso, o DirectML requer que todos os buffers associados tenham um tamanho total alinhado em **DWORD** e, portanto, o tamanho mínimo implícito em bytes deve ser arredondado para o limite mais próximo de 4 bytes.
...
Essa função auxiliar calcula o sobremissões para os dezenases de 4D com o layout NCHW ou NHWC e a difusão opcional.
