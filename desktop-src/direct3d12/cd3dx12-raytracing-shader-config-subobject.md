...
description: Uma classe auxiliar para criar um subobjeto de estado de configuração do sombreador de raio.
keywords:
...
ms.locfileid: "121812914"
---
# <a name="cd3dx12_raytracing_shader_config_subobject-class"></a>CD3DX12_RAYTRACING_SHADER_CONFIG_SUBOBJECT classe

Uma classe auxiliar para criar um subobjeto de estado de configuração do sombreador de raio.
...
Construtor que cria uma nova instância de um **CD3DX12_RAYTRACING_SHADER_CONFIG_SUBOBJECT** inicializado com o conteúdo de um [**CD3DX12_STATE_OBJECT_DESC**](cd3dx12-state-object-desc.md) objeto .
...
Recupera o tipo do subobjeto, representado pela [D3D12_STATE_SUBOBJECT_TYPE_RAYTRACING_SHADER_CONFIG](/windows/win32/api/d3d12/ne-d3d12-d3d12_state_subobject_type) constante.
...
Operador de conversão que retorna uma referência a um [objeto D3D12_RAYTRACING_SHADER_CONFIG](/windows/win32/api/d3d12/ns-d3d12-d3d12_raytracing_shader_config) constante que descreve o objeto de estado.
