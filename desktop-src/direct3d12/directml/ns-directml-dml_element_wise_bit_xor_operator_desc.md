...
---
# <a name="dml_element_wise_bit_xor_operator_desc-structure-directmlh"></a>DML_ELEMENT_WISE_BIT_XOR_OPERATOR_DESC estrutura (directml.h)

Calcula o XOR bit a bit (eXclusive OR) entre cada elemento correspondente dos tensores de entrada e grava o resultado no tensor de saída.

O tensor de entrada e saída deve ter o mesmo *DimensionCount,* *Tamanhos* e *DataType*.

Esse operador dá suporte à execução in-loca, o que significa que o tensor de saída tem permissão para alias um ou mais dos tensores de entrada durante a associação.
