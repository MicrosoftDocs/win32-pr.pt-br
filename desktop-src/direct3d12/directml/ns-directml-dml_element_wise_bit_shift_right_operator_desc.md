...
---
# <a name="dml_element_wise_bit_shift_right_operator_desc-structure-directmlh"></a>DML_ELEMENT_WISE_BIT_SHIFT_RIGHT_OPERATOR_DESC estrutura (directml.h)

Executa um deslocamento lógico para a direita de cada elemento *de ATensor* por um número de bits determinados pelo elemento correspondente *de BTensor*, colocando o resultado no elemento correspondente *de OutputTensor*.
