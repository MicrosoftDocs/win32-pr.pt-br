...
---
# <a name="dml_element_wise_modulus_floor_operator_desc-structure-directmlh"></a>DML_ELEMENT_WISE_MODULUS_FLOOR_OPERATOR_DESC estrutura (directml.h)

Calcula o módulo, com os mesmos resultados que o módulo do Python, para cada par de elementos correspondentes dos tensores de entrada, colocando o resultado no elemento correspondente *de OutputTensor*.

Como o quociente é arredondado para -inf, o resultado terá o mesmo sinal que o divisor.
