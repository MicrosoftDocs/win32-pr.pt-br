...
---
# <a name="dml_element_wise_modulus_floor_operator_desc-structure-directmlh"></a>Estrutura de DML_ELEMENT_WISE_MODULUS_FLOOR_OPERATOR_DESC (directml. h)

Computa o módulo, com os mesmos resultados que o módulo python, para cada par de elementos correspondentes dos tempos de entrada, colocando o resultado no elemento correspondente de *OutputTensor*.

Como o quociente é arredondado para o inf, o resultado terá o mesmo sinal do divisor.
