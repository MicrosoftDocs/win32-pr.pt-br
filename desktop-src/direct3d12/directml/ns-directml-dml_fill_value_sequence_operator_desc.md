...
---
# <a name="dml_fill_value_sequence_operator_desc-structure-directmlh"></a>DML_FILL_VALUE_SEQUENCE_OPERATOR_DESC estrutura (directml.h)
...
### <a name="example-1-1d-ascending-step"></a>Exemplo 1. Etapa crescente 1D
...
### <a name="example-2-2d-ascending-step"></a>Exemplo 2. Etapa crescente 2D
