...
---
# <a name="dml_element_wise_modulus_truncate_operator_desc-structure-directmlh"></a>Estrutura de DML_ELEMENT_WISE_MODULUS_TRUNCATE_OPERATOR_DESC (directml. h)

Computa o operador de módulo C para cada par de elementos correspondentes dos tempos de entrada, colocando o resultado no elemento correspondente de *OutputTensor*.

Como o quociente é arredondado em direção a 0, o resultado terá o mesmo sinal que o dividendo.
