...
---
# <a name="win32_tsvirtualipsetting-class"></a>\_Classe Win32 TSVirtualIPSetting
...
A classe **Win32 \_ TSVirtualIPSetting** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Win32 \_ TSVirtualIPSetting** tem essas propriedades.
...
Tipo de dados: **[ **Win32 \_ TerminalService**](win32-terminalservice.md)**
</dt> <dt>
...
Uma referência a um [**objeto \_ TerminalService do Win32**](win32-terminalservice.md) que é a classe do elemento para a associação.
...
Tipo de dados: **[ **Win32 \_ TSVirtualIP**](win32-tsvirtualip.md)**
</dt> <dt>
...
Uma referência a um [**objeto \_ TSVirtualIP do Win32**](win32-tsvirtualip.md) que é a classe de configuração para a associação.
