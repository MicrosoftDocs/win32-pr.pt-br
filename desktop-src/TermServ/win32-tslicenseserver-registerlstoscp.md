...
---
# <a name="registerlstoscp-method-of-the-win32_tslicenseserver-class"></a>Método RegisterLSToSCP da classe Win32 \_ TSLicenseServer

Registra o servidor de licença de Área de Trabalho Remota como um ponto de conexão de serviço no Active Directory Domain Services.
