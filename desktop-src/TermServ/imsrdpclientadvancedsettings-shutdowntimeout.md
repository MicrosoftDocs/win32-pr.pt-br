...
Especifica o período de tempo, em segundos, para aguardar até que o servidor responda a uma solicitação de desconexão.

Se o servidor não responder dentro do tempo especificado, o controle de cliente será desconectado.
...
O novo horário, em segundos. O valor padrão da propriedade é 10. O valor máximo é 600, que representa 10 minutos.
