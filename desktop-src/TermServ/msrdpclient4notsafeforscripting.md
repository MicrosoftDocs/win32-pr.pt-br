...
keywords:
- Classe MsRdpClient4NotSafeForScripting Serviços de Área de Trabalho Remota
- Classe MsRdpClient4NotSafeForScripting Serviços de Área de Trabalho Remota , descrita
topic_type:
- apiref
api_name:
...
**MsRdpClient4NotSafeForScripting** tem estes tipos de membros:
...
A **classe MsRdpClient4NotSafeForScripting** tem esses métodos.
...
| [**OnAuthenticationWarningDisplayed**](imstscaxevents-onauthenticationwarningdisplayed.md) | Chamado antes de um controle ActiveX exibição de uma caixa de diálogo de autenticação (por exemplo, a caixa de diálogo de erro de certificado).<br/>                                                                                                                                                            |
...
A **classe MsRdpClient4NotSafeForScripting** tem essas propriedades.
...
| [**AdvancedSettings2**](imsrdpclient-advancedsettings2.md)<br/>                     | Somente leitura<br/>  | Ponteiro para a interface [**IMsRdpClientAdvancedSettings,**](imsrdpclientadvancedsettings-interface.md) usada para definir configurações avançadas para o controle do cliente.<br/>                                    |
...
| [**AdvancedSettings4**](imsrdpclient3-advancedsettings4.md)<br/>                    | Somente leitura<br/>  | Ponteiro para a interface [**IMsRdpClientAdvancedSettings3,**](imsrdpclientadvancedsettings3.md) usada para definir configurações avançadas para o controle do cliente.<br/>                                            |
...
| [**ClearTextPassword**](imstscnonscriptable-cleartextpassword.md)<br/>              | Somente gravação<br/> | A Área de Trabalho Remota ActiveX controle de senha, em formato de texto não criptografado.<br/>                                                                                                                                 |
...
| [**DisconnectedText**](imstscax-disconnectedtext.md)<br/>                           | Leitura/gravação<br/> | O texto que aparece centralizado no controle antes de uma conexão ser encerrada.<br/>                                                                                                                  |
| [**Domínio**](imstscax-domain.md)<br/>                                               | Leitura/gravação<br/> | O domínio no qual o usuário atual faz o login.<br/>                                                                                                                                                     |
| [**ExtendedDisconnectReason**](imsrdpclient-extendeddisconnectreason.md)<br/>       | Somente leitura<br/>  | Informações estendidas sobre o motivo da desconexão do controle do cliente.<br/>                                                                                                                         |
...
| [**SecuredSettings2**](imsrdpclient-securedsettings2.md)<br/>                       | Somente leitura<br/>  | Ponteiro para a interface [**IMsRdpClientSecuredSettings,**](imsrdpclientsecuredsettings-interface.md) usada para definir configurações protegidas para o controle do cliente.<br/>                                       |
...
| CLSID<br/>                    | CLSID \_ MsRdpClient4NotSafeForScripting é definido como 6AE29350-321B-42BE-BBE5-12FB5270C0DE<br/> |
