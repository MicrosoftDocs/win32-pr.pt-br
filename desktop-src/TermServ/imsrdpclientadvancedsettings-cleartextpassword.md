...
---
# <a name="imsrdpclientadvancedsettingscleartextpassword-property"></a>Propriedade IMsRdpClientAdvancedSettings:: ClearTextPassword

Especifica a senha com a qual se conectar. Para obter mais informações, consulte a interface [**IMsTscNonScriptable**](imstscnonscriptable-interface.md) .

> [!Caution]  
> Embora o acesso programável a senhas de texto não criptografado esteja disponível por meio dessa propriedade, ainda é responsabilidade do desenvolvedor exercitar a cada cuidado e manter a segurança ao passar senhas em seus aplicativos.
