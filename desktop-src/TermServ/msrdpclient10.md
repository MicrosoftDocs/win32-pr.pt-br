...
keywords:
- Classe MsRdpClient10 Serviços de Área de Trabalho Remota
- Classe MsRdpClient10 Serviços de Área de Trabalho Remota , descrita
topic_type:
- apiref
api_name:
- MsRdpClient10
...
<td style="text-align: left;">Leitura/gravação<br/></td>
<td style="text-align: left;">Especifica se o usuário iniciou o controle de cliente usando a interface de Acesso via Web RD.<br/></td>
</tr>
<tr class="even">
