...
ms.locfileid: "122465463"
---
# <a name="msrdpclient10-class"></a>Classe MsRdpClient10

Controle de cliente RDP da Microsoft (redistribuível)-versão 11
...
**MsRdpClient10** tem estes tipos de membros:
...
A classe **MsRdpClient10** tem esses métodos.
...
A **classe MsRdpClient10** tem essas propriedades.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient10 é definido como C0EFA91A-EEB7-41C7-97FA-F0ED645EFB24<br/>     |
