...
description: fornece acesso às propriedades não programáveis da sessão remota de um cliente no controle de ActiveX de Área de Trabalho Remota. Deriva da interface IMsRdpClientNonScriptable.
