...
description: C \ código de exemplo que mostra um método que retorna True se a função de servidor Serviços de Área de Trabalho Remota estiver instalada e em execução ou false caso contrário, começando com Windows server 2008.
