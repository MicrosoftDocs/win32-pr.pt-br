...
---
# <a name="activateserverautomatic-method-of-the-win32_tslicenseserver-class"></a>Método ActivateServerAutomatic da classe Win32 \_ TSLicenseServer

Ativa a Área de Trabalho Remota servidor de licença automaticamente pela Internet.
...
Esse método falha, a menos que as propriedades **FirstName**, **LastName**, **Company** e **CountryRegion** sejam definidas.
