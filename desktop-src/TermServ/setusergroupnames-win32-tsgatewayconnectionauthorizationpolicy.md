...
---
# <a name="setusergroupnames-method-of-the-win32_tsgatewayconnectionauthorizationpolicy-class"></a>Método SetUserGroupNames da classe Win32 \_ TSGatewayConnectionAuthorizationPolicy

Define a propriedade **Usergroupnames** para esta área de trabalho remota política de autorização de conexão (RD CAP).
