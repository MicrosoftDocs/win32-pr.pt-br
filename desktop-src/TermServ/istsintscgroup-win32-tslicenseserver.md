...
---
# <a name="istsintscgroup-method-of-the-win32_tslicenseserver-class"></a>Método IsTSinTSCGroup da classe Win32 \_ TSLicenseServer

Recupera se um servidor de Host da Sessão da Área de Trabalho Remota (Host da Sessão RD) é membro do grupo local computadores Terminal Server no servidor de licença Área de Trabalho Remota.
...
Valor booliano que indica se o servidor de Host da Sessão RD é membro do grupo local de computadores Terminal Server.
