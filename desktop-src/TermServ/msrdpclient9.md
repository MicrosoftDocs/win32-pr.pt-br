...
keywords:
- Classe MsRdpClient9 Serviços de Área de Trabalho Remota
- Classe MsRdpClient9 Serviços de Área de Trabalho Remota , descrita
topic_type:
- apiref
api_name:
- MsRdpClient9
...
ms.locfileid: "122474542"
---
# <a name="msrdpclient9-class"></a>Classe MsRdpClient9

Controle de cliente RDP da Microsoft (redistribuível) – versão 10
...
**MsRdpClient9** tem estes tipos de membros:
...
A **classe MsRdpClient9** tem esses métodos.
...
A **classe MsRdpClient9** tem essas propriedades.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient9 é definido como 301B94BA-5D25-4A12-BFFE-3B6E7A616585<br/>      |
