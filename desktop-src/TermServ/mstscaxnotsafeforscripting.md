...
keywords:
- Classe MsTscAxNotSafeForScripting Serviços de Área de Trabalho Remota
- Classe MsTscAxNotSafeForScripting Serviços de Área de Trabalho Remota , descrita
topic_type:
- apiref
api_name:
...
ms.locfileid: "117756349"
---
# <a name="mstscaxnotsafeforscripting-class"></a>Classe MsTscAxNotSafeForScripting

Controle de cliente dos Serviços de Terminal da Microsoft – versão 1
...
**MsTscAxNotSafeForScripting** tem estes tipos de membros:
...
A **classe MsTscAxNotSafeForScripting** tem esses métodos.
...
A **classe MsTscAxNotSafeForScripting** tem essas propriedades.
...
| CLSID<br/>                    | CLSID \_ MsTscAxNotSafeForScripting é definido como A41A4187-5A86-4E26-B40A-856F9035D9CB<br/> |
