...
ms.locfileid: "119768906"
---
# <a name="win32_workspace-class"></a>\_Classe de espaço de trabalho Win32

Especifica Serviços de Área de Trabalho Remota informações de configuração do espaço de trabalho.
...
A classe de **\_ espaço de trabalho do Win32** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe de **\_ espaço de trabalho do Win32** tem essas propriedades.
...
Especifica se o nome do espaço de trabalho é o nome padrão. Contém zero se o nome for um nome padrão ou zero caso contrário.
...
O nome do computador do redirecionador para o espaço de trabalho.
...
O endereço alternativo para o redirecionador.
