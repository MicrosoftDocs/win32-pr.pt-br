...
---
# <a name="imsrdpclientadvancedsettingshotkeyctrlesc-property"></a>Propriedade IMsRdpClientAdvancedSettings:: HotKeyCtrlEsc

Especifica o código de chave virtual a ser adicionado a ALT para determinar a substituição de tecla de atalho para CTRL + ESC.
...
O novo código de chave virtual. **VK \_ HOME** é o valor padrão, com Alt + Home como a sequência resultante.
