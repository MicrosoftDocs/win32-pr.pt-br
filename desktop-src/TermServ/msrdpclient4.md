...
description: Controle de cliente RDP da Microsoft (redistribuível) – versão 5.
ms.assetid: 3F238C63-E860-4F27-B3D6-29F03B22E49E
ms.tgt_platform: multiple
keywords:
- Classe MsRdpClient4 Serviços de Área de Trabalho Remota
- Classe MsRdpClient4 Serviços de Área de Trabalho Remota , descrita
topic_type:
- apiref
api_name:
- MsRdpClient4
...
**MsRdpClient4** tem estes tipos de membros:
...
A **classe MsRdpClient4** tem esses métodos.
...
A classe **MsRdpClient4** tem essas propriedades.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient4 é definido como 4EDCB26C-D24C-4E72-AF07-B576699AC0DE<br/>      |
