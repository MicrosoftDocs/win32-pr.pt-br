---
title: Inserindo o controle ActiveX Área de Trabalho Remota em uma página da Web
description: Exemplo que demonstra o uso das interfaces programáveis.
...
---
# <a name="embedding-the-remote-desktop-activex-control-in-a-webpage"></a><span data-ttu-id="9c0b5-103">Inserindo o controle ActiveX Área de Trabalho Remota em uma página da Web</span><span class="sxs-lookup"><span data-stu-id="9c0b5-103">Embedding the Remote Desktop ActiveX control in a webpage</span></span>

<span data-ttu-id="9c0b5-104">Você pode inserir o controle ActiveX Área de Trabalho Remota em uma página da Web usando um código semelhante ao seguinte.</span><span class="sxs-lookup"><span data-stu-id="9c0b5-104">You can embed the Remote Desktop ActiveX control in a web page by using code that is similar to the following.</span></span>
...
<span data-ttu-id="9c0b5-105">O CLSID é para o controle ActiveX hospedado pelo Conexão de Área de Trabalho Remota (RDP) 6,0.</span><span class="sxs-lookup"><span data-stu-id="9c0b5-105">The CLSID is for the ActiveX control that is hosted by Remote Desktop Connection (RDP) 6.0.</span></span> <span data-ttu-id="9c0b5-106">Esse controle ActiveX implementa [**IMsRdpClient**](imsrdpclient-interface.md).</span><span class="sxs-lookup"><span data-stu-id="9c0b5-106">This ActiveX control implements [**IMsRdpClient**](imsrdpclient-interface.md).</span></span>

## <a name="related-topics"></a><span data-ttu-id="9c0b5-107">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="9c0b5-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="9c0b5-108">Usando o controle ActiveX Área de Trabalho Remota</span><span class="sxs-lookup"><span data-stu-id="9c0b5-108">Using the Remote Desktop ActiveX control</span></span>](using-remote-desktop-web-connection.md)
</dt> </dl>
