...
---
# <a name="win32_tsdeploymentlicensing-class"></a>\_Classe Win32 TSDeploymentLicensing

Configurações de licenciamento para a implantação de RDV (virtualização de Área de Trabalho Remota).
...
A classe **Win32 \_ TSDeploymentLicensing** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Win32 \_ TSDeploymentLicensing** tem essas propriedades.
...
Especifica os servidores de licença a serem usados.
...
Especifica se as configurações de licenciamento de toda a implantação devem ser usadas. **True** para usar essas configurações para todos os servidores nesta implantação. **false** para defini-los por servidor. Se isso for definido como **false**, todas as outras configurações de licenciamento serão ignoradas.
