---
title: Referência de API de gateway de Área de Trabalho Remota
description: Implementa plug-ins que substituem os mecanismos de autenticação e autorização padrão do gateway de Área de Trabalho Remota (Gateway RD).
