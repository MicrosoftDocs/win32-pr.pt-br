...
description: Fornece os métodos e propriedades necessários para configurar e usar o controle de cliente. Deriva da interface IMsTscAx.
ms.assetid: 6698c1d7-94d2-453c-96db-366113b95dd4
ms.tgt_platform: multiple
keywords:
- Interface IMsRdpClient Serviços de Área de Trabalho Remota
- Interface IMsRdpClient Serviços de Área de Trabalho Remota , descrita
topic_type:
- apiref
api_name:
- IMsRdpClient
...
ms.locfileid: "120010056"
---
# <a name="imsrdpclient-interface"></a>Interface IMsRdpClient

Fornece os métodos e propriedades necessários para configurar e usar o controle de cliente. Deriva da interface [**IMsTscAx.**](imstscax-interface.md)
