...
libera memória que contém [**WTS \_ informações de \_ processo \_ EX**](/windows/desktop/api/Wtsapi32/ns-wtsapi32-wts_process_info_exa) ou [**WTS estruturas de informações de \_ sessão \_ \_ 1**](/windows/desktop/api/Wtsapi32/ns-wtsapi32-wts_session_info_1a) alocadas por uma função de Serviços de Área de Trabalho Remota.
