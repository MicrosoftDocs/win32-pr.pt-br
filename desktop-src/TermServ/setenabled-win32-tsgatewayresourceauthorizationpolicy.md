...
---
# <a name="setenabled-method-of-the-win32_tsgatewayresourceauthorizationpolicy-class"></a>Método sethabilitado da \_ classe Win32 TSGatewayResourceAuthorizationPolicy

Habilita ou desabilita a RD RAP (política de autorização de recursos) de Área de Trabalho Remota definindo a propriedade **Enabled** .
...
Se **for true**, a RD RAP será habilitada. Se **for false**, a RD RAP será desabilitada.
