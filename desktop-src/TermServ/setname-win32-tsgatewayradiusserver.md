...
---
# <a name="setname-method-of-the-win32_tsgatewayradiusserver-class"></a>Método SetName da classe Win32 \_ TSGatewayRADIUSServer

Define a propriedade **Name** para este servidor de serviço RADIUS (RADIUS).
