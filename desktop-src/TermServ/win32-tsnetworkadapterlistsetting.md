...
description: Enumera a lista de adaptadores de rede que podem ser configurados para um Terminal Win32, com base no protocolo terminal e no método \_ de transporte especificados.
ms.assetid: affe440a-1a7b-49be-a4aa-d792811c59ea
ms.tgt_platform: multiple
keywords:
- Win32_TSNetworkAdapterListSetting classe Serviços de Área de Trabalho Remota
- Win32_TSNetworkAdapterListSetting classe Serviços de Área de Trabalho Remota , descrito
topic_type:
- apiref
api_name:
...
ms.locfileid: "119769436"
---
# <a name="win32_tsnetworkadapterlistsetting-class"></a>Classe Win32 \_ TSNetworkAdapterListSetting

A classe WMI **Win32 \_ TSNetworkAdapterListSetting** enumera a lista de adaptadores de rede que podem ser configurados para um [**\_ Terminal Win32,**](win32-terminal.md)com base no protocolo terminal e no método de transporte especificados.
