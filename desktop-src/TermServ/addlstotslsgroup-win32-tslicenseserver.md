...
---
# <a name="addlstotslsgroup-method-of-the-win32_tslicenseserver-class"></a>Método AddLStoTSLSGroup da classe Win32 \_ TSLicenseServer

Adiciona o Área de Trabalho Remota servidor de licença ao grupo de servidores de licença do agente de Conexão de Área de Trabalho Remota (agente de conexão RD) em um controlador de domínio no mesmo domínio que o servidor de licença do Área de Trabalho Remota.
...
O servidor de licença deve ser membro do grupo Área de Trabalho Remota servidores de licença se o servidor estiver configurado para usar o escopo de descoberta de domínio ou floresta.
