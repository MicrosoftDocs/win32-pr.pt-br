...
---
# <a name="win32_tsstartmenuapplication-class"></a>\_Classe Win32 TSStartMenuApplication

Descreve os aplicativos que estão no menu iniciar de um servidor de Host da Sessão da Área de Trabalho Remota (Host da Sessão RD).
...
A classe **Win32 \_ TSStartMenuApplication** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A classe **Win32 \_ TSStartMenuApplication** tem essas propriedades.
...
Os argumentos de linha de comando a serem usados.
...
O caminho virtual do aplicativo. Isso inclui variáveis de ambiente do sistema, como% windir%.
