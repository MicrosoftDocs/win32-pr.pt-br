...
Fornece os métodos e as propriedades necessários para configurar e usar o controle de cliente. Deriva da interface [**IMsRdpClient2**](imsrdpclient2.md) .

## <a name="members"></a>Membros

A interface **IMsRdpClient3** herda de [**IMsRdpClient2**](imsrdpclient2.md). **IMsRdpClient3** também tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A interface **IMsRdpClient3** tem essas propriedades.
...
A interface **IMsRdpClient3** foi estendida pelas seguintes interfaces, com cada nova interface herdando todos os métodos e propriedades das interfaces anteriores:
