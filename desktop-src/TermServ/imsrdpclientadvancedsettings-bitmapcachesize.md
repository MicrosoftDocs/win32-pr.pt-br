...
O tamanho, em kilobytes, do arquivo de cache de bitmap usado para bitmaps de 8 bits por pixel.
...
O novo tamanho do cache, em kilobytes. Os valores numéricos válidos são de 1 a 32, inclusive.
