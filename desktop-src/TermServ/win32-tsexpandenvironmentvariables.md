...
---
# <a name="win32_tsexpandenvironmentvariables-class"></a>\_Classe Win32 TSExpandEnvironmentVariables
...
A classe **Win32 \_ TSExpandEnvironmentVariables** tem estes tipos de membros:
...
A classe **Win32 \_ TSExpandEnvironmentVariables** tem esses métodos.



| Método                                                                                  | Descrição                                              |
|:----------------------------------------------------------------------------------------|:---------------------------------------------------------|
| [**EnvironmentVariables**](environmentvariables-win32-tsexpandenvironmentvariables.md) | Expande variáveis de ambiente definidas pelo sistema.<br/> |
...
A classe **Win32 \_ TSExpandEnvironmentVariables** tem essas propriedades.
