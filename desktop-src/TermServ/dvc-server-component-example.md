...
---
# <a name="dvc-server-module-example"></a>Exemplo de módulo de servidor DVC

O exemplo de código C++ a seguir fornece um exemplo de como criar o módulo DVC (canal virtual dinâmico) do lado do servidor.
