...
description: Adiciona o servidor de licença especificado ao final da lista de servidores de licença especificados.
ms.assetid: 2aebe7c0-5ec2-4c2d-9887-7ecd2d6ec02a
ms.tgt_platform: multiple
keywords:
- Método AddLSToSpecifiedLicenseServerList Serviços de Área de Trabalho Remota
- Método AddLSToSpecifiedLicenseServerList Serviços de Área de Trabalho Remota , Win32_TerminalServiceSetting classe
- Win32_TerminalServiceSetting classe Serviços de Área de Trabalho Remota , método AddLSToSpecifiedLicenseServerList
topic_type:
- apiref
api_name:
...
Adiciona o servidor de licença especificado ao final da lista de servidores de licença especificados.
...
O nome do servidor de licença a ser adicionar.
