...
---
# <a name="isloadbalancingserver-method-of-the-win32_tsgatewayloadbalancer-class"></a>Método IsLoadBalancingServer da classe Win32 \_ TSGatewayLoadBalancer

Determina se o servidor de gateway de área de trabalho de Área de Trabalho Remota (Gateway RD) pode executar o balanceamento de carga.
