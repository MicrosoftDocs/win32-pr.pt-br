...
description: Controle de cliente dos serviços de terminal da Microsoft (redistribuível)-versão 1.
ms.assetid: 8B8FEF40-89A5-47C0-94EE-4F4B2B5738AB
ms.tgt_platform: multiple
keywords:
- Serviços de Área de Trabalho Remota classe MsTscAx
- Serviços de Área de Trabalho Remota classe MsTscAx, descrita
topic_type:
- apiref
api_name:
- MsTscAx
...
ms.locfileid: "117756339"
---
# <a name="mstscax-class"></a>Classe MsTscAx

Controle de cliente dos serviços de terminal da Microsoft (redistribuível) – versão 1
...
**MsTscAx** tem estes tipos de membros:
...
A classe **MsTscAx** tem esses métodos.
...
A **classe MsTscAx** tem essas propriedades.
...
| CLSID<br/>                    | CLSID MsTscAx é definido como \_ 1FB464C8-09BB-4017-A2F5-EB742F04392F<br/>           |
