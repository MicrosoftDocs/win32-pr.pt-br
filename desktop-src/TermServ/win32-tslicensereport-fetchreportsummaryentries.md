...
- Método FetchReportSummaryEntries Serviços de Área de Trabalho Remota , Win32_TSLicenseReport classe
...
Recupera resumos de licenças Serviços de Área de Trabalho Remota acesso de cliente por usuário (CALs de RDS por usuário) do relatório.
