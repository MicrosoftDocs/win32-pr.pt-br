...
---
# <a name="windows-animation-overview"></a>Visão geral da animação do Windows

Esta visão geral fornece uma introdução ao Gerenciador de animação do Windows e se concentra nos principais componentes e conceitos. Para obter mais informações sobre storyboards e transições, consulte [visão geral do storyboard](storyboard-construction.md).

Este tópico contém as seguintes seções:

-   [Conceitos básicos](#basic-concepts)
-   [Componentes da animação do Windows](#components-of-windows-animation)
-   [A API de animação do Windows](#the-windows-animation-api)
...
Como exemplos, a animação do Windows é usada na barra de tarefas para ajudá-lo a gerenciar e acessar arquivos e programas, e a lupa para ampliar partes diferentes da tela para facilitar a visualização dos usuários.
...
## <a name="components-of-windows-animation"></a>Componentes da animação do Windows
...
## <a name="the-windows-animation-api"></a>A API de animação do Windows
...
Para obter a referência completa da API, consulte [referência de animação do Windows](windows-animation-reference.md). Para obter um exemplo de código, consulte [tarefas de animação do Windows](using-windows-animation.md) e exemplos de animação do [Windows](windows-animation-samples.md).

## <a name="configurations"></a>Configurações

Os aplicativos devem obter a hora atual antes de agendar uma nova animação. A seguir estão os mecanismos de tempo com suporte na animação do Windows:
...
O diagrama a seguir mostra as interações entre um aplicativo e os componentes de animação do Windows quando o aplicativo está orientando as atualizações de animação diretamente.
...
O diagrama a seguir mostra as interações entre um aplicativo e os componentes de animação do Windows quando o temporizador de animação está orientando as atualizações de animação.
...
Além de uma base básica para dar suporte à animação, a animação do Windows inclui suporte para várias técnicas de animação avançadas, incluindo:
...
[Tarefas de animação do Windows](using-windows-animation.md)
</dt> </dl>
