...
description: Indica que esta é a entrada inicial em um determinado loop.
...
---
# <a name="ui_animation_iteration_none"></a>\_iteração de animação de IU \_ \_ nenhum

Indica que esta é a entrada inicial em um determinado loop.

<dl> <dt>

<span id="UI_ANIMATION_ITERATION_NONE"></span><span id="ui_animation_iteration_none"></span>**\_iteração de animação de IU \_ \_ nenhum**
</dt> <dd> <dl> <dt>
