...
description: Indica que o intervalo entre dois quadros-chave em um storyboard deve repetir indefinidamente até que o loop de Keyframe termine no quadro-chave inicial quando o método de conclusão IUIAnimationStoryboard for chamado.
...
Indica que o intervalo entre dois quadros-chave em um storyboard deve repetir indefinidamente até que o loop de Keyframe termine no quadro-chave inicial quando o método [**IUIAnimationStoryboard:: concluir**](/windows/desktop/api/UIAnimation/nf-uianimation-iuianimationstoryboard-conclude) for chamado.



| Constante/valor                                                                                                                                                                                                                                                                                                                            | Descrição      |
|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
| <span id="UI_ANIMATION_REPEAT_INDEFINITELY_CONCLUDE_AT_START"></span><span id="ui_animation_repeat_indefinitely_conclude_at_start"></span><dl> <dt>**Interface do usuário \_ \_A animação repetida \_ indefinidamente \_ termina \_ em \_ Start**</dt> <dt>-2</dt> </dl> | INT32<br/> |
