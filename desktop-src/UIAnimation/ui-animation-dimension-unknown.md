...
---
# <a name="ui_animation_dimension_unknown"></a>dimensão de animação de interface do usuário \_ \_ \_ desconhecida

Indica que a dimensão solicitada não pode ser recuperada.



| Constante/valor                                                                                                                                                                                                                                                             | Descrição     |
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------|
| <span id="UI_ANIMATION_DIMENSION_UNKNOWN"></span><span id="ui_animation_dimension_unknown"></span><dl> <dt>**Interface do usuário \_ Dimensão de animação \_ \_ desconhecida**</dt> <dt>-1</dt> </dl> | UINT<br/> |
...
[**Método IUIAnimationVariable2:: GetDimension**](/windows/desktop/api/UIAnimation/nf-uianimation-iuianimationvariable2-getdimension)
</dt> </dl>
