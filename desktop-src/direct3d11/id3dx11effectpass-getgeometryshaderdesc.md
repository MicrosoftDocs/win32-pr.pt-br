...
Obtenha uma descrição do sombreador Geometry.
...
Um ponteiro para uma descrição Geometry-Shader (consulte [**D3DX11 \_ Pass \_ Shader \_ desc**](d3dx11-pass-shader-desc.md)).
