...
---
# <a name="d3dx11createtexturefromfile-function"></a>Função D3DX11CreateTextureFromFile
...
> -   Biblioteca [DirectXTex](https://github.com/Microsoft/DirectXTex) (ferramentas), **LoadFromXXXFile** (em que xxx é WIC, DDS ou TGA; O WIC não oferece suporte a DDS e TGA; O D3DX 9 TGA com suporte como um formato de origem de arte comum para jogos) e **CreateTexture**

 

Crie um recurso de textura a partir de um arquivo.
