...
---
# <a name="d3dx11createtexturefrommemory-function"></a>Função D3DX11CreateTextureFromMemory
...
Endereço de um ponteiro para o recurso criado. Consulte [**ID3D11Resource**](/windows/desktop/api/D3D11/nn-d3d11-id3d11resource).
