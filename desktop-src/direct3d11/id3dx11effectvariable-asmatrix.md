...
Asmatrix retorna uma versão da variável de efeito que foi especializada em uma variável de matriz. De forma semelhante a uma conversão, essa especialização retornará um objeto inválido se a variável de efeito não contiver dados de matriz.
