...
---
# <a name="layer-interfaces"></a>Interfaces de camada

Esta seção contém informações sobre as interfaces de camada.
...
<td>Uma interface de depuração controla as configurações de depuração, valida o estado do pipeline e só pode ser usada se a camada de depuração estiver ativada.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/D3D11SDKLayers/nn-d3d11sdklayers-id3d11infoqueue"><strong>ID3D11InfoQueue</strong></a><br/></td>
<td>Uma interface de fila de informações armazena, recupera e filtra mensagens de depuração. A fila consiste em uma fila de mensagens, uma pilha de filtro de armazenamento opcional e uma pilha de filtro de recuperação opcional.<br/></td>
</tr>
<tr class="odd">
...
<td>A interface de rastreamento padrão define as opções de controle padrão de referência.<br/></td>
</tr>
<tr class="even">
...
<td>A interface de acompanhamento define as opções de acompanhamento de referência.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/D3D11SDKLayers/nn-d3d11sdklayers-id3d11switchtoref"><strong>ID3D11SwitchToRef</strong></a><br/></td>
<td><blockquote>
[!Note]<br />
Não há suporte para a interface <a href="/windows/desktop/api/D3D11SDKLayers/nn-d3d11sdklayers-id3d11switchtoref"><strong>ID3D11SwitchToRef</strong></a> e seus métodos no Direct3D 11.
</blockquote>
<br/></td>
</tr>
<tr class="even">
...
<td>A interface do dispositivo de rastreamento define informações de rastreamento do sombreador, que permite o registro em log preciso e a reprodução da execução do sombreador.<br/></td>
</tr>
</tbody>
</table>
