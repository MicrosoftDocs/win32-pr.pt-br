...
Um sombreador de computação é um sombreador programável do Microsoft High-Level Shader (HLSL) que usa entrada generalizada e acesso de memória de saída para dar suporte a praticamente qualquer tipo de cálculo. Este tópico mostra como criar um sombreador de computação. A tecnologia de sombreador de computação também é conhecida como a tecnologia DirectCompute.

**Para criar um sombreador de computação:**

1.  Compile o código do sombreador HLSL chamando [**D3DCompileFromFile**](/windows/desktop/direct3dhlsl/d3dcompilefromfile).
    ```
...
2.  Crie um sombreador de computação usando [**ID3D11Device:: CreateComputeShader**](/windows/desktop/api/D3D11/nf-d3d11-id3d11device-createcomputeshader).
    ```
...
O exemplo de código anterior compila o código do sombreador de computação no arquivo ExampleCompute. HLSL. Aqui está o código em ExampleCompute. HLSL:
...
* [Aplicativo de exemplo BasicCompute11](https://github.com/walbourn/directx-sdk-samples/tree/master/BasicCompute11)