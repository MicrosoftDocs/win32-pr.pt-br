---
title: Método GetRenderTargetViewVariable ID3DX11EffectRenderTargetArray (D3dx11effect.h)
description: Obter uma matriz de destinos de renderização.
...
- ID3DX11EffectRenderTargetViewVariable interface Direct3D 11 , método GetRenderTargetArray
topic_type:
- apiref
api_name:
...
Obter uma matriz de destinos de renderização.
