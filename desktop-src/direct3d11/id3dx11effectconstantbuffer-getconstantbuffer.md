---
title: Método GetConstantBuffer ID3DX11EffectConstantBuffer (D3dx11effect.h)
description: Obter um buffer constante.
...
- ID3DX11EffectConstantBuffer interface Direct3D 11 , método GetConstantBuffer
topic_type:
- apiref
api_name:
