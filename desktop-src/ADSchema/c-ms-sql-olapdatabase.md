...
ms.locfileid: "119441206"
---
# <a name="ms-sql-olapdatabase-class"></a>classe MS-SQL-OLAPDatabase

contêiner para armazenar objetos [**MS-SQL-OLAPCube**](c-ms-sql-olapcube.md) .
...
| Superiores possíveis          | [**MS-SQL-OLAPServer**](c-ms-sql-olapserver.md)                                             |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MS-SQL-descrição**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-palavras-chave**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-OLAPDatabase**         |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Possíveis superiores          | [**MS-SQL-OLAPServer**](c-ms-sql-olapserver.md)                                             |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                    | Falso     | **MS-SQL-OLAPDatabase**         |
| [**Palavras-chave SQL MS**](a-ms-sql-keywords.md)                                | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                    | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                  | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                        | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                    | Falso     | **MS-SQL-OLAPDatabase**         |
| [**Tamanho SQL MS**](a-ms-sql-size.md)                                        | Falso     | **MS-SQL-OLAPDatabase**         |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                    | Falso     | **MS-SQL-OLAPDatabase**         |
| [**Tipo de SQL MS**](a-ms-sql-type.md)                                        | Falso     | **MS-SQL-OLAPDatabase**         |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                    | Falso     | [**Início**](c-top.md)<br/> |
