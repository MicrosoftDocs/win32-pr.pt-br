...
ms.locfileid: "118961165"
---
# <a name="ms-ds-machine-account-quota-attribute"></a>MS-DS-Machine-Account-atributo quota

O número de contas de computador que um usuário tem permissão para criar em um domínio.
...
| Frequência de atualização  | Sempre que a cota de um domínio precisar ser alterada. |
