...
keywords:
- Class-Registration classe AD Schema
- Classe classRegistration Esquema do AD
topic_type:
- apiref
api_name:
- Class-Registration
...
ms.locfileid: "119643826"
---
# <a name="class-registration-class"></a>Class-Registration classe

Informações de registro para um objeto COM.
...
| [**COM-CLSID**](a-comclsid.md)                                           | Falso     | **Registro de classe**          |
| [**COM-InterfaceID**](a-cominterfaceid.md)                               | Falso     | **Registro de classe**          |
| [**Common-Name**](a-cn.md)                                               | Falso     | [**Início**](c-top.md)<br/> |
| [**COM-Other-Prog-Id**](a-comotherprogid.md)                             | Falso     | **Registro de classe**          |
| [**COM-ProgID**](a-comprogid.md)                                         | Falso     | **Registro de classe**          |
| [**COM-Treat-as-Class-Id**](a-comtreatasclassid.md)                      | Falso     | **Registro de classe**          |
...
| [**Implementado-categorias**](a-implementedcategories.md)                 | Falso     | **Registro de classe**          |
...
| [**Gerenciado por**](a-managedby.md)                                         | Falso     | **Registro de classe**          |
...
| [**Obrigatório-categorias**](a-requiredcategories.md)                       | Falso     | **Registro de classe**          |
...
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/> |
| [**COM-CLSID**](a-comclsid.md)                                             | Falso     | **Registro de classe**          |
| [**COM-InterfaceName**](a-cominterfaceid.md)                                 | Falso     | **Registro de classe**          |
| [**Nome comum**](a-cn.md)                                                 | Falso     | [**Início**](c-top.md)<br/> |
| [**COM-Other-PROG-ID**](a-comotherprogid.md)                               | Falso     | **Registro de classe**          |
| [**ProgID de COM**](a-comprogid.md)                                           | Falso     | **Registro de classe**          |
| [**COM-tratar como ID de classe**](a-comtreatasclassid.md)                        | Falso     | **Registro de classe**          |
...
| [**Categorias implementadas**](a-implementedcategories.md)                   | Falso     | **Registro de classe**          |
| [**Tipo de instância**](a-instancetype.md)                                     | Verdadeiro      | [**Início**](c-top.md)<br/> |
...
| [**Reps-To**](a-repsto.md)                                                 | Falso     | [**Início**](c-top.md)<br/> |
| [**Categorias necessárias**](a-requiredcategories.md)                         | Falso     | **Registro de classe**          |
| [**Revisão**](a-revision.md)                                              | Falso     | [**Início**](c-top.md)<br/> |
