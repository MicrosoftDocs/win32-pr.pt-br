...
---
# <a name="ms-wmi-genus-attribute"></a>atributo ms-WMI-genus

Identifica o tipo de objeto de uma codificação.
...
| Tamanho              | 4 bytes. 1 indica uma classe. 2 indica uma instância.          |
