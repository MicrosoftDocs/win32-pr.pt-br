...
ms.locfileid: "120065356"
---
# <a name="ms-dfsr-localsettings-class"></a>classe MS-DFSR-LocalSettings

Contém as configurações de serviço de replicação do Sistema de Arquivos Distribuído (DFS) que são aplicáveis ao computador local.
...
| [**MS-DFSR-opções**](a-msdfsr-options.md)                                 | Falso     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-versão**](a-msdfsr-version.md)                                 | Falso     | **MS-DFSR-LocalSettings**       |
...
A classe **MS-DFSR-LocalSettings** faz parte do suporte ao serviço de replicação do DFS.
