...
description: Contém objetos de servidor em um site.
ms.assetid: 1da4d943-1196-4425-9799-3ac44f7591f2
ms.tgt_platform: multiple
keywords:
- Servers-Container classe AD Schema
- Esquema do AD da classe serversContainer
topic_type:
- apiref
api_name:
- Servers-Container
...
ms.locfileid: "119533786"
---
# <a name="servers-container-class"></a>Servers-Container classe

Contém objetos de servidor em um site.
...
| Frequência de atualização  | Quando um site é criado.              |
...
| Descritor de segurança padrão | D:(A;; CC;;; BA)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY)(A;; RPLCLORC;;; AU) |
...
| Descritor de segurança padrão | D: (A;; CC;;; BA) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; AU |
| System-Flags                | 0x00000010                                                           |
