...
ms.locfileid: "119879886"
---
# <a name="ms-ds-quota-control-class"></a>classe ms-DS-quota-control

Uma classe usada para representar as especificações de cota para o banco de dados de diretório.
...
| Superiores possíveis          | [**ms-DS-quota-container**](c-msds-quotacontainer.md)   |
| Classes Auxiliares           | \-                                                       |
| NT-Security-Descriptor      | O:BAG: INADEQUADO: S:                                             |
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPLCLORC;;; BA |
...
| [**Nome comum**](a-cn.md)                                                 | Verdadeiro      | **MS-DS-quota-control** [ **superior**](c-top.md)<br/> |
...
| [**ms-DS-Quota-Amount**](a-msds-quotaamount.md)                            | Verdadeiro      | **ms-DS-Quota-Control**                                 |
| [**ms-DS-Quota-Trustee**](a-msds-quotatrustee.md)                          | Verdadeiro      | **ms-DS-Quota-Control**                                 |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                        |
| Possíveis superiores          | [**ms-DS-Quota-Container**](c-msds-quotacontainer.md) |
| Classes Auxiliares           | \-                                                     |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/>                         |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/>                         |
| [**Common-Name**](a-cn.md)                                                 | Verdadeiro      | **ms-DS-Quota-Control** [ **Top**](c-top.md)<br/> |
...
| Classes Auxiliares           | \-                                                       |
| Descritor de segurança NT      | O:BAG:BAD:S:                                             |
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;;D A)(A;; RPLCLORC;;; BA) |
| System-Flags                | 0x00000010                                               |
