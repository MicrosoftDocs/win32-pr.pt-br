...
---
# <a name="next-level-store-attribute"></a>Atributo de repositório de próximo nível

Esse atributo indica o próximo repositório de classe a ser pesquisado.



| Entrada | Valor |
|-------------------|-----------------------------------------|
| CN                | Armazenamento de nível mais próximo                        |
