...
keywords:
- Esquema do AD da classe ms-DS-Az-Task
- Esquema do AD da classe msDS-AzTask
topic_type:
- apiref
api_name:
- ms-DS-Az-Task
...
| [**Descrição**](a-description.md)                                             | Falso     | **ms-DS-Az-Task** [ **Top**](c-top.md)<br/> |
