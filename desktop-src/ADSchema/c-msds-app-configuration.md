...
Usado para armazenar as informações de configurações de um aplicativo. O atributo [**MS-DS-Settings**](a-msds-settings.md) deve ser usado para armazenar os valores reais.
