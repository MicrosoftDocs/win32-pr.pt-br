...
description: Usado para armazenar as informações de configurações de um aplicativo. O atributo ms-DS-Configurações deve ser usado para armazenar os valores reais.
ms.assetid: cbb050c8-c391-4c13-bb01-11a11635c9be
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-DS-App-Configuration
- Esquema do AD da classe msDS-App-Configuration
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880596"
---
# <a name="ms-ds-app-configuration-class"></a>Classe ms-DS-App-Configuration

Usado para armazenar as informações de configurações de um aplicativo. O [**atributo ms-DS-Configurações**](a-msds-settings.md) deve ser usado para armazenar os valores reais.
...
| [**Palavras-chave**](a-keywords.md)                                              | Falso     | **ms-DS-app-Configuration**                                      |
| [**Último-pai conhecido**](a-lastknownparent.md)                              | Falso     | [**Início**](c-top.md)<br/>                                  |
| [**Gerenciado por**](a-managedby.md)                                           | Falso     | **ms-DS-app-Configuration**                                      |
...
| [**Matriz ms-DS-byte**](a-msds-bytearray.md)                                | Falso     | **ms-DS-app-Configuration**                                      |
...
| [**ms-DS-data/hora**](a-msds-datetime.md)                                  | Falso     | **ms-DS-app-Configuration**                                      |
...
| [**Proprietário**](a-owner.md)                                                    | Falso     | **ms-DS-app-Configuration**                                      |
