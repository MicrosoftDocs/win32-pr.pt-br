...
ms.locfileid: "118681707"
---
# <a name="public-key-policy-attribute"></a>Atributo de política de chave pública

Referência à política de chave pública para este domínio.



| Entrada | Valor |
|-------------------|-------------------------------------------------------|
| CN                | Política de chave pública                                     |
