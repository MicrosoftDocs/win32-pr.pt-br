...
ms.locfileid: "118689453"
---
# <a name="acs-rsvp-log-files-location-attribute"></a>ACS-RSVP-log-files-atributo Location

O caminho do sistema de arquivos para o armazenamento de arquivos de log RSVP.
...
| LDAP-Display-Name | aCSRSVPLogFilesLocation                     |
| Tamanho              | \-                                          |
| Privilégio de atualização  | \-                                          |
| Frequência de atualização  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.773                      |
| System-ID-GUID    | 1cb3559b-56d0-11d1-a9c6-0000f80367c1        |
