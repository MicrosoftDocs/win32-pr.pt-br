...
keywords:
- ACS-Policy classe AD Schema
- Esquema do AD da classe aCSPolicy
topic_type:
- apiref
api_name:
- ACS-Policy
...
ms.locfileid: "119021964"
---
# <a name="acs-policy-class"></a>ACS-Policy classe

A política de alocação de largura de banda do Serviço de Controles de Admissão para um usuário ou perfil.
...
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLOLORCWOWDSDDTDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY)(A;; RPLCLORC;;; AU) |
...
| [**Direção do ACS**](a-acsdirection.md)                                          | Falso     | **ACS-Policy**                  |
...
| [**Latência mínima do ACS**](a-acsminimumlatency.md)                               | Falso     | **ACS-Policy**                  |
...
| [**Prioridade do ACS**](a-acspriority.md)                                            | Falso     | **ACS-Policy**                  |
| [**Tipo de serviço ACS**](a-acsservicetype.md)                                     | Falso     | **ACS-Policy**                  |
| [**ACS-time-of-day**](a-acstimeofday.md)                                        | Falso     | **ACS-política**                  |
| [**ACS-total-sem fluxos**](a-acstotalnoofflows.md)                             | Falso     | **ACS-política**                  |
...
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLOLORCWOWDSDDTDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; AU |
| System-Flags                | 0x00000010                                                                                       |
...
| Atributo                                                                        | Obrigatório | Derivado de                    |
|----------------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Aggregate-token-taxa por usuário**](a-acsaggregatetokenrateperuser.md)      | Falso     | **ACS-política**                  |
| [**ACS-direção**](a-acsdirection.md)                                          | Falso     | **ACS-política**                  |
| [**ACS-Identity-Name**](a-acsidentityname.md)                                   | Falso     | **ACS-política**                  |
| [**ACS-Max-Aggregate-pico de taxa por usuário**](a-acsmaxaggregatepeakrateperuser.md) | Falso     | **ACS-política**                  |
| [**ACS-Max-Duration por Flow**](a-acsmaxdurationperflow.md)                     | Falso     | **ACS-política**                  |
| [**ACS-Maximum-SDU-tamanho**](a-acsmaximumsdusize.md)                              | Falso     | **ACS-política**                  |
| [**ACS-Max-pico-largura de banda por Flow**](a-acsmaxpeakbandwidthperflow.md)          | Falso     | **ACS-política**                  |
| [**ACS-Max-token-bucket por Flow**](a-acsmaxtokenbucketperflow.md)              | Falso     | **ACS-política**                  |
| [**ACS-Max-token-Rate por Flow**](a-acsmaxtokenrateperflow.md)                  | Falso     | **ACS-política**                  |
| [**ACS-mínimo-variação de atraso**](a-acsminimumdelayvariation.md)                | Falso     | **ACS-política**                  |
| [**ACS – latência mínima**](a-acsminimumlatency.md)                               | Falso     | **ACS-política**                  |
| [**ACS-tamanho mínimo-policiado**](a-acsminimumpolicedsize.md)                      | Falso     | **ACS-política**                  |
| [**ACS-permissão-bits**](a-acspermissionbits.md)                               | Falso     | **ACS-política**                  |
| [**ACS-prioridade**](a-acspriority.md)                                            | Falso     | **ACS-política**                  |
| [**ACS-tipo de serviço**](a-acsservicetype.md)                                     | Falso     | **ACS-política**                  |
...
| [**ACS-prioridade**](a-acspriority.md)                                            | Falso     | **ACS-política**                  |
| [**ACS-tipo de serviço**](a-acsservicetype.md)                                     | Falso     | **ACS-política**                  |
| [**ACS-hora do dia**](a-acstimeofday.md)                                        | Falso     | **ACS-política**                  |
| [**ACS-total-sem fluxos**](a-acstotalnoofflows.md)                             | Falso     | **ACS-política**                  |
| [**Descrição do administrador**](a-admindescription.md)                                  | Falso     | [**Início**](c-top.md)<br/> |
| [**Administração – nome de exibição**](a-admindisplayname.md)                                 | Falso     | [**Início**](c-top.md)<br/> |
| [**Atributos permitidos**](a-allowedattributes.md)                                | Falso     | [**Início**](c-top.md)<br/> |
