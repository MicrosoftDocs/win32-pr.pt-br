...
ms.locfileid: "119834666"
---
# <a name="ms-sql-olapcube-class"></a>classe MS-SQL-OLAPCube

classe para armazenar SQL Server propriedades do cubo OLAP.
...
| Superiores possíveis          | [**MS-SQL-OLAPDatabase**](c-ms-sql-olapdatabase.md)                                         |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MS-SQL-descrição**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-palavras-chave**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-OLAPCube**             |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Possíveis superiores          | [**MS-SQL-OLAPDatabase**](c-ms-sql-olapdatabase.md)                                         |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                    | Falso     | **MS-SQL-OLAPCube**             |
| [**Palavras-chave MS-SQL-keywords**](a-ms-sql-keywords.md)                                | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                  | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                        | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                    | Falso     | **MS-SQL-OLAPCube**             |
| [**Tamanho SQL MS**](a-ms-sql-size.md)                                        | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                    | Falso     | **MS-SQL-OLAPCube**             |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                    | Falso     | [**Início**](c-top.md)<br/> |
...
| [**MS-SQL-Description**](a-ms-sql-description.md)                             | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                       | Falso     | **MS-SQL-OLAPCube**             |
| [**Palavras-chave SQL MS**](a-ms-sql-keywords.md)                                   | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                     | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                           | Falso     | **MS-SQL-OLAPCube**             |
| [**MS-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                       | Falso     | **MS-SQL-OLAPCube**             |
| [**Tamanho SQL MS**](a-ms-sql-size.md)                                           | Falso     | **MS-SQL-OLAPCube**             |
