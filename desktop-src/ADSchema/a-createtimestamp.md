...
---
# <a name="create-time-stamp-attribute"></a>Criar-atributo de carimbo de data/hora

A data em que este objeto foi criado. Esse valor é replicado.



| Entrada | Valor |
|-------------------|---------------------------------------------------------------|
| CN                | Criação-carimbo de data/hora                                             |
