...
ms.locfileid: "119879976"
---
# <a name="ms-ds-optional-feature-class"></a>classe de recurso ms-DS-optional-

Configuração para um recurso opcional do DS.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | ms-DS-opcional-Feature               |
...
| Descritor de segurança padrão | D: (A;; RPLCLORC;;; AU) (A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; EA) (A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; CO) (A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; Sy |
...
| [**ms-DS-optional-reflags de recursos**](a-msds-optionalfeatureflags.md)                    | Verdadeiro      | **ms-DS-opcional-Feature**      |
| [**ms-DS-opcional-Feature-GUID**](a-msds-optionalfeatureguid.md)                      | Verdadeiro      | **ms-DS-opcional-Feature**      |
...
| [**ms-DS-Required-Domain-Behavior-Version**](a-msds-requireddomainbehaviorversion.md) | Falso     | **ms-DS-opcional-Feature**      |
| [**ms-DS-Required-floresta-Behavior-Version**](a-msds-requiredforestbehaviorversion.md) | Falso     | **ms-DS-opcional-Feature**      |
