...
ms.locfileid: "119643437"
---
# <a name="domain-class"></a>Classe de domínio

Contém informações sobre um domínio.
...
| System-Only                 | Falso                                            |
| Object-Category             | 2                                                |
| Categoria de objeto-padrão     | [**Domínio-DNS**](c-domaindns.md)<br/>     |
...
| Superiores possíveis          | [](c-organization.md)**Domínio** da organização |
| Classes Auxiliares           | \-                                               |
...
| [**Componente de domínio**](a-dc.md)                                          | Verdadeiro      | **Domínio**                      |
...
| Nome comum                                  |
|----------------------------------------------|
| [**Senha de domínio**](r-domain-password.md) |
...
| System-Only                 | Falso                                            |
| Object-Category             | 2                                                |
| Default-Object-Category     | [**DNS de domínio**](c-domaindns.md)<br/>     |
| Governs-Id                  | 1.2.840.113556.1.5.66                            |
| Valor ocultado padrão        | 1                                                |
| Rdn-Att-Id                  | [**Componente de domínio**](a-dc.md)<br/>      |
| Subclasse de                 | [**Início**](c-top.md)<br/>                  |
| Possíveis superiores          | [**Domínio da**](c-organization.md)**organização** |
| Classes Auxiliares           | \-                                               |
