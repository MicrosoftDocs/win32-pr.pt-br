...
---
# <a name="ms-dfsr-dfslinktarget-attribute"></a>atributo ms-DFSR-DfsLinkTarget

Contém o destino do link para a assinatura.
...
| LDAP-Display-Name | msDFSR-DfsLinkTarget                        |
| Tamanho              | \-                                          |
...
O atributo **MS-DFSR-DfsLinkTarget** faz parte do suporte ao serviço de replicação do sistema de arquivos distribuído (DFS).
