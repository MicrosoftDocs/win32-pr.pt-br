...
description: Contém o RID FSMO e o local RID-Available-Pool usado pelo Rid Manager. O gerenciador RID é um componente em execução no DC que é responsável por alocar identificadores de segurança.
ms.assetid: 84af5d6d-a5a7-4288-a9eb-0eaaf0c23063
ms.tgt_platform: multiple
keywords:
- RID-Manager classe AD Schema
- Esquema do AD da classe rIDManager
topic_type:
- apiref
api_name:
- RID-Manager
...
ms.locfileid: "118959565"
---
# <a name="rid-manager-class"></a>RID-Manager classe

Contém o RID FSMO e o local RID-Available-Pool usado pelo Rid Manager. O gerenciador RID é um componente em execução no DC que é responsável por alocar identificadores de segurança.
...
| Frequência de atualização  | Sempre que a alocação do pool RID for mudada. |
...
| [**RID-Available-Pool**](a-ridavailablepool.md)                          | Verdadeiro      | **RID-Manager**                 |
...
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; AU) S: (AU; SA; CRWP;;; WD |
| System-Flags                | 0x00000010                                                                                                      |
...
| [**Reps-to**](a-repsto.md)                                                 | Falso     | [**Início**](c-top.md)<br/> |
| [**Revisão**](a-revision.md)                                              | Falso     | [**Início**](c-top.md)<br/> |
| [**RID-disponível-pool**](a-ridavailablepool.md)                            | Verdadeiro      | **Gerenciador de RID**                 |
...
| Nome comum                                      |
|--------------------------------------------------|
| [**Change-RID-mestre**](r-change-rid-master.md) |
...
| Classes Auxiliares           | \-                                                                                                              |
| Descritor de segurança NT      | O:BAG:BAD:S:                                                                                                    |
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY)(A;; RPLCLORC;;; AU)S:(AU;SA; CRWP;;; WD) |
| System-Flags                | 0x00000010                                                                                                      |
