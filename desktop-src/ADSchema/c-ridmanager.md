...
Contém o RID FSMO e o local do pool de RID disponível usado pelo Gerenciador de RID. O Gerenciador de RID é um componente em execução no DC que é responsável por alocar identificadores de segurança.
...
| Frequência de atualização  | Sempre que a alocação do pool de RIDs for alterada. |
...
| [**RID-disponível-pool**](a-ridavailablepool.md)                          | True      | **Gerenciador de RID**                 |
