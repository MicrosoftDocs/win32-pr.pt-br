...
ms.locfileid: "118423196"
---
# <a name="control-access-right-class"></a>Controle-acesso-classe Right

Identifica um direito estendido que pode ser concedido ou revogado usando uma ACL.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Controle-acesso-à direita                 |
...
| [**Aplica-se-a**](a-appliesto.md)                                         | Falso     | **Controle-acesso-à direita**        |
...
| [**Localização-exibição-ID**](a-localizationdisplayid.md)                | Falso     | **Controle-acesso-à direita**        |
...
| [**GUID de direitos**](a-rightsguid.md)                                       | Falso     | **Controle-acesso-à direita**        |
...
| [**Válido-acessos**](a-validaccesses.md)                                 | Falso     | **Controle-acesso-à direita**        |
...
| [**Acessos válidos**](a-validaccesses.md)                                   | Falso     | **Control-Access-Right**        |
...
| [**Aplica-se a**](a-appliesto.md)                                           | Falso     | **Control-Access-Right**        |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/> |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/> |
...
| [**Is-Member-of-DL**](a-memberof.md)                                       | Falso     | [**Início**](c-top.md)<br/> |
| [**Último pai conhecido**](a-lastknownparent.md)                              | Falso     | [**Início**](c-top.md)<br/> |
| [**Localization-Display-Id**](a-localizationdisplayid.md)                  | Falso     | **Controle-acesso-à direita**        |
| [**Objetos gerenciados**](a-managedobjects.md)                                 | Falso     | [**Início**](c-top.md)<br/> |
| [**Mestre por**](a-masteredby.md)                                         | Falso     | [**Início**](c-top.md)<br/> |
| [**Modificar-carimbo de data/hora**](a-modifytimestamp.md)                              | Falso     | [**Início**](c-top.md)<br/> |
