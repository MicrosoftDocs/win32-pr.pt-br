...
description: Contêiner para objetos de ativação usados pela ativação baseada no Active Directory
ms.assetid: 3e43b439-91aa-4bdf-b1af-96d908c9a3eb
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-SPP-Activation-Objects-Container
- Esquema do AD da classe msSPP-ActivationObjectsContainer
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879396"
---
# <a name="ms-spp-activation-objects-container-class"></a>Classe ms-SPP-Activation-Objects-Container

Contêiner para objetos de ativação usados pela ativação baseada no Active Directory
...
| Descritor de segurança padrão | O:BAG:BAD: (A;; RPWPCRCCDCLCLORCWOWDSDTSW;;;D A)(A;; RPLCLORC;;; AU) |
