...
---
# <a name="ms-spp-activation-objects-container-class"></a>MS-SPP-Activation-Objects-classe container

Contêiner para objetos de ativação usados pela ativação baseada em Active Directory
