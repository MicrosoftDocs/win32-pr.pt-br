...
description: A classe base X.500 para aplicativos Exchange usa apenas a subclasse DSA-Application.
ms.assetid: 3ab2e166-e9db-400b-80c5-e8cd871d407e
ms.tgt_platform: multiple
keywords:
- Application-Process classe AD Schema
- Esquema do AD da classe applicationProcess
topic_type:
- apiref
api_name:
- Application-Process
...
| Possíveis superiores          | [**Contêiner do**](c-computer.md)[**computador**](c-container.md)                               |
| Classes Auxiliares           | \-                                                                                           |
...
| Rdn-Att-Id                  | [**Common-Name**](a-cn.md)<br/>                                                                                                                  |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                                         |
| Possíveis superiores          | [**Unidade organizacional**](c-organizationalunit.md) da [**organização**](c-organization.md)de [**contêiner**](c-container.md)do [**computador**](c-computer.md) |
| Classes Auxiliares           | \-                                                                                                                                                      |
