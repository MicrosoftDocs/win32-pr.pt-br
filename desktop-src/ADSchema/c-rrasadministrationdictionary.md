...
---
# <a name="rras-administration-dictionary-class"></a>RRAS-administração-classe de dicionário

Objeto Dictionary para converter atributos de roteamento específicos do fornecedor em nomes.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | RRAS-administração-dicionário       |
