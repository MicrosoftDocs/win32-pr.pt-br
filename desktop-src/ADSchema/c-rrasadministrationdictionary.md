...
description: Objeto de dicionário para traduzir atributos de roteamento específicos do fornecedor para nomes.
ms.assetid: 52318b1d-a76f-4293-91f5-a63288c6f0be
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe RRAS-Administration-Dictionary
- Esquema do AD da classe rRASAdministrationDictionary
topic_type:
- apiref
api_name:
...
ms.locfileid: "119801466"
---
# <a name="rras-administration-dictionary-class"></a>Classe RRAS-Administration-Dictionary

Objeto de dicionário para traduzir atributos de roteamento específicos do fornecedor para nomes.
...
| [**Entrada de atributo ms-RRAS-Vendor**](a-msrrasvendorattributeentry.md)    | Falso     | **RRAS-administração-dicionário** |
