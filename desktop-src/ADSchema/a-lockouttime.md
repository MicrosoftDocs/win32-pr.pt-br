...
keywords:
- Lockout-Time atributo AD Schema
- Esquema do AD do atributo lockoutTime
topic_type:
- apiref
api_name:
- Lockout-Time
...
ms.locfileid: "119301606"
---
# <a name="lockout-time-attribute"></a>Lockout-Time atributo

A data e hora (UTC) em que essa conta foi bloqueada. Esse valor é armazenado como um inteiro grande que representa o número de intervalos de 100 nanossegundos desde 1º de janeiro de 1601 (UTC). Um valor de zero significa que a conta não está bloqueada no momento.
