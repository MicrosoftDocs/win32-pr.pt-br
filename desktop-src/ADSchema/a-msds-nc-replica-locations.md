...
description: Uma lista de servidores que são o conjunto de réplicas para o contexto de nomen por não domínio correspondente.
ms.assetid: b0379bb6-feee-432a-b484-1a6c8100d027
ms.tgt_platform: multiple
keywords:
- Atributo aD MS-DS-NC-Replica-Locations
- Atributo AD MSDS-NC-Replica-Locations
topic_type:
- apiref
api_name:
...
ms.locfileid: "118684540"
---
# <a name="ms-ds-nc-replica-locations-attribute"></a>Atributo ms-DS-NC-Replica-Locations

Uma lista de servidores que são o conjunto de réplicas para o contexto de nomen por não domínio correspondente.
