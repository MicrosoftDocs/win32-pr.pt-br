...
Valor do atributo [**USN-Changed**](a-usnchanged.md) do objeto do diretório remoto que replicou a alteração para o servidor local.
...
| Frequência de atualização  | Quando o objeto é alterado em um diretório remoto que replicou a alteração para o diretório local. |
