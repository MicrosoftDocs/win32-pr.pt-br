...
ms.locfileid: "119324116"
---
# <a name="link-track-volume-table-class"></a>Classe link-Track-volume-Table

Contêiner para objetos de entrada de link-Track-Vol.



| Entrada | Valor |
|-------------------|---------------------------------------|
| CN                | Link-Track-volume-tabela               |
...
| Subclasse de                 | [**Rastreamento de link de arquivo**](c-filelinktracking.md)<br/>                                  |
