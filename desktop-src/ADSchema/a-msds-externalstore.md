...
---
# <a name="ms-ds-external-store-attribute"></a>atributo ms-DS-external-Store

Uma cadeia de caracteres que identifica o local de um repositório externo, como um banco de dados.
