...
keywords:
- Esquema do AD da classe ms-DFSR-Subscription
- Esquema do AD da classe msDFSR-Subscription
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880626"
---
# <a name="ms-dfsr-subscription-class"></a>Classe ms-DFSR-Subscription

Contém a participação do computador local em um conjunto de conteúdo.
...
| Possíveis superiores          | [**ms-DFSR-Subscriber**](c-msdfsr-subscriber.md)                                                                                |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**ms-DFSR-ContentSetGuid**](a-msdfsr-contentsetguid.md)                   | Verdadeiro      | **ms-DFSR-Subscription**        |
...
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)       | Verdadeiro      | **ms-DFSR-Subscription**        |
...
| RDN-ATT-ID                  | \-                                                                                                                               |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Superiores possíveis          | [**MS-DFSR-Subscriber**](c-msdfsr-subscriber.md)                                                                                |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**MS-DFSR-DeletedSizeInMb**](a-msdfsr-deletedsizeinmb.md)                                   | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-DfsLinkTarget**](a-msdfsr-dfslinktarget.md)                                       | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR habilitado**](a-msdfsr-enabled.md)                                                   | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                                               | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-flags**](a-msdfsr-flags.md)                                                       | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-MaxAgeInCacheInMin**](a-msdfsr-maxageincacheinmin.md)                             | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                               | Falso     | [**Início**](c-top.md)<br/> |
...
| [**MS-DFSR-OnDemandExclusionDirectoryFilter**](a-msdfsr-ondemandexclusiondirectoryfilter.md) | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-OnDemandExclusionFileFilter**](a-msdfsr-ondemandexclusionfilefilter.md)           | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-opções**](a-msdfsr-options.md)                                                   | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                                 | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-ReadOnly**](a-msdfsr-readonly.md)                                                 | Falso     | **MS-DFSR-Subscription**        |
| [**MS-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)                         | Verdadeiro      | **MS-DFSR-Subscription**        |
| [**MS-DFSR-RootFence**](a-msdfsr-rootfence.md)                                               | Falso     | **MS-DFSR-Subscription**        |
...
A classe **MS-DFSR-Subscription** faz parte do suporte ao serviço de replicação do sistema de arquivos distribuído (DFS).
