...
description: A classe de objeto de conta é usada para definir entradas que representam contas de computador.
ms.assetid: 94199a02-47ea-4b44-b116-e6bed0aa1e1e
ms.tgt_platform: multiple
keywords:
- classe de conta Esquema do AD
topic_type:
- apiref
api_name:
- account
...
ms.locfileid: "119644196"
---
# <a name="account-class"></a>classe account

A classe de objeto de conta é usada para definir entradas que representam contas de computador.
...
| [**Descrição**](a-description.md)                                        | Falso     | **conta** [ **Superior**](c-top.md)<br/> |
...
| [**Locality-Name**](a-l.md)                                                | Falso     | **conta**                                 |
...
| [**Nome da unidade organizacional**](a-ou.md)                                    | Falso     | **conta**                                 |
| [**Nome da organização**](a-o.md)                                            | Falso     | **conta**                                 |
...
| [**Consulte-também**](a-seealso.md)                                               | Falso     | **conta**                                 |
...
| [**Descrição**](a-description.md)                                           | Falso     |  [ **parte superior** da conta](c-top.md)<br/> |
| [**Nome de exibição**](a-displayname.md)                                          | Falso     | [**Início**](c-top.md)<br/>             |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                       | Falso     | [**Início**](c-top.md)<br/>             |
...
| [**hospedeira**](a-host.md)                                                         | Falso     | **conta**                                 |
| [**Tipo de instância**](a-instancetype.md)                                        | Verdadeiro      | [**Início**](c-top.md)<br/>             |
...
| [**Último-pai conhecido**](a-lastknownparent.md)                                 | Falso     | [**Início**](c-top.md)<br/>             |
| [**Localidade-nome**](a-l.md)                                                   | Falso     | **conta**                                 |
| [**Objetos gerenciados**](a-managedobjects.md)                                    | Falso     | [**Início**](c-top.md)<br/>             |
