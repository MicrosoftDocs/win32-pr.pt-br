...
---
# <a name="ms-ds-all-users-trust-quota-attribute"></a>Atributo MS-DS-All-Users-Trust-quota

Usado para impor uma cota de usuários combinados no número total de objetos Trusted-Domain criados usando o direito de acesso de novo controle, criar-entrada-floresta-Trust.
