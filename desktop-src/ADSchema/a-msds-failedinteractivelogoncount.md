...
---
# <a name="ms-ds-failed-interactive-logon-count-attribute"></a>atributo ms-DS-Failed-Interactive-login-Count

O número total de logons interativos com falha desde que esse recurso foi ativado.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | ms-DS-Failed-Interactive-login-Count |
