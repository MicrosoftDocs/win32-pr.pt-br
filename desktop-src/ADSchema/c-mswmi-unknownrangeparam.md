...
ms.locfileid: "119753607"
---
# <a name="ms-wmi-unknownrangeparam-class"></a>classe MS-WMI-UnknownRangeParam

Dá suporte a tipos de parâmetro que não sabemos nada, portanto eles são transportados como objetos WMI compilados.
...
| [**ms-WMI-NormalizedClass**](a-mswmi-normalizedclass.md)                   | Verdadeiro      | **ms-WMI-UnknownRangeParam**                               |
...
| [**ms-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Verdadeiro      | **ms-WMI-UnknownRangeParam**                               |
