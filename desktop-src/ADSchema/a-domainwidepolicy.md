...
---
# <a name="domain-wide-policy-attribute"></a>Atributo de diretiva de todo o domínio

Isso é para que a política extensível do usuário seja replicada para os clientes.



| Entrada | Valor |
|-------------------|-------------------------------------------------------|
| CN                | Política de todo o domínio                                    |
