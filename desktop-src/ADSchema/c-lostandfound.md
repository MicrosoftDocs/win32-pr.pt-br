...
ms.locfileid: "119324106"
---
# <a name="lost-and-found-class"></a>Classe perdida e encontrada

Contêiner para objetos órfãos.



| Entrada | Valor |
|-------------------|-----------------------------------------------------------|
| CN                | Perdido e encontrado                                            |
| LDAP-Display-Name | lostAndFound                                              |
| Privilégio de atualização  | Esse contêiner é gerenciado pelo sistema.                  |
| Frequência de atualização  | Sempre que o local de um objeto não puder ser reconciliado. |
...
| Superiores possíveis          | Domínio [**DMD**](c-dmd.md)[**-configuração de DNS**](c-domaindns.md)[](c-configuration.md) |
| Classes Auxiliares           | \-                                                                                            |
...
| [**Estado de árvore de movimentação**](a-movetreestate.md)                                | Falso     | **Perdido e encontrado**              |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                               |
| Possíveis superiores          | [**Configuração de DNS**](c-dmd.md)de domínio [](c-domaindns.md)[**DMD**](c-configuration.md) |
| Classes Auxiliares           | \-                                                                                            |
...
| [**Modificar carimbo de data/hora**](a-modifytimestamp.md)                              | Falso     | [**Início**](c-top.md)<br/> |
| [**Estado da árvore de movimentação**](a-movetreestate.md)                                  | Falso     | **Perdidos e Encontrados**              |
