...
description: Contém um conjunto de assinaturas para um conjunto de réplicas.
ms.assetid: f961c2bb-4647-49da-be53-1d1aa0d55ef5
ms.tgt_platform: multiple
keywords:
- NTFRS-Subscriptions classe AD Schema
- Esquema do AD da classe nTFRSSubscriptions
topic_type:
- apiref
api_name:
- NTFRS-Subscriptions
...
ms.locfileid: "118959755"
---
# <a name="ntfrs-subscriptions-class"></a>NTFRS-Subscriptions classe

Contém um conjunto de assinaturas para um conjunto de réplicas.
...
| Possíveis superiores          | **Usuário do computador NTFRS-Subscriptions**[](c-computer.md)[](c-user.md)                                                      |
| Classes Auxiliares           | \-                                                                                                                               |
...
| Rdn-Att-Id                  | [**Common-Name**](a-cn.md)<br/>                                                                                           |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Possíveis superiores          | **NTFRS-**[](c-computer.md)[**usuário**](c-user.md) do computador de assinaturas                                                      |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**FRS-Computer-Reference-BL**](a-frscomputerreferencebl.md)               | Falso     | [**Início**](c-top.md)<br/> |
| [**FRS-Extensions**](a-frsextensions.md)                                   | Falso     | **NTFRS-assinaturas**         |
| [**FRS-member-Reference-BL**](a-frsmemberreferencebl.md)                   | Falso     | [**Início**](c-top.md)<br/> |
| [**Versão do FRS**](a-frsversion.md)                                         | Falso     | **NTFRS-assinaturas**         |
| [**FRS – caminho de trabalho**](a-frsworkingpath.md)                                | Falso     | **NTFRS-assinaturas**         |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Superiores possíveis          | **NTFRS-**[](c-computer.md)[**usuário**](c-user.md) do computador de assinaturas                                                      |
| Classes Auxiliares           | \-                                                                                                                               |
| NT-Security-Descriptor      | O:BAG: INADEQUADO: S:                                                                                                                     |
| Descritor de segurança padrão | D: (A;; RPLCLORC;;; AU) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; COLABORA |
| System-Flags                | 0x00000010                                                                                                                       |
