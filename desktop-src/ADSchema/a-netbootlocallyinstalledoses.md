...
---
# <a name="netboot-locally-installed-oses-attribute"></a>netboot-localmente-instalado-atributo-SOS

O atributo **netboot-local-SOS-os-** os está reservado para uso interno.



| Entrada | Valor |
|-------------------|---------------------------------------------|
| CN                | netboot-localmente instalado-sistemas operacionais              |
