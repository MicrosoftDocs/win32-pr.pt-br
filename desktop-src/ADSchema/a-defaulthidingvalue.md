...
Um valor booliano que especifica a configuração padrão da propriedade showInAdvancedViewOnly de novas instâncias dessa classe.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Padrão-ocultando valor                 |
| LDAP-Display-Name | defaultocultarvalue                   |
| Tamanho              | \-                                   |
