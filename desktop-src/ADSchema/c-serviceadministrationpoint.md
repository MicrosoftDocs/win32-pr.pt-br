...
keywords:
- Esquema do AD da classe Service-Administration-Point
- Esquema do AD da classe serviceAdministrationPoint
topic_type:
- apiref
api_name:
...
ms.locfileid: "119548976"
---
# <a name="service-administration-point-class"></a>Classe Service-Administration-Point

Contém informações de associação para se conectar a um serviço para administrá-lo.
