...
---
# <a name="com-connection-point-class"></a>Classe de ponto de conexão com
...
| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Ponto de conexão com                 |
| LDAP-Display-Name | desconnectionpoint                   |
...
| [**Nome comum**](a-cn.md)                                               | True      | **Com-** [ **ponto de conexão** de ponto de conexão](c-connectionpoint.md)<br/> [**Início**](c-top.md)<br/> |
