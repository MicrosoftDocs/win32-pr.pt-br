...
Um objeto de ponto de conexão usado pelo serviço de nome de RnR (registro e resolução do Windows Sockets), que é acessado por meio das APIs do WSA do Windows Sockets \* .
...
| [**Nome de exibição**](a-displayname.md)                                     | True      | **Serviço-instância** [ **superior**](c-top.md)<br/>                                     |
...
| [**ID de classe de serviço**](a-serviceclassid.md)                              | True      | **Instância de serviço**                                                                     |
