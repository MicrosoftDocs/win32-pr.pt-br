...
description: Um objeto de ponto de conexão usado pelo serviço de nome RnR (registro e resolução de soquetes) do Windows, que é acessado por meio das APIs WSA\ Windows Sockets.
ms.assetid: a9dfe942-c42d-4494-a1e6-ab03df5daecd
ms.tgt_platform: multiple
keywords:
- Service-Instance classe AD Schema
- Esquema do AD da classe serviceInstance
topic_type:
- apiref
api_name:
- Service-Instance
...
ms.locfileid: "118959525"
---
# <a name="service-instance-class"></a>Service-Instance classe

Um objeto de ponto de conexão usado pelo serviço de nome RnR (registro e resolução de soquetes) do Windows Sockets, que é acessado por meio das APIs do WSA Windows \* Sockets.
...
| [**Nome de exibição**](a-displayname.md)                                     | Verdadeiro      | **Parte superior da instância de** [ **serviço**](c-top.md)<br/>                                     |
...
| [**ID de classe de serviço**](a-serviceclassid.md)                              | Verdadeiro      | **Instância de serviço**                                                                     |
| [**Versão da instância de serviço**](a-serviceinstanceversion.md)              | Falso     | **Instância de serviço**                                                                     |
...
| [**Endereços de Winsock**](a-winsockaddresses.md)                           | Falso     | **Instância de serviço**                                                                     |
...
| [**Quando alterado**](a-whenchanged.md)                                       | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Quando criado**](a-whencreated.md)                                       | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Winsock-Addresses**](a-winsockaddresses.md)                             | Falso     | **Instância de serviço**                                                                     |
| [**WWW-Home Page**](a-wwwhomepage.md)                                      | Falso     | [**Início**](c-top.md)<br/>                                                          |
...
| [**Descrição**](a-description.md)                                             | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Nome de exibição**](a-displayname.md)                                            | Verdadeiro      | **Serviço-instância** [ **superior**](c-top.md)<br/>                                     |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                         | Falso     | [**Início**](c-top.md)<br/>                                                          |
