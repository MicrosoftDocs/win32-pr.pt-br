...
---
# <a name="acs-resource-limits-class"></a>ACS – Resource-Limits Class

Contém limites de recursos reserváveis para uma sub-rede. Esses limites podem ser para cada tipo de serviço do ACS ou para todos os tipos de serviço.



| Entrada | Valor |
|-------------------|------------------------------------------------|
| CN                | ACS-limites de recursos                            |
...
| [**ACS-Max-pico-largura de banda por fluxo**](a-acsmaxpeakbandwidthperflow.md)   | Falso     | **ACS-limites de recursos**         |
| [**ACS-Max-token-taxa por fluxo**](a-acsmaxtokenrateperflow.md)           | Falso     | **ACS-limites de recursos**         |
