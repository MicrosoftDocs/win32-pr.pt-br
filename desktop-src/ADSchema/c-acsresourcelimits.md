...
description: Contém limites de recursos que podem ser reservados para uma sub-rede. Esses limites podem ser para cada tipo de serviço do ACS ou para todos os tipos de serviço.
ms.assetid: 6b1d15e8-a60b-4253-8521-db3c9ebbb69b
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ACS-Resource-Limits
- ACSResourceLimits classe AD Schema
topic_type:
- apiref
api_name:
- ACS-Resource-Limits
...
ms.locfileid: "119021874"
---
# <a name="acs-resource-limits-class"></a>Classe ACS-Resource-Limits

Contém limites de recursos que podem ser reservados para uma sub-rede. Esses limites podem ser para cada tipo de serviço do ACS ou para todos os tipos de serviço.



| Entrada | Valor |
|-------------------|------------------------------------------------|
| CN                | Limites de recursos do ACS                            |
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Allocable-RSVP-Bandwidth**](a-acsallocablersvpbandwidth.md)       | Falso     | **Limites de recursos do ACS**         |
| [**ACS-Max-Peak-Bandwidth**](a-acsmaxpeakbandwidth.md)                   | Falso     | **Limites de recursos do ACS**         |
| [**ACS-Max-Peak-Bandwidth-per-Flow**](a-acsmaxpeakbandwidthperflow.md)   | Falso     | **Limites de recursos do ACS**         |
| [**ACS-Max-Token-Rate-per-Flow**](a-acsmaxtokenrateperflow.md)           | Falso     | **Limites de recursos do ACS**         |
| [**Tipo de serviço ACS**](a-acsservicetype.md)                              | Falso     | **Limites de recursos do ACS**         |
...
| Atributo                                                                   | Obrigatório | Derivado de                    |
|-----------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-allocable-RSVP-largura de banda**](a-acsallocablersvpbandwidth.md)         | Falso     | **ACS-limites de recursos**         |
| [**ACS-Max-pico-largura de banda**](a-acsmaxpeakbandwidth.md)                     | Falso     | **ACS-limites de recursos**         |
| [**ACS-Max-pico-largura de banda por Flow**](a-acsmaxpeakbandwidthperflow.md)     | Falso     | **ACS-limites de recursos**         |
| [**ACS-Max-token-Rate por Flow**](a-acsmaxtokenrateperflow.md)             | Falso     | **ACS-limites de recursos**         |
| [**ACS-tipo de serviço**](a-acsservicetype.md)                                | Falso     | **ACS-limites de recursos**         |
| [**Descrição do administrador**](a-admindescription.md)                             | Falso     | [**Início**](c-top.md)<br/> |
