...
description: Uma classe abstrata cujas subclasses são usadas pelo serviço de nome RPC (Ns), que é acessada usando as funções RpcNs\ na API win32.
ms.assetid: 8ec4831d-d30b-4b4d-a5d4-8457a7774ec0
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe rpc-Entry
- Esquema do AD da classe rpcEntry
topic_type:
- apiref
api_name:
- rpc-Entry
...
ms.locfileid: "119801546"
---
# <a name="rpc-entry-class"></a>Classe rpc-Entry

Uma classe abstrata cujas subclasses são usadas pelo serviço de nome RPC (Ns), que é acessada usando as funções RpcNs na \* API do Win32.
