...
---
# <a name="rpc-entry-class"></a>classe de entrada RPC

Uma classe abstrata cujas subclasses são usadas pelo serviço de nomes RPC (ns), que é acessado usando as \* funções RpcNs na API do Win32.
