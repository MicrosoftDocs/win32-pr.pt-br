...
description: Uma identidade assinada digitalmente ou certificada e um conjunto de atributos. Usado para vincular informações de autorização a uma identidade.
ms.assetid: 46519f26-01db-4f8e-936d-9255c72cd30c
ms.tgt_platform: multiple
keywords:
- atributoCertificateAttribute atributo AD Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "118688103"
---
# <a name="attributecertificateattribute-attribute"></a>Atributo AttributeCertificateAttribute

Uma identidade assinada digitalmente ou certificada e um conjunto de atributos. Usado para vincular informações de autorização a uma identidade.
