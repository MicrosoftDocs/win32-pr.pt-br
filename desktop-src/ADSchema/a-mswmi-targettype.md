...
Referência de WMI a uma definição de tipo para um objeto de política.
...
| Tamanho              | Menos de 100 caracteres.                   |
...
| Classes usadas em        | [**MS-WMI-Policytemplate**](c-mswmi-policytemplate.md)<br/> [**MS-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/> |
