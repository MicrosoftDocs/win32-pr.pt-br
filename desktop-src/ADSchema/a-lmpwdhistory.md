...
O histórico de senha do usuário no formato unidirecional do LM (LAN Manager) (). O LM OWF é usado para compatibilidade com o LAN Manager 2. *x* clients, Windows 95 e Windows 98.
