...
ms.locfileid: "119835026"
---
# <a name="ipsec-negotiation-policy-class"></a>Classe de diretiva IPSec-Negotiation

A classe **IPSec-Negotiation Policy** é somente para uso interno.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | IPSec-negociação-política             |
...
| [**IPSEC-negociação-política-ação**](a-ipsecnegotiationpolicyaction.md)   | Falso     | **IPSec-negociação-política**                 |
| [**IPSEC-negociação-tipo de política**](a-ipsecnegotiationpolicytype.md)       | Falso     | **IPSec-negociação-política**                 |
