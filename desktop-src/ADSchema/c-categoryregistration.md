...
keywords:
- Category-Registration classe AD Schema
- Esquema do AD da classe categoryRegistration
topic_type:
- apiref
api_name:
...
ms.locfileid: "119643836"
---
# <a name="category-registration-class"></a>Category-Registration classe

Informações de registro para uma categoria de componente.
...
| [**ID da categoria**](a-categoryid.md)                                       | Falso     | **Registro de categoria**       |
...
| [**Locale-ID**](a-localeid.md)                                           | Falso     | **Registro de categoria**       |
| [**Descrição localizada**](a-localizeddescription.md)                   | Falso     | **Registro de categoria**       |
| [**Gerenciado por**](a-managedby.md)                                         | Falso     | **Registro de categoria**       |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/> |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/> |
| [**ID da categoria**](a-categoryid.md)                                         | Falso     | **Categoria-registro**       |
...
| [**Último-pai conhecido**](a-lastknownparent.md)                              | Falso     | [**Início**](c-top.md)<br/> |
| [**ID da localidade**](a-localeid.md)                                             | Falso     | **Categoria-registro**       |
| [**Localizada-descrição**](a-localizeddescription.md)                     | Falso     | **Categoria-registro**       |
| [**Gerenciado por**](a-managedby.md)                                           | Falso     | **Categoria-registro**       |
| [**Objetos gerenciados**](a-managedobjects.md)                                 | Falso     | [**Início**](c-top.md)<br/> |
