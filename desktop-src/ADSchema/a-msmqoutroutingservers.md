...
---
# <a name="msmq-out-routing-servers-attribute"></a>Atributo MSMQ-out-Routing-Servers

Links de DN para servidores de roteamento MSMQ por meio do qual todo o tráfego de saída deste computador deve ser roteado.
