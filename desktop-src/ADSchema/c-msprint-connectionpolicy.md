...
description: Contém a política de conexão da impressora.
ms.assetid: 39981d4b-ee21-4f11-8393-5d40d1909bcb
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-Print-ConnectionPolicy
- Esquema do AD da classe msPrint-ConnectionPolicy
topic_type:
- apiref
api_name:
...
| [**Common-Name**](a-cn.md)                                                 | Verdadeiro      | **ms-Print-ConnectionPolicy** [ **Top**](c-top.md)<br/> |
...
| [**Atributos de impressão**](a-printattributes.md)                               | Falso     | **ms-Print-ConnectionPolicy**                                 |
| [**Nome da impressora**](a-printername.md)                                       | Falso     | **ms-Print-ConnectionPolicy**                                 |
...
| [**Nome do servidor**](a-servername.md)                                         | Falso     | **ms-Print-ConnectionPolicy**                                 |
...
| [**Conjunto de atributos parciais**](a-partialattributeset.md)                           | Falso     | [**Início**](c-top.md)<br/>                               |
| [**Possíveis-inferiores**](a-possibleinferiors.md)                                | Falso     | [**Início**](c-top.md)<br/>                               |
| [**Imprimir atributos**](a-printattributes.md)                                    | Falso     | **MS-Print-ConnectionPolicy**                                 |
| [**Nome da impressora**](a-printername.md)                                            | Falso     | **MS-Print-ConnectionPolicy**                                 |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                                | Falso     | [**Início**](c-top.md)<br/>                               |
| [**Nome canônico**](a-canonicalname.md)                                                    | Falso     | [**Início**](c-top.md)<br/>                               |
| [**Nome comum**](a-cn.md)                                                                  | Verdadeiro      | **MS-Print-ConnectionPolicy** [ **superior**](c-top.md)<br/> |
