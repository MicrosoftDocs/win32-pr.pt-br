...
Contêiner para armazenamento de objetos [**MS-SQL-SQLDatabase**](c-ms-sql-sqldatabase.md), [**MS-SQL-sqlpublication**](c-ms-sql-sqlpublication.md)e [**MS-SQL-sqlrepository**](c-ms-sql-sqlrepository.md) .
...
| [**MS-SQL-clusterizado**](a-ms-sql-clustered.md)                            | Falso     | **MS-SQL-SQLServer**                                                                     |
