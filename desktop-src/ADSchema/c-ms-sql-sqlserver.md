...
description: Contêiner para armazenar objetos MS-SQL-SQLDatabase, MS-SQL-SQLPublication e MS-SQL-SQLRepository.
ms.assetid: e83c93fa-b5d8-4941-af8c-b7a4c47c8e87
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe MS-SQL-SQLServer
- Esquema do AD da classe mS-SQL-SQLServer
topic_type:
- apiref
api_name:
...
ms.locfileid: "119834616"
---
# <a name="ms-sql-sqlserver-class"></a>Classe MS-SQL-SQLServer

Contêiner para armazenar objetos [**MS-SQL-SQLDatabase,**](c-ms-sql-sqldatabase.md) [**MS-SQL-SQLPublication**](c-ms-sql-sqlpublication.md)e [**MS-SQL-SQLRepository.**](c-ms-sql-sqlrepository.md)
...
| [**Cluster SQL MS**](a-ms-sql-clustered.md)                            | Falso     | **MS-SQL-SQLServer**                                                                     |
...
| [**Palavras-chave MS-SQL-keywords**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-SQLServer**                                                                     |
...
| [**MS-SQL-GPSLongitude**](a-ms-sql-gpslongitude.md)                        | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                    | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-palavras-chave**](a-ms-sql-keywords.md)                                | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                  | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-Location**](a-ms-sql-location.md)                                | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-Memory**](a-ms-sql-memory.md)                                    | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-multiprotocolo**](a-ms-sql-multiprotocol.md)                      | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                        | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-NamedPipe**](a-ms-sql-namedpipe.md)                              | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-RegisteredOwner**](a-ms-sql-registeredowner.md)                  | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**conta do MS-SQL-microsoft**](a-ms-sql-serviceaccount.md)                    | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-SortOrder**](a-ms-sql-sortorder.md)                              | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-SPX**](a-ms-sql-spx.md)                                          | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-Status**](a-ms-sql-status.md)                                    | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-TCPIP**](a-ms-sql-tcpip.md)                                      | Falso     | **MS-SQL-SQLServer**                                                                     |
...
| [**MS-SQL-Build**](a-ms-sql-build.md)                                         | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-CharacterSet**](a-ms-sql-characterset.md)                           | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**Cluster de SQL MS**](a-ms-sql-clustered.md)                                 | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                     | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-GPSHeight**](a-ms-sql-gpsheight.md)                                 | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-GPSLatitude**](a-ms-sql-gpslatitude.md)                             | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-GPSLongitude**](a-ms-sql-gpslongitude.md)                           | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                       | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**Palavras-chave SQL MS**](a-ms-sql-keywords.md)                                   | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                     | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-Location**](a-ms-sql-location.md)                                   | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-memory**](a-ms-sql-memory.md)                                       | Falso     | **MS-SQL-SQLServer**                                                                     |
| [**MS-SQL-MultiProtocol**](a-ms-sql-multiprotocol.md)                         | Falso     | **MS-SQL-SQLServer**                                                                     |
