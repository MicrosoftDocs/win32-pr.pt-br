...
description: Usado para definir um destinatário personalizado do MSMQ (também conhecido como uma fila de alias). Define um alias para uma fila fora da empresa. Contém o nome do formato dessa fila.
ms.assetid: d940d687-0d16-42c6-b836-502fc3ca96f4
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe MSMQ-Custom-Recipient
- Esquema do AD da classe msMQ-Custom-Recipient
topic_type:
- apiref
api_name:
...
ms.locfileid: "118175632"
---
# <a name="msmq-custom-recipient-class"></a>Classe MSMQ-Custom-Recipient

Usado para definir um destinatário personalizado do MSMQ (também conhecido como uma fila de alias). Define um alias para uma fila fora da empresa. Contém o nome do formato dessa fila.
...
| Schema-Id-Guid    | 876d6817-35cc-436c- ltd-5ef7174dd9be     |
...
| Possíveis superiores          | [**Unidade organizacional**](c-container.md)[**de domínio do contêiner DNS**](c-domaindns.md)[](c-organizationalunit.md) |
| Classes Auxiliares           | \-                                                                                                                   |
...
| [**MSMQ-destinatário-FormatName**](a-msmq-recipient-formatname.md)            | Falso     | **MSMQ-personalizado-destinatário**       |
...
| [**ms-DS-Tasks-For-Az-Task-BL**](a-msds-tasksforaztaskbl.md)               | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-Exch-Owner-BL**](a-ownerbl.md)                                       | Falso     | [**Início**](c-top.md)<br/> |
| [**MSMQ-Recipient-FormatName**](a-msmq-recipient-formatname.md)            | Falso     | **MSMQ-Custom-Recipient**       |
