...
---
# <a name="msmq-custom-recipient-class"></a>Classe de destinatário do MSMQ-Custom

Usado para definir um destinatário do MSMQ personalizado (também conhecido como uma fila de alias). Define um alias para uma fila fora da empresa. Contém o nome do formato dessa fila.



| Entrada | Valor |
|-------------------|------------------------------------------|
| CN                | MSMQ-personalizado-destinatário                    |
| LDAP-Display-Name | msMQ-personalizado-destinatário                    |
