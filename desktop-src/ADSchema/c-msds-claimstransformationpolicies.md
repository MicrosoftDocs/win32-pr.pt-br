...
description: Um objeto dessa classe contém um conjunto de Política de Transformação de Declarações para Transformação de Declarações Entre Florestas. | Classe ms-DS-Claims-Transformation-Policies
ms.assetid: d6e188b3-0ff2-4888-8e19-277d642de68e
ms.tgt_platform: multiple
keywords:
- Classe AD Schema ms-DS-Claims-Transformation-Policies
- Esquema do AD da classe msDS-ClaimsTransformationPolicies
topic_type:
- apiref
api_name:
...
Um objeto dessa classe contém um conjunto de Política de Transformação de Declarações para Transformação de Declarações Entre Florestas.
...
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; EA)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY) |
