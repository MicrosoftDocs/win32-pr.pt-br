...
keywords:
- Display-Template classe AD Schema
- Esquema do AD da classe displayTemplate
topic_type:
- apiref
api_name:
- Display-Template
...
ms.locfileid: "119081240"
---
# <a name="display-template-class"></a>Display-Template classe

Especifica informações para um modelo de endereço.
...
|------------------------------------------------------------------------------|-----------|------------------------------------------------------|
| [**Address-Entry-Display-Table**](a-addressentrydisplaytable.md)            | Falso     | **Exibir modelo**                                 |
| [**Address-Entry-Display-Table-MSDOS**](a-addressentrydisplaytablemsdos.md) | Falso     | **Exibir modelo**                                 |
...
| [**Common-Name**](a-cn.md)                                                  | Verdadeiro      | **Display-Template** [ **Top**](c-top.md)<br/> |
...
| [**Ajuda-Data16**](a-helpdata16.md)                                          | Falso     | **Display-template**                                 |
| [**Ajuda-Data32**](a-helpdata32.md)                                          | Falso     | **Display-template**                                 |
| [**Ajuda-nome do arquivo**](a-helpfilename.md)                                     | Falso     | **Display-template**                                 |
...
| [**Original-exibição-tabela**](a-originaldisplaytable.md)                     | Falso     | **Display-template**                                 |
| [**Original-display-Table-MSDOS**](a-originaldisplaytablemsdos.md)          | Falso     | **Display-template**                                 |
...
| Atributo                                                                    | Obrigatório | Derivado de                                         |
|------------------------------------------------------------------------------|-----------|------------------------------------------------------|
| [**Endereço-entrada-exibição-tabela**](a-addressentrydisplaytable.md)            | Falso     | **Display-template**                                 |
| [**Endereço-entrada-exibição-tabela-MSDOS**](a-addressentrydisplaytablemsdos.md) | Falso     | **Display-template**                                 |
| [**Descrição do administrador**](a-admindescription.md)                              | Falso     | [**Início**](c-top.md)<br/>                      |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                | Falso     | [**Início**](c-top.md)<br/>                      |
| [**Nome canônico**](a-canonicalname.md)                                    | Falso     | [**Início**](c-top.md)<br/>                      |
| [**Nome comum**](a-cn.md)                                                  | Verdadeiro      | **Exibição-modelo** [ **superior**](c-top.md)<br/> |
...
| [**Ajuda-Data16**](a-helpdata16.md)                                          | Falso     | **Display-template**                                 |
| [**Ajuda-Data32**](a-helpdata32.md)                                          | Falso     | **Display-template**                                 |
| [**Nome do arquivo de ajuda**](a-helpfilename.md)                                     | Falso     | **Exibir modelo**                                 |
| [**Tipo de instância**](a-instancetype.md)                                      | Verdadeiro      | [**Início**](c-top.md)<br/>                      |
...
| [**Versão do objeto**](a-objectversion.md)                                    | Falso     | [**Início**](c-top.md)<br/>                      |
| [**Original-Display-Table**](a-originaldisplaytable.md)                     | Falso     | **Exibir modelo**                                 |
| [**Original-Display-Table-MSDOS**](a-originaldisplaytablemsdos.md)          | Falso     | **Exibir modelo**                                 |
...
| [**Help-Data16**](a-helpdata16.md)                                          | Falso     | **Exibir modelo**                                 |
| [**Help-Data32**](a-helpdata32.md)                                          | Falso     | **Exibir modelo**                                 |
| [**Nome do arquivo de ajuda**](a-helpfilename.md)                                     | Falso     | **Exibir modelo**                                 |
| [**Tipo de instância**](a-instancetype.md)                                      | Verdadeiro      | [**Início**](c-top.md)<br/>                      |
| [**Is-Critical-System-Object**](a-iscriticalsystemobject.md)                | Falso     | [**Início**](c-top.md)<br/>                      |
| [**Is-Deleted**](a-isdeleted.md)                                            | Falso     | [**Início**](c-top.md)<br/>                      |
