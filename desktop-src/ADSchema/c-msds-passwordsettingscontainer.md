---
title: Classe ms-DS-Password-Configurações-Container
description: Contêiner para objetos de configurações de senha.
ms.assetid: 45e55a1d-63a9-41e5-ac54-3ed467251d3d
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-DS-Password-Configurações-Container
- Esquema do AD da classe msDS-PasswordSettingsContainer
topic_type:
- apiref
api_name:
...
ms.locfileid: "119879936"
---
# <a name="ms-ds-password-settings-container-class"></a>Classe ms-DS-Password-Configurações-Container

Contêiner para objetos de configurações de senha.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | ms-DS-Password-Configurações-Container    |
