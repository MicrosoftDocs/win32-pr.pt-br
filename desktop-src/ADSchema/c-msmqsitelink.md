...
---
# <a name="msmq-site-link-class"></a>Classe de link de site do MSMQ

Contém informações sobre a conectividade de roteamento do MSMQ entre sites. Esse objeto é criado para cada link de roteamento que é criado e contém informações de conectividade. Esses objetos estão contidos nos objetos dos Serviços MSMQ.



| Entrada | Valor |
|-------------------|-------------------------------------------------------------------|
| CN                | MSMQ-link de site                                                    |
| LDAP-Display-Name | mSMQSiteLink                                                      |
| Privilégio de atualização  | O proprietário da fila.                                                  |
| Frequência de atualização  | Uma instância é criada por cada par de sites que estão conectados. |
...
| Superiores possíveis          | [**MSMQ-Enterprise-Settings**](c-msmqenterprisesettings.md)                                 |
| Classes Auxiliares           | \-                                                                                           |
...
| [**Custo de MSMQ**](a-msmqcost.md)                                           | True      | **MSMQ-link de site**              |
| [**MSMQ-site-1**](a-msmqsite1.md)                                        | True      | **MSMQ-link de site**              |
| [**MSMQ-site-2**](a-msmqsite2.md)                                        | True      | **MSMQ-link de site**              |
| [**MSMQ-sites-Gates**](a-msmqsitegates.md)                                | Falso     | **MSMQ-link de site**              |
| [**MSMQ-site-Gates-MiG**](a-msmqsitegatesmig.md)                         | Falso     | **MSMQ-link de site**              |
