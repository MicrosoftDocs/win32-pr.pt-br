...
| [**Nome comum**](a-cn.md)                                               | True      |  [ **Parte superior** do contêiner](c-top.md)<br/> |
...
| RDN-ATT-ID                  | [**Nome comum**](a-cn.md)<br/>                                                                                                                                                                                                                                   |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                                                                                                                                                          |
| Superiores possíveis          | Domínio da [**organização**](c-organization.md)[**configuração**](c-configuration.md)do **contêiner** da [**unidade organizacional**](c-organizationalunit.md)[**-DNS**](c-domaindns.md)[**NTDS-**](c-ntdsservice.md)[**sub-rede**](c-subnet.md) [**do servidor**](c-server.md)de serviço |
| Classes Auxiliares           | \-                                                                                                                                                                                                                                                                       |
| NT-Security-Descriptor      | O:BAG: INADEQUADO: S:                                                                                                                                                                                                                                                             |
