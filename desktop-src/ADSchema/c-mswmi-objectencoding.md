...
ms.locfileid: "119440286"
---
# <a name="ms-wmi-objectencoding-class"></a>classe MS-WMI-objectencoding

Contém dados de codificação para uma classe WMI ou objeto de instância, bem como informações adicionais sobre o objeto.
...
| [**Classe ms-WMI**](a-mswmi-class.md)                                       | True      | **ms-WMI-ObjectEncoding**       |
| [**ms-WMI-Ltda**](a-mswmi-genus.md)                                       | True      | **ms-WMI-ObjectEncoding**       |
