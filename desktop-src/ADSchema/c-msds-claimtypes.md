...
keywords:
- Esquema do AD da classe ms-DS-Claim-Types
- Classe AD Schema msDS-ClaimTypes
topic_type:
- apiref
api_name:
- ms-DS-Claim-Types
...
ms.locfileid: "118422771"
---
# <a name="ms-ds-claim-types-class"></a>Classe ms-DS-Claim-Types

Um contêiner dessa classe pode conter objetos de tipo de declaração.
