...
ms.locfileid: "119648526"
---
# <a name="netboot-new-machine-ou-attribute"></a>netboot – atributo New-Machine-UO

Indica onde a nova conta de computador cliente será criada.



| Entrada | Valor |
|-------------------|-----------------------------------------|
| CN                | netboot – nova máquina-UO                  |
