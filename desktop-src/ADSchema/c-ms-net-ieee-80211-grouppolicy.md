...
Essa classe representa um objeto de Política de Grupo de rede sem fio 802,11. Essa classe contém identificadores e dados de configuração relevantes para uma rede sem fio 802,11.
...
| Superiores possíveis          | [**Computador**](c-computer.md) [**contêiner**](c-container.md)de [**pessoa**](c-person.md)     |
| Classes Auxiliares           | \-                                                                                           |
