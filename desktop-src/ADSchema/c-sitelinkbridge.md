...
description: Um objeto para acompanhar os links do site que estão conectados transitivamente.
ms.assetid: dabd236e-f4e7-4a4b-92ea-c0d144dea74c
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe Site-Link-Bridge
- Esquema do AD da classe siteLinkBridge
topic_type:
- apiref
api_name:
- Site-Link-Bridge
...
ms.locfileid: "119548896"
---
# <a name="site-link-bridge-class"></a>Classe Site-Link-Bridge

Um objeto para acompanhar os links do site que estão conectados transitivamente.
...
| Frequência de atualização  | Sempre que um link do site precisar ser adicionado ou removido da ponte. |
...
| [**Lista de links de site**](a-sitelinklist.md)                                  | Verdadeiro      | **Site-link-Bridge**            |
...
| [**Site-Link-List**](a-sitelinklist.md)                                    | Verdadeiro      | **Site-Link-Bridge**            |
| [**Site-Object-BL**](a-siteobjectbl.md)                                    | Falso     | [**Início**](c-top.md)<br/> |
