...
Um objeto para acompanhar os links de site que estão conectados transitivamente.
...
| Frequência de atualização  | Sempre que um link de site precisa ser adicionado ou removido da ponte. |
...
| [**Lista de links de site**](a-sitelinklist.md)                                  | True      | **Site-link-Bridge**            |
