...
---
# <a name="friendly-names-attribute"></a>Friendly-Names atributo

Lista de definições de nome de exibição padrão com suporte por um catálogo.
...
| Classes usadas em        | [**Index-Server-Catalog**](c-indexservercatalog.md)<br/> |
