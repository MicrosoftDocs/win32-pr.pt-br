...
description: Objeto de parâmetro de conjunto de inteiros com sinal.
ms.assetid: ad7b7a66-3216-496f-a40d-f3b4ab8de8ec
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-WMI-IntSetParam
- Esquema do AD da classe msWMI-IntSetParam
topic_type:
- apiref
api_name:
- ms-WMI-IntSetParam
...
ms.locfileid: "119440326"
---
# <a name="ms-wmi-intsetparam-class"></a>Classe ms-WMI-IntSetParam

Objeto de parâmetro de conjunto de inteiros com sinal.
