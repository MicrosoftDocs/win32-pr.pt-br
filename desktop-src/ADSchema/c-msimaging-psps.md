...
description: contêiner para todos os Enterprise examinar objetos de processo após a verificação.
...
ms.locfileid: "118175730"
---
# <a name="ms-imaging-psps-class"></a>classe MS-Imaging-PSPs

contêiner para todos os Enterprise examinar objetos de processo após a verificação.
...
| [**Nome comum**](a-cn.md)                                                      | Verdadeiro      | [**Contêiner**](c-container.md)<br/> [**Início**](c-top.md)<br/> |
...
| [**Versão do esquema**](a-schemaversion.md)                                        | Falso     | [**Contêiner**](c-container.md)<br/>                                 |
