...
---
# <a name="print-start-time-attribute"></a>Imprimir-atributo de hora de início

O tempo que uma fila de impressão começa a atender aos trabalhos.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Imprimir-hora de início                     |
| LDAP-Display-Name | imstart                       |
| Tamanho              | 4 bytes                              |
