...
ms.locfileid: "119922736"
---
# <a name="file-link-tracking-class"></a>Classe de rastreamento de link de arquivo

Contêiner para objetos de entrada de controle de link de arquivo.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Rastreamento de link de arquivo                   |
