...
description: Representa uma abstração de uma conta com atributos POSIX (Interface de Sistema Operacional Portátil).
ms.assetid: 3b7ca288-ede3-4fbd-a0c1-5083017acaff
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe posixAccount
topic_type:
- apiref
api_name:
- posixAccount
...
ms.locfileid: "118959725"
---
# <a name="posixaccount-class"></a>Classe posixAccount

Representa uma abstração de uma conta com atributos POSIX (Interface de Sistema Operacional Portátil).
...
| [**Descrição**](a-description.md)                                        | Falso     | **posixAccount** [ **Top**](c-top.md)<br/> |
...
| [**Diretório inicial**](a-homedirectory.md)                                   | Falso     | **posixAccount**                                 |
...
| [**Senha do usuário**](a-userpassword.md)                                     | Falso     | **posixAccount**                                 |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                  | Falso     | [**Início**](c-top.md)<br/>                  |
| [**Nome canônico**](a-canonicalname.md)                                      | Falso     | [**Início**](c-top.md)<br/>                  |
| [**Nome comum**](a-cn.md)                                                    | Falso     | **posixAccount** [ **superior**](c-top.md)<br/> |
| [**Criação-carimbo de data/hora**](a-createtimestamp.md)                                 | Falso     | [**Início**](c-top.md)<br/>                  |
| [**Descrição**](a-description.md)                                           | Falso     | **posixAccount** [ **superior**](c-top.md)<br/> |
| [**Nome de exibição**](a-displayname.md)                                          | Falso     | [**Início**](c-top.md)<br/>                  |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                       | Falso     | [**Início**](c-top.md)<br/>                  |
...
| [**unixHomeDirectory**](a-unixhomedirectory.md)                               | Falso     | **posixAccount**                                 |
| [**unixUserPassword**](a-unixuserpassword.md)                                 | Falso     | **posixAccount**                                 |
| [**Usuário-senha**](a-userpassword.md)                                        | Falso     | **posixAccount**                                 |
| [**USN-alterado**](a-usnchanged.md)                                            | Falso     | [**Início**](c-top.md)<br/>                  |
