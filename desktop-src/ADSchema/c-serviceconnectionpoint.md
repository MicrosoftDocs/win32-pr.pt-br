...
---
# <a name="service-connection-point-class"></a>Classe de ponto de conexão de serviço

Esse objeto destina-se à publicação de informações que os aplicativos cliente podem usar para se associar a um serviço.
