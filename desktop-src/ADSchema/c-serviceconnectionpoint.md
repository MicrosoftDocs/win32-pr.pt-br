...
description: Esse objeto é para publicar informações que os aplicativos cliente podem usar para se vincular a um serviço.
ms.assetid: 8615dc9a-001c-4a48-a9dd-0b1772b35c46
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe Service-Connection-Point
- Esquema do AD da classe serviceConnectionPoint
topic_type:
- apiref
api_name:
...
ms.locfileid: "119533646"
---
# <a name="service-connection-point-class"></a>Classe Service-Connection-Point

Esse objeto é para publicar informações que os aplicativos cliente podem usar para se vincular a um serviço.



| Entrada | Valor |
|-------------------|------------------------------------------------------------|
| CN                | Ponto de conexão de serviço                                   |
| Ldap-Display-Name | Serviceconnectionpoint                                     |
| Privilégio de atualização  | Um administrador ou qualquer pessoa que precise instalar o serviço. |
| Frequência de atualização  | Quando um novo serviço é instalado.                           |
...
| Possíveis superiores          | [**Unidade organizacional**](c-computer.md)[**do contêiner**](c-container.md)de [**computador**](c-organizationalunit.md)                |
| Classes Auxiliares           | \-                                                                                                                               |
| Descritor de segurança NT      | O:BAG:BAD:S:                                                                                                                     |
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; CO)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY)(A;; RPLCLORC;;; AU) |
...
| [**Service-Binding-Information**](a-servicebindinginformation.md)        | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Nome da classe de serviço**](a-serviceclassname.md)                          | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Nome DNS do serviço**](a-servicednsname.md)                              | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Service-DNS-Name-Type**](a-servicednsnametype.md)                     | Falso     | **Ponto de conexão de serviço**                                                             |
...
| Subclasse de                 | [**Ponto de conexão**](c-connectionpoint.md)<br/>                                                                         |
| Superiores possíveis          | [**Unidade organizacional**](c-organizationalunit.md) do [**contêiner**](c-container.md)do [**computador**](c-computer.md)                |
| Classes Auxiliares           | \-                                                                                                                               |
| NT-Security-Descriptor      | O:BAG: INADEQUADO: S:                                                                                                                     |
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; CO) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; AU |
| System-Flags                | 0x00000010                                                                                                                       |
...
| [**Versão de esquema de aplicativo**](a-appschemaversion.md)                            | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/>                                                          |
...
| [**Associação de serviço-informações**](a-servicebindinginformation.md)          | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Nome da classe de serviço**](a-serviceclassname.md)                            | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Nome DNS do serviço**](a-servicednsname.md)                                | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Serviço-DNS-tipo de nome**](a-servicednsnametype.md)                       | Falso     | **Ponto de conexão de serviço**                                                             |
...
| [**USN-Last-obj-REM**](a-usnlastobjrem.md)                                 | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**USN-Source**](a-usnsource.md)                                           | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Fornecedor**](a-vendor.md)                                                  | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Número de versão**](a-versionnumber.md)                                   | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Version-Number-Hi**](a-versionnumberhi.md)                              | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Version-Number-Lo**](a-versionnumberlo.md)                              | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Wbem-Path**](a-wbempath.md)                                             | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Objetos conhecidos**](a-wellknownobjects.md)                            | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Quando alterado**](a-whenchanged.md)                                       | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Quando criado**](a-whencreated.md)                                       | Falso     | [**Início**](c-top.md)<br/>                                                          |
...
| [**Classes filho permitidas**](a-allowedchildclasses.md)                      | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Allowed-Child-Classes-Effective**](a-allowedchildclasseseffective.md)   | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**App-Schema-Version**](a-appschemaversion.md)                            | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Common-Name**](a-cn.md)                                                 | Verdadeiro      | [**Ponto de conexão**](c-connectionpoint.md)<br/> [**Início**](c-top.md)<br/> |
| [**Criar carimbo de data/hora**](a-createtimestamp.md)                              | Falso     | [**Início**](c-top.md)<br/>                                                          |
...
| [**Fornecedor**](a-vendor.md)                                                  | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Número de versão**](a-versionnumber.md)                                   | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Versão-número-Olá**](a-versionnumberhi.md)                              | Falso     | **Ponto de conexão de serviço**                                                             |
| [**Versão-número-lo**](a-versionnumberlo.md)                              | Falso     | **Ponto de conexão de serviço**                                                             |
