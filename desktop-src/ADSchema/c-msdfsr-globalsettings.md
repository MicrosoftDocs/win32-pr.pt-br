...
ms.locfileid: "118680786"
---
# <a name="ms-dfsr-globalsettings-class"></a>classe MS-DFSR-GlobalSettings

Contém as configurações globais que se aplicam a todos os membros do grupo de replicação.
...
| [**MS-DFSR-flags**](a-msdfsr-flags.md)                                        | Falso     | **MS-DFSR-GlobalSettings**      |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Falso     | [**Início**](c-top.md)<br/> |
| [**MS-DFSR-opções**](a-msdfsr-options.md)                                    | Falso     | **MS-DFSR-GlobalSettings**      |
...
A **classe ms-DFSR-GlobalSettings** faz parte do suporte ao serviço de replicação Sistema de Arquivos Distribuído (DFS).
