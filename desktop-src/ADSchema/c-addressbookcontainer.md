...
---
# <a name="address-book-container-class"></a>Classe do catálogo de endereços-contêiner

Contêiner para manter membros de uma exibição de catálogo de endereços.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Catálogo de endereços-contêiner               |
...
| [**Nome de exibição**](a-displayname.md)                                     | True      | **Catálogo de endereços-** [ **parte superior** do contêiner](c-top.md)<br/> |
