...
---
# <a name="ms-wmi-query-attribute"></a>MS-WMI-atributo de consulta

Uma única consulta WQL.
...
|-------------------|---------------------------------------------|
| CN                | MS-WMI-Query                                |
| LDAP-Display-Name | msWMI-consulta                                 |
| Tamanho              | Menos de 250 caracteres.                   |
...
| Classes usadas em        | [**MS-WMI-Rule**](c-mswmi-rule.md)<br/> |
