...
keywords:
- Esquema do AD da classe ms-DFSR-ContentSet
- Esquema do AD da classe msDFSR-ContentSet
topic_type:
- apiref
api_name:
- ms-DFSR-ContentSet
...
ms.locfileid: "118423067"
---
# <a name="ms-dfsr-contentset-class"></a>Classe ms-DFSR-ContentSet

Define as informações de configuração do conjunto de conteúdo.
...
| Possíveis superiores          | [**ms-DFSR-Content**](c-msdfsr-content.md)                                                                                      |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**Descrição**](a-description.md)                                        | Falso     | **ms-DFSR-ContentSet** [ **Top**](c-top.md)<br/> |
...
| [**MS-DFSR-filtro de**](a-msdfsr-filefilter.md)                           | Falso     | **MS-DFSR-Contentset**                                 |
...
| [**MS-DFSR-opções**](a-msdfsr-options.md)                                 | Falso     | **MS-DFSR-Contentset**                                 |
...
| RDN-ATT-ID                  | \-                                                                                                                               |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Superiores possíveis          | [**MS-DFSR-Content**](c-msdfsr-content.md)                                                                                      |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**Common-Name**](a-cn.md)                                                                     | Falso     | [**Início**](c-top.md)<br/>                        |
| [**Criar carimbo de data/hora**](a-createtimestamp.md)                                                  | Falso     | [**Início**](c-top.md)<br/>                        |
| [**Descrição**](a-description.md)                                                            | Falso     | **MS-DFSR-contentset** [ **superior**](c-top.md)<br/> |
| [**Nome de exibição**](a-displayname.md)                                                           | Falso     | [**Início**](c-top.md)<br/>                        |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                                        | Falso     | [**Início**](c-top.md)<br/>                        |
...
A classe **MS-DFSR-contentset** faz parte do suporte ao serviço de replicação do sistema de arquivos distribuído (DFS).
