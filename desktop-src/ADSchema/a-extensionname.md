...
ms.locfileid: "119929676"
---
# <a name="extension-name-attribute"></a>Extension-Name atributo

O nome de uma página de propriedades usada para estender a interface do usuário de um objeto de diretório.
...
| Tamanho              | \-                                          |
| Privilégio de atualização  | O criador do objeto de extensão.        |
| Frequência de atualização  | Sempre que uma nova extensão de interface do usuário for criada.     |
