...
Classe para armazenar SQL Server propriedades do repositório.
...
| [**MS-SQL-descrição**](a-ms-sql-description.md)                        | Falso     | **MS-SQL-sqlrepository**        |
...
| [**Versão do MS-SQL**](a-ms-sql-version.md)                                | Falso     | **MS-SQL-sqlrepository**        |
