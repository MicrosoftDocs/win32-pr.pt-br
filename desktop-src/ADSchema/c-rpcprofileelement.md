...
---
# <a name="rpc-profile-element-class"></a>classe de elemento do perfil RPC

Mantém uma entrada em um perfil RPC.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Elemento de perfil RPC                  |
...
| Superiores possíveis          | [**Perfil RPC**](c-rpcprofile.md)                                                          |
| Classes Auxiliares           | \-                                                                                           |
...
| [**RPC-NS-Annotation**](a-rpcnsannotation.md)                            | Falso     | **Elemento de perfil RPC**                                                                  |
| [**RPC-NS-interface-ID**](a-rpcnsinterfaceid.md)                         | True      | **Elemento de perfil RPC**                                                                  |
| [**RPC-NS-Priority**](a-rpcnspriority.md)                                | True      | **Elemento de perfil RPC**                                                                  |
| [**RPC-NS-Profile-entry**](a-rpcnsprofileentry.md)                       | Falso     | **Elemento de perfil RPC**                                                                  |
