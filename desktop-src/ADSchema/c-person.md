...
ms.locfileid: "119753056"
---
# <a name="person-class"></a>Classe Person

Contém informações pessoais sobre um usuário.
...
| [**Nome comum**](a-cn.md)                                               | Verdadeiro      |  [ **Parte superior** da pessoa](c-top.md)<br/> |
...
| [**Consulte também**](a-seealso.md)                                             | Falso     | **Person**                                 |
...
| [**Sobrenome**](a-sn.md)                                                   | Falso     | **Person**                                 |
| [**Sinalizadores de sistema**](a-systemflags.md)                                     | Falso     | [**Início**](c-top.md)<br/>            |
| [**Número de telefone**](a-telephonenumber.md)                             | Falso     | **Person**                                 |
| [**Senha do usuário**](a-userpassword.md)                                   | Falso     | **Person**                                 |
...
| [**Consulte-também**](a-seealso.md)                                               | Falso     | **Person**                                 |
| [**Número de série**](a-serialnumber.md)                                     | Falso     | **Person**                                 |
...
| [**Número de telefone**](a-telephonenumber.md)                               | Falso     | **Person**                                 |
| [**Usuário-senha**](a-userpassword.md)                                     | Falso     | **Person**                                 |
| [**USN-alterado**](a-usnchanged.md)                                         | Falso     | [**Início**](c-top.md)<br/>            |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/>            |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/>            |
| [**Common-Name**](a-cn.md)                                                 | Verdadeiro      | **Person** [ **Top**](c-top.md)<br/> |
