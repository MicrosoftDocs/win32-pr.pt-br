...
description: Contém uma instância de objeto compilado WMI.
ms.assetid: 8691ae8f-e5fa-439a-bade-5e278b74e959
ms.tgt_platform: multiple
keywords:
- Esquema AD da classe MS-WMI-ShadowObject
- Esquema do AD da classe msWMI-ShadowObject
topic_type:
- apiref
api_name:
- ms-WMI-ShadowObject
...
ms.locfileid: "118175169"
---
# <a name="ms-wmi-shadowobject-class"></a>Classe ms-WMI-ShadowObject

Contém uma instância de objeto compilado WMI.
...
| Possíveis superiores          | [**ms-WMI-PolicyType**](c-mswmi-policytype.md)                                              |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MS-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Verdadeiro      | **MS-WMI-Shadowobject**         |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Superiores possíveis          | [**MS-WMI-PolicyType**](c-mswmi-policytype.md)                                              |
| Classes Auxiliares           | \-                                                                                           |
