...
| [**ms-DS-Claim-is-valor único**](a-msds-claimissinglevalued.md)                           | True      | **ms-DS-Value-Type**            |
| [**ms-DS-Claim-is-Value-Space-delimitado**](a-msds-claimisvaluespacerestricted.md)          | True      | **ms-DS-Value-Type**            |
| [**ms-DS-Claim-shares-possíveis-Values-with-BL**](a-msds-claimsharespossiblevalueswithbl.md) | Falso     | [**Início**](c-top.md)<br/> |
| [**Tipo de valor do MS-DS-Claim**](a-msds-claimvaluetype.md)                                      | True      | **ms-DS-Value-Type**            |
...
| [**ms-DS-is-possíveis-Values-Present**](a-msds-ispossiblevaluespresent.md)                   | True      | **ms-DS-Value-Type**            |
