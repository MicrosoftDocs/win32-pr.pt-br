...
ms.locfileid: "119879786"
---
# <a name="ms-ds-value-type-class"></a>classe de tipo ms-DS-Value

Um objeto de tipo de valor contém informações de tipo de valor para uma propriedade de recurso.
...
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; EA) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D Um |
...
| [**ms-DS-Claim-is-valor único**](a-msds-claimissinglevalued.md)                           | Verdadeiro      | **ms-DS-Value-Type**            |
| [**ms-DS-Claim-is-Value-Space-delimitado**](a-msds-claimisvaluespacerestricted.md)          | Verdadeiro      | **ms-DS-Value-Type**            |
| [**ms-DS-Claim-shares-possíveis-Values-with-BL**](a-msds-claimsharespossiblevalueswithbl.md) | Falso     | [**Início**](c-top.md)<br/> |
| [**Tipo de valor do MS-DS-Claim**](a-msds-claimvaluetype.md)                                      | Verdadeiro      | **ms-DS-Value-Type**            |
...
| [**ms-DS-is-possíveis-Values-Present**](a-msds-ispossiblevaluespresent.md)                   | Verdadeiro      | **ms-DS-Value-Type**            |
