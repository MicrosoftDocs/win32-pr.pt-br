...
keywords:
- Esquema do AD da classe ms-DFSR-Topology
- Esquema do AD da classe msDFSR-Topology
topic_type:
- apiref
api_name:
- ms-DFSR-Topology
...
ms.locfileid: "118959855"
---
# <a name="ms-dfsr-topology-class"></a>Classe ms-DFSR-Topology

Contém os objetos que formam a topologia de replicação.
...
| Possíveis superiores          | [**ms-DFSR-ReplicationGroup**](c-msdfsr-replicationgroup.md)                                                                    |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**MS-DFSR-opções**](a-msdfsr-options.md)                                 | Falso     | **MS-DFSR-Topology**            |
...
| RDN-ATT-ID                  | \-                                                                                                                               |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Superiores possíveis          | [**MS-DFSR-telereplication**](c-msdfsr-replicationgroup.md)                                                                    |
| Classes Auxiliares           | \-                                                                                                                               |
...
A classe **MS-DFSR-Topology** faz parte do suporte ao serviço de replicação do sistema de arquivos distribuído (DFS).
