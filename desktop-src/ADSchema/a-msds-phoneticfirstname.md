...
description: Contém o nome ou o nome phoneético da pessoa.
ms.assetid: a1338295-4545-4146-9dfe-8e45d5f9fdf4
ms.tgt_platform: multiple
keywords:
- Esquema do AD do atributo ms-DS-Phonetic-First-Name
- Esquema do AD do atributo msDS-PhoneticFirstName
topic_type:
- apiref
api_name:
