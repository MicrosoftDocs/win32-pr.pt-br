...
ms.locfileid: "119879406"
---
# <a name="ms-tapi-rt-conference-class"></a>classe MS-TAPI-RT-Conference

Usado para publicar uma conferência de multicast de TAPI em tempo real.
...
| Frequência de atualização  | A frequência de criação está no critério do usuário sempre que uma conferência TAPI precisa ser publicada. Depois de criado, o tempo de vida típico de um objeto de conferência TAPI pode estar no intervalo de 30 minutos a 1 ano. |
...
| RDN-ATT-ID                  | [**MS-TAPI-identificador exclusivo**](a-mstapi-uid.md)<br/>                                 |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Superiores possíveis          | [**Unidade organizacional**](c-organizationalunit.md)                                          |
| Classes Auxiliares           | \-                                                                                           |
...
| [**ms-TAPI-Unique-Identifier**](a-mstapi-uid.md)                           | Verdadeiro      | **ms-TAPI-Rt-Conference**       |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Possíveis superiores          | [**Unidade organizacional**](c-organizationalunit.md)                                          |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MS-TAPI-Conference-blob**](a-mstapi-conferenceblob.md)                  | Falso     | **MS-TAPI-RT-Conference**       |
| [**MS-TAPI-Protocol-ID**](a-mstapi-protocolid.md)                          | Falso     | **MS-TAPI-RT-Conference**       |
| [**MS-TAPI-identificador exclusivo**](a-mstapi-uid.md)                           | Verdadeiro      | **MS-TAPI-RT-Conference**       |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                    | Falso     | [**Início**](c-top.md)<br/> |
