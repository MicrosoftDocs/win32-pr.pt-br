...
Representa uma abstração da Associação de chamada de procedimento remoto (RPC) de computação de rede aberta (ONC).
...
| [**Nome comum**](a-cn.md)                                                 | True      | **oncRpc** [ **superior**](c-top.md)<br/> |
