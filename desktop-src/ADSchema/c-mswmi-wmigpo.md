...
description: Esse valor é gravado no Active Directory no caminho apontado pelo objeto Política de Grupo correspondente. Ele destina-se a unir os vários objetos usados para expressar as extensões WMI para a infraestrutura Política de Grupo dados.
ms.assetid: fe70fb59-7ba5-4ae1-ac3e-9a521157bc9b
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe MS-WMI-WMIGPO
- Esquema do AD da classe msWMI-WMIGPO
topic_type:
- apiref
api_name:
- ms-WMI-WMIGPO
...
ms.locfileid: "119753626"
---
# <a name="ms-wmi-wmigpo-class"></a>Classe ms-WMI-WMIGPO

Esse valor é gravado no Active Directory no caminho apontado pelo objeto Política de Grupo correspondente. Ele destina-se a unir os vários objetos usados para expressar as extensões WMI para a infraestrutura Política de Grupo dados.
...
| Descritor de segurança padrão | D:(A;; RPLCLORC;;; AU)(A;; RPWPCRLCLOCCDCRCWDWOSW;;;D A)(A;; CC;;; PA)(A;; RPWPCRLCLOCCDCRCWDWOSDDTSW;;; SY) |
...
| [**MS-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Verdadeiro      | **MS-WMI-WMIGPO**               |
