...
Esse valor é gravado no Active Directory no caminho apontado pelo objeto Política de Grupo correspondente. Ele se destina a unir os vários objetos usados para expressar as extensões WMI para a infraestrutura de Política de Grupo.
