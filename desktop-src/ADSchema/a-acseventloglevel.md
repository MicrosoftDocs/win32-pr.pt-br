...
---
# <a name="acs-event-log-level-attribute"></a>ACS-atributo de nível de log de evento
...
| Entrada | Valor |
|-------------------|-----------------------------------------|
| CN                | ACS-nível de log de eventos                     |
| LDAP-Display-Name | aCSEventLogLevel                        |
| Tamanho              | 4 bytes pode ter os valores 0, 1, 2 e 3. |
