...
---
# <a name="remote-mail-recipient-class"></a>Classe de destinatário de email remoto

Um destinatário de email externo. Este atributo está obsoleto.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Email remoto-destinatário                |
