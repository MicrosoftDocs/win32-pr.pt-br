...
description: Um destinatário de email externo. Esse atributo está obsoleto.
ms.assetid: df405a53-b522-42e8-907e-2c4a2296b971
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe Remote-Mail-Recipient
- Esquema do AD da classe remoteMailRecipient
topic_type:
- apiref
api_name:
...
ms.locfileid: "119752776"
---
# <a name="remote-mail-recipient-class"></a>Classe Remote-Mail-Recipient

Um destinatário de email externo. Esse atributo está obsoleto.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Destinatário de email remoto                |
...
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY)(A;; RPLCLORC;;; AU)(OA;; CR;ab721a55-1e2f-11d0-9819-00aa0040529b;; AU) |
...
| [**Gerenciado por**](a-managedby.md)                                         | Falso     | **Email remoto-destinatário**                                                            |
...
| [**Origem remota**](a-remotesource.md)                                   | Falso     | **Destinatário de email remoto**                                                            |
| [**Tipo de origem remota**](a-remotesourcetype.md)                          | Falso     | **Destinatário de email remoto**                                                            |
...
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; AU) (OA;; CR; ab721a55-1e2f-11D0-9819-00aa0040529b;; AU |
| System-Flags                | 0x00000010                                                                                                                                    |
...
| [**Gerenciado por**](a-managedby.md)                                           | Falso     | **Destinatário de email remoto**                                                            |
| [**Objetos gerenciados**](a-managedobjects.md)                                 | Falso     | [**Início**](c-top.md)<br/>                                                      |
...
| [**RDN**](a-name.md)                                                       | Falso     | [**Início**](c-top.md)<br/>                                                      |
| [**Origem remota**](a-remotesource.md)                                     | Falso     | **Email remoto-destinatário**                                                            |
| [**Tipo de origem remota**](a-remotesourcetype.md)                            | Falso     | **Email remoto-destinatário**                                                            |
| [**Repl-Property-meta-data**](a-replpropertymetadata.md)                   | Falso     | [**Início**](c-top.md)<br/>                                                      |
| [**Repl-UpToDate-vector**](a-repluptodatevector.md)                        | Falso     | [**Início**](c-top.md)<br/>                                                      |
| [**Relatórios**](a-directreports.md)                                          | Falso     | [**Início**](c-top.md)<br/>                                                      |
