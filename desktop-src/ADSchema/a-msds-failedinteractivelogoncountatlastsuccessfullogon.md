...
O número total de logons interativos com falha até o último logon do C-A-D bem-sucedido.



| Entrada | Valor |
|-------------------|---------------------------------------------------------------|
| CN                | ms-DS-Failed-Interactive-logon-contagem-em-último-logon bem-sucedido |
