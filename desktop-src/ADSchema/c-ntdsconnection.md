...
Uma conexão de um controlador de domínio remoto.
...
| Superiores possíveis          | [**NTDS-DSA**](c-ntdsdsa.md)[**NTFRS-réplica-Set**](c-ntfrsreplicaset.md)[**NTFRS-member**](c-ntfrsmember.md) |
| Classes Auxiliares           | \-                                                                                                               |
...
| [**Habilitado-conexão**](a-enabledconnection.md)                         | True      | **NTDS-conexão**             |
...
| [**Do-servidor**](a-fromserver.md)                                       | True      | **NTDS-conexão**             |
...
| [**Gerado-conexão**](a-generatedconnection.md)                     | Falso     | **NTDS-conexão**             |
...
| [**MS-DS-Replicas-NC-Reason**](a-ms-ds-replicatesncreason.md)          | Falso     | **NTDS-conexão**             |
...
| [**Opções**](a-options.md)                                              | True      | **NTDS-conexão**             |
...
| [**Agenda**](a-schedule.md)                                            | Falso     | **NTDS-conexão**             |
...
| [**Tipo de transporte**](a-transporttype.md)                                 | Falso     | **NTDS-conexão**             |
...
| RDN-ATT-ID                  | [**Nome comum**](a-cn.md)<br/> |
| Subclasse de                 | [**Leaf**](c-leaf.md)<br/>      |
| Superiores possíveis          | [**NTDS-DSA**](c-ntdsdsa.md)          |
| Classes Auxiliares           | \-                                     |
| NT-Security-Descriptor      | O:BAG: INADEQUADO: S:                           |
