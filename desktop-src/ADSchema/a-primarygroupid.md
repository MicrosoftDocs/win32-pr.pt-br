...
---
# <a name="primary-group-id-attribute"></a>Atributo Primary-Group-ID

Contém o identificador relativo (RID) do grupo primário do usuário. Por padrão, esse é o RID do grupo usuários do domínio.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | ID do grupo primário                     |
