...
keywords:
- Infrastructure-Update classe AD Schema
- InfrastructureUpdate classe AD Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119324486"
---
# <a name="infrastructure-update-class"></a>Infrastructure-Update classe

Esse objeto representa o mestre de infraestrutura para um domínio.
...
| Possíveis superiores          | [**Infraestrutura de**](c-domain.md)**Domínio – Atualização** |
| Classes Auxiliares           | \-                                                  |
...
| [**DN-Reference-Update**](a-dnreferenceupdate.md)                        | Falso     | **Atualização de infraestrutura**       |
...
| Nome comum                                                            |
|------------------------------------------------------------------------|
| [**Alterar infraestrutura-mestre**](r-change-infrastructure-master.md) |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                     |
| Superiores possíveis          | [](c-domain.md)**Infraestrutura de domínio-atualização** |
| Classes Auxiliares           | \-                                                  |
...
| [**Nome de exibição**](a-displayname.md)                                                        | Falso     | [**Início**](c-top.md)<br/> |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                                     | Falso     | [**Início**](c-top.md)<br/> |
| [**DN-referência-atualização**](a-dnreferenceupdate.md)                                           | Falso     | **Infraestrutura – atualização**       |
