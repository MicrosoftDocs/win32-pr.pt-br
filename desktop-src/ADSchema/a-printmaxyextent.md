...
ms.locfileid: "118682174"
---
# <a name="print-max-y-extent-attribute"></a>Imprimir-atributo de extensão Max-Y

A região de impressão vertical máxima.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Impressão-Max-Y-extensão                   |
