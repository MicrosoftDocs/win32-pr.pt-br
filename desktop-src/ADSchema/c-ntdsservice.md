...
description: Essa classe é usada para um objeto de serviços NTDS, que contém informações sobre a configuração da floresta do serviço de diretório. esse objeto é mantido no serviço de diretório cn, cn Windows NT, serviços cn, configuração de cn,... Container.
...
ms.locfileid: "119753446"
---
# <a name="ntds-service-class"></a>Classe NTDS-Service

Essa classe é usada para um objeto de serviços NTDS, que contém informações sobre a configuração da floresta do serviço de diretório. esse objeto é mantido no serviço de diretório cn =, cn = Windows NT, cn = Services, cn = Configuration,... Container.
...
| [**DS-heurística**](a-dsheuristics.md)                                   | Falso     | **NTDS-serviço**                |
...
| [**Lixo-Coll-period**](a-garbagecollperiod.md)                        | Falso     | **NTDS-serviço**                |
...
| [**Repl-topologia-permanecer de execução**](a-repltopologystayofexecution.md)  | Falso     | **NTDS-serviço**                |
...
| [**Mapeamentos de SPN**](a-spnmappings.md)                                     | Falso     | **NTDS-serviço**                |
...
| [**Desativação-tempo de vida**](a-tombstonelifetime.md)                         | Falso     | **NTDS-serviço**                |
...
| [**DS-Heuristics**](a-dsheuristics.md)                                     | Falso     | **NTDS-Service**                |
| [**Nome da extensão**](a-extensionname.md)                                   | Falso     | [**Início**](c-top.md)<br/> |
...
| [**Período de coleta de lixo**](a-garbagecollperiod.md)                          | Falso     | **NTDS-Service**                |
| [**Tipo de instância**](a-instancetype.md)                                     | Verdadeiro      | [**Início**](c-top.md)<br/> |
...
| [**ms-DS-Other-Configurações**](a-msds-other-settings.md)                       | Falso     | **NTDS-serviço**                |
...
| [**Site-Object-BL**](a-siteobjectbl.md)                                    | Falso     | [**Início**](c-top.md)<br/> |
| [**Mapeamentos de SPN**](a-spnmappings.md)                                       | Falso     | **NTDS-Service**                |
...
| [**Tempo de vida de tombstone**](a-tombstonelifetime.md)                           | Falso     | **NTDS-Service**                |
| [**USN alterado**](a-usnchanged.md)                                         | Falso     | [**Início**](c-top.md)<br/> |
...
| [**ms-DS-Other-Configurações**](a-msds-other-settings.md)                       | Falso     | **NTDS-Service**                |
| [**ms-DS-Repl-Attribute-Meta-Data**](a-msds-replattributemetadata.md)      | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-Repl-Value-Meta-Data**](a-msds-replvaluemetadata.md)              | Falso     | [**Início**](c-top.md)<br/> |
...
| [**MS-DS-Consistency-filho-Count**](a-ms-ds-consistencychildcount.md)           | Falso     | [**Início**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                        | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-Deleted-Object-tempo de vida**](a-msds-deletedobjectlifetime.md)            | Falso     | **NTDS-serviço**                |
