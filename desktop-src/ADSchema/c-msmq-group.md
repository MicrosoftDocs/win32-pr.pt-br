...
Usado para definir um grupo de filas do MSMQ (também conhecido como lista de distribuição).
...
|-------------------|---------------------------------------------------------|
| CN                | MSMQ-Group                                              |
| LDAP-Display-Name | Grupo msMQ                                              |
| Privilégio de atualização  | O proprietário da fila.                                        |
| Frequência de atualização  | Cada vez que um membro é adicionado ou removido de um grupo. |
...
| [**Membro**](a-member.md)                                                  | True      | **Grupo MSMQ**                  |
