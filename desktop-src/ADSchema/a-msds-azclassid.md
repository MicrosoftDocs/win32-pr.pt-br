...
---
# <a name="ms-ds-az-class-id-attribute"></a>atributo ms-DS-AZ-Class-ID

Uma ID de classe exigida pela interface do usuário do amAzRoles no objeto AzApplication.
...
| LDAP-Display-Name | msDS-AzClassId                              |
