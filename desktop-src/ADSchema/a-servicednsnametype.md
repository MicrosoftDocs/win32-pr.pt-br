...
ms.locfileid: "119836626"
---
# <a name="service-dns-name-type-attribute"></a>Atributo Service-DNS-Name-Type

Tipo de registro DNS a ser pesquisado para este serviço. Por exemplo, A ou SRV.



| Entrada | Valor |
|-------------------|---------------------------------------------|
| CN                | Serviço-DNS-tipo de nome                       |
...
| Classes usadas em        | [**Ponto de conexão de serviço**](c-serviceconnectionpoint.md)<br/> |
