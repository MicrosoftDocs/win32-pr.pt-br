---
title: Classe Application-Site-Configurações
description: Contém todas as configurações específicas do site.
ms.assetid: 9431ec9c-7647-4de8-94c0-824763ceee97
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe Application-Site-Configurações
- Esquema do AD da classe applicationSiteSettings
topic_type:
- apiref
api_name:
...
ms.locfileid: "119703906"
---
# <a name="application-site-settings-class"></a>Classe Application-Site-Configurações

Contém todas as configurações específicas do site.



| Entrada | Valor |
|-------------------|------------------------------------------------------|
| CN                | Application-Site-Configurações                            |
| Ldap-Display-Name | applicationSiteSettings                              |
| Privilégio de atualização  | O sistema define esse valor.                          |
| Frequência de atualização  | Sempre que esse direito estendido se aplica a uma nova classe. |
...
| [**Nome do Aplicativo**](a-applicationname.md)                             | Falso     | **Application-Site-Configurações**   |
...
| [**Lista de notificações**](a-notificationlist.md)                           | Falso     | **Application-Site-Configurações**   |
...
| [**Lista de notificações**](a-notificationlist.md)                             | Falso     | **aplicativo-Configurações de Site**   |
| [**NT-Security-Descriptor**](a-ntsecuritydescriptor.md)                    | Verdadeiro      | [**Início**](c-top.md)<br/> |
| [**Obj-dist-Name**](a-distinguishedname.md)                                | Falso     | [**Início**](c-top.md)<br/> |
| [**Objeto-categoria**](a-objectcategory.md)                                 | Verdadeiro      | [**Início**](c-top.md)<br/> |
| [**Classe de objeto**](a-objectclass.md)                                       | Verdadeiro      | [**Início**](c-top.md)<br/> |
...
| [**Classes filho permitidas**](a-allowedchildclasses.md)                           | Falso     | [**Início**](c-top.md)<br/> |
| [**Permitido-filho-classes-efetivas**](a-allowedchildclasseseffective.md)        | Falso     | [**Início**](c-top.md)<br/> |
| [**Nome do aplicativo**](a-applicationname.md)                                    | Falso     | **aplicativo-Configurações de Site**   |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                    | Falso     | [**Início**](c-top.md)<br/> |
| [**Nome canônico**](a-canonicalname.md)                                        | Falso     | [**Início**](c-top.md)<br/> |
| [**Nome comum**](a-cn.md)                                                      | Falso     | [**Início**](c-top.md)<br/> |
| [**Criação-carimbo de data/hora**](a-createtimestamp.md)                                   | Falso     | [**Início**](c-top.md)<br/> |
