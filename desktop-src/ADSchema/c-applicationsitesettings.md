...
---
# <a name="application-site-settings-class"></a>Aplicativo-site-configurações classe
...
| Entrada | Valor |
|-------------------|------------------------------------------------------|
| CN                | Aplicativo-Configurações do site                            |
...
| [**Nome do aplicativo**](a-applicationname.md)                             | Falso     | **Aplicativo-Configurações do site**   |
...
| [**Lista de notificações**](a-notificationlist.md)                           | Falso     | **Aplicativo-Configurações do site**   |
