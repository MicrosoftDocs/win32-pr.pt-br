...
description: Contém a associação de computador local de um grupo de replicação.
ms.assetid: 02ce34b3-2dc0-44ae-b392-b1545e92a0f7
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-DFSR-Subscriber
- Esquema do AD da classe msDFSR-Subscriber
topic_type:
- apiref
api_name:
- ms-DFSR-Subscriber
...
ms.locfileid: "118959885"
---
# <a name="ms-dfsr-subscriber-class"></a>Classe ms-DFSR-Subscriber

Contém a associação de computador local de um grupo de replicação.
...
| Possíveis superiores          | [**ms-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**ms-DFSR-MemberReference**](a-msdfsr-memberreference.md)                 | Verdadeiro      | **ms-DFSR-Subscriber**          |
...
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)       | Verdadeiro      | **ms-DFSR-Subscriber**          |
...
| RDN-ATT-ID                  | \-                                                                                                                               |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Superiores possíveis          | [**MS-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**MS-DFSR-MemberReference**](a-msdfsr-memberreference.md)                                  | Verdadeiro      | **MS-DFSR-Subscriber**          |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                              | Falso     | [**Início**](c-top.md)<br/> |
| [**MS-DFSR-opções**](a-msdfsr-options.md)                                                  | Falso     | **MS-DFSR-Subscriber**          |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                                | Falso     | **MS-DFSR-Subscriber**          |
| [**MS-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)                        | Verdadeiro      | **MS-DFSR-Subscriber**          |
...
A classe **MS-DFSR-Subscriber** faz parte do suporte ao serviço de replicação do sistema de arquivos distribuído (DFS).
