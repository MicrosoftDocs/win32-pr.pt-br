...
---
# <a name="inter-site-transport-class"></a>Classe de transporte entre sites

Atributo opcional de objetos ntdsConnection. Se presente, mantém o DN de um objeto interSiteTransport no CN = Transportes entre sites, CN = sites, CN = Configuration,... Container.
...
| Frequência de atualização  | Criados/gerenciados pelo Knowledge Consistency Checker em resposta a alterações na topologia de rede (incluindo interrupções temporárias). |
...
| [**Transporte-endereço-atributo**](a-transportaddressattribute.md)        | True      | **Transporte entre sites**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | True      | **Transporte entre sites**        |
