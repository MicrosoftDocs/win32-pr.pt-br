...
description: Atributo opcional de objetos ntdsConnection. Se presente, contém o DN de um objeto interSiteTransport no CN Inter-Site Transports,CN Sites, Configuração cn,... Recipiente.
ms.assetid: eeeb47aa-cfe8-4ff6-86e7-b3e1727c907a
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe Inter-Site-Transport
- Esquema do AD da classe interSiteTransport
topic_type:
- apiref
api_name:
...
ms.locfileid: "119703676"
---
# <a name="inter-site-transport-class"></a>Classe Inter-Site-Transport

Atributo opcional de objetos ntdsConnection. Se presente, contém o DN de um objeto interSiteTransport em CN=Inter-Site Transports,CN=Sites,CN=Configuration,... Recipiente.



| Entrada | Valor |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------|
| CN                | Transporte entre sites                                                                                                               |
| Ldap-Display-Name | interSiteTransport                                                                                                                 |
| Privilégio de atualização  | Esse valor é definido pelo KCC ou pelo administrador corporativo.                                                                          |
| Frequência de atualização  | Criado/gerenciado pelo Knowledge Consistency Checker em resposta a alterações na topologia de rede (incluindo interrupções temporárias). |
...
| Possíveis superiores          | [**Inter-Site-Transport-Container**](c-intersitetransportcontainer.md)                      |
| Classes Auxiliares           | \-                                                                                           |
...
| [**Opções**](a-options.md)                                              | Falso     | **Transporte entre sites**        |
...
| [**Intervalo de repl**](a-replinterval.md)                                   | Falso     | **Transporte entre sites**        |
...
| [**Transport-Address-Attribute**](a-transportaddressattribute.md)        | Verdadeiro      | **Transporte entre sites**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | Verdadeiro      | **Transporte entre sites**        |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Superiores possíveis          | [**Contêiner de transporte entre sites**](c-intersitetransportcontainer.md)                      |
| Classes Auxiliares           | \-                                                                                           |
...
| [**RDN**](a-name.md)                                                       | Falso     | [**Início**](c-top.md)<br/> |
| [**Repl-intervalo**](a-replinterval.md)                                     | Falso     | **Transporte entre sites**        |
| [**Repl-Property-meta-data**](a-replpropertymetadata.md)                   | Falso     | [**Início**](c-top.md)<br/> |
| [**Repl-UpToDate-vector**](a-repluptodatevector.md)                        | Falso     | [**Início**](c-top.md)<br/> |
| [**Relatórios**](a-directreports.md)                                          | Falso     | [**Início**](c-top.md)<br/> |
...
| [**Transporte-endereço-atributo**](a-transportaddressattribute.md)          | Verdadeiro      | **Transporte entre sites**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                            | Verdadeiro      | **Transporte entre sites**        |
| [**USN-alterado**](a-usnchanged.md)                                         | Falso     | [**Início**](c-top.md)<br/> |
