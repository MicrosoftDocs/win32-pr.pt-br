...
description: A lista dos principais usuários de cota atualmente no banco de dados de diretório, ordenados diminuindo o uso de cota.
ms.assetid: c52db8c8-233c-495f-b3fe-edbe1d723677
ms.tgt_platform: multiple
keywords:
- Esquema do AD do atributo ms-DS-Top-Quota-Usage
- Esquema do AD do atributo msDS-TopQuotaUsage
topic_type:
- apiref
api_name:
...
ms.locfileid: "118683253"
---
# <a name="ms-ds-top-quota-usage-attribute"></a>Atributo ms-DS-Top-Quota-Usage

A lista dos principais usuários de cota atualmente no banco de dados de diretório, ordenados diminuindo o uso de cota.
