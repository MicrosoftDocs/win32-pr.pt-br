...
ms.locfileid: "120005366"
---
# <a name="rpc-server-element-class"></a>classe de elemento de servidor RPC

Representa uma única interface em um determinado servidor RPC.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Servidor RPC-elemento                   |
...
| Subclasse de                 | [**Entrada RPC**](c-rpcentry.md)<br/>                                                   |
| Superiores possíveis          | [**Servidor RPC**](c-rpcserver.md)                                                            |
| Classes Auxiliares           | \-                                                                                           |
...
| [**RPC-NS-bindings**](a-rpcnsbindings.md)                                | Verdadeiro      | **Servidor RPC-elemento**                                                                   |
| [**RPC-NS-interface-ID**](a-rpcnsinterfaceid.md)                         | Verdadeiro      | **Servidor RPC-elemento**                                                                   |
| [**RPC-NS-Transfer-Syntax**](a-rpcnstransfersyntax.md)                   | Verdadeiro      | **Servidor RPC-elemento**                                                                   |
...
| Subclasse de                 | [**rpc-Entry**](c-rpcentry.md)<br/>                                                   |
| Possíveis superiores          | [**rpc-Server**](c-rpcserver.md)                                                            |
| Classes Auxiliares           | \-                                                                                           |
...
| [**Reps-To**](a-repsto.md)                                                 | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Revisão**](a-revision.md)                                              | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**rpc-Ns-Bindings**](a-rpcnsbindings.md)                                  | Verdadeiro      | **rpc-Server-Element**                                                                   |
| [**rpc-Ns-Interface-ID**](a-rpcnsinterfaceid.md)                           | Verdadeiro      | **rpc-Server-Element**                                                                   |
| [**rpc-Ns-Transfer-Syntax**](a-rpcnstransfersyntax.md)                     | Verdadeiro      | **rpc-Server-Element**                                                                   |
