...
Mantém os registros de recurso DNS para um único host.
...
| Superiores possíveis          | [**Zona DNS**](c-dnszone.md)                                                                                                                                        |
| Classes Auxiliares           | \-                                                                                                                                                                   |
| NT-Security-Descriptor      | O:BAG: INADEQUADO: S:                                                                                                                                                         |
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; ED) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; CO) (A;; RPLCLORC;;; WD |
...
| [**Propriedade DNS**](a-dnsproperty.md)                                     | Falso     | **Nó DNS**                    |
| [**Registro de DNS**](a-dnsrecord.md)                                         | Falso     | **Nó DNS**                    |
| [**DNS-marcado para exclusão**](a-dnstombstoned.md)                                 | Falso     | **Nó DNS**                    |
| [**Componente de domínio**](a-dc.md)                                          | True      | **Nó DNS**                    |
