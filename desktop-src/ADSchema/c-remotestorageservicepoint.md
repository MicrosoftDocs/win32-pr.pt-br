---
title: classe de ponto de serviço Armazenamento remoto
...
keywords:
- Armazenamento remoto – esquema de classe de ponto de serviço
...
ms.locfileid: "118959685"
---
# <a name="remote-storage-service-point-class"></a>classe de ponto de serviço Armazenamento remoto

Essa classe contém informações sobre o local de armazenamento remoto para arquivos que são armazenados offline.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | ponto de serviço Armazenamento remoto         |
...
| [**GUID Armazenamento remoto**](a-remotestorageguid.md)                        | Falso     | **Remote-Armazenamento-Service-Point**                                                         |
...
| Possíveis superiores          | [**Computador**](c-computer.md)                                                                                                   |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**RDN**](a-name.md)                                                       | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Armazenamento-GUID remoto**](a-remotestorageguid.md)                          | Falso     | **ponto de serviço Armazenamento remoto**                                                         |
| [**Repl-Property-meta-data**](a-replpropertymetadata.md)                   | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Repl-UpToDate-vector**](a-repluptodatevector.md)                        | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Relatórios**](a-directreports.md)                                          | Falso     | [**Início**](c-top.md)<br/>                                                          |
