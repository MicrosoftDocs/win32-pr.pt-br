...
---
# <a name="remote-storage-service-point-class"></a>Armazenamento remoto-classe de ponto de serviço
...
| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Armazenamento remoto-ponto de serviço         |
...
| [**GUID de armazenamento remoto**](a-remotestorageguid.md)                        | Falso     | **Armazenamento remoto-ponto de serviço**                                                         |
