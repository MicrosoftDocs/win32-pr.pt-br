...
Um objeto dessa classe contém um conjunto de política de transformação de declarações para a transformação de declarações entre florestas.
...
| Superiores possíveis          | [**ms-DS-Claims-Transformation-Policies**](c-msds-claimstransformationpolicies.md) |
| Classes Auxiliares           | \-                                                                                  |
| NT-Security-Descriptor      | O:BAG: INADEQUADO: S:                                                                        |
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; EA) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; Sy          |
