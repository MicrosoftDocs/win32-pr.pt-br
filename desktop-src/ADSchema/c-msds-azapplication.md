...
description: Define uma instância instalada de um aplicativo vinculado a um determinado armazenamento de políticas.
ms.assetid: 8714a351-79c0-4b5e-a160-293e4f806d6a
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-DS-Az-Application
- Esquema do AD da classe msDS-AzApplication
topic_type:
- apiref
api_name:
...
ms.locfileid: "119880386"
---
# <a name="ms-ds-az-application-class"></a>Classe ms-DS-Az-Application

Define uma instância instalada de um aplicativo vinculado a um determinado armazenamento de políticas.
...
| Possíveis superiores          | [**ms-DS-Az-Admin-Manager**](c-msds-azadminmanager.md)                                                                          |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**Descrição**](a-description.md)                                        | Falso     | **ms-DS-Az-Application** [ **Top**](c-top.md)<br/> |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Superiores possíveis          | [**ms-DS-AZ-admin-Manager**](c-msds-azadminmanager.md)                                                                          |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**Descrição**](a-description.md)                                           | Falso     | **MS-DS-AZ-Application** [ **superior**](c-top.md)<br/> |
| [**Nome de exibição**](a-displayname.md)                                          | Falso     | [**Início**](c-top.md)<br/>                          |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                       | Falso     | [**Início**](c-top.md)<br/>                          |
...
| [**ms-DS-AZ-Application-Version**](a-msds-azapplicationversion.md)            | Falso     | **ms-DS-AZ-Application**                                 |
| [**ms-DS-AZ-Class-ID**](a-msds-azclassid.md)                                  | Falso     | **ms-DS-AZ-Application**                                 |
| [**ms-DS-AZ-Generate-Auditions**](a-msds-azgenerateaudits.md)                    | Falso     | **ms-DS-AZ-Application**                                 |
