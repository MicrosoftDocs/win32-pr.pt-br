...
Objeto de processo de verificação de verificação do Enterprise Scan.
...
| Superiores possíveis          | [**MS-Imaging-PSPs**](c-msimaging-psps.md)                                                      |
| Classes Auxiliares           | \-                                                                                               |
...
| [**Nome de exibição**](a-displayname.md)                                            | True      | **MS-Imaging-PostScanProcess** [ **superior**](c-top.md)<br/> |
...
| [**Nome do servidor**](a-servername.md)                                              | Falso     | **MS-Imaging-PostScanProcess**                                 |
