...
keywords:
- Esquema do AD da classe ipHost
topic_type:
- apiref
api_name:
- ipHost
...
ms.locfileid: "118680894"
---
# <a name="iphost-class"></a>Classe ipHost

Representa uma abstração de um host ou outro dispositivo IP.
...
| [**Descrição**](a-description.md)                                        | Falso     | **ipHost** [ **Top**](c-top.md)<br/> |
...
| [**Localidade-nome**](a-l.md)                                                | Falso     | **ipHost**                                 |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                  | Falso     | [**Início**](c-top.md)<br/>            |
| [**Nome canônico**](a-canonicalname.md)                                      | Falso     | [**Início**](c-top.md)<br/>            |
| [**Nome comum**](a-cn.md)                                                    | Falso     | **ipHost** [ **superior**](c-top.md)<br/> |
...
| [**Objetos gerenciados**](a-managedobjects.md)                                    | Falso     | [**Início**](c-top.md)<br/>            |
| [**Gerente**](a-manager.md)                                                   | Falso     | **ipHost**                                 |
...
| [**Nome comum**](a-cn.md)                                                      | Falso     | **ipHost** [ **superior**](c-top.md)<br/> |
| [**Criação-carimbo de data/hora**](a-createtimestamp.md)                                   | Falso     | [**Início**](c-top.md)<br/>            |
| [**Descrição**](a-description.md)                                             | Falso     | **ipHost** [ **superior**](c-top.md)<br/> |
| [**Nome de exibição**](a-displayname.md)                                            | Falso     | [**Início**](c-top.md)<br/>            |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                         | Falso     | [**Início**](c-top.md)<br/>            |
