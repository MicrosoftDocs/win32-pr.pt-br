...
description: Define um conjunto de operações que podem ser executadas por um conjunto específico de usuários dentro de um escopo específico.
ms.assetid: 1cf0c229-8e5f-4c3b-9284-50be088ecdc3
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-DS-Az-Role
- Esquema do AD da classe msDS-AzRole
topic_type:
- apiref
api_name:
- ms-DS-Az-Role
...
ms.locfileid: "119880316"
---
# <a name="ms-ds-az-role-class"></a>Classe ms-DS-Az-Role

Define um conjunto de operações que podem ser executadas por um conjunto específico de usuários dentro de um escopo específico.
...
| Possíveis superiores          | [**Contêiner ms-DS-Az-Application**](c-msds-azapplication.md)[**ms-DS-Az-Scope**](c-msds-azscope.md)[](c-container.md)     |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**Descrição**](a-description.md)                                        | Falso     | **ms-DS-Az-Role** [ **Top**](c-top.md)<br/> |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Superiores possíveis          | [**MS-DS-AZ-Application**](c-msds-azapplication.md)[**MS-DS-AZ-escopo**](c-msds-azscope.md)[**container**](c-container.md)     |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**Nome comum**](a-cn.md)                                                      | Falso     | [**Início**](c-top.md)<br/>                   |
| [**Criação-carimbo de data/hora**](a-createtimestamp.md)                                   | Falso     | [**Início**](c-top.md)<br/>                   |
| [**Descrição**](a-description.md)                                             | Falso     | **MS-DS-AZ-role** na [ **parte superior**](c-top.md)<br/> |
| [**Nome de exibição**](a-displayname.md)                                            | Falso     | [**Início**](c-top.md)<br/>                   |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                         | Falso     | [**Início**](c-top.md)<br/>                   |
