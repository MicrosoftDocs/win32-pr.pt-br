...
description: Objeto de parâmetro do conjunto de cadeias de caracteres.
ms.assetid: dd253c7d-d968-46be-a39f-f844be6e1fcb
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-WMI-StringSetParam
- Esquema do AD da classe msWMI-StringSetParam
topic_type:
- apiref
api_name:
...
ms.locfileid: "119753646"
---
# <a name="ms-wmi-stringsetparam-class"></a>Classe ms-WMI-StringSetParam

Objeto de parâmetro do conjunto de cadeias de caracteres.
...
| Subclasse de                 | [**ms-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/>                                         |
| Possíveis superiores          | [**ms-WMI-MergeablePolicyTemplate**](c-mswmi-mergeablepolicytemplate.md)                          |
| Classes Auxiliares           | \-                                                                                                 |
...
| [**MS-WMI-PropertyName**](a-mswmi-propertyname.md)                         | Verdadeiro      | [**MS-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/> |
| [**MS-WMI-stringDefault**](a-mswmi-stringdefault.md)                       | Verdadeiro      | **MS-WMI-StringSetParam**                                  |
| [**MS-WMI-stringValidValues**](a-mswmi-stringvalidvalues.md)               | Falso     | **MS-WMI-StringSetParam**                                  |
| [**MS-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Verdadeiro      | [**MS-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/> |
| [**MS-WMI-TargetType**](a-mswmi-targettype.md)                             | Verdadeiro      | [**MS-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/> |
...
| Subclasse de                 | [**MS-WMI-RangeParam**](c-mswmi-rangeparam.md)<br/>                                         |
| Superiores possíveis          | [**MS-WMI-MergeablePolicyTemplate**](c-mswmi-mergeablepolicytemplate.md)                          |
| Classes Auxiliares           | \-                                                                                                 |
