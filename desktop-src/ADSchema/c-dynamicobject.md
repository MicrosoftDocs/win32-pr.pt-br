...
ms.locfileid: "119922806"
---
# <a name="dynamic-object-class"></a>Classe Dynamic-Object

Essa classe, se estiver presente em uma entrada, indica que essa entrada tem um tempo de vida limitado e pode desaparecer automaticamente quando seu time-to-Live atingir 0. Se o cliente não tiver fornecido um valor para o atributo entryTtl, o servidor fornecerá um.
...
| [**TTL da entrada**](a-entryttl.md)                                             | Falso     | **Objeto dinâmico**              |
...
| [**ms-DS-entry-time-to-Die**](a-msds-entry-time-to-die.md)                 | Falso     | **Objeto dinâmico**              |
...
| [**Entry-TTL**](a-entryttl.md)                                                | Falso     | **Objeto dinâmico**              |
| [**Nome da extensão**](a-extensionname.md)                                      | Falso     | [**Início**](c-top.md)<br/> |
