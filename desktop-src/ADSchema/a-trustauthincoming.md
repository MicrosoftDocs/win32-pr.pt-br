...
ms.locfileid: "119835658"
---
# <a name="trust-auth-incoming-attribute"></a>Atributo Trust-auth-transcoming

Informações de autenticação para a parte de entrada de uma relação de confiança.



| Entrada | Valor |
|-------------------|-------------------------------------------------------|
| CN                | Trust-auth-entrada                                   |
