...
---
# <a name="msmq-migrated-user-class"></a>MSMQ – migrado-classe de usuário

No MSMQ 1,0 tivemos nosso próprio DS, no qual mantivemos algumas informações por usuário. Como parte da integração do MSMQ com o Windows 2000 DS, o MSMQ fornece uma ferramenta de migração. Durante a migração, para cada usuário que não está no domínio do Windows 2000, criamos um usuário migrado.



| Entrada | Valor |
|-------------------|--------------------------------------------------------------------------------------------------|
| CN                | MSMQ-migrado-usuário                                                                               |
| LDAP-Display-Name | mSMQMigratedUser                                                                                 |
| Privilégio de atualização  | O proprietário da fila.                                                                                 |
| Frequência de atualização  | Esse objeto é criado pelo assistente de atualização de enfileiramento de mensagens em um ambiente de domínio de modo misto. |
...
| Superiores possíveis          | Domínio [**interno-**](c-builtindomain.md)[](c-domaindns.md)[**unidade organizacional**](c-organizationalunit.md) do DNS |
| Classes Auxiliares           | \-                                                                                                                            |
...
| [**MSMQ-resumos**](a-msmqdigests.md)                                     | Falso     | **MSMQ-migrado-usuário**          |
| [**MSMQ-resumos-MiG**](a-msmqdigestsmig.md)                              | Falso     | **MSMQ-migrado-usuário**          |
| [**MSMQ-assinar certificados**](a-msmqsigncertificates.md)                  | Falso     | **MSMQ-migrado-usuário**          |
| [**MSMQ-Sign-Certificates-MiG**](a-msmqsigncertificatesmig.md)           | Falso     | **MSMQ-migrado-usuário**          |
| [**MSMQ-usuário-Sid**](a-msmqusersid.md)                                    | Falso     | **MSMQ-migrado-usuário**          |
...
| [**Objeto-Sid**](a-objectsid.md)                                         | Falso     | **MSMQ-migrado-usuário**          |
