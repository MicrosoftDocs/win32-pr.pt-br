---
title: atributo ms-DS-Required-floresta-Behavior-Version
description: Nível de função de floresta necessário para este recurso.
ms.assetid: ad884471-a416-4210-8cc8-0dbdf7ec535a
ms.tgt_platform: multiple
keywords:
- ms-DS-Required-floresta-Behavior-Version esquema do AD
- atributo msDS-RequiredForestBehaviorVersion do AD Schema
topic_type:
- apiref
api_name:
...
Nível de função de floresta necessário para este recurso.



| Entrada | Valor |
|-------------------|----------------------------------------|
| CN                | ms-DS-Required-floresta-Behavior-Version |
