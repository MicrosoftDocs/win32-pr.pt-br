...
ms.locfileid: "119583636"
---
# <a name="class-display-name-attribute"></a>Atributo Class-Display-Name

O nome do objeto a ser exibido nas caixas de diálogo.



| Entrada | Valor |
|-------------------|---------------------------------------------|
| CN                | Nome de exibição de classe                          |
...
| Classes usadas em        | [**Atributo-esquema**](c-attributeschema.md)<br/> [**Esquema de classe**](c-classschema.md)<br/> [**Especificador de exibição**](c-displayspecifier.md)<br/> |
