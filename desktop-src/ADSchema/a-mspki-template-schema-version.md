...
ms.locfileid: "120066416"
---
# <a name="ms-pki-template-schema-version-attribute"></a>MS-PKI-template-atributo de versão de esquema

Controla as atualizações de esquema da classe PKI-Certificate-template.



| Entrada | Valor |
|-------------------|---------------------------------------------------------------------------------------------------|
| CN                | MS-PKI-template-versão de esquema                                                                    |
| LDAP-Display-Name | msPKI-modelo-versão de esquema                                                                     |
| Tamanho              | 4 bytes                                                                                           |
