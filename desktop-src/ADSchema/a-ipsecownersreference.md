...
---
# <a name="ipsec-owners-reference-attribute"></a>IPSec-proprietários-atributo de referência

O atributo **IPSec-Owners-Reference** é somente para uso interno.



| Entrada | Valor |
|-------------------|-----------------------------------------|
| CN                | IPSec-proprietários-referência                  |
