...
---
# <a name="ms-ds-claim-type-property-base-class"></a>classe base ms-DS-Claim-Type-Property

Uma classe abstrata que define a classe base para o tipo de declaração ou classes de propriedade de recurso.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | ms-DS-Claim-tipo-propriedade-base       |
...
| [**habilitado**](a-enabled.md)                                                                 | Falso     | **ms-DS-Claim-tipo-propriedade-base** |
...
| [**ms-DS-Claim-possíveis-valores**](a-msds-claimpossiblevalues.md)                            | Falso     | **ms-DS-Claim-tipo-propriedade-base** |
| [**ms-DS-Claim-shares-possíveis-Values-with**](a-msds-claimsharespossiblevalueswith.md)      | Falso     | **ms-DS-Claim-tipo-propriedade-base** |
