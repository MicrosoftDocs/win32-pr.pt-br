...
---
# <a name="msmq-prev-site-gates-attribute"></a>Atributo MSMQ-anterior-site-Gates

O atributo **MSMQ-anterior-site-Gates** contém informações de modo misto do MSMQ.



| Entrada | Valor |
|-------------------|-----------------------------------------|
| CN                | MSMQ-anterior-site-Gates                    |
