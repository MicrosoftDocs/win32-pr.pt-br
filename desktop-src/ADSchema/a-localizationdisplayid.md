...
Usado para indexar no arquivo Extrts.mc para obter o displayName localizado para os objetos para fins de interface do usuário.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Localização-exibição-ID              |
