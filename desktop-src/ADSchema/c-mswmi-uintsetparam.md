...
description: Objeto de parâmetro de conjunto de inteiros sem sinal.
ms.assetid: 02e3758d-031b-4b68-90d7-393d6b7acca7
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-WMI-UintSetParam
- Esquema do AD da classe msWMI-UintSetParam
topic_type:
- apiref
api_name:
- ms-WMI-UintSetParam
...
ms.locfileid: "119801556"
---
# <a name="ms-wmi-uintsetparam-class"></a>Classe ms-WMI-UintSetParam

Objeto de parâmetro de conjunto de inteiros sem sinal.
...
| [**ms-WMI-intDefault**](a-mswmi-intdefault.md)                             | Verdadeiro      | **ms-WMI-UintSetParam**                                    |
