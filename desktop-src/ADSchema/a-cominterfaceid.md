...
ms.locfileid: "119509606"
---
# <a name="com-interfaceid-attribute"></a>COM-InterfaceID atributo

Esse atributo armazena a lista de interfaces que são implementadas neste pacote de aplicativos.
...
| Classes usadas em        | [**Registro de classe**](c-classregistration.md)<br/> [**Registro de pacote**](c-packageregistration.md)<br/> [**Biblioteca de tipos**](c-typelibrary.md)<br/> |
