...
Define a política de autoridade de segurança local para um ou mais domínios.
...
| Superiores possíveis          | Domínio do [**contêiner**](c-container.md)[**-**](c-domaindns.md)[**unidade organizacional**](c-organizationalunit.md) do DNS |
| Classes Auxiliares           | \-                                                                                                                   |
...
| [**Opções de autenticação**](a-authenticationoptions.md)                 | Falso     | **Política de domínio**               |
...
| [**Padrão-local-política-objeto**](a-defaultlocalpolicyobject.md)         | Falso     | **Política de domínio**               |
...
| [**Autoridades de certificação de domínio**](a-domaincas.md)                     | Falso     | **Política de domínio**               |
| [**Referência de política de domínio**](a-domainpolicyreference.md)                | Falso     | **Política de domínio**               |
| [**Política de todo o domínio**](a-domainwidepolicy.md)                          | Falso     | **Política de domínio**               |
...
| [**EFSPolicy**](a-efspolicy.md)                                          | Falso     | **Política de domínio**               |
| [**Nome da extensão**](a-extensionname.md)                                 | Falso     | [**Início**](c-top.md)<br/> |
| [**Flags**](a-flags.md)                                                  | Falso     | [**Início**](c-top.md)<br/> |
| [**Forçar logoff**](a-forcelogoff.md)                                     | Falso     | **Política de domínio**               |
...
| [**Referência de política de IPSec**](a-ipsecpolicyreference.md)                  | Falso     | **Política de domínio**               |
...
| [**Duração do bloqueio**](a-lockoutduration.md)                             | Falso     | **Política de domínio**               |
| [**Bloqueio-saída-janela**](a-lockoutobservationwindow.md)         | Falso     | **Política de domínio**               |
| [**Limite de bloqueio**](a-lockoutthreshold.md)                           | Falso     | **Política de domínio**               |
| [**Gerenciado por**](a-managedby.md)                                         | Falso     | **Política de domínio**               |
| [**Objetos gerenciados**](a-managedobjects.md)                               | Falso     | [**Início**](c-top.md)<br/> |
| [**Mestre por**](a-masteredby.md)                                       | Falso     | [**Início**](c-top.md)<br/> |
| [**Max-pwd-age**](a-maxpwdage.md)                                        | Falso     | **Política de domínio**               |
| [**Max-Renew-age**](a-maxrenewage.md)                                    | Falso     | **Política de domínio**               |
| [**Duração máxima de tíquetes**](a-maxticketage.md)                                  | Falso     | **Política de domínio**               |
| [**Mín-pwd-idade**](a-minpwdage.md)                                        | Falso     | **Política de domínio**               |
| [**Mín-pwd-comprimento**](a-minpwdlength.md)                                  | Falso     | **Política de domínio**               |
| [**Duração mínima de tíquetes**](a-minticketage.md)                                  | Falso     | **Política de domínio**               |
...
| [**Tempo de vida do proxy**](a-proxylifetime.md)                                 | Falso     | **Política de domínio**               |
| [**Política de chave pública**](a-publickeypolicy.md)                            | Falso     | **Política de domínio**               |
| [**Pwd-tamanho do histórico**](a-pwdhistorylength.md)                          | Falso     | **Política de domínio**               |
| [**Pwd-Propriedades**](a-pwdproperties.md)                                 | Falso     | **Política de domínio**               |
| [**Qualidade de serviço**](a-qualityofservice.md)                          | Falso     | **Política de domínio**               |
