...
---
# <a name="netboot-current-client-count-attribute"></a>netboot-atributo atual-de-cliente-contagem

O atributo **netboot – Current-Client-Count** é reservado para uso interno.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | netboot-atual-contagem de clientes         |
