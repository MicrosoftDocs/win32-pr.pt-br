...
keywords:
- Esquema de Query-Filter do atributo AD
- Esquema de AD do atributo queryFilter
topic_type:
- apiref
api_name:
- Query-Filter
...
ms.locfileid: "119646916"
---
# <a name="query-filter-attribute"></a>Query-Filter atributo

Atributo de filtro de consulta.
