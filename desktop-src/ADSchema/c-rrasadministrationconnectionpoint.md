...
ms.locfileid: "120079926"
---
# <a name="rras-administration-connection-point-class"></a>Classe de ponto de conexão RRAS-Administration-Connection

Este objeto contém o ponto de conexão para o RRAS.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | RRAS-administração – ponto de conexão |
...
| [**ms-DS-Tasks-for-AZ-Task-BL**](a-msds-tasksforaztaskbl.md)               | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Ms-Exch-Owner-BL**](a-ownerbl.md)                                       | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**MS-RRAS-Attribute**](a-msrrasattribute.md)                              | Falso     | **RRAS-administração – ponto de conexão**                                                 |
