...
---
# <a name="ms-ds-last-successful-interactive-logon-time-attribute"></a>ms-DS-Last-êxito-Interactive-atributo de tempo de logon

A hora em que a senha correta foi apresentada durante um logon Ctrl + Alt + Delete.



| Entrada | Valor |
|-------------------|----------------------------------------------|
| CN                | ms-DS-última-êxito-interativo-tempo de logon |
