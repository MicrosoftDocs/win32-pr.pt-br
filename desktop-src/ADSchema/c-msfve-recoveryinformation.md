...
keywords:
- Esquema do AD da classe ms-FVE-RecoveryInformation
- Esquema do AD da classe msFVE-RecoveryInformation
topic_type:
- apiref
api_name:
...
ms.locfileid: "118175804"
---
# <a name="ms-fve-recoveryinformation-class"></a>Classe ms-FVE-RecoveryInformation

Essa classe contém uma senha de recuperação de Criptografia de Volume Completo com seu GUID associado.
...
| [**ms-FVE-KeyPackage**](a-msfve-keypackage.md)                                | Falso     | **ms-FVE-RecoveryInformation**  |
| [**ms-FVE-RecoveryGuid**](a-msfve-recoveryguid.md)                            | Verdadeiro      | **ms-FVE-RecoveryInformation**  |
| [**ms-FVE-RecoveryPassword**](a-msfve-recoverypassword.md)                    | Verdadeiro      | **ms-FVE-RecoveryInformation**  |
