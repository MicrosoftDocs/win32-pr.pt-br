...
Este objeto contém parâmetros de configuração do MSMQ para um computador específico. Os atributos dessa classe são específicos do MSMQ e são usados para decisões de roteamento do MSMQ.
...
| Frequência de atualização  | Uma instância dessa classe é criada por cada computador que instala o MSMQ, no objeto de computador. |
...
| Superiores possíveis          | [**Computador**](c-computer.md)                                                               |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MSMQ-tipo de computador**](a-msmqcomputertype.md)                          | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-tipo de computador-ex**](a-msmqcomputertypeex.md)                     | Falso     | **Configuração do MSMQ**          |
| [**Serviços de cliente dependentes do MSMQ**](a-msmqdependentclientservices.md)   | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-DS-Services**](a-msmqdsservices.md)                              | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-Encrypt-Key**](a-msmqencryptkey.md)                              | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-externo**](a-msmqforeign.md)                                     | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-in-Routing-Servers**](a-msmqinroutingservers.md)                 | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-diário-cota**](a-msmqjournalquota.md)                          | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-tipo de sistema operacional**](a-msmqostype.md)                                      | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-out-Routing-Servers**](a-msmqoutroutingservers.md)               | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | Falso     | **Configuração do MSMQ**          |
| [**Cota de MSMQ**](a-msmqquota.md)                                         | Falso     | **Configuração do MSMQ**          |
| [**Serviços de roteamento MSMQ**](a-msmqroutingservices.md)                    | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-tipo de serviço**](a-msmqservicetype.md)                            | Falso     | **Configuração do MSMQ**          |
| [**MSMQ-chave de assinatura**](a-msmqsignkey.md)                                    | Falso     | **Configuração do MSMQ**          |
| [**Sites MSMQ**](a-msmqsites.md)                                         | Falso     | **Configuração do MSMQ**          |
...
| Nome comum                                                              |
|--------------------------------------------------------------------------|
| [**MSMQ-recebimento-mensagens mortas**](r-msmq-receive-dead-letter.md)           |
| [**MSMQ-Peek-mensagens mortas**](r-msmq-peek-dead-letter.md)                 |
