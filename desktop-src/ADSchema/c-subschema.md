...
keywords:
- Esquema do AD da classe SubSchema
- Esquema do AD da classe subSchema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119021734"
---
# <a name="subschema-class"></a>Classe SubSchema

Contém a definição de esquema.
...
| Schema-Id-Guid    | 5a8b3261-c38d-11d1-lt9-0080c76670c0 |
...
| [**DIT-Content-Rules**](a-ditcontentrules.md)                            | Falso     | **Subesquema**                                 |
...
| [**Extended-Attribute-info**](a-extendedattributeinfo.md)                | Falso     | **Subesquema**                                 |
| [**Informações de classe estendida**](a-extendedclassinfo.md)                        | Falso     | **Subesquema**                                 |
...
| [**Modificar-carimbo de data/hora**](a-modifytimestamp.md)                            | Falso     |  [ **Parte superior** do subesquema](c-top.md)<br/> |
...
| [**Classes de objeto**](a-objectclasses.md)                                 | Falso     | **Subesquema**                                 |
...
| [**Informações de classe estendida**](a-extendedclassinfo.md)                          | Falso     | **SubSchema**                                 |
| [**Nome da extensão**](a-extensionname.md)                                   | Falso     | [**Início**](c-top.md)<br/>               |
...
| [**Objeto-categoria**](a-objectcategory.md)                                 | Verdadeiro      | [**Início**](c-top.md)<br/>               |
| [**Classe de objeto**](a-objectclass.md)                                       | Verdadeiro      | [**Início**](c-top.md)<br/>               |
| [**Classes de objeto**](a-objectclasses.md)                                   | Falso     | **SubSchema**                                 |
...
| [**Tipos de atributo**](a-attributetypes.md)                                 | Falso     | **Subesquema**                                 |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/>               |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/>               |
...
| [**Modificar carimbo de data/hora**](a-modifytimestamp.md)                              | Falso     | **SubSchema** [ **Top**](c-top.md)<br/> |
| [**ms-COM-PartitionSetLink**](a-mscom-partitionsetlink.md)                 | Falso     | [**Início**](c-top.md)<br/>               |
| [**ms-COM-UserLink**](a-mscom-userlink.md)                                 | Falso     | [**Início**](c-top.md)<br/>               |
