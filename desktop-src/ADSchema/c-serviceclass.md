...
keywords:
- Service-Class classe AD Schema
- Esquema do AD da classe serviceClass
topic_type:
- apiref
api_name:
- Service-Class
...
ms.locfileid: "119548926"
---
# <a name="service-class-class"></a>Service-Class classe

Usado para armazenar as propriedades de um serviço Winsock.
...
| [**Nome de exibição**](a-displayname.md)                                     | Verdadeiro      | **Classe de serviço** [ **superior**](c-top.md)<br/> |
...
| [**ID de classe de serviço**](a-serviceclassid.md)                              | Verdadeiro      | **Classe de serviço**                                 |
| [**Service-Class-Info**](a-serviceclassinfo.md)                          | Falso     | **Classe de serviço**                                 |
...
| [**ID de classe de serviço**](a-serviceclassid.md)                                   | Verdadeiro      | **Classe de serviço**                                 |
| [**Informações de classe de serviço**](a-serviceclassinfo.md)                               | Falso     | **Classe de serviço**                                 |
