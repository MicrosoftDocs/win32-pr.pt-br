...
description: Raiz da instância do armazenamento da Política de Autorização. Observe que pode haver muitas instâncias de armazenamento.
ms.assetid: 4dfd7b5e-847c-4778-82e5-64b6c6525e73
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-DS-Az-Admin-Manager
- Esquema do AD da classe msDS-AzAdminManager
topic_type:
- apiref
api_name:
...
ms.locfileid: "118422970"
---
# <a name="ms-ds-az-admin-manager-class"></a>Classe ms-DS-Az-Admin-Manager

Raiz da instância do armazenamento da Política de Autorização. Observe que pode haver muitas instâncias de armazenamento.
...
| Privilégio de atualização  | Esse valor é definido pelo administrador do AzRoles. |
...
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY)(A;; RPLCLORC;;; AU)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; CO) |
...
| [**Descrição**](a-description.md)                                        | Falso     | **ms-DS-Az-Admin-Manager** [ **Top**](c-top.md)<br/> |
...
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; AU) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; COLABORA |
| System-Flags                | 0x00000010                                                                                                                       |
...
| [**Descrição**](a-description.md)                                           | Falso     | **MS-DS-AZ-admin-Manager** na [ **parte superior**](c-top.md)<br/> |
| [**Nome de exibição**](a-displayname.md)                                          | Falso     | [**Início**](c-top.md)<br/>                            |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                       | Falso     | [**Início**](c-top.md)<br/>                            |
...
| [**ms-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)                    | Falso     | **ms-DS-AZ-admin-Manager**                                 |
| [**ms-DS-AZ-Domain-Timeout**](a-msds-azdomaintimeout.md)                        | Falso     | **ms-DS-AZ-admin-Manager**                                 |
| [**ms-DS-AZ-Generate-Auditions**](a-msds-azgenerateaudits.md)                      | Falso     | **ms-DS-AZ-admin-Manager**                                 |
| [**ms-DS-AZ-Generic-data**](a-msds-azgenericdata.md)                            | Falso     | **ms-DS-AZ-admin-Manager**                                 |
| [**ms-DS-AZ-Major-Version**](a-msds-azmajorversion.md)                          | Falso     | **ms-DS-AZ-admin-Manager**                                 |
| [**ms-DS-AZ-minor-version**](a-msds-azminorversion.md)                          | Falso     | **ms-DS-AZ-admin-Manager**                                 |
| [**ms-DS-AZ-Object-GUID**](a-msds-azobjectguid.md)                              | Falso     | **ms-DS-AZ-admin-Manager**                                 |
