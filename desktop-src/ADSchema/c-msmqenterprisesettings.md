...
Um objeto com informações gerais do MSMQ. Ele é colocado em \\ serviços de configuração \\ . Só pode haver um deles em uma floresta. Este objeto contém informações de configuração de toda a organização para enfileiramento de mensagens.
...
| [**MSMQ-CSP-Name**](a-msmqcspname.md)                                    | Falso     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-Interval1**](a-msmqinterval1.md)                                 | Falso     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-Interval2**](a-msmqinterval2.md)                                 | Falso     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-vida longa**](a-msmqlonglived.md)                                | Falso     | **MSMQ-Enterprise-Settings**    |
| [**MSMQ-nome-do-estilo**](a-msmqnamestyle.md)                                | Falso     | **MSMQ-Enterprise-Settings**    |
| [**Versão do MSMQ**](a-msmqversion.md)                                     | Falso     | **MSMQ-Enterprise-Settings**    |
