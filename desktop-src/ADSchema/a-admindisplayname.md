...
description: O nome a ser exibido nas telas do administrador.
ms.assetid: a4395f7f-3665-48c8-ac1a-68ab9a03d762
ms.tgt_platform: multiple
keywords:
- Esquema do AD do atributo Admin-Display-Name
- Esquema do AD do atributo adminDisplayName
topic_type:
- apiref
api_name:
- Admin-Display-Name
...
ms.locfileid: "118178045"
---
# <a name="admin-display-name-attribute"></a>Atributo Admin-Display-Name

O nome a ser exibido nas telas do administrador.
