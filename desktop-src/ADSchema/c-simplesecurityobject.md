...
keywords:
- Esquema do AD da classe simpleSecurityObject
topic_type:
- apiref
api_name:
...
ms.locfileid: "119021744"
---
# <a name="simplesecurityobject-class"></a>Classe simpleSecurityObject

Permite que uma entrada tenha um atributo userPassword quando as classes de objeto principal de uma entrada não permitem userPassword como um tipo de atributo.
...
| [**Senha do usuário**](a-userpassword.md)                                     | Falso     | **simpleSecurityObject**        |
...
| [**Usuário-senha**](a-userpassword.md)                                     | Falso     | **simpleSecurityObject**        |
| [**USN-alterado**](a-usnchanged.md)                                         | Falso     | [**Início**](c-top.md)<br/> |
