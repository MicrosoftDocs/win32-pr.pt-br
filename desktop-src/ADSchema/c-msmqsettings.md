...
A finalidade desses objetos é habilitar a consulta rápida de servidores MSMQ em um site específico. Esse objeto contém informações como serviços de enfileiramento de mensagens que o servidor fornece.
...
| Frequência de atualização  | Esse objeto é criado para cada servidor de enfileiramento de mensagens instalado em um controlador de domínio do Windows 2000 e para cada servidor de enfileiramento de mensagens com serviços de roteamento. |
...
| [**Serviço de cliente dependente do MSMQ**](a-msmqdependentclientservice.md)     | Falso     | **Configurações do MSMQ**               |
| [**MSMQ-DS-Service**](a-msmqdsservice.md)                                | Falso     | **Configurações do MSMQ**               |
| [**MSMQ-migrado**](a-msmqmigrated.md)                                   | Falso     | **Configurações do MSMQ**               |
| [**MSMQ-NT4-flags**](a-msmqnt4flags.md)                                  | Falso     | **Configurações do MSMQ**               |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | Falso     | **Configurações do MSMQ**               |
| [**MSMQ-QM-ID**](a-msmqqmid.md)                                          | Falso     | **Configurações do MSMQ**               |
| [**MSMQ-serviço de roteamento**](a-msmqroutingservice.md)                      | Falso     | **Configurações do MSMQ**               |
| [**Serviços MSMQ**](a-msmqservices.md)                                   | Falso     | **Configurações do MSMQ**               |
| [**MSMQ-nome do site**](a-msmqsitename.md)                                  | Falso     | **Configurações do MSMQ**               |
| [**MSMQ-nome-do-site-ex**](a-msmqsitenameex.md)                             | Falso     | **Configurações do MSMQ**               |
