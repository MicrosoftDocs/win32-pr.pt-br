...
keywords:
- Application-Settings classe AD Schema
...
ms.locfileid: "119643906"
---
# <a name="application-settings-class"></a>Application-Settings classe

Classe base para configurações de aplicativo específicas do servidor.
...
| Possíveis superiores          | [**Servidor**](c-server.md)             |
| Classes Auxiliares           | \-                                     |
...
| [**Nome do Aplicativo**](a-applicationname.md)                             | Falso     | **Aplicativos Configurações**        |
...
| [**Lista de notificações**](a-notificationlist.md)                           | Falso     | **Aplicativos Configurações**        |
...
| [**ms-DS-Configurações**](a-msds-settings.md)                                   | Falso     | **Configurações do aplicativo**        |
...
| [**Lista de notificações**](a-notificationlist.md)                             | Falso     | **Configurações do aplicativo**        |
...
| [**ms-DS-Configurações**](a-msds-settings.md)                                   | Falso     | **Aplicativos Configurações**        |
| [**Descritor de segurança NT**](a-ntsecuritydescriptor.md)                    | Verdadeiro      | [**Início**](c-top.md)<br/> |
| [**Obj-Dist-Name**](a-distinguishedname.md)                                | Falso     | [**Início**](c-top.md)<br/> |
| [**Categoria de objeto**](a-objectcategory.md)                                 | Verdadeiro      | [**Início**](c-top.md)<br/> |
| [**Classe de objeto**](a-objectclass.md)                                       | Verdadeiro      | [**Início**](c-top.md)<br/> |
...
| [**Classes filho permitidas**](a-allowedchildclasses.md)                      | Falso     | [**Início**](c-top.md)<br/> |
| [**Permitido-filho-classes-efetivas**](a-allowedchildclasseseffective.md)   | Falso     | [**Início**](c-top.md)<br/> |
| [**Nome do aplicativo**](a-applicationname.md)                               | Falso     | **Configurações do aplicativo**        |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/> |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/> |
| [**Common-Name**](a-cn.md)                                                 | Falso     | [**Início**](c-top.md)<br/> |
| [**Criar carimbo de data/hora**](a-createtimestamp.md)                              | Falso     | [**Início**](c-top.md)<br/> |
