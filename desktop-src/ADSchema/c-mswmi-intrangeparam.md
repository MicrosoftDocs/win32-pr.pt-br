...
description: Objeto de parâmetro de intervalo de inteiros com sinal.
ms.assetid: cf777d5b-d674-4ccd-a7f5-0ae2c15d8daf
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-WMI-IntRangeParam
- Esquema do AD da classe msWMI-IntRangeParam
topic_type:
- apiref
api_name:
...
ms.locfileid: "119643086"
---
# <a name="ms-wmi-intrangeparam-class"></a>Classe ms-WMI-IntRangeParam

Objeto de parâmetro de intervalo de inteiros com sinal.
...
| [**ms-WMI-intDefault**](a-mswmi-intdefault.md)                             | Verdadeiro      | **ms-WMI-IntRangeParam**                                   |
