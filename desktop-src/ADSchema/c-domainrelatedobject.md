...
keywords:
- Esquema do AD da classe domainRelatedObject
topic_type:
- apiref
api_name:
- domainRelatedObject
...
ms.locfileid: "119324706"
---
# <a name="domainrelatedobject-class"></a>Classe domainRelatedObject

A classe de objeto domainRelatedObject é usada para definir uma entrada que representa uma série de documentos.
