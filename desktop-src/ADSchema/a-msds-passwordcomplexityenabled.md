...
---
# <a name="ms-ds-password-complexity-enabled-attribute"></a>ms-DS-password-atributo habilitado para complexidade

Status de complexidade de senha para contas de usuário.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | ms-DS-password-complexidade-habilitado    |
