...
O repositório de classe padrão para um determinado usuário.



| Entrada | Valor |
|-------------------|-----------------------------------------|
| CN                | Armazenamento de classe padrão                     |
...
| Classes usadas em        | [**Contêiner**](c-container.md)<br/> [**Usuário**](c-user.md)<br/> |
