...
description: Inicialização remota herdda para gerenciar grupos de computadores servidores. Não usado no momento.
ms.assetid: 493ad5f3-59e0-4c44-94d1-63f33e6fb9e3
ms.tgt_platform: multiple
keywords:
- Intellimirror-Group classe AD Schema
- Esquema do AD da classe intellimirrorGroup
topic_type:
- apiref
api_name:
- Intellimirror-Group
...
ms.locfileid: "118680904"
---
# <a name="intellimirror-group-class"></a>Intellimirror-Group classe

Inicialização remota herdda para gerenciar grupos de computadores servidores. Não usado no momento.
...
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;;D A)(A;; CCDC;;; CO)(A;; RPLCLORC;;; AU)           |
...
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; CCDC;;; CO) (A;; RPLCLORC;;; AU           |
| System-Flags                | 0x00000010                                                                                                           |
