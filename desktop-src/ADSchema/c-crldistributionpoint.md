...
---
# <a name="crl-distribution-point-class"></a>CRL – classe de ponto de distribuição

O objeto que contém o certificado, a autoridade e as listas de revogação Delta.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | CRL-ponto de distribuição               |
...
| [**Nome comum**](a-cn.md)                                               | True      | **CRL-distribuição-ponto** [ **superior**](c-top.md)<br/> |
