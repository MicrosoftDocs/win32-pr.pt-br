...
description: O objeto que mantém as listas certificado, autoridade e revogação delta.
ms.assetid: 8d99052c-b72b-49b6-9c1b-a9c1fcd09fe7
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe CRL-Distribution-Point
- Esquema do AD da classe cRLDistributionPoint
topic_type:
- apiref
api_name:
...
ms.locfileid: "119701945"
---
# <a name="crl-distribution-point-class"></a>Classe CRL-Distribution-Point

O objeto que mantém as listas certificado, autoridade e revogação delta.
...
| [**Lista de revogação de autoridade**](a-authorityrevocationlist.md)            | Falso     | **CRL-Distribution-Point**                                 |
...
| [**Lista de certificados revogados**](a-certificaterevocationlist.md)        | Falso     | **CRL-Distribution-Point**                                 |
| [**Common-Name**](a-cn.md)                                               | Verdadeiro      | **CRL-Distribution-Point** [ **Top**](c-top.md)<br/> |
...
| [**Autoridade-lista de revogação**](a-authorityrevocationlist.md)              | Falso     | **CRL-ponto de distribuição**                                 |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/>                            |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/>                            |
| [**Certificado-autoridade-objeto**](a-certificateauthorityobject.md)        | Falso     | **CRL-ponto de distribuição**                                 |
| [**Certificado-lista de certificados revogados**](a-certificaterevocationlist.md)          | Falso     | **CRL-ponto de distribuição**                                 |
| [**Nome comum**](a-cn.md)                                                 | Verdadeiro      | **CRL-distribuição-ponto** [ **superior**](c-top.md)<br/> |
| [**Criação-carimbo de data/hora**](a-createtimestamp.md)                              | Falso     | [**Início**](c-top.md)<br/>                            |
| [**CRL-particionado-lista de revogação**](a-crlpartitionedrevocationlist.md)   | Falso     | **CRL-ponto de distribuição**                                 |
| [**Delta-lista de revogação**](a-deltarevocationlist.md)                      | Falso     | **CRL-ponto de distribuição**                                 |
| [**Descrição**](a-description.md)                                        | Falso     | [**Início**](c-top.md)<br/>                            |
| [**Nome de exibição**](a-displayname.md)                                       | Falso     | [**Início**](c-top.md)<br/>                            |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                    | Falso     | [**Início**](c-top.md)<br/>                            |
