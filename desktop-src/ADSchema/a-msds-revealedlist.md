...
Identifica entidades de segurança cujas senhas de conta do computador atual foram replicadas para o RODC.



| Entrada | Valor |
|-------------------|-------------------------------------------------------|
| CN                | ms-DS-revelado-lista                                   |
| LDAP-Display-Name | msDS-revelalist                                     |
| Tamanho              | \-                                                    |
