...
Este atributo contém informações de estado para uma árvore de diretório que está sendo movida.



| Entrada | Valor |
|-------------------|-------------------------------------------------------|
| CN                | Estado de árvore de movimentação                                       |
...
| Classes usadas em        | [**Perdido e encontrado**](c-lostandfound.md)<br/> |
