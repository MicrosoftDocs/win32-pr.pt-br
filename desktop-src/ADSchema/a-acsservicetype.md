...
keywords:
- Esquema do AD do atributo ACS-Service-Type
- Esquema do AD do atributo aCSServiceType
topic_type:
- apiref
api_name:
- ACS-Service-Type
...
ms.locfileid: "118178339"
---
# <a name="acs-service-type-attribute"></a>Atributo ACS-Service-Type

O tipo de serviço do ACS. Carga controlada ou largura de banda garantida.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Tipo de serviço ACS                     |
