...
ms.locfileid: "119703756"
---
# <a name="file-link-tracking-entry-class"></a>Classe de entrada de rastreamento de link de arquivo

Mantém o GUID e as informações atuais do computador para um arquivo rastreado por link.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Entrada de rastreamento de link de arquivo             |
...
| Superiores possíveis          | [**Rastreamento de link de arquivo**](c-filelinktracking.md)                                             |
| Classes Auxiliares           | \-                                                                                           |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Possíveis superiores          | [**Rastreamento de link de arquivo**](c-filelinktracking.md)                                             |
| Classes Auxiliares           | \-                                                                                           |
