...
---
# <a name="ms-ds-value-type-reference-bl-attribute"></a>atributo ms-DS-Value-Type-Reference-BL

Este é o link voltar para o MS-DS-Value-Type-Reference. Ele vincula um objeto de tipo Value de volta às propriedades de recurso.
