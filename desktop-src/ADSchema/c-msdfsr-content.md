...
keywords:
- Esquema do AD da classe ms-DFSR-Content
- Esquema do AD da classe msDFSR-Content
topic_type:
- apiref
api_name:
- ms-DFSR-Content
...
ms.locfileid: "119880686"
---
# <a name="ms-dfsr-content-class"></a>Classe ms-DFSR-Content

Representa um contêiner para [**objetos ms-DFSR-ContentSet.**](c-msdfsr-contentset.md)
...
| [**MS-DFSR-flags**](a-msdfsr-flags.md)                                          | Falso     | **MS-DFSR-Content**             |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                  | Falso     | [**Início**](c-top.md)<br/> |
| [**MS-DFSR-opções**](a-msdfsr-options.md)                                      | Falso     | **MS-DFSR-Content**             |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                    | Falso     | **MS-DFSR-Content**             |
...
A **classe ms-DFSR-Content** faz parte do suporte ao serviço de replicação Sistema de Arquivos Distribuído (DFS).
