...
Usado para mapear um usuário para o endereço IP do computador no qual o usuário está conectado para uso por conferências de multicast de TAPI.
...
| Frequência de atualização  | Sempre que um cliente TAPI é iniciado após ter sido registrado com o diretório TAPI. |
...
| Superiores possíveis          | Organização da [**unidade organizacional**](c-organizationalunit.md)[](c-organization.md)    |
| Classes Auxiliares           | \-                                                                                           |
