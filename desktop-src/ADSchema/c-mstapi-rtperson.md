...
description: Usado para mapear um usuário para o endereço IP do computador em que o usuário está conectado para uso por conferências tapi multicast.
ms.assetid: 3866eb11-8719-40b6-b73c-314009db2553
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-TAPI-Rt-Person
- Esquema do AD da classe msTAPI-RtPerson
topic_type:
- apiref
api_name:
- ms-TAPI-Rt-Person
...
ms.locfileid: "119879376"
---
# <a name="ms-tapi-rt-person-class"></a>Classe ms-TAPI-Rt-Person

Usado para mapear um usuário para o endereço IP do computador em que o usuário está conectado para uso por conferências tapi multicast.
...
| Frequência de atualização  | Sempre que um cliente TAPI é iniciado depois de ter se registrado no diretório TAPI. |
...
| Possíveis superiores          | [**Organização da Unidade**](c-organizationalunit.md)[**Organizacional**](c-organization.md)    |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MS-TAPI-identificador exclusivo**](a-mstapi-uid.md)                           | Falso     | **MS-TAPI-RT-Person**           |
