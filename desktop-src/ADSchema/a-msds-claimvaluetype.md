...
keywords:
- Esquema do AD do atributo ms-DS-Claim-Value-Type
- Esquema do AD do atributo msDS-ClaimValueType
topic_type:
- apiref
api_name:
...
ms.locfileid: "118960835"
---
# <a name="ms-ds-claim-value-type-attribute"></a>Atributo ms-DS-Claim-Value-Type

Para um objeto de tipo de declaração, especifica o tipo de valor das declarações emitidas.
