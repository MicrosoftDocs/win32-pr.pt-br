...
Classe para armazenar SQL Server Propriedades de publicação. Permite que o usuário procure as publicações que estão disponíveis para assinar.
...
| [**MS-SQL-descrição**](a-ms-sql-description.md)                                               | Falso     | **MS-SQL-sqlpublication**       |
