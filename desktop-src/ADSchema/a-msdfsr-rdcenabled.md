...
Contém o valor que especifica se a RDC está habilitada ou desabilitada.
...
O atributo **MS-DFSR-RdcEnabled** faz parte do suporte ao serviço de replicação do sistema de arquivos distribuído (DFS).
