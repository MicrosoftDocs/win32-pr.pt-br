...
description: Contém os nomes DNS de Windows NT servidores que têm permissão para executar o ACS.
ms.assetid: 1a26ba49-e9c9-4881-a7ce-7c91bf32875e
ms.tgt_platform: multiple
keywords:
- Esquema do AD do atributo ACS-Server-List
- Esquema do AD do atributo aCSServerList
topic_type:
- apiref
api_name:
- ACS-Server-List
...
ms.locfileid: "118689345"
---
# <a name="acs-server-list-attribute"></a>Atributo ACS-Server-List

Contém os nomes DNS de Windows NT servidores que têm permissão para executar o ACS.
