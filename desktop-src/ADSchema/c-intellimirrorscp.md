...
Este objeto contém informações de configuração para o serviço que responde a clientes de inicialização remota que solicitam atenção de um servidor de instalação remota.
