...
description: Esse objeto contém informações de configuração para o serviço que responde a clientes de Inicialização Remota que solicitam atenção de um Servidor de Instalação Remota.
ms.assetid: 6284a1ad-8184-4dda-a588-ed89c8f19fd5
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe Intellimirror-SCP
- Esquema do AD da classe intellimirrorSCP
topic_type:
- apiref
api_name:
- Intellimirror-SCP
...
ms.locfileid: "118423114"
---
# <a name="intellimirror-scp-class"></a>Classe Intellimirror-SCP

Esse objeto contém informações de configuração para o serviço que responde a clientes de Inicialização Remota que solicitam atenção de um Servidor de Instalação Remota.
...
| Subclasse de                 | [**Service-Administration-Point**](c-serviceadministrationpoint.md)<br/>              |
| Possíveis superiores          | [**Intellimirror-Group**](c-intellimirrorgroup.md)[**Computer**](c-computer.md)            |
| Classes Auxiliares           | \-                                                                                           |
...
| [**netboot-permitir-novos clientes**](a-netbootallownewclients.md)                | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot-somente resposta-clientes válidos**](a-netbootansweronlyvalidclients.md) | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot-resposta-solicitações**](a-netbootanswerrequests.md)                   | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot-atual-contagem de clientes**](a-netbootcurrentclientcount.md)          | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot-IntelliMirror-SOS**](a-netbootintellimirroroses.md)             | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot – limite-clientes**](a-netbootlimitclients.md)                       | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot-localmente instalado-sistemas operacionais**](a-netbootlocallyinstalledoses.md)      | Falso     | **IntelliMirror-SCP**                                                                    |
| [**Netboot-máquina-arquivo-caminho**](a-netbootmachinefilepath.md)                | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot-Max-clients**](a-netbootmaxclients.md)                           | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot-novo-Machine-nome-da-política**](a-netbootnewmachinenamingpolicy.md) | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot – nova máquina-UO**](a-netbootnewmachineou.md)                      | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                     | Falso     | [**Início**](c-top.md)<br/>                                                          |
| [**Servidor netboot-**](a-netbootserver.md)                                    | Falso     | **IntelliMirror-SCP**                                                                    |
| [**netboot – ferramentas**](a-netboottools.md)                                      | Falso     | **IntelliMirror-SCP**                                                                    |
...
| Subclasse de                 | [**Serviço-Administração-ponto**](c-serviceadministrationpoint.md)<br/>              |
| Superiores possíveis          | [**IntelliMirror-grupo de**](c-intellimirrorgroup.md)[**computadores**](c-computer.md)            |
| Classes Auxiliares           | \-                                                                                           |
...
| [**netboot-New-Machine-UO**](a-netbootnewmachineou.md)                      | Falso     | **Intellimirror-SCP**                                                                    |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                     | Falso     | [**Início**](c-top.md)<br/>                                                          |
