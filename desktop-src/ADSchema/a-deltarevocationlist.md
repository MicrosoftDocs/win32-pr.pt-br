...
---
# <a name="delta-revocation-list-attribute"></a>Atributo Delta-Revocation-List

Lista de certificados que foram revogados desde a última atualização Delta.



| Entrada | Valor |
|-------------------|-------------------------------------------------------|
| CN                | Delta-lista de revogação                                 |
...
| Classes usadas em        | [**Autoridade de certificação**](c-certificationauthority.md)<br/> [**CRL-ponto de distribuição**](c-crldistributionpoint.md)<br/> |
