...
keywords:
- Esquema do AD da classe de configuração
- classe de configuração Esquema do AD
topic_type:
- apiref
api_name:
- Configuration
...
ms.locfileid: "119701926"
---
# <a name="configuration-class"></a>Classe de configuração

Esse é um contêiner que contém as informações de configuração de um domínio.
...
|-------------------|------------------------------------------------|
| CN                | Configuração                                  |
| Ldap-Display-Name | configuração                                  |
...
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLORCWOWDSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY)(A;; RPLCLORC;;; AU) |
...
| [**Common-Name**](a-cn.md)                                               | Verdadeiro      | **Parte superior da** [ **configuração**](c-top.md)<br/> |
...
| [**GP-Link**](a-gplink.md)                                                 | Falso     | **Configuration**                                 |
| [**Opções de GP**](a-gpoptions.md)                                           | Falso     | **Configuration**                                 |
| [**Tipo de instância**](a-instancetype.md)                                     | Verdadeiro      | [**Início**](c-top.md)<br/>                   |
...
|------------------------------------------------------------------------------|
| [**DS-Replication-Get-Changes**](r-ds-replication-get-changes.md)           |
| [**DS-replicação-sincronizar**](r-ds-replication-synchronize.md)           |
| [**DS-replicação-gerenciar-topologia**](r-ds-replication-manage-topology.md)   |
| [**DS-Replication-Get-Changes-All**](r-ds-replication-get-changes-all.md)   |
| [**Reanimar-marcas de exclusão**](r-reanimate-tombstones.md)                       |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/>                   |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/>                   |
| [**Nome comum**](a-cn.md)                                                 | Verdadeiro      |  [ **Início** da configuração](c-top.md)<br/> |
...
| Classes Auxiliares           | \-                                                                                       |
| NT-Security-Descriptor      | O:BAG: INADEQUADO: S:                                                                             |
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A;; RPLCLORC;;; AU |
| System-Flags                | 0x00000010                                                                               |
...
| [**FSMO-função-proprietário**](a-fsmoroleowner.md)                                  | Falso     | [**Início**](c-top.md)<br/>                   |
| [**GP-link**](a-gplink.md)                                                 | Falso     | **Configuration**                                 |
| [**GP-opções**](a-gpoptions.md)                                           | Falso     | **Configuration**                                 |
| [**Tipo de instância**](a-instancetype.md)                                     | Verdadeiro      | [**Início**](c-top.md)<br/>                   |
| [**É-crítico-System-Object**](a-iscriticalsystemobject.md)               | Falso     | [**Início**](c-top.md)<br/>                   |
| [**É excluído**](a-isdeleted.md)                                           | Falso     | [**Início**](c-top.md)<br/>                   |
| [**Is-member-of-DL**](a-memberof.md)                                       | Falso     | [**Início**](c-top.md)<br/>                   |
...
| [**Reanimar-marcas de exclusão**](r-reanimate-tombstones.md)                                                 |
| [**DS-Replication-Monitor-Topology**](r-ds-replication-monitor-topology.md)                           |
| [**Somente leitura-replicação-segredo-sincronização**](r-read-only-replication-secret-synchronization.md) |
| [**DS-Replication-Get-Changes-in-Filter-Set**](r-ds-replication-get-changes-in-filtered-set.md)     |
