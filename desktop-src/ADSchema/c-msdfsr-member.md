...
ms.locfileid: "118011025"
---
# <a name="ms-dfsr-member-class"></a>classe MS-DFSR-Member

Representa um membro do grupo de replicação.
...
|-------------------|--------------------------------------|
| CN                | MS-DFSR-Member                       |
| LDAP-Display-Name | msDFSR-membro                        |
...
| Superiores possíveis          | [**MS-DFSR-Topology**](c-msdfsr-topology.md)                                                                                    |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**MS-DFSR-ComputerReference**](a-msdfsr-computerreference.md)             | Verdadeiro      | **MS-DFSR-Member**              |
...
| [**MS-DFSR-Keywords**](a-msdfsr-keywords.md)                               | Falso     | **MS-DFSR-Member**              |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | Falso     | [**Início**](c-top.md)<br/> |
| [**MS-DFSR-opções**](a-msdfsr-options.md)                                 | Falso     | **MS-DFSR-Member**              |
...
| [**Referência de servidor**](a-serverreference.md)                               | Falso     | **ms-DFSR-Member**              |
...
| [**ms-DFSR-Extension**](a-msdfsr-extension.md)                                | Falso     | **ms-DFSR-Member**              |
| [**ms-DFSR-Flags**](a-msdfsr-flags.md)                                        | Falso     | **ms-DFSR-Member**              |
| [**palavras-chave ms-DFSR**](a-msdfsr-keywords.md)                                  | Falso     | **ms-DFSR-Member**              |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Falso     | [**Início**](c-top.md)<br/> |
...
| Rdn-Att-Id                  | \-                                                                                                                               |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Possíveis superiores          | [**ms-DFSR-Topology**](c-msdfsr-topology.md)                                                                                    |
| Classes Auxiliares           | \-                                                                                                                               |
...
A classe **MS-DFSR-Member** faz parte do suporte ao serviço de replicação do sistema de arquivos distribuído (DFS).
