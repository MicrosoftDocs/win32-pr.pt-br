...
---
# <a name="licensing-site-settings-class"></a>Licença-site-configurações classe
...
| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Licenciamento – site-Settings              |
...
| [**Servidor de site**](a-siteserver.md)                                       | Falso     | **Licenciamento – site-Settings**                                               |
