---
title: Classe Licensing-Site-Configurações
description: Aponta para o servidor de licenciamento de um site.
ms.assetid: b1573bfc-e81b-4b94-858d-5cc274c07d1a
ms.tgt_platform: multiple
keywords:
- Esquema do AD licensing-Site-Configurações classe
- LicensingSiteSettings classe AD Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "118423077"
---
# <a name="licensing-site-settings-class"></a>Classe Licensing-Site-Configurações

Aponta para o servidor de licenciamento de um site.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Licensing-Site-Configurações              |
...
| [**Site-Server**](a-siteserver.md)                                       | Falso     | **Licensing-Site-Configurações**                                               |
...
| [**Site-Object-BL**](a-siteobjectbl.md)                                    | Falso     | [**Início**](c-top.md)<br/>                                           |
| [**Servidor de site**](a-siteserver.md)                                         | Falso     | **licenciamento-Site-Configurações**                                               |
