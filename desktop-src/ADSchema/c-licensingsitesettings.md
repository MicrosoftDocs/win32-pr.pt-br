...
---
# <a name="licensing-site-settings-class"></a>licenciamento-Site-Configurações classe
...
| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | licenciamento-Site-Configurações              |
