...
description: Representa uma abstração de um serviço de protocolo da Internet.
ms.assetid: 6edeccd0-c6ff-413c-be3c-f99915e594fb
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ipService
topic_type:
- apiref
api_name:
- ipService
...
ms.locfileid: "119324126"
---
# <a name="ipservice-class"></a>Classe ipService

Representa uma abstração de um serviço de protocolo da Internet.
...
| [**Common-Name**](a-cn.md)                                                 | Verdadeiro      | **ipService** [ **Top**](c-top.md)<br/> |
| [**Criar carimbo de data/hora**](a-createtimestamp.md)                              | Falso     | [**Início**](c-top.md)<br/>               |
| [**Descrição**](a-description.md)                                        | Falso     | **ipService** [ **Top**](c-top.md)<br/> |
...
| [**msSFU-30-NIS-domínio**](a-mssfu30nisdomain.md)                           | Falso     | **ipService**                                 |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                  | Falso     | [**Início**](c-top.md)<br/>               |
| [**Nome canônico**](a-canonicalname.md)                                      | Falso     | [**Início**](c-top.md)<br/>               |
| [**Nome comum**](a-cn.md)                                                    | Verdadeiro      | **ipService** [ **superior**](c-top.md)<br/> |
| [**Criação-carimbo de data/hora**](a-createtimestamp.md)                                 | Falso     | [**Início**](c-top.md)<br/>               |
| [**Descrição**](a-description.md)                                           | Falso     | **ipService** [ **superior**](c-top.md)<br/> |
| [**Nome de exibição**](a-displayname.md)                                          | Falso     | [**Início**](c-top.md)<br/>               |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                       | Falso     | [**Início**](c-top.md)<br/>               |
...
| [**Tipo de instância**](a-instancetype.md)                                        | Verdadeiro      | [**Início**](c-top.md)<br/>               |
| [**ipServicePort**](a-ipserviceport.md)                                       | Verdadeiro      | **ipService**                                 |
| [**ipServiceProtocol**](a-ipserviceprotocol.md)                               | Verdadeiro      | **ipService**                                 |
