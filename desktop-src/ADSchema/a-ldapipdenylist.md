...
---
# <a name="ldap-ipdeny-list-attribute"></a>Atributo LDAP-IPDeny-List

Mantém uma lista de endereços IP binários que têm acesso negado a um servidor LDAP.
...
| Classes usadas em        | [**Política de consulta**](c-querypolicy.md)<br/> |
