...
ms.locfileid: "119548906"
---
# <a name="site-link-class"></a>Site-Link classe

Esse objeto representa a conexão entre dois sites.
...
| Frequência de atualização  | Sempre que os sites conectados a esse link mudarem. |
...
| Possíveis superiores          | [**Transporte entre sites**](c-intersitetransport.md)                                         |
| Classes Auxiliares           | \-                                                                                           |
...
| [**Custo**](a-cost.md)                                                    | Falso     | **Link do site**                   |
...
| [**Opções**](a-options.md)                                              | Falso     | **Link de site**                   |
...
| [**Intervalo de repl**](a-replinterval.md)                                   | Falso     | **Link do site**                   |
...
| [**Agenda**](a-schedule.md)                                            | Falso     | **Link do site**                   |
...
| [**Lista de sites**](a-sitelist.md)                                           | Verdadeiro      | **Link do site**                   |
...
| [**Versão do objeto**](a-objectversion.md)                                   | Falso     | [**Início**](c-top.md)<br/> |
| [**Opções**](a-options.md)                                                | Falso     | **Link do site**                   |
...
| [**Reps-to**](a-repsto.md)                                                 | Falso     | [**Início**](c-top.md)<br/> |
| [**Revisão**](a-revision.md)                                              | Falso     | [**Início**](c-top.md)<br/> |
| [**Agenda**](a-schedule.md)                                              | Falso     | **Link de site**                   |
...
| [**Lista de sites**](a-sitelist.md)                                             | Verdadeiro      | **Link de site**                   |
| [**Site-Object-BL**](a-siteobjectbl.md)                                    | Falso     | [**Início**](c-top.md)<br/> |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Superiores possíveis          | [**Transporte entre sites**](c-intersitetransport.md)                                         |
| Classes Auxiliares           | \-                                                                                           |
...
| [**RDN**](a-name.md)                                                          | Falso     | [**Início**](c-top.md)<br/> |
| [**Repl-intervalo**](a-replinterval.md)                                        | Falso     | **Link de site**                   |
| [**Repl-Property-meta-data**](a-replpropertymetadata.md)                      | Falso     | [**Início**](c-top.md)<br/> |
| [**Repl-UpToDate-vector**](a-repluptodatevector.md)                           | Falso     | [**Início**](c-top.md)<br/> |
| [**Relatórios**](a-directreports.md)                                             | Falso     | [**Início**](c-top.md)<br/> |
| [**Representantes-de**](a-repsfrom.md)                                                | Falso     | [**Início**](c-top.md)<br/> |
