...
Representa uma abstração de uma rede. O valor de nome distinto do atributo [**common-name**](a-cn.md) denota o nome canônico da rede.
...
| [**Nome comum**](a-cn.md)                                                 | True      | **ipNetwork** [ **superior**](c-top.md)<br/> |
