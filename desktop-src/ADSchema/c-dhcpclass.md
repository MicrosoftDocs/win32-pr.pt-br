...
keywords:
- DHCP-Class classe AD Schema
- Esquema do AD da classe dHCPClass
topic_type:
- apiref
api_name:
- DHCP-Class
...
ms.locfileid: "119703776"
---
# <a name="dhcp-class-class"></a>DHCP-Class classe

Representa um servidor DHCP (ou conjunto de servidores).
...
| [**dhcp-Classes**](a-dhcpclasses.md)                                     | Falso     | **Classe DHCP**                  |
| [**dhcp-Flags**](a-dhcpflags.md)                                         | Verdadeiro      | **Classe DHCP**                  |
| [**dhcp-Identification**](a-dhcpidentification.md)                       | Verdadeiro      | **Classe DHCP**                  |
...
| [**Opções de DHCP**](a-dhcpoptions.md)                                     | Falso     | **Classe DHCP**                  |
| [**DHCP-Propriedades**](a-dhcpproperties.md)                               | Falso     | **Classe DHCP**                  |
| [**Intervalos DHCP**](a-dhcpranges.md)                                       | Falso     | **Classe DHCP**                  |
| [**DHCP-reservas**](a-dhcpreservations.md)                           | Falso     | **Classe DHCP**                  |
| [**Servidores DHCP**](a-dhcpservers.md)                                     | Falso     | **Classe DHCP**                  |
| [**DHCP-sites**](a-dhcpsites.md)                                         | Falso     | **Classe DHCP**                  |
| [**Estado do DHCP**](a-dhcpstate.md)                                         | Falso     | **Classe DHCP**                  |
| [**DHCP-sub-redes**](a-dhcpsubnets.md)                                     | Falso     | **Classe DHCP**                  |
| [**Tipo de DHCP**](a-dhcptype.md)                                           | Verdadeiro      | **Classe DHCP**                  |
| [**Chave exclusiva do DHCP**](a-dhcpuniquekey.md)                                | Verdadeiro      | **Classe DHCP**                  |
| [**DHCP-tempo de atualização**](a-dhcpupdatetime.md)                              | Falso     | **Classe DHCP**                  |
...
| [**Endereço de rede**](a-networkaddress.md)                               | Falso     | **Classe DHCP**                  |
...
| [**Opção-descrição**](a-optiondescription.md)                         | Falso     | **Classe DHCP**                  |
| [**Opções-localização**](a-optionslocation.md)                             | Falso     | **Classe DHCP**                  |
...
| [**Descrição do superescococo**](a-superscopedescription.md)                | Falso     | **Classe DHCP**                  |
| [**Super-escopos**](a-superscopes.md)                                     | Falso     | **Classe DHCP**                  |
...
| [**dhcp-Type**](a-dhcptype.md)                                             | Verdadeiro      | **Classe DHCP**                  |
| [**dhcp-Unique-Key**](a-dhcpuniquekey.md)                                  | Verdadeiro      | **Classe DHCP**                  |
...
| [**Sub-referências**](a-subrefs.md)                                               | Falso     | [**Início**](c-top.md)<br/> |
| [**SubSchemaSubEntry**](a-subschemasubentry.md)                            | Falso     | [**Início**](c-top.md)<br/> |
| [**Super escopo-descrição**](a-superscopedescription.md)                  | Falso     | **Classe DHCP**                  |
| [**Superescopos**](a-superscopes.md)                                       | Falso     | **Classe DHCP**                  |
...
| [**Versão do objeto**](a-objectversion.md)                                   | Falso     | [**Início**](c-top.md)<br/> |
| [**Descrição da opção**](a-optiondescription.md)                           | Falso     | **Classe DHCP**                  |
| [**Opções – Localização**](a-optionslocation.md)                               | Falso     | **Classe DHCP**                  |
...
| [**Descrição**](a-description.md)                                                         | Falso     | [**Início**](c-top.md)<br/> |
| [**Classes DHCP**](a-dhcpclasses.md)                                                        | Falso     | **Classe DHCP**                  |
| [**Sinalizadores de DHCP**](a-dhcpflags.md)                                                            | Verdadeiro      | **Classe DHCP**                  |
| [**Identificação de DHCP**](a-dhcpidentification.md)                                          | Verdadeiro      | **Classe DHCP**                  |
| [**Máscara de DHCP**](a-dhcpmask.md)                                                              | Falso     | **Classe DHCP**                  |
| [**DHCP-MaxKey**](a-dhcpmaxkey.md)                                                          | Falso     | **Classe DHCP**                  |
| [**DHCP-obj-Description**](a-dhcpobjdescription.md)                                         | Falso     | **Classe DHCP**                  |
| [**DHCP-obj-Name**](a-dhcpobjname.md)                                                       | Falso     | **Classe DHCP**                  |
| [**Opções de DHCP**](a-dhcpoptions.md)                                                        | Falso     | **Classe DHCP**                  |
