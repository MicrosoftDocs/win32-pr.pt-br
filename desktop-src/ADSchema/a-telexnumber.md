...
description: Uma lista de números telex alternativos.
ms.assetid: e5fead61-fec1-4ba1-b9bd-d5510f3f2183
ms.tgt_platform: multiple
keywords:
- Telex-Number atributo AD Schema
- esquema do AD do atributo telexNumber
topic_type:
- apiref
api_name:
- Telex-Number
...
ms.locfileid: "119835845"
---
# <a name="telex-number-attribute"></a>Telex-Number atributo

Uma lista de números telex alternativos.
