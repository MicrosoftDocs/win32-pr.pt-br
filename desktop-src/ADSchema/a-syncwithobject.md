...
---
# <a name="sync-with-object-attribute"></a>Atributo Sync-with-Object

Nome distinto do objeto que está sendo sincronizado para a sincronização de diretiva local/grupo do SAM Builtin.



| Entrada | Valor |
|-------------------|-----------------------------------------|
| CN                | Sincronizar com objeto                        |
