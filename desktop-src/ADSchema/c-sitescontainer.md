...
Um contêiner para armazenar objetos do site. Localizado no contexto de nomenclatura de configuração.
...
| Privilégio de atualização  | Esse objeto é mantido pelo sistema. |
| Frequência de atualização  | Quando o serviço de diretório é criado.   |
