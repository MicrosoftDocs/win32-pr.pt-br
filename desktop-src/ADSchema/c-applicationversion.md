...
ms.locfileid: "119021894"
---
# <a name="application-version-class"></a>Classe Application-Version

Pode ser usado por desenvolvedores de aplicativos para armazenar informações de versão sobre seu aplicativo ou seu esquema.
...
| [**Versão de esquema de aplicativo**](a-appschemaversion.md)                            | Falso     | **Versão do aplicativo**                                          |
...
| [**Palavras-chave**](a-keywords.md)                                              | Falso     | **Versão do aplicativo**                                          |
| [**Último pai conhecido**](a-lastknownparent.md)                              | Falso     | [**Início**](c-top.md)<br/>                                  |
| [**Gerenciado por**](a-managedby.md)                                           | Falso     | **Versão do aplicativo**                                          |
...
| [**Proprietário**](a-owner.md)                                                    | Falso     | **Versão do aplicativo**                                          |
...
| [**Fornecedor**](a-vendor.md)                                                  | Falso     | **Versão do aplicativo**                                          |
| [**Número de versão**](a-versionnumber.md)                                   | Falso     | **Versão do aplicativo**                                          |
| [**Version-Number-Hi**](a-versionnumberhi.md)                              | Falso     | **Versão do aplicativo**                                          |
| [**Version-Number-Lo**](a-versionnumberlo.md)                              | Falso     | **Versão do aplicativo**                                          |
...
| [**App-Schema-Version**](a-appschemaversion.md)                            | Falso     | **Versão do aplicativo**                                          |
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Falso     | [**Início**](c-top.md)<br/>                                  |
| [**Nome canônico**](a-canonicalname.md)                                   | Falso     | [**Início**](c-top.md)<br/>                                  |
...
| [**Fornecedor**](a-vendor.md)                                                       | Falso     | **Versão do aplicativo**                                          |
| [**Número de versão**](a-versionnumber.md)                                        | Falso     | **Versão do aplicativo**                                          |
| [**Versão-número-Olá**](a-versionnumberhi.md)                                   | Falso     | **Versão do aplicativo**                                          |
| [**Versão-número-lo**](a-versionnumberlo.md)                                   | Falso     | **Versão do aplicativo**                                          |
