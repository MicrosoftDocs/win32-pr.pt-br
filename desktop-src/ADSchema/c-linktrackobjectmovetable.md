...
---
# <a name="link-track-object-move-table-class"></a>Classe link-Track-Object-mover-tabela

Contêiner para objetos de entrada de link-Track-OMT.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Link-Track-objeto-mover-tabela         |
