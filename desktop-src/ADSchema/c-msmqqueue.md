...
Os usuários do MSMQ criam filas (pelo MMC ou pela API do MSMQ) de acordo com seus requisitos. Uma fila é associada a um computador específico e é colocada sob a MSMQ-Configuration desse computador. Não há nenhum limite para o número de filas por computador.
