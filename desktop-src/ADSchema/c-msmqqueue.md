...
description: Os usuários do MSMQ criam filas (pelo MMC ou pela API do MSMQ) de acordo com seus requisitos. Uma fila é associada a um computador específico e é colocada sob a MSMQ-Configuration desse computador. Não há limite para o número de filas por computador.
ms.assetid: 166475ba-6c5b-41bd-a9b9-8ed8ee5f12cb
ms.tgt_platform: multiple
keywords:
- MSMQ-Queue classe AD Schema
- Esquema do AD da classe mSMQQueue
topic_type:
- apiref
api_name:
- MSMQ-Queue
...
ms.locfileid: "118175220"
---
# <a name="msmq-queue-class"></a>MSMQ-Queue classe

Os usuários do MSMQ criam filas (pelo MMC ou pela API do MSMQ) de acordo com seus requisitos. Uma fila é associada a um computador específico e é colocada sob a MSMQ-Configuration desse computador. Não há limite para o número de filas por computador.
...
| Schema-Id-Guid    | 9a0dc343-c100-11d1-football5-0080c76670c0 |
...
| Possíveis superiores          | [**MSMQ-Configuration**](c-msmqconfiguration.md)                                            |
| Classes Auxiliares           | \-                                                                                           |
...
| [**Autenticar no MSMQ**](a-msmqauthenticate.md)                           | Falso     | **Fila MSMQ**                  |
| [**MSMQ-base-prioridade**](a-msmqbasepriority.md)                          | Falso     | **Fila MSMQ**                  |
| [**MSMQ-diário**](a-msmqjournal.md)                                     | Falso     | **Fila MSMQ**                  |
| [**Rótulo MSMQ**](a-msmqlabel.md)                                         | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Label-ex**](a-msmqlabelex.md)                                    | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | Falso     | **Fila MSMQ**                  |
| [**MSMQ-privacidade-nível**](a-msmqprivacylevel.md)                          | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Queue-diário-quota**](a-msmqqueuejournalquota.md)               | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Queue-Name-ext**](a-msmqqueuenameext.md)                         | Falso     | **Fila MSMQ**                  |
| [**MSMQ-cota de fila**](a-msmqqueuequota.md)                              | Falso     | **Fila MSMQ**                  |
| [**MSMQ-tipo de fila**](a-msmqqueuetype.md)                                | Falso     | **Fila MSMQ**                  |
| [**MSMQ-transacional**](a-msmqtransactional.md)                         | Falso     | **Fila MSMQ**                  |
...
| [**Autenticar MSMQ**](a-msmqauthenticate.md)                             | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Base-Priority**](a-msmqbasepriority.md)                            | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Journal**](a-msmqjournal.md)                                       | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Label**](a-msmqlabel.md)                                           | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Label-Ex**](a-msmqlabelex.md)                                      | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Multicast-Address**](a-msmq-multicastaddress.md)                   | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                      | Falso     | **Fila MSMQ**                  |
| [**Nível de privacidade do MSMQ**](a-msmqprivacylevel.md)                            | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Queue-Journal-Quota**](a-msmqqueuejournalquota.md)                 | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Queue-Name-Ext**](a-msmqqueuenameext.md)                           | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Queue-Quota**](a-msmqqueuequota.md)                                | Falso     | **Fila MSMQ**                  |
| [**Tipo de fila MSMQ**](a-msmqqueuetype.md)                                  | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Secured-Source**](a-msmq-securedsource.md)                         | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Transactional**](a-msmqtransactional.md)                           | Falso     | **Fila MSMQ**                  |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                    | Falso     | [**Início**](c-top.md)<br/> |
| [**Non-Security-Member-BL**](a-nonsecuritymemberbl.md)                     | Falso     | [**Início**](c-top.md)<br/> |
| [**Descritor de segurança NT**](a-ntsecuritydescriptor.md)                    | True      | [**Início**](c-top.md)<br/> |
| [**Obj-Dist-Name**](a-distinguishedname.md)                                | Falso     | [**Início**](c-top.md)<br/> |
| [**Categoria de objeto**](a-objectcategory.md)                                 | Verdadeiro      | [**Início**](c-top.md)<br/> |
| [**Classe de objeto**](a-objectclass.md)                                       | Verdadeiro      | [**Início**](c-top.md)<br/> |
| [**Guid de objeto**](a-objectguid.md)                                         | Falso     | [**Início**](c-top.md)<br/> |
...
| Nome comum                                            |
|--------------------------------------------------------|
| [**MSMQ-receber**](r-msmq-receive.md)                 |
| [**MSMQ-Peek**](r-msmq-peek.md)                       |
| [**MSMQ-enviar**](r-msmq-send.md)                       |
| [**MSMQ-recebimento-diário**](r-msmq-receive-journal.md) |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Superiores possíveis          | [**Configuração do MSMQ**](c-msmqconfiguration.md)                                            |
| Classes Auxiliares           | \-                                                                                           |
...
| [**Rótulo MSMQ**](a-msmqlabel.md)                                              | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Label-ex**](a-msmqlabelex.md)                                         | Falso     | **Fila MSMQ**                  |
| [**MSMQ-endereço de multicast**](a-msmq-multicastaddress.md)                      | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                         | Falso     | **Fila MSMQ**                  |
| [**MSMQ-privacidade-nível**](a-msmqprivacylevel.md)                               | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Queue-diário-quota**](a-msmqqueuejournalquota.md)                    | Falso     | **Fila MSMQ**                  |
| [**MSMQ-Queue-Name-ext**](a-msmqqueuenameext.md)                              | Falso     | **Fila MSMQ**                  |
| [**MSMQ-cota de fila**](a-msmqqueuequota.md)                                   | Falso     | **Fila MSMQ**                  |
| [**MSMQ-tipo de fila**](a-msmqqueuetype.md)                                     | Falso     | **Fila MSMQ**                  |
| [**Fonte protegida pelo MSMQ**](a-msmq-securedsource.md)                            | Falso     | **Fila MSMQ**                  |
| [**MSMQ-transacional**](a-msmqtransactional.md)                              | Falso     | **Fila MSMQ**                  |
