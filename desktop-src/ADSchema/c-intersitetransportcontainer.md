...
---
# <a name="inter-site-transport-container-class"></a>Classe de contêiner entre sites-transporte

Mantém objetos de transporte entre sites.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Contêiner de transporte entre sites       |
