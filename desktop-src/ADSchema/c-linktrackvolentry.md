...
ms.locfileid: "119834926"
---
# <a name="link-track-vol-entry-class"></a>Classe link-Track-Vol-entry

A entrada de um link para um arquivo em um volume.
...
| Frequência de atualização  | Sempre que um link para um arquivo é criado. |
...
| Superiores possíveis          | [**Link-Track-volume-tabela**](c-linktrackvolumetable.md)                  |
| Classes Auxiliares           | \-                                                                         |
...
| [**ID da máquina**](a-currmachineid.md)                                | Falso     | **Link-Track-Vol-entry**        |
...
| [**Contagem de objetos**](a-objectcount.md)                                     | Falso     | **Link-Track-Vol-Entry**        |
...
| [**Atualização de tempo**](a-timerefresh.md)                                     | Falso     | **Link-Track-Vol-Entry**        |
| [**Time-Vol-Change**](a-timevolchange.md)                                | Falso     | **Link-Track-Vol-Entry**        |
...
| Subclasse de                 | [**Leaf**](c-leaf.md)<br/>                                          |
| Possíveis superiores          | [**Link-Track-Volume-Table**](c-linktrackvolumetable.md)                  |
| Classes Auxiliares           | \-                                                                         |
...
| [**Último-pai conhecido**](a-lastknownparent.md)                              | Falso     | [**Início**](c-top.md)<br/> |
| [**Link-Track-secreto**](a-linktracksecret.md)                              | Falso     | **Link-Track-Vol-entry**        |
| [**Objetos gerenciados**](a-managedobjects.md)                                 | Falso     | [**Início**](c-top.md)<br/> |
...
| [**Atualização de tempo**](a-timerefresh.md)                                       | Falso     | **Link-Track-Vol-entry**        |
| [**Tempo-Vol-alteração**](a-timevolchange.md)                                  | Falso     | **Link-Track-Vol-entry**        |
| [**USN-alterado**](a-usnchanged.md)                                         | Falso     | [**Início**](c-top.md)<br/> |
...
| [**Seq-notificação**](a-seqnotification.md)                                  | Falso     | **Link-Track-Vol-entry**        |
