...
description: Objeto genérico para publicação de UNCs de arquivo.
ms.assetid: d183a507-4b73-44c1-a074-d9648991cd5f
ms.tgt_platform: multiple
keywords:
- Armazenamento classe AD Schema
- classe de armazenamento Esquema do AD
topic_type:
- apiref
api_name:
- Storage
...
ms.locfileid: "119548856"
---
# <a name="storage-class"></a>Classe de armazenamento

Objeto genérico para publicação de UNCs de arquivo.
...
|-------------------|--------------------------------------|
| CN                | Armazenamento                              |
| Ldap-Display-Name | armazenamento                              |
...
| [**Ícone-caminho**](a-iconpath.md)                                           | Falso     | **Storage**                                                                              |
...
| [**Moniker-nome de exibição**](a-monikerdisplayname.md)                      | Falso     | **Storage**                                                                              |
...
| [**Caminho do ícone**](a-iconpath.md)                                                | Falso     | **Storage**                                                                              |
| [**Tipo de instância**](a-instancetype.md)                                        | Verdadeiro      | [**Início**](c-top.md)<br/>                                                          |
