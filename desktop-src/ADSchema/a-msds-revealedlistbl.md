...
ms.locfileid: "119925456"
---
# <a name="ms-ds-revealed-list-bl-attribute"></a>atributo ms-DS-revelate-List-BL

Atributo de link para trás para o [**MS-DS-Revelate-List**](a-msds-revealedlist.md).



| Entrada | Valor |
|-------------------|-----------------------------------------|
| CN                | ms-DS-revelado-List-BL                  |
