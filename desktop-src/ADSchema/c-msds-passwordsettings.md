...
> [!Note]  
> Esse objeto classSchema é criado com uma lista de OIDs systemMustContain. Essa é uma lista de atributos que um PSO (objeto de configurações de senha) deve conter ou a criação do PSO falhará.
...
| Superiores possíveis          | [**ms-DS-password-Settings-contêiner**](c-msds-passwordsettingscontainer.md) |
| Classes Auxiliares           | \-                                                                            |
...
| [**ms-DS-Lock-Duration**](a-msds-lockoutduration.md)                                           | True      | **ms-DS-password-Settings**     |
| [**ms-DS-Lock-Observação-janela**](a-msds-lockoutobservationwindow.md)                        | True      | **ms-DS-password-Settings**     |
| [**ms-DS-Lock-Threshold**](a-msds-lockoutthreshold.md)                                         | True      | **ms-DS-password-Settings**     |
...
| [**ms-DS-mínimo-senha-idade**](a-msds-minimumpasswordage.md)                                    | True      | **ms-DS-password-Settings**     |
| [**ms-DS-mínimo-senha-comprimento**](a-msds-minimumpasswordlength.md)                              | True      | **ms-DS-password-Settings**     |
...
| [**ms-DS-password-complexidade-habilitado**](a-msds-passwordcomplexityenabled.md)                      | True      | **ms-DS-password-Settings**     |
| [**ms-DS-password-tamanho do histórico**](a-msds-passwordhistorylength.md)                              | True      | **ms-DS-password-Settings**     |
| [**ms-DS-password-reversível-Encryption-habilitado**](a-msds-passwordreversibleencryptionenabled.md) | True      | **ms-DS-password-Settings**     |
| [**ms-DS-password-Settings-precedência**](a-msds-passwordsettingsprecedence.md)                    | True      | **ms-DS-password-Settings**     |
...
| [**ms-DS-PSO-AppliesTo**](a-msds-psoappliesto.md)                                                | Falso     | **ms-DS-password-Settings**     |
