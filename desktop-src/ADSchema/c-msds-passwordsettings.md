---
title: Classe ms-DS-Password-Configurações
description: Objeto de configurações de senha para contas.
ms.assetid: 4e3a5a80-4f55-4c26-b5af-ace9dd853836
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe ms-DS-Password-Configurações
- Esquema do AD da classe msDS-PasswordSettings
topic_type:
- apiref
api_name:
...
ms.locfileid: "118959775"
---
# <a name="ms-ds-password-settings-class"></a>Classe ms-DS-Password-Configurações

Objeto de configurações de senha para contas.

> [!Note]  
> Esse objeto classSchema é criado com uma lista de OIDs systemMustContain. Esta é uma lista de atributos que um PSO (Password Configurações Object) deve conter ou a criação do PSO falhará.
...
| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | ms-DS-Password-Configurações              |
...
| Possíveis superiores          | [**ms-DS-Password-Configurações-Container**](c-msds-passwordsettingscontainer.md) |
| Classes Auxiliares           | \-                                                                            |
| Descritor de segurança NT      | O:BAG:BAD:S:                                                                  |
| Descritor de segurança padrão | D:(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;;D A)(A;; RPWPCRCCDCLCLORCWOWDSDTSW;;; SY)    |
...
| [**ms-DS-Lock-Duration**](a-msds-lockoutduration.md)                                           | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-Lock-Observação-janela**](a-msds-lockoutobservationwindow.md)                        | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-Lock-Threshold**](a-msds-lockoutthreshold.md)                                         | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-Masterd-by**](a-msds-masteredby.md)                                                     | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-Maximum-password-age**](a-msds-maximumpasswordage.md)                                    | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-Members-for-AZ-role-BL**](a-msds-membersforazrolebl.md)                                  | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-mínimo-senha-idade**](a-msds-minimumpasswordage.md)                                    | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-Minimum-Password-Length**](a-msds-minimumpasswordlength.md)                              | Verdadeiro      | **ms-DS-Password-Configurações**     |
...
| [**ms-DS-Password-Complexity-Enabled**](a-msds-passwordcomplexityenabled.md)                      | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-Password-History-Length**](a-msds-passwordhistorylength.md)                              | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-Password-Reversible-Encryption-Enabled**](a-msds-passwordreversibleencryptionenabled.md) | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-Password-Configurações-Precedence**](a-msds-passwordsettingsprecedence.md)                    | Verdadeiro      | **ms-DS-Password-Configurações**     |
...
| [**ms-DS-PSO-Applies-To**](a-msds-psoappliesto.md)                                                | Falso     | **ms-DS-Password-Configurações**     |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                               |
| Superiores possíveis          | [**ms-DS-Password-Configurações-Container**](c-msds-passwordsettingscontainer.md) |
| Classes Auxiliares           | \-                                                                            |
| NT-Security-Descriptor      | O:BAG: INADEQUADO: S:                                                                  |
| Descritor de segurança padrão | D: (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;;D A) (A;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; Sy    |
| System-Flags                | 0x00000010                                                                    |
...
| [**ms-DS-Members-for-AZ-role-BL**](a-msds-membersforazrolebl.md)                                  | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-mínimo-senha-idade**](a-msds-minimumpasswordage.md)                                    | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-mínimo-senha-comprimento**](a-msds-minimumpasswordlength.md)                              | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-NC-Repl-Cursors**](a-msds-ncreplcursors.md)                                              | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-NC-Repl-Inbound-Neighbors**](a-msds-ncreplinboundneighbors.md)                           | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-NC-Repl-Outbound-Neighbors**](a-msds-ncreploutboundneighbors.md)                         | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-NC-RO-Replica-Locations-BL**](a-msds-nc-ro-replica-locations-bl.md)                      | Falso     | [**Início**](c-top.md)<br/> |
...
| [**ms-DS-Minimum-Password-Age**](a-msds-minimumpasswordage.md)                                    | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-Minimum-Password-Length**](a-msds-minimumpasswordlength.md)                              | Verdadeiro      | **ms-DS-Password-Configurações**     |
| [**ms-DS-NC-Repl-Cursors**](a-msds-ncreplcursors.md)                                              | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-NC-Repl-Inbound-Neighbors**](a-msds-ncreplinboundneighbors.md)                           | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-NC-Repl-Outbound-Neighbors**](a-msds-ncreploutboundneighbors.md)                         | Falso     | [**Início**](c-top.md)<br/> |
