...
keywords:
- Esquema do AD da classe Ipsec-ISAKMP-Policy
- Esquema do AD da classe ipsecISAKMPPolicy
topic_type:
- apiref
api_name:
- Ipsec-ISAKMP-Policy
...
ms.locfileid: "119324226"
---
# <a name="ipsec-isakmp-policy-class"></a>Classe Ipsec-ISAKMP-Policy

A **classe Ipsec-ISAKMP-Policy** é somente para uso interno.
