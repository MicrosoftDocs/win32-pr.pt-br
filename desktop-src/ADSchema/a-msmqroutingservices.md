...
---
# <a name="msmq-routing-services-attribute"></a>MSMQ-atributo de serviços de roteamento

Indica se o MSMQ instalado neste computador fornece serviços de roteamento MSMQ.



| Entrada | Valor |
|-------------------|--------------------------------------|
| CN                | Serviços de roteamento MSMQ                |
