...
description: Número de versão secundária para AzRoles.
ms.assetid: 90e12e89-62cf-4e69-b497-d283d21ccb2c
ms.tgt_platform: multiple
keywords:
- Esquema de AD do atributo ms-DS-AZ-minor-version
- atributo msDS-AzMinorVersion do AD Schema
topic_type:
- apiref
api_name:
...
ms.locfileid: "119552756"
---
# <a name="ms-ds-az-minor-version-attribute"></a>atributo ms-DS-AZ-minor-version

Número de versão secundária para AzRoles.
