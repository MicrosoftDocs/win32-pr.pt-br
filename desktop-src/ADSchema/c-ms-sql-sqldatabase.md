...
description: Classe para armazenar SQL Server de banco de dados.
ms.assetid: ad1d7532-534a-4220-8e19-70f7c6f36e36
ms.tgt_platform: multiple
keywords:
- Esquema do AD da classe MS-SQL-SQLDatabase
- Esquema do AD da classe mS-SQL-SQLDatabase
topic_type:
- apiref
api_name:
...
ms.locfileid: "119441186"
---
# <a name="ms-sql-sqldatabase-class"></a>Classe MS-SQL-SQLDatabase

Classe para armazenar SQL Server de banco de dados.
...
| Possíveis superiores          | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)                                               |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MS-SQL-Keywords**](a-ms-sql-keywords.md)                              | Falso     | **MS-SQL-SQLDatabase**          |
...
| [**Tamanho SQL MS**](a-ms-sql-size.md)                                      | Falso     | **MS-SQL-SQLDatabase**          |
...
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                              |
| Superiores possíveis          | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)                                               |
| Classes Auxiliares           | \-                                                                                           |
...
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                       | Falso     | **MS-SQL-sqldatabase**          |
| [**MS-SQL-CreationDate**](a-ms-sql-creationdate.md)                             | Falso     | **MS-SQL-sqldatabase**          |
| [**MS-SQL-descrição**](a-ms-sql-description.md)                               | Falso     | **MS-SQL-sqldatabase**          |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                         | Falso     | **MS-SQL-sqldatabase**          |
| [**MS-SQL-palavras-chave**](a-ms-sql-keywords.md)                                     | Falso     | **MS-SQL-sqldatabase**          |
| [**MS-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                         | Falso     | **MS-SQL-sqldatabase**          |
| [**MS-SQL-LastDiagnosticDate**](a-ms-sql-lastdiagnosticdate.md)                 | Falso     | **MS-SQL-sqldatabase**          |
| [**MS-SQL-Name**](a-ms-sql-name.md)                                             | Falso     | **MS-SQL-sqldatabase**          |
