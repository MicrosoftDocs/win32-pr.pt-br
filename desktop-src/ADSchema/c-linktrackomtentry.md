...
keywords:
- Esquema do AD da classe Link-Track-OMT-Entry
- Esquema do AD da classe linkTrackOMTEntry
topic_type:
- apiref
api_name:
...
ms.locfileid: "118423087"
---
# <a name="link-track-omt-entry-class"></a>Classe Link-Track-OMT-Entry

Rastreia o link para objetos que foram movidos.
...
| Frequência de atualização  | Sempre que um link para um arquivo é mudar.   |
...
| Possíveis superiores          | [**Link-Track-Object-Move-Table**](c-linktrackobjectmovetable.md)                           |
| Classes Auxiliares           | \-                                                                                           |
...
| [**Local de nascimento**](a-birthlocation.md)                                 | Falso     | **Link-Track-OMT-Entry**        |
...
| [**Local atual**](a-currentlocation.md)                             | Falso     | **Link-Track-OMT-Entry**        |
...
| [**Atualização de tempo**](a-timerefresh.md)                                     | Falso     | **Link-Track-OMT-entry**        |
...
| Subclasse de                 | [**Leaf**](c-leaf.md)<br/>                                                            |
| Superiores possíveis          | [**Link-Track-objeto-mover-tabela**](c-linktrackobjectmovetable.md)                           |
| Classes Auxiliares           | \-                                                                                           |
