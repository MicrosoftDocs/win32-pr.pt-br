...
keywords:
- Allowed-Attributes atributo AD Schema
- Esquema do AD do atributo allowedAttributes
topic_type:
- apiref
api_name:
- Allowed-Attributes
...
ms.locfileid: "118688308"
---
# <a name="allowed-attributes-attribute"></a>Allowed-Attributes atributo

Atributos que terão permissão para serem atribuídos a uma classe.
