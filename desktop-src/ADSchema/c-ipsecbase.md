...
keywords:
- Ipsec-Base classe AD Schema
- Esquema do AD da classe ipsecBase
topic_type:
- apiref
api_name:
- Ipsec-Base
...
ms.locfileid: "119922556"
---
# <a name="ipsec-base-class"></a>Ipsec-Base classe

Classe base IPSEC da qual todas as classes IPSEC são derivadas.
...
| [**IPSec-dados**](a-ipsecdata.md)                                         | Falso     | **Base de IPSec**                  |
| [**IPSec-tipo de dados**](a-ipsecdatatype.md)                                | Falso     | **Base de IPSec**                  |
| [**ID do IPSec**](a-ipsecid.md)                                             | Falso     | **Base de IPSec**                  |
| [**Nome do IPSec**](a-ipsecname.md)                                         | Falso     | **Base de IPSec**                  |
| [**IPSec-proprietários-referência**](a-ipsecownersreference.md)                  | Falso     | **Base de IPSec**                  |
...
| [**Tipo de dados Ipsec**](a-ipsecdatatype.md)                                  | Falso     | **Ipsec-Base**                  |
