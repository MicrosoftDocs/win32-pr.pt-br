...
keywords:
- Esquema do AD da classe ms-DFSR-Connection
- Esquema do AD da classe msDFSR-Connection
topic_type:
- apiref
api_name:
- ms-DFSR-Connection
...
ms.locfileid: "117836219"
---
# <a name="ms-dfsr-connection-class"></a>Classe ms-DFSR-Connection

Representa uma conexão direcional entre dois membros.
...
| Schema-Id-Guid    | e58f972e-64b5-46ef-8d8b-ique3e1897eab |
...
| Possíveis superiores          | [**ms-DFSR-Member**](c-msdfsr-member.md)                                                                                        |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**From-Server**](a-fromserver.md)                                         | Verdadeiro      | **ms-DFSR-Connection**          |
...
| [**palavras-chave ms-DFSR**](a-msdfsr-keywords.md)                               | Falso     | **ms-DFSR-Connection**          |
...
| RDN-ATT-ID                  | \-                                                                                                                               |
| Subclasse de                 | [**Início**](c-top.md)<br/>                                                                                                  |
| Superiores possíveis          | [**MS-DFSR-Member**](c-msdfsr-member.md)                                                                                        |
| Classes Auxiliares           | \-                                                                                                                               |
...
| [**Do-servidor**](a-fromserver.md)                                              | Verdadeiro      | **MS-DFSR-Connection**          |
| [**FRS-Computer-Reference-BL**](a-frscomputerreferencebl.md)                    | Falso     | [**Início**](c-top.md)<br/> |
| [**FRS-member-Reference-BL**](a-frsmemberreferencebl.md)                        | Falso     | [**Início**](c-top.md)<br/> |
...
| [**MS-DFSR-ComputerReferenceBL**](a-msdfsr-computerreferencebl.md)              | Falso     | [**Início**](c-top.md)<br/> |
| [**MS-DFSR-DisablePacketPrivacy**](a-msdfsr-disablepacketprivacy.md)            | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR habilitado**](a-msdfsr-enabled.md)                                      | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                                  | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR-flags**](a-msdfsr-flags.md)                                          | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR-Keywords**](a-msdfsr-keywords.md)                                    | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                  | Falso     | [**Início**](c-top.md)<br/> |
| [**MS-DFSR-opções**](a-msdfsr-options.md)                                      | Falso     | **MS-DFSR-Connection**          |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                    | Falso     | **MS-DFSR-Connection**          |
| [**ms-DFSR-Priority**](a-msdfsr-priority.md)                                    | Falso     | **ms-DFSR-Connection**          |
| [**ms-DFSR-RdcEnabled**](a-msdfsr-rdcenabled.md)                                | Falso     | **ms-DFSR-Connection**          |
| [**ms-DFSR-RdcMinFileSizeInKb**](a-msdfsr-rdcminfilesizeinkb.md)                | Falso     | **ms-DFSR-Connection**          |
...
A classe **MS-DFSR-Connection** faz parte do suporte ao serviço de replicação do sistema de arquivos distribuído (DFS).
