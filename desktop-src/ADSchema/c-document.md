...
description: A classe de objeto de documento é usada para definir entradas que representam documentos.
ms.assetid: 846663cc-e1c0-4651-a14d-7fc2c2f7c339
ms.tgt_platform: multiple
keywords:
- classe de documento Esquema do AD
topic_type:
- apiref
api_name:
- document
...
ms.locfileid: "119643466"
---
# <a name="document-class"></a>classe de documento

A classe de objeto de documento é usada para definir entradas que representam documentos.
...
| [**Descrição**](a-description.md)                                        | Falso     | **document** [ **Top**](c-top.md)<br/> |
...
| [**Localidade-nome**](a-l.md)                                                | Falso     | **document**                                 |
...
| [**Nome da unidade organizacional**](a-ou.md)                                    | Falso     | **document**                                 |
| [**Nome da organização**](a-o.md)                                            | Falso     | **document**                                 |
...
| [**Consulte-também**](a-seealso.md)                                               | Falso     | **document**                                 |
...
| [**Bridgehead-Server-List-BL**](a-bridgeheadserverlistbl.md)                  | Falso     | [**Início**](c-top.md)<br/>              |
| [**Nome canônico**](a-canonicalname.md)                                      | Falso     | [**Início**](c-top.md)<br/>              |
| [**Nome comum**](a-cn.md)                                                    | Falso     |  [ **parte superior** do documento](c-top.md)<br/> |
| [**Criação-carimbo de data/hora**](a-createtimestamp.md)                                 | Falso     | [**Início**](c-top.md)<br/>              |
| [**Descrição**](a-description.md)                                           | Falso     |  [ **parte superior** do documento](c-top.md)<br/> |
| [**Nome de exibição**](a-displayname.md)                                          | Falso     | [**Início**](c-top.md)<br/>              |
| [**Nome de exibição-imprimível**](a-displaynameprintable.md)                       | Falso     | [**Início**](c-top.md)<br/>              |
| [**documentAuthor**](a-documentauthor.md)                                     | Falso     | **document**                                 |
| [**documentIdentifier**](a-documentidentifier.md)                             | Falso     | **document**                                 |
