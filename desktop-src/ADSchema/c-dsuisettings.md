...
Usado para armazenar as definições de configuração usadas pelo snap-in Active Directory usuários e computadores.
...
| [**DS-UI-admin-máximo**](a-dsuiadminmaximum.md)                         | Falso     | **DS-UI-Settings**              |
| [**DS-UI-admin-Notification**](a-dsuiadminnotification.md)               | Falso     | **DS-UI-Settings**              |
| [**DS-UI-Shell-máximo**](a-dsuishellmaximum.md)                         | Falso     | **DS-UI-Settings**              |
...
| [**MS-DS-Consistency-filho-Count**](a-ms-ds-consistencychildcount.md)                    | Falso     | [**Início**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                                 | Falso     | [**Início**](c-top.md)<br/> |
| [**ms-DS-Filter-containers**](a-msds-filtercontainers.md)                                | Falso     | **DS-UI-Settings**              |
...
| [**ms-DS-non-Security-Group-extra-classes**](a-msds-non-security-group-extra-classes.md) | Falso     | **DS-UI-Settings**              |
...
| [**ms-DS-Security-Group-extra-classes**](a-msds-security-group-extra-classes.md)         | Falso     | **DS-UI-Settings**              |
