...
---
# <a name="parental-controls-wmi-provider-schema"></a><span data-ttu-id="279a1-104">Controle dos pais esquema do provedor WMI</span><span class="sxs-lookup"><span data-stu-id="279a1-104">Parental Controls WMI Provider Schema</span></span>

<span data-ttu-id="279a1-105">O provedor WMI de controles pai é uma instância e um provedor de métodos.</span><span class="sxs-lookup"><span data-stu-id="279a1-105">The Parental Controls WMI Provider is an instance and method provider.</span></span> <span data-ttu-id="279a1-106">A instanciação de novas instâncias de classe, leitura ou modificação de propriedades de instância existentes e a invocação de métodos são controladas pelo arquivo Wpcsprov. mof.</span><span class="sxs-lookup"><span data-stu-id="279a1-106">Instantiation of new class instances, reading or modification of existing instance properties, and invocation of methods is controlled by the Wpcsprov.mof file.</span></span>

<span data-ttu-id="279a1-107">A sintaxe a seguir é do namespace. mof</span><span class="sxs-lookup"><span data-stu-id="279a1-107">The following syntax is from Namespace.mof</span></span>
...
<span data-ttu-id="279a1-108">A sintaxe a seguir é de ratings. mof</span><span class="sxs-lookup"><span data-stu-id="279a1-108">The following syntax is from Ratings.mof</span></span>
...
<span data-ttu-id="279a1-109">A sintaxe a seguir é de WpcSettings. mof</span><span class="sxs-lookup"><span data-stu-id="279a1-109">The following syntax is from WpcSettings.mof</span></span>
...
<span data-ttu-id="279a1-110">A sintaxe a seguir é de WpcProvider. mof</span><span class="sxs-lookup"><span data-stu-id="279a1-110">The following syntax is from WpcProvider.mof</span></span>
