...
-   Aplicativo cliente autônomo. Os exemplos são clientes de email e media players. embora os media players tenham um risco para a Internet e alguns tenham serviços específicos, Windows controles dos pais promovem principalmente o registro em log e as restrições de atividades de reprodução para minimizar os impactos na biblioteca e registrar o ruído nos administradores.
...
Recomendações para implementar soluções em conformidade para cada categoria são especificadas na tabela a seguir.



| Categoria                           | Registro em log                                                  | Configurações de restrições                                    | Imposição de restrições                                 | Substituição de filtro de conteúdo da Web                                                        | Uso do link de extensibilidade para acesso de log e configurações               |
|------------------------------------|----------------------------------------------------------|----------------------------------------------------------|----------------------------------------------------------|---------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
