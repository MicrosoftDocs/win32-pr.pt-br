---
description: Usado por uma interface ID3DX10ThreadPump para carregar dados de um disco.
...
ms.locfileid: "105812373"
---
# <a name="id3dx10dataloaderload-method"></a>Método ID3DX10DataLoader:: Load

Usado por uma [**interface ID3DX10ThreadPump**](id3dx10threadpump.md) para carregar dados de um disco.
