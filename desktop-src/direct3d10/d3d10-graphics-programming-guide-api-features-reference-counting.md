...
- No Direct3D 9, as funções Set contêm uma referência aos objetos do dispositivo; nas funções do conjunto do Direct3D 10, não mantenha uma referência aos objetos do dispositivo filho.
