...
Computa o produto de duas funções de harmônica esféricas (*f* e *g*). Ambas as funções são de Order N = 2.
...
O produto de duas funções SH de Order N = 2 gera uma função SH da ordem 2 × *N* -1 = 3, mas os resultados são truncados. Isso significa que o produto está mudo ( *f* × *g*  =  *g* × *f* ), mas não associa ( *f* × (*g* × *h*) ≠ ( *f* × *g*) × *h* ).
