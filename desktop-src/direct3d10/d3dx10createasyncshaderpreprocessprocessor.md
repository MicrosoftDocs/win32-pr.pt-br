...
---
# <a name="d3dx10createasyncshaderpreprocessprocessor-function"></a>Função D3DX10CreateAsyncShaderPreprocessProcessor
...
Endereço de um ponteiro para um buffer que contém o texto ASCII do sombreador (consulte a [**interface ID3D10Blob**](/windows/win32/api/D3DCommon/nn-d3dcommon-id3d10blob)).
