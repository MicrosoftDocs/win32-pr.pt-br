...
---
# <a name="id3dx10fontpreloadglyphs-method"></a>ID3DX10Font: método reloadGlyphs de:P
...
Os glifos não serão renderizados para o dispositivo; ID3DX10Font::D rawText ainda deve ser chamado para renderizar os glifos. No entanto, ao pré-carregar glifos na memória de vídeo, ID3DX10Font::D rawText usará substancialmente menos recursos de CPU.
