...
---
# <a name="d3dxvec3normalize-function-d3dx10mathh"></a>Função D3DXVec3Normalize (D3DX10Math. h)
...
Ponteiro para uma estrutura D3DXVECTOR3 que é a versão normalizada do vetor especificado.
