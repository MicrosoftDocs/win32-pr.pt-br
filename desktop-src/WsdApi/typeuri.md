...
ms.locfileid: "104169649"
---
# <a name="typeuri-element"></a>elemento typeUri

Especifica um tipo a ser incluído de um arquivo XSD.
...
|---------------------|------------------------------|----------------|------------------------------------------------------------------------|
| **tipo**<br/> | Cadeia de caracteres \_<br/> | Yes<br/> | O nome do tipo.<br/> <br/>                           |
| **uri**<br/>  | Cadeia de caracteres \_<br/> | Yes<br/> | O namespace do tipo. Deve ser um URI válido.<br/> <br/> |
