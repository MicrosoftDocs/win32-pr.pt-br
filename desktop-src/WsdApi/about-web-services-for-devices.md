...
Para obter mais informações sobre padrões de mensagens de dispositivo, consulte [descoberta e padrões de mensagem de troca de metadados](discovery-and-metadata-exchange-message-patterns.md).
