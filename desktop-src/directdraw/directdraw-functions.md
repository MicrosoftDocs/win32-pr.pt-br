---
title: Funções do DirectDraw
description: Esta seção contém informações sobre as seguintes funções globais do DirectDraw
...
---
# <a name="directdraw-functions"></a>Funções do DirectDraw

Esta seção contém informações sobre as seguintes funções globais do DirectDraw:
