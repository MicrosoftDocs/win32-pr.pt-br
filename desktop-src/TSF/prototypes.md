...
---
# <a name="prototypes"></a><span data-ttu-id="1196b-110">Protótipos</span><span class="sxs-lookup"><span data-stu-id="1196b-110">Prototypes</span></span>

<span data-ttu-id="1196b-111">[ITfContextRenderingMarkup](/windows/desktop/TSF/itfcontextrenderingmarkup), [IEnumTfRenderingMarkup](/windows/desktop/TSF/ienumtfrenderingmarkup)e [TF \_ RENDERINGMARKUP](/windows/desktop/TSF/tf-renderingmarkup) descritos nesta referência não são definidos em arquivos IDL ou de cabeçalho.</span><span class="sxs-lookup"><span data-stu-id="1196b-111">[ITfContextRenderingMarkup](/windows/desktop/TSF/itfcontextrenderingmarkup), [IEnumTfRenderingMarkup](/windows/desktop/TSF/ienumtfrenderingmarkup), and [TF\_RENDERINGMARKUP](/windows/desktop/TSF/tf-renderingmarkup) described in this reference are not defined in IDL or header files.</span></span> <span data-ttu-id="1196b-112">Os protótipos a seguir são necessários para serem compatíveis com o compilador MIDL para obter o arquivo de cabeçalho.</span><span class="sxs-lookup"><span data-stu-id="1196b-112">The following prototypes are needed to be complied by MIDL compiler to get the header file..</span></span>
