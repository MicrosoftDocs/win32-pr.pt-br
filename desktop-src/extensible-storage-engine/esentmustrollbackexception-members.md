...
ms.locfileid: "119851926"
---
# <a name="esentmustrollbackexception-members"></a>Membros do EsentMustRollbackException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. MustRollback exceções.

O tipo [EsentMustRollbackException](./esentmustrollbackexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentMustRollbackException.</td>
</tr>
</tbody>
</table>
