---
description: 'Saiba mais sobre: ColumnValueOfStruct <T> . Propriedade Length'
title: ColumnValueOfStruct (T). Propriedade Length
...
Obtém o comprimento de bytes de um valor de coluna, que será zero se a coluna for nula, caso contrário, ela corresponderá ao tamanho dessa coluna de tamanho fixo.
