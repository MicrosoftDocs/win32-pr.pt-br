...
---
# <a name="jet_dbinfomiscfupgradedb-property"></a>Propriedade JET_DBINFOMISC. fUpgradeDb

Obtém um valor que indica se o banco de dados está sendo atualizado. Esse valor é somente para uso interno.
