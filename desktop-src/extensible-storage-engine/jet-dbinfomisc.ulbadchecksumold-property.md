...
---
# <a name="jet_dbinfomisculbadchecksumold-property"></a>Propriedade JET_DBINFOMISC. ulBadChecksumOld

Obtém o número de vezes que um erro de soma de verificação não corrigível foi encontrado antes do último reparo.
