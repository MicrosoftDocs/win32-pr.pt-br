...
ms.locfileid: "120065996"
---
# <a name="esentdbtimetoooldexception-members"></a>Membros do EsentDbTimeTooOldException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. DbTimeTooOld exceções.

O tipo [EsentDbTimeTooOldException](./esentdbtimetoooldexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentDbTimeTooOldException.</td>
</tr>
</tbody>
</table>
