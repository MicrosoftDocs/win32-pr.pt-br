...
---
# <a name="esenttaggednotnullexception-members"></a>Membros do EsentTaggedNotNULLException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. TaggedNotNULL exceções.

O tipo [EsentTaggedNotNULLException](./esenttaggednotnullexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentTaggedNotNULLException.</td>
</tr>
</tbody>
</table>
