---
description: 'Saiba mais sobre: membros do EsentDataException'
title: Membros do EsentDataException
...
ms.locfileid: "104568184"
---
# <a name="esentdataexception-members"></a>Membros do EsentDataException
...
O tipo [EsentDataException](./esentdataexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentDataException. Esse construtor é usado para desserializar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn274233(v=exchg.10).md">EsentDataException (cadeia de caracteres, JET_err)</a></td>
<td>Inicializa uma nova instância da classe EsentDataException.</td>
</tr>
</tbody>
</table>
