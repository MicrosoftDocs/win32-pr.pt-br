---
description: 'Saiba mais sobre: Membros EsentDataException'
title: Membros EsentDataException
...
ms.locfileid: "118271202"
---
# <a name="esentdataexception-members"></a>Membros EsentDataException
...
<td>Inicializa uma nova instância da classe EsentDataException. Esse construtor é usado para desserlizar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
