...
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-string-encoding"></a>Método API. SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Cadeia de caracteres, codificação)
