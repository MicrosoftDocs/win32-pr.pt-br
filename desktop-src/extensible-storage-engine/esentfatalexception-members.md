...
---
# <a name="esentfatalexception-members"></a>Membros do EsentFatalException
...
O tipo [EsentFatalException](./esentfatalexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentFatalException. Esse construtor é usado para desserializar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn274274(v=exchg.10).md">EsentFatalException (cadeia de caracteres, JET_err)</a></td>
<td>Inicializa uma nova instância da classe EsentFatalException.</td>
</tr>
</tbody>
</table>
