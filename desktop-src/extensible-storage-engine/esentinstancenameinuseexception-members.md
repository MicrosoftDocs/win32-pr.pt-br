...
---
# <a name="esentinstancenameinuseexception-members"></a>Membros do EsentInstanceNameInUseException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. InstanceNameInUse exceções.

O tipo [EsentInstanceNameInUseException](./esentinstancenameinuseexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentInstanceNameInUseException.</td>
</tr>
</tbody>
</table>
