...
Chamar **JetCreateTableColumnIndex** é idêntico a chamar [JetCreateTableColumnIndex2](./jetcreatetablecolumnindex2-function.md), com cada campo na estrutura de [JET_TABLECREATE2](./jet-tablecreate2-structure.md) que contém o valor do campo correspondente de [JET_TABLECREATE](./jet-tablecreate-structure.md), com as seguintes exceções:
  ...
  - JET_TABLECREATE2. szCallback definido como nulo
...
<td><p>Implementado como <strong>JetCreateTableColumnIndexW</strong> (Unicode) e <strong>JetCreateTableColumnIndexA</strong> (ANSI).</p></td>
</tr>
</tbody>
</table>
