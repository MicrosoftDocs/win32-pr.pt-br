...
Recupera a chave da entrada de índice na posição atual de um cursor. Consulte também [RetrieveKey (JET_SESID, JET_TABLEID, RetrieveKeyGrbit)](./api.retrievekey-method.md).
...
<!-- end list -->
  ...
  - data  
    ...
    O buffer para o qual recuperar a chave.
