...
---
# <a name="esentstateexception-members"></a>Membros do EsentStateException
...
O tipo [EsentStateException](./esentstateexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentStateException. Esse construtor é usado para desserializar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn334929(v=exchg.10).md">EsentStateException (cadeia de caracteres, JET_err)</a></td>
<td>Inicializa uma nova instância da classe EsentStateException.</td>
</tr>
</tbody>
</table>
