...
---
# <a name="esentbadlogversionexception-members"></a>Membros do EsentBadLogVersionException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. BadLogVersion exceções.

O tipo [EsentBadLogVersionException](./esentbadlogversionexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentBadLogVersionException.</td>
</tr>
</tbody>
</table>
