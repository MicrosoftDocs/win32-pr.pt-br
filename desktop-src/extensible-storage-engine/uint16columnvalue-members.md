...
---
# <a name="uint16columnvalue-members"></a>Membros do UInt16ColumnValue

Incluir membros protegidos  
Incluir membros herdados  

Um valor de coluna [UInt16](/dotnet/api/system.uint16) .

O tipo [UInt16ColumnValue](./uint16columnvalue-class.md) expõe os membros a seguir.
...
<td><a href="dn351182(v=exchg.10).md">Tamanho</a></td>
