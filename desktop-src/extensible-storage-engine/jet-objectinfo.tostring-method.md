---
description: 'Saiba mais sobre: JET_OBJECTINFO. Método ToString'
title: JET_OBJECTINFO. Método ToString
...
Retorna uma [cadeia de caracteres](/dotnet/api/system.string) que representa a [JET_OBJECTINFO](./jet-objectinfo-class.md)atual.
