...
---
# <a name="esentlogsequenceenddatabasesconsistentexception-members"></a>Membros do EsentLogSequenceEndDatabasesConsistentException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. LogSequenceEndDatabasesConsistent exceções.

O tipo [EsentLogSequenceEndDatabasesConsistentException](./esentlogsequenceenddatabasesconsistentexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentLogSequenceEndDatabasesConsistentException.</td>
</tr>
</tbody>
</table>
