...
---
# <a name="esentinvalidsystempathexception-members"></a>Membros do EsentInvalidSystemPathException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. InvalidSystemPath exceções.

O tipo [EsentInvalidSystemPathException](./esentinvalidsystempathexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentInvalidSystemPathException.</td>
</tr>
</tbody>
</table>
