...
Remove um intervalo de índice criado com [JetSetIndexRange (JET_SESID, JET_TABLEID, SetIndexRangeGrbit)](./api.jetsetindexrange-method.md) ou [TrySetIndexRange (JET_SESID, JET_TABLEID, SetIndexRangeGrbit)](./api.trysetindexrange-method.md). Se nenhum intervalo de índice estiver presente, esse método não fará nada.
...
<!-- end list -->
  ...
  - TableID  
    ...
    O cursor no qual o intervalo de índice será removido.
