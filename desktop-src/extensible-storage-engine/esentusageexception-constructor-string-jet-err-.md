...
---
# <a name="esentusageexception-constructor-string-jet_err"></a>Construtor EsentUsageException (cadeia de caracteres, JET_err)

Inicializa uma nova instância da classe EsentUsageException.
