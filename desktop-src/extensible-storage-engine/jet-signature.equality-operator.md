...
ms.locfileid: "118073426"
---
# <a name="jet_signatureequality-operator"></a>JET_SIGNATURE. Operador de igualdade

Determina se duas instâncias especificadas do JET_SIGNATURE são iguais.
