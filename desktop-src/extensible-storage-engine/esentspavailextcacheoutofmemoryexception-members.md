...
ms.locfileid: "118078762"
---
# <a name="esentspavailextcacheoutofmemoryexception-members"></a>Membros do EsentSPAvailExtCacheOutOfMemoryException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. SPAvailExtCacheOutOfMemory exceções.

O tipo [EsentSPAvailExtCacheOutOfMemoryException](./esentspavailextcacheoutofmemoryexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentSPAvailExtCacheOutOfMemoryException.</td>
</tr>
</tbody>
</table>
