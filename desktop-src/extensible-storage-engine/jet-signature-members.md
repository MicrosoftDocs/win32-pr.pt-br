---
description: 'Saiba mais sobre: membros do JET_SIGNATURE'
title: Membros do JET_SIGNATURE
...
ms.locfileid: "119833386"
---
# <a name="jet_signature-members"></a>Membros do JET_SIGNATURE

Incluir membros protegidos  
Incluir membros herdados  

A estrutura de JET_SIGNATURE contém informações que identificam exclusivamente um banco de dados ou uma sequência de logfile.

O tipo de [JET_SIGNATURE](./jet-signature-structure2.md) expõe os membros a seguir.
...
<td><a href="hh565133(v=exchg.10).md">Igualitário</a></td>
<td>Determina se duas instâncias especificadas do JET_SIGNATURE são iguais.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Operador público" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
<td><a href="hh596753(v=exchg.10).md">Desigualdade</a></td>
<td>Determina se duas instâncias especificadas do JET_SIGNATURE não são iguais.</td>
</tr>
</tbody>
</table>
