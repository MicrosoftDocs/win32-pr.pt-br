...
---
# <a name="esentindextuplesvarsegmacnotallowedexception-members"></a>Membros do EsentIndexTuplesVarSegMacNotAllowedException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. IndexTuplesVarSegMacNotAllowed exceções.

O tipo [EsentIndexTuplesVarSegMacNotAllowedException](./esentindextuplesvarsegmacnotallowedexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentIndexTuplesVarSegMacNotAllowedException.</td>
</tr>
</tbody>
</table>
