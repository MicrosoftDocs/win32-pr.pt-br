...
---
# <a name="esentdistributedtransactionnotyetpreparedtocommitexception-members"></a>Membros do EsentDistributedTransactionNotYetPreparedToCommitException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. DistributedTransactionNotYetPreparedToCommit exceções.

O tipo [EsentDistributedTransactionNotYetPreparedToCommitException](./esentdistributedtransactionnotyetpreparedtocommitexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentDistributedTransactionNotYetPreparedToCommitException.</td>
</tr>
</tbody>
</table>
