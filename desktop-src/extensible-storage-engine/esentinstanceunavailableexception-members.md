...
---
# <a name="esentinstanceunavailableexception-members"></a>Membros do EsentInstanceUnavailableException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. InstanceUnavailable exceções.

O tipo [EsentInstanceUnavailableException](./esentinstanceunavailableexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentInstanceUnavailableException.</td>
</tr>
</tbody>
</table>
