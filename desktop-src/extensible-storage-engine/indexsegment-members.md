---
description: 'Saiba mais sobre: membros do IndexSegment'
title: Membros do IndexSegment
...
ms.locfileid: "103647609"
---
# <a name="indexsegment-members"></a>Membros do IndexSegment
...
O tipo [IndexSegment](./indexsegment-class.md) expõe os membros a seguir.
...
<td>Obtém o tipo da coluna que está sendo indexada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn350918(v=exchg.10).md">ColumnName</a></td>
<td>Obtém o nome da coluna que está sendo indexada.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn350938(v=exchg.10).md">IsAscending</a></td>
<td>Obtém um valor que indica se o segmento de índice está em ordem crescente.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn350922(v=exchg.10).md">Isascii</a></td>
<td>Obtém um valor que indica se o segmento de índice está sobre uma coluna de texto ASCII. Esse valor só é significativo para segmentos de coluna de texto.</td>
</tr>
</tbody>
</table>
