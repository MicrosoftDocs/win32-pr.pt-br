---
description: 'Saiba mais sobre: membros do EsentResourceException'
title: Membros do EsentResourceException
...
ms.locfileid: "104560422"
---
# <a name="esentresourceexception-members"></a>Membros do EsentResourceException
...
O tipo [EsentResourceException](./esentresourceexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentResourceException. Esse construtor é usado para desserializar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn350558(v=exchg.10).md">EsentResourceException (cadeia de caracteres, JET_err)</a></td>
<td>Inicializa uma nova instância da classe EsentResourceException.</td>
</tr>
</tbody>
</table>
