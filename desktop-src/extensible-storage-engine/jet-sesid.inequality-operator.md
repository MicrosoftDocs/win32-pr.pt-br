...
ms.locfileid: "118979406"
---
# <a name="jet_sesidinequality-operator"></a>JET_SESID. Operador de desigualdade

Determina se duas instâncias especificadas do JET_SESID não são iguais.
