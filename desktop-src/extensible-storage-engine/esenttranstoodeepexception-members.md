---
description: 'Saiba mais sobre: membros do EsentTransTooDeepException'
title: Membros do EsentTransTooDeepException
...
ms.locfileid: "104568218"
---
# <a name="esenttranstoodeepexception-members"></a>Membros do EsentTransTooDeepException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. TransTooDeep exceções.

O tipo [EsentTransTooDeepException](./esenttranstoodeepexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentTransTooDeepException.</td>
</tr>
</tbody>
</table>
