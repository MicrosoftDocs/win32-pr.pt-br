---
description: 'Saiba mais sobre: JET_SETCOLUMN. Método ToString'
...
ms:contentKeyID: 55107681
ms.date: 07/30/2014
ms.topic: reference
f1_keywords:
- Microsoft.Isam.Esent.Interop.JET_SETCOLUMN.ToString
dev_langs:
- CSharp
- JScript
- VB
...
ms.locfileid: "105810708"
---
# <a name="jet_setcolumntostring-method"></a>JET_SETCOLUMN. Método ToString

Retorna uma [cadeia de caracteres](/dotnet/api/system.string) que representa a [JET_SETCOLUMN](./jet-setcolumn-class.md)atual.
...
Uma [cadeia de caracteres](/dotnet/api/system.string) que representa a [JET_SETCOLUMN](./jet-setcolumn-class.md)atual.  
