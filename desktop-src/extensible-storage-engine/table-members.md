...
---
# <a name="table-members"></a>Membros da tabela 
...
<td>Inicializa uma nova instância da classe da tabela. A tabela é aberta do banco de dados especificado.</td>
</tr>
</tbody>
</table>
...
<td>Libere o JET_TABLEID subjacente. (Substitui <a href="dn350545(v=exchg.10).md">EsentResource. ReleaseResource ()</a>.)</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
...
<td>Retorna uma <a href="/dotnet/api/system.string">cadeia de caracteres</a> que representa a <a href="dn351163(v=exchg.10).md">tabela</a>atual. (Substitui <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
...
<td><a href="dn351239(v=exchg.10).md">Implícito (tabela para JET_TABLEID)</a></td>
<td>Operador de conversão implícita de uma tabela para um JET_TABLEID. Isso permite que uma tabela seja usada com APIs que esperam um JET_TABLEID.</td>
</tr>
</tbody>
</table>
