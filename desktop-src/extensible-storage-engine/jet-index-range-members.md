---
description: 'Saiba mais sobre: membros do JET_INDEX_RANGE'
title: Membros de JET_INDEX_RANGE (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "119039144"
---
# <a name="jet_index_range-members"></a>Membros do JET_INDEX_RANGE

Incluir membros protegidos  
Incluir membros herdados  

Contém a definição para [JetPrereadIndexRanges (JET_SESID, JET_TABLEID, \[ \] , Int32, Int32, Int32, \[ \] , PrereadIndexRangesGrbit)](./windows8api.jetprereadindexranges-method.md).
...
<td>Obtém ou define os valores de coluna para o final do índice.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn335485(v=exchg.10).md">startColumns</a></td>
<td>Obtém ou define os valores de coluna para o início do índice.</td>
</tr>
</tbody>
</table>
