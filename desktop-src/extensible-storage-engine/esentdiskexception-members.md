---
description: 'Saiba mais sobre: membros do EsentDiskException'
title: Membros do EsentDiskException
...
ms.locfileid: "104552765"
---
# <a name="esentdiskexception-members"></a>Membros do EsentDiskException
...
O tipo [EsentDiskException](./esentdiskexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentDiskException. Esse construtor é usado para desserializar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn274282(v=exchg.10).md">EsentDiskException (cadeia de caracteres, JET_err)</a></td>
<td>Inicializa uma nova instância da classe EsentDiskException.</td>
</tr>
</tbody>
</table>
