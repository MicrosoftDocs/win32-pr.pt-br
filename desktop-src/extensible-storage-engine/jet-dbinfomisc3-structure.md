---
description: 'Saiba mais sobre: estrutura JET_DBINFOMISC3 dados'
...
ms.locfileid: "122987280"
---
# <a name="jet_dbinfomisc3-structure"></a>Estrutura JET_DBINFOMISC3
...
A **JET_DBINFOMISC3** estrutura contém informações diversas sobre um banco de dados. Essas são as informações contidas no header do banco de dados.
...
Representa a geração de log mínima necessária para repetir os logs. Normalmente, isso é o mesmo que a geração de ponto de verificação.
...
A geração de log atual. Isso pode ser menor que genMaxRequired se JET_paramWaypointLatency for diferente de zero.
