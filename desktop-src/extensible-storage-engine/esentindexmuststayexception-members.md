...
---
# <a name="esentindexmuststayexception-members"></a>Membros do EsentIndexMustStayException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. IndexMustStay exceções.

O tipo [EsentIndexMustStayException](./esentindexmuststayexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentIndexMustStayException.</td>
</tr>
</tbody>
</table>
