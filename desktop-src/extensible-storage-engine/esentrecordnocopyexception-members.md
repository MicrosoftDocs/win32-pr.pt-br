...
---
# <a name="esentrecordnocopyexception-members"></a>Membros do EsentRecordNoCopyException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. RecordNoCopy exceções.

O tipo [EsentRecordNoCopyException](./esentrecordnocopyexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentRecordNoCopyException.</td>
</tr>
</tbody>
</table>
