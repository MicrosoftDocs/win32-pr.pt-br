...
---
# <a name="esentlsnotsetexception-members"></a>Membros do EsentLSNotSetException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. LSNotSet exceções.

O tipo [EsentLSNotSetException](./esentlsnotsetexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentLSNotSetException.</td>
</tr>
</tbody>
</table>
