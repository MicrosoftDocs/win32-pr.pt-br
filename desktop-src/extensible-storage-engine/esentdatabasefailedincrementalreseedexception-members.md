...
---
# <a name="esentdatabasefailedincrementalreseedexception-members"></a>Membros do EsentDatabaseFailedIncrementalReseedException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. DatabaseFailedIncrementalReseed exceções.

O tipo [EsentDatabaseFailedIncrementalReseedException](./esentdatabasefailedincrementalreseedexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentDatabaseFailedIncrementalReseedException.</td>
</tr>
</tbody>
</table>
