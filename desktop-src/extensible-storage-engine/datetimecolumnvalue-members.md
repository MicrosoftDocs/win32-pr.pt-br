...
---
# <a name="datetimecolumnvalue-members"></a>Membros do DateTimeColumnValue
...
O tipo [DateTimeColumnValue](./datetimecolumnvalue-class.md) expõe os membros a seguir.
...
<td><a href="dn334243(v=exchg.10).md">Tamanho</a></td>
