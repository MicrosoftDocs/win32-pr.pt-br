...
ms.locfileid: "119781126"
---
# <a name="jet_bklogtimeinequality-operator"></a>JET_BKLOGTIME. Operador de desigualdade

Determina se duas instâncias especificadas do JET_BKLOGTIME não são iguais.
