---
description: 'Saiba mais sobre: ColumnValueOfStruct <T> . Método CheckDataCount'
title: ColumnValueOfStruct (T). Método CheckDataCount
...
ms.locfileid: "104170181"
---
# <a name="columnvalueofstructtcheckdatacount-method"></a>ColumnValueOfStruct \<T\> . Método CheckDataCount

Verifique se os dados recuperados são exatamente o tamanho necessário para a estrutura. Uma exceção será lançada se houver uma incompatibilidade.
...
#### <a name="parameters"></a>Parâmetros
  ...
  - count  
    ...
    O tamanho dos dados recuperados.
