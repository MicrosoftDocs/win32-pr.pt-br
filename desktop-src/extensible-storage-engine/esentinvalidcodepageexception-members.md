...
---
# <a name="esentinvalidcodepageexception-members"></a>Membros do EsentInvalidCodePageException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. InvalidCodePage exceções.

O tipo [EsentInvalidCodePageException](./esentinvalidcodepageexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentInvalidCodePageException.</td>
</tr>
</tbody>
</table>
