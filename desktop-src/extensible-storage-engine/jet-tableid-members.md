---
description: 'Saiba mais sobre: membros do JET_TABLEID'
title: Membros do JET_TABLEID
...
ms.locfileid: "119472756"
---
# <a name="jet_tableid-members"></a>Membros do JET_TABLEID

Incluir membros protegidos  
Incluir membros herdados  

Um JET_TABLEID contém um identificador para o cursor do banco de dados a ser usado para uma chamada para a API do JET. Um cursor só pode ser usado com a sessão que foi usada para abrir esse cursor.
...
<td><a href="hh596595(v=exchg.10).md">Igualitário</a></td>
