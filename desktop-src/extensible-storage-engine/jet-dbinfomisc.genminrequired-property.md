...
---
# <a name="jet_dbinfomiscgenminrequired-property"></a>Propriedade JET_DBINFOMISC. genMinRequired

Obtém a geração de log mínima necessária para repetir os logs. Normalmente, a geração do ponto de verificação.
