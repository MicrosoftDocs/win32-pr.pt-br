---
description: 'Saiba mais sobre: membros do BoolColumnValue'
title: Membros do BoolColumnValue
...
ms.locfileid: "118982856"
---
# <a name="boolcolumnvalue-members"></a>Membros do BoolColumnValue

Incluir membros protegidos  
Incluir membros herdados  

Um valor de coluna [booliana](/dotnet/api/system.boolean) .

O tipo [BoolColumnValue](./boolcolumnvalue-class.md) expõe os membros a seguir.
...
<td><a href="dn334107(v=exchg.10).md">Tamanho</a></td>
...
<td>Obtém o último conjunto ou o valor recuperado da coluna. O valor é retornado como um objeto genérico. (Substitui <a href="dn334226(v=exchg.10).md">ColumnValueOfStruct &lt; T &gt; . ValueAsObject</a>.)</td>
</tr>
</tbody>
</table>
