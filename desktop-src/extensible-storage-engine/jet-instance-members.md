...
---
# <a name="jet_instance-members"></a>Membros do JET_INSTANCE

Incluir membros protegidos  
Incluir membros herdados  

Um JET_INSTANCE contém um identificador para a instância do banco de dados a ser usado para chamadas para a API do JET.

O tipo de [JET_INSTANCE](./jet-instance-structure.md) expõe os membros a seguir.
...
<td><a href="hh578872(v=exchg.10).md">Apostar</a></td>
<td>Obtém um JET_INSTANCE nulo.</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Método público" alt="Public method" /></td>
<td><a href="hh578011(v=exchg.10).md">ToString (cadeia de caracteres, IFormatProvider)</a></td>
...
<td><a href="hh564998(v=exchg.10).md">Igualitário</a></td>
<td>Determina se duas instâncias especificadas do JET_INSTANCE são iguais.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Operador público" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
<td><a href="hh557678(v=exchg.10).md">Desigualdade</a></td>
<td>Determina se duas instâncias especificadas do JET_INSTANCE não são iguais.</td>
</tr>
</tbody>
</table>
