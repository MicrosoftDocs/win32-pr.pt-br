...
| <p><strong>Unicode</strong></p> | <p>Implementado como <strong>JetSetCurrentIndexW</strong> (Unicode) e <strong>JetSetCurrentIndexA</strong> (ANSI).</p> | 
