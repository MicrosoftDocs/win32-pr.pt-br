...
ms.locfileid: "118983206"
---
# <a name="apijetrollback-method"></a>Método Api.JetRollback

Desfaz as alterações feitas no estado do banco de dados e retorna para o último ponto de salvar. JetRollback também fechará todos os cursores abertos durante o ponto de salvar. Se o ponto de salvar mais externo for desfeito, a sessão sairá da transação.
...
#### <a name="parameters"></a>Parâmetros
  ...
  - sesid  
    ...
    A sessão para a que reverter a transação.
