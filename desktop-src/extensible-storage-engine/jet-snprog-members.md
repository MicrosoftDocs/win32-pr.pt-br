---
description: 'Saiba mais sobre: membros do JET_SNPROG'
title: Membros do JET_SNPROG
...
ms.locfileid: "104501309"
---
# <a name="jet_snprog-members"></a>Membros do JET_SNPROG

Incluir membros protegidos  
Incluir membros herdados  

Contém informações sobre o progresso de uma operação de execução longa.

O tipo de [JET_SNPROG](./jet-snprog-class.md) expõe os membros a seguir.
...
<td>Obtém o número de unidades de trabalho que já foram concluídas durante a operação de execução demorada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn351094(v=exchg.10).md">cunitTotal</a></td>
<td>Obtém o número de unidades de trabalho que precisam ser concluídas. Esse valor sempre será maior ou igual a cunitDone.</td>
</tr>
</tbody>
</table>
