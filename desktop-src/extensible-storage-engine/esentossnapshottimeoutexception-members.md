...
---
# <a name="esentossnapshottimeoutexception-members"></a>Membros do EsentOSSnapshotTimeOutException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. OSSnapshotTimeOut exceções.

O tipo [EsentOSSnapshotTimeOutException](./esentossnapshottimeoutexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentOSSnapshotTimeOutException.</td>
</tr>
</tbody>
</table>
