...
---
# <a name="esentossnapshotnotallowedexception-members"></a>Membros do EsentOSSnapshotNotAllowedException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. OSSnapshotNotAllowed exceções.

O tipo [EsentOSSnapshotNotAllowedException](./esentossnapshotnotallowedexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentOSSnapshotNotAllowedException.</td>
</tr>
</tbody>
</table>
