...
---
# <a name="esentsqllinknotsupportedexception-members"></a>Membros do EsentSQLLinkNotSupportedException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. SQLLinkNotSupported exceções.

O tipo [EsentSQLLinkNotSupportedException](./esentsqllinknotsupportedexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentSQLLinkNotSupportedException.</td>
</tr>
</tbody>
</table>
