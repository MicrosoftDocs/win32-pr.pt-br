---
description: 'Saiba mais sobre: membros do JET_OSSNAPID'
title: Membros do JET_OSSNAPID
...
ms.locfileid: "104571729"
---
# <a name="jet_ossnapid-members"></a>Membros do JET_OSSNAPID

Incluir membros protegidos  
Incluir membros herdados  

Um JET_OSSNAPID contém um identificador para um instantâneo de um banco de dados.
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Método público" alt="Public method" /></td>
<td><a href="hh557619(v=exchg.10).md">ToString (cadeia de caracteres, IFormatProvider)</a></td>
...
<td><a href="hh579206(v=exchg.10).md">Igualitário</a></td>
<td>Determina se duas instâncias especificadas do JET_OSSNAPID são iguais.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Operador público" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
<td><a href="hh557443(v=exchg.10).md">Desigualdade</a></td>
<td>Determina se duas instâncias especificadas do JET_OSSNAPID não são iguais.</td>
</tr>
</tbody>
</table>
