---
description: 'Saiba mais sobre: método ColumnInfo. ToString'
title: Método ColumnInfo. ToString
...
ms.locfileid: "105798072"
---
# <a name="columninfotostring-method"></a>Método ColumnInfo. ToString

Retorna uma [cadeia de caracteres](/dotnet/api/system.string) que representa o [ColumnInfo](./columninfo-class.md)atual.
...
Uma [cadeia de caracteres](/dotnet/api/system.string) que representa o [ColumnInfo](./columninfo-class.md)atual.  
