---
description: 'Saiba mais sobre a propriedade: Instanceparameters. MaxOpenTables'
title: Propriedade instanceparameters. MaxOpenTables
...
Obtém ou define o número de recursos da árvore B + reservados para esta instância.
