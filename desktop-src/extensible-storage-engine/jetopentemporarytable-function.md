...
| <p>JET_errInvalidColumnType</p> | <p>O <strong>membro coltyp</strong> do <a href="gg294130(v=exchg.10).md">JET_COLUMNDEF</a> não foi definido como um tipo de coluna válido.</p> | 
