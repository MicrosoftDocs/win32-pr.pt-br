---
description: 'Saiba mais sobre: membros do JET_LS'
title: Membros do JET_LS
...
ms.locfileid: "104170561"
---
# <a name="jet_ls-members"></a>Membros do JET_LS

Incluir membros protegidos  
Incluir membros herdados  

Armazenamento local para um identificador de ESENT. Usado por [JetGetLS (JET_SESID, JET_TABLEID, JET_LS, LsGrbit)](./api.jetgetls-method.md) e [JetSetLS (JET_SESID, JET_TABLEID, JET_LS, LsGrbit)](./api.jetsetls-method.md).
...
<td>Obtém ou define o valor do identificador.</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Método público" alt="Public method" /></td>
<td><a href="hh557697(v=exchg.10).md">ToString (cadeia de caracteres, IFormatProvider)</a></td>
...
<td><a href="hh566276(v=exchg.10).md">Igualitário</a></td>
<td>Determina se duas instâncias especificadas do JET_LS são iguais.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Operador público" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
<td><a href="hh578707(v=exchg.10).md">Desigualdade</a></td>
<td>Determina se duas instâncias especificadas do JET_LS não são iguais.</td>
</tr>
</tbody>
</table>
