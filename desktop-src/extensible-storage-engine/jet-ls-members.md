---
description: 'Saiba mais sobre: JET_LS membros'
title: JET_LS membros
...
ms.locfileid: "120016996"
---
# <a name="jet_ls-members"></a>JET_LS membros
...
O [JET_LS](./jet-ls-structure.md) tipo expõe os membros a seguir.
...
<td>Obtém ou define o valor do alça.</td>
</tr>
</tbody>
</table>
...
<td>Determina se duas instâncias especificadas de JET_LS são iguais.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Operador público" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
