...
---
# <a name="esentquerynotsupportedexception-members"></a>Membros do EsentQueryNotSupportedException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. QueryNotSupported exceções.

O tipo [EsentQueryNotSupportedException](./esentquerynotsupportedexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentQueryNotSupportedException.</td>
</tr>
</tbody>
</table>
