---
description: 'Saiba mais sobre: Membros EsentKeyIs BluetoothException'
title: Membros EsentKeyIsOseException
...
ms.locfileid: "119837136"
---
# <a name="esentkeyismadeexception-members"></a>Membros EsentKeyIsOseException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. Exceções KeyIs Além.

O [tipo EsentKeyIsRiaException](./esentkeyismadeexception-class.md) expõe os membros a seguir.
...
<td><a href="dn334551(v=exchg.10).md">EsentKeyIsRiaException</a></td>
<td>Inicializa uma nova instância da classe EsentKeyIsOseException.</td>
</tr>
</tbody>
</table>
...
[Classe EsentKeyIsOseException](./esentkeyismadeexception-class.md)
