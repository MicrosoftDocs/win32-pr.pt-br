---
description: 'Saiba mais sobre: Membros EsentIOException'
title: Membros EsentIOException
...
ms.locfileid: "119971986"
---
# <a name="esentioexception-members"></a>Membros EsentIOException
...
<td>Inicializa uma nova instância da classe EsentIOException. Esse construtor é usado para desserlizar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
