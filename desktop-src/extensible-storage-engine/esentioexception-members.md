---
description: 'Saiba mais sobre: membros do EsentIOException'
title: Membros do EsentIOException
...
ms.locfileid: "103836928"
---
# <a name="esentioexception-members"></a>Membros do EsentIOException
...
O tipo [EsentIOException](./esentioexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentIOException. Esse construtor é usado para desserializar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn319596(v=exchg.10).md">EsentIOException (cadeia de caracteres, JET_err)</a></td>
<td>Inicializa uma nova instância da classe EsentIOException.</td>
</tr>
</tbody>
</table>
