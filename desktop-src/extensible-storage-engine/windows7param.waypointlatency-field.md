---
description: 'Saiba mais sobre: campo Windows7Param. WaypointLatency'
...
ms.locfileid: "104296512"
---
# <a name="windows7paramwaypointlatency-field"></a>Campo Windows7Param. WaypointLatency

Esse parâmetro define o número de logs para os quais o ESENT adiará a liberação do banco de dados. Isso pode ser usado para aumentar a capacidade de recuperação do banco de dados se as falhas causarem a perda de arquivos de log.
...
[Membros do Windows7Param](./windows7param-members.md)
