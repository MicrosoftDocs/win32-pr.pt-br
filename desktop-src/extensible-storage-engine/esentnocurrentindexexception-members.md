...
---
# <a name="esentnocurrentindexexception-members"></a>Membros do EsentNoCurrentIndexException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. NoCurrentIndex exceções.

O tipo [EsentNoCurrentIndexException](./esentnocurrentindexexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentNoCurrentIndexException.</td>
</tr>
</tbody>
</table>
