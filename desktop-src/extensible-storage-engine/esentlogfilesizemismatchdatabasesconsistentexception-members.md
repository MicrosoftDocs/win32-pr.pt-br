...
---
# <a name="esentlogfilesizemismatchdatabasesconsistentexception-members"></a>Membros do EsentLogFileSizeMismatchDatabasesConsistentException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. LogFileSizeMismatchDatabasesConsistent exceções.

O tipo [EsentLogFileSizeMismatchDatabasesConsistentException](./esentlogfilesizemismatchdatabasesconsistentexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentLogFileSizeMismatchDatabasesConsistentException.</td>
</tr>
</tbody>
</table>
