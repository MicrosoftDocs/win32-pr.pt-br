...
ms.locfileid: "120019946"
---
# <a name="esentlogwritefailexception-members"></a>Membros do EsentLogWriteFailException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. LogWriteFail exceções.

O tipo [EsentLogWriteFailException](./esentlogwritefailexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentLogWriteFailException.</td>
</tr>
</tbody>
</table>
