...
<!-- end list -->
  ...
  - statusCallback  
    ...
    Uma função de retorno de chamada que pode ser chamada periodicamente por meio da operação compacta do banco de dados para relatar o progresso.
