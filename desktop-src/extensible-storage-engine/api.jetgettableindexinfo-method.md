---
description: 'Saiba mais sobre: método API. JetGetTableIndexInfo'
title: Método API. JetGetTableIndexInfo
...
ms.locfileid: "104090904"
---
# <a name="apijetgettableindexinfo-method"></a>Método API. JetGetTableIndexInfo
