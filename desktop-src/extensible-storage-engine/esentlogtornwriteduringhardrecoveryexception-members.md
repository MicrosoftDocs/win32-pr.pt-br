...
ms.locfileid: "118080480"
---
# <a name="esentlogtornwriteduringhardrecoveryexception-members"></a>Membros do EsentLogTornWriteDuringHardRecoveryException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. LogTornWriteDuringHardRecovery exceções.

O tipo [EsentLogTornWriteDuringHardRecoveryException](./esentlogtornwriteduringhardrecoveryexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentLogTornWriteDuringHardRecoveryException.</td>
</tr>
</tbody>
</table>
