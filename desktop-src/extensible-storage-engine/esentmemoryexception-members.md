---
description: 'Saiba mais sobre: membros do EsentMemoryException'
title: Membros do EsentMemoryException
...
ms.locfileid: "104502447"
---
# <a name="esentmemoryexception-members"></a>Membros do EsentMemoryException
...
O tipo [EsentMemoryException](./esentmemoryexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentMemoryException. Esse construtor é usado para desserializar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn334638(v=exchg.10).md">EsentMemoryException (cadeia de caracteres, JET_err)</a></td>
<td>Inicializa uma nova instância da classe EsentMemoryException.</td>
</tr>
</tbody>
</table>
