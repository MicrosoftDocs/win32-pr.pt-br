---
description: 'Saiba mais sobre: Membros EsentMemoryException'
title: Membros EsentMemoryException
...
ms.locfileid: "119115596"
---
# <a name="esentmemoryexception-members"></a>Membros EsentMemoryException
...
<td>Inicializa uma nova instância da classe EsentMemoryException. Esse construtor é usado para desserlizar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
