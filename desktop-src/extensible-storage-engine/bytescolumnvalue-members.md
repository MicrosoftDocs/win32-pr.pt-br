...
---
# <a name="bytescolumnvalue-members"></a>Membros do BytesColumnValue

Incluir membros protegidos  
Incluir membros herdados  

Um valor de coluna de matriz de bytes.
...
<td>Retorna uma <a href="/dotnet/api/system.string">cadeia de caracteres</a> que representa o <a href="dn334170(v=exchg.10).md">BytesColumnValue</a>atual. (Substitui <a href="dn334163(v=exchg.10).md">columnvalue. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
