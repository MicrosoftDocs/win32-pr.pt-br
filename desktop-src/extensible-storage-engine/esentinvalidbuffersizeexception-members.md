...
---
# <a name="esentinvalidbuffersizeexception-members"></a>Membros do EsentInvalidBufferSizeException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. InvalidBufferSize exceções.

O tipo [EsentInvalidBufferSizeException](./esentinvalidbuffersizeexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentInvalidBufferSizeException.</td>
</tr>
</tbody>
</table>
