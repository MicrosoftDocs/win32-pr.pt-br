...
---
# <a name="esentdatabasebufferdependenciescorruptedexception-members"></a>Membros do EsentDatabaseBufferDependenciesCorruptedException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. DatabaseBufferDependenciesCorrupted exceções.

O tipo [EsentDatabaseBufferDependenciesCorruptedException](./esentdatabasebufferdependenciescorruptedexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentDatabaseBufferDependenciesCorruptedException.</td>
</tr>
</tbody>
</table>
