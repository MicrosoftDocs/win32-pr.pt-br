...
ms.locfileid: "117902372"
---
# <a name="apimovebeforefirst-method"></a>Método Api.MoveBeforeFirst

Posiciona o cursor antes do primeiro registro na tabela. Uma próxima movimentação posicionará o cursor no primeiro registro.
