---
description: 'Saiba mais sobre: membros do EsentFragmentationException'
title: Membros do EsentFragmentationException
...
ms.locfileid: "104164685"
---
# <a name="esentfragmentationexception-members"></a>Membros do EsentFragmentationException
...
O tipo [EsentFragmentationException](./esentfragmentationexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentFragmentationException. Esse construtor é usado para desserializar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn350469(v=exchg.10).md">EsentFragmentationException (cadeia de caracteres, JET_err)</a></td>
<td>Inicializa uma nova instância da classe EsentFragmentationException.</td>
</tr>
</tbody>
</table>
