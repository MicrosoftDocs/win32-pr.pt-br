...
---
# <a name="esentinvalidlogdirectoryexception-members"></a>Membros do EsentInvalidLogDirectoryException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. InvalidLogDirectory exceções.

O tipo [EsentInvalidLogDirectoryException](./esentinvalidlogdirectoryexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentInvalidLogDirectoryException.</td>
</tr>
</tbody>
</table>
