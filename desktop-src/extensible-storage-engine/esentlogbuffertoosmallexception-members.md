...
---
# <a name="esentlogbuffertoosmallexception-members"></a>Membros do EsentLogBufferTooSmallException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. LogBufferTooSmall exceções.

O tipo [EsentLogBufferTooSmallException](./esentlogbuffertoosmallexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentLogBufferTooSmallException.</td>
</tr>
</tbody>
</table>
