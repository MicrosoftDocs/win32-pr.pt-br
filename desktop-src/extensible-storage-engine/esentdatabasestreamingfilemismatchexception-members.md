...
---
# <a name="esentdatabasestreamingfilemismatchexception-members"></a>Membros do EsentDatabaseStreamingFileMismatchException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. DatabaseStreamingFileMismatch exceções.

O tipo [EsentDatabaseStreamingFileMismatchException](./esentdatabasestreamingfilemismatchexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentDatabaseStreamingFileMismatchException.</td>
</tr>
</tbody>
</table>
