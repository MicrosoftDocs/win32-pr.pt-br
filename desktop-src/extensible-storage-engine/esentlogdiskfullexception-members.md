...
---
# <a name="esentlogdiskfullexception-members"></a>Membros do EsentLogDiskFullException
...
O tipo [EsentLogDiskFullException](./esentlogdiskfullexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentLogDiskFullException.</td>
</tr>
</tbody>
</table>
