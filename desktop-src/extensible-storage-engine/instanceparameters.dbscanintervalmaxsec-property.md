...
---
# <a name="instanceparametersdbscanintervalmaxsec-property"></a>Propriedade instanceparameters. DbScanIntervalMaxSec

Obtém ou define o intervalo máximo para que a verificação do banco de dados seja concluída, em segundos.
