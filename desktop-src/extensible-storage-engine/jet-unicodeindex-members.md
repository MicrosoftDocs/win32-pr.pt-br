---
description: 'Saiba mais sobre: membros do JET_UNICODEINDEX'
title: Membros do JET_UNICODEINDEX
...
ms.locfileid: "119945526"
---
# <a name="jet_unicodeindex-members"></a>Membros do JET_UNICODEINDEX
...
O tipo de [JET_UNICODEINDEX](./jet-unicodeindex-class.md) expõe os membros a seguir.
...
<td>Obtém ou define os sinalizadores a serem usados com LCMapString ao normalizar dados Unicode.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn351144(v=exchg.10).md">lcid</a></td>
<td>Obtém ou define o LCID a ser usado ao normalizar dados Unicode.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn351147(v=exchg.10).md">szLocaleName</a></td>
<td>Obtém ou define o Localename a ser usado ao normalizar dados Unicode.</td>
</tr>
</tbody>
</table>
...
<td>Como solução alternativa para sistemas que não têm suporte a LCID, converteremos um número muito limitado de LCIDs em nomes de localidade.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Método público" alt="Public method" /></td>
