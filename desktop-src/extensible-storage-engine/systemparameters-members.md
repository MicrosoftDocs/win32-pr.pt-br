...
---
# <a name="systemparameters-members"></a>Membros do SystemParameters

Incluir membros protegidos  
Incluir membros herdados  

Constantes para a API ESENT. Eles não precisam ser pesquisados por meio de parâmetros do sistema. Essa classe fornece propriedades estáticas para definir e obter parâmetros de sistema ESENT globais. Essa classe fornece propriedades estáticas para definir e obter parâmetros de sistema ESENT globais.
...
<td>O comprimento do prefixo usado para nomear arquivos usados pelo mecanismo de banco de dados.</td>
</tr>
<tr class="even">
<td><img src="../images/hh596466.pubfield(exchg.10).gif" title="Campo público" alt="Public field" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
...
<td>Número máximo de colunas fixas permitidas em uma tabela.</td>
</tr>
<tr class="even">
<td><img src="../images/hh596466.pubfield(exchg.10).gif" title="Campo público" alt="Public field" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
<td><a href="dn351140(v=exchg.10).md">ColumnsMost</a></td>
<td>Número máximo de colunas permitidas em uma tabela.</td>
</tr>
<tr class="odd">
<td><img src="../images/hh596466.pubfield(exchg.10).gif" title="Campo público" alt="Public field" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
<td><a href="dn351148(v=exchg.10).md">ColumnsTaggedMost</a></td>
<td>Número máximo de colunas marcadas permitidas em uma tabela.</td>
</tr>
<tr class="even">
<td><img src="../images/hh596466.pubfield(exchg.10).gif" title="Campo público" alt="Public field" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
...
<td>Tamanho máximo de um nome de tabela/coluna/índice.</td>
</tr>
<tr class="odd">
<td><img src="../images/hh596466.pubfield(exchg.10).gif" title="Campo público" alt="Public field" /><img src="../images/dn292146.static(exchg.10).gif" title="Membro estático" alt="Static member" /></td>
<td><a href="dn351211(v=exchg.10).md">PageTempDBSmallest</a></td>
<td>O número de páginas que fornece o menor banco de dados temporário possível.</td>
</tr>
</tbody>
</table>
