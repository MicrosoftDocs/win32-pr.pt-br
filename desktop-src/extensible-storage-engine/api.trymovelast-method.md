...
ms.locfileid: "119947696"
---
# <a name="apitrymovelast-method"></a>Método API. TryMoveLast

Tente mover para o último registro na tabela. Se a tabela estiver vazia, isso retornará false, se um erro diferente for encontrado, uma exceção será lançada.
