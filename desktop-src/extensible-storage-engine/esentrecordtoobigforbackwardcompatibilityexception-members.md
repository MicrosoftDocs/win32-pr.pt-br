...
---
# <a name="esentrecordtoobigforbackwardcompatibilityexception-members"></a>Membros do EsentRecordTooBigForBackwardCompatibilityException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. RecordTooBigForBackwardCompatibility exceções.

O tipo [EsentRecordTooBigForBackwardCompatibilityException](./esentrecordtoobigforbackwardcompatibilityexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentRecordTooBigForBackwardCompatibilityException.</td>
</tr>
</tbody>
</table>
