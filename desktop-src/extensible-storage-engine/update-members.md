---
description: 'Saiba mais sobre: atualizar Membros'
title: 'Membros da atualização '
...
ms.locfileid: "118978266"
---
# <a name="update-members"></a>Membros da atualização 

Incluir membros protegidos  
Incluir membros herdados  

Uma classe que encapsula uma atualização em um JET_TABLEID.
...
<td><a href="dn351261(v=exchg.10).md">Atualização</a></td>
<td>Inicializa uma nova instância da classe Update. Isso inicia automaticamente uma atualização. A atualização será cancelada se não for salva explicitamente.</td>
</tr>
</tbody>
</table>
