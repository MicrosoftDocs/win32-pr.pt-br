...
---
# <a name="esentmultivaluedduplicateaftertruncationexception-members"></a>Membros do EsentMultiValuedDuplicateAfterTruncationException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. MultiValuedDuplicateAfterTruncation exceções.

O tipo [EsentMultiValuedDuplicateAfterTruncationException](./esentmultivaluedduplicateaftertruncationexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentMultiValuedDuplicateAfterTruncationException.</td>
</tr>
</tbody>
</table>
