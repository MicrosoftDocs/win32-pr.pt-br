...
---
# <a name="bytecolumnvalue-members"></a>Membros do ByteColumnValue

Incluir membros protegidos  
Incluir membros herdados  

Um valor de coluna de [byte](/dotnet/api/system.byte) .

O tipo [ByteColumnValue](./bytecolumnvalue-class.md) expõe os membros a seguir.
...
<td><a href="dn334116(v=exchg.10).md">Tamanho</a></td>
