...
---
# <a name="esentfileiosparseexception-members"></a>Membros do EsentFileIOSparseException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. FileIOSparse exceções.

O tipo [EsentFileIOSparseException](./esentfileiosparseexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentFileIOSparseException.</td>
</tr>
</tbody>
</table>
