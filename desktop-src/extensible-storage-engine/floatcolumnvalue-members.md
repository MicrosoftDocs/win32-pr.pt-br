...
---
# <a name="floatcolumnvalue-members"></a>Membros do FloatColumnValue

Incluir membros protegidos  
Incluir membros herdados  

Um valor de coluna [única](/dotnet/api/system.single) .
...
<td><a href="dn350901(v=exchg.10).md">Tamanho</a></td>
