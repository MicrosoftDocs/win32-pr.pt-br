...
| <p><strong>Unicode</strong></p> | <p>Implementado como <strong>JetCreateDatabaseW</strong> (Unicode) e <strong>JetCreateDatabaseA</strong> (ANSI).</p> | 
