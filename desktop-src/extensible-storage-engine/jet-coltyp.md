...
| <p>JET_coltypLongText<br />12</p> | <p>Um comprimento fixo ou variável, coluna de texto que pode ter até 2147483647 caracteres ASCII de comprimento ou 1073741823 caracteres Unicode de comprimento. Esse tipo é considerado um Valor Longo. Um Valor Longo é especial porque pode ser grande e porque pode ser acessado como um fluxo. Esse tipo é idêntico ao JET_coltypText.</p> | 
...
| <p>JET_coltypMax<br />18</p> | <p>Uma constante que descreve o tipo de coluna máximo (ou seja, um além do maior válido) com suporte pelo mecanismo.</p><p>Esse valor deve ser usado com cuidado, pois ele será alterado à medida que novos tipos de coluna são suportados. Por exemplo, ele tem um valor literal diferente Windows 2000 do que em versões Windows XP e posteriores.</p> | 
