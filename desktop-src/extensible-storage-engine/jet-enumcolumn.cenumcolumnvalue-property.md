---
description: 'Saiba mais sobre a propriedade: JET_ENUMCOLUMN. cEnumColumnValue'
title: Propriedade JET_ENUMCOLUMN. cEnumColumnValue
...
ms.locfileid: "103646743"
---
# <a name="jet_enumcolumncenumcolumnvalue-property"></a>Propriedade JET_ENUMCOLUMN. cEnumColumnValue

Obtém o número de valores de coluna enumerados para a coluna. Esse membro só será usado se [Err](./jet-enumcolumn.err-property.md) não for [ColumnSingleValue](./jet-wrn-enumeration.md).
