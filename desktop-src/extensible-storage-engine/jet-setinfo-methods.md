---
description: 'Saiba mais sobre: métodos de JET_SETINFO'
title: Métodos de JET_SETINFO
...
ms.locfileid: "119729516"
---
# <a name="jet_setinfo-methods"></a>Métodos de JET_SETINFO

Incluir membros protegidos  
Incluir membros herdados  

O tipo de [JET_SETINFO](./jet-setinfo-class.md) expõe os membros a seguir.
...
<td>Retorna uma <a href="/dotnet/api/system.string">cadeia de caracteres</a> que representa a <a href="dn351059(v=exchg.10).md">JET_SETINFO</a>atual. (Substitui <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
