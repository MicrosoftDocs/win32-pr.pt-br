...
---
# <a name="jet_dbinfomisclgposconsistent-property"></a>Propriedade JET_DBINFOMISC. lgposConsistent

Obtém o LGPOs quando o banco de dados tornou-se consistente. Esse valor será nulo se o banco de dados estiver inconsistente.
