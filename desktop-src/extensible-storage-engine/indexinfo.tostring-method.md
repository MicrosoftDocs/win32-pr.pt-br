---
description: 'Saiba mais sobre: método IndexInfo. ToString'
...
ms.locfileid: "104164789"
---
# <a name="indexinfotostring-method"></a>Método IndexInfo. ToString

Retorna uma [cadeia de caracteres](/dotnet/api/system.string) que representa o [IndexInfo](./indexinfo-class.md)atual.
...
Uma [cadeia de caracteres](/dotnet/api/system.string) que representa o [IndexInfo](./indexinfo-class.md)atual.  
