...
---
# <a name="esentdatabasealreadyrunningmaintenanceexception-members"></a>Membros do EsentDatabaseAlreadyRunningMaintenanceException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. DatabaseAlreadyRunningMaintenance exceções.

O tipo [EsentDatabaseAlreadyRunningMaintenanceException](./esentdatabasealreadyrunningmaintenanceexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentDatabaseAlreadyRunningMaintenanceException.</td>
</tr>
</tbody>
</table>
