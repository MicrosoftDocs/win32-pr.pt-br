...
---
# <a name="esentdistributedtransactionalreadypreparedtocommitexception-members"></a>Membros do EsentDistributedTransactionAlreadyPreparedToCommitException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. DistributedTransactionAlreadyPreparedToCommit exceções.

O tipo [EsentDistributedTransactionAlreadyPreparedToCommitException](./esentdistributedtransactionalreadypreparedtocommitexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentDistributedTransactionAlreadyPreparedToCommitException.</td>
</tr>
</tbody>
</table>
