...
ms.locfileid: "117713947"
---
# <a name="esentcolumninuseexception-members"></a>Membros do EsentColumnInUseException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. ColumnInUse exceções.

O tipo [EsentColumnInUseException](./esentcolumninuseexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentColumnInUseException.</td>
</tr>
</tbody>
</table>
