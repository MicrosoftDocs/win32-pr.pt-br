---
description: 'Saiba mais sobre: método API. JetGetTableColumnInfo'
title: Método API. JetGetTableColumnInfo
...
ms.locfileid: "104171228"
---
# <a name="apijetgettablecolumninfo-method"></a>Método API. JetGetTableColumnInfo
