...
---
# <a name="systemparametersenablefilecache-property"></a>Propriedade SystemParameters. EnableFileCache

Obtém ou define um valor que indica se o mecanismo de banco de dados deve usar o cache de arquivos do so para todos os arquivos gerenciados.
