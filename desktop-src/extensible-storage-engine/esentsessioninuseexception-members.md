...
---
# <a name="esentsessioninuseexception-members"></a>Membros do EsentSessionInUseException
...
O tipo [EsentSessionInUseException](./esentsessioninuseexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentSessionInUseException.</td>
</tr>
</tbody>
</table>
