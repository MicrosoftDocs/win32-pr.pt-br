...
---
# <a name="esentloggenerationmismatchexception-members"></a>Membros do EsentLogGenerationMismatchException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. LogGenerationMismatch exceções.

O tipo [EsentLogGenerationMismatchException](./esentloggenerationmismatchexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentLogGenerationMismatchException.</td>
</tr>
</tbody>
</table>
