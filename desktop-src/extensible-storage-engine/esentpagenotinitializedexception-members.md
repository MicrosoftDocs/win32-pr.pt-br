...
---
# <a name="esentpagenotinitializedexception-members"></a>Membros do EsentPageNotInitializedException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. PageNotInitialized exceções.

O tipo [EsentPageNotInitializedException](./esentpagenotinitializedexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentPageNotInitializedException.</td>
</tr>
</tbody>
</table>
