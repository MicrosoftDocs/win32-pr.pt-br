...
---
# <a name="esentfatalexception-constructor-serializationinfo-streamingcontext"></a>Construtor EsentFatalException (SerializationInfo, StreamingContext)

Inicializa uma nova instância da classe EsentFatalException. Esse construtor é usado para desserializar uma exceção serializada.
