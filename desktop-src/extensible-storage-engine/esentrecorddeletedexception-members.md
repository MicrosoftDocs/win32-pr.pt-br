...
---
# <a name="esentrecorddeletedexception-members"></a>Membros do EsentRecordDeletedException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. RecordDeleted exceções.

O tipo [EsentRecordDeletedException](./esentrecorddeletedexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentRecordDeletedException.</td>
</tr>
</tbody>
</table>
