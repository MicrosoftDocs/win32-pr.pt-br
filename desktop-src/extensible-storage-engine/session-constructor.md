---
description: 'Saiba mais sobre: Construtor de sessão'
title: Construtor de sessão
...
ms.locfileid: "117702885"
---
# <a name="session-constructor"></a>Construtor de sessão

Inicializa uma nova instância da classe de sessão. Uma nova JET_SESSION é alocada a partir da instância especificada.
...
#### <a name="parameters"></a>Parâmetros
  ...
  - instance  
    ...
    A instância na qual iniciar a sessão.
