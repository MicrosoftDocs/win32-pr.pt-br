---
description: 'Saiba mais sobre a propriedade: JET_TABLECREATE. pSeqSpacehints'
title: Propriedade JET_TABLECREATE. pSeqSpacehints
...
Obtém ou define as dicas de alocação, manutenção e uso de espaço para o índice sequencial padrão.
