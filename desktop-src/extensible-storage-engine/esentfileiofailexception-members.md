...
---
# <a name="esentfileiofailexception-members"></a>Membros do EsentFileIOFailException
...
O tipo [EsentFileIOFailException](./esentfileiofailexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentFileIOFailException.</td>
</tr>
</tbody>
</table>
