...
Recupera um valor de coluna UInt16 do registro atual. O registro é aquele associado à entrada de índice na posição atual do cursor.
...
Os dados recuperados da coluna como UInt16. NULL se a coluna for nula.  
