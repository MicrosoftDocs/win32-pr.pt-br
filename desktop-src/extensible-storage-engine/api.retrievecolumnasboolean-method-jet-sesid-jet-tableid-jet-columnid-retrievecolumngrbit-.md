...
Recupera um valor de coluna booliana do registro atual. O registro é aquele associado à entrada de índice na posição atual do cursor.
...
Os dados recuperados da coluna como um booliano. NULL se a coluna for nula.  
...
[Sobrecarga de RetrieveColumnAsBoolean](./api.retrievecolumnasboolean-method.md)
