...
| <p><strong>Unicode</strong></p> | <p>Implementado como <strong>JetAttachDatabase2W</strong> (Unicode) e <strong>JetAttachDatabase2A</strong> (ANSI).</p> | 
