...
ms.locfileid: "118983086"
---
# <a name="apijetterm2-method"></a>Método Api.JetTerm2

Encente uma instância que foi criada com [JetInit(JET_INSTANCE)](./api.jetinit-method.md) ou [JetCreateInstance(JET_INSTANCE, String).](./api.jetcreateinstance-method.md)
