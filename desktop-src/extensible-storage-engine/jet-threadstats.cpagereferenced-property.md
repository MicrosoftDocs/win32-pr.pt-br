---
description: 'Saiba mais sobre: JET_THREADSTATS.cPageReferenced'
...
ms.locfileid: "120115796"
---
# <a name="jet_threadstatscpagereferenced-property"></a>JET_THREADSTATS.cPageReferenced

Obtém o número total de páginas de banco de dados visitadas pelo mecanismo de banco de dados no thread atual.
