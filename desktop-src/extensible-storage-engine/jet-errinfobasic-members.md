---
description: 'Saiba mais sobre: membros do JET_ERRINFOBASIC'
title: Membros de JET_ERRINFOBASIC (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "104560890"
---
# <a name="jet_errinfobasic-members"></a>Membros do JET_ERRINFOBASIC

Incluir membros protegidos  
Incluir membros herdados  

Contém as informações sobre um erro.
...
<td>Inicializa uma nova instância da classe JET_ERRINFOBASIC.</td>
</tr>
</tbody>
</table>
...
<td>Obtém ou define a categoria do erro.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
...
<td>Obtém ou define a linha do arquivo de origem para o nível de informações solicitado.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn335345(v=exchg.10).md">rgCategoricalHierarchy</a></td>
<td>Obtém ou define a hierarquia de erros. A posição 0 é o nível mais alto na hierarquia e o restante é JET_errcatUnknown.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn335474(v=exchg.10).md">rgszSourceFile</a></td>
<td>Obtém ou define o nome do arquivo de origem para o nível de informações solicitado.</td>
</tr>
</tbody>
</table>
