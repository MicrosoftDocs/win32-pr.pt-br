---
description: 'Saiba mais sobre a propriedade: JET_TABLECREATE. pLVSpacehints'
title: Propriedade JET_TABLECREATE. pLVSpacehints
...
ms.locfileid: "105751969"
---
# <a name="jet_tablecreateplvspacehints-property"></a>Propriedade JET_TABLECREATE. pLVSpacehints

Obtém ou define as dicas de alocação, manutenção e uso de espaço para a árvore LV separada, do tipo [JET_SPACEHINTS](./jet-spacehints-class.md).
