...
---
# <a name="esenttoomanyopendatabasesexception-members"></a>Membros do EsentTooManyOpenDatabasesException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. TooManyOpenDatabases exceções.

O tipo [EsentTooManyOpenDatabasesException](./esenttoomanyopendatabasesexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentTooManyOpenDatabasesException.</td>
</tr>
</tbody>
</table>
