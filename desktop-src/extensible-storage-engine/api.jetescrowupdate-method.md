...
<!-- end list -->
  ...
  - columnid  
    ...
    A coluna a ser atualizada. Deve ser uma coluna atualizável de caução.
...
<!-- end list -->
  ...
  - actualPreviousValueLength  
    ...
    Retorna o tamanho real do anteriorvalue.
...
<!-- end list -->
  ...
  - grbit  
    ...
    Opções de atualização de caução.
