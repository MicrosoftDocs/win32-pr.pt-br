...
---
# <a name="esentrecordnotdeletedexception-members"></a>Membros do EsentRecordNotDeletedException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. RecordNotDeleted exceções.

O tipo [EsentRecordNotDeletedException](./esentrecordnotdeletedexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentRecordNotDeletedException.</td>
</tr>
</tbody>
</table>
