...
---
# <a name="esentinvalidprereadexception-members"></a>Membros do EsentInvalidPrereadException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. InvalidPreread exceções.

O tipo [EsentInvalidPrereadException](./esentinvalidprereadexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentInvalidPrereadException.</td>
</tr>
</tbody>
</table>
