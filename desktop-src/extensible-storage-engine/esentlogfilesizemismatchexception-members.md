...
---
# <a name="esentlogfilesizemismatchexception-members"></a>Membros do EsentLogFileSizeMismatchException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. LogFileSizeMismatch exceções.

O tipo [EsentLogFileSizeMismatchException](./esentlogfilesizemismatchexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentLogFileSizeMismatchException.</td>
</tr>
</tbody>
</table>
