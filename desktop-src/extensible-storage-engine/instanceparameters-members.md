---
description: 'Saiba mais sobre: membros de Instanceparameters'
title: Membros de instanceparameters
...
Essa classe fornece propriedades para definir e obter parâmetros do sistema em uma instância de ESENT. Essa classe fornece propriedades estáticas para definir e obter parâmetros de sistema de ESENT por instância.
...
<td><a href="dn350965(v=exchg.10).md">Instânciaparameters</a></td>
<td>Inicializa uma nova instância da classe Instanceparameters.</td>
</tr>
</tbody>
</table>
