---
description: 'Saiba mais sobre: Membros columnValueOfStruct <T>'
title: Membros columnValueOfStruct(T)
...
ms.locfileid: "119042344"
---
# <a name="columnvalueofstructt-members"></a>Membros columnValueOfStruct \<T\>

Incluir membros protegidos  
Incluir membros herdados  

Definir uma coluna de um tipo de struct (por exemplo, Int32/Guid).

O [tipo ColumnValueOfStruct \<T\> ](./columnvalueofstruct-t-class.md) expõe os membros a seguir.
...
<td>Obtém o comprimento de byte de um valor de coluna, que é zero se a coluna for nula; caso contrário, corresponde ao Tamanho dessa coluna de tamanho fixo. (Substitui <a href="dn334213(v=exchg.10).md">ColumnValue.Length</a>.)</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
...
<td>Obtém o tamanho do valor na coluna. Isso retorna 0 para colunas de tamanho variável (ou seja, binário e cadeia de caracteres). (Herdado de <a href="dn334206(v=exchg.10).md">ColumnValue</a>.)</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
<td><a href="dn334180(v=exchg.10).md">Valor</a></td>
<td>Obtém ou define o valor no struct.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriedade pública" alt="Public property" /></td>
...
<td>Certifique-se de que os dados recuperados são exatamente o tamanho necessário para a estrutura. Uma exceção será lançada se houver uma incompatibilidade.</td>
</tr>
<tr class="even">
...
<td>Dados recuperados do ESENT, decodificar os dados e definir o valor no objeto ColumnValue. (Herdado de <a href="dn334206(v=exchg.10).md">ColumnValue</a>.)</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
...
[Classe ColumnValueOfStruct \<T\>](./columnvalueofstruct-t-class.md)
