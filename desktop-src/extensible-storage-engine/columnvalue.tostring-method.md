---
description: 'Saiba mais sobre: método Columnvalue. ToString'
...
Retorna uma [cadeia de caracteres](/dotnet/api/system.string) que representa o [columnvalue](./columnvalue-class.md)atual.
