...
---
# <a name="esentoutofbuffersexception-members"></a>Membros do EsentOutOfBuffersException

Incluir membros protegidos  
Incluir membros herdados  

Classe base para JET_err. OutOfBuffers exceções.

O tipo [EsentOutOfBuffersException](./esentoutofbuffersexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentOutOfBuffersException.</td>
</tr>
</tbody>
</table>
