...
ms.locfileid: "119976286"
---
# <a name="esentapiexception-members"></a>Membros do EsentApiException
...
O tipo [EsentApiException](./esentapiexception-class.md) expõe os membros a seguir.
...
<td>Inicializa uma nova instância da classe EsentApiException. Esse construtor é usado para desserializar uma exceção serializada.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Método protegido" alt="Protected method" /></td>
<td><a href="dn274002(v=exchg.10).md">EsentApiException (cadeia de caracteres, JET_err)</a></td>
<td>Inicializa uma nova instância da classe EsentApiException.</td>
</tr>
</tbody>
</table>
