...
ms.locfileid: "118163845"
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a>Exemplos de provedor WMI de DNS – Gerenciando Zonas DNS

Esta seção demonstra as tarefas de script associadas ao gerenciamento de zonas DNS. Os links a seguir são vinculados a sub-rotinas no arquivo de script.

-   [Criar uma zona DNS](#create-a-dns-zone)
-   [Modificar uma zona DNS](#modify-a-dns-zone)
-   [Excluir uma zona DNS](#delete-a-dns-zone)
-   [Adicionar um endereço IP de zona](#add-a-zone-ip-address)
-   [Excluir um endereço IP de zona](#delete-a-zone-ip-address)
-   [Pausar uma zona](#pause-a-zone)
-   [Retomar uma zona](#resume-a-zone)
-   [Atualizar uma zona](#update-a-zone)
-   [Recarregar uma zona](#reload-a-zone)
-   [Atualizar uma zona](#refresh-a-zone)
...
## <a name="modify-a-dns-zone"></a>Modificar uma zona DNS
...
## <a name="add-a-zone-ip-address"></a>Adicionar um endereço IP de zona
...
## <a name="delete-a-zone-ip-address"></a>Excluir um endereço IP de zona
...
## <a name="pause-a-zone"></a>Pausar uma zona
...
## <a name="resume-a-zone"></a>Retomar uma zona
...
## <a name="update-a-zone"></a>Atualizar uma zona
...
## <a name="reload-a-zone"></a>Recarregar uma zona
...
## <a name="refresh-a-zone"></a>Atualizar uma zona
