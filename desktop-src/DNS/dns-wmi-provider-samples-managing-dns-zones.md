---
title: Exemplos de provedor WMI de DNS – Gerenciando Zonas DNS
description: Exemplos de provedor WMI de DNS – Gerenciando Zonas DNS
ms.assetid: 12958b71-b47d-4dd7-bd08-409ecd369e4f
keywords:
- Exemplos de provedor WMI de DNS 8212; Gerenciando Zonas DNS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104363925"
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a><span data-ttu-id="685e6-104">Exemplos de provedor WMI de DNS – Gerenciando Zonas DNS</span><span class="sxs-lookup"><span data-stu-id="685e6-104">DNS WMI Provider Samples—Managing DNS Zones</span></span>

<span data-ttu-id="685e6-105">Esta seção demonstra as tarefas de script associadas ao gerenciamento de zonas DNS.</span><span class="sxs-lookup"><span data-stu-id="685e6-105">This section demonstrates scripting tasks associated with managing DNS zones.</span></span> <span data-ttu-id="685e6-106">Os links a seguir são vinculados a sub-rotinas no arquivo de script.</span><span class="sxs-lookup"><span data-stu-id="685e6-106">The following links link to subroutines in the script file.</span></span>

-   [<span data-ttu-id="685e6-107">Criar uma zona DNS</span><span class="sxs-lookup"><span data-stu-id="685e6-107">Create a DNS zone</span></span>](#create-a-dns-zone)
-   [<span data-ttu-id="685e6-108">Modificar uma zona DNS</span><span class="sxs-lookup"><span data-stu-id="685e6-108">Modify a DNS zone</span></span>](#modify-a-dns-zone)
-   [<span data-ttu-id="685e6-109">Excluir uma zona DNS</span><span class="sxs-lookup"><span data-stu-id="685e6-109">Delete a DNS zone</span></span>](#delete-a-dns-zone)
-   [<span data-ttu-id="685e6-110">Adicionar um endereço IP de zona</span><span class="sxs-lookup"><span data-stu-id="685e6-110">Add a zone IP address</span></span>](#add-a-zone-ip-address)
-   [<span data-ttu-id="685e6-111">Excluir um endereço IP de zona</span><span class="sxs-lookup"><span data-stu-id="685e6-111">Delete a zone IP address</span></span>](#delete-a-zone-ip-address)
-   [<span data-ttu-id="685e6-112">Pausar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-112">Pause a zone</span></span>](#pause-a-zone)
-   [<span data-ttu-id="685e6-113">Retomar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-113">Resume a zone</span></span>](#resume-a-zone)
-   [<span data-ttu-id="685e6-114">Atualizar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-114">Update a zone</span></span>](#update-a-zone)
-   [<span data-ttu-id="685e6-115">Recarregar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-115">Reload a zone</span></span>](#reload-a-zone)
-   [<span data-ttu-id="685e6-116">Atualizar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-116">Refresh a zone</span></span>](#refresh-a-zone)
...
## <a name="create-a-dns-zone"></a><span data-ttu-id="685e6-117">Criar uma zona DNS</span><span class="sxs-lookup"><span data-stu-id="685e6-117">Create a DNS Zone</span></span>
...
## <a name="modify-a-dns-zone"></a><span data-ttu-id="685e6-118">Modificar uma zona DNS</span><span class="sxs-lookup"><span data-stu-id="685e6-118">Modify a DNS Zone</span></span>
...
## <a name="delete-a-dns-zone"></a><span data-ttu-id="685e6-119">Excluir uma zona DNS</span><span class="sxs-lookup"><span data-stu-id="685e6-119">Delete a DNS Zone</span></span>
...
## <a name="add-a-zone-ip-address"></a><span data-ttu-id="685e6-120">Adicionar um endereço IP de zona</span><span class="sxs-lookup"><span data-stu-id="685e6-120">Add a Zone IP Address</span></span>
...
## <a name="delete-a-zone-ip-address"></a><span data-ttu-id="685e6-121">Excluir um endereço IP de zona</span><span class="sxs-lookup"><span data-stu-id="685e6-121">Delete a Zone IP Address</span></span>
...
## <a name="pause-a-zone"></a><span data-ttu-id="685e6-122">Pausar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-122">Pause a Zone</span></span>
...
## <a name="resume-a-zone"></a><span data-ttu-id="685e6-123">Retomar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-123">Resume a Zone</span></span>
...
## <a name="update-a-zone"></a><span data-ttu-id="685e6-124">Atualizar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-124">Update a Zone</span></span>
...
## <a name="reload-a-zone"></a><span data-ttu-id="685e6-125">Recarregar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-125">Reload a Zone</span></span>
...
## <a name="refresh-a-zone"></a><span data-ttu-id="685e6-126">Atualizar uma zona</span><span class="sxs-lookup"><span data-stu-id="685e6-126">Refresh a Zone</span></span>
