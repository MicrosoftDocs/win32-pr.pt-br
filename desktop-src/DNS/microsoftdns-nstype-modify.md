---
title: Modificar o método da MicrosoftDNS_NSType classe
description: O método Modify atualiza um registro de recurso do servidor de nomes (NS).
ms.assetid: da625231-cf4e-4526-b713-737e6b9f5831
keywords:
- Modificar o método DNS
- Modificar o método DNS, MicrosoftDNS_NSType classe
- MicrosoftDNS_NSType classe DNS, método Modify
topic_type:
- apiref
api_name:
...
---
# <a name="modify-method-of-the-microsoftdns_nstype-class"></a>Modificar método da classe NSType do MicrosoftDNS \_

O **método Modify** atualiza um registro de recurso do servidor de nomes (NS).
