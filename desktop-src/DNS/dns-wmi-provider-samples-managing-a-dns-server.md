---
title: Exemplos de provedor WMI de DNS – gerenciando um servidor DNS
description: Exemplos de provedor WMI de DNS – gerenciando um servidor DNS
...
ms.locfileid: "104500126"
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a><span data-ttu-id="2ca40-103">Exemplos de provedor WMI de DNS – gerenciando um servidor DNS</span><span class="sxs-lookup"><span data-stu-id="2ca40-103">DNS WMI Provider Samples—Managing a DNS Server</span></span>

> [!NOTE]
> <span data-ttu-id="2ca40-104">Este artigo contém referências ao termo "servidor subordinado", um termo que a Microsoft não usa mais.</span><span class="sxs-lookup"><span data-stu-id="2ca40-104">This article contains references to the term slave, a term that Microsoft no longer uses.</span></span> <span data-ttu-id="2ca40-105">Quando o termo for removido do software, também o removeremos deste artigo.</span><span class="sxs-lookup"><span data-stu-id="2ca40-105">When the term is removed from the software, we’ll remove it from this article.</span></span>

<span data-ttu-id="2ca40-106">Esta seção demonstra as tarefas de script associadas ao gerenciamento de um servidor DNS.</span><span class="sxs-lookup"><span data-stu-id="2ca40-106">This section demonstrates scripting tasks associated with managing a DNS Server.</span></span> <span data-ttu-id="2ca40-107">Os links abaixo saltam para as sub-rotinas no arquivo de script:</span><span class="sxs-lookup"><span data-stu-id="2ca40-107">The links below jump to subroutines in the script file:</span></span>

-   [<span data-ttu-id="2ca40-108">Listar Propriedades do servidor DNS</span><span class="sxs-lookup"><span data-stu-id="2ca40-108">List DNS Server properties</span></span>](#list-dns-server-properties)
-   [<span data-ttu-id="2ca40-109">Parar, iniciar ou reiniciar um servidor DNS</span><span class="sxs-lookup"><span data-stu-id="2ca40-109">Stop, start, or restart a DNS Server</span></span>](#stop-start-or-restart-a-dns-server)
-   [<span data-ttu-id="2ca40-110">Modificar propriedades do servidor DNS</span><span class="sxs-lookup"><span data-stu-id="2ca40-110">Modify DNS Server properties</span></span>](#modify-dns-server-properties)
-   [<span data-ttu-id="2ca40-111">Adicionar um endereço IP</span><span class="sxs-lookup"><span data-stu-id="2ca40-111">Add an IP address</span></span>](#add-an-ip-address)
-   [<span data-ttu-id="2ca40-112">Excluir um endereço IP</span><span class="sxs-lookup"><span data-stu-id="2ca40-112">Delete an IP address</span></span>](#delete-an-ip-address)
-   [<span data-ttu-id="2ca40-113">Listar Zonas</span><span class="sxs-lookup"><span data-stu-id="2ca40-113">List Zones</span></span>](#list-zones)
...
## <a name="list-dns-server-properties"></a><span data-ttu-id="2ca40-114">Listar Propriedades do servidor DNS</span><span class="sxs-lookup"><span data-stu-id="2ca40-114">List DNS Server properties</span></span>
...
## <a name="stop-start-or-restart-a-dns-server"></a><span data-ttu-id="2ca40-115">Parar, iniciar ou reiniciar um servidor DNS</span><span class="sxs-lookup"><span data-stu-id="2ca40-115">Stop, Start, or Restart a DNS Server</span></span>
...
## <a name="modify-dns-server-properties"></a><span data-ttu-id="2ca40-116">Modificar propriedades do servidor DNS</span><span class="sxs-lookup"><span data-stu-id="2ca40-116">Modify DNS Server Properties</span></span>
...
## <a name="add-an-ip-address"></a><span data-ttu-id="2ca40-117">Adicionar um endereço IP</span><span class="sxs-lookup"><span data-stu-id="2ca40-117">Add an IP Address</span></span>
...
## <a name="delete-an-ip-address"></a><span data-ttu-id="2ca40-118">Excluir um endereço IP</span><span class="sxs-lookup"><span data-stu-id="2ca40-118">Delete an IP Address</span></span>
...
## <a name="list-zones"></a><span data-ttu-id="2ca40-119">Listar Zonas</span><span class="sxs-lookup"><span data-stu-id="2ca40-119">List Zones</span></span>
