...
ms.locfileid: "119795706"
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a>Exemplos de provedor WMI de DNS – gerenciando um servidor DNS
...
Esta seção demonstra as tarefas de script associadas ao gerenciamento de um servidor DNS. Os links abaixo saltam para as sub-rotinas no arquivo de script:

-   [Listar Propriedades do servidor DNS](#list-dns-server-properties)
-   [Parar, iniciar ou reiniciar um servidor DNS](#stop-start-or-restart-a-dns-server)
-   [Modificar propriedades do servidor DNS](#modify-dns-server-properties)
-   [Adicionar um endereço IP](#add-an-ip-address)
-   [Excluir um endereço IP](#delete-an-ip-address)
-   [Listar Zonas](#list-zones)
...
## <a name="list-dns-server-properties"></a>Listar Propriedades do servidor DNS
...
## <a name="stop-start-or-restart-a-dns-server"></a>Parar, iniciar ou reiniciar um servidor DNS
...
## <a name="modify-dns-server-properties"></a>Modificar propriedades do servidor DNS
...
## <a name="add-an-ip-address"></a>Adicionar um endereço IP
...
## <a name="delete-an-ip-address"></a>Excluir um endereço IP
...
## <a name="list-zones"></a>Listar Zonas
