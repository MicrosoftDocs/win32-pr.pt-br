...
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_mftype-class"></a>Método CreateInstanceFromPropertyData da \_ classe MFType MicrosoftDNS

O método **CreateInstanceFromPropertyData** instancia um registro de recurso do agente de encaminhamento de mensagens para o domínio (MF).
