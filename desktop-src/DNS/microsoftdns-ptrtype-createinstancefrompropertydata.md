...
O método **CreateInstanceFromPropertyData** instancia um registro de recurso de ponteiro (PTR).
...
Cadeia de caracteres que representa o endereço de nome de domínio do registro PTR.
