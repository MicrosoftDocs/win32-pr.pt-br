---
title: Exemplos de provedor WMI de DNS – Gerenciando registros de recursos de DNS
description: Exemplos de provedor WMI de DNS – Gerenciando registros de recursos de DNS
...
ms.locfileid: "118163835"
---
# <a name="dns-wmi-provider-samplesmanaging-dns-resource-records"></a>Exemplos de provedor WMI de DNS – Gerenciando registros de recursos de DNS

Esta seção demonstra as tarefas de script associadas ao gerenciamento de registros de recursos DNS. Os links abaixo saltam para as sub-rotinas no arquivo de script.

-   [Listar registros de recursos](#list-resource-records)
-   [Adicionar um registro de recurso](#add-a-resource-record)
-   [Excluir um registro de recurso](#delete-a-resource-record)
-   [Modificar um registro de recurso](#modify-a-resource-record)
-   [Conexão ao provedor WMI de DNS](#connect-to-the-dns-wmi-provider)

A implementação geral do script é a seguinte:

1.  Uma classe é criada para cada tipo de registro de recurso.
2.  Os dados de registro de recurso são fornecidos por meio de entradas de linha de comando de usuário e informações de provedor WMI de DNS para cada classe de tipo de registro.
3.  Funções comuns como lista, exclusão e modificação são criadas e podem ser usadas em classes de tipo de registro de recurso individual.

Este exemplo de código mostra tarefas associadas ao gerenciamento de registros de recursos DNS.
...
## <a name="list-resource-records"></a>Listar registros de recursos

Este exemplo de código mostra as tarefas associadas à listagem de registros de recursos.
...
## <a name="add-a-resource-record"></a>Adicionar um registro de recurso

Este exemplo de código mostra as tarefas associadas à adição de registros de recursos.
...
## <a name="delete-a-resource-record"></a>Excluir um registro de recurso

Este exemplo de código mostra as tarefas associadas à exclusão de registros de recursos.
...
## <a name="modify-a-resource-record"></a>Modificar um registro de recurso

Este exemplo de código mostra as tarefas associadas à alteração de registros de recursos.
...
## <a name="connect-to-the-dns-wmi-provider"></a>Conexão ao provedor WMI de DNS

Este exemplo de código mostra as tarefas associadas à conexão a um provedor WMI de DNS.
