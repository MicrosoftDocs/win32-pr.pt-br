...
ms.locfileid: "119668036"
---
# <a name="disable-method-of-the-win32_tpm-class"></a>Método Disable da classe Win32 \_ TPM

O método **Disable** da classe [**Win32 \_ TPM**](win32-tpm.md) permite que o proprietário do TPM desabilite ou suspenda o TPM. Esse método suspende o BitLocker se a chamada puder fazer com que a recuperação do BitLocker seja necessária. O BitLocker será retomado automaticamente depois que o TPM tiver sido provisionado.
...
Para desabilitar o TPM sem ter o valor de autorização de proprietário do TPM, use o método [**SetPhysicalPresenceRequest**](setphysicalpresencerequest-win32-tpm.md) .
