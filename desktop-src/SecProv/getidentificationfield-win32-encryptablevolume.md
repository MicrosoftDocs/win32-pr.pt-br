...
ms.locfileid: "119797126"
---
# <a name="getidentificationfield-method-of-the-win32_encryptablevolume-class"></a>Método getidentificafield da classe Win32 \_ EncryptableVolume

O método **Getidentificafield** da classe [**Win32 \_ EncryptableVolume**](win32-encryptablevolume.md) retorna a cadeia de caracteres do identificador disponível nos metadados do volume.
...
*Identificação do identificador* \[ fora\]
</dt> <dd>

Tipo: **cadeia de caracteres**

Uma cadeia de caracteres que especifica o campo de identificação que é atribuído ao volume.
