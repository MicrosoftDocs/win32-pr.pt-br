...
---
# <a name="getkeyprotectorexternalkey-method-of-the-win32_encryptablevolume-class"></a>Método GetKeyProtectorExternalKey da classe Win32 \_ EncryptableVolume
...
O identificador de protetor de chave deve se referir a um protetor de chave do tipo "chave externa", "TPM e PIN e chave de inicialização", ou "TPM e chave de inicialização".
