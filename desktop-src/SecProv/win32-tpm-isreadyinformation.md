...
| <span id="INFORMATION_TPM_SRKPUB"></span><span id="information_tpm_srkpub"></span><dl> <dt>**Informações \_ do 0x00000800 \_ SRKPUB TPM**</dt> <dt></dt> </dl>                                          | As informações de registro do sistema operacional sobre a chave raiz de armazenamento do TPM não correspondem à chave raiz de armazenamento do TPM.<br/>                                                                                                       |
