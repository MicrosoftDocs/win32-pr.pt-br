...
O método **ProtectKeyWithTPM** da classe [**Win32 \_ EncryptableVolume**](win32-encryptablevolume.md) protege a chave de criptografia do volume usando o hardware de segurança Trusted Platform Module (TPM) no computador, se disponível.

Um protetor de chave do tipo "TPM" será criado para o volume, se ainda não existir um.

Esse método só é aplicável para o volume que contém o sistema operacional em execução no momento e se um protetor de chave ainda não existir no volume.
...
| <dl> <dt>9</dt> </dl>  | Código de inicialização NTFS<br/>                                                           |
| <dl> <dt>10</dt> </dl> | Gerenciador de inicialização<br/>                                                             |
| <dl> <dt>11</dt> </dl> | Controle de acesso Criptografia de Unidade de Disco BitLocker<br/>                                |
