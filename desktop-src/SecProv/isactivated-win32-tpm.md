...
---
# <a name="isactivated-method-of-the-win32_tpm-class"></a>Método isActivated da \_ classe TPM do Win32

O método **isActivated** da classe [**Win32 \_ TPM**](win32-tpm.md) indica se o dispositivo está ativado.
...
Se **for true**, o dispositivo será ativado.
...
A desativação é semelhante à desabilitada, mas as alterações de estado operacional são possíveis. De acordo com a especificação de TCG (Trusted Computing Group) v 1.2, somente os comandos a seguir estão disponíveis quando o dispositivo está em um estado desativado.
