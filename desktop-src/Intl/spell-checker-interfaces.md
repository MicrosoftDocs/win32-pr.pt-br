---
description: 'Saiba mais sobre: interfaces de verificação ortográfica'
ms.assetid: 42738598-FF25-4E75-9B42-353EC991DDBC
title: Interfaces de verificação ortográfica
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="spell-checking-interfaces"></a>Interfaces de verificação ortográfica

A API de verificação ortográfica contém as seguintes interfaces:
...
[Enumerações de verificação ortográfica](spell-checker-enumerations.md)
</dt> </dl>
