---
description: Esta seção descreve as estruturas usadas com as funções e mensagens do IMM.
ms.assetid: 1be3ae8b-e083-4420-bc8a-7f49c4264cab
title: Estruturas do Gerenciador de métodos de entrada
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118145885"
---
# <a name="input-method-manager-structures"></a>Estruturas do Gerenciador de métodos de entrada

Esta seção descreve as estruturas usadas com as funções e mensagens do IMM.
