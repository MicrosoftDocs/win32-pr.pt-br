---
description: Seus aplicativos Unicode sempre devem ser lançados como TCHAR ao usar cadeias de caracteres terminadas em nulo.
...
Seus aplicativos Unicode sempre devem ser lançados como TCHAR ao usar cadeias de caracteres terminadas em nulo. O código 0x0000 é o terminador de cadeia de caracteres Unicode para uma cadeia de caracteres terminada em nulo. Um único byte nulo não é suficiente para esse código, porque muitos caracteres Unicode contêm bytes nulos como o byte alto ou baixo. Um exemplo é a letra A, para a qual o código de caractere é 0x0041.
