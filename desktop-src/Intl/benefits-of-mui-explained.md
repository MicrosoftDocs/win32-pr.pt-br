...
Antes do lançamento do Windows Vista, a falta de suporte interno para esse último modelo tornou difícil a adoção. No entanto, isso mudou, e os benefícios desse modelo são numerosos e tornam um excelente modelo para seus aplicativos:
...
-   Ferramentas e diretrizes que ajudam você a migrar seu aplicativo para o modelo MUI do Windows Vista estão disponíveis. Em particular, o MSDN fornece um [conjunto significativo de documentação](multilingual-user-interface.md) sobre o MUI.
