...
---
# <a name="mui-system-settings-application-sample"></a><span data-ttu-id="181a7-103">MUI: exemplo de aplicativo de configurações do sistema</span><span class="sxs-lookup"><span data-stu-id="181a7-103">MUI: System Settings Application Sample</span></span>

<span data-ttu-id="181a7-104">O aplicativo de exemplo descrito neste tópico é um aplicativo simples de Hello MUI que dá suporte às configurações do sistema para seus idiomas de interface do usuário.</span><span class="sxs-lookup"><span data-stu-id="181a7-104">The sample application described in this topic is a simple Hello MUI application that supports system settings for its user interface languages.</span></span>
