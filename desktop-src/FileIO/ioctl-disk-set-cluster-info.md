...
---
# <a name="ioctl_disk_set_cluster_info-control-code"></a>\_Código de \_ controle de informações do \_ cluster do conjunto de discos do IOCTL \_

Define as informações de cluster em um disco.
...
Use **as \_ \_ informações do \_ cluster \_ do conjunto de discos do IOCTL** para esta operação.
...
Um ponteiro para uma estrutura de dados de [**\_ \_ informações de cluster de disco**](disk-cluster-info.md) que contém informações de cluster para o disco.
