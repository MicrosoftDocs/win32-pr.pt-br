...
---
# <a name="adding-users-to-an-encrypted-file"></a><span data-ttu-id="a507d-103">Adicionando usuários a um arquivo criptografado</span><span class="sxs-lookup"><span data-stu-id="a507d-103">Adding Users to an Encrypted File</span></span>

<span data-ttu-id="a507d-104">O exemplo de código neste tópico adiciona um novo usuário a um arquivo criptografado existente usando a função [**AddUsersToEncryptedFile**](/windows/desktop/api/Winefs/nf-winefs-adduserstoencryptedfile) .</span><span class="sxs-lookup"><span data-stu-id="a507d-104">The code sample in this topic adds a new user to an existing encrypted file by using the [**AddUsersToEncryptedFile**](/windows/desktop/api/Winefs/nf-winefs-adduserstoencryptedfile) function.</span></span> <span data-ttu-id="a507d-105">Ele requer que o certificado de sistema de arquivos com criptografia (EFS) do usuário (do Active Directory) exista no repositório de certificados do usuário de pessoas confiáveis.</span><span class="sxs-lookup"><span data-stu-id="a507d-105">It requires the user's Encrypting File System (EFS) certificate (from the Active Directory) to exist in the Trusted People user certificate store.</span></span>

<span data-ttu-id="a507d-106">Este exemplo adiciona um novo campo de recuperação de dados ao arquivo criptografado.</span><span class="sxs-lookup"><span data-stu-id="a507d-106">This sample adds a new Data Recovery Field to the encrypted file.</span></span> <span data-ttu-id="a507d-107">Como resultado, o usuário recém-adicionado pode descriptografar o arquivo criptografado.</span><span class="sxs-lookup"><span data-stu-id="a507d-107">As a result, the newly added user can decrypt the encrypted file.</span></span> <span data-ttu-id="a507d-108">O chamador já deve ter acesso ao arquivo criptografado, seja como o proprietário original, o agente de recuperação de dados ou como um usuário que foi adicionado anteriormente ao arquivo criptografado.</span><span class="sxs-lookup"><span data-stu-id="a507d-108">The caller must already have access to the encrypted file, either as the original owner, the data recovery agent, or as a user who was previously added to the encrypted file.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="a507d-109">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="a507d-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="a507d-110">**CertCloseStore**</span><span class="sxs-lookup"><span data-stu-id="a507d-110">**CertCloseStore**</span></span>](/windows/desktop/api/wincrypt/nf-wincrypt-certclosestore)
</dt> <dt>

[<span data-ttu-id="a507d-111">**CertFindCertificateInStore**</span><span class="sxs-lookup"><span data-stu-id="a507d-111">**CertFindCertificateInStore**</span></span>](/windows/desktop/api/wincrypt/nf-wincrypt-certfindcertificateinstore)
</dt> <dt>

[<span data-ttu-id="a507d-112">**CertFreeCertificateContext**</span><span class="sxs-lookup"><span data-stu-id="a507d-112">**CertFreeCertificateContext**</span></span>](/windows/desktop/api/wincrypt/nf-wincrypt-certfreecertificatecontext)
</dt> <dt>

[<span data-ttu-id="a507d-113">**CertOpenSystemStore**</span><span class="sxs-lookup"><span data-stu-id="a507d-113">**CertOpenSystemStore**</span></span>](/windows/desktop/api/wincrypt/nf-wincrypt-certopensystemstorea)
</dt> <dt>

[<span data-ttu-id="a507d-114">Criptografia de Arquivo</span><span class="sxs-lookup"><span data-stu-id="a507d-114">File Encryption</span></span>](file-encryption.md)
</dt> <dt>

[<span data-ttu-id="a507d-115">**LookupAccountName**</span><span class="sxs-lookup"><span data-stu-id="a507d-115">**LookupAccountName**</span></span>](/windows/desktop/api/winbase/nf-winbase-lookupaccountnamea)
</dt> </dl>
