---
description: o Windows armazena os dados em operações de gravação e leitura de arquivo em buffers de dados mantidos pelo sistema para otimizar o desempenho do disco.
