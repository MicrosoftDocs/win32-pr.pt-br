...
| [Pontos de nova análise e operações de arquivo](reparse-points-and-file-operations.md)<br/> | descreve como os pontos de nova análise permitem o comportamento do sistema de arquivos que faz parte do comportamento que mais Windows os desenvolvedores esperam.<br/>                                                                                     |
