...
ms.locfileid: "118482977"
---
# <a name="input-source-identification"></a>Identificação da origem de entrada
...
As APIs de Identificação de Origem de Entrada são projetadas para desenvolvedores que estão criando estruturas de interface do usuário que fornecem uma experiência de usuário consistente com otimização de toque em aplicativos da área de trabalho.
