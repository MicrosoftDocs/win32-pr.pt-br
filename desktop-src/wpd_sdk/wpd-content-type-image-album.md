...
ms.locfileid: "117842323"
---
# <a name="wpd_content_type_image_album"></a>\_álbum de \_ imagem de tipo de conteúdo WPD \_ \_

Um objeto que descreve seu tipo de \_ álbum de imagem de tipo de conteúdo WPD \_ \_ \_ representa uma coleção de imagens ainda. Um álbum de imagem é funcionalmente equivalente a uma lista de reprodução de arquivos de imagem, mas é usado para representar um álbum de fotos física para o usuário final.
...
| [IsSystem de \_ objetos WPD \_](object-properties.md)                                                    | Necessário se o objeto for um objeto do sistema (ou seja, representar um arquivo do sistema). |
