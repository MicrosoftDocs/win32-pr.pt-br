...
Os dispositivos portáteis do Windows oferecem suporte aos seguintes atributos de propriedade. Esses atributos são retornados pelos seguintes métodos:
...
| **\_ \_ Propriedade rápida do atributo de propriedade WPD \_ \_**        | **BOOL do VT \_**    | Se for true, essa propriedade pertencerá ao grupo de *Propriedades Fast* . Essas são propriedades que podem ser recuperadas rapidamente do dispositivo.                                                                                                                                                                                                                                                        |
