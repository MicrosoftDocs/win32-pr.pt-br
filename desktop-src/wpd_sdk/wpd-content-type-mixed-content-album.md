...
Um objeto que descreve seu tipo como WPD CONTENT TYPE MIXED CONTENT ALBUM representa uma coleção de objetos de mídia misturada, por exemplo, arquivos de \_ \_ \_ \_ \_ áudio, imagem e vídeo. Um álbum de conteúdo misto é funcionalmente equivalente a uma playlist de arquivos de mídia, mas é usado para representar um álbum físico para o usuário final.
