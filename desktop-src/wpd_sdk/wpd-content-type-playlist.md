...
ms.locfileid: "117842296"
---
# <a name="wpd_content_type_playlist"></a>\_playlist de \_ tipo de conteúdo WPD \_

Um objeto que descreve seu tipo de \_ lista de reprodução de tipo de conteúdo WPD \_ \_ representa uma lista de reprodução. Uma lista de reprodução pode ser representada por um arquivo físico ou pode consistir em referências armazenadas como metadados.
...
| [\_indicador de \_ objeto de mídia WPD \_](object-properties.md)                                                                 | Recomendável.                                                                                                                                   |
...
|--------------------------------------------------------|----------------------|------------------------------------------------------------------------------------------------------------------------------|
| [**\_padrão de recursos WPD \_**](wpd-resource-default.md) | Opcional.            | Se a playlist for um arquivo físico, por exemplo, um arquivo XML que lista os arquivos de mídia a serem reproduzidos, esses serão os bytes de arquivo reais. |
