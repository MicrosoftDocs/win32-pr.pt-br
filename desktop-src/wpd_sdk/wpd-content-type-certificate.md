...
---
# <a name="wpd_content_type_certificate"></a>\_certificado de \_ tipo de conteúdo WPD \_
...
|--------------------------------------------------------|----------------------|--------------------|
| [**\_padrão de recursos WPD \_**](wpd-resource-default.md) | Obrigatórios.            | Contém os dados. |
