---
description: Emitindo o comando GetDevicePropValue
ms.assetid: 60294ac6-06e0-4546-bbe9-da48d250e31e
title: Emitindo o comando GetDevicePropValue
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105807851"
---
# <a name="issuing-the-getdevicepropvalue-command"></a><span data-ttu-id="88725-103">Emitindo o comando GetDevicePropValue</span><span class="sxs-lookup"><span data-stu-id="88725-103">Issuing the GetDevicePropValue Command</span></span>

<span data-ttu-id="88725-104">O exemplo nesta seção invoca o comando **GetDevicePropValue** MTP para recuperar a propriedade de dispositivo **BatteryLevel** .</span><span class="sxs-lookup"><span data-stu-id="88725-104">The example in this section invokes the **GetDevicePropValue** MTP command to retrieve the **BatteryLevel** device property.</span></span> <span data-ttu-id="88725-105">(Para obter uma descrição completa desse comando e de seus parâmetros, consulte a [especificação do MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span><span class="sxs-lookup"><span data-stu-id="88725-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="88725-106">No caso do **GetDevicePropValue**, o código de exemplo usa a seguinte sequência:</span><span class="sxs-lookup"><span data-stu-id="88725-106">In the case of **GetDevicePropValue**, the sample code uses the following sequence:</span></span>

1.  <span data-ttu-id="88725-107">\_comando WPD \_ MTP \_ ext \_ \_ comando \_ com \_ dados \_ a serem \_ lidos</span><span class="sxs-lookup"><span data-stu-id="88725-107">WPD\_COMMAND\_MTP\_EXT\_EXECUTE\_COMMAND\_WITH\_DATA\_TO\_READ</span></span>
2.  <span data-ttu-id="88725-108">comando WPD de \_ \_ leitura de \_ \_ dados de extensão MTP \_</span><span class="sxs-lookup"><span data-stu-id="88725-108">WPD\_COMMAND\_MTP\_EXT\_READ\_DATA</span></span>
3.  <span data-ttu-id="88725-109">\_transferência de \_ \_ dados de \_ extremidade \_ de \_ MTP de comando WPD</span><span class="sxs-lookup"><span data-stu-id="88725-109">WPD\_COMMAND\_MTP\_EXT\_END\_DATA\_TRANSFER</span></span>

<span data-ttu-id="88725-110">O exemplo de código a seguir mostra como o aplicativo initates a sequência de comandos.</span><span class="sxs-lookup"><span data-stu-id="88725-110">The following code example shows how the application initates the command sequence.</span></span>
...
<span data-ttu-id="88725-111">O exemplo de código a seguir mostra como o aplicativo recupera os dados de propriedade.</span><span class="sxs-lookup"><span data-stu-id="88725-111">The following code example shows how the application retrieves the property data.</span></span>
...
<span data-ttu-id="88725-112">O exemplo de código a seguir mostra como o aplicativo recupera a resposta do dispositivo para o comando.</span><span class="sxs-lookup"><span data-stu-id="88725-112">The following code example shows how the application retrieves the device response to the command.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="88725-113">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="88725-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="88725-114">Suporte a extensões de MTP</span><span class="sxs-lookup"><span data-stu-id="88725-114">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
