...
ms.locfileid: "119839276"
---
# <a name="issuing-the-getdevicepropvalue-command"></a>Emitindo o comando GetDevicePropValue

O exemplo nesta seção invoca o comando **GetDevicePropValue** MTP para recuperar a propriedade de dispositivo **BatteryLevel** . (Para obter uma descrição completa desse comando e de seus parâmetros, consulte a [especificação do MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).)

No caso do **GetDevicePropValue**, o código de exemplo usa a seguinte sequência:

1.  \_comando WPD \_ MTP \_ ext \_ \_ comando \_ com \_ dados \_ a serem \_ lidos
2.  comando WPD de \_ \_ leitura de \_ \_ dados de extensão MTP \_
3.  \_transferência de \_ \_ dados de \_ extremidade \_ de \_ MTP de comando WPD

O exemplo de código a seguir mostra como o aplicativo initates a sequência de comandos.
...
O exemplo de código a seguir mostra como o aplicativo recupera os dados de propriedade.
...
O exemplo de código a seguir mostra como o aplicativo recupera a resposta do dispositivo para o comando.
