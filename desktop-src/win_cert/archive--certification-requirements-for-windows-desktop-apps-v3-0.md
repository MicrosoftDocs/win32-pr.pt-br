...
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v30"></a>Arquivo morto: requisitos de certificação para Aplicativos da Área de Trabalho do Windows v3.0

**Versão do documento:** 3.0

**Data do documento:** 29 de junho de 2012

Este documento contém os requisitos técnicos e as qualificações de qualificação que um aplicativo da área de trabalho deve atender para participar do programa Windows 8 de Certificação de Aplicativos da Área de Trabalho. Para o Windows 7, esse programa era conhecido como Programa de Logotipo de Software do Windows.
...
1.3 Seu aplicativo não deve carregar DLLs arbitrárias para interceptar chamadas à API win32 usando dlls do Microsoft HKLM \\ Software \\ Windows NT \\ \\ CurrentVersion Windows \\ AppInit. \_  
</dl>
...
| 29 de junho de 2012 | 3.0     | Documento final do Windows 8               | 3.0                                                                          |
