...
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v30"></a>Arquivo: requisitos de certificação para aplicativos da área de trabalho do Windows v 3.0
