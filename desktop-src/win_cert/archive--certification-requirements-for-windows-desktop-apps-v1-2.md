---
title: requisitos de certificação de arquivamento para Windows aplicativos de área de trabalho v 1.2
description: documento versão 1.2 data do documento 31 de maio de 2012This documento contém os requisitos técnicos e as qualificações de qualificação que um aplicativo de desktop deve atender para participar do programa de certificação de aplicativo de área de trabalho Windows 8.
...
ms.locfileid: "122882662"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v12"></a>arquivo: requisitos de certificação para Windows aplicativos de área de trabalho v 1.2
...
| teste do modo de Cofre                                                          | Aprovado/reprovado               |
| suporte para teste de Windows x64                                                | Aprovado/reprovado               |
| testar alterações em Windows recursos de segurança (analisador de superfície de ataque) | Aprovação/falha/aviso     |
| testar alterações em Windows recursos de segurança (analisador de binário BinScope) | Aviso                   |
...
-   [Windows Requisitos de certificação de aplicativos da loja](/legal/windows/agreements/store-policies)
