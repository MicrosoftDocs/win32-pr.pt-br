...
description: Determina se o RPCSS anexa automaticamente um SID TODOS OS PACOTES DE APLICATIVOs às \_ \_ restrições COM por padrão.
...
ms.locfileid: "117737002"
---
# <a name="donotaddallapplicationpackagestorestrictions"></a>DoNotAddAllApplicationPackagesToRestrictions

Determina se o RPCSS anexa automaticamente um SID TODOS OS PACOTES DE APLICATIVOs às \_ \_ restrições COM por padrão.
...
| Valor | Descrição                                                                               |
|-------|-------------------------------------------------------------------------------------------|
| 0     | Desabilita Windows Aplicativos da Store após a migração do Windows 7 para Windows 8.                   |
| 1     | Não adiciona o SID TODOS \_ OS PACOTES \_ DE APLICATIVOs às restrições COM. Esse é o padrão. |
