---
title: Estruturas (OLE e Transferência de Dados)
description: As estruturas a seguir são usadas para implementar documentos compostos e realizar a transferência de dados entre aplicativos.
...
ms.locfileid: "104008710"
---
# <a name="structures-ole-and-data-transfer"></a>Estruturas (OLE e Transferência de Dados)

As estruturas a seguir são usadas para implementar documentos compostos e realizar a transferência de dados entre aplicativos.
