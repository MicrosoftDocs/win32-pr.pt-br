...
---
# <a name="iorpcdebugnotifyserverfillbuffer-method"></a>Método IOrpcDebugNotify:: ServerFillBuffer

Envia dados do depurador do servidor para o depurador do cliente.
