---
title: Funções (controles e páginas de propriedades)
description: As funções a seguir são usadas para criar objetos COM padrão e páginas de propriedades.
...
ms.locfileid: "119462536"
---
# <a name="functions-controls-and-property-pages"></a>Funções (controles e páginas de propriedades)

As funções a seguir são usadas para criar objetos COM padrão e páginas de propriedades.
