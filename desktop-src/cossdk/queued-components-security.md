...
Devido ao risco de um ataque sofisticado associado a qualquer mecanismo que propaga a identidade em uma rede, bem como o risco de um ataque de negação de serviço simples inundando as filas com solicitações não executáveis, é recomendável que você implante o serviço de componentes na fila COM+ somente em uma rede de hosts confiáveis, por exemplo, em uma rede privada ou virtual privada ou por trás de um firewall configurado adequadamente.
