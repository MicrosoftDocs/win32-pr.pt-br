...
## <a name="low-memory-activation-gates"></a>Low-Memory de ativação
...
O acesso à rede COM+ é desabilitado por padrão no Windows Server 2003, o que significa que o COM+ pode ser usado somente localmente por padrão. Use o procedimento a seguir para habilitar o acesso COM+ à rede.
