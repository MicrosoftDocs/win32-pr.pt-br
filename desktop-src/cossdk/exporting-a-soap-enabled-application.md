---
description: Quando você usa o COM+ para criar um serviço Web XML, esse serviço pode ser usado por qualquer cliente autorizado, incluindo aqueles que não usam COM+ ou até mesmo o Microsoft Windows.
