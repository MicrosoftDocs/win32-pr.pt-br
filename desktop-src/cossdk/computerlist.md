...
---
# <a name="computerlist-collection"></a>Coleção de computerlist

Contém uma lista dos computadores na pasta **computadores** da ferramenta de administração de serviços de componentes. Ele contém um objeto para cada computador.
...
A coleção **computerlist** herda da interface [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) , mas não tem membros adicionais.
