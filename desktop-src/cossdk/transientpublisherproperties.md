---
description: Contém um objeto para cada propriedade transitória do Publicador para a coleção TransientSubscriptions pai. Assinaturas transitórias podem ser criadas instantaneamente para execução de instâncias de objeto e desaparecem quando o objeto é destruído.
ms.assetid: 63921caa-5c22-4203-b1a3-f143928f4742
title: Coleção TransientPublisherProperties
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "105813569"
---
# <a name="transientpublisherproperties-collection"></a>Coleção TransientPublisherProperties

Contém um objeto para cada propriedade transitória do Publicador para a coleção [**TransientSubscriptions**](transientsubscriptions.md) pai. Assinaturas transitórias podem ser criadas instantaneamente para execução de instâncias de objeto e desaparecem quando o objeto é destruído.
...
A coleção **TransientPublisherProperties** herda da interface [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) , mas não tem membros adicionais.
