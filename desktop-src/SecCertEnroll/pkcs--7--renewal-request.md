...
---
# <a name="pkcs-7-renewal-request"></a><span data-ttu-id="13b42-105">\#Solicitação de renovação PKCS 7</span><span class="sxs-lookup"><span data-stu-id="13b42-105">PKCS \#7 Renewal Request</span></span>

<span data-ttu-id="13b42-106">O exemplo a seguir contém uma \# solicitação de renovação PKCS 7.</span><span class="sxs-lookup"><span data-stu-id="13b42-106">The following example contains a PKCS \#7 renewal request.</span></span> <span data-ttu-id="13b42-107">O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="13b42-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="13b42-108">O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.</span><span class="sxs-lookup"><span data-stu-id="13b42-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="13b42-109">A configuração especifica o tipo de solicitação (PKCS \# 7) e o número de série do certificado no qual a solicitação se baseia.</span><span class="sxs-lookup"><span data-stu-id="13b42-109">The configuration specifies the type of request (PKCS \#7) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="13b42-110">Isso gera a saída a seguir.</span><span class="sxs-lookup"><span data-stu-id="13b42-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="13b42-111">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="13b42-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="13b42-112">Solicitações de amostra</span><span class="sxs-lookup"><span data-stu-id="13b42-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
