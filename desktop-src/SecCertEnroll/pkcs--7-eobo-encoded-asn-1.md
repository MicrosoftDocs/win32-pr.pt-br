...
---
# <a name="pkcs-7-eobo-encoded-asn1"></a><span data-ttu-id="6a62a-105">\#ASN codificado EOBO PKCS 7.1</span><span class="sxs-lookup"><span data-stu-id="6a62a-105">PKCS \#7 EOBO Encoded ASN.1</span></span>

<span data-ttu-id="6a62a-106">O exemplo a seguir contém uma \# solicitação de inscrição PKCS 7 em nome de (EOBO) mostrada no formato ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="6a62a-106">The following example contains a PKCS \#7 Enroll On Behalf Of (EOBO) request shown in ASN.1 format.</span></span> <span data-ttu-id="6a62a-107">O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="6a62a-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="6a62a-108">O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.</span><span class="sxs-lookup"><span data-stu-id="6a62a-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="6a62a-109">Essa configuração gera a seguinte saída de exemplo.</span><span class="sxs-lookup"><span data-stu-id="6a62a-109">This configuration generates the following sample output.</span></span> <span data-ttu-id="6a62a-110">A configuração especifica o tipo de solicitação (PKCS \# 7), o nome da entidade que solicita o registro e o nome do modelo.</span><span class="sxs-lookup"><span data-stu-id="6a62a-110">The configuration specifies the type of request (PKCS \#7), the name of the entity requesting the enrollment, and the name of the template.</span></span> <span data-ttu-id="6a62a-111">O modelo de usuário especifica que:</span><span class="sxs-lookup"><span data-stu-id="6a62a-111">The User template specifies that:</span></span>

-   <span data-ttu-id="6a62a-112">A solicitação deve usar o provedor criptográfico 1,0 da Microsoft ou o provedor de criptografia avançada da Microsoft 1,0.</span><span class="sxs-lookup"><span data-stu-id="6a62a-112">The request must use either the Microsoft Base Cryptographic Provider 1.0 or the Microsoft Enhanced Cryptographic Provider 1.0.</span></span>
-   <span data-ttu-id="6a62a-113">O nome da entidade deve ser criado a partir de Active Directory.</span><span class="sxs-lookup"><span data-stu-id="6a62a-113">The subject name must be built from Active Directory.</span></span>
-   <span data-ttu-id="6a62a-114">A solicitação inclui o nome do modelo de certificado, EKU (uso avançado de chave) e extensões de uso de chave.</span><span class="sxs-lookup"><span data-stu-id="6a62a-114">The request includes the Certificate Template Name, Enhanced Key Usage (EKU), and Key Usage extensions.</span></span> <span data-ttu-id="6a62a-115">A extensão EKU especifica que o certificado emitido pode ser usado para sistema de arquivos com criptografia (EFS), email seguro e autenticação de cliente.</span><span class="sxs-lookup"><span data-stu-id="6a62a-115">The EKU extension specifies that the issued certificate can be used for Encrypting File System (EFS), secure email, and client authentication.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="6a62a-116">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="6a62a-116">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="6a62a-117">Solicitações de amostra</span><span class="sxs-lookup"><span data-stu-id="6a62a-117">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
