---
description: O exemplo a seguir contém uma solicitação de arquivamento de chave CMC. O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
ms.assetid: e418ef57-90de-4374-b607-52823bbdd429
title: Solicitação de arquivamento de chave CMC
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118901613"
---
# <a name="cmc-key-archival-request"></a>Solicitação de arquivamento de chave CMC

O exemplo a seguir contém uma solicitação de arquivamento de chave CMC. O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
