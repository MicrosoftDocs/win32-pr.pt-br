...
Quando você instala o SDK (Kit de desenvolvimento de software) do Microsoft Windows, o exemplo é instalado, por padrão, na pasta *% ProgramFiles%* \\ SDKs do Microsoft \\ Windows \\ v 7.0 \\ Samples \\ X509 Certificate Enrollment \\ vc \\ enrollNestedCMC.
