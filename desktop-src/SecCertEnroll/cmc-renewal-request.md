---
description: O exemplo a seguir contém uma solicitação de renovação de CMC. O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
ms.assetid: 45b8e5f1-93e0-4216-945a-221a22acfd68
title: Solicitação de renovação de CMC
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103921361"
---
# <a name="cmc-renewal-request"></a>Solicitação de renovação de CMC

O exemplo a seguir contém uma solicitação de renovação de CMC. O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
...
A configuração especifica o tipo de solicitação (CMC) e o número de série do certificado no qual a solicitação se baseia. Isso gera a saída a seguir.
