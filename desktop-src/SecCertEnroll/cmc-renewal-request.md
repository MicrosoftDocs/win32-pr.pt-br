...
---
# <a name="cmc-renewal-request"></a><span data-ttu-id="a1ae1-105">Solicitação de renovação de CMC</span><span class="sxs-lookup"><span data-stu-id="a1ae1-105">CMC Renewal Request</span></span>

<span data-ttu-id="a1ae1-106">O exemplo a seguir contém uma solicitação de renovação de CMC.</span><span class="sxs-lookup"><span data-stu-id="a1ae1-106">The following example contains a CMC renewal request.</span></span> <span data-ttu-id="a1ae1-107">O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="a1ae1-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="a1ae1-108">O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.</span><span class="sxs-lookup"><span data-stu-id="a1ae1-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="a1ae1-109">A configuração especifica o tipo de solicitação (CMC) e o número de série do certificado no qual a solicitação se baseia.</span><span class="sxs-lookup"><span data-stu-id="a1ae1-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="a1ae1-110">Isso gera a saída a seguir.</span><span class="sxs-lookup"><span data-stu-id="a1ae1-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="a1ae1-111">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="a1ae1-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="a1ae1-112">Solicitações de amostra</span><span class="sxs-lookup"><span data-stu-id="a1ae1-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
