---
description: O exemplo a seguir contém uma \# solicitação PKCS 10. O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
ms.assetid: a71cd259-e5b0-42ee-a26c-fd949386ff9d
title: '\#Solicitação PKCS 10'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105760022"
---
# <a name="pkcs-10-request"></a>\#Solicitação PKCS 10

O exemplo a seguir contém uma \# solicitação PKCS 10. O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
