---
description: O exemplo a seguir mostra como usar a API de registro de certificado para enumerar os provedores instalados em um computador.
ms.assetid: d7fa03d5-775c-41f3-9fef-8929bd25ed92
title: Enumerando provedores instalados
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103828827"
---
# <a name="enumerating-installed-providers"></a><span data-ttu-id="19dfd-103">Enumerando provedores instalados</span><span class="sxs-lookup"><span data-stu-id="19dfd-103">Enumerating Installed Providers</span></span>

<span data-ttu-id="19dfd-104">O exemplo a seguir mostra como usar a API de registro de certificado para enumerar os provedores instalados em um computador.</span><span class="sxs-lookup"><span data-stu-id="19dfd-104">The following example shows how to use the Certificate Enrollment API to enumerate the providers installed on a computer.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="19dfd-105">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="19dfd-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="19dfd-106">Noções básicas sobre provedores criptográficos</span><span class="sxs-lookup"><span data-stu-id="19dfd-106">Understanding Cryptographic Providers</span></span>](understanding-cryptographic-providers.md)
</dt> </dl>
