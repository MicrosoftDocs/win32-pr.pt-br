...
---
# <a name="enumerating-installed-providers"></a>Enumerando provedores instalados

O exemplo a seguir mostra como usar a API de registro de certificado para enumerar os provedores instalados em um computador.
