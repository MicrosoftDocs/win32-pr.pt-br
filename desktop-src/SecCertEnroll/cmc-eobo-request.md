---
description: O exemplo a seguir contém uma solicitação de inscrição de CMC em nome de (EOBO). O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
ms.assetid: 05ec0b2c-56a5-4d9c-999b-23324134153b
title: Solicitação EOBO de CMC
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103662678"
---
# <a name="cmc-eobo-request"></a>Solicitação EOBO de CMC

O exemplo a seguir contém uma solicitação de inscrição de CMC em nome de (EOBO). O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
