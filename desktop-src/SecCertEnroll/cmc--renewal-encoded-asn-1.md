...
---
# <a name="cmc-renewal-encoded-asn1"></a><span data-ttu-id="85fc3-105">ASN codificado para renovação de CMC. 1</span><span class="sxs-lookup"><span data-stu-id="85fc3-105">CMC Renewal Encoded ASN.1</span></span>

<span data-ttu-id="85fc3-106">O exemplo a seguir contém uma solicitação de renovação de CMC mostrada no formato ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="85fc3-106">The following example contains a CMC renewal request shown in ASN.1 format.</span></span> <span data-ttu-id="85fc3-107">O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="85fc3-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="85fc3-108">O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.</span><span class="sxs-lookup"><span data-stu-id="85fc3-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="85fc3-109">A configuração especifica o tipo de solicitação (CMC) e o número de série do certificado no qual a solicitação se baseia.</span><span class="sxs-lookup"><span data-stu-id="85fc3-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="85fc3-110">Isso gera a saída a seguir.</span><span class="sxs-lookup"><span data-stu-id="85fc3-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="85fc3-111">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="85fc3-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="85fc3-112">Solicitações de amostra</span><span class="sxs-lookup"><span data-stu-id="85fc3-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
