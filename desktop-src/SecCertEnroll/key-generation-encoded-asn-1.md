---
description: O exemplo a seguir contém uma solicitação de geração de chave mostrada no formato ASN. 1.
ms.assetid: d08c33f8-f372-44d3-8c8e-a26440e85c34
title: ASN codificado de geração de chave. 1
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105755961"
---
# <a name="key-generation-encoded-asn1"></a><span data-ttu-id="50a45-103">ASN codificado de geração de chave. 1</span><span class="sxs-lookup"><span data-stu-id="50a45-103">Key Generation Encoded ASN.1</span></span>

<span data-ttu-id="50a45-104">O exemplo a seguir contém uma solicitação de geração de chave mostrada no formato ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="50a45-104">The following example contains a key generation request shown in ASN.1 format.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="50a45-105">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="50a45-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="50a45-106">Solicitações de amostra</span><span class="sxs-lookup"><span data-stu-id="50a45-106">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
