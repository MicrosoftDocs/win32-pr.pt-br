...
---
# <a name="cmc-request"></a><span data-ttu-id="00a2d-105">Solicitação de CMC</span><span class="sxs-lookup"><span data-stu-id="00a2d-105">CMC Request</span></span>

<span data-ttu-id="00a2d-106">O exemplo a seguir contém uma solicitação de certificado CMC.</span><span class="sxs-lookup"><span data-stu-id="00a2d-106">The following example contains a CMC certificate request.</span></span> <span data-ttu-id="00a2d-107">O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="00a2d-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="00a2d-108">O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.</span><span class="sxs-lookup"><span data-stu-id="00a2d-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="00a2d-109">Essa configuração gera a seguinte saída de exemplo.</span><span class="sxs-lookup"><span data-stu-id="00a2d-109">This configuration generates the following sample output.</span></span> <span data-ttu-id="00a2d-110">A configuração especifica o assunto, o tipo de solicitação (CMC) e o modelo de certificado (usuário).</span><span class="sxs-lookup"><span data-stu-id="00a2d-110">The configuration specifies the subject, type of request (CMC), and certificate template (User).</span></span> <span data-ttu-id="00a2d-111">O modelo de usuário especifica que:</span><span class="sxs-lookup"><span data-stu-id="00a2d-111">The User template specifies that:</span></span>

-   <span data-ttu-id="00a2d-112">A solicitação deve usar o provedor criptográfico 1,0 da Microsoft ou o provedor de criptografia avançada da Microsoft 1,0.</span><span class="sxs-lookup"><span data-stu-id="00a2d-112">The request must use either the Microsoft Base Cryptographic Provider 1.0 or the Microsoft Enhanced Cryptographic Provider 1.0.</span></span>
-   <span data-ttu-id="00a2d-113">O nome da entidade deve ser criado a partir de Active Directory.</span><span class="sxs-lookup"><span data-stu-id="00a2d-113">The subject name must be built from Active Directory.</span></span>
-   <span data-ttu-id="00a2d-114">A solicitação inclui o nome do modelo de certificado, EKU (uso avançado de chave) e extensões de uso de chave.</span><span class="sxs-lookup"><span data-stu-id="00a2d-114">The request includes the Certificate Template Name, Enhanced Key Usage (EKU), and Key Usage extensions.</span></span> <span data-ttu-id="00a2d-115">A extensão EKU especifica que o certificado emitido pode ser usado para sistema de arquivos com criptografia (EFS), email seguro e autenticação de cliente.</span><span class="sxs-lookup"><span data-stu-id="00a2d-115">The EKU extension specifies that the issued certificate can be used for Encrypting File System (EFS), secure email, and client authentication.</span></span>

<span data-ttu-id="00a2d-116">Uma solicitação de certificado CMC é representada pela interface [**IX509CertificateRequestCmc**](/windows/desktop/api/CertEnroll/nn-certenroll-ix509certificaterequestcmc) .</span><span class="sxs-lookup"><span data-stu-id="00a2d-116">A CMC certificate request is represented by the [**IX509CertificateRequestCmc**](/windows/desktop/api/CertEnroll/nn-certenroll-ix509certificaterequestcmc) interface.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="00a2d-117">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="00a2d-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="00a2d-118">Solicitações de amostra</span><span class="sxs-lookup"><span data-stu-id="00a2d-118">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
