---
description: O exemplo a seguir contém uma solicitação de certificado CMC. O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
ms.assetid: 54c9c447-5c97-462f-b9cb-2df7d4126d80
title: Solicitação de CMC
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105761876"
---
# <a name="cmc-request"></a>Solicitação de CMC

O exemplo a seguir contém uma solicitação de certificado CMC. O exemplo foi gerado usando as ferramentas Certreq.exe e Certutil.exe. O arquivo. inf usado como entrada para Certreq.exe contém a configuração a seguir.
...
Uma solicitação de certificado CMC é representada pela interface [**IX509CertificateRequestCmc**](/windows/desktop/api/CertEnroll/nn-certenroll-ix509certificaterequestcmc) .
