...
ms.locfileid: "118903695"
---
# <a name="sequence"></a>SEQUENCE

Uma **sequência** contém um campo ordenado de um ou mais tipos. Ele é codificado em um terceto TLV que começa com um byte de **marca** de 0x30. O seguinte Certutil.exe saída do tópico [ \# ASN. 1 codificado em PKCS 10](pkcs--10-encoded-asn-1.md) fornece vários exemplos de estruturas de dados de **sequência** . A saída mostra uma chave pública de 128 bytes e o expoente de três bytes.
