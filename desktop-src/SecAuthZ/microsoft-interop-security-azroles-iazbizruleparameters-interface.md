---
description: Links para documentação para os métodos e propriedades do wrapper de interoperabilidade do IAzBizRuleParameters.
ms.assetid: 5aa05570-32d2-446d-b7c0-6d63e3d3feae
title: Interface Microsoft. Interop. Security. AzRoles. IAzBizRuleParameters
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117781074"
---
# <a name="microsoftinteropsecurityazrolesiazbizruleparameters-interface"></a>Interface Microsoft. Interop. Security. AzRoles. IAzBizRuleParameters

Os métodos e as propriedades do wrapper de interoperabilidade **Microsoft. Interop. Security. Azroles. IAzBizRuleParameters** são documentados na versão com do método ou da propriedade. Um link para a documentação COM correlacionada segue cada nome de membro.

## <a name="members"></a>Membros

A interface **Microsoft. Interop. Security. AzRoles. IAzBizRuleParameters** tem estes tipos de membros:
...
A interface **Microsoft. Interop. Security. AzRoles. IAzBizRuleParameters** tem esses métodos.
...
| **Microsoft. Interop. Security. Azroles. IAzBizRuleParameters. Parameters**     | [**IAzBizRuleParameters:: Parameters**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleparameters-addparameters)<br/>         |
| **Microsoft. Interop. Security. Azroles. IAzBizRuleParameters. ParameterValue** | [**IAzBizRuleParameters:: ParameterValue**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleparameters-getparametervalue)<br/> |
...
A interface **Microsoft. Interop. Security. AzRoles. IAzBizRuleParameters** tem essas propriedades.



| Propriedade                                                                     | Tipo de acesso          | Descrição                                                                                    |
|:-----------------------------------------------------------------------------|:---------------------|:-----------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. Azroles. IAzBizRuleParameters. Count**<br/> | Somente leitura<br/> | [**Propriedade Count de IAzBizRuleParameters**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleparameters-get_count)<br/> |
