...
-   Os direitos de acesso específicos para tokens de acesso, que são listados na tabela a seguir.
    ...
    | ID do TOKEN de \_ ajuste \_  | Necessário para ajustar a ID de sessão de um token de acesso. o \_ privilégio de nome ES TCB \_ é necessário.                                                                                                                                                                                    |
    | \_atribuição \_ primária de token    | Necessário para anexar um [*token primário*](/windows/desktop/SecGloss/p-gly) a um [*processo*](/windows/desktop/SecGloss/p-gly). o \_ privilégio de nome ES ASSIGNPRIMARYTOKEN \_ também é necessário para realizar essa tarefa. |
