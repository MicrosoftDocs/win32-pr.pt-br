...
| **Membro \_ de {**_SidArray_*_}_*<br/>                         | Testa se a matriz de [**\_ \_ atributos e Sid**](/windows/desktop/api/Winnt/ns-winnt-sid_and_attributes) do contexto do cliente contém todos os SIDs ( [identificadores de segurança](security-identifiers.md) ) na lista separada por vírgulas especificada por *SidArray*.<br/> para permitir ACEs, um SID de contexto de cliente deve ter o atributo de **ES \_ grupo \_ habilitado** definido para ser considerado uma correspondência.<br/> para Deny ACEs, um SID de contexto de cliente deve ter **o \_ grupo \_ de ES habilitado** ou o **uso do \_ grupo \_ de ES \_ para \_ negação \_** de atributo definido para ser considerado uma correspondência.<br/> A matriz *SidArray* pode conter cadeias de caracteres Sid (por exemplo, "S-1-5-6") ou aliases de Sid (por exemplo, "BA"<br/> |
