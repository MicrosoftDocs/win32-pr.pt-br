...
A interface Teredo é basicamente suportada pelo Windows Vista e pelo Windows Server 2008. A funcionalidade limitada da interface teredo com suporte do Windows XP com Service Pack 2 (SP2) e Windows Server 2003 é detalhada no [recebimento do tráfego solicitado por Teredo](receiving-solicited-traffic-over-teredo.md).
