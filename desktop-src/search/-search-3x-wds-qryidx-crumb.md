---
description: entenda como usar o argumento de trilha em Windows pesquisa como um meio de controlar o escopo de uma pesquisa.
ms.assetid: b0b974ae-0573-45e4-888e-07138604b62e
title: argumento de trilha (pesquisa de Windows)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "122886831"
---
# <a name="crumb-argument-windows-search"></a>argumento de trilha (pesquisa de Windows)
...
para Windows pesquisa no Windows XP (WDS 3. x), os termos de AQS "kind" e "store" têm uma implementação especial. Os valores de "Kind" são os mesmos [valores usados no WDS 2. x](../lwef/-search-2x-wds-perceivedtype.md). Os valores de "Store" incluem o seguinte:
