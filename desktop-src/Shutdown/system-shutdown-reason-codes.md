...
| <span id="SHTDN_REASON_FLAG_PLANNED"></span><span id="shtdn_reason_flag_planned"></span><dl> <dt>**SHTDN \_ MOTIVO \_ do \_ sinalizador demarcado**</dt> <dt>0x80000000</dt> </dl>                 | O desligamento foi planejado. O sistema gera um arquivo de dados de estado do sistema (SSD). Esse arquivo contém informações de estado do sistema, como processos, threads, uso de memória e configuração. <br/> Se esse sinalizador não estiver presente, o desligamento não foi planejado. As opções de notificação e relatório são controladas por um conjunto de políticas. Por exemplo, depois de fazer logon, o sistema exibirá uma caixa de diálogo relatando o desligamento não planejado se a política tiver sido habilitada. Um arquivo SSD será criado somente se a política de SSD estiver habilitada no sistema. O administrador pode usar [relatório de erros do Windows](../wer/windows-error-reporting.md) para enviar os dados de SSD para um local central ou para a Microsoft.<br/> |



## <a name="remarks"></a>Comentários

As combinações a seguir são reconhecidas pelo sistema. A tabela indica a cadeia de caracteres exibida no controlador de eventos de desligamento e fornece uma descrição mais detalhada. A cadeia de caracteres padrão é "nenhum título para esse motivo foi encontrado".



| Combinação                                                                                                | Descrição                                                                                                                                                                                                                                      |
|------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| \_motivo SHTDN \_ principal \_ SHTDN do aplicativo \| motivo do \_ \_ \_ desligamento secundário                                            | "Aplicativo: sem resposta" um reinício ou desligamento não planejado para solucionar problemas de um aplicativo sem resposta.<br/>                                                                                                                             |
| SHTDN \_ motivo \_ principal do \_ aplicativo \| SHTDN motivo da \_ \_ \_ instalação secundária \| SHTDN sinalizador de \_ motivo \_ \_ planejado    | "Aplicativo: instalação (planejada)" uma reinicialização planejada ou desligamento para executar a instalação do aplicativo.<br/>                                                                                                                              |
| \_motivo SHTDN \_ principal \_ SHTDN do aplicativo \| motivo da \_ \_ \_ manutenção secundária                                     | "Aplicativo: manutenção (não planejada)" uma reinicialização ou desligamento não planejado para atender a um aplicativo.<br/>                                                                                                                                    |
| SHTDN \_ motivo \_ principal do \_ aplicativo \| SHTDN motivo de \_ \_ \_ manutenção secundária \| SHTDN sinalizador de \_ motivo \_ \_ planejado     | "Aplicativo: manutenção (planejada)" uma reinicialização planejada ou desligamento para executar a manutenção planejada em um aplicativo.<br/>                                                                                                                  |
| \_motivo SHTDN \_ principal \_ SHTDN do aplicativo \| \_ motivo \_ secundário \_ instável                                        | "Aplicativo: instável" um reinício ou desligamento não planejado para solucionar problemas de um aplicativo instável.<br/>                                                                                                                                     |
| \_motivo SHTDN \_ principal \_ SHTDN de hardware \| motivo da \_ \_ \_ instalação secundária                                       | "Hardware: instalação (não planejada)" uma reinicialização ou desligamento não planejado para começar ou concluir a instalação do hardware.<br/>                                                                                                                     |
| \_motivo SHTDN \_ principal \_ SHTDN de hardware \| motivo de \_ \_ \_ instalação secundária \| SHTDN sinalizador de \_ motivo \_ \_ planejado       | "Hardware: instalação (planejada)" uma reinicialização planejada ou desligamento para iniciar ou concluir a instalação do hardware.<br/>                                                                                                                          |
| \_motivo SHTDN \_ principal \_ SHTDN de hardware \| motivo de \_ \_ \_ manutenção secundária                                        | "Hardware: manutenção (não planejada)" uma reinicialização ou desligamento não planejado para o hardware de serviço no sistema.<br/>                                                                                                                               |
| \_motivo SHTDN \_ principal \_ SHTDN de hardware \| motivo de \_ \_ \_ manutenção secundária \| SHTDN sinalizador de \_ motivo \_ \_ planejado        | "Hardware: manutenção (planejada)" uma reinicialização planejada ou desligamento para o hardware de serviço no sistema.<br/>                                                                                                                                    |
| \_motivo SHTDN \_ da \_ API herdada principal \_                                                                          | "Desligamento de API herdada" esse desligamento foi iniciado pela função [**InitiateSystemShutdown**](/windows/desktop/api/Winreg/nf-winreg-initiatesystemshutdowna) herdada. Os aplicativos devem usar a função [**InitiateSystemShutdownEx**](/windows/desktop/api/Winreg/nf-winreg-initiatesystemshutdownexa) .<br/> |
| SHTDN \_ do \_ principal sistema \_ operacional \| SHTDN motivo de \_ \_ \_ hotfix secundário                                      | "Sistema operacional: Hot Fix (não planejado)" uma reinicialização ou desligamento não planejado para instalar um Hot Fix.<br/>                                                                                                                                        |
| SHTDN \_ motivo \_ principal \_ SHTDN de sistema operacional \| \_ motivo \_ secundário \_ hotfix \| SHTDN \_ sinalizador de motivo \_ \_ planejado      | "Sistema operacional: Hot Fix (planejado)" uma reinicialização planejada ou desligamento para instalar um Hot Fix.<br/>                                                                                                                                             |
| SHTDN \_ do \_ principal sistema \_ operacional \| SHTDN \_ motivo pelo qual a \_ \_ reconfiguração secundária                                    | "Sistema operacional: reconfiguração (não planejada)" uma reinicialização ou desligamento não planejado para alterar a configuração do sistema operacional.<br/>                                                                                                        |
| SHTDN \_ motivo \_ principal \_ SHTDN de sistema operacional \| motivo de \_ \_ \_ reconfiguração secundária \| SHTDN sinalizador de \_ motivo \_ \_ planejado    | "Sistema operacional: reconfiguração (planejada)" uma reinicialização planejada ou desligamento para alterar a configuração do sistema operacional.<br/>                                                                                                             |
| SHTDN \_ motivo \_ principal \_ SHTDN de sistema operacional, \| \_ motivo \_ secundário \_ SECURITYFIX                                 | "Sistema operacional: correção de segurança (não planejada)" uma reinicialização ou desligamento não planejado para instalar um patch de segurança.<br/>                                                                                                                            |
| SHTDN \_ motivo \_ principal \_ SHTDN de sistema operacional \| \_ motivo \_ secundário \_ SECURITYFIX \| sinalizador de \_ motivo SHTDN \_ \_ planejado | "Sistema operacional: correção de segurança (planejada)" uma reinicialização planejada ou desligamento para instalar um patch de segurança.<br/>                                                                                                                                 |
| SHTDN \_ motivo \_ principal \_ SHTDN de sistema operacional \| \_ motivo \_ secundário do \_ Service Pack \| SHTDN sinalizador de \_ motivo \_ \_ planejado | "Sistema operacional: Service Pack (planejado)" uma reinicialização planejada ou desligamento para instalar um service pack.<br/>                                                                                                                                   |
| SHTDN \_ motivo \_ principal \_ SHTDN de sistema operacional \| motivo de \_ \_ \_ atualização secundária \| SHTDN sinalizador de \_ motivo \_ \_ planejado     | "Sistema operacional: atualização (planejada)" uma reinicialização planejada ou desligamento para atualizar a configuração do sistema operacional.<br/>                                                                                                                    |
| SHTDN \_ motivo \_ principal \_ outro \| SHTDN \_ motivo \_ secundário \_                                                 | "Outro (não planejado)" um desligamento ou reinicialização não planejado.<br/>                                                                                                                                                                                 |
| \_motivo SHTDN \_ principal \_ outro \| SHTDN \_ motivo menor que o sinalizador de \_ \_ \| motivo de SHTDN \_ \_ \_ mais baixou                 | "Outro (planejado)" um desligamento ou reinicialização planejado.<br/>                                                                                                                                                                                      |
| \_motivo SHTDN \_ principal \_ outro \| SHTDN \_ motivo \_ secundário \_ travado                                                  | "Outra falha: sistema sem resposta" o sistema parou de responder.<br/>                                                                                                                                                                  |
| \_motivo SHTDN \_ principal \_ \| SHTDN motivo de CORDUNPLUGGED de energia \_ \_ secundário \_                                         | "Falha de energia: cabo desconectado" o computador foi desconectado.<br/>                                                                                                                                                                           |
| motivo SHTDN do \_ \_ principal \_ \| \_ \_ \_ ambiente de SHTDN de motivos de energia                                           | "Falha de energia: ambiente" houve uma interrupção de energia.<br/>                                                                                                                                                                                |
| SHTDN \_ motivo \_ principal do \_ sistema \| SHTDN \_ motivo \_ secundário \_ BLUESCREEN                                           | "Falha do sistema: parar erro" o computador exibiu um evento de falha de tela azul.<br/>                                                                                                                                                        |
| SHTDN \_ motivo \_ principal do \_ sistema \| SHTDN motivo de conectividade de \_ \_ \_ rede menor \_                                | "Perda de conectividade de rede (não planejada)" o computador precisa ser desligado devido a um problema de conectividade de rede.<br/>                                                                                                                    |
| SHTDN \_ motivo \_ principal do \_ sistema \| SHTDN motivo de \_ \_ \_ segurança mínima                                             | "Problema de segurança" o computador precisa ser desligado devido a um problema de segurança.<br/>                                                                                                                                                          |



 

Você também pode definir seus próprios motivos de desligamento e adicioná-los ao registro. Cada código de motivo deve ser armazenado como um valor de registro na seguinte chave:**HKEY \_ local \_ Machine \\ software \\ Microsoft \\ Windows \\ CurrentVersion \\ confiabilidade \\ userdefine \\<\_ ID do idioma do sistema padrão \_ \_>**

Essa chave contém nomes de valores do seguinte formato: *xxxxx*; *nnn*; *nnnnn*. Os pontos-e-vírgulas delimitam os componentes de um nome de valor.
...
| S    | Exibir a caixa de diálogo de desligamento esperado. S, D ou S e D devem ser usados.<br/>   |
| D    | Exibir a caixa de diálogo desligamento inesperado. S, D ou S e D devem ser usados.<br/> |
...
Razão principal. Esse componente deve ser um número no intervalo de 64-255. O intervalo de 0-63 é reservado para uso pelo sistema.
...
Razão secundária. Esse componente deve estar no intervalo de 0-65535.

</dd> </dl>

Os motivos personalizados são classificados na interface do usuário pelo número principal do motivo e, em seguida, pelo número da razão secundária. Duas razões personalizadas podem usar as mesmas razões principais e secundárias, a menos que uma esteja planejada e a outra não esteja planejada. Caso contrário, o sistema usará a primeira instância e ignorará as outras.

Os dados para cada valor de registro são duas cadeias de caracteres, separadas por \\ n \\ r. A primeira cadeia de caracteres é uma cadeia de título a ser exibida na caixa de diálogo de desligamento e gravada no log de eventos. O tamanho máximo é de 64 caracteres. As cadeias de caracteres de título devem ser exclusivas. Os títulos personalizados não podem corresponder aos títulos padrão definidos pelo sistema ou a outro título personalizado. A segunda cadeia de caracteres é uma descrição da cadeia de caracteres a ser exibida na caixa de diálogo de desligamento; é opcional. O tamanho máximo é de 256 caracteres.
...
| parâmetro<br/>                   | <dl> <dt>Razão. h</dt> </dl> |
