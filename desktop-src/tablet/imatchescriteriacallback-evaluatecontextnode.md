...
*pContextNodeToEvaluate* \[ no\]
</dt> <dd>

O objeto [**IContextNode**](icontextnode.md) a ser avaliado.
...
**Variante \_ TRUE** se *pContextNodeToEvaluate* corresponder aos critérios; caso contrário, **Variant \_ false**.
