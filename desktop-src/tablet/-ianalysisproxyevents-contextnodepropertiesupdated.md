...
Ocorre depois que o [**IInkAnalyzer**](iinkanalyzer.md) atualiza uma ou mais propriedades de um objeto [**IContextNode**](icontextnode.md) .
...
O objeto [**IInkAnalyzer**](iinkanalyzer.md) atualizando as propriedades.

</dd> <dt>

*pContextNodeUpdated* \[ no\]
</dt> <dd>

O objeto [**IContextNode**](icontextnode.md) cujas propriedades são atualizadas.
