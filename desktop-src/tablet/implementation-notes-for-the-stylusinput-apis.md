...
As classes [**RealTimeStylus**](realtimestylus-class.md), [GestureRecognizer](/previous-versions/ms575185(v=vs.100))e [DynamicRenderer](/previous-versions/ms575176(v=vs.100)) são implementadas como wrappers com e estão disponíveis somente em código gerenciado.

Quando o objeto [**RealTimeStylus**](realtimestylus-class.md), [GestureRecognizer](/previous-versions/ms575185(v=vs.100))ou [DynamicRenderer](/previous-versions/ms575176(v=vs.100)) é adicionado como um plug-in a um objeto **RealTimeStylus** , os objetos COM subjacentes interagem no nível de com. Portanto, chamar diretamente os métodos das interfaces [IStylusSyncPlugin](/previous-versions/ms575201(v=vs.100)) ou [IStylusAsyncPlugin](/previous-versions/ms575194(v=vs.100)) não tem suporte. Adicionar o objeto **RealTimeStylus**, GestureRecognizer ou DynamicRenderer ao objeto **RealTimeStylus** é a única maneira de acessar esses recursos.
