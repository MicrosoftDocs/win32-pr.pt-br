...
> [!Caution]  
> Para evitar um vazamento de memória, chame [**IUnknown:: Release**](/windows/desktop/api/unknwn/nf-unknwn-iunknown-release) em \* *ppContextLinks* quando você não precisar mais usar a coleção de links de contexto.
...
Para obter mais informações sobre os tipos de relações que são descritos por links, consulte [**IContextLink**](icontextlink.md) e [**ContextLinkDirection**](contextlinkdirection.md).
