...
A tabela a seguir descreve quais threads os eventos do objeto [**RecognizerContext**](inkrecognizercontext-class.md) podem acionar.
...
| [**RecognitionWithAlternates**](inkrecognizercontext-recognitionwithalternates.md) | Acionado no thread de reconhecimento em segundo plano.<br/>                                                                                                                                                               |
