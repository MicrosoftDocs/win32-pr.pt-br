...
---
# <a name="iinkanalysisrecognizersgetcount-method"></a>Método IInkAnalysisRecognizers:: GetCount

Recupera o número de objetos [**IInkAnalysisRecognizer**](iinkanalysisrecognizer.md) nesta coleção.
...
O número de objetos [**IInkAnalysisRecognizer**](iinkanalysisrecognizer.md) nesta coleção.
