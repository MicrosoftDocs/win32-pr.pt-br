---
description: Este tópico contém a definição do esquema de leitor do diário.
ms.assetid: 2fa6a5d9-64d6-447f-bf2a-d3bf6ca7c093
title: Definição de esquema do leitor de diário
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105769642"
---
# <a name="journal-reader-schema-definition"></a><span data-ttu-id="07658-103">Definição de esquema do leitor de diário</span><span class="sxs-lookup"><span data-stu-id="07658-103">Journal Reader Schema Definition</span></span>

<span data-ttu-id="07658-104">Este tópico contém a definição do esquema de leitor do diário.</span><span class="sxs-lookup"><span data-stu-id="07658-104">This topic contains the definition of the Journal Reader schema.</span></span>

## <a name="schema"></a><span data-ttu-id="07658-105">Esquema</span><span class="sxs-lookup"><span data-stu-id="07658-105">Schema</span></span>
