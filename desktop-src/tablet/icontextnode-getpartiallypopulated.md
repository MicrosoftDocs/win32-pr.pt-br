...
Recupera o valor que indica se um objeto [**IContextNode**](icontextnode.md) está parcialmente populado ou totalmente preenchido.
...
*pfPartiallyPopulated* \[ fora\]
</dt> <dd>

**Variante \_ TRUE** se este objeto [**IContextNode**](icontextnode.md) não contiver dados completos; caso contrário, **Variant \_ false**.
