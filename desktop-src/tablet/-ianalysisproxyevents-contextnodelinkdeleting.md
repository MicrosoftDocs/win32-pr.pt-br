---
description: Ocorre antes que o IInkAnalyzer exclua um objeto IContextLink entre dois objetos IContextNode.
ms.assetid: bc9716b8-8793-4886-aff4-d880024129a6
title: _IAnalysisProxyEvents::Evento ContextNodeLinkDeleting (IACom.h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
Ocorre antes que [**o IInkAnalyzer**](iinkanalyzer.md) exclua um [**objeto IContextLink**](icontextlink.md) entre dois [**objetos IContextNode.**](icontextnode.md)
