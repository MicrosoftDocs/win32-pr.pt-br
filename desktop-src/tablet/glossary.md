...
<span id="tablet.tablet_glossary_ink_analysis"></span><span id="TABLET.TABLET_GLOSSARY_INK_ANALYSIS"></span>**análise de tinta**
</dt> <dd>

O processo de examinar programaticamente a entrada de tinta.
...
<span id="tablet.tablet_glossary_microsoft_gesture_recognizer"></span><span id="TABLET.TABLET_GLOSSARY_MICROSOFT_GESTURE_RECOGNIZER"></span>**Reconhecedor de gestos da Microsoft**
</dt> <dd>

Um mecanismo que reconhece e processa a entrada de tinta como comandos do sistema ou do aplicativo.
...
<span id="tablet.tablet_glossary_recognizer_context"></span><span id="TABLET.TABLET_GLOSSARY_RECOGNIZER_CONTEXT"></span>**contexto do reconhecedor**
</dt> <dd>

Informações específicas do aplicativo que o reconhecedor usa para executar o reconhecimento de tinta.
