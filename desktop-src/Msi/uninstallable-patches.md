...
-   Uma [atualização importante](major-upgrades.md) aplicada por um patch não é desinstalável. As principais atualizações de um aplicativo devem ser executadas instalando o aplicativo atualizado (.msi arquivo) em vez de um patch.
