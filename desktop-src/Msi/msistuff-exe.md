...
| **-d**               | \_banco de dados ISETUPPROPNAME     | Defina msi, o nome do arquivo de .msi. Esse é um caminho relativo para o arquivo de .msi em relação ao local do programa de Setup.exe. Essa opção será necessária se a opção-m não for especificada. As opções-d e-m são mutuamente exclusivas. Eles não podem ser ambos especificados.                                                                                                                                                                                                                                                    |
