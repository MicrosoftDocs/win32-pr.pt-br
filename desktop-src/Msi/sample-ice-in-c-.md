---
description: Este código de exemplo é de uma ação personalizada de ICE (ICE01). Ele valida que o mecanismo ICE está funcionando exibindo a hora. A ICE posta uma mensagem fornecendo a hora em que o instalador chamou o ICE. Essa ICE nunca deve retornar um erro.
ms.assetid: 7e580f6b-8adf-4b11-9072-5b2e1506fabb
title: ICE de exemplo em C++
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105752239"
---
# <a name="sample-ice-in-c"></a><span data-ttu-id="a2ea8-106">ICE de exemplo em C++</span><span class="sxs-lookup"><span data-stu-id="a2ea8-106">Sample ICE in C++</span></span>

<span data-ttu-id="a2ea8-107">Este código de exemplo é de uma ação personalizada de ICE ( [ICE01](ice01.md)).</span><span class="sxs-lookup"><span data-stu-id="a2ea8-107">This sample code is from an ICE custom action ( [ICE01](ice01.md)).</span></span> <span data-ttu-id="a2ea8-108">Ele valida que o mecanismo ICE está funcionando exibindo a hora.</span><span class="sxs-lookup"><span data-stu-id="a2ea8-108">It validates that the ICE mechanism is working by displaying the time.</span></span> <span data-ttu-id="a2ea8-109">A ICE posta uma mensagem fornecendo a hora em que o instalador chamou o ICE.</span><span class="sxs-lookup"><span data-stu-id="a2ea8-109">The ICE posts a message giving the time the installer called the ICE.</span></span> <span data-ttu-id="a2ea8-110">Essa ICE nunca deve retornar um erro.</span><span class="sxs-lookup"><span data-stu-id="a2ea8-110">This ICE should never return an error.</span></span>
