...
---
# <a name="sample-ice-in-c"></a>ICE de exemplo em C++

Este código de exemplo é de uma ação personalizada de ICE ( [ICE01](ice01.md)). Ele valida que o mecanismo ICE está funcionando exibindo a hora. A ICE posta uma mensagem fornecendo a hora em que o instalador chamou o ICE. Essa ICE nunca deve retornar um erro.
