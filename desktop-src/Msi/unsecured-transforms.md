...
Durante uma [instalação de manutenção](maintenance-installation.md), o instalador pesquisa a transformação no local do cache. Se a cópia armazenada em cache da transformação ficar indisponível, o instalador pesquisará a transformação na origem do pacote ao lado do arquivo. msi.
