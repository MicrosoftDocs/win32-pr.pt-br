...
-   no Windows Vista com Windows Installer, um membro do grupo administradores pode fornecer autorização para que um não administrador eleve a instalação por meio do uac ( [*controle de conta de usuário*](u-gly.md) ), conforme descrito em usando o [Windows Installer com o UAC](using-windows-installer-with-uac.md).
