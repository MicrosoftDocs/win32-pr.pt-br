---
description: Para obter uma lista completa dos códigos de erro retornados pelas funções Windows Installer MsiExec.exe e InstMsi.exe, consulte MsiExec.exe e InstMsi.exe mensagens de erro.
