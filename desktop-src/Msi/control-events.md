...
---
# <a name="control-events-windows-installer"></a>Eventos de controle (Windows Installer)
...
| Evento de controle                                                       | Breve descrição do ControlEvent,                                                                                                                                                                             |
|---------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| [EnableRollback](enablerollback-controlevent.md)                   | Usado para desativar e desativar os recursos de rollback.                                                                                                                                                                |
| [EndDialog](enddialog-controlevent.md)                             | Notifica o instalador para remover uma caixa de diálogo modal.                                                                                                                                                          |
| [IgnoreChange](ignorechange-controlevent.md)                       | Publicado pelo controle Directorylist quando uma pasta é realçada, mas não é aberta.                                                                                                                           |
| [MsiLaunchApp](msilaunchapp-controlevent.md)                       | Esse evento de controle executa um arquivo especificado. **[Windows Installer 4,5 e anteriores](not-supported-in-windows-installer-4-5.md):** Sem suporte.<br/>                                                       |
| [MsiPrint](msiprint-controlevent.md)                               | Permite que o usuário imprima o conteúdo do [controle ScrollableText](scrollabletext-control.md). **[Windows Installer 4,5 e anteriores](not-supported-in-windows-installer-4-5.md):** Sem suporte.<br/> |
...
| [Remover](remove-controlevent.md)                                   | Notifica o instalador quando os recursos são selecionados para remoção.                                                                                                                                                |
...
| [RmShutdownAndRestart](rmshutdownandrestart-controlevent.md)       | Use o [Gerenciador de reinicialização](/windows/desktop/RstMgr/restart-manager-portal) para desligar todos os aplicativos que têm arquivos em uso e para reiniciá-los no final da instalação.                                                              |
...
| [SelectionNoItems](selectionnoitems-controlevent.md)               | Usado pelo SelectionTree para excluir texto ou Desabilitar botões.                                                                                                                                                      |
...
| [Em andamento](setprogress-controlevent.md)                         | Publicado pelo instalador para fornecer o progresso da instalação.                                                                                                                                                  |
...
| [ValidateProductID](validateproductid-controlevent.md)             | Define ProductID como a ID de produto completa.                                                                                                                                                                        |
