...
O método **SourceListClearMediaDisk** do objeto [**Product**](product-object.md) remove um disco especificado do conjunto de discos registrados para um produto. Aceita *DiskId* como um parâmetro. Esse método chama [**MsiSourceListClearMediaDisk**](/windows/desktop/api/Msi/nf-msi-msisourcelistclearmediadiska).
