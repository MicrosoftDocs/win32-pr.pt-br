...
O método **ReinstallFeature** do objeto do [**instalador**](installer-object.md) reinstala recursos ou corrige problemas com os recursos instalados.
...
Especifica o recurso a ser reinstalado. O recurso pai ou o recurso filho do recurso especificado não é reinstalado. Para reinstalar o recurso pai ou filho, você deve chamar o método **ReinstallFeature** para cada um separadamente ou usar o método [**ReinstallProduct**](installer-reinstallproduct.md) .
