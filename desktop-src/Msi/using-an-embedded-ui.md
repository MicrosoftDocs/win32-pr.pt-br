...
| MsiEmbeddedUI | FileName    | Atributos | MessageFilter | Dados            |
|---------------|-------------|------------|---------------|-----------------|
...
O DLL da interface do usuário personalizada, neste exemplo embedui.dll, deve exportar as funções *InitializeEmbeddedUI*, *EmbeddedUIHandler* e *ShutdownEmbeddedUI* definidas pelo usuário. O código de exemplo a seguir ilustra essas funções.
