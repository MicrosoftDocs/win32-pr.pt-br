---
description: O sequenciamento das ações a seguir é irrestrito. Essas ações podem ser colocadas em qualquer lugar na sequência de ação.
ms.assetid: 35ccfad2-b022-4446-8275-a3b26f4e4db2
title: Ações sem restrições de sequenciamento
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119559516"
---
# <a name="actions-without-sequencing-restrictions"></a>Ações sem restrições de sequenciamento

O sequenciamento das ações a seguir é irrestrito. Essas ações podem ser colocadas em qualquer lugar na sequência de ação.
