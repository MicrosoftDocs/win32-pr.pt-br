...
Uma ferramenta de mesclagem avalia a tabela ModuleInstallUISequence e, em seguida, insere as ações calculadas na [tabela InstallUISequence](installuisequence-table.md) com um número de sequência correto.

A tabela ModuleInstallUISequence tem as colunas a seguir.
...
Se essa tabela estiver presente, a [tabela InstallUISequence](installuisequence-table.md) também deverá estar presente no módulo de mesclagem.
