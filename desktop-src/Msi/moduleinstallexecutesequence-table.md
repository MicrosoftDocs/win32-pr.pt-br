...
Uma ferramenta de mesclagem avalia a tabela ModuleInstallExecuteSequence e, em seguida, insere as ações calculadas na [tabela InstallExecuteSequence](installexecutesequence-table.md) com um número de sequência correto.
...
Ação a ser inserida em sequência. Refere-se a uma das [ações padrão](standard-actions.md)do instalador ou a uma entrada na tabela [CustomAction](customaction-table.md)ou [tabela de diálogo](dialog-table.md)do módulo de mesclagem.
...
Uma instrução condicional que indica se a ação deve ser executada. Um valor nulo é avaliado como true.

</dd> </dl>

## <a name="remarks"></a>Comentários

Se a [tabela ModuleInstallExecuteSequence](installexecutesequence-table.md) estiver presente, a [tabela InstallExecuteSequence](installexecutesequence-table.md) também deverá estar presente no módulo de mesclagem.
