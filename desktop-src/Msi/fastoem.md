...
para exibir o tamanho do aplicativo em adicionar ou remover programas no painel de controle Windows 2000, você deve gravar manualmente o valor de EstimatedSize na chave
...
Use a seguinte linha de comando de exemplo se o CD-ROM enviado para os usuários finais armazenar o pacote de instalação do aplicativo na raiz do CD-ROM. Observe que o rótulo de volume na [tabela de mídia](media-table.md) do arquivo de .msi deve corresponder ao rótulo de volume do CD-ROM.

**Msiexec/I C: \\ TempImage \\package.msi/qn/Le logfile.txt AllUsers = 1 FASTOEM = 1 DISABLEROLLBACK = 1 ROOTDRIVE = C:\\**

Use a seguinte linha de comando de exemplo se o pacote de instalação não estiver localizado na raiz do CD-ROM enviado aos usuários finais. Você deve definir a propriedade [**MEDIAPACKAGEPATH**](mediapackagepath.md) nesse caso como o caminho para o pacote de instalação. O rótulo de volume na [tabela de mídia](media-table.md) do arquivo de .msi deve corresponder ao rótulo de volume do CD-ROM. Nesse caso, siga este exemplo.
