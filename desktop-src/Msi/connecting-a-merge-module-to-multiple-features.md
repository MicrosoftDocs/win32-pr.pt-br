---
description: O Conexão método do Objeto de Mesclagem pode ser usado para conectar um módulo a um recurso adicional que foi mesclado ao banco de dados ou que será mesclado no banco de dados. O recurso deve existir antes de chamar esse método.
