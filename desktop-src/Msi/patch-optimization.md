...
se um patch modificar apenas as tabelas a seguir, Windows Installer 3,0 ou posterior ignorará as ações associadas a todas as outras tabelas, mesmo se essas ações estiverem listadas nas tabelas de sequência do pacote de instalação do aplicativo original (.msi arquivo).
