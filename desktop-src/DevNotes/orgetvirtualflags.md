...
Recupera os sinalizadores virtuais na chave do registro aberta especificada em um hive do registro offline.
...
| Valor                                                                                                                                                                                                                                                    | Significado                                                                                                                                                                                                                                                                                                                                       |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="REG_KEY_DONT_SILENT_FAIL"></span><span id="reg_key_dont_silent_fail"></span><dl> <dt>**Reg \_ CHAVE \_ não \_ silenciosa com \_ falha**</dt> <dt>4</dt> </dl> | Se esse sinalizador for definido e uma operação de abertura falhar em uma chave com virtualização habilitada, o registro não tentará reabrir a chave. Se esse sinalizador for claro, o registro tentará reabrir a chave com o \_ acesso máximo permitido.<br/>                                                                                            |
