---
description: 'As seguintes enumerações são usadas na enumeração de recursos:'
ms.assetid: fb43b8b4-04ed-4fcf-9df3-cdcad1a73fb5
title: Enumerações de enumeração de recursos
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104370431"
---
# <a name="resource-enumeration-enumerations"></a>Enumerações de enumeração de recursos

As seguintes enumerações são usadas na enumeração de recursos:

-   [**eAvrfResourceTypes**](/windows/desktop/api/Avrfsdk/ne-avrfsdk-eavrfresourcetypes)
-   [**\_operações de rastreamento do eHANDLE \_**](/windows/desktop/api/Avrfsdk/ne-avrfsdk-ehandle_trace_operations)
