...
---
# <a name="ntgdiddlock-function"></a>Função NtGdiDdLock
...
Bloqueia uma área especificada de memória de superfície e fornece um ponteiro válido para um bloco de memória associado a uma superfície.
...
Identificador para uma [**estrutura \_ \_ local de superfície do DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) que descreve a superfície associada à região da memória a ser bloqueada.
...
**NtGdiDdLock** retorna um dos seguintes códigos de retorno de chamada.
