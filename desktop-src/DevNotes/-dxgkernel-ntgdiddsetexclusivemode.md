...
*puSetExclusiveModeData* \[ entrada, saída\]
</dt> <dd>

Ponteiro para uma [**estrutura \_ SETEXCLUSIVEMODEDATA do DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_setexclusivemodedata) que contém as informações de notificação.
