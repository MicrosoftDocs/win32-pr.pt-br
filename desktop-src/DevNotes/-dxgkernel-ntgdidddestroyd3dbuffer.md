...
Destrói um objeto de superfície do Microsoft DirectDraw do modo de kernel alocado anteriormente que foi criado com o membro **dwCaps** da estrutura [**DDSCAPS**](/previous-versions/windows/hardware/drivers/ff550286(v=vs.85)) definida como DDSCAPS \_ EXECUTEBUFFER.
...
Identificador para uma [**estrutura \_ DESTROYSURFACEDATA do DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_destroysurfacedata) que contém as informações necessárias para destruir um comando do Direct3D ou um buffer de vértice.
