...
---
# <a name="ntgdiddunlockd3d-function"></a>Função NtGdiDdUnlockD3D
...
Usado para liberar um bloqueio mantido em uma área especificada da memória de buffer.
...
Ponteiro para uma [**estrutura \_ \_ local de superfície DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) que descreve a superfície a ser desbloqueada.

</dd> <dt>

*puUnlockData* \[ entrada, saída\]
</dt> <dd>

Ponteiro para uma [**estrutura \_ UNLOCKDATA do DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_unlockdata) que contém as informações necessárias para executar a liberação de bloqueio.

</dd> </dl>

## <a name="return-value"></a>Retornar valor

**NtGdiDdUnlockD3D** retorna um dos seguintes códigos de retorno de chamada.
