...
A sintaxe a seguir ilustra a criação de um gabinete.

> [!Note]  
> Esse código é apenas para fins ilustrativos. Para compilar, as funções de retorno de chamada devem ser definidas.
