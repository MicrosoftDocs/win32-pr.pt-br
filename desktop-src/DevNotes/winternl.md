...
-   [Chamando APIs internas](calling-internal-apis.md)
-   [Obtendo a ID da sessão de console ativa](getting-the-active-console-session-id.md)
-   [Obtendo a ID de sessão do processo atual](getting-the-session-id-of-the-current-process.md)
-   [**\_informações de consulta TCP de IOCTL \_ \_ \_ ex**](/windows/desktop/api/Tcpioctl/ni-tcpioctl-ioctl_tcp_query_information_ex)
