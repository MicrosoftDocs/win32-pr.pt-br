...
Permite que o driver relate que internamente aloca memória de vídeo para executar a compensação de movimento.
...
*puGetInternalData* \[ entrada, saída\]
</dt> <dd>

Ponteiro para uma [**estrutura \_ GETINTERNALMOCOMPDATA do DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getinternalmocompdata) que contém os requisitos de memória interna.

</dd> </dl>

## <a name="return-value"></a>Retornar valor

**NtGdiDdGetInternalMoCompInfo** retorna um dos seguintes códigos de retorno de chamada.
