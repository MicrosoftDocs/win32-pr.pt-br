...
---
# <a name="using-resource-enumeration"></a>Usando a enumeração de recursos

O exemplo a seguir mostra como usar a função [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) e os elementos de programação relacionados para abstrair e categorizar informações de recursos específicas do processo.
