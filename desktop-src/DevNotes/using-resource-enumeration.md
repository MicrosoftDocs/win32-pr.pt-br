---
description: O exemplo a seguir mostra como usar a função VerifierEnumerateResource e os elementos de programação relacionados para abstrair e categorizar informações de recursos específicas do processo.
ms.assetid: e0c2c795-2960-44f9-8b63-2329f5b42e15
title: Usando a enumeração de recursos
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103920146"
---
# <a name="using-resource-enumeration"></a><span data-ttu-id="21c58-103">Usando a enumeração de recursos</span><span class="sxs-lookup"><span data-stu-id="21c58-103">Using Resource Enumeration</span></span>

<span data-ttu-id="21c58-104">O exemplo a seguir mostra como usar a função [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) e os elementos de programação relacionados para abstrair e categorizar informações de recursos específicas do processo.</span><span class="sxs-lookup"><span data-stu-id="21c58-104">The following example shows how to use the [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) function and related programming elements to abstract and categorize process-specific resource information.</span></span>
