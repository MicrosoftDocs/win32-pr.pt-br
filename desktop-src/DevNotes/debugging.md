...
title: Depuração (notas do desenvolvedor)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119654189"
---
# <a name="debugging-developer-notes"></a>Depuração (notas do desenvolvedor)

## <a name="in-this-section"></a>Nesta seção

-   [Depuração da máquina virtual do DOS](virtual-dos-machine-debug.md)
