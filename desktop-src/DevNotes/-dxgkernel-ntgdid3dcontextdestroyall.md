...
Consulta a quantidade de memória livre no heap de memória gerenciada por driver.
...
**NtGdiD3DContextDestroyAll** retorna um dos seguintes códigos de retorno de chamada.
