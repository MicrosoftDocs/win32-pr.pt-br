...
O nome do provedor de início para o cartão SIM/dispositivo especificado. Para obter mais informações, consulte a documentação do elemento v1 [**HomeProviderName**](./schema-homeprovidername-mbnprofile-element.md) .
