...
<td><p>Especifica que esse perfil está ativo somente quando a classe celular atual é a especificada. Caso contrário, o perfil não será aplicável e não poderá ser usado para ativar um contexto de protocolo de dados de pacote (PDP).</p></td>
</tr>
<tr class="even">
<td><a href="element-imsi.md">IMSI</a></td>
<td><p>Especifica que esse perfil está ativo somente quando o IMSI atual que está sendo usado no ICCID é o especificado. Caso contrário, o perfil não será aplicável e não poderá ser usado para ativar um contexto de protocolo de dados de pacote (PDP).</p></td>
</tr>
<tr class="odd">
...
<td><p>Especifica que esse perfil está ativo somente quando o tipo RAT é aquele especificado. Caso contrário, o perfil não será aplicável e não poderá ser usado para ativar um contexto de protocolo de dados de pacote (PDP).</p></td>
</tr>
<tr class="odd">
