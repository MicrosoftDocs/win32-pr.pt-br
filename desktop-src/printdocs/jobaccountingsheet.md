---
description: Saiba mais sobre o elemento JobAccountingSheet, que descreve a planilha contábil a ser impressa para o trabalho.
...
ms.locfileid: "119034154"
---
# <a name="jobaccountingsheet"></a>JobAccountingSheet

Este tópico não é atual. Para obter as informações mais atuais, consulte a [especificação do esquema de impressão](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Descreve a planilha de contabilidade a ser impressa para o trabalho. A folha contábil deve ser saída no PageMediaSize padrão e usando o PageMediaType padrão. A folha de contabilidade deve ser isolada do restante do trabalho. Isso significa que qualquer opção de acabamento ou de processamento (como JobDuplex, JobStaple ou JobBinding) não deve incluir a planilha de contabilidade. A folha contábil pode ocorrer como a primeira ou última página do trabalho na critério do implementador.
