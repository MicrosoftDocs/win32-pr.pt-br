...
---
# <a name="pagemediasize"></a><span data-ttu-id="925e5-104">PageMediaSize</span><span class="sxs-lookup"><span data-stu-id="925e5-104">PageMediaSize</span></span>

<span data-ttu-id="925e5-105">Este tópico não é atual.</span><span class="sxs-lookup"><span data-stu-id="925e5-105">This topic is not current.</span></span> <span data-ttu-id="925e5-106">Para obter as informações mais atuais, consulte a [especificação do esquema de impressão](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span><span class="sxs-lookup"><span data-stu-id="925e5-106">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="925e5-107">Descreve as dimensões de mídia física usadas para a saída.</span><span class="sxs-lookup"><span data-stu-id="925e5-107">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="925e5-108">O diagrama a seguir ilustra o uso da variável PageMediaSize (a opção ISOA4 é usada como um exemplo).</span><span class="sxs-lookup"><span data-stu-id="925e5-108">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![um diagrama que mostra as dimensões da página](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="925e5-110">Informações do elemento</span><span class="sxs-lookup"><span data-stu-id="925e5-110">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="925e5-111">Conteúdo estrutural</span><span class="sxs-lookup"><span data-stu-id="925e5-111">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="925e5-112">Conteúdo de linguagem XML (XML)</span><span class="sxs-lookup"><span data-stu-id="925e5-112">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="925e5-113">Informações do elemento</span><span class="sxs-lookup"><span data-stu-id="925e5-113">Element Information</span></span>



|                            |                    |
|----------------------------|--------------------|
| <span data-ttu-id="925e5-114">Nome</span><span class="sxs-lookup"><span data-stu-id="925e5-114">Name</span></span> | <span data-ttu-id="925e5-115">Valor</span><span class="sxs-lookup"><span data-stu-id="925e5-115">Value</span></span> |
| <span data-ttu-id="925e5-116">Tipo de elemento</span><span class="sxs-lookup"><span data-stu-id="925e5-116">Element Type</span></span> <br/>   | <span data-ttu-id="925e5-117">Recurso</span><span class="sxs-lookup"><span data-stu-id="925e5-117">Feature</span></span><br/> |
| <span data-ttu-id="925e5-118">Prefixo de escopo</span><span class="sxs-lookup"><span data-stu-id="925e5-118">Scoping Prefix</span></span> <br/> | <span data-ttu-id="925e5-119">?</span><span class="sxs-lookup"><span data-stu-id="925e5-119">Page</span></span><br/>    |
| <span data-ttu-id="925e5-120">Observações</span><span class="sxs-lookup"><span data-stu-id="925e5-120">Notes</span></span> <br/>          | <span data-ttu-id="925e5-121">Nenhum</span><span class="sxs-lookup"><span data-stu-id="925e5-121">None</span></span><br/>    |



 

## <a name="structural-content"></a><span data-ttu-id="925e5-122">Conteúdo estrutural</span><span class="sxs-lookup"><span data-stu-id="925e5-122">Structural Content</span></span>

<span data-ttu-id="925e5-123">A estrutura XML desse elemento é:</span><span class="sxs-lookup"><span data-stu-id="925e5-123">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="925e5-124">Variáveis de estrutura</span><span class="sxs-lookup"><span data-stu-id="925e5-124">Structure Variables</span></span>

<span data-ttu-id="925e5-125">A tabela a seguir descreve as características das variáveis definidas na estrutura XML.</span><span class="sxs-lookup"><span data-stu-id="925e5-125">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="925e5-126">Nome</span><span class="sxs-lookup"><span data-stu-id="925e5-126">Name</span></span>                                | <span data-ttu-id="925e5-127">Tipo de dados</span><span class="sxs-lookup"><span data-stu-id="925e5-127">Data type</span></span>          | <span data-ttu-id="925e5-128">Unidade</span><span class="sxs-lookup"><span data-stu-id="925e5-128">Unit</span></span>                  | <span data-ttu-id="925e5-129">Valores com suporte</span><span class="sxs-lookup"><span data-stu-id="925e5-129">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="925e5-130">Resumo</span><span class="sxs-lookup"><span data-stu-id="925e5-130">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="925e5-131">\_OptionName\_</span><span class="sxs-lookup"><span data-stu-id="925e5-131">\_OptionName\_</span></span><br/>           | <span data-ttu-id="925e5-132">string</span><span class="sxs-lookup"><span data-stu-id="925e5-132">string</span></span><br/>  | <span data-ttu-id="925e5-133">characters</span><span class="sxs-lookup"><span data-stu-id="925e5-133">characters</span></span><br/> | <span data-ttu-id="925e5-134">Nome totalmente qualificado válido, conforme definido pelos [namespaces em XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span><span class="sxs-lookup"><span data-stu-id="925e5-134">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="925e5-135">Se nenhum namespace for especificado, o namespace padrão será assumido.</span><span class="sxs-lookup"><span data-stu-id="925e5-135">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="925e5-136">Especifica o nome da mídia.</span><span class="sxs-lookup"><span data-stu-id="925e5-136">Specifies the name of the media.</span></span> <span data-ttu-id="925e5-137">A nomenclatura deve usar a seguinte convenção: " \_ OptionNameStandard \_ " " \_ OptionNameCommonName \_ " " \_ OptionNameDescriptor \_ ".</span><span class="sxs-lookup"><span data-stu-id="925e5-137">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="925e5-138">\_IdentityOptionValue\_</span><span class="sxs-lookup"><span data-stu-id="925e5-138">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="925e5-139">string</span><span class="sxs-lookup"><span data-stu-id="925e5-139">string</span></span><br/>  | <span data-ttu-id="925e5-140">N/D</span><span class="sxs-lookup"><span data-stu-id="925e5-140">n/a</span></span><br/>        | <span data-ttu-id="925e5-141">True, False.</span><span class="sxs-lookup"><span data-stu-id="925e5-141">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="925e5-142">Define uma opção que, quando selecionada, desabilita esse recurso.</span><span class="sxs-lookup"><span data-stu-id="925e5-142">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="925e5-143">\_OptionNameStandard\_</span><span class="sxs-lookup"><span data-stu-id="925e5-143">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="925e5-144">string</span><span class="sxs-lookup"><span data-stu-id="925e5-144">string</span></span><br/>  | <span data-ttu-id="925e5-145">characters</span><span class="sxs-lookup"><span data-stu-id="925e5-145">characters</span></span><br/> | <span data-ttu-id="925e5-146">' ISO ', ' JIS ', ' Japão ', ' América do, ' OtherMetric ', ' PRC ', nenhum.</span><span class="sxs-lookup"><span data-stu-id="925e5-146">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="925e5-147">Indica se o tamanho da mídia está definido por um padrão específico.</span><span class="sxs-lookup"><span data-stu-id="925e5-147">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="925e5-148">\_OptionNameCommonName\_</span><span class="sxs-lookup"><span data-stu-id="925e5-148">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="925e5-149">string</span><span class="sxs-lookup"><span data-stu-id="925e5-149">string</span></span><br/>  | <span data-ttu-id="925e5-150">characters</span><span class="sxs-lookup"><span data-stu-id="925e5-150">characters</span></span><br/> | <span data-ttu-id="925e5-151">Nome totalmente qualificado válido, conforme definido pelos [namespaces em XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span><span class="sxs-lookup"><span data-stu-id="925e5-151">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="925e5-152">Se nenhum namespace for especificado, o namespace padrão será assumido.</span><span class="sxs-lookup"><span data-stu-id="925e5-152">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="925e5-153">Nome comum para o tamanho da mídia.</span><span class="sxs-lookup"><span data-stu-id="925e5-153">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="925e5-154">\_OptionNameDescriptor\_</span><span class="sxs-lookup"><span data-stu-id="925e5-154">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="925e5-155">string</span><span class="sxs-lookup"><span data-stu-id="925e5-155">string</span></span><br/>  | <span data-ttu-id="925e5-156">characters</span><span class="sxs-lookup"><span data-stu-id="925e5-156">characters</span></span><br/> | <span data-ttu-id="925e5-157">Big, envelope, extra, mais, cartão-postal, girado, planilha, ' nenhum '.</span><span class="sxs-lookup"><span data-stu-id="925e5-157">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="925e5-158">Big, envelope, extra, mais, cartão-postal, girado, planilha, ' nenhum '.</span><span class="sxs-lookup"><span data-stu-id="925e5-158">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="925e5-159">\_MediaSizeWidth\_</span><span class="sxs-lookup"><span data-stu-id="925e5-159">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="925e5-160">Número inteiro</span><span class="sxs-lookup"><span data-stu-id="925e5-160">integer</span></span><br/> | <span data-ttu-id="925e5-161">mícrons</span><span class="sxs-lookup"><span data-stu-id="925e5-161">microns</span></span><br/>    | <span data-ttu-id="925e5-162">Maior que 0, menor que o tamanho máximo de mídia de suporte para o dispositivo.</span><span class="sxs-lookup"><span data-stu-id="925e5-162">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="925e5-163">Especifica a largura da mídia física.</span><span class="sxs-lookup"><span data-stu-id="925e5-163">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="925e5-164">\_MediaSizeHeight\_</span><span class="sxs-lookup"><span data-stu-id="925e5-164">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="925e5-165">Número inteiro</span><span class="sxs-lookup"><span data-stu-id="925e5-165">integer</span></span><br/> | <span data-ttu-id="925e5-166">mícrons</span><span class="sxs-lookup"><span data-stu-id="925e5-166">microns</span></span><br/>    | <span data-ttu-id="925e5-167">Maior que 0, menor que o tamanho máximo de mídia de suporte para o dispositivo.</span><span class="sxs-lookup"><span data-stu-id="925e5-167">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="925e5-168">Especifica a altura da mídia física.</span><span class="sxs-lookup"><span data-stu-id="925e5-168">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="925e5-169">Conteúdo de linguagem XML (XML)</span><span class="sxs-lookup"><span data-stu-id="925e5-169">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="925e5-170">As palavras-chave do esquema de impressão pública são definidas no `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span><span class="sxs-lookup"><span data-stu-id="925e5-170">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="925e5-171">O conteúdo do linguagem XML público (XML) para essa palavra-chave é definido abaixo:</span><span class="sxs-lookup"><span data-stu-id="925e5-171">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="925e5-172">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="925e5-172">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="925e5-173">Especificação de esquema de impressão</span><span class="sxs-lookup"><span data-stu-id="925e5-173">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
