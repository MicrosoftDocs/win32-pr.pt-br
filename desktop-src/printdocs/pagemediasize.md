...
---
# <a name="pagemediasize"></a><span data-ttu-id="fbf3e-104">PageMediaSize</span><span class="sxs-lookup"><span data-stu-id="fbf3e-104">PageMediaSize</span></span>

<span data-ttu-id="fbf3e-105">Este tópico não é atual.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-105">This topic is not current.</span></span> <span data-ttu-id="fbf3e-106">Para obter as informações mais atuais, consulte a [especificação do esquema de impressão](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span><span class="sxs-lookup"><span data-stu-id="fbf3e-106">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="fbf3e-107">Descreve as dimensões de mídia física usadas para a saída.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-107">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="fbf3e-108">O diagrama a seguir ilustra o uso da variável PageMediaSize (a opção ISOA4 é usada como um exemplo).</span><span class="sxs-lookup"><span data-stu-id="fbf3e-108">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![um diagrama que mostra as dimensões da página](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="fbf3e-110">Informações do elemento</span><span class="sxs-lookup"><span data-stu-id="fbf3e-110">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="fbf3e-111">Conteúdo estrutural</span><span class="sxs-lookup"><span data-stu-id="fbf3e-111">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="fbf3e-112">Conteúdo de linguagem XML (XML)</span><span class="sxs-lookup"><span data-stu-id="fbf3e-112">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="fbf3e-113">Informações do elemento</span><span class="sxs-lookup"><span data-stu-id="fbf3e-113">Element Information</span></span>



|                            |                    |
|----------------------------|--------------------|
| <span data-ttu-id="fbf3e-114">Nome</span><span class="sxs-lookup"><span data-stu-id="fbf3e-114">Name</span></span>                       |                    |
| <span data-ttu-id="fbf3e-115">Tipo de elemento</span><span class="sxs-lookup"><span data-stu-id="fbf3e-115">Element Type</span></span> <br/>   | <span data-ttu-id="fbf3e-116">Recurso</span><span class="sxs-lookup"><span data-stu-id="fbf3e-116">Feature</span></span><br/> |
| <span data-ttu-id="fbf3e-117">Prefixo de escopo</span><span class="sxs-lookup"><span data-stu-id="fbf3e-117">Scoping Prefix</span></span> <br/> | <span data-ttu-id="fbf3e-118">?</span><span class="sxs-lookup"><span data-stu-id="fbf3e-118">Page</span></span><br/>    |
| <span data-ttu-id="fbf3e-119">Observações</span><span class="sxs-lookup"><span data-stu-id="fbf3e-119">Notes</span></span> <br/>          | <span data-ttu-id="fbf3e-120">Nenhum</span><span class="sxs-lookup"><span data-stu-id="fbf3e-120">None</span></span><br/>    |



 

## <a name="structural-content"></a><span data-ttu-id="fbf3e-121">Conteúdo estrutural</span><span class="sxs-lookup"><span data-stu-id="fbf3e-121">Structural Content</span></span>

<span data-ttu-id="fbf3e-122">A estrutura XML desse elemento é:</span><span class="sxs-lookup"><span data-stu-id="fbf3e-122">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="fbf3e-123">Variáveis de estrutura</span><span class="sxs-lookup"><span data-stu-id="fbf3e-123">Structure Variables</span></span>

<span data-ttu-id="fbf3e-124">A tabela a seguir descreve as características das variáveis definidas na estrutura XML.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-124">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="fbf3e-125">Nome</span><span class="sxs-lookup"><span data-stu-id="fbf3e-125">Name</span></span>                                | <span data-ttu-id="fbf3e-126">Tipo de dados</span><span class="sxs-lookup"><span data-stu-id="fbf3e-126">Data type</span></span>          | <span data-ttu-id="fbf3e-127">Unidade</span><span class="sxs-lookup"><span data-stu-id="fbf3e-127">Unit</span></span>                  | <span data-ttu-id="fbf3e-128">Valores com suporte</span><span class="sxs-lookup"><span data-stu-id="fbf3e-128">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="fbf3e-129">Resumo</span><span class="sxs-lookup"><span data-stu-id="fbf3e-129">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="fbf3e-130">\_OptionName\_</span><span class="sxs-lookup"><span data-stu-id="fbf3e-130">\_OptionName\_</span></span><br/>           | <span data-ttu-id="fbf3e-131">string</span><span class="sxs-lookup"><span data-stu-id="fbf3e-131">string</span></span><br/>  | <span data-ttu-id="fbf3e-132">characters</span><span class="sxs-lookup"><span data-stu-id="fbf3e-132">characters</span></span><br/> | <span data-ttu-id="fbf3e-133">Nome totalmente qualificado válido, conforme definido pelos [namespaces em XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span><span class="sxs-lookup"><span data-stu-id="fbf3e-133">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="fbf3e-134">Se nenhum namespace for especificado, o namespace padrão será assumido.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-134">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="fbf3e-135">Especifica o nome da mídia.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-135">Specifies the name of the media.</span></span> <span data-ttu-id="fbf3e-136">A nomenclatura deve usar a seguinte convenção: " \_ OptionNameStandard \_ " " \_ OptionNameCommonName \_ " " \_ OptionNameDescriptor \_ ".</span><span class="sxs-lookup"><span data-stu-id="fbf3e-136">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="fbf3e-137">\_IdentityOptionValue\_</span><span class="sxs-lookup"><span data-stu-id="fbf3e-137">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="fbf3e-138">string</span><span class="sxs-lookup"><span data-stu-id="fbf3e-138">string</span></span><br/>  | <span data-ttu-id="fbf3e-139">N/D</span><span class="sxs-lookup"><span data-stu-id="fbf3e-139">n/a</span></span><br/>        | <span data-ttu-id="fbf3e-140">True, False.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-140">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="fbf3e-141">Define uma opção que, quando selecionada, desabilita esse recurso.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-141">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="fbf3e-142">\_OptionNameStandard\_</span><span class="sxs-lookup"><span data-stu-id="fbf3e-142">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="fbf3e-143">string</span><span class="sxs-lookup"><span data-stu-id="fbf3e-143">string</span></span><br/>  | <span data-ttu-id="fbf3e-144">characters</span><span class="sxs-lookup"><span data-stu-id="fbf3e-144">characters</span></span><br/> | <span data-ttu-id="fbf3e-145">' ISO ', ' JIS ', ' Japão ', ' América do, ' OtherMetric ', ' PRC ', nenhum.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-145">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="fbf3e-146">Indica se o tamanho da mídia está definido por um padrão específico.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-146">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="fbf3e-147">\_OptionNameCommonName\_</span><span class="sxs-lookup"><span data-stu-id="fbf3e-147">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="fbf3e-148">string</span><span class="sxs-lookup"><span data-stu-id="fbf3e-148">string</span></span><br/>  | <span data-ttu-id="fbf3e-149">characters</span><span class="sxs-lookup"><span data-stu-id="fbf3e-149">characters</span></span><br/> | <span data-ttu-id="fbf3e-150">Nome totalmente qualificado válido, conforme definido pelos [namespaces em XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span><span class="sxs-lookup"><span data-stu-id="fbf3e-150">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="fbf3e-151">Se nenhum namespace for especificado, o namespace padrão será assumido.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-151">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="fbf3e-152">Nome comum para o tamanho da mídia.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-152">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="fbf3e-153">\_OptionNameDescriptor\_</span><span class="sxs-lookup"><span data-stu-id="fbf3e-153">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="fbf3e-154">string</span><span class="sxs-lookup"><span data-stu-id="fbf3e-154">string</span></span><br/>  | <span data-ttu-id="fbf3e-155">characters</span><span class="sxs-lookup"><span data-stu-id="fbf3e-155">characters</span></span><br/> | <span data-ttu-id="fbf3e-156">Big, envelope, extra, mais, cartão-postal, girado, planilha, ' nenhum '.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-156">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="fbf3e-157">Big, envelope, extra, mais, cartão-postal, girado, planilha, ' nenhum '.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-157">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="fbf3e-158">\_MediaSizeWidth\_</span><span class="sxs-lookup"><span data-stu-id="fbf3e-158">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="fbf3e-159">Número inteiro</span><span class="sxs-lookup"><span data-stu-id="fbf3e-159">integer</span></span><br/> | <span data-ttu-id="fbf3e-160">mícrons</span><span class="sxs-lookup"><span data-stu-id="fbf3e-160">microns</span></span><br/>    | <span data-ttu-id="fbf3e-161">Maior que 0, menor que o tamanho máximo de mídia de suporte para o dispositivo.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-161">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="fbf3e-162">Especifica a largura da mídia física.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-162">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="fbf3e-163">\_MediaSizeHeight\_</span><span class="sxs-lookup"><span data-stu-id="fbf3e-163">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="fbf3e-164">Número inteiro</span><span class="sxs-lookup"><span data-stu-id="fbf3e-164">integer</span></span><br/> | <span data-ttu-id="fbf3e-165">mícrons</span><span class="sxs-lookup"><span data-stu-id="fbf3e-165">microns</span></span><br/>    | <span data-ttu-id="fbf3e-166">Maior que 0, menor que o tamanho máximo de mídia de suporte para o dispositivo.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-166">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="fbf3e-167">Especifica a altura da mídia física.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-167">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="fbf3e-168">Conteúdo de linguagem XML (XML)</span><span class="sxs-lookup"><span data-stu-id="fbf3e-168">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="fbf3e-169">As palavras-chave do esquema de impressão pública são definidas no `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span><span class="sxs-lookup"><span data-stu-id="fbf3e-169">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="fbf3e-170">O conteúdo do linguagem XML público (XML) para essa palavra-chave é definido abaixo:</span><span class="sxs-lookup"><span data-stu-id="fbf3e-170">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="fbf3e-171">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="fbf3e-171">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="fbf3e-172">Especificação de esquema de impressão</span><span class="sxs-lookup"><span data-stu-id="fbf3e-172">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
