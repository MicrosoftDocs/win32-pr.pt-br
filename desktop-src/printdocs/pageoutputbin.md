---
description: Leia sobre o elemento configurável pelo usuário PageOutputBin. Este tópico não é atual. Para obter as informações mais atuais, consulte a Especificação de Esquema de Impressão.
...
| \_BinTypeValue\_<br/>            | string<br/>  | n/d<br/>        | FaceDownTray, FaceUpTray, MailBox, Sorter, Stacker, Finisher None.<br/>                                                                                                         | Especifica o tipo geral do compartimento.<br/>                                   |
