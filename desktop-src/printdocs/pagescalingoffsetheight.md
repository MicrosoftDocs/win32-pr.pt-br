---
description: Obter informações sobre o parâmetro PageScalingOffsetHeight. Este tópico não é atual. Para obter as informações mais atuais, consulte a Especificação de Esquema de Impressão.
...
ms.locfileid: "119034114"
---
# <a name="pagescalingoffsetheight"></a>PageScalingOffsetHeight

Este tópico não é atual. Para obter as informações mais atuais, consulte a [Especificação de Esquema de Impressão](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Especifica o deslocamento de dimensionamento na direção ImageableSizeHeight para dimensionamento personalizado.
