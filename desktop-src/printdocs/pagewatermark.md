---
description: Saiba mais sobre o elemento PageWatermark configurável pelo usuário. Este tópico não é atual. Para obter as informações mais atuais, consulte a especificação do esquema de impressão.
...
ms.locfileid: "120091866"
---
# <a name="pagewatermark"></a>PageWatermark

Este tópico não é atual. Para obter as informações mais atuais, consulte a [especificação do esquema de impressão](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Descreve a configuração de marca d' água da saída e as características da marca d' água. As marcas d' água se aplicam à página lógica, não à página física. Por exemplo, se DocumentDuplex estiver habilitado, uma marca d' água será exibida em cada página do Mpeza em cada planilha. Se DocumentDuplex, PagesPerSheet = 2, cada planilha terá 2 marcas-d ' água.
...
| Observações <br/>          | As coordenadas são relativas a PageImageableSize, em que a origem da marca d' água é relativa à origem do PageImageableSize.<br/> |
