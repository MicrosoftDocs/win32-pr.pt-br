---
description: Saiba mais sobre o elemento PageBlendColorSpace configurável pelo usuário. Este tópico não é atual. Para obter as informações mais atuais, consulte a especificação do esquema de impressão.
...
ms.locfileid: "119711666"
---
# <a name="pageblendcolorspace"></a>PageBlendColorSpace

Este tópico não é atual. Para obter as informações mais atuais, consulte a [especificação do esquema de impressão](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Descreve o espaço de cores que deve ser usado para operações de mesclagem.
