...
Para o .NET Framework 3,0, o Windows Vista e versões posteriores, as tecnologias de PrintCapabilities e PrintTicket estendem os recursos do esquema de impressão para permitir uma experiência de impressão mais rica.
