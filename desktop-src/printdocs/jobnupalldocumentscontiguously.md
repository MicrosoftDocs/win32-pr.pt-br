---
description: Saiba mais sobre o elemento JobNUpAllDocumentsContiguously, que descreve a saída de várias páginas lógicas para uma única planilha física.
...
Descreve a saída de várias páginas lógicas para uma única planilha física. Todos os documentos no trabalho são compilados juntos de forma contígua. JobNUpAllDocumentsContiguously e DocumentNUp são mutuamente exclusivos. O driver deve determinar o tratamento de restrição entre essas palavras-chave.

O diagrama a seguir ilustra um exemplo com o Documento 1 contendo 3 páginas e o Documento 2 contendo duas páginas. Cada documento no trabalho é duplexado de forma contígua. As instruções de apresentação mostradas no exemplo são a opção RightBottom.

![um diagrama que mostra como as páginas de documento são colocadas em uma única planilha com base na configuração de documentnup](images/local-1242234459-jobduplexpics.gif)
...
| Observações <br/>          | Top, Bottom, Left e Right são relativos ao PageImageableSize, em que TopLeft é anotado pela origem da altura e largura.<br/> |
