...
Força a saída a aparecer na frente de uma folha de mídia. Relevante para folhas de mídia com superfícies diferentes em cada lado. Nos casos em que esse recurso interfere nas opções de processamento (como DocumentDuplex), PageForceFrontSide tem precedência para a página específica à qual o recurso se aplica.
