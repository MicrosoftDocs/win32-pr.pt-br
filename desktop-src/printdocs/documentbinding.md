...
Descreve o método de associação. Cada documento é vinculado separadamente. DocumentBinding e JobBindAllDocuments são mutuamente exclusivos. O driver deve determinar a manipulação de restrição entre palavras-chave.
...
| \_BindingGutterValue\_<br/>  | Integer<br/> | Mícrons<br/>    | Maior ou igual a 0.<br/>                                                                                                                                                | Define a mediana de associação mínima para a associação final especificada. A media mediana é medida em mícronos em relação à borda da dimensão de mídia física.<br/> |
