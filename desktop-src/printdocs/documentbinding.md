...
ms.locfileid: "119949866"
---
# <a name="documentbinding"></a>Documentbinding

Este tópico não é atual. Para obter as informações mais atuais, consulte a [especificação do esquema de impressão](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Descreve o método de associação. Cada documento é associado separadamente. Documentbinding e JobBindAllDocuments são mutuamente exclusivos. Cabe ao driver determinar o tratamento de restrições entre palavras-chave.
...
| \_BindingGutterValue\_<br/>  | Integer<br/> | mícrons<br/>    | Maior ou igual a 0.<br/>                                                                                                                                                | Define a medianiz de associação mínima para a associação de conclusão especificada. A medianiz é medida em mícrons em relação à borda da dimensão de mídia física.<br/> |
