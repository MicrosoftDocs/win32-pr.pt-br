---
description: Revise o elemento configurável pelo usuário PageDestinationColorProfile. Este tópico não é atual. Para obter as informações mais atuais, consulte a Especificação de Esquema de Impressão.
