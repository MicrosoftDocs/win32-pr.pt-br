---
description: Saiba mais sobre o elemento JobBindAllDocuments, que descreve a descrição do método de associação. Todos os documentos no trabalho são vinculados em conjunto.
...
ms.locfileid: "117686495"
---
# <a name="jobbindalldocuments"></a>JobBindAllDocuments

Este tópico não é atual. Para obter as informações mais atuais, consulte a [especificação do esquema de impressão](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Descreve o método de associação. Todos os documentos no trabalho são vinculados em conjunto. JobBindAllDocuments e Documentbinding são mutuamente exclusivos. Cabe ao driver determinar o tratamento de restrições entre essas palavras-chave.
...
| Observações <br/>          | Superior, inferior, esquerda e direita são relativos ao PageImageableSize.<br/> |
...
| \_BindingGutterValue\_<br/>  | Número inteiro<br/> | mícrons<br/>    | Maior que 0.<br/>                                                                                                                                                            | Define a medianiz de associação mínima para a associação de conclusão especificada. A medianiz é medida em mícrons em relação à borda da dimensão de mídia física.<br/> |
