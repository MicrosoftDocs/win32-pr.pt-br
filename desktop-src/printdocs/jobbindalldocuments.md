...
Descreve o método de associação. Todos os documentos no trabalho são vinculados. JobBindAllDocuments e DocumentBinding são mutuamente exclusivos. O driver deve determinar o tratamento de restrição entre essas palavras-chave.
...
| \_BindingGutterValue\_<br/>  | Número inteiro<br/> | Mícrons<br/>    | Maior que 0.<br/>                                                                                                                                                            | Define a mediana de associação mínima para a associação final especificada. A media mediana é medida em mícronos em relação à borda da dimensão de mídia física.<br/> |
