---
description: Leia sobre o parâmetro PageDeviceColorSpaceProfileURI. Este tópico não é atual. Para obter as informações mais atuais, consulte a especificação do esquema de impressão.
