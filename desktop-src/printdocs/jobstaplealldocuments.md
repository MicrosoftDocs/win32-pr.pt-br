...
Descreve as características de grampeamento da saída. Todos os documentos no trabalho são grampeados juntos. As palavras-chave JobStapleAllDocuments e DocumentStaple são mutuamente exclusivas. Cabe ao driver determinar o tratamento de restrições entre essas palavras-chave.
...
| \_Ângulovalue\_<br/>          | Número inteiro<br/> | graus<br/>         | Maior que 0.<br/>                                                                                                                                                            | Especifica o ângulo do grampo, em relação à largura do PageImageableSize. O ângulo do grampo é medido em uma direção no sentido anti-horário.<br/> |
