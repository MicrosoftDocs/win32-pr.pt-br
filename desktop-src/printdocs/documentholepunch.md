...
Descreve as características de perfuração da saída. Cada documento é perfurado separadamente. As palavras-chave JobHolePunch e DocumentHolePunch são mutuamente exclusivas. Ambos não devem ser especificados simultaneamente em um documento de PrintTicket ou recursos de impressão.
