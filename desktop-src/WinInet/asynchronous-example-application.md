...
ms.locfileid: "118562319"
---
# <a name="asynchronous-example-application"></a>Aplicativo de exemplo assíncrono

O exemplo a seguir demonstrou o envio de uma solicitação de forma assíncrona.
