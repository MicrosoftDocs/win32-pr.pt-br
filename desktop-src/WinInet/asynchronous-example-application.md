---
title: Aplicativo de exemplo assíncrono
description: O exemplo a seguir demonstrou o envio de uma solicitação de forma assíncrona.
...
ms.locfileid: "104159974"
---
# <a name="asynchronous-example-application"></a><span data-ttu-id="66413-103">Aplicativo de exemplo assíncrono</span><span class="sxs-lookup"><span data-stu-id="66413-103">Asynchronous Example Application</span></span>

<span data-ttu-id="66413-104">O exemplo a seguir demonstrou o envio de uma solicitação de forma assíncrona.</span><span class="sxs-lookup"><span data-stu-id="66413-104">The following example demonstrated sending a request asynchronously.</span></span>
