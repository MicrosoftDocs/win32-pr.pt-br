---
title: Cabeçalho de exemplo assíncrono
description: A seguir está o arquivo de cabeçalho para o aplicativo de exemplo assíncrono.
...
---
# <a name="asynchronous-example-header"></a><span data-ttu-id="ee44c-103">Cabeçalho de exemplo assíncrono</span><span class="sxs-lookup"><span data-stu-id="ee44c-103">Asynchronous Example Header</span></span>

<span data-ttu-id="ee44c-104">A seguir está o arquivo de cabeçalho para o [aplicativo de exemplo assíncrono](asynchronous-example-application.md).</span><span class="sxs-lookup"><span data-stu-id="ee44c-104">The following is the header file for the [asynchronous example application](asynchronous-example-application.md).</span></span>
