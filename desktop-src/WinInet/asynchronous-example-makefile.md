...
description: A seguir está o makefile para o aplicativo de exemplo assíncrono.
...
ms.locfileid: "119051844"
---
# <a name="asynchronous-example-makefile"></a>Makefile de exemplo assíncrono

A seguir está o makefile para o aplicativo de exemplo [assíncrono](asynchronous-example-application.md).
