...
---
# <a name="asynchronous-example-makefile"></a><span data-ttu-id="14a0c-103">Makefile de exemplo assíncrono</span><span class="sxs-lookup"><span data-stu-id="14a0c-103">Asynchronous Example Makefile</span></span>

<span data-ttu-id="14a0c-104">Este é o makefile para o [aplicativo de exemplo assíncrono](asynchronous-example-application.md).</span><span class="sxs-lookup"><span data-stu-id="14a0c-104">The following is the makefile for the [asynchronous example application](asynchronous-example-application.md).</span></span>
