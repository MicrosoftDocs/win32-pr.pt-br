...
---
# <a name="receiving-event-notification"></a>Recebendo notificação de eventos

O exemplo a seguir mostra como usar a função [**NotifyChangeEventLog**](/windows/desktop/api/Winbase/nf-winbase-notifychangeeventlog) para receber notificações quando um evento é registrado. Este exemplo filtra os eventos gravados pelo exemplo em [relatando um evento](reporting-an-event.md).
