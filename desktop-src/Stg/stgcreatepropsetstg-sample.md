...
---
# <a name="stgcreatepropsetstg-sample"></a>Exemplo de StgCreatePropSetStg

O exemplo StgCreatePropSetStg. cpp mostra como a função [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) pode ser usada para criar uma interface [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) na parte superior de qualquer interface [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) específica.
