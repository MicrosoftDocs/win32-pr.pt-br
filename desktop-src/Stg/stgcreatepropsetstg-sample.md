---
title: Exemplo de StgCreatePropSetStg
description: Mostra como a função StgCreatePropSetStg pode ser usada para criar uma interface IPropertySetStorage na parte superior de qualquer interface IStorage específica.
ms.assetid: f0d0664a-2cfd-4eb0-b1d5-47d1545394fd
keywords:
- Strctd de armazenamento estruturado, STG, exemplos, StgCreatePropSetStg
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104364311"
---
# <a name="stgcreatepropsetstg-sample"></a><span data-ttu-id="f27b7-104">Exemplo de StgCreatePropSetStg</span><span class="sxs-lookup"><span data-stu-id="f27b7-104">StgCreatePropSetStg Sample</span></span>

<span data-ttu-id="f27b7-105">O exemplo StgCreatePropSetStg. cpp mostra como a função [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) pode ser usada para criar uma interface [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) na parte superior de qualquer interface [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) específica.</span><span class="sxs-lookup"><span data-stu-id="f27b7-105">The StgCreatePropSetStg.cpp sample shows how the [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) function can be used to create an [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) interface on top of any given [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) interface.</span></span>
