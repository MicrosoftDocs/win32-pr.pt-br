---
title: Exemplo de EnumAll
description: Coloca todas as propriedades em todos os conjuntos de propriedades de um arquivo de armazenamento.
ms.assetid: 40dd62b8-f76a-4cd8-9a9f-6ac344389b6c
keywords:
- Strctd de armazenamento estruturado, STG, exemplos, EnumAll
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104292076"
---
# <a name="enumall-sample"></a><span data-ttu-id="a9a57-104">Exemplo de EnumAll</span><span class="sxs-lookup"><span data-stu-id="a9a57-104">EnumAll Sample</span></span>

<span data-ttu-id="a9a57-105">O aplicativo de exemplo EnumAll. cpp coloca todas as propriedades em todos os conjuntos de propriedades de um arquivo de armazenamento.</span><span class="sxs-lookup"><span data-stu-id="a9a57-105">The EnumAll.cpp sample application puts all properties in all property sets of a storage file.</span></span>
