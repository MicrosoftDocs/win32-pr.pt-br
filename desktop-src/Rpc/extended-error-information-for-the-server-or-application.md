---
title: Informações de erro estendidas para o servidor ou aplicativo
description: Esta seção descreve o que um servidor RPC ou um aplicativo que usa RPC deve fazer para permitir que o usuário se beneficie totalmente das informações de erro estendidas.
