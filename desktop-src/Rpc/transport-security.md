...
> [!Note]  
> Se você estiver executando um aplicativo que é um serviço e estiver usando NTLM para segurança, deverá adicionar uma dependência de serviço explícita para seu aplicativo. O Secur32.dll chamará o Gerenciador de controle de serviço (SCM) para iniciar o serviço de pacote de segurança NTLM. No entanto, um aplicativo RPC que é um serviço e está sendo executado como um sistema, também deve entrar em contato com o SC, a menos que ele esteja se conectando a outro serviço no mesmo computador.
