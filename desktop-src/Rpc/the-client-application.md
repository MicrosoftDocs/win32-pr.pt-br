...
description: Exiba a parte do aplicativo cliente de um exemplo de RPC (chamada de procedimento remoto). O exemplo a seguir é do aplicativo ' Olá, Mundo ' no SDK da plataforma.
