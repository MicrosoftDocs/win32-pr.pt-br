...
Os programas cliente também podem receber a notificação de conclusão por meio de suas filas de mensagens do Windows. Nessa situação, eles simplesmente processam a mensagem de conclusão como fariam com qualquer mensagem do Windows.
