...
O Windows 95 não usa o Microsoft Locator. Para usar um serviço de nome em um aplicativo do Windows 95, o computador com o Windows 95 deve:

-   Faça parte de um grupo de trabalho ou domínio que inclua um computador que esteja executando o Windows 2000 ou o Windows NT para servir como um provedor de serviços de nome de proxy.
