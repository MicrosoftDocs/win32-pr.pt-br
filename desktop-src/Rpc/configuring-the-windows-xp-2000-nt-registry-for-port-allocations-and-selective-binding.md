...
A partir do Windows 2000, um utilitário no Windows Resource Kit chamado Rpccfg.exe deve ser usado para definir associações. Para obter mais informações, consulte o Windows Resource Kit para obter a versão apropriada do sistema operacional.
...
Se uma chave estiver ausente ou se contiver um valor inválido, a configuração inteira será marcada como inválida e todas as chamadas de **RpcServerUseProtseq \*** sobre o IP [**\_ \_ TCP**](/windows/desktop/Midl/ncacn-ip-tcp) ou [**ncadg \_ IP \_ UDP**](/windows/desktop/Midl/ncadg-ip-udp) falharão.
...
| LocalApp    | S   | S   | Usa uma porta fora do intervalo de 5000-5100 |
| DefaultApp  | S   | S   | Usa portas entre 5000 e 5100        |
| Internetapp | S   | N   | Usa portas entre 5000 e 5100        |
| LocalApp    | S   | N   | Usa uma porta fora do intervalo de 5000-5100 |
| DefaultApp  | S   | N   | Usa uma porta fora do intervalo de 5000-5100 |
| Internetapp | N   | S   | Usa uma porta fora do intervalo de 5000-5100 |
| LocalApp    | N   | S   | Usa portas entre 5000 e 5100        |
| DefaultApp  | N   | S   | Usa uma porta fora do intervalo de 5000-5100 |
