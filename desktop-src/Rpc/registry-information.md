...
description: Esta seção contém uma discussão sobre as entradas do registro que são relevantes para o RPC.
ms.assetid: f107e2f6-6a6d-4f70-81a0-bc7adc87aab4
keywords:
- RPC de chamada de procedimento remoto, descrito, informações do registro
ms.topic: article
ms.date: 05/31/2018
