---
description: As funções de acesso à imagem acessam os dados em uma imagem executável. Essas funções fornecem acesso de alto nível à base de imagens e acesso muito específico às partes mais comuns dos dados de uma imagem.
ms.assetid: da72af2b-7afe-42fc-80ae-700ac0829356
title: Funções de acesso à imagem
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118162637"
---
# <a name="image-access-functions"></a>Funções de acesso à imagem

As funções de acesso à imagem acessam os dados em uma imagem executável. Essas funções fornecem acesso de alto nível à base de imagens e acesso muito específico às partes mais comuns dos dados de uma imagem.
