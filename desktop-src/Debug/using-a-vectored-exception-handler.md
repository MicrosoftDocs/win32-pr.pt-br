---
description: O código de exemplo a seguir demonstra como usar a manipulação de exceção em vetor. Ele usa a função AddVectoredExceptionHandler para adicionar vários manipuladores, testa os manipuladores e, em seguida, usa a função RemoveVectoredExceptionHandler para remover os manipuladores.
ms.assetid: dbf7016b-09ac-4ca7-9b47-38b0dd763462
title: Usando um manipulador de exceção em vetor
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103826397"
---
# <a name="using-a-vectored-exception-handler"></a><span data-ttu-id="2ba87-104">Usando um manipulador de exceção em vetor</span><span class="sxs-lookup"><span data-stu-id="2ba87-104">Using a Vectored Exception Handler</span></span>

<span data-ttu-id="2ba87-105">O código de exemplo a seguir demonstra como usar a manipulação de exceção em vetor.</span><span class="sxs-lookup"><span data-stu-id="2ba87-105">The following sample code demonstrates how to use vectored exception handling.</span></span> <span data-ttu-id="2ba87-106">Ele usa a função [**AddVectoredExceptionHandler**](/windows/win32/api/errhandlingapi/nf-errhandlingapi-addvectoredexceptionhandler) para adicionar vários manipuladores, testa os manipuladores e, em seguida, usa a função [**RemoveVectoredExceptionHandler**](/windows/win32/api/errhandlingapi/nf-errhandlingapi-removevectoredexceptionhandler) para remover os manipuladores.</span><span class="sxs-lookup"><span data-stu-id="2ba87-106">It uses the [**AddVectoredExceptionHandler**](/windows/win32/api/errhandlingapi/nf-errhandlingapi-addvectoredexceptionhandler) function to add several handlers, tests the handlers, then uses the [**RemoveVectoredExceptionHandler**](/windows/win32/api/errhandlingapi/nf-errhandlingapi-removevectoredexceptionhandler) function to remove the handlers.</span></span>

<span data-ttu-id="2ba87-107">**Windows de 64 bits:** Esse código não é adequado para o Windows de 64 bits.</span><span class="sxs-lookup"><span data-stu-id="2ba87-107">**64-bit Windows:** This code is not suitable for 64-bit Windows.</span></span>
