...
---
# <a name="working-with-xstate-context"></a><span data-ttu-id="aac73-103">Trabalhando com o contexto XState</span><span class="sxs-lookup"><span data-stu-id="aac73-103">Working with XState Context</span></span>

<span data-ttu-id="aac73-104">Este documento contém um exemplo que demonstra como usar as funções de contexto XState para recuperar e definir recursos estendidos em um thread.</span><span class="sxs-lookup"><span data-stu-id="aac73-104">This document contains an example that demonstrates how to use the XState context functions to retrieve and set extended features on a thread.</span></span> <span data-ttu-id="aac73-105">Os exemplos a seguir manipulam o estado AVX (extensões de vetor avançado) da Intel, que é definido pelo FeatureId 2 (máscara de recurso 4).</span><span class="sxs-lookup"><span data-stu-id="aac73-105">The following examples manipulate Intel Advanced Vector Extensions (AVX) state which is defined by FeatureId 2 (Feature Mask 4).</span></span> <span data-ttu-id="aac73-106">O Intel AVX é definido na "referência de programação de extensões de vetor avançadas da Intel", disponível em <https://go.microsoft.com/fwlink/p/?linkid=212716> .</span><span class="sxs-lookup"><span data-stu-id="aac73-106">Intel AVX is defined in the "Intel Advanced Vector Extensions Programming Reference" available from <https://go.microsoft.com/fwlink/p/?linkid=212716>.</span></span>

<span data-ttu-id="aac73-107">**Windows 7 com SP1:** A [API AVX](avx-support-portal.md) é implementada pela primeira vez no Windows 7 com SP1.</span><span class="sxs-lookup"><span data-stu-id="aac73-107">**Windows 7 with SP1:** The [AVX API](avx-support-portal.md) is first implemented on Windows 7 with SP1.</span></span> <span data-ttu-id="aac73-108">Como não há nenhum SDK para o Windows 7 com SP1, isso significa que não há cabeçalhos disponíveis e arquivos de biblioteca com os quais trabalhar.</span><span class="sxs-lookup"><span data-stu-id="aac73-108">Since there is no SDK for Windows 7 with SP1, that means there are no available headers and library files to work with.</span></span> <span data-ttu-id="aac73-109">Nessa situação, um chamador deve declarar as funções necessárias desta documentação e obter ponteiros para elas usando [**GetModuleHandle**](/windows/win32/api/libloaderapi/nf-libloaderapi-getmodulehandlea) em "Kernel32.dll", seguido por chamadas para [**GetProcAddress**](/windows/win32/api/libloaderapi/nf-libloaderapi-getprocaddress).</span><span class="sxs-lookup"><span data-stu-id="aac73-109">In this situation, a caller must declare the needed functions from this documentation and get pointers to them using [**GetModuleHandle**](/windows/win32/api/libloaderapi/nf-libloaderapi-getmodulehandlea) on "Kernel32.dll", followed by calls to [**GetProcAddress**](/windows/win32/api/libloaderapi/nf-libloaderapi-getprocaddress).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="aac73-110">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="aac73-110">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="aac73-111">**CopyContext**</span><span class="sxs-lookup"><span data-stu-id="aac73-111">**CopyContext**</span></span>](/windows/desktop/api/WinBase/nf-winbase-copycontext)
</dt> <dt>

[<span data-ttu-id="aac73-112">**InitializeContext**</span><span class="sxs-lookup"><span data-stu-id="aac73-112">**InitializeContext**</span></span>](/windows/desktop/api/WinBase/nf-winbase-initializecontext)
</dt> <dt>

[<span data-ttu-id="aac73-113">**GetEnabledXStateFeatures**</span><span class="sxs-lookup"><span data-stu-id="aac73-113">**GetEnabledXStateFeatures**</span></span>](/windows/desktop/api/WinBase/nf-winbase-getenabledxstatefeatures)
</dt> <dt>

[<span data-ttu-id="aac73-114">**LocateXStateFeature**</span><span class="sxs-lookup"><span data-stu-id="aac73-114">**LocateXStateFeature**</span></span>](/windows/desktop/api/WinBase/nf-winbase-locatexstatefeature)
</dt> <dt>

[<span data-ttu-id="aac73-115">**GetXStateFeaturesMask**</span><span class="sxs-lookup"><span data-stu-id="aac73-115">**GetXStateFeaturesMask**</span></span>](/windows/desktop/api/WinBase/nf-winbase-getxstatefeaturesmask)
</dt> <dt>

[<span data-ttu-id="aac73-116">**SetXStateFeaturesMask**</span><span class="sxs-lookup"><span data-stu-id="aac73-116">**SetXStateFeaturesMask**</span></span>](/windows/desktop/api/WinBase/nf-winbase-setxstatefeaturesmask)
</dt> </dl>
