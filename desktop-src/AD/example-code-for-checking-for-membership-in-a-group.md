---
title: Exemplo de código para verificar a associação em um grupo
description: O exemplo de código a seguir verifica a associação absoluta de um objeto, verificando recursivamente se um objeto é membro de um grupo ou de quaisquer grupos aninhados nesse grupo.
...
O exemplo de código a seguir verifica a associação absoluta de um objeto, verificando recursivamente se um objeto é membro de um grupo ou de quaisquer grupos aninhados nesse grupo.
