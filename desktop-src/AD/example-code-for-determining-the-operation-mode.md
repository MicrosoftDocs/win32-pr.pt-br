...
---
# <a name="example-code-for-determining-the-operation-mode"></a><span data-ttu-id="3ca5e-104">Exemplo de código para determinar o modo de operação</span><span class="sxs-lookup"><span data-stu-id="3ca5e-104">Example Code for Determining the Operation Mode</span></span>

<span data-ttu-id="3ca5e-105">Este tópico inclui um exemplo de código que lê a propriedade **ntMixedDomain** de um domínio e determina o modo de operação.</span><span class="sxs-lookup"><span data-stu-id="3ca5e-105">This topic includes a code example that reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>

<span data-ttu-id="3ca5e-106">O exemplo de código C++ a seguir lê a propriedade **ntMixedDomain** de um domínio e determina o modo de operação.</span><span class="sxs-lookup"><span data-stu-id="3ca5e-106">The following C++ code example reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>
...
<span data-ttu-id="3ca5e-107">O exemplo de código a seguir Visual Basic lê a propriedade **ntMixedDomain** de um domínio e determina o modo de operação.</span><span class="sxs-lookup"><span data-stu-id="3ca5e-107">The following Visual Basic code example reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>
...
<span data-ttu-id="3ca5e-108">O exemplo de código a seguir Visual Basic Scripting Edition lê a propriedade **ntMixedDomain** de um domínio e determina o modo de operação.</span><span class="sxs-lookup"><span data-stu-id="3ca5e-108">The following Visual Basic Scripting Edition code example reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>
