---
title: Exemplo de código para pesquisar grupos em um domínio
description: Este tópico inclui um exemplo de código que pesquisa a subárvore do contêiner especificado para todos os objetos de grupo que têm o tipo de grupo especificado.
ms.assetid: 07b27324-4f59-42c2-a42f-8c2cef138928
ms.tgt_platform: multiple
keywords:
- Exemplos de Active Directory Active Directory, procurando grupos em um domínio
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103915944"
---
# <a name="example-code-for-searching-for-groups-in-a-domain"></a><span data-ttu-id="5a6d7-104">Exemplo de código para pesquisar grupos em um domínio</span><span class="sxs-lookup"><span data-stu-id="5a6d7-104">Example Code for Searching for Groups in a Domain</span></span>

<span data-ttu-id="5a6d7-105">O exemplo de código C/C++ a seguir pesquisa a subárvore do contêiner especificado para todos os objetos de grupo que têm o tipo de grupo especificado.</span><span class="sxs-lookup"><span data-stu-id="5a6d7-105">The following C/C++ code example searches the subtree of the specified container for all group objects that have the specified group type.</span></span>
