...
---
# <a name="vb-script-listing-all-service-connection-points"></a>Script VB listando todos os pontos de conexão de serviço

Os pontos de conexão de serviço podem ser gerenciados usando o script VB. O código de exemplo a seguir mostra como listar todos os pontos de conexão de serviço no nome de domínio fornecido na linha de comando:
