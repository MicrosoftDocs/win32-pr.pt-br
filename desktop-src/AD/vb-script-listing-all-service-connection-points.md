---
title: Script VB listando todos os pontos de conexão de serviço
ms.assetid: 7a76f872-3e4e-4bb7-8f2d-e30b1246369f
ms.tgt_platform: multiple
description: 'Saiba mais sobre: script VB listando todos os pontos de conexão de serviço'
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "104456945"
---
# <a name="vb-script-listing-all-service-connection-points"></a><span data-ttu-id="00aef-103">Script VB listando todos os pontos de conexão de serviço</span><span class="sxs-lookup"><span data-stu-id="00aef-103">VB Script Listing all Service Connection Points</span></span>

<span data-ttu-id="00aef-104">Os pontos de conexão de serviço podem ser gerenciados usando o script VB.</span><span class="sxs-lookup"><span data-stu-id="00aef-104">Service Connection Points can be managed using VB Script.</span></span> <span data-ttu-id="00aef-105">O código de exemplo a seguir mostra como listar todos os pontos de conexão de serviço no nome de domínio fornecido na linha de comando:</span><span class="sxs-lookup"><span data-stu-id="00aef-105">The following sample code shows how to list all Service Connection Points on the domain name provided on the command line:</span></span>
