...
quando você usa com para criar uma DLL de extensão de menu de contexto para um serviço de diretório Active Directory, a extensão deve ser registrada com o registro de Windows e Active Directory Domain Services para notificar os snap-ins administrativos do MMC de Active Directory e o shell de Windows da extensão.
