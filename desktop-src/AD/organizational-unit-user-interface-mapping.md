...
---
# <a name="organizational-unit-user-interface-mapping"></a>Mapeamento da interface do usuário da unidade organizacional

Este tópico descreve as folhas de propriedades de objeto da UO (unidade organizacional) no snap-in Active Directory usuários e computadores.
...
| CEP | [**Código postal**](/windows/desktop/ADSchema/a-postalcode)      |
