---
title: Exemplo de código para criar um usuário
description: Este tópico inclui exemplos de código que criam um usuário em um domínio controlado por Active Directory Domain Services.
...
---
# <a name="example-code-for-creating-a-user"></a><span data-ttu-id="941c3-104">Exemplo de código para criar um usuário</span><span class="sxs-lookup"><span data-stu-id="941c3-104">Example Code for Creating a User</span></span>

<span data-ttu-id="941c3-105">Este tópico inclui exemplos de código que criam um usuário em um domínio controlado por Active Directory Domain Services.</span><span class="sxs-lookup"><span data-stu-id="941c3-105">This topic includes code examples that create a user in a domain controlled by Active Directory Domain Services.</span></span>
