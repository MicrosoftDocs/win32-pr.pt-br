...
keywords:
- Windows Registro de soquetes e de resolução, código de exemplo, implementando um serviço Winsock com uma publicação RnR
...
ms.locfileid: "118693650"
---
# <a name="example-code-for-implementing-a-winsock-service-with-an-rnr-publication"></a>Exemplo de código para implementar um serviço Winsock com uma publicação RnR

O exemplo de código a seguir implementa o serviço Winsock de exemplo com a publicação RnR.

Este exemplo usa a função **serverRegister** definida no [código de exemplo para publicar o tópico do ponto de conexão do RnR](example-code-for-publishing-the-rnr-connection-point.md) e a função **ServerUnregister** definida no [código de exemplo para remover o tópico do ponto de conexão do RnR](example-code-for-removing-the-rnr-connection-point.md) .
