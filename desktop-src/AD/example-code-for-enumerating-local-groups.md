---
title: Exemplo de código para enumeração de grupos locais
description: Este tópico inclui um exemplo de código que enumera todos os objetos de uma classe especificada.
ms.assetid: d113d132-24cf-4319-826b-0d3d10e432f6
ms.tgt_platform: multiple
keywords:
- Exemplos de Active Directory Active Directory, enumerando grupos locais
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="example-code-for-enumerating-local-groups"></a><span data-ttu-id="e392d-104">Exemplo de código para enumeração de grupos locais</span><span class="sxs-lookup"><span data-stu-id="e392d-104">Example Code for Enumerating Local Groups</span></span>

<span data-ttu-id="e392d-105">Este tópico inclui um exemplo de código que enumera todos os objetos de uma classe especificada.</span><span class="sxs-lookup"><span data-stu-id="e392d-105">This topic includes a code example that enumerates all objects of a specified class.</span></span>

<span data-ttu-id="e392d-106">O exemplo de código C++ a seguir enumera todos os objetos de uma classe especificada usando ADSI.</span><span class="sxs-lookup"><span data-stu-id="e392d-106">The following C++ code example enumerates all objects of a specified class using ADSI.</span></span>
...
<span data-ttu-id="e392d-107">O exemplo de código a seguir Visual Basic enumera os grupos locais usando as interfaces [**IADsContainer**](/windows/desktop/api/iads/nn-iads-iadscontainer) e [**IADs**](/windows/desktop/api/iads/nn-iads-iadsgroup) .</span><span class="sxs-lookup"><span data-stu-id="e392d-107">The following Visual Basic code example enumerates local groups using the [**IADsContainer**](/windows/desktop/api/iads/nn-iads-iadscontainer) and [**IADsGroup**](/windows/desktop/api/iads/nn-iads-iadsgroup) interfaces.</span></span>
