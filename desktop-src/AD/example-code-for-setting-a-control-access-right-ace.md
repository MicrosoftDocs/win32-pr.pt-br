---
title: Exemplo de código para definir uma ACE Right de acesso de controle
description: O exemplo de código C/C++ a seguir adiciona uma ACE para um direito de acesso de controle à ACL de um objeto.
ms.assetid: 8fb5eb47-27ca-4e60-ad39-ca4392da4e7d
ms.tgt_platform: multiple
keywords:
- Exemplo de código para definir um acesso de controle ACE Right
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104159318"
---
# <a name="example-code-for-setting-a-control-access-right-ace"></a><span data-ttu-id="85b92-104">Exemplo de código para definir uma ACE Right de acesso de controle</span><span class="sxs-lookup"><span data-stu-id="85b92-104">Example Code for Setting a Control Access Right ACE</span></span>

<span data-ttu-id="85b92-105">O exemplo de código C/C++ a seguir adiciona uma ACE para um direito de acesso de controle à ACL de um objeto.</span><span class="sxs-lookup"><span data-stu-id="85b92-105">The following C/C++ code example adds an ACE for a control access right to the ACL of an object.</span></span>
