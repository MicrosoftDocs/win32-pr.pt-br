---
title: Exemplo de código para criar um descritor de segurança
description: Este tópico inclui um exemplo de código Visual Basic que mostra como criar um objeto de descritor de segurança para um objeto ADSI.
ms.assetid: 7c6dcdaf-0bef-4f72-bd9d-dc3ab4295008
ms.tgt_platform: multiple
keywords:
- Exemplo de código para criar um descritor de segurança
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "104453508"
---
# <a name="example-code-for-creating-a-security-descriptor"></a><span data-ttu-id="50002-104">Exemplo de código para criar um descritor de segurança</span><span class="sxs-lookup"><span data-stu-id="50002-104">Example Code for Creating a Security Descriptor</span></span>

<span data-ttu-id="50002-105">Este tópico inclui um exemplo de código Visual Basic que mostra como criar um objeto de descritor de segurança para um objeto ADSI.</span><span class="sxs-lookup"><span data-stu-id="50002-105">This topic includes a Visual Basic code example that shows you how to create a security descriptor object for an ADSI object.</span></span>
