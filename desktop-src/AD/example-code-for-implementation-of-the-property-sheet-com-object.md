---
title: Exemplo de código para implementação do objeto COM da folha de propriedades
description: O exemplo de código a seguir pode ser usado para implementar uma extensão de folha de propriedades Active Directory.
ms.assetid: aeee870e-1a0e-437f-a724-0bbac30f5e34
ms.tgt_platform: multiple
keywords:
- Exemplo de código para implementação do objeto COM da folha de propriedades AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104453926"
---
# <a name="example-code-for-implementation-of-the-property-sheet-com-object"></a><span data-ttu-id="036d6-104">Exemplo de código para implementação do objeto COM da folha de propriedades</span><span class="sxs-lookup"><span data-stu-id="036d6-104">Example Code for Implementation of the Property Sheet COM Object</span></span>

<span data-ttu-id="036d6-105">O exemplo de código a seguir pode ser usado para implementar uma extensão de folha de propriedades Active Directory.</span><span class="sxs-lookup"><span data-stu-id="036d6-105">The following code example can be used to implement an Active Directory property sheet extension.</span></span>

## <a name="ishellextinit-implementation"></a><span data-ttu-id="036d6-106">Implementação de IShellExtInit</span><span class="sxs-lookup"><span data-stu-id="036d6-106">IShellExtInit Implementation</span></span>

<span data-ttu-id="036d6-107">O exemplo de código C++ a seguir pode ser usado para implementar os métodos [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .</span><span class="sxs-lookup"><span data-stu-id="036d6-107">The following C++ code example can be used to implement the [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) methods.</span></span>
...
## <a name="ishellpropsheetext-implementation"></a><span data-ttu-id="036d6-108">Implementação de IShellPropSheetExt</span><span class="sxs-lookup"><span data-stu-id="036d6-108">IShellPropSheetExt Implementation</span></span>

<span data-ttu-id="036d6-109">O exemplo de código C++ a seguir pode ser usado para implementar os métodos [**IShellPropSheetExt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) .</span><span class="sxs-lookup"><span data-stu-id="036d6-109">The following C++ code example can be used to implement the [**IShellPropSheetExt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) methods.</span></span>
...
## <a name="miscellaneous-implementation"></a><span data-ttu-id="036d6-110">Implementação diversas</span><span class="sxs-lookup"><span data-stu-id="036d6-110">Miscellaneous Implementation</span></span>

<span data-ttu-id="036d6-111">O exemplo de código C++ a seguir pode ser usado para implementar os métodos e funções do utilitário usados no exemplo de código anterior.</span><span class="sxs-lookup"><span data-stu-id="036d6-111">The following C++ code example can be used to implement the utility methods and functions used in the previous code example.</span></span>
