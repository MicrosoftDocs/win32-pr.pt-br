...
ms.locfileid: "118190597"
---
# <a name="example-code-for-implementation-of-the-property-sheet-com-object"></a>Exemplo de código para implementação do objeto COM da folha de propriedades

O exemplo de código a seguir pode ser usado para implementar uma extensão de folha de propriedades Active Directory.

## <a name="ishellextinit-implementation"></a>Implementação de IShellExtInit

O exemplo de código C++ a seguir pode ser usado para implementar os métodos [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .
...
## <a name="ishellpropsheetext-implementation"></a>Implementação de IShellPropSheetExt

O exemplo de código C++ a seguir pode ser usado para implementar os métodos [**IShellPropSheetExt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) .
...
## <a name="miscellaneous-implementation"></a>Implementação diversas

O exemplo de código C++ a seguir pode ser usado para implementar os métodos e funções do utilitário usados no exemplo de código anterior.
