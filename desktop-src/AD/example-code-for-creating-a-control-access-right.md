...
---
# <a name="example-code-for-creating-a-control-access-right"></a>Exemplo de código para criar um direito de acesso de controle

O exemplo a seguir Visual Basic cria um objeto **controlAccessRight** no contêiner Extended-Rights.
...
O exemplo de código C++ a seguir é uma função que cria um objeto **controlAccessRight** no contêiner Extended-Rights. Ao chamar essa função, use o formato a seguir para especificar a cadeia de caracteres GUID para o parâmetro *pszRightsGUID* .
...
A matriz **ADSVALUE** da propriedade **AppliesTo** usa o mesmo formato de GUID e define o membro **dwType** como a **cadeia \_ de \_ \_ caracteres de ignorar caso de ADSTYPE**.
...
Essa função de exemplo **CreateExtendedRight** pode ser chamada com o exemplo de código a seguir.
