---
title: Exemplo de código para criar um grupo
description: Este tópico inclui um código de exemplo de código que cria um grupo.
ms.assetid: f6bba6fc-fec2-4dd9-b7f2-da7782a6caa5
ms.tgt_platform: multiple
keywords:
- Exemplos de Active Directory Active Directory, criando um grupo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104453509"
---
# <a name="example-code-for-creating-a-group"></a><span data-ttu-id="6a6da-104">Exemplo de código para criar um grupo</span><span class="sxs-lookup"><span data-stu-id="6a6da-104">Example Code for Creating a Group</span></span>

<span data-ttu-id="6a6da-105">O exemplo de código C++ a seguir contém uma função que cria um grupo com apenas as propriedades essenciais definidas explicitamente (**CN**, **sAMAccountType**, **GroupType**) e não contém membros.</span><span class="sxs-lookup"><span data-stu-id="6a6da-105">The following C++ code example contains a function that creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
...
<span data-ttu-id="6a6da-106">O exemplo de código a seguir Visual Basic cria um grupo com apenas as propriedades essenciais definidas explicitamente (**CN**, **sAMAccountType**, **GroupType**) e não contém membros.</span><span class="sxs-lookup"><span data-stu-id="6a6da-106">The following Visual Basic code example creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
