...
---
# <a name="example-code-for-extending-the-schema-programmatically"></a><span data-ttu-id="e8195-105">Exemplo de código para estender o esquema programaticamente</span><span class="sxs-lookup"><span data-stu-id="e8195-105">Example Code for Extending the Schema Programmatically</span></span>

<span data-ttu-id="e8195-106">Este tópico inclui um exemplo de código C++ que estende programaticamente o esquema de Active Directory.</span><span class="sxs-lookup"><span data-stu-id="e8195-106">This topic includes a C++ code example that programmatically extends the Active Directory Schema.</span></span>
