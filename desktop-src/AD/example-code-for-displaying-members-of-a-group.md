...
---
# <a name="example-code-for-displaying-members-of-a-group"></a><span data-ttu-id="3a103-104">Exemplo de código para exibir membros de um grupo</span><span class="sxs-lookup"><span data-stu-id="3a103-104">Example Code for Displaying Members of a Group</span></span>

<span data-ttu-id="3a103-105">Este tópico inclui exemplos de código que exibem membros de um grupo.</span><span class="sxs-lookup"><span data-stu-id="3a103-105">This topic includes code examples that display members of a group.</span></span>

<span data-ttu-id="3a103-106">O exemplo de código C++ a seguir usa as classes [**IADs**](/windows/desktop/api/iads/nn-iads-iadsgroup) e [**IADsMembers**](/windows/desktop/api/iads/nn-iads-iadsmembers) para exibir os membros de um grupo.</span><span class="sxs-lookup"><span data-stu-id="3a103-106">The following C++ code example uses the [**IADsGroup**](/windows/desktop/api/iads/nn-iads-iadsgroup) and [**IADsMembers**](/windows/desktop/api/iads/nn-iads-iadsmembers) classes to display the members of a group.</span></span>
...
<span data-ttu-id="3a103-107">O exemplo de código a seguir Visual Basic usa a classe [**IADs**](/windows/desktop/api/iads/nn-iads-iads) para exibir os membros do grupo.</span><span class="sxs-lookup"><span data-stu-id="3a103-107">The following Visual Basic code example uses the [**IADs**](/windows/desktop/api/iads/nn-iads-iads) class to display the group members.</span></span>
