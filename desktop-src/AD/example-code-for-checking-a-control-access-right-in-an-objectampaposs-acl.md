...
---
# <a name="example-code-for-checking-a-control-access-right-in-an-objects-acl"></a>Código de exemplo para verificar um direito de acesso de controle na ACL de um objeto

O exemplo a seguir pode ser usado para verificar se o usuário conectado no momento tem permissões para um direito de acesso de controle no objeto especificado.
