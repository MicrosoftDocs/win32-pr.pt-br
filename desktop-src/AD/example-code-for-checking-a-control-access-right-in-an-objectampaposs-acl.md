---
title: Código de exemplo para verificar um direito de acesso de controle na ACL de um objeto
description: O exemplo a seguir pode ser usado para verificar se o usuário conectado no momento tem permissões para um direito de acesso de controle no objeto especificado.
ms.assetid: 360320b8-32bd-4141-924b-25833a2761c8
ms.tgt_platform: multiple
keywords:
- Código de exemplo para verificar um direito de acesso de controle na ACL de um objeto
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103822286"
---
# <a name="example-code-for-checking-a-control-access-right-in-an-objects-acl"></a><span data-ttu-id="14826-104">Código de exemplo para verificar um direito de acesso de controle na ACL de um objeto</span><span class="sxs-lookup"><span data-stu-id="14826-104">Example Code for Checking a Control Access Right in an Object's ACL</span></span>

<span data-ttu-id="14826-105">O exemplo a seguir pode ser usado para verificar se o usuário conectado no momento tem permissões para um direito de acesso de controle no objeto especificado.</span><span class="sxs-lookup"><span data-stu-id="14826-105">The following example can be used to verify that the currently logged-on user has permissions for a control access right on the specified object.</span></span>
