...
ms.locfileid: "118188255"
---
# <a name="how-applications-should-use-display-specifiers"></a>Como os aplicativos devem usar especificadores de exibição

Para exibir Domínio do Active Directory objetos de serviço, use especificadores de exibição para obter dados de exibição localizados para objetos de classe e atributo. Isso permite que os nomes de exibição localizados e os ícones sejam usados e evita a localização desnecessária dos dados de exibição.

## <a name="display-names"></a>Nomes de exibição

As propriedades **classDisplayName** e **attributeDisplayNames** dos objetos de especificador de exibição para a localidade apropriada devem ser usadas para obter texto de exibição para nomes de classe e atributo. Não use as propriedades **CN**, **classDisplayName** ou **LdapDisplayName** dos objetos **classSchema** ou **attributeSchema** para obter rótulos de texto de exibição porque esses valores não são localizados. Para obter mais informações sobre como recuperar texto localizado para um objeto de classe, consulte o código de exemplo a seguir.

## <a name="icons"></a>Ícones

A propriedade **iconPath** dos objetos de especificador de exibição para a localidade apropriada deve ser usada para obter o ícone a ser exibido para um objeto de classe. Para obter mais informações, consulte [ícones de classe](class-icons.md). Se nenhum ícone localizado for especificado para um objeto de classe, um ícone padrão deverá ser exibido para o item.

## <a name="creating-new-objects"></a>Criando novos objetos

Quando possível, use os assistentes de criação de objeto apropriados para criar novos objetos. Para obter mais informações, consulte [invocando assistentes de criação do seu aplicativo](invoking-creation-wizards-from-your-application.md).
