...
## <a name="registering-a-notification-handler-in-the-windows-registry"></a>Registrando um manipulador de notificação no registro do Windows
...
Os manipuladores de notificação são registrados no atributo **dsUIAdminNotification** no contêiner **DS-UI-default-Settings** . Esse valor de cadeia de caracteres Unicode com vários valores, em que cada valor requer o seguinte formato:
