...
ms.locfileid: "118694252"
---
# <a name="example-code-for-creating-a-container-object"></a>Exemplo de código para criar um objeto de contêiner

O exemplo de código a seguir cria dois objetos. Primeiro, um objeto de contêiner e, segundo, um objeto de subcontêiner. Um valor para o objeto de subcontêiner é adicionado à propriedade [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) do objeto de contêiner. O exemplo de código é associado ao objeto de subcontêiner usando a associação WKGUID e exibe seu ADsPath. Em seguida, ele renomeia o objeto de subcontêiner e se associa novamente usando a mesma associação de WKGUID.
