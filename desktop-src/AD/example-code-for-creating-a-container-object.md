---
title: Exemplo de código para criar um objeto de contêiner
description: O exemplo de código a seguir cria dois objetos.
ms.assetid: bd9a8d62-c8e8-4ee5-86d8-bda5ddeb6e2c
ms.tgt_platform: multiple
keywords:
- Exemplos de Active Directory Active Directory, criando um objeto de contêiner
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103917135"
---
# <a name="example-code-for-creating-a-container-object"></a><span data-ttu-id="6adda-104">Exemplo de código para criar um objeto de contêiner</span><span class="sxs-lookup"><span data-stu-id="6adda-104">Example Code for Creating a Container Object</span></span>

<span data-ttu-id="6adda-105">O exemplo de código a seguir cria dois objetos.</span><span class="sxs-lookup"><span data-stu-id="6adda-105">The following code example creates two objects.</span></span> <span data-ttu-id="6adda-106">Primeiro, um objeto de contêiner e, segundo, um objeto de subcontêiner.</span><span class="sxs-lookup"><span data-stu-id="6adda-106">First, a container object and, second, a sub-container object.</span></span> <span data-ttu-id="6adda-107">Um valor para o objeto de subcontêiner é adicionado à propriedade [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) do objeto de contêiner.</span><span class="sxs-lookup"><span data-stu-id="6adda-107">A value for the sub-container object is added to the [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) property of the container object.</span></span> <span data-ttu-id="6adda-108">O exemplo de código é associado ao objeto de subcontêiner usando a associação WKGUID e exibe seu ADsPath.</span><span class="sxs-lookup"><span data-stu-id="6adda-108">The code example binds to the sub-container object using the WKGUID binding and displays its ADsPath.</span></span> <span data-ttu-id="6adda-109">Em seguida, ele renomeia o objeto de subcontêiner e se associa novamente usando a mesma associação de WKGUID.</span><span class="sxs-lookup"><span data-stu-id="6adda-109">It then renames the sub-container object and binds again using the same WKGUID binding.</span></span>
