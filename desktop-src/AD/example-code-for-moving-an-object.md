...
---
# <a name="example-code-for-moving-an-object"></a><span data-ttu-id="8ccb0-105">Exemplo de código para mover um objeto</span><span class="sxs-lookup"><span data-stu-id="8ccb0-105">Example Code for Moving an Object</span></span>

<span data-ttu-id="8ccb0-106">Este tópico inclui exemplos de código usados para mover um objeto no domínio.</span><span class="sxs-lookup"><span data-stu-id="8ccb0-106">This topic includes code examples used to move an object in the domain.</span></span>

<span data-ttu-id="8ccb0-107">O exemplo de código C++ a seguir mostra como usar ADSI para mover um objeto no domínio.</span><span class="sxs-lookup"><span data-stu-id="8ccb0-107">The following C++ code example shows how to use ADSI to move an object in the domain.</span></span>
...
<span data-ttu-id="8ccb0-108">O exemplo de código a seguir Visual Basic mostra como usar ADSI para mover um objeto no domínio.</span><span class="sxs-lookup"><span data-stu-id="8ccb0-108">The following Visual Basic code example shows how to use ADSI to move an object in the domain.</span></span>
