---
title: Exemplo de código para criar um objeto crossRef externo
description: Este tópico inclui um exemplo de código que cria um objeto crossRef externo.
ms.assetid: 282ca648-3bc7-4c5b-98db-1d8f2d040e3a
ms.tgt_platform: multiple
keywords:
- Exemplos de Active Directory Active Directory, criando um objeto crossRef externo
- Exemplos de Active Directory Active Directory criação de um anúncio de referência externa, código de exemplo
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "104007313"
---
# <a name="example-code-for-creating-an-external-crossref-object"></a><span data-ttu-id="45e86-105">Exemplo de código para criar um objeto crossRef externo</span><span class="sxs-lookup"><span data-stu-id="45e86-105">Example Code for Creating an External crossRef Object</span></span>

<span data-ttu-id="45e86-106">O exemplo de código a seguir Visual Basic mostra como criar um objeto [**crossRef**](/windows/desktop/ADSchema/c-crossref) externo.</span><span class="sxs-lookup"><span data-stu-id="45e86-106">The following Visual Basic code example shows how to create an external [**crossRef**](/windows/desktop/ADSchema/c-crossref) object.</span></span>
