...
---
# <a name="updating-a-service-connection-point"></a>Atualizando um ponto de conexão de serviço

O exemplo de código a seguir mostra como atualizar um ponto de conexão de serviço. Esse código é normalmente executado por um serviço quando ele é iniciado.

Este exemplo recupera a cadeia de caracteres de associação do GUID do SCP que o instalador de serviço armazenou em cache no registro. Ele usa essa cadeia de caracteres para associar a um ponteiro [**IDirectoryObject**](/windows/desktop/api/iads/nn-iads-idirectoryobject) no objeto SCP e, em seguida, chama o método [**IDirectoryObject:: getobjectattributes**](/windows/desktop/api/iads/nf-iads-idirectoryobject-getobjectattributes) para obter os atributos **serviceDNSName** e **ServiceBindingInformation** do SCP. Lembre-se de que seu serviço pode exigir a verificação e a atualização de atributos adicionais.

O código compara o valor de **serviceDNSName** com o nome DNS retornado pela função [**GetComputerNameEx devia**](/windows/desktop/api/sysinfoapi/nf-sysinfoapi-getcomputernameexa) . Ele também compara o número da porta atual do serviço com o número da porta armazenado no atributo **ServiceBindingInformation** . Se um desses valores tiver sido alterado, o código chamará o método [**IDirectoryObject:: Setobjectattributes**](/windows/desktop/api/iads/nf-iads-idirectoryobject-setobjectattributes) para atualizar os atributos do SCP.
