---
title: Arquitetura de Active Directory Domain Services
description: Esta seção apresenta os principais componentes de arquitetura do Active Directory Domain Services.
ms.assetid: 6af17ae4-4f31-47dd-a764-b6e5eeafc9c4
ms.tgt_platform: multiple
keywords:
- arquitetura do Active Directory Active Directory
- arquitetura do Active Directory Domain Services Active Directory
ms.topic: article
ms.date: 05/31/2018
