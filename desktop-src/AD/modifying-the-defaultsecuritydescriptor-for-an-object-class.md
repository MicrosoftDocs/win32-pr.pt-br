...
---
# <a name="modifying-the-defaultsecuritydescriptor-for-an-object-class"></a><span data-ttu-id="954dc-106">Modificando o defaultSecurityDescriptor para uma classe de objeto</span><span class="sxs-lookup"><span data-stu-id="954dc-106">Modifying the defaultSecurityDescriptor for an Object Class</span></span>

<span data-ttu-id="954dc-107">O exemplo de código a seguir recupera o descritor de segurança padrão para uma classe de objeto, adiciona uma ACE à DACL e, em seguida, define o descritor de segurança modificado na classe de objeto.</span><span class="sxs-lookup"><span data-stu-id="954dc-107">The following code example retrieves the default security descriptor for an object class, adds an ACE to the DACL, and then sets the modified security descriptor on the object class.</span></span>

<span data-ttu-id="954dc-108">Lembre-se de que a modificação de esquema está desabilitada, por padrão, em todos os controladores de domínio do Windows 2000.</span><span class="sxs-lookup"><span data-stu-id="954dc-108">Be aware that schema modification is disabled, by default, on all Windows 2000 domain controllers.</span></span> <span data-ttu-id="954dc-109">Para habilitar a modificação de esquema em um determinado DC, defina um \_ valor reg DWORD denominado "atualização de esquema permitido" na seguinte chave do registro:</span><span class="sxs-lookup"><span data-stu-id="954dc-109">To enable schema modification at a particular DC, set a REG\_DWORD value named "Schema Update Allowed" under the following registry key:</span></span>

<span data-ttu-id="954dc-110">**HKEY \_ \_** \\  \\  \\  \\  \\ **Parâmetros** NTDS dos serviços do sistema de máquina local CurrentControlSet</span><span class="sxs-lookup"><span data-stu-id="954dc-110">**HKEY\_LOCAL\_MACHINE**\\**System**\\**CurrentControlSet**\\**Services**\\**NTDS**\\**Parameters**</span></span>

<span data-ttu-id="954dc-111">Adicione esse valor se ele ainda não existir.</span><span class="sxs-lookup"><span data-stu-id="954dc-111">Add this value if it does not already exist.</span></span> <span data-ttu-id="954dc-112">Defina esse valor como 1 para habilitar a modificação do esquema.</span><span class="sxs-lookup"><span data-stu-id="954dc-112">Set this value to 1 to enable schema modification.</span></span> <span data-ttu-id="954dc-113">Se esse valor for zero, a modificação de esquema será desabilitada.</span><span class="sxs-lookup"><span data-stu-id="954dc-113">If this value is zero, schema modification is disabled.</span></span> <span data-ttu-id="954dc-114">O snap-in do MMC do Gerenciador de esquema fornece uma caixa de seleção que seleciona ou limpa essa chave do registro.</span><span class="sxs-lookup"><span data-stu-id="954dc-114">The Schema Manager MMC snap-in provides a check box that selects or clears this registry key.</span></span>
