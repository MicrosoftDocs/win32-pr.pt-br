---
title: autenticação mútua em um serviço de soquetes Windows com o SCP
...
keywords:
- autenticação mútua em um serviço de soquetes de Windows com um SCP AD
- Active Directory, usando a autenticação mútua, o serviço de soquetes Windows com um SCP
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "122881375"
---
# <a name="mutual-authentication-in-a-windows-sockets-service-with-scp"></a>autenticação mútua em um serviço de soquetes Windows com o SCP
...
-   [como um cliente autentica um serviço de soquetes de Windows baseado em SCP](how-a-client-authenticates-an-scp-based-windows-sockets-service.md)
-   [compor e registrar SPNs para um serviço de soquetes de Windows baseado em SCP](composing-and-registering-spns-for-an-scp-based-windows-sockets-service.md)
-   [como um serviço de soquetes de Windows autentica um cliente](how-a-windows-sockets-service-authenticates-a-client.md)
