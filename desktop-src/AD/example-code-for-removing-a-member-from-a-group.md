...
---
# <a name="example-code-for-removing-a-member-from-a-group"></a><span data-ttu-id="a7f21-104">Exemplo de código para remover um membro de um grupo</span><span class="sxs-lookup"><span data-stu-id="a7f21-104">Example Code for Removing a Member from a Group</span></span>

<span data-ttu-id="a7f21-105">O exemplo de código a seguir contém uma função que remove um membro de um grupo.</span><span class="sxs-lookup"><span data-stu-id="a7f21-105">The following code example contains a function that removes a member from a group.</span></span>
