...
---
# <a name="example-code-for-implementation-of-the-context-menu-com-object"></a><span data-ttu-id="d59f7-105">Código de exemplo para implementação do objeto COM do menu de contexto</span><span class="sxs-lookup"><span data-stu-id="d59f7-105">Example Code for Implementation of the Context Menu COM Object</span></span>

<span data-ttu-id="d59f7-106">O exemplo de código a seguir pode ser usado para implementar uma extensão de menu de contexto Active Directory.</span><span class="sxs-lookup"><span data-stu-id="d59f7-106">The following code example can be used to implement an Active Directory context menu extension.</span></span> <span data-ttu-id="d59f7-107">O item de menu de contexto único exibirá uma caixa de mensagem que contém o ADsPath de cada item selecionado.</span><span class="sxs-lookup"><span data-stu-id="d59f7-107">The single context menu item will display a message box that contains the ADsPath of each item selected.</span></span>

## <a name="ishellextinit-implementation"></a><span data-ttu-id="d59f7-108">Implementação de IShellExtInit</span><span class="sxs-lookup"><span data-stu-id="d59f7-108">IShellExtInit Implementation</span></span>

<span data-ttu-id="d59f7-109">O exemplo de código a seguir pode ser usado para implementar os métodos [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .</span><span class="sxs-lookup"><span data-stu-id="d59f7-109">The following code example can be used to implement the [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) methods.</span></span>
...
## <a name="icontextmenu-implementation"></a><span data-ttu-id="d59f7-110">Implementação de IContextMenu</span><span class="sxs-lookup"><span data-stu-id="d59f7-110">IContextMenu Implementation</span></span>

<span data-ttu-id="d59f7-111">O exemplo de código a seguir pode ser usado para implementar os métodos [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) .</span><span class="sxs-lookup"><span data-stu-id="d59f7-111">The following code example can be used to implement the [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) methods.</span></span>
