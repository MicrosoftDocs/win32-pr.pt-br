---
title: Código de exemplo para a criação de usuários em um servidor membro ou Windows 2000 Professional
description: O exemplo de código a seguir Visual Basic cria um usuário em um servidor membro ou Windows 2000 Professional.
ms.assetid: 0a0800d6-eb2c-4d88-b9d4-91640206fe7b
ms.tgt_platform: multiple
keywords:
- Active Directory exemplos Active Directory, criando usuários em um servidor membro ou no Windows 2000 Professional
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
---
# <a name="example-code-for-creating-users-on-a-member-server-or-windows-2000-professional"></a>Código de exemplo para a criação de usuários em um servidor membro ou Windows 2000 Professional

O exemplo de código a seguir Visual Basic cria um usuário em um servidor membro ou Windows 2000 Professional.
