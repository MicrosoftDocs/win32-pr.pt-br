...
Para obter mais informações e um exemplo de código usado para compor um SPN para um serviço, consulte [como um cliente autentica um serviço de soquetes do Windows baseado em SCP](how-a-client-authenticates-an-scp-based-windows-sockets-service.md).
