...
ms.locfileid: "118962295"
---
# <a name="example-code-for-creating-an-attribute"></a>Exemplo de código para criar um atributo

O exemplo de código a seguir cria um objeto [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) no contêiner de esquema.

A função **CreateAttribute** cria um objeto [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) no contêiner de esquema, mas não o confirma para o diretório. Chame o método [**IADs. setinfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) para confirmar o novo objeto **attributeSchema** no diretório.

A função **BytesToVariantArray** é uma função de utilitário que empacota uma cadeia de caracteres de octeto em uma matriz variante.
