---
title: Exemplo de código para criar um atributo
description: O exemplo de código a seguir cria um objeto attributeSchema no contêiner de esquema.
ms.assetid: 5f679a88-29d1-44ec-918b-091522188ae9
ms.tgt_platform: multiple
keywords:
- Exemplo de código para criar um atributo de AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104453928"
---
# <a name="example-code-for-creating-an-attribute"></a><span data-ttu-id="4b31d-104">Exemplo de código para criar um atributo</span><span class="sxs-lookup"><span data-stu-id="4b31d-104">Example Code for Creating an Attribute</span></span>

<span data-ttu-id="4b31d-105">O exemplo de código a seguir cria um objeto [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) no contêiner de esquema.</span><span class="sxs-lookup"><span data-stu-id="4b31d-105">The following code example creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container.</span></span>

<span data-ttu-id="4b31d-106">A função **CreateAttribute** cria um objeto [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) no contêiner de esquema, mas não o confirma para o diretório.</span><span class="sxs-lookup"><span data-stu-id="4b31d-106">The **CreateAttribute** function creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container, but does not commit it to the directory.</span></span> <span data-ttu-id="4b31d-107">Chame o método [**IADs. setinfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) para confirmar o novo objeto **attributeSchema** no diretório.</span><span class="sxs-lookup"><span data-stu-id="4b31d-107">Call the [**IADs.SetInfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) method to commit the new **attributeSchema** object to the directory.</span></span>

<span data-ttu-id="4b31d-108">A função **BytesToVariantArray** é uma função de utilitário que empacota uma cadeia de caracteres de octeto em uma matriz variante.</span><span class="sxs-lookup"><span data-stu-id="4b31d-108">The **BytesToVariantArray** function is a utility function that packs an octet string into a variant array.</span></span>
