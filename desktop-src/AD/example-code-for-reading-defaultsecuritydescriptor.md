---
title: Exemplo de código para leitura de defaultSecurityDescriptor
description: O exemplo de código a seguir lê o defaultSecurityDescriptor para uma classe de objeto especificada.
ms.assetid: 9462686d-654b-40bb-be10-80ca03790ad5
ms.tgt_platform: multiple
keywords:
- Exemplos de Active Directory Active Directory, lendo defaultSecurityDescriptor
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118962235"
---
# <a name="example-code-for-reading-defaultsecuritydescriptor"></a>Exemplo de código para leitura de defaultSecurityDescriptor

O exemplo de código a seguir lê o **defaultSecurityDescriptor** para uma classe de objeto especificada.
