---
title: Código de exemplo para adicionar um usuário de domínio ou grupo a um grupo local
description: Este tópico inclui um exemplo de código que mostra como adicionar um usuário de domínio ou grupo a um grupo local em um servidor membro ou um computador em execução no Windows NT Workstation ou Windows 2000 Professional.
ms.assetid: 6333ce9f-0396-4af7-9e81-f008cf4536ec
ms.tgt_platform: multiple
keywords:
- Exemplos do Active Directory do Active Directory, adicionando um usuário de domínio ou grupo a um grupo local
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="example-code-for-adding-a-domain-user-or-group-to-a-local-group"></a>Código de exemplo para adicionar um usuário de domínio ou grupo a um grupo local

O exemplo de código C++ a seguir adiciona um usuário de domínio ou grupo a um grupo local em um servidor membro ou em um computador em execução no Windows NT Workstation ou Windows 2000 Professional.
...
O exemplo Visual Basic código a seguir adiciona um usuário de domínio ou grupo a um grupo local em um servidor membro ou em um computador em execução no Windows NT Workstation ou Windows 2000 Professional.
