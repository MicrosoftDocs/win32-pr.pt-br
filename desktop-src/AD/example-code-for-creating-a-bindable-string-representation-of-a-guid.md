...
ms.locfileid: "118694279"
---
# <a name="example-code-for-creating-a-bindable-string-representation-of-a-guid"></a>Exemplo de código para criar uma representação de cadeia de caracteres vinculável de um GUID

O exemplo de código a seguir pode ser usado para retornar uma representação de cadeia de caracteres de um GUID que pode ser usado para associar ao objeto.
