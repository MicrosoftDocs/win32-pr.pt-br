---
title: Código de exemplo para pesquisa de usuários
description: Os exemplos de código a seguir pesquisam usuários no domínio da conta de usuário sob a qual o processo de chamada está sendo executado. Exemplo básico do C++ ExampleVisual
ms.assetid: 53bbd57b-0bd2-4acb-a69f-89764b85e257
ms.tgt_platform: multiple
keywords:
- Exemplos de Active Directory Active Directory, pesquisando usuários
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104365823"
---
# <a name="example-code-for-searching-for-users"></a><span data-ttu-id="16c4a-104">Código de exemplo para pesquisa de usuários</span><span class="sxs-lookup"><span data-stu-id="16c4a-104">Example Code for Searching for Users</span></span>

<span data-ttu-id="16c4a-105">Os exemplos de código a seguir pesquisam usuários no domínio da conta de usuário sob a qual o processo de chamada está sendo executado.</span><span class="sxs-lookup"><span data-stu-id="16c4a-105">The following code examples search for users in the domain of the user account under which the calling process is running.</span></span>

-   [<span data-ttu-id="16c4a-106">Exemplo de C++</span><span class="sxs-lookup"><span data-stu-id="16c4a-106">C++ Example</span></span>](#c-example)
-   [<span data-ttu-id="16c4a-107">Exemplo de Visual Basic</span><span class="sxs-lookup"><span data-stu-id="16c4a-107">Visual Basic Example</span></span>](#visual-basic-example)

## <a name="c-example"></a><span data-ttu-id="16c4a-108">Exemplo de C++</span><span class="sxs-lookup"><span data-stu-id="16c4a-108">C++ Example</span></span>

<span data-ttu-id="16c4a-109">O exemplo de código C++ a seguir pesquisa o domínio atual para todos os usuários ou um usuário específico com base em um filtro especificado.</span><span class="sxs-lookup"><span data-stu-id="16c4a-109">The following C++ code example searches the current domain for all users, or a specific user based on a specified filter.</span></span>
...
## <a name="visual-basic-example"></a><span data-ttu-id="16c4a-110">Exemplo de Visual Basic</span><span class="sxs-lookup"><span data-stu-id="16c4a-110">Visual Basic Example</span></span>

<span data-ttu-id="16c4a-111">O exemplo de código a seguir Visual Basic pesquisa o domínio atual para usuários com o sobrenome especificado e retorna os atributos Name e [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) para os objetos encontrados.</span><span class="sxs-lookup"><span data-stu-id="16c4a-111">The following Visual Basic code example searches the current domain for users with the specified surname and returns the name and [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) attributes for the objects that are found.</span></span> <span data-ttu-id="16c4a-112">O exemplo de código a seguir usa o ADO para executar a pesquisa.</span><span class="sxs-lookup"><span data-stu-id="16c4a-112">The following code example uses ADO to perform the search.</span></span>
