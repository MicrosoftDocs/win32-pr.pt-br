---
title: Exemplo de código para criar uma partição de diretório de aplicativo
description: Este tópico inclui exemplos de código para criar uma partição de diretório de aplicativo.
ms.assetid: dc538afc-8529-42cf-a276-a4579d555557
ms.tgt_platform: multiple
keywords:
- código de exemplo para criar uma partição de diretório de aplicativo Active Directory
- partições de diretório de aplicativo Active Directory, código de exemplo para criar
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="example-code-for-creating-an-application-directory-partition"></a><span data-ttu-id="16f16-105">Exemplo de código para criar uma partição de diretório de aplicativo</span><span class="sxs-lookup"><span data-stu-id="16f16-105">Example Code for Creating an Application Directory Partition</span></span>

<span data-ttu-id="16f16-106">O exemplo de código C++ a seguir cria uma nova partição de diretório de aplicativo usando ADSI.</span><span class="sxs-lookup"><span data-stu-id="16f16-106">The following C++ code example creates a new application directory partition using ADSI.</span></span>
...
<span data-ttu-id="16f16-107">O exemplo de código a seguir Visual Basic Scripting Edition mostra como criar uma nova partição de diretório de aplicativo usando ADSI.</span><span class="sxs-lookup"><span data-stu-id="16f16-107">The following Visual Basic Scripting Edition code example shows how to create a new application directory partition using ADSI.</span></span>
...
<span data-ttu-id="16f16-108">O exemplo de código .NET a seguir Visual Basic mostra como criar uma nova partição de diretório de aplicativo usando [System. DirectoryServices](/dotnet/api/system.directoryservices).</span><span class="sxs-lookup"><span data-stu-id="16f16-108">The following Visual Basic .NET code example shows how to create a new application directory partition using [System.DirectoryServices](/dotnet/api/system.directoryservices).</span></span>
...
<span data-ttu-id="16f16-109">O exemplo de código C# a seguir mostra como criar uma nova partição de diretório de aplicativo usando [System. DirectoryServices](/dotnet/api/system.directoryservices).</span><span class="sxs-lookup"><span data-stu-id="16f16-109">The following C# code example shows how to create a new application directory partition using [System.DirectoryServices](/dotnet/api/system.directoryservices).</span></span>
