---
title: Exemplo de código para pesquisar objetos de esquema
description: Este tópico inclui um exemplo de código usado para pesquisar objetos de esquema.
ms.assetid: 539e0127-1355-4606-97bd-49dfafb25f8d
ms.tgt_platform: multiple
keywords:
- Código de exemplo para pesquisa de objetos de esquema AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118190256"
---
# <a name="example-code-for-searching-for-schema-objects"></a>Exemplo de código para pesquisar objetos de esquema

Este tópico inclui um exemplo de código usado para pesquisar objetos de esquema.

O exemplo de código C++ a seguir mostra como Pesquisar objetos de esquema que têm bits definidos no atributo **systemFlags** .
...
O exemplo de código C e C++ a seguir mostra como procurar objetos de esquema replicados para o catálogo global.
...
O exemplo de código C e C++ a seguir mostra como Pesquisar objetos de esquema indexados.
