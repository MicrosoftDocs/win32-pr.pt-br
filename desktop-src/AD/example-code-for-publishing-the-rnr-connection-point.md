---
title: Código de exemplo para publicação do ponto de conexão do RnR
description: O exemplo de código a seguir é usado pelo serviço Winsock para registrar o ponto de conexão do RnR para o serviço.
ms.assetid: dd2c7ac9-76fc-4366-8654-8048e6793a16
ms.tgt_platform: multiple
keywords:
- Código de exemplo para publicar o AD do ponto de conexão do RnR
- Registro do Windows Sockets, anúncio de resolução, código de exemplo, publicação do ponto de conexão do RnR
- Publicando o AD do ponto de conexão do RnR, código de exemplo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104159320"
---
# <a name="example-code-for-publishing-the-rnr-connection-point"></a><span data-ttu-id="1decf-106">Código de exemplo para publicação do ponto de conexão do RnR</span><span class="sxs-lookup"><span data-stu-id="1decf-106">Example Code for Publishing the RnR Connection Point</span></span>

<span data-ttu-id="1decf-107">O exemplo de código a seguir é usado pelo serviço Winsock para registrar o ponto de conexão do RnR para o serviço.</span><span class="sxs-lookup"><span data-stu-id="1decf-107">The following code example is used by the Winsock service to register the RnR connection point for the service.</span></span>
