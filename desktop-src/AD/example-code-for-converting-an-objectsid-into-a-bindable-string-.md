---
title: Código de exemplo para converter um objectSid em uma cadeia de caracteres vinculável
description: Este tópico contém um exemplo de código que converte um objectSid em uma cadeia de caracteres vinculável para adicionar um membro que pertence a um domínio de nível inferior a um grupo em um domínio de nível superior.
...
ms.locfileid: "118191086"
---
# <a name="example-code-for-converting-an-objectsid-into-a-bindable-string"></a>Código de exemplo para converter um objectSid em uma cadeia de caracteres vinculável

Este tópico contém um exemplo de código que converte um **objectSid** em uma cadeia de caracteres vinculável para adicionar um membro que pertence a um domínio de nível inferior a um grupo em um domínio de nível superior.

O exemplo de código C++ a seguir mostra como converter um **objectSid** em uma cadeia de caracteres vinculável.
