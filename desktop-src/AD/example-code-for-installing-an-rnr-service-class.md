---
title: Código de exemplo para instalar uma classe de serviço RnR
description: O programa a seguir instala uma classe de serviço RnR.
ms.assetid: 85605ecf-bc82-48ac-8b36-ee43862a3bc9
ms.tgt_platform: multiple
keywords:
- Registro do Windows Sockets, anúncio de resolução, código de exemplo, instalação de uma classe de serviço RnR
- Instalando um anúncio de classe de serviço RnR, código de exemplo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104159322"
---
# <a name="example-code-for-installing-an-rnr-service-class"></a><span data-ttu-id="5d7b0-105">Código de exemplo para instalar uma classe de serviço RnR</span><span class="sxs-lookup"><span data-stu-id="5d7b0-105">Example Code for Installing an RnR Service Class</span></span>

<span data-ttu-id="5d7b0-106">O programa a seguir instala uma classe de serviço RnR.</span><span class="sxs-lookup"><span data-stu-id="5d7b0-106">The following program installs an RnR Service class.</span></span>
