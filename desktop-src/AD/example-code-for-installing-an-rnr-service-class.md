...
---
# <a name="example-code-for-installing-an-rnr-service-class"></a>Código de exemplo para instalar uma classe de serviço RnR

O programa a seguir instala uma classe de serviço RnR.
