---
title: Código de exemplo para definir direitos para tipos específicos de objetos
description: O exemplo de código C/C++ a seguir cria uma ACE que atribui direitos herdados pelo tipo de objeto especificado, mas que não são eficazes no objeto atual.
ms.assetid: c36ae0c8-40ad-4afd-8552-4de77f4463e2
ms.tgt_platform: multiple
keywords:
- Exemplos de Active Directory Active Directory, definindo direitos para tipos específicos de objetos
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118189797"
---
# <a name="example-code-for-setting-rights-to-specific-types-of-objects"></a>Código de exemplo para definir direitos para tipos específicos de objetos

O exemplo de código C/C++ a seguir cria uma ACE que atribui direitos herdados pelo tipo de objeto especificado, mas que não são eficazes no objeto atual.
