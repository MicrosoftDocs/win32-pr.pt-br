...
ms.locfileid: "118908800"
---
# <a name="cng-cryptographic-configuration-functions"></a>Funções de configuração criptográfica de CNG

Cryptography API: próxima geração (CNG) define as funções a seguir que são usadas com o sistema de configuração de criptografia CNG.
...
-   [**BCryptRegisterConfigChangeNotify (identificador \* )**](/windows/desktop/api/Bcrypt/nf-bcrypt-bcryptregisterconfigchangenotify)
...
-   [**BCryptUnregisterConfigChangeNotify (identificador)**](/windows/desktop/api/Bcrypt/nf-bcrypt-bcryptunregisterconfigchangenotify)
