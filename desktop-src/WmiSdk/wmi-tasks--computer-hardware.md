...
---
# <a name="wmi-tasks-computer-hardware"></a>Tarefas do WMI: hardware do computador

As tarefas do WMI para o hardware do computador obtêm informações sobre a presença, o estado ou as propriedades dos componentes de hardware. Por exemplo, você pode determinar se um computador é um desktop ou um laptop. Para obter outros exemplos, consulte o TechNet ScriptCenter em [https://www.microsoft.com/technet](https://technet.microsoft.com/default.aspx) .
...
<tbody>
<tr class="odd">
<td>... determinar a quantidade de memória livre que um computador tem?</td>
<td>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-operatingsystem"><strong>Win32_OperatingSystem</strong></a> e a propriedade <strong>FreePhysicalMemory</strong> .<br/> <span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
<col style="width: 100%" />
</colgroup>
...
<tr class="even">
<td>... determinar se um computador tem uma unidade de DVD?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-cdromdrive"><strong>Win32_CDROMDrive</strong></a> e verifique o DVD acrônimo na propriedade <strong>Name</strong> ou <strong>DeviceID</strong> .</p>
<div class="code">
...
<tr class="odd">
<td>... determinar a quantidade de RAM instalada em um computador?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-computersystem"><strong>Win32_ComputerSystem</strong></a> e verifique o valor da propriedade <strong>TotalPhysicalMemory</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... determinar se um computador tem mais de um processador?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-computersystem"><strong>Win32_ComputerSystem</strong></a> e a propriedade <strong>NumberOfProcessors</strong>.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... determinar se um computador tem um slot PCMCIA?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-pcmciacontroller"><strong>Win32_PCMCIAController</strong></a> e verifique o valor da propriedade <strong>Count</strong> . Se <strong>Count</strong> for 0, o computador não terá nenhum slot PCMCIA.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... identificar os dispositivos que não estão funcionando (aqueles marcados com um ícone de ponto de exclamação no <strong>Gerenciador de dispositivos</strong>)?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-pnpentity"><strong>Win32_PnPEntity</strong></a> e use a seguinte cláusula em sua consulta <a href="querying-with-wql.md">WQL</a> . <strong>Onde ConfigManagerErrorCode <> 0</strong> Observe que esse código pode não detectar dispositivos USB que não têm drivers.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... determinar as propriedades do mouse usadas no computador?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-pointingdevice"><strong>Win32_PointingDevice</strong></a> . Isso retorna as propriedades de todos os dispositivos apontadores, não apenas os dispositivos de mouse.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... determinar a velocidade de um processador instalado em um computador?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-processor"><strong>Win32_Processor</strong></a> e verifique o valor da propriedade <strong>MaxClockSpeed</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... determinar se um computador é uma torre, um mini-torre, um laptop e assim por diante?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-systemenclosure"><strong>Win32_SystemEnclosure</strong></a> e verifique o valor da propriedade <strong>ChassisType</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... obter o número de série e a marca de ativo de um computador?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-systemenclosure"><strong>Win32_SystemEnclosure</strong></a> e as propriedades <strong>SerialNumber</strong> e <strong>SMBIOSAssetTag</strong>.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... determinar que tipo de dispositivo está conectado a uma porta USB?</td>
<td><p>Use a classe <a href="/previous-versions/windows/desktop/cimwin32a/win32-usbhub"><strong>Win32_USBHub</strong></a> e verifique a propriedade <strong>Descrição</strong> . Essa propriedade pode ter um valor como um &quot; dispositivo de armazenamento em massa &quot; ou &quot; suporte de impressão &quot; .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... determinar quantas unidades de fita estão instaladas em um computador?</td>
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-tapedrive"><strong>Win32_TapeDrive</strong></a> Class e, em seguida, use o método <a href="swbemobjectset-count.md"><strong>SWbemObjectSet. Count</strong></a> . Se contagem = 0, não há unidades de fita instaladas no computador.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
O [código de exemplo](https://Gallery.TechNet.Microsoft.Com/scriptcenter/List-for-several-machines-1baf6df0) da galeria do TechNet a seguir descreve como listar o espaço livre de todas as unidades para vários computadores.

As [informações do computador get-ComputerInfo-Query de computadores locais/remotos-(WMI) exemplo do](https://Gallery.TechNet.Microsoft.Com/Get-ComputerInfo-Query-23dd6042) PowerShell na galeria do TechNet usam várias chamadas para hardware e software para exibir informações sobre um sistema local ou remoto.

O exemplo de [coleta de ativos de sistema multithread com](https://Gallery.TechNet.Microsoft.Com/Multithreaded-System-Asset-856a8f7c) PowerShell do PowerShell no TechNetGallery coleta uma infinidade de informações úteis do sistema por meio de WMI e multithreading com o PowerShell.
