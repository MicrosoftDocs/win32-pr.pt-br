---
description: As tarefas WMI para hardware do computador obtém informações sobre a presença, o estado ou as propriedades dos componentes de hardware.
ms.assetid: eb4c2c38-4853-4486-b889-93a843d88edb
ms.tgt_platform: multiple
title: 'Tarefas WMI: Hardware do Computador'
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "122624562"
---
# <a name="wmi-tasks-computer-hardware"></a>Tarefas WMI: Hardware do Computador

As tarefas WMI para hardware do computador obtém informações sobre a presença, o estado ou as propriedades dos componentes de hardware. Por exemplo, você pode determinar se um computador é um desktop ou laptop. Para outros exemplos, consulte o TechNet ScriptCenter em [https://www.microsoft.com/technet](https://technet.microsoft.com/default.aspx) .
...
<tbody>
<tr class="odd">
<td>... determinar a memória livre que um computador tem?</td>
<td>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-operatingsystem"><strong>Win32_OperatingSystem</strong></a> e a <strong>propriedade FreePhysicalMemory.</strong><br/> <span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
<col  />
</colgroup>
...
<td><p>Use a <a href="/windows/desktop/CIMWin32Prov/win32-cdromdrive"><strong>Win32_CDROMDrive</strong></a> classe e verifique o DVD do acrônimo na <strong>propriedade Name</strong> ou <strong>DeviceID.</strong></p>
<div class="code">
...
<td><p>Use a <a href="/windows/desktop/CIMWin32Prov/win32-computersystem"><strong>Win32_ComputerSystem</strong></a> classe e verifique o valor da <strong>propriedade TotalPhysicalMemory.</strong></p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Use a <a href="/windows/desktop/CIMWin32Prov/win32-computersystem"><strong>Win32_ComputerSystem</strong></a> e a propriedade <strong>NumberOfProcessors</strong>.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Use a <a href="/windows/desktop/CIMWin32Prov/win32-pcmciacontroller"><strong>Win32_PCMCIAController</strong></a> classe e verifique o valor da <strong>propriedade Count.</strong> Se <strong>Count</strong> for 0, o computador não terá slots PCMCIA.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... identificar dispositivos que não estão funcionando (aqueles marcados com um ícone de ponto de exclamação <strong>Gerenciador de Dispositivos</strong>)?</td>
<td><p>Use a <a href="/windows/desktop/CIMWin32Prov/win32-pnpentity"><strong>Win32_PnPEntity</strong></a> e use a cláusula a seguir em sua <a href="querying-with-wql.md">consulta WQL.</a> <strong>WHERE ConfigManagerErrorCode <> 0</strong> Observe que esse código pode não detectar dispositivos USB que não têm drivers.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Use a <a href="/windows/desktop/CIMWin32Prov/win32-pointingdevice"><strong>classe Win32_PointingDevice</strong></a> dados. Isso retorna as propriedades de todos os dispositivos que apontam, não apenas dispositivos com mouse.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Use a <a href="/windows/desktop/CIMWin32Prov/win32-processor"><strong>Win32_Processor</strong></a> classe e verifique o valor da <strong>propriedade MaxClockSpeed.</strong></p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... determinar se um computador é uma torre, uma mini-torre, um laptop e assim por diante?</td>
<td><p>Use a <a href="/windows/desktop/CIMWin32Prov/win32-systemenclosure"><strong>Win32_SystemEnclosure</strong></a> classe e verifique o valor da <strong>propriedade ChassisType.</strong></p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Use a <a href="/windows/desktop/CIMWin32Prov/win32-systemenclosure"><strong>Win32_SystemEnclosure</strong></a> e as propriedades <strong>SerialNumber</strong> e <strong>SMBIOSAssetTag</strong>.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Use a <a href="/previous-versions/windows/desktop/cimwin32a/win32-usbhub"><strong>classe Win32_USBHub</strong></a> e verifique a <strong>propriedade Descrição.</strong> Essa propriedade pode ter um valor como &quot; Mass Armazenamento Dispositivo &quot; ou Suporte &quot; à &quot; Impressão.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<td><p>Use a classe <a href="/windows/desktop/CIMWin32Prov/win32-tapedrive"><strong>Win32_TapeDrive</strong></a> classe e, em seguida, use o <a href="swbemobjectset-count.md"><strong>método SWbemObjectSet.Count.</strong></a> Se Count = 0, nenhuma unidades de fita será instalada no computador.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
O código de exemplo da Galeria do TechNet [a](https://Gallery.TechNet.Microsoft.Com/scriptcenter/List-for-several-machines-1baf6df0) seguir descreve como listar o espaço livre de todas as unidades para vários máquinas.

O exemplo [do PowerShell Get-ComputerInfo – Query Computer From Local/Remote Computers – (WMI) na](https://Gallery.TechNet.Microsoft.Com/Get-ComputerInfo-Query-23dd6042) Galeria do TechNet usa várias chamadas para hardware e software para exibir informações sobre um sistema local ou remoto.

O exemplo coleta de ativos do sistema multithread com [o PowerShell](https://Gallery.TechNet.Microsoft.Com/Multithreaded-System-Asset-856a8f7c) do PowerShell no TechNetGallery coleta uma grande quantidade de informações úteis do sistema por meio de WMI e multithreading com o PowerShell.
