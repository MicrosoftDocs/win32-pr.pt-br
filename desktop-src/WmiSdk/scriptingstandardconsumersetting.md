---
description: A classe singleton ScriptingStandardConsumerSetting fornece dados de registro comuns a todas as instâncias da classe de consumidor padrão ActiveScriptEventConsumer.
...
A classe **singleton ScriptingStandardConsumerSetting** fornece dados de registro comuns a todas as instâncias da classe de consumidor padrão [**ActiveScriptEventConsumer.**](activescripteventconsumer.md) Uma **instância ActiveScriptEventConsumer** usa as **propriedades MaximumScripts** e **Timeout.** Para obter mais informações, [consulte Monitoramento e resposta a eventos com consumidores padrão.](monitoring-and-responding-to-events-with-standard-consumers.md)
...
Uma breve descrição de um objeto em uma cadeia de caracteres de uma linha. Contém a cadeia **de caracteres ScriptingStandardConsumerSetting** porque essa é uma classe singleton.
...
Número máximo de scripts que são executados antes de um consumidor iniciar uma nova instância. Para limpar vazamentos de memória de scripts, desligue o consumidor regularmente. O valor padrão é 300.
...
Número máximo de minutos antes de um consumidor iniciar uma nova instância. Se 0 (zero), a propriedade **MaximumScripts** controlará o tempo de vida do consumidor. O intervalo válido para **Timeout** é de 0 a 71.000 e o valor padrão é 0 (zero).
