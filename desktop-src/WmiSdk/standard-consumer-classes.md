...
| [**NTEventLogEventConsumer**](nteventlogeventconsumer.md)                   | Registra uma mensagem específica no log de eventos do Windows quando um evento é entregue a ele.<br/> Exemplo: [log no log de eventos NT com base em um evento](logging-to-nt-event-log-based-on-an-event.md)<br/>                                          |
