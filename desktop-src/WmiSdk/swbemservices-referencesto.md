...
---
# <a name="swbemservicesreferencesto-method"></a>Método SWbemServices. References

O método **References** do objeto [**SWbemServices**](swbemservices.md) retorna uma coleção de todas as classes ou instâncias de associação que se referem a uma classe ou instância de origem específica. Esse método executa a mesma função que as [referências da](references-of-statement.md) consulta WQL executa.
...
Após a conclusão do método **References** , o objeto **Err** pode conter um dos códigos de erro na lista a seguir.
