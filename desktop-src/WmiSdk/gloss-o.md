...
Uma cadeia de caracteres formatada que identifica exclusivamente um [*namespace*](gloss-n.md), uma classe ou uma instância do WMI. Os caminhos de objeto são semelhantes em conceito a URLs (Uniform Resource Locators).
