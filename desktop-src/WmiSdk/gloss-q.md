...
ms.locfileid: "118319054"
---
# <a name="q-wmi"></a>P (WMI)
...
<span id="wmi.gloss_qualifier"></span><span id="WMI.GLOSS_QUALIFIER"></span>**qualificado**
</dt> <dd>

Um modificador que contém informações que descrevem uma classe, instância, [*Propriedade*](gloss-p.md), método ou parâmetro.

</dd> <dt>

<span id="wmi.gloss_qualifier_flavor"></span><span id="WMI.GLOSS_QUALIFIER_FLAVOR"></span>**tipo de qualificador**
</dt> <dd>

Consulte [*flavor*](gloss-f.md).
