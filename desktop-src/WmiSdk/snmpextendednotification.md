...
Identificação autoritativa desta notificação. Mapas diretamente à associação de variável SnmpTrapOID da entrada MIB. Esta propriedade é válida somente para o SNMPv2C.
