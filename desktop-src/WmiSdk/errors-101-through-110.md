---
description: Descreve os erros do provedor SNMP WMI 101 a 110.
ms.assetid: baa64233-eb19-4f52-836b-5bdf4a23ae4f
ms.tgt_platform: multiple
title: Erros 101 a 110
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105754090"
---
# <a name="errors-101-through-110"></a>Erros 101 a 110

Descreve os erros do provedor SNMP WMI 101 a 110.
...
Erro de sintaxe de linha de comando. Há alguns argumentos extras ou um comutador não é válido na linha de comando. O <last correct argument> parâmetro refere-se ao último argumento que foi lido corretamente na linha de comando e possivelmente pode ser smi2smir, que é o nome do arquivo executável para o compilador de informações do módulo SNMP.
...
<span id="_105__Fatal____Maximum_diagnostic_count_missing_after_the__c_switch_"></span><span id="_105__fatal____maximum_diagnostic_count_missing_after_the__c_switch_"></span><span id="_105__FATAL____MAXIMUM_DIAGNOSTIC_COUNT_MISSING_AFTER_THE__C_SWITCH_"></span>**<105, fatal>: "contagem máxima de diagnósticos ausente após a opção/c"**
</dt> <dd>
...
<span id="_106__Fatal_____argument__is_not_a_valid_diagnostic_count_"></span><span id="_106__fatal_____argument__is_not_a_valid_diagnostic_count_"></span><span id="_106__FATAL_____ARGUMENT__IS_NOT_A_VALID_DIAGNOSTIC_COUNT_"></span>**<106, fatal>: " <argument> não é uma contagem de diagnóstico válida"**
</dt> <dd>
...
<span id="_107__Fatal____File_Name_s__missing_"></span><span id="_107__fatal____file_name_s__missing_"></span><span id="_107__FATAL____FILE_NAME_S__MISSING_"></span>**<107,> fatal: "nome (s) de arquivo ausente"**
</dt> <dd>

Erro semântico de linha de comando. Um ou mais nomes de arquivo devem ser especificados na linha de comando para a combinação determinada de opções.
...
Erro de sintaxe de linha de comando. Algumas ações devem ser especificadas na linha de comando.
