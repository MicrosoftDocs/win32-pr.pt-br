...
ms.locfileid: "119897576"
---
# <a name="swbemrefreshableitemobjectset-property"></a>Propriedade SWbemRefreshableItem. ObjectSet

A propriedade **SWbemRefreshableItem. ObjectSet** representa o conjunto de objetos a ser atualizado. A propriedade **ObjectSet** é um enumerador ou um item de coleta contido em um objeto [**SWbemRefresher**](swbemrefresher.md) .
...
Essa propriedade é **nula** , a menos que [**SWbemRefreshableItem. IsSet**](swbemrefreshableitem-isset.md) seja **true**.
