...
Determina o quão detalhado a chamada enumera. Os valores padrão para esse parâmetro são **wbemFlagReturnImmediately** e **wbemQueryFlagDeep**. Esse parâmetro pode aceitar os valores a seguir.
