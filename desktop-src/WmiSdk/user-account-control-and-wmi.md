...
Para executar o [seguinte WMI Command-Line Ferramentas](wmi-command-line-tools.md), sua conta deve estar no grupo Administradores e a ferramenta deve ser executado em um prompt de comandos com privilégios elevados. A conta de administrador integrado também pode executar essas ferramentas.
