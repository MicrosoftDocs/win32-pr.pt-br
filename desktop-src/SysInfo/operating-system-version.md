...
| Windows XP 64-edição de bits | 5.2   |
| Windows XP | 5.1                  |
| Windows 2000     | 5.0            |

**\*** para aplicativos que foram manifestados para Windows 8.1 ou Windows 10. os aplicativos não manifestados para Windows 8.1 ou Windows 10 retornarão o valor da versão do Windows 8 os (6,2). para manifestar seus aplicativos para Windows 8.1 ou Windows 10, consulte [direcionando seu aplicativo para Windows](targeting-your-application-at-windows-8-1.md).<br/>
...
para obter mais informações, consulte [Windows 10 informações de versão](/windows/release-information/) e [folha de fatos do ciclo de vida do Windows](https://support.microsoft.com/help/13853/windows-lifecycle-fact-sheet).
