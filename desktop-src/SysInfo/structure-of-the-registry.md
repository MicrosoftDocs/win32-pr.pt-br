---
description: O Registro é um banco de dados hierárquico que contém dados críticos para a operação do Windows e os aplicativos e serviços executados em Windows.
...
[Visão geral do Windows Registro](/previous-versions/windows/it-pro/windows-server-2003/cc781906(v=ws.10))
</dt> </dl>
