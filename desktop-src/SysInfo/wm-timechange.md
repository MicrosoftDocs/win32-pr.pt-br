...
---
# <a name="wm_timechange-message"></a>\_Mensagem de TIMEchange do WM

Uma mensagem que é enviada sempre que há uma alteração na hora do sistema.
...
Um aplicativo não deve transmitir essa mensagem, pois o sistema transmitirá essa mensagem quando o aplicativo alterar a hora do sistema.
