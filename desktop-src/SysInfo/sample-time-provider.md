---
description: O exemplo a seguir demonstra como estruturar um provedor de tempo. Neste exemplo, a DLL dá suporte a dois provedores de tempo de hardware.
ms.assetid: 6be08c49-be68-4b75-b740-fc1d5a2ff592
title: Provedor de tempo de exemplo
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104506054"
---
# <a name="sample-time-provider"></a><span data-ttu-id="3b3eb-104">Provedor de tempo de exemplo</span><span class="sxs-lookup"><span data-stu-id="3b3eb-104">Sample Time Provider</span></span>

<span data-ttu-id="3b3eb-105">O exemplo a seguir demonstra como estruturar um provedor de tempo.</span><span class="sxs-lookup"><span data-stu-id="3b3eb-105">The following example demonstrates how to structure a time provider.</span></span> <span data-ttu-id="3b3eb-106">Neste exemplo, a DLL dá suporte a dois provedores de tempo de hardware.</span><span class="sxs-lookup"><span data-stu-id="3b3eb-106">In this example, the DLL supports two hardware time providers.</span></span>
