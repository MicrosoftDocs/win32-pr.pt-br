...
---
# <a name="sample-time-provider"></a>Provedor de tempo de exemplo

O exemplo a seguir demonstra como estruturar um provedor de tempo. Neste exemplo, a DLL dá suporte a dois provedores de tempo de hardware.
