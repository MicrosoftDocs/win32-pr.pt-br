...
| REG \_ DWORD de valor \_ pequeno \_<br/> | Um número de 32 bits no formato little-endian.<br/> o Windows foi projetado para ser executado em arquiteturas de computador little-endian. portanto, esse valor é definido como REG \_ DWORD nos arquivos de cabeçalho Windows.<br/>                                                                                                                                                                                                                          |
| REG \_ DWORD \_ Big \_ ENDIAN<br/>    | Um número de 32 bits no formato big-endian.<br/> alguns sistemas UNIX dão suporte a arquiteturas big-endian.<br/>                                                                                                                                                                                                                                                                                                                         |
...
| REG \_ QWORD \_ Little \_ ENDIAN<br/> | Um número de 64 bits no formato little-endian.<br/> o Windows foi projetado para ser executado em arquiteturas de computador little-endian. portanto, esse valor é definido como REG \_ QWORD nos arquivos de cabeçalho Windows.<br/>                                                                                                                                                                                                                          |
