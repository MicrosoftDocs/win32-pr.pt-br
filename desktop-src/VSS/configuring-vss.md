---
description: 'Usando as ferramentas de configuração do VSS&\# 8212; incluindo a definição do contexto de cópia de sombra, a escolha de um método de restauração e a alteração de um destino de restauração&\# 8212; gravadores e solicitantes controlam como ocorre uma operação de backup ou restauração:'
ms.assetid: fe6d7e5d-c181-4413-a4ca-c9e0c7cfc6f5
title: Configurando o VSS
ms.topic: article
ms.date: 05/31/2018
