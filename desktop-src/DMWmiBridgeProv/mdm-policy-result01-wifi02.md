...
ms.locfileid: "119694506"
---
# <a name="mdm_policy_result01_wifi02-class"></a>\_Classe MDM \_ Result01 \_ WiFi02

\[Algumas informações estão relacionadas ao produto de pré-lançamento que pode ser substancialmente modificado antes de ser lançado comercialmente. A Microsoft não oferece garantias, expressas ou implícitas, das informações aqui fornecidas.\]

A classe **MDM \_ Policy \_ Result01 \_ WiFi02** representa as políticas de Wi-Fi disponíveis. Essas políticas determinam Wi-Fi configurações permitidas.
...
A **classe \_ \_ Result01 \_ WiFi02 da política MDM** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A **classe \_ \_ Result01 \_ WiFi02 da política MDM** tem essas propriedades.
...
Identifica o nome do nó pai. Para essa classe, a cadeia de caracteres é "WiFi".
