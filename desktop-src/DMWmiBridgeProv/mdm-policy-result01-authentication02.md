...
---
# <a name="mdm_policy_result01_authentication02-class"></a>\_Classe MDM \_ Result01 \_ Authentication02

\[Algumas informações estão relacionadas ao produto de pré-lançamento que pode ser substancialmente modificado antes de ser lançado comercialmente. A Microsoft não faz nenhuma garantia, expressa ou implícita, com relação às informações fornecidas aqui.\]

A classe **MDM \_ Policy \_ Result01 \_ Authentication02** representa as políticas de gerenciamento de autenticação disponíveis.
...
A **classe \_ \_ Result01 \_ Authentication02 da política MDM** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A **classe \_ \_ Result01 \_ Authentication02 da política MDM** tem essas propriedades.
