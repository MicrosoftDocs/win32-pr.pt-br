...
[Habilitada](/windows/client-management/mdm/enterpriseapn-csp#enterpriseapn-connectionname-enabled)
</dt> <dd> <dl> <dt>
...
nome da conexão como visto por Windows gerenciador de conexões.
