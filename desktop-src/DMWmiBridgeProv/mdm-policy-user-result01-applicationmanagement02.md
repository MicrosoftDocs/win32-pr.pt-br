...
---
# <a name="mdm_policy_user_result01_applicationmanagement02-class"></a>Result01 de usuário de política de MDM- \_ \_ \_ \_ classe ApplicationManagement02

\[Algumas informações estão relacionadas ao produto de pré-lançamento que pode ser substancialmente modificado antes de ser lançado comercialmente. A Microsoft não faz nenhuma garantia, expressa ou implícita, com relação às informações fornecidas aqui.\]

A **classe \_ \_ \_ Result01 \_ ApplicationManagement02 do usuário da política de MDM** representa as políticas de início disponíveis que são definidas por usuário.
...
A **classe \_ \_ \_ Result01 \_ ApplicationManagement02 do usuário da política MDM** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A **classe \_ \_ \_ Result01 \_ ApplicationManagement02 do usuário da política MDM** tem essas propriedades.
