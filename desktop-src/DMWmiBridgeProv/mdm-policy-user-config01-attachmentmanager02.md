...
description: A classe \_ \_ \_ AttachmentManager02 config01 AttachmentManager02 da Política de MDM \_ representa as políticas disponíveis do gerenciador de anexos.
ms.assetid: b20ec516-cdc9-4aeb-802d-97cd8423eceb
keywords:
- MDM_Policy_User_Config01_AttachmentManager02 classe
- MDM_Policy_User_Config01_AttachmentManager02 classe , descrita
topic_type:
- apiref
api_name:
...
ms.locfileid: "119875026"
---
# <a name="mdm_policy_user_config01_attachmentmanager02-class"></a>Classe \_ \_ \_ AttachmentManager02 de Configuração de Usuário da Política de MDM \_

\[Algumas informações estão relacionadas ao produto pré-lançado, que pode ser substancialmente modificado antes de ser lançado comercialmente. A Microsoft não oferece garantias, expressas ou implícitas, das informações aqui fornecidas.\]

A classe \_ \_ \_ AttachmentManager02 config01 AttachmentManager02 da Política de MDM \_ representa as políticas disponíveis do gerenciador de anexos.
...
A **classe \_ \_ \_ \_ AttachmentManager02 do MDM Policy User Config01** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A **classe MDM \_ Policy User \_ \_ Config01 \_ AttachmentManager02** tem essas propriedades.
