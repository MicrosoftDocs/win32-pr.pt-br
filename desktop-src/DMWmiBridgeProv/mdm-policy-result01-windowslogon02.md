...
---
# <a name="mdm_policy_result01_windowslogon02-class"></a>\_Classe MDM \_ Result01 \_ WindowsLogon02

\[Algumas informações estão relacionadas ao produto de pré-lançamento que pode ser substancialmente modificado antes de ser lançado comercialmente. A Microsoft não faz nenhuma garantia, expressa ou implícita, com relação às informações fornecidas aqui.\]

A \_ classe Result01 WindowsLogon02 da política de MDM \_ \_ Obtém as configurações da tela de bloqueio e da interface do usuário da rede no logon.
...
A **classe \_ \_ Result01 \_ WindowsLogon02 da política MDM** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A **classe \_ \_ Result01 \_ WindowsLogon02 da política MDM** tem essas propriedades.
