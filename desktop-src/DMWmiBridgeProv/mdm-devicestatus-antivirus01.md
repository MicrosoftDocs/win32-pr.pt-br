...
---
# <a name="mdm_devicestatus_antivirus01-class"></a>\_ \_ Classe ANTIVIRUS01 do MDM DeviceStatus

\[Algumas informações estão relacionadas ao produto de pré-lançamento que pode ser substancialmente modificado antes de ser lançado comercialmente. A Microsoft não faz nenhuma garantia, expressa ou implícita, com relação às informações fornecidas aqui.\]

A classe **MDM \_ DeviceStatus \_ Antivirus01** é usada pela empresa para consultar o estado de conformidade antivírus de dispositivos com suas políticas corporativas.
...
A **classe \_ \_ Antivirus01 de MDM DeviceStatus** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A **classe \_ \_ Antivirus01 do MDM DeviceStatus** tem essas propriedades.
