...
---
# <a name="mdm_activesync_user_options03-class"></a>\_ \_ Classe Options03 de usuário do MDM ActiveSync \_

\[Algumas informações estão relacionadas ao produto de pré-lançamento que pode ser substancialmente modificado antes de ser lançado comercialmente. A Microsoft não faz nenhuma garantia, expressa ou implícita, com relação às informações fornecidas aqui.\]

A **classe \_ \_ \_ Options03 de usuário do MDM ActiveSync** define as opções que são definidas para cada conta do ActiveSync.
...
A **classe \_ \_ \_ Options03 do usuário do MDM ActiveSync** tem estes tipos de membros:

-   [Propriedades](#properties)

### <a name="properties"></a>Propriedades

A **classe \_ \_ \_ Options03 de usuário do MDM ActiveSync** tem essas propriedades.
