...
|----------------|-----------|
| <strong>System. Runtime. InteropServices. COMException</strong> | Você pode receber essa exceção por um dos seguintes motivos:<ul><li>O objeto de desempenho especificado não foi encontrado no computador. O valor Err. Number é 0xC0000BB8.</li><li>O contador especificado não pôde ser encontrado. O valor Err. Number é 0xC0000BB9.</li></ul> | 
