...
description: Este exemplo mostra como implementar um serviço não tipado com o modelo de serviço. Nesse caso, o modelo de serviço fornece a infraestrutura de placa do preparador.
ms.assetid: 4235554e-19a8-4df7-97a5-2f7544a3c830
keywords:
- UnTypedServiceExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119083100"
---
# <a name="untypedserviceexample"></a>UnTypedServiceExample

Este exemplo mostra como implementar um serviço não tipado com o modelo de serviço. Nesse caso, o modelo de serviço fornece a infraestrutura de placa do preparador.
