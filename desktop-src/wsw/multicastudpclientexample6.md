...
description: Este exemplo mostra um cliente UDP que multicastsa uma solicitação e, em seguida, aguarda mensagens de resposta de servidores, usando IPv6.
...
ms.locfileid: "119444506"
---
# <a name="multicastudpclientexample6"></a>MulticastUdpClientExample6

Este exemplo mostra um cliente UDP que multicastsa uma solicitação e, em seguida, aguarda mensagens de resposta de servidores, usando IPv6.
