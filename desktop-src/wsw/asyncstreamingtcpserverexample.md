...
description: Este exemplo mostra um servidor TCP que recebe mensagens unidirecionais em um modo de streaming assíncrono.
ms.assetid: 8b79735b-f238-4d49-8977-2935fc208d48
keywords:
- AsyncStreamingTcpServerExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105764710"
---
# <a name="asyncstreamingtcpserverexample"></a><span data-ttu-id="82ca7-106">AsyncStreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="82ca7-106">AsyncStreamingTcpServerExample</span></span>

<span data-ttu-id="82ca7-107">Este exemplo mostra um servidor TCP que recebe mensagens unidirecionais em um modo de streaming assíncrono.</span><span class="sxs-lookup"><span data-stu-id="82ca7-107">This example shows a TCP server that receives one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="82ca7-108">AsyncStreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="82ca7-108">AsyncStreamingTcpServer.cpp</span></span>](#asyncstreamingtcpservercpp)
-   [<span data-ttu-id="82ca7-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="82ca7-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="82ca7-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="82ca7-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpservercpp"></a><span data-ttu-id="82ca7-111">AsyncStreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="82ca7-111">AsyncStreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="82ca7-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="82ca7-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="82ca7-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="82ca7-113">Makefile</span></span>
