...
---
# <a name="httpcalculatorserviceexample"></a><span data-ttu-id="da5d8-106">HttpCalculatorServiceExample</span><span class="sxs-lookup"><span data-stu-id="da5d8-106">HttpCalculatorServiceExample</span></span>

<span data-ttu-id="da5d8-107">Este exemplo mostra como usar o host de serviço para hospedar um serviço de calculadora sobre HTTP.</span><span class="sxs-lookup"><span data-stu-id="da5d8-107">This example shows how to use service host for hosting a calculator service over HTTP.</span></span>

-   [<span data-ttu-id="da5d8-108">HttpCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="da5d8-108">HttpCalculatorService.cpp</span></span>](#httpcalculatorservicecpp)
-   [<span data-ttu-id="da5d8-109">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="da5d8-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="da5d8-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="da5d8-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicecpp"></a><span data-ttu-id="da5d8-111">HttpCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="da5d8-111">HttpCalculatorService.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="da5d8-112">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="da5d8-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="da5d8-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="da5d8-113">Makefile</span></span>
