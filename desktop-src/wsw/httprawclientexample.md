...
description: Este exemplo é o lado do cliente que envia solicitações HTTP brutas.
ms.assetid: bc9e108e-d4a0-4bdd-82c2-5486ea46364b
keywords:
- HttpRawClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103822788"
---
# <a name="httprawclientexample"></a><span data-ttu-id="c85e3-106">HttpRawClientExample</span><span class="sxs-lookup"><span data-stu-id="c85e3-106">HttpRawClientExample</span></span>

<span data-ttu-id="c85e3-107">Este exemplo é o lado do cliente que envia solicitações HTTP brutas.</span><span class="sxs-lookup"><span data-stu-id="c85e3-107">This example is the client side that sends raw HTTP requests.</span></span>

## <a name="httprawclientcpp"></a><span data-ttu-id="c85e3-108">HttpRawClient. cpp</span><span class="sxs-lookup"><span data-stu-id="c85e3-108">HttpRawClient.cpp</span></span>
