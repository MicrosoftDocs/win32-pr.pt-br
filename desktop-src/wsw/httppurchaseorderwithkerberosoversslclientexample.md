...
description: Este exemplo mostra um cliente HTTP que usa o proxy de serviço para se comunicar com um serviço PurchaseOrder, com segurança de modo misto Kerberos sobre SSL.
ms.assetid: 6756043c-ef4c-4fa6-a27b-7ecb900601f9
keywords:
- HttpPurchaseOrderWithKerberosOverSslClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104364146"
---
# <a name="httppurchaseorderwithkerberosoversslclientexample"></a><span data-ttu-id="962b7-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="962b7-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="962b7-107">Este exemplo mostra um cliente HTTP que usa o proxy de serviço para se comunicar com um serviço PurchaseOrder, com segurança de modo misto Kerberos sobre SSL.</span><span class="sxs-lookup"><span data-stu-id="962b7-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="962b7-108">Nessa configuração, a conexão de transporte é protegida (assinada, criptografada) pelo SSL que também fornece autenticação de servidor.</span><span class="sxs-lookup"><span data-stu-id="962b7-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="962b7-109">A autenticação de cliente é fornecida por um tíquete APREQ do Kerberos em um cabeçalho WS-Security na mensagem.</span><span class="sxs-lookup"><span data-stu-id="962b7-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="962b7-110">PurchaseOrderClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="962b7-110">PurchaseOrderClientKerberosOverSsl.cpp</span></span>](#purchaseorderclientkerberosoversslcpp)
-   [<span data-ttu-id="962b7-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="962b7-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="962b7-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="962b7-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientkerberosoversslcpp"></a><span data-ttu-id="962b7-113">PurchaseOrderClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="962b7-113">PurchaseOrderClientKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="962b7-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="962b7-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="962b7-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="962b7-115">Makefile</span></span>
