...
ms.locfileid: "119026514"
---
# <a name="httpcalculatorwithencodedchannelclientexample"></a>HttpCalculatorWithEncodedChannelClientExample

Este exemplo mostra como usar o proxy de serviço para se comunicar com um serviço de calculadora baseado em HTTP usando um canal personalizado. O canal usa um codificador personalizado.
