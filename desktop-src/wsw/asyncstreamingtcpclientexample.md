...
description: Este exemplo mostra um cliente TCP que envia mensagens unidirecionais em um modo de streaming assíncrono.
ms.assetid: b0040b3d-d830-421a-bbf1-afb0cac47599
keywords:
- AsyncStreamingTcpClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104292314"
---
# <a name="asyncstreamingtcpclientexample"></a><span data-ttu-id="9bbb6-106">AsyncStreamingTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="9bbb6-106">AsyncStreamingTcpClientExample</span></span>

<span data-ttu-id="9bbb6-107">Este exemplo mostra um cliente TCP que envia mensagens unidirecionais em um modo de streaming assíncrono.</span><span class="sxs-lookup"><span data-stu-id="9bbb6-107">This example shows a TCP client that sends one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="9bbb6-108">AsyncStreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9bbb6-108">AsyncStreamingTcpClient.cpp</span></span>](#asyncstreamingtcpclientcpp)
-   [<span data-ttu-id="9bbb6-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9bbb6-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9bbb6-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="9bbb6-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpclientcpp"></a><span data-ttu-id="9bbb6-111">AsyncStreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9bbb6-111">AsyncStreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9bbb6-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9bbb6-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9bbb6-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="9bbb6-113">Makefile</span></span>
