...
description: Este exemplo mostra um cliente HTTP que usa o proxy de serviço para se falar com um serviço de calculadora, com kerberos sobre segurança de modo misto SSL.
