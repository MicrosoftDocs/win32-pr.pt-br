...
---
# <a name="requestreplytcpclientwithwindowstransportsecurityexample"></a><span data-ttu-id="60d42-107">RequestReplyTcpClientWithWindowsTransportSecurityExample</span><span class="sxs-lookup"><span data-stu-id="60d42-107">RequestReplyTcpClientWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="60d42-108">Este exemplo mostra um cliente TCP que envia mensagens de solicitação-resposta, com segurança fornecida pela segurança de transporte SSPI do Windows.</span><span class="sxs-lookup"><span data-stu-id="60d42-108">This example shows a TCP client that sends request-reply messages, with security provided by Windows SSPI transport security.</span></span> <span data-ttu-id="60d42-109">Ele também ilustra o cliente usando propriedades de token de segurança para modificar o nível de representação permitido do padrão.</span><span class="sxs-lookup"><span data-stu-id="60d42-109">It also illustrates the client using security token properties to modify the allowed impersonation level from the default.</span></span>

-   [<span data-ttu-id="60d42-110">RequestReplyTcpClientWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="60d42-110">RequestReplyTcpClientWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpclientwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="60d42-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="60d42-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="60d42-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="60d42-112">Makefile</span></span>](#makefile)

## <a name="requestreplytcpclientwithwindowstransportsecuritycpp"></a><span data-ttu-id="60d42-113">RequestReplyTcpClientWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="60d42-113">RequestReplyTcpClientWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="60d42-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="60d42-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="60d42-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="60d42-115">Makefile</span></span>
