...
description: Examine um exemplo de leitura/gravação XML que usa a API de serviços Web do Windows (WWSAPI). Este exemplo grava XML em um buffer XML e, em seguida, lê-o de volta.
...
ms.locfileid: "112404089"
---
# <a name="readwritexmlexample"></a><span data-ttu-id="db018-107">ReadWriteXmlExample</span><span class="sxs-lookup"><span data-stu-id="db018-107">ReadWriteXmlExample</span></span>

<span data-ttu-id="db018-108">Este exemplo grava XML em um buffer XML e, em seguida, lê-o de volta.</span><span class="sxs-lookup"><span data-stu-id="db018-108">This example writes XML to an XML buffer, and then reads it back out.</span></span>

-   [<span data-ttu-id="db018-109">ReadWriteXml. cpp</span><span class="sxs-lookup"><span data-stu-id="db018-109">ReadWriteXml.cpp</span></span>](#readwritexmlcpp)
-   [<span data-ttu-id="db018-110">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="db018-110">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="db018-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="db018-111">Makefile</span></span>](#makefile)

## <a name="readwritexmlcpp"></a><span data-ttu-id="db018-112">ReadWriteXml. cpp</span><span class="sxs-lookup"><span data-stu-id="db018-112">ReadWriteXml.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="db018-113">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="db018-113">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="db018-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="db018-114">Makefile</span></span>
