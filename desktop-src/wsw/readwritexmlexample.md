...
ms.locfileid: "103915854"
---
# <a name="readwritexmlexample"></a><span data-ttu-id="79c71-106">ReadWriteXmlExample</span><span class="sxs-lookup"><span data-stu-id="79c71-106">ReadWriteXmlExample</span></span>

<span data-ttu-id="79c71-107">Este exemplo grava XML em um buffer XML e, em seguida, lê-o de volta.</span><span class="sxs-lookup"><span data-stu-id="79c71-107">This example writes XML to an XML buffer, and then reads it back out.</span></span>

-   [<span data-ttu-id="79c71-108">ReadWriteXml. cpp</span><span class="sxs-lookup"><span data-stu-id="79c71-108">ReadWriteXml.cpp</span></span>](#readwritexmlcpp)
-   [<span data-ttu-id="79c71-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="79c71-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="79c71-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="79c71-110">Makefile</span></span>](#makefile)

## <a name="readwritexmlcpp"></a><span data-ttu-id="79c71-111">ReadWriteXml. cpp</span><span class="sxs-lookup"><span data-stu-id="79c71-111">ReadWriteXml.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="79c71-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="79c71-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="79c71-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="79c71-113">Makefile</span></span>
