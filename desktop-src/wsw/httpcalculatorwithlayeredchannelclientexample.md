...
description: Este exemplo mostra como usar o proxy de serviço para se comunicar com um serviço de calculadora baseado em HTTP usando um canal personalizado. O canal personalizado é um canal em camadas que simplesmente Delega toda a funcionalidade ao canal HTTP existente.
ms.assetid: 897673df-f3a3-4b38-8b79-c9f1119be6d5
keywords:
- HttpCalculatorWithLayeredChannelClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105798485"
---
# <a name="httpcalculatorwithlayeredchannelclientexample"></a><span data-ttu-id="0f7fa-107">HttpCalculatorWithLayeredChannelClientExample</span><span class="sxs-lookup"><span data-stu-id="0f7fa-107">HttpCalculatorWithLayeredChannelClientExample</span></span>

<span data-ttu-id="0f7fa-108">Este exemplo mostra como usar o proxy de serviço para se comunicar com um serviço de calculadora baseado em HTTP usando um canal personalizado.</span><span class="sxs-lookup"><span data-stu-id="0f7fa-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="0f7fa-109">O canal personalizado é um canal em camadas que simplesmente Delega toda a funcionalidade ao canal HTTP existente.</span><span class="sxs-lookup"><span data-stu-id="0f7fa-109">The custom channel is a layered channel which simply delegates all functionality to the existing HTTP channel.</span></span>

-   [<span data-ttu-id="0f7fa-110">HttpCalculatorWithLayeredChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="0f7fa-110">HttpCalculatorWithLayeredChannelClient.cpp</span></span>](#httpcalculatorwithlayeredchannelclientcpp)
-   [<span data-ttu-id="0f7fa-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="0f7fa-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="0f7fa-112">LayeredChannel. h</span><span class="sxs-lookup"><span data-stu-id="0f7fa-112">LayeredChannel.h</span></span>](#layeredchannelh)
-   [<span data-ttu-id="0f7fa-113">LayeredChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="0f7fa-113">LayeredChannel.cpp</span></span>](#layeredchannelcpp)
-   [<span data-ttu-id="0f7fa-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="0f7fa-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithlayeredchannelclientcpp"></a><span data-ttu-id="0f7fa-115">HttpCalculatorWithLayeredChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="0f7fa-115">HttpCalculatorWithLayeredChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="0f7fa-116">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="0f7fa-116">CalculatorService.wsdl</span></span>
...
## <a name="layeredchannelh"></a><span data-ttu-id="0f7fa-117">LayeredChannel. h</span><span class="sxs-lookup"><span data-stu-id="0f7fa-117">LayeredChannel.h</span></span>
...
## <a name="layeredchannelcpp"></a><span data-ttu-id="0f7fa-118">LayeredChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="0f7fa-118">LayeredChannel.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0f7fa-119">Makefile</span><span class="sxs-lookup"><span data-stu-id="0f7fa-119">Makefile</span></span>
