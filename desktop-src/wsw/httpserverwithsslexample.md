...
description: Este exemplo mostra um servidor TCP que aceita um canal e recebe e responde a mensagens, com segurança de transporte SSL.
ms.assetid: 627b6ba8-3bb2-41f3-a456-a811eb3b8e3d
keywords:
- HttpServerWithSslExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104292773"
---
# <a name="httpserverwithsslexample"></a><span data-ttu-id="fa96c-106">HttpServerWithSslExample</span><span class="sxs-lookup"><span data-stu-id="fa96c-106">HttpServerWithSslExample</span></span>

<span data-ttu-id="fa96c-107">Este exemplo mostra um servidor TCP que aceita um canal e recebe e responde a mensagens, com segurança de transporte SSL.</span><span class="sxs-lookup"><span data-stu-id="fa96c-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="fa96c-108">HttpServerWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="fa96c-108">HttpServerWithSsl.cpp</span></span>](#httpserverwithsslcpp)
-   [<span data-ttu-id="fa96c-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="fa96c-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="fa96c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="fa96c-110">Makefile</span></span>](#makefile)

## <a name="httpserverwithsslcpp"></a><span data-ttu-id="fa96c-111">HttpServerWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="fa96c-111">HttpServerWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="fa96c-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="fa96c-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="fa96c-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="fa96c-113">Makefile</span></span>
