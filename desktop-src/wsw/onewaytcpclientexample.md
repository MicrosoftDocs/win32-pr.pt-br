...
ms.locfileid: "105788083"
---
# <a name="onewaytcpclientexample"></a><span data-ttu-id="1b83c-106">OneWayTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="1b83c-106">OneWayTcpClientExample</span></span>

<span data-ttu-id="1b83c-107">Este exemplo mostra um cliente TCP que envia uma mensagem unidirecional.</span><span class="sxs-lookup"><span data-stu-id="1b83c-107">This example shows a TCP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="1b83c-108">OneWayTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="1b83c-108">OneWayTcpClient.cpp</span></span>](#onewaytcpclientcpp)
-   [<span data-ttu-id="1b83c-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="1b83c-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="1b83c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="1b83c-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpclientcpp"></a><span data-ttu-id="1b83c-111">OneWayTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="1b83c-111">OneWayTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="1b83c-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="1b83c-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="1b83c-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="1b83c-113">Makefile</span></span>
