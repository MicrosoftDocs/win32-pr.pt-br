...
description: Este exemplo mostra um servidor UDP que escuta em um endereço multicast e responde às solicitações enviadas para esse endereço.
ms.assetid: 9688756b-3c5e-42ca-a9da-f258d4be2360
keywords:
- MulticastUdpServerExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105762850"
---
# <a name="multicastudpserverexample"></a><span data-ttu-id="ecce4-106">MulticastUdpServerExample</span><span class="sxs-lookup"><span data-stu-id="ecce4-106">MulticastUdpServerExample</span></span>

<span data-ttu-id="ecce4-107">Este exemplo mostra um servidor UDP que escuta em um endereço multicast e responde às solicitações enviadas para esse endereço.</span><span class="sxs-lookup"><span data-stu-id="ecce4-107">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span>

-   [<span data-ttu-id="ecce4-108">MulticastUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="ecce4-108">MulticastUdpServer.cpp</span></span>](#multicastudpservercpp)
-   [<span data-ttu-id="ecce4-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="ecce4-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="ecce4-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="ecce4-110">Makefile</span></span>](#makefile)

## <a name="multicastudpservercpp"></a><span data-ttu-id="ecce4-111">MulticastUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="ecce4-111">MulticastUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="ecce4-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="ecce4-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="ecce4-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="ecce4-113">Makefile</span></span>
