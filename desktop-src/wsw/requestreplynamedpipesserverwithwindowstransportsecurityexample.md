...
---
# <a name="requestreplynamedpipesserverwithwindowstransportsecurityexample"></a><span data-ttu-id="f6883-103">RequestReplyNamedPipesServerWithWindowsTransportSecurityExample</span><span class="sxs-lookup"><span data-stu-id="f6883-103">RequestReplyNamedPipesServerWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="f6883-104">Este exemplo mostra um servidor de pipes nomeados que aceita um canal e recebe e responde a mensagens com segurança fornecida pela segurança de transporte SSPI do Windows.</span><span class="sxs-lookup"><span data-stu-id="f6883-104">This example shows a named pipes server that accepts a channel, and receives and replies to messages with security provided by Windows SSPI transport security.</span></span>

-   [<span data-ttu-id="f6883-105">RequestReplyNamedPipesServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="f6883-105">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplynamedpipesserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="f6883-106">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f6883-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f6883-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="f6883-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="f6883-108">RequestReplyNamedPipesServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="f6883-108">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f6883-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="f6883-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f6883-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="f6883-110">Makefile</span></span>
