...
description: Este exemplo mostra como inserir um elemento em um buffer XML.
ms.assetid: 98fed487-77f8-4224-9a73-b20afcb01d47
keywords:
- InsertElementExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104498748"
---
# <a name="insertelementexample"></a><span data-ttu-id="5784d-106">InsertElementExample</span><span class="sxs-lookup"><span data-stu-id="5784d-106">InsertElementExample</span></span>

<span data-ttu-id="5784d-107">Este exemplo mostra como inserir um elemento em um buffer XML.</span><span class="sxs-lookup"><span data-stu-id="5784d-107">This example shows how to insert an element in an xml buffer.</span></span>

## <a name="insertelementcpp"></a><span data-ttu-id="5784d-108">Inserir. cpp</span><span class="sxs-lookup"><span data-stu-id="5784d-108">InsertElement.cpp</span></span>
