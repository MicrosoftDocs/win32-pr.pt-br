...
description: Este exemplo mostra a leitura e a gravação de XML usando a codificação bruta.
ms.assetid: e13e6add-f58b-468a-a472-f0aa29d030b3
keywords:
- API de serviços Web do Windows ReadWriteRawXmlExample
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104004833"
---
# <a name="readwriterawxmlexample"></a><span data-ttu-id="20e5d-106">ReadWriteRawXmlExample</span><span class="sxs-lookup"><span data-stu-id="20e5d-106">ReadWriteRawXmlExample</span></span>

<span data-ttu-id="20e5d-107">Este exemplo mostra a leitura e a gravação de XML usando a codificação bruta.</span><span class="sxs-lookup"><span data-stu-id="20e5d-107">This example shows reading and writing of xml using the raw encoding.</span></span>

## <a name="readwriterawxmlcpp"></a><span data-ttu-id="20e5d-108">ReadWriteRawXml. cpp</span><span class="sxs-lookup"><span data-stu-id="20e5d-108">ReadWriteRawXml.cpp</span></span>
