...
description: Este exemplo grava um documento usando um \_ dicionário XML do WS \_ .
ms.assetid: d8185577-3483-4005-84e5-0b10a6698e79
keywords:
- XmlDictionaryExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104292455"
---
# <a name="xmldictionaryexample"></a><span data-ttu-id="a2d0d-106">XmlDictionaryExample</span><span class="sxs-lookup"><span data-stu-id="a2d0d-106">XmlDictionaryExample</span></span>

<span data-ttu-id="a2d0d-107">Este exemplo grava um documento usando um \_ dicionário XML do WS \_ .</span><span class="sxs-lookup"><span data-stu-id="a2d0d-107">This example writes a document using a WS\_XML\_DICTIONARY.</span></span>

-   [<span data-ttu-id="a2d0d-108">XmlDictionary. cpp</span><span class="sxs-lookup"><span data-stu-id="a2d0d-108">XmlDictionary.cpp</span></span>](#xmldictionarycpp)
-   [<span data-ttu-id="a2d0d-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="a2d0d-109">Makefile</span></span>](#makefile)

## <a name="xmldictionarycpp"></a><span data-ttu-id="a2d0d-110">XmlDictionary. cpp</span><span class="sxs-lookup"><span data-stu-id="a2d0d-110">XmlDictionary.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a2d0d-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="a2d0d-111">Makefile</span></span>
