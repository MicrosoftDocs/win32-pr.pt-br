...
description: Este exemplo grava dados binários usando a codificação MTOM e lê-os de volta.
ms.assetid: 6b80846e-6959-4c38-bf1b-17827ecb9d1a
keywords:
- ReadWriteBytesXmlExample Web Services para Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105766553"
---
# <a name="readwritebytesxmlexample"></a><span data-ttu-id="ef2a2-106">ReadWriteBytesXmlExample</span><span class="sxs-lookup"><span data-stu-id="ef2a2-106">ReadWriteBytesXmlExample</span></span>

<span data-ttu-id="ef2a2-107">Este exemplo grava dados binários usando a codificação MTOM e lê-os de volta.</span><span class="sxs-lookup"><span data-stu-id="ef2a2-107">This example writes binary data using the MTOM encoding and reads it back out.</span></span>

## <a name="readwritebytesxmlcpp"></a><span data-ttu-id="ef2a2-108">ReadWriteBytesXml. cpp</span><span class="sxs-lookup"><span data-stu-id="ef2a2-108">ReadWriteBytesXml.cpp</span></span>
