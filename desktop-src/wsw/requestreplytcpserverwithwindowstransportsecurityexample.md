---
title: Exemplo de RequestReplyTcpServerWithWindowsTransportSecurity
description: Este exemplo mostra um servidor TCP que aceita um canal e recebe e responde a mensagens, com segurança fornecida pela segurança de transporte baseada em SSPI do Windows.
ms.assetid: 690fa5cd-228b-4099-bd2b-cbf9c8d70c53
keywords:
- RequestReplyTcpServerWithWindowsTransportSecurityExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104084295"
---
# <a name="requestreplytcpserverwithwindowstransportsecurity-example"></a><span data-ttu-id="5e5c9-106">Exemplo de RequestReplyTcpServerWithWindowsTransportSecurity</span><span class="sxs-lookup"><span data-stu-id="5e5c9-106">RequestReplyTcpServerWithWindowsTransportSecurity example</span></span>

<span data-ttu-id="5e5c9-107">Este exemplo mostra um servidor TCP que aceita um canal e recebe e responde a mensagens, com segurança fornecida pela segurança de transporte baseada em SSPI do Windows.</span><span class="sxs-lookup"><span data-stu-id="5e5c9-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with security provided by Windows SSPI-based transport security.</span></span>

-   [<span data-ttu-id="5e5c9-108">RequestReplyTcpServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="5e5c9-108">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="5e5c9-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="5e5c9-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5e5c9-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="5e5c9-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="5e5c9-111">RequestReplyTcpServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="5e5c9-111">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5e5c9-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="5e5c9-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5e5c9-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="5e5c9-113">Makefile</span></span>
