...
---
# <a name="requestreplytcpserverwithwindowstransportsecurity-example"></a>Exemplo de RequestReplyTcpServerWithWindowsTransportSecurity

Este exemplo mostra um servidor TCP que aceita um canal e recebe e responde a mensagens, com segurança fornecida pela segurança de transporte baseada em SSPI do Windows.
