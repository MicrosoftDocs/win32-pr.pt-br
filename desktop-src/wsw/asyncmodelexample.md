---
title: Exemplo de função assíncrona
...
---
# <a name="asynchronous-function-example"></a><span data-ttu-id="2cc5e-106">Exemplo de função assíncrona</span><span class="sxs-lookup"><span data-stu-id="2cc5e-106">Asynchronous Function Example</span></span>

<span data-ttu-id="2cc5e-107">Este exemplo ilustra a implementação e a chamada de funções assíncronas.</span><span class="sxs-lookup"><span data-stu-id="2cc5e-107">This example illustrates implementing and calling asynchronous functions.</span></span>

<span data-ttu-id="2cc5e-108">O exemplo consiste nas seguintes partes:</span><span class="sxs-lookup"><span data-stu-id="2cc5e-108">The example consists of the following parts:</span></span>

-   <span data-ttu-id="2cc5e-109">A função Add, que adicionará dois números de forma síncrona ou assíncrona.</span><span class="sxs-lookup"><span data-stu-id="2cc5e-109">The Add function which will add two numbers synchronously or asynchronously.</span></span> <span data-ttu-id="2cc5e-110">Ele cria um thread como um detalhe de implementação para o caso assíncrono.</span><span class="sxs-lookup"><span data-stu-id="2cc5e-110">It creates a thread as an implementation detail for the asynchronous case.</span></span>
-   <span data-ttu-id="2cc5e-111">A função CallAddSync invoca as funções Add de forma síncrona.</span><span class="sxs-lookup"><span data-stu-id="2cc5e-111">The CallAddSync function invokes the Add functions synchronously.</span></span>
-   <span data-ttu-id="2cc5e-112">A função CallAddAsync invoca as funções Add de forma assíncrona.</span><span class="sxs-lookup"><span data-stu-id="2cc5e-112">The CallAddAsync function invokes the Add functions asynchronously.</span></span>

## <a name="asyncmodelcpp"></a><span data-ttu-id="2cc5e-113">AsyncModel. cpp</span><span class="sxs-lookup"><span data-stu-id="2cc5e-113">AsyncModel.cpp</span></span>
