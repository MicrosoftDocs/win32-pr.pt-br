...
description: Este exemplo mostra um cliente HTTP que faz a solicitação-resposta usando as APIs de streaming.
ms.assetid: dd391506-6f14-4d3a-bd65-96a338b3f7cd
keywords:
- StreamingHttpClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105813551"
---
# <a name="streaminghttpclientexample"></a><span data-ttu-id="2d162-106">StreamingHttpClientExample</span><span class="sxs-lookup"><span data-stu-id="2d162-106">StreamingHttpClientExample</span></span>

<span data-ttu-id="2d162-107">Este exemplo mostra um cliente HTTP que faz a solicitação-resposta usando as APIs de streaming.</span><span class="sxs-lookup"><span data-stu-id="2d162-107">This example shows an HTTP client that does request-reply using the streaming APIs.</span></span>

-   [<span data-ttu-id="2d162-108">StreamingHttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="2d162-108">StreamingHttpClient.cpp</span></span>](#streaminghttpclientcpp)
-   [<span data-ttu-id="2d162-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2d162-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="2d162-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="2d162-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpclientcpp"></a><span data-ttu-id="2d162-111">StreamingHttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="2d162-111">StreamingHttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="2d162-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2d162-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2d162-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="2d162-113">Makefile</span></span>
