...
description: Este exemplo mostra como usar o proxy de serviço para se comunicar com um serviço PurchaseOrder baseado em HTTP.
ms.assetid: e577b06c-28b1-4f8f-a6af-025b9672cf27
keywords:
- HttpPurchaseOrderClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118963215"
---
# <a name="httppurchaseorderclientexample"></a>HttpPurchaseOrderClientExample

Este exemplo mostra como usar o proxy de serviço para se comunicar com um serviço PurchaseOrder baseado em HTTP.
