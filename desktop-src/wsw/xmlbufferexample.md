...
description: Este exemplo mostra algum uso das APIs de buffer XML.
ms.assetid: cf4530c7-48f4-4a76-bd3d-1f21b5469902
keywords:
- XmlBufferExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119707166"
---
# <a name="xmlbufferexample"></a>XmlBufferExample

Este exemplo mostra algum uso das APIs de buffer XML.
