...
description: Este exemplo grava e lê tipos derivados usando funções auxiliares de C++ Wsutil geradas. Consulte \_ \_ \_ \_ mapeamento de campo de atributo de tipo WS para obter mais informações sobre descrições de tipos derivados.
ms.assetid: 279663c0-8797-4f87-aaec-8cb8d4046a05
keywords:
- DerivedTypeExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105788641"
---
# <a name="derivedtypeexample"></a><span data-ttu-id="35428-107">DerivedTypeExample</span><span class="sxs-lookup"><span data-stu-id="35428-107">DerivedTypeExample</span></span>

<span data-ttu-id="35428-108">Este exemplo grava e lê tipos derivados usando funções auxiliares de C++ Wsutil geradas.</span><span class="sxs-lookup"><span data-stu-id="35428-108">This example writes and reads derived types using Wsutil generated C++ helper functions.</span></span> <span data-ttu-id="35428-109">Consulte [**\_ mapeamento de \_ \_ campo de \_ atributo de tipo WS**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) para obter mais informações sobre descrições de tipos derivados.</span><span class="sxs-lookup"><span data-stu-id="35428-109">See [**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) for more about derived type descriptions.</span></span>

-   [<span data-ttu-id="35428-110">Derivatype. cpp</span><span class="sxs-lookup"><span data-stu-id="35428-110">DerivedType.cpp</span></span>](#derivedtypecpp)
-   [<span data-ttu-id="35428-111">Derivadotype. xsd</span><span class="sxs-lookup"><span data-stu-id="35428-111">DerivedType.xsd</span></span>](#derivedtypexsd)
-   [<span data-ttu-id="35428-112">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="35428-112">Related topics</span></span>](#related-topics)

## <a name="derivedtypecpp"></a><span data-ttu-id="35428-113">Derivatype. cpp</span><span class="sxs-lookup"><span data-stu-id="35428-113">DerivedType.cpp</span></span>
...
## <a name="derivedtypexsd"></a><span data-ttu-id="35428-114">Derivadotype. xsd</span><span class="sxs-lookup"><span data-stu-id="35428-114">DerivedType.xsd</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="35428-115">Tópicos relacionados</span><span class="sxs-lookup"><span data-stu-id="35428-115">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="35428-116">**\_mapeamento de \_ campo de atributo de tipo WS \_ \_**</span><span class="sxs-lookup"><span data-stu-id="35428-116">**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
