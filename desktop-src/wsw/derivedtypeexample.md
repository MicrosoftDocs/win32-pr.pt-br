...
ms.locfileid: "118026219"
---
# <a name="derivedtypeexample"></a>DerivedTypeExample

Este exemplo grava e lê tipos derivados usando funções auxiliares de C++ Wsutil geradas. Consulte [**\_ mapeamento de \_ \_ campo de \_ atributo de tipo WS**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) para obter mais informações sobre descrições de tipos derivados.

-   [Derivatype. cpp](#derivedtypecpp)
-   [Derivadotype. xsd](#derivedtypexsd)
-   [Tópicos relacionados](#related-topics)

## <a name="derivedtypecpp"></a>Derivatype. cpp
...
## <a name="derivedtypexsd"></a>Derivadotype. xsd
...
[**\_mapeamento de \_ campo de atributo de tipo WS \_ \_**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
