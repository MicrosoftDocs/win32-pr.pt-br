...
description: Revise um exemplo Windows API de Serviços Web (WWSAPI) C++ de como usar o host de serviço para hospedar um serviço de ordem de compra por HTTP.
