...
description: Este exemplo mostra um servidor TCP que aceita um canal e lê mensagens unidirecionais de maneira contínua.
ms.assetid: 0b9c6fba-9dee-4409-b715-7827793a5522
keywords:
- StreamingTcpServerExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104363893"
---
# <a name="streamingtcpserverexample"></a><span data-ttu-id="0926f-106">StreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="0926f-106">StreamingTcpServerExample</span></span>

<span data-ttu-id="0926f-107">Este exemplo mostra um servidor TCP que aceita um canal e lê mensagens unidirecionais de maneira contínua.</span><span class="sxs-lookup"><span data-stu-id="0926f-107">This example shows a TCP server that accepts a channel, and reads one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="0926f-108">StreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="0926f-108">StreamingTcpServer.cpp</span></span>](#streamingtcpservercpp)
-   [<span data-ttu-id="0926f-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0926f-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0926f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="0926f-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpservercpp"></a><span data-ttu-id="0926f-111">StreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="0926f-111">StreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0926f-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0926f-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0926f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="0926f-113">Makefile</span></span>
