...
ms.locfileid: "118962905"
---
# <a name="service-model-examples"></a>Exemplos de modelo de serviço

Os exemplos a seguir ilustram o uso do [modelo de serviço](service-model-layer-overview.md):
...
-   Serviço de calculadora com segurança de transporte SSL:
...
-   Serviço de calculadora com nome de usuário sobre segurança de modo misto SSL:
...
-   Serviço de calculadora com segurança de modo misto Kerberos sobre SSL:
...
-   Serviço de calculadora com autenticação básica de cabeçalho HTTP sobre segurança de transporte SSL:
...
-   Serviço de ordem de compra com segurança de transporte SSL:
...
-   Serviço de ordem de compra com nome de usuário sobre segurança de modo misto SSL:
...
-   Serviço de ordem de compra com segurança de modo misto Kerberos sobre SSL:
...
-   Operação de serviço com notificação de anulação:
...
-   Comunique-se com um serviço TerraService ASMX usando um proxy personalizado: [AsmxTerraServiceSampleWithCustomProxy](asmxterraservicesamplewithcustomproxy.md).
...
-   Comunique-se com um serviço WCF: [WcfPublicServiceSample](wcfpublicservicesample.md).
