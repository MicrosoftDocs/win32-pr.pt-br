...
description: Este exemplo mostra um cliente HTTP que usa o proxy de serviço para se comunicar com um serviço de calculadora, com o nome de usuário sobre segurança de modo misto SSL.
ms.assetid: 82f27502-0f18-4b30-9da1-9191e34366c6
keywords:
- HttpCalculatorWithUsernameOverSslClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105782523"
---
# <a name="httpcalculatorwithusernameoversslclientexample"></a><span data-ttu-id="a4a9d-106">HttpCalculatorWithUsernameOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="a4a9d-106">HttpCalculatorWithUsernameOverSslClientExample</span></span>

<span data-ttu-id="a4a9d-107">Este exemplo mostra um cliente HTTP que usa o proxy de serviço para se comunicar com um serviço de calculadora, com o nome de usuário sobre segurança de modo misto SSL.</span><span class="sxs-lookup"><span data-stu-id="a4a9d-107">This example shows a HTTP client that uses service proxy to talk to a calculator service, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="a4a9d-108">Nessa configuração, a conexão de transporte é protegida (assinada, criptografada) pelo SSL que também fornece autenticação de servidor.</span><span class="sxs-lookup"><span data-stu-id="a4a9d-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="a4a9d-109">A autenticação de cliente é fornecida por um par de nome de usuário/senha em um cabeçalho WS-Security na mensagem.</span><span class="sxs-lookup"><span data-stu-id="a4a9d-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="a4a9d-110">CalculatorClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="a4a9d-110">CalculatorClientUserNameOverSsl.cpp</span></span>](#calculatorclientusernameoversslcpp)
-   [<span data-ttu-id="a4a9d-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="a4a9d-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="a4a9d-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="a4a9d-112">Makefile</span></span>](#makefile)

## <a name="calculatorclientusernameoversslcpp"></a><span data-ttu-id="a4a9d-113">CalculatorClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="a4a9d-113">CalculatorClientUserNameOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="a4a9d-114">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="a4a9d-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a4a9d-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="a4a9d-115">Makefile</span></span>
