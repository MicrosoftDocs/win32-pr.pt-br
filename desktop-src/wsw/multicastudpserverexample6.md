...
description: Este exemplo mostra um servidor UDP que escuta em um endereço multicast e responde às solicitações enviadas para esse endereço. Este exemplo usa IPv6.
ms.assetid: 9e2a254c-dbfc-4b73-a1a5-6a1db1ac5921
keywords:
- MulticastUdpServerExample6 nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105755265"
---
# <a name="multicastudpserverexample6"></a><span data-ttu-id="67e72-107">MulticastUdpServerExample6</span><span class="sxs-lookup"><span data-stu-id="67e72-107">MulticastUdpServerExample6</span></span>

<span data-ttu-id="67e72-108">Este exemplo mostra um servidor UDP que escuta em um endereço multicast e responde às solicitações enviadas para esse endereço.</span><span class="sxs-lookup"><span data-stu-id="67e72-108">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span> <span data-ttu-id="67e72-109">Este exemplo usa IPv6.</span><span class="sxs-lookup"><span data-stu-id="67e72-109">This example uses IPv6.</span></span>

-   [<span data-ttu-id="67e72-110">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="67e72-110">MulticastUdpServer6.cpp</span></span>](#multicastudpserver6cpp)
-   [<span data-ttu-id="67e72-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="67e72-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="67e72-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="67e72-112">Makefile</span></span>](#makefile)

## <a name="multicastudpserver6cpp"></a><span data-ttu-id="67e72-113">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="67e72-113">MulticastUdpServer6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="67e72-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="67e72-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="67e72-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="67e72-115">Makefile</span></span>
