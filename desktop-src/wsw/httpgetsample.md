---
title: HttpGetSample
description: Este exemplo mostra como usar o host de serviço para hospedar um serviço PurchaseOrder por HTTP. O serviço expõe metadados sobre HTTP GET e WS-Metadata Exchange v 1.1. O serviço também mostra como implementar uma página de rosto para um serviço WWSAPI.
ms.assetid: 5e3a2d24-afd1-451d-94c4-4234c24a4895
keywords:
- HttpGetSample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104365428"
---
# <a name="httpgetsample"></a><span data-ttu-id="7b230-108">HttpGetSample</span><span class="sxs-lookup"><span data-stu-id="7b230-108">HttpGetSample</span></span>

<span data-ttu-id="7b230-109">Este exemplo mostra como usar o host de serviço para hospedar um serviço PurchaseOrder por HTTP.</span><span class="sxs-lookup"><span data-stu-id="7b230-109">This example shows how to use service host for hosting a PurchaseOrder service over HTTP.</span></span> <span data-ttu-id="7b230-110">O serviço expõe metadados sobre HTTP GET e WS-Metadata Exchange v 1.1.</span><span class="sxs-lookup"><span data-stu-id="7b230-110">The service exposes metadata over HTTP GET and WS-Metadata Exchange v1.1.</span></span> <span data-ttu-id="7b230-111">O serviço também mostra como implementar uma página de rosto para um serviço WWSAPI.</span><span class="sxs-lookup"><span data-stu-id="7b230-111">The service also shows how to implement a cover page for a WWSAPI service.</span></span>

-   [<span data-ttu-id="7b230-112">HttpGetService. cpp</span><span class="sxs-lookup"><span data-stu-id="7b230-112">HttpGetService.cpp</span></span>](#httpgetservicecpp)
-   [<span data-ttu-id="7b230-113">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7b230-113">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="7b230-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="7b230-114">Makefile</span></span>](#makefile)

## <a name="httpgetservicecpp"></a><span data-ttu-id="7b230-115">HttpGetService. cpp</span><span class="sxs-lookup"><span data-stu-id="7b230-115">HttpGetService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="7b230-116">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7b230-116">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7b230-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="7b230-117">Makefile</span></span>
