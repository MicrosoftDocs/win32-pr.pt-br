...
description: Este exemplo mostra um servidor TCP que aceita um canal e recebe e responde a mensagens, com nome de usuário sobre segurança de modo misto SSL.
ms.assetid: d70ae988-0d7c-4494-a54d-1cd73ab8a8ce
keywords:
- HttpServerWithUsernameOverSslExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105753063"
---
# <a name="httpserverwithusernameoversslexample"></a><span data-ttu-id="112bf-106">HttpServerWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="112bf-106">HttpServerWithUsernameOverSslExample</span></span>

<span data-ttu-id="112bf-107">Este exemplo mostra um servidor TCP que aceita um canal e recebe e responde a mensagens, com nome de usuário sobre segurança de modo misto SSL.</span><span class="sxs-lookup"><span data-stu-id="112bf-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="112bf-108">Nessa configuração, a conexão de transporte é protegida (assinada, criptografada) pelo SSL que também fornece autenticação de servidor.</span><span class="sxs-lookup"><span data-stu-id="112bf-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="112bf-109">A autenticação de cliente é fornecida por um par de nome de usuário/senha em um cabeçalho WS-Security na mensagem.</span><span class="sxs-lookup"><span data-stu-id="112bf-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="112bf-110">HttpServerWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="112bf-110">HttpServerWithUsernameOverSsl.cpp</span></span>](#httpserverwithusernameoversslcpp)
-   [<span data-ttu-id="112bf-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="112bf-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="112bf-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="112bf-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithusernameoversslcpp"></a><span data-ttu-id="112bf-113">HttpServerWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="112bf-113">HttpServerWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="112bf-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="112bf-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="112bf-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="112bf-115">Makefile</span></span>
