...
description: Este exemplo mostra como usar o host de serviço para hospedar um serviço de calculadora por HTTP, com o nome de usuário sobre segurança de modo misto SSL.
ms.assetid: 92dfec48-2314-4e83-8fe9-9d25aa100043
keywords:
- HttpCalculatorWithUserNameOverSslServiceExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
