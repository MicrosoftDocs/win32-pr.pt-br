...
description: consulte um exemplo de solicitação e resposta ao servidor TCP que usa a API de serviços Web do Windows (WWSAPI). Este exemplo aceita um canal e recebe e responde a mensagens.
