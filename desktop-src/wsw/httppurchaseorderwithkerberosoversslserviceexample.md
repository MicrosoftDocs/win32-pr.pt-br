...
description: Este exemplo mostra como usar o host de serviço para hospedar um serviço PurchaseOrder via HTTP, com segurança de modo misto Kerberos sobre SSL.
ms.assetid: 9fbf5577-6a54-4ce1-ad44-80b9ee91c0d3
keywords:
- HttpPurchaseOrderWithKerberosOverSslServiceExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105807890"
---
# <a name="httppurchaseorderwithkerberosoversslserviceexample"></a><span data-ttu-id="58cb1-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="58cb1-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span></span>

<span data-ttu-id="58cb1-107">Este exemplo mostra como usar o host de serviço para hospedar um serviço PurchaseOrder via HTTP, com segurança de modo misto Kerberos sobre SSL.</span><span class="sxs-lookup"><span data-stu-id="58cb1-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="58cb1-108">Nessa configuração, a conexão de transporte é protegida (assinada, criptografada) pelo SSL que também fornece autenticação de servidor.</span><span class="sxs-lookup"><span data-stu-id="58cb1-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="58cb1-109">A autenticação de cliente é fornecida por um tíquete APREQ do Kerberos em um cabeçalho WS-Security na mensagem.</span><span class="sxs-lookup"><span data-stu-id="58cb1-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="58cb1-110">PurchaseOrderServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="58cb1-110">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>](#purchaseorderservicekerberosoversslcpp)
-   [<span data-ttu-id="58cb1-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="58cb1-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="58cb1-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="58cb1-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderservicekerberosoversslcpp"></a><span data-ttu-id="58cb1-113">PurchaseOrderServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="58cb1-113">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="58cb1-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="58cb1-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="58cb1-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="58cb1-115">Makefile</span></span>
