...
description: Este exemplo mostra como usar o host de serviço para hospedar um serviço PurchaseOrder por HTTP, com kerberos sobre segurança de modo misto SSL.
