...
description: Este exemplo mostra como usar o proxy de serviço para se comunicar com um serviço de calculadora, com segurança de transporte SSL e autenticação básica de cabeçalho HTTP.
ms.assetid: be1a44e6-642c-42fa-8b95-bd8c6f335696
keywords:
- HttpCalculatorWithBasicOverSslClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105772497"
---
# <a name="httpcalculatorwithbasicoversslclientexample"></a><span data-ttu-id="0b827-106">HttpCalculatorWithBasicOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="0b827-106">HttpCalculatorWithBasicOverSslClientExample</span></span>

<span data-ttu-id="0b827-107">Este exemplo mostra como usar o proxy de serviço para se comunicar com um serviço de calculadora, com segurança de transporte SSL e autenticação básica de cabeçalho HTTP.</span><span class="sxs-lookup"><span data-stu-id="0b827-107">This example shows how to use the service proxy to talk to a calculator service, with SSL transport security and HTTP header basic authentication.</span></span> <span data-ttu-id="0b827-108">Nessa configuração, a conexão de transporte é protegida (assinada, criptografada) pelo SSL que também fornece autenticação de servidor.</span><span class="sxs-lookup"><span data-stu-id="0b827-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="0b827-109">A autenticação de cliente é fornecida por um par de nome de usuário/senha fornecido em cabeçalhos HTTP usando o esquema básico.</span><span class="sxs-lookup"><span data-stu-id="0b827-109">Client authentication is provided by a username/password pair supplied in HTTP headers using the basic scheme.</span></span>

-   [<span data-ttu-id="0b827-110">HttpCalculatorWithBasicOverSslClient. cpp</span><span class="sxs-lookup"><span data-stu-id="0b827-110">HttpCalculatorWithBasicOverSslClient.cpp</span></span>](#httpcalculatorwithbasicoversslclientcpp)
-   [<span data-ttu-id="0b827-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="0b827-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="0b827-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="0b827-112">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithbasicoversslclientcpp"></a><span data-ttu-id="0b827-113">HttpCalculatorWithBasicOverSslClient. cpp</span><span class="sxs-lookup"><span data-stu-id="0b827-113">HttpCalculatorWithBasicOverSslClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="0b827-114">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="0b827-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0b827-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="0b827-115">Makefile</span></span>
