...
description: Este exemplo mostra um servidor TCP que aceita um canal e recebe mensagens unidirecionais.
ms.assetid: a43fc6a8-f1ee-4f6b-9737-bfe340bb67f0
keywords:
- OneWayTcpServerExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104160422"
---
# <a name="onewaytcpserverexample"></a><span data-ttu-id="93e2a-106">OneWayTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="93e2a-106">OneWayTcpServerExample</span></span>

<span data-ttu-id="93e2a-107">Este exemplo mostra um servidor TCP que aceita um canal e recebe mensagens unidirecionais.</span><span class="sxs-lookup"><span data-stu-id="93e2a-107">This example shows a TCP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="93e2a-108">OneWayTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="93e2a-108">OneWayTcpServer.cpp</span></span>](#onewaytcpservercpp)
-   [<span data-ttu-id="93e2a-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="93e2a-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="93e2a-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="93e2a-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpservercpp"></a><span data-ttu-id="93e2a-111">OneWayTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="93e2a-111">OneWayTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="93e2a-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="93e2a-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="93e2a-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="93e2a-113">Makefile</span></span>
