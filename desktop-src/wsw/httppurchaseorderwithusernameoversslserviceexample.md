...
---
# <a name="httppurchaseorderwithusernameoversslserviceexample"></a><span data-ttu-id="d9f5b-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="d9f5b-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span></span>

<span data-ttu-id="d9f5b-107">Este exemplo mostra como usar o host de serviço para hospedar um serviço PurchaseOrder por HTTP, com o nome de usuário sobre segurança de modo misto SSL.</span><span class="sxs-lookup"><span data-stu-id="d9f5b-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="d9f5b-108">Nessa configuração, a conexão de transporte é protegida (assinada, criptografada) pelo SSL que também fornece autenticação de servidor.</span><span class="sxs-lookup"><span data-stu-id="d9f5b-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="d9f5b-109">A autenticação de cliente é fornecida por um par de nome de usuário/senha em um cabeçalho WS-Security na mensagem.</span><span class="sxs-lookup"><span data-stu-id="d9f5b-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="d9f5b-110">PurchaseOrderServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="d9f5b-110">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>](#purchaseorderserviceusernameoversslcpp)
-   [<span data-ttu-id="d9f5b-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d9f5b-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d9f5b-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="d9f5b-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderserviceusernameoversslcpp"></a><span data-ttu-id="d9f5b-113">PurchaseOrderServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="d9f5b-113">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d9f5b-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d9f5b-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d9f5b-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="d9f5b-115">Makefile</span></span>
