...
description: Este exemplo mostra como usar as rotinas auxiliares de política geradas pelo Wsutil para criar o proxy de serviço para se comunicar com um serviço de calculadora, com segurança de transporte SSL.
ms.assetid: cf2455d4-0670-4ea2-8ee7-073698bfb765
keywords:
- HttpCalculatorWithSslPolicyClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103916341"
---
# <a name="httpcalculatorwithsslpolicyclientexample"></a><span data-ttu-id="75ed6-106">HttpCalculatorWithSslPolicyClientExample</span><span class="sxs-lookup"><span data-stu-id="75ed6-106">HttpCalculatorWithSslPolicyClientExample</span></span>

<span data-ttu-id="75ed6-107">Este exemplo mostra como usar as rotinas auxiliares de política geradas pelo Wsutil para criar o proxy de serviço para se comunicar com um serviço de calculadora, com segurança de transporte SSL.</span><span class="sxs-lookup"><span data-stu-id="75ed6-107">This example shows how to use the wsutil generated policy helper routines to create service proxy to talk to a calculator service, with SSL transport security.</span></span> <span data-ttu-id="75ed6-108">Nessa configuração, a conexão de transporte é protegida (assinada, criptografada) pelo SSL que também fornece autenticação de servidor.</span><span class="sxs-lookup"><span data-stu-id="75ed6-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span>

-   [<span data-ttu-id="75ed6-109">HttpCalculatorWithSslPolicyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="75ed6-109">HttpCalculatorWithSslPolicyClient.cpp</span></span>](#httpcalculatorwithsslpolicyclientcpp)
-   [<span data-ttu-id="75ed6-110">CalculatorServiceWithPolicy. WSDL</span><span class="sxs-lookup"><span data-stu-id="75ed6-110">CalculatorServiceWithPolicy.wsdl</span></span>](#calculatorservicewithpolicywsdl)
-   [<span data-ttu-id="75ed6-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="75ed6-111">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithsslpolicyclientcpp"></a><span data-ttu-id="75ed6-112">HttpCalculatorWithSslPolicyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="75ed6-112">HttpCalculatorWithSslPolicyClient.cpp</span></span>
...
## <a name="calculatorservicewithpolicywsdl"></a><span data-ttu-id="75ed6-113">CalculatorServiceWithPolicy. WSDL</span><span class="sxs-lookup"><span data-stu-id="75ed6-113">CalculatorServiceWithPolicy.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="75ed6-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="75ed6-114">Makefile</span></span>
