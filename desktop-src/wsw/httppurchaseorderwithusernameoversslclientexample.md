...
description: Este exemplo mostra um cliente HTTP que usa o proxy de serviço para se comunicar com um serviço PurchaseOrder, com o nome de usuário sobre segurança de modo misto SSL.
ms.assetid: 9874f00d-1efa-47ed-8029-f93962046789
keywords:
- HttpPurchaseOrderWithUsernameOverSslClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104160152"
---
# <a name="httppurchaseorderwithusernameoversslclientexample"></a><span data-ttu-id="7c85b-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="7c85b-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span></span>

<span data-ttu-id="7c85b-107">Este exemplo mostra um cliente HTTP que usa o proxy de serviço para se comunicar com um serviço PurchaseOrder, com o nome de usuário sobre segurança de modo misto SSL.</span><span class="sxs-lookup"><span data-stu-id="7c85b-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="7c85b-108">Nessa configuração, a conexão de transporte é protegida (assinada, criptografada) pelo SSL que também fornece autenticação de servidor.</span><span class="sxs-lookup"><span data-stu-id="7c85b-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="7c85b-109">A autenticação de cliente é fornecida por um par de nome de usuário/senha em um cabeçalho WS-Security na mensagem.</span><span class="sxs-lookup"><span data-stu-id="7c85b-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="7c85b-110">PurchaseOrderClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="7c85b-110">PurchaseOrderClientUserNameOverSsl.cpp</span></span>](#purchaseorderclientusernameoversslcpp)
-   [<span data-ttu-id="7c85b-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7c85b-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="7c85b-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="7c85b-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientusernameoversslcpp"></a><span data-ttu-id="7c85b-113">PurchaseOrderClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="7c85b-113">PurchaseOrderClientUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="7c85b-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7c85b-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7c85b-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="7c85b-115">Makefile</span></span>
