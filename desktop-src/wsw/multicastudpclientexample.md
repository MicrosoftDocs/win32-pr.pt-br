...
ms.locfileid: "104159490"
---
# <a name="multicastudpclientexample"></a><span data-ttu-id="a4176-106">MulticastUdpClientExample</span><span class="sxs-lookup"><span data-stu-id="a4176-106">MulticastUdpClientExample</span></span>

<span data-ttu-id="a4176-107">Este exemplo mostra um cliente UDP que faz a difusão de uma solicitação e, em seguida, aguarda mensagens de resposta dos servidores.</span><span class="sxs-lookup"><span data-stu-id="a4176-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers.</span></span>

-   [<span data-ttu-id="a4176-108">MulticastUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="a4176-108">MulticastUdpClient.cpp</span></span>](#multicastudpclientcpp)
-   [<span data-ttu-id="a4176-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a4176-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="a4176-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="a4176-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclientcpp"></a><span data-ttu-id="a4176-111">MulticastUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="a4176-111">MulticastUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="a4176-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a4176-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a4176-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="a4176-113">Makefile</span></span>
