...
---
# <a name="customheaderexample"></a><span data-ttu-id="6fe35-106">CustomHeaderExample</span><span class="sxs-lookup"><span data-stu-id="6fe35-106">CustomHeaderExample</span></span>

<span data-ttu-id="6fe35-107">Este exemplo mostra como adicionar e recuperar um cabeçalho personalizado.</span><span class="sxs-lookup"><span data-stu-id="6fe35-107">This example shows how to add and retrieve a custom header.</span></span>

-   [<span data-ttu-id="6fe35-108">CustomHeader. cpp</span><span class="sxs-lookup"><span data-stu-id="6fe35-108">CustomHeader.cpp</span></span>](#customheadercpp)
-   [<span data-ttu-id="6fe35-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6fe35-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6fe35-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="6fe35-110">Makefile</span></span>](#makefile)

## <a name="customheadercpp"></a><span data-ttu-id="6fe35-111">CustomHeader. cpp</span><span class="sxs-lookup"><span data-stu-id="6fe35-111">CustomHeader.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6fe35-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6fe35-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6fe35-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="6fe35-113">Makefile</span></span>
