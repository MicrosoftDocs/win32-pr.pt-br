...
description: Este exemplo ilustra como criar manualmente a descrição da política e usá-la para criar o proxy de serviço.
ms.assetid: 1c7ff0fb-06a2-4285-bbc8-ea8f2d82b15b
keywords:
- PolicyTemplateExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104005754"
---
# <a name="policytemplateexample"></a><span data-ttu-id="d36ae-106">PolicyTemplateExample</span><span class="sxs-lookup"><span data-stu-id="d36ae-106">PolicyTemplateExample</span></span>

<span data-ttu-id="d36ae-107">Este exemplo ilustra como criar manualmente a descrição da política e usá-la para criar o proxy de serviço.</span><span class="sxs-lookup"><span data-stu-id="d36ae-107">This example illustrates how to manually create policy description and use it to create service proxy.</span></span>

-   [<span data-ttu-id="d36ae-108">Policytemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="d36ae-108">PolicyTemplate.cpp</span></span>](#policytemplatecpp)
-   [<span data-ttu-id="d36ae-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="d36ae-109">Makefile</span></span>](#makefile)

## <a name="policytemplatecpp"></a><span data-ttu-id="d36ae-110">Policytemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="d36ae-110">PolicyTemplate.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d36ae-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="d36ae-111">Makefile</span></span>
