...
Este exemplo ilustra a importação de metadados de um ponto de extremidade que dá suporte ao uso de um token X509 usando a [**Associação de segurança de \_ \_ mensagem de token \_ \_ \_ XML WS**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) com associação de [**segurança de \_ \_ transporte \_ \_ WS SSL**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).
