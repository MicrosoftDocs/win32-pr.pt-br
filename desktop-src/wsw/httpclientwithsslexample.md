...
description: Este exemplo mostra um cliente HTTP que envia mensagens de solicitação-resposta, com segurança de transporte SSL.
ms.assetid: 0e73baee-a56d-446e-ae2e-a3aae31d8508
keywords:
- HttpClientWithSslExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118963335"
---
# <a name="httpclientwithsslexample"></a>HttpClientWithSslExample

Este exemplo mostra um cliente HTTP que envia mensagens de solicitação-resposta, com segurança de transporte SSL.
