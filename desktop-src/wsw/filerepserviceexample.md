...
Obrigatórios. Indica que o serviço é executado como cliente.
...
<span id="Connections"></span><span id="connections"></span><span id="CONNECTIONS"></span>Conexões
</dt> <dd>
...
**Servidor** *<Service Url>* deWsFileRepService.exe **\[ /Reporting: <Error/info/Verbose>\] \[ /Encoding: <Text/Binary/MTOM>\] \[ /Connections:** _<number of connections>_ *_\] \[ /Chunk:_*_<size of the payload per message in bytes>_*_\]_*
...
Obrigatórios. Indica que o serviço é executado como servidor de arquivos.
