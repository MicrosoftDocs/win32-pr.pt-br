...
description: Este exemplo lê e grava uma matriz de elementos.
ms.assetid: 3c4851b5-1c31-4de7-929e-03a8199b273a
keywords:
- ReadWriteArrayExample Web Services para Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105814450"
---
# <a name="readwritearrayexample"></a><span data-ttu-id="6854f-106">ReadWriteArrayExample</span><span class="sxs-lookup"><span data-stu-id="6854f-106">ReadWriteArrayExample</span></span>

<span data-ttu-id="6854f-107">Este exemplo lê e grava uma matriz de elementos.</span><span class="sxs-lookup"><span data-stu-id="6854f-107">This example reads and writes an array of elements.</span></span>

## <a name="readwritearraycpp"></a><span data-ttu-id="6854f-108">ReadWriteArray. cpp</span><span class="sxs-lookup"><span data-stu-id="6854f-108">ReadWriteArray.cpp</span></span>
