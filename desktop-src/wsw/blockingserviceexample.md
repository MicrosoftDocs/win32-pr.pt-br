...
description: Exemplo de aplicativo de serviço que demonstra o cancelamento de chamada no lado do servidor.
ms.assetid: a0a862bc-521a-477a-854d-58642d497109
keywords:
- BlockingServiceExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104005597"
---
# <a name="blockingserviceexample"></a><span data-ttu-id="11619-106">BlockingServiceExample</span><span class="sxs-lookup"><span data-stu-id="11619-106">BlockingServiceExample</span></span>

<span data-ttu-id="11619-107">Exemplo de aplicativo de serviço que demonstra o cancelamento de chamada no lado do servidor.</span><span class="sxs-lookup"><span data-stu-id="11619-107">Example service application demonstrating server side call cancellation.</span></span>

-   [<span data-ttu-id="11619-108">CancellingService. cpp</span><span class="sxs-lookup"><span data-stu-id="11619-108">CancellingService.cpp</span></span>](#cancellingservicecpp)
-   [<span data-ttu-id="11619-109">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="11619-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="11619-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="11619-110">Makefile</span></span>](#makefile)

## <a name="cancellingservicecpp"></a><span data-ttu-id="11619-111">CancellingService. cpp</span><span class="sxs-lookup"><span data-stu-id="11619-111">CancellingService.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="11619-112">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="11619-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="11619-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="11619-113">Makefile</span></span>
