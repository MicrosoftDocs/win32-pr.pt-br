...
---
# <a name="httprawserviceexample"></a><span data-ttu-id="ad24c-106">HttpRawServiceExample</span><span class="sxs-lookup"><span data-stu-id="ad24c-106">HttpRawServiceExample</span></span>

<span data-ttu-id="ad24c-107">Este exemplo mostra como usar o host de serviço para lidar com solicitações HTTP brutas (não SOAP).</span><span class="sxs-lookup"><span data-stu-id="ad24c-107">This example shows how to use service host to handle raw (non-SOAP) HTTP requests.</span></span>

## <a name="httprawservicecpp"></a><span data-ttu-id="ad24c-108">HttpRawService. cpp</span><span class="sxs-lookup"><span data-stu-id="ad24c-108">HttpRawService.cpp</span></span>
