...
description: Este exemplo mostra como usar o proxy de serviço para se comunicar com um serviço PurchaseOrder, com segurança de transporte SSL.
ms.assetid: afa73250-5f1c-4151-a2e0-4a5ccc91b63f
keywords:
- HttpPurchaseOrderWithSslClientExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105798400"
---
# <a name="httppurchaseorderwithsslclientexample"></a><span data-ttu-id="c1d98-106">HttpPurchaseOrderWithSslClientExample</span><span class="sxs-lookup"><span data-stu-id="c1d98-106">HttpPurchaseOrderWithSslClientExample</span></span>

<span data-ttu-id="c1d98-107">Este exemplo mostra como usar o proxy de serviço para se comunicar com um serviço PurchaseOrder, com segurança de transporte SSL.</span><span class="sxs-lookup"><span data-stu-id="c1d98-107">This example show how to use the service proxy to talk to a PurchaseOrder service, with SSL transport security.</span></span>

-   [<span data-ttu-id="c1d98-108">HttpPurchaseOrderClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="c1d98-108">HttpPurchaseOrderClientWithSsl.cpp</span></span>](#httppurchaseorderclientwithsslcpp)
-   [<span data-ttu-id="c1d98-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c1d98-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c1d98-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="c1d98-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientwithsslcpp"></a><span data-ttu-id="c1d98-111">HttpPurchaseOrderClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="c1d98-111">HttpPurchaseOrderClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c1d98-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c1d98-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c1d98-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="c1d98-113">Makefile</span></span>
