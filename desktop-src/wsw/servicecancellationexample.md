...
description: Aplicativo cliente de exemplo que demonstra o cancelamento do serviço.
ms.assetid: c9e727c8-5fa7-47b9-8624-18fe4de79026
keywords:
- ServiceCancellationExample nativo – Web-Services
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103822148"
---
# <a name="servicecancellationexample"></a><span data-ttu-id="632bd-106">ServiceCancellationExample</span><span class="sxs-lookup"><span data-stu-id="632bd-106">ServiceCancellationExample</span></span>

<span data-ttu-id="632bd-107">Aplicativo cliente de exemplo que demonstra o cancelamento do serviço.</span><span class="sxs-lookup"><span data-stu-id="632bd-107">Example client application demonstrating service cancellation.</span></span>

-   [<span data-ttu-id="632bd-108">Cancelamento. cpp</span><span class="sxs-lookup"><span data-stu-id="632bd-108">ServiceCancel.cpp</span></span>](#servicecancelcpp)
-   [<span data-ttu-id="632bd-109">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="632bd-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="632bd-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="632bd-110">Makefile</span></span>](#makefile)

## <a name="servicecancelcpp"></a><span data-ttu-id="632bd-111">Cancelamento. cpp</span><span class="sxs-lookup"><span data-stu-id="632bd-111">ServiceCancel.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="632bd-112">BlockUnBlockService. WSDL</span><span class="sxs-lookup"><span data-stu-id="632bd-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="632bd-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="632bd-113">Makefile</span></span>
