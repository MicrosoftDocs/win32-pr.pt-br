...
description: Este exemplo mostra um cliente de pipe nomeado que envia mensagens de solicitação-resposta.
...
ms.locfileid: "118192862"
---
# <a name="requestreplynamedpipesclientexample"></a>RequestReplyNamedPipesClientExample

Este exemplo mostra um cliente de pipe nomeado que envia mensagens de solicitação-resposta.
