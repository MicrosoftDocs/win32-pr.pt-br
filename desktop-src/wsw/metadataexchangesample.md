...
Este exemplo mostra como usar o host de serviço para hospedar um serviço PurchaseOrder sobre TCP. O serviço também oferece suporte a WS-MetadataExchange.
