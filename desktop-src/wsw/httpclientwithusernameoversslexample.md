...
---
# <a name="httpclientwithusernameoversslexample"></a><span data-ttu-id="91c41-106">HttpClientWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="91c41-106">HttpClientWithUsernameOverSslExample</span></span>

<span data-ttu-id="91c41-107">Este exemplo mostra um cliente HTTP que envia mensagens de solicitação-resposta, com nome de usuário sobre segurança de modo misto SSL.</span><span class="sxs-lookup"><span data-stu-id="91c41-107">This example shows a HTTP client that sends request-reply messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="91c41-108">Nessa configuração, a conexão de transporte é protegida (assinada, criptografada) pelo SSL que também fornece autenticação de servidor.</span><span class="sxs-lookup"><span data-stu-id="91c41-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="91c41-109">A autenticação de cliente é fornecida por um par de nome de usuário/senha em um cabeçalho WS-Security na mensagem.</span><span class="sxs-lookup"><span data-stu-id="91c41-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="91c41-110">HttpClientWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="91c41-110">HttpClientWithUsernameOverSsl.cpp</span></span>](#httpclientwithusernameoversslcpp)
-   [<span data-ttu-id="91c41-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="91c41-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="91c41-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="91c41-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithusernameoversslcpp"></a><span data-ttu-id="91c41-113">HttpClientWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="91c41-113">HttpClientWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="91c41-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="91c41-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="91c41-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="91c41-115">Makefile</span></span>
