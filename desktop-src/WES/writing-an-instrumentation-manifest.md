...
Além dos consumidores que usam o nível e as palavras-chave para consumir tipos específicos de eventos, uma sessão de rastreamento ETW pode usar o nível e os metadados de palavra-chave para informar ao ETW para limitar os eventos que são gravados no log de rastreamento de eventos. Por exemplo, a sessão pode limitar os eventos a apenas eventos nos quais o nível é "erro" ou "crítico" e a palavra-chave é "leitura".
...
-   [Definindo os canais nos quais os eventos são gravados](defining-channels.md)
-   [Definindo os níveis de severidade dos eventos que o provedor grava](defining-severity-levels.md)
...
-   [Definindo os mapas de nome/valor que os dados de modelo referenciam](defining-name-value-mappings.md)
