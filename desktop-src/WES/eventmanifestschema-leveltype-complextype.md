...
| value   | [**UInt8Type**](eventmanifestschema-hexint8type-simpletype.md)   | O valor de nível. Você pode especificar valores no intervalo de 16 a 255. Para valores de nível predefinidos, consulte comentários.<br/>                                                                                                                                                                                               |
