...
---
# <a name="searching-downloading-and-installing-updates"></a><span data-ttu-id="c7a65-103">Pesquisando, baixando e instalando atualizações</span><span class="sxs-lookup"><span data-stu-id="c7a65-103">Searching, Downloading, and Installing Updates</span></span>

<span data-ttu-id="c7a65-104">O exemplo de script neste tópico mostra como usar o WUA (Windows Update Agent) para verificar, baixar e instalar atualizações.</span><span class="sxs-lookup"><span data-stu-id="c7a65-104">The scripting sample in this topic shows you how to use Windows Update Agent (WUA) to scan, download, and install updates.</span></span>

<span data-ttu-id="c7a65-105">O exemplo pesquisa todas as atualizações de software aplicáveis e, em seguida, lista essas atualizações.</span><span class="sxs-lookup"><span data-stu-id="c7a65-105">The sample searches for all the applicable software updates and then lists those updates.</span></span> <span data-ttu-id="c7a65-106">Em seguida, ele cria uma coleção de atualizações para baixar e, em seguida, baixa esses itens.</span><span class="sxs-lookup"><span data-stu-id="c7a65-106">Next, it creates a collection of updates to download and then downloads them.</span></span> <span data-ttu-id="c7a65-107">Por fim, ele cria uma coleção de atualizações para instalar e, em seguida, as instala.</span><span class="sxs-lookup"><span data-stu-id="c7a65-107">Finally, it creates a collection of updates to install and then installs them.</span></span>

<span data-ttu-id="c7a65-108">Se você quiser pesquisar, baixar e instalar uma atualização específica que você identifica usando o título da atualização, consulte [pesquisando, baixando e instalando atualizações específicas](searching--downloading--and-installing-specific-updates.md).</span><span class="sxs-lookup"><span data-stu-id="c7a65-108">If you want to search, download, and install a specific update that you identify by using the update title, see [Searching, Downloading, and Installing Specific Updates](searching--downloading--and-installing-specific-updates.md).</span></span>

<span data-ttu-id="c7a65-109">Antes de tentar executar este exemplo, observe o seguinte:</span><span class="sxs-lookup"><span data-stu-id="c7a65-109">Before you attempt to run this sample, note the following:</span></span>

-   <span data-ttu-id="c7a65-110">O WUA deve estar instalado no computador.</span><span class="sxs-lookup"><span data-stu-id="c7a65-110">WUA must be installed on the computer.</span></span> <span data-ttu-id="c7a65-111">Para obter mais informações sobre como determinar a versão do WUA que está instalada, consulte [determinando a versão atual do WUA](determining-the-current-version-of-wua.md).</span><span class="sxs-lookup"><span data-stu-id="c7a65-111">For more information about how to determine the version of WUA that is installed, see [Determining the Current Version of WUA](determining-the-current-version-of-wua.md).</span></span>
-   <span data-ttu-id="c7a65-112">O exemplo pode baixar atualizações somente usando o WUA.</span><span class="sxs-lookup"><span data-stu-id="c7a65-112">The sample can download updates only by using WUA.</span></span> <span data-ttu-id="c7a65-113">Ele não pode baixar atualizações de um servidor SUS (Software Update Services) 1,0.</span><span class="sxs-lookup"><span data-stu-id="c7a65-113">It cannot download updates from a Software Update Services (SUS) 1.0 server.</span></span>
-   <span data-ttu-id="c7a65-114">A execução deste exemplo requer o WSH (Windows Script Host).</span><span class="sxs-lookup"><span data-stu-id="c7a65-114">Running this sample requires Windows Script Host (WSH).</span></span> <span data-ttu-id="c7a65-115">Para obter mais informações sobre o WSH, consulte a seção WSH do kit de desenvolvimento de software de plataforma (SDK).</span><span class="sxs-lookup"><span data-stu-id="c7a65-115">For more information about WSH, see the WSH section of the Platform Software Development Kit (SDK).</span></span> <span data-ttu-id="c7a65-116">Se o exemplo for copiado para um arquivo chamado WUA \_SearchDownloadInstall.vbs, você poderá executar o exemplo abrindo uma janela de prompt de comando e digitando o comando a seguir no prompt de comando.</span><span class="sxs-lookup"><span data-stu-id="c7a65-116">If the sample is copied to a file named WUA\_SearchDownloadInstall.vbs, you can run the sample by opening a Command Prompt window and typing the following command at the command prompt.</span></span>

    <span data-ttu-id="c7a65-117">**SearchDownloadInstall.vbsdo cscript WUA \_**</span><span class="sxs-lookup"><span data-stu-id="c7a65-117">**cscript WUA\_SearchDownloadInstall.vbs**</span></span>

## <a name="example"></a><span data-ttu-id="c7a65-118">Exemplo</span><span class="sxs-lookup"><span data-stu-id="c7a65-118">Example</span></span>

> [!IMPORTANT]
> <span data-ttu-id="c7a65-119">Esse script destina-se a demonstrar o uso das APIs do agente de Windows Update e fornece um exemplo de como os desenvolvedores podem usar essas APIs para resolver problemas.</span><span class="sxs-lookup"><span data-stu-id="c7a65-119">This script is intended to demonstrate the use of the Windows Update Agent APIs, and provide an example of how developers can use these APIs to solve problems.</span></span> <span data-ttu-id="c7a65-120">Esse script não se destina como código de produção e o próprio script não tem suporte da Microsoft (embora haja suporte para as APIs de agente de Windows Update subjacentes).</span><span class="sxs-lookup"><span data-stu-id="c7a65-120">This script is not intended as production code, and the script itself is not supported by Microsoft (though the underlying Windows Update Agent APIs are supported).</span></span>
