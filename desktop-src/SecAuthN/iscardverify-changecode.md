---
description: Substitui o código CHV atual (verificação do titular do cartão) pelo novo código CHV.
...
O **método ChangeCode** substitui o código CHV atual (verificação do titular do cartão) pelo novo código CHV.
...
Ponteiro para [**um IByteBuffer que**](ibytebuffer.md) contém o código atual do usuário.
...
Ponteiro para um [**IByteBuffer que**](ibytebuffer.md) contém o novo código que será apresentado ao [*cartão*](../secgloss/s-gly.md) inteligente durante o processo de alteração para autenticar o usuário.
