...
| Tópico                                                                         | Descrição                                                                                       |
|-------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| [Política de Grupo CredSSP Configurações](credssp-group-policy-settings.md)<br/> | A delegação de credenciais por CredSSP pode ser controlada usando configurações de política de grupo.<br/> |
