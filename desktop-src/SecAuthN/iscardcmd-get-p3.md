---
description: Recupera o terceiro byte de parâmetro (P3) da APDU (unidade de dados do protocolo de aplicativo).
...
ms.locfileid: "120014916"
---
# <a name="iscardcmdget_p3-method"></a>Método ISCardCmd::get \_ P3

\[O **método \_ get P3** está disponível para uso nos sistemas operacionais especificados na seção Requisitos. Ele não está disponível para uso no Windows Server 2003 com Service Pack 1 (SP1) e posterior, Windows Vista, Windows Server 2008 e versões subsequentes do sistema operacional. Os [Módulos de Cartão Inteligente](/previous-versions/windows/desktop/secsmart/smart-card-modules) fornecem funcionalidade semelhante.\]

O **método \_ get P3** recupera o terceiro parâmetro (P3) byte da APDU (unidade de dados [*do*](../secgloss/a-gly.md) protocolo de aplicativo). Esse valor de byte somente leitura representa o tamanho da parte de dados do APDU.
...
Ponteiro para o byte que é o P3 do APDU no retorno.
...
| <dl> <dt>**PONTEIRO \_ E**</dt> </dl>     | Um ponteiro ruim foi passado em *pbyP3.*<br/> |
...
O exemplo a seguir mostra como recuperar o terceiro byte de parâmetro (P3) da APDU (unidade de dados [*do*](../secgloss/a-gly.md) protocolo de aplicativo). O exemplo supõe que pISCardCmd é um ponteiro válido para uma instância da interface [**ISCardCmd.**](iscardcmd.md)
