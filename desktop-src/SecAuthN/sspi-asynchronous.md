...
O cabeçalho SSPI assíncrono inclui funções que dão suporte a objetos de contexto assíncrono, permitindo que os chamadores estabeleçam contextos de segurança entre o servidor e os clientes remotos simultaneamente por meio de um ciclo de vida de chamada SSPI Async.
