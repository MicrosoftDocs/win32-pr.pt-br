...
---
# <a name="tls-cipher-suites-in-windows-10-v1809"></a>Conjunto de Criptografia TLS Windows 10 v1809
...
Por Windows 10, versão 1809, os seguintes pacote de codificação estão habilitados e, por padrão, nessa ordem de prioridade usando o Provedor Schannel da Microsoft:
