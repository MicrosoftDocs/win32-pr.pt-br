---
description: saiba mais sobre os conjuntos de codificação TLS no Windows 10 v1809. Os conjuntos de codificação só podem ser negociados para versões de TLS que dão suporte a eles.
...
por Windows 10, versão 1809, os seguintes conjuntos de codificação estão habilitados e nesta ordem de prioridade por padrão usando o provedor Microsoft Schannel:
