...
Por Windows 10, versão 1809, os seguintes pacote de codificação estão habilitados e, por padrão, nessa ordem de prioridade usando o Provedor do Microsoft Schannel:
