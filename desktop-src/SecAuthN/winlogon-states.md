...
Quando o Winlogon está no estado conectado, os usuários são solicitados a se identificar e fornecer informações de autenticação. se um usuário fornecer informações de conta de usuário corretas e nenhuma restrição impedi-la, o usuário será conectado e um programa de shell (como Windows Explorer) será executado no aplicativo desktop. O Winlogon muda para o estado conectado.
