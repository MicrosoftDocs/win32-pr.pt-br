...
O depurador da Web do Fiddler pode ser usado com aplicativos do Windows 8.
...
1.  Por o AuthHost executar no seu próprio contêiner de aplicativo para dar maior capacidade de rede privada, você deve definir uma chave de registro: Windows Registry Editor Version 5.00
    ...
    **HKEY \_ \_** \\  \\ Opções de execução de arquivo de imagem **do Microsoft** \\ **Windows NT** CurrentVersion de máquina local \\  \\  \\ **authhost.exe** \\ **EnablePrivateNetwork** = 00000001<dl> <dt>
