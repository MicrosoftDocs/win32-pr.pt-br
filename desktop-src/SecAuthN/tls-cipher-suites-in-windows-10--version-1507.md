---
description: Saiba mais sobre os suites de criptografia TLS Windows 10 v1507. Os suites de criptografia só podem ser negociados para versões TLS que os suportam.
ms.assetid: 58A47273-D2D3-449D-891C-C9502012C557
title: Conjunto de Criptografia TLS Windows 10 v1507
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "117786232"
---
# <a name="tls-cipher-suites-in-windows-10-v1507"></a>Conjunto de Criptografia TLS Windows 10 v1507
...
-   Permitido quando o aplicativo passa SCH USE STRONG CRYPTO: o provedor \_ \_ do Microsoft Schannel filtrará os suites de criptografia fracos conhecidos quando o aplicativo usar o sinalizador \_ SCH \_ USE STRONG \_ \_ CRYPTO. No Windows 10, a versão 1507, os pacote de criptografia RC4 são filtrados.
...
Por Windows 10, versão 1507, os seguintes pacote de codificação estão habilitados e, por padrão, nessa ordem de prioridade usando o Provedor Schannel da Microsoft:
...
| TLS \_ RSA WITH NULL \_ \_ \_ MD5 usado somente quando o aplicativo solicita explicitamente.<br/> | Sim<br/>                      | TLS 1.2, TLS 1.1, TLS 1.0, SSL 3.0<br/> |
