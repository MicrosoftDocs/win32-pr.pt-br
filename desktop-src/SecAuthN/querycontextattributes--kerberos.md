---
description: Permite que um aplicativo de transporte [](../secgloss/s-gly.md) consulte o pacote de segurança Kerberos para determinados atributos de um [*contexto de segurança*](../secgloss/s-gly.md).
...
ms.locfileid: "118920161"
---
# <a name="querycontextattributes-kerberos-function"></a>Função QueryContextAttributes (Kerberos)

A **função QueryContextAttributes (Kerberos)** permite que um aplicativo de transporte [](../secgloss/a-gly.md#_security_attribute_gly) consulte o pacote de segurança Kerberos [](../secgloss/s-gly.md) para determinados atributos de um contexto de [*segurança*](../secgloss/s-gly.md).
