...
A função **QueryContextAttributes (Kerberos)** permite que um aplicativo de transporte consulte o [*pacote de segurança*](../secgloss/s-gly.md) Kerberos para determinados [*atributos*](../secgloss/a-gly.md#_security_attribute_gly) de um [*contexto de segurança*](../secgloss/s-gly.md).
