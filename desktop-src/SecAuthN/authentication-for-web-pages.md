...
2.  Além disso, um aplicativo da Windows Store "fabrikam social" será desempacotado na área de trabalho.

### <a name="2-getting-familiar"></a>2. familiarizando-se

Para ter uma ideia de como as páginas de exemplo se parecem no agente de autenticação da Web, abra o arquivo de solução Fabrikam social do Visual Studio 11 na pasta "fabrikam social" na área de trabalho.
