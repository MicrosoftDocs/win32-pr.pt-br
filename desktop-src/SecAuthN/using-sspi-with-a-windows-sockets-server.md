...
<span data-ttu-id="3e035-115">Este programa de exemplo usa tratamento de erro limitado.</span><span class="sxs-lookup"><span data-stu-id="3e035-115">This sample program uses limited error handling.</span></span>
