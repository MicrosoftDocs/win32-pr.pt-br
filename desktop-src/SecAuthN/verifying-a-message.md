...
O exemplo supõe que uma variável **SecHandle** chamada phContext e uma estrutura de **soquete** chamada s são inicializadas. Para as declarações e as iniciações dessas variáveis, consulte [usando o SSPI com um cliente do Windows Sockets](using-sspi-with-a-windows-sockets-client.md) e [usando o SSPI com um servidor do Windows Sockets](using-sspi-with-a-windows-sockets-server.md). Esse código inclui chamadas para funções em Secur32. lib, que devem ser incluídas entre as bibliotecas de links.
