---
description: Torna o arquivo especificado (EF ou DF) não válido. Um arquivo que não é válido não pode ser acessado por outros métodos antes de usar Reabilitar.
...
O **método Invalidate** torna o arquivo especificado (EF ou DF) inválido. Um arquivo que não é válido não pode ser acessado por outros métodos antes de usar [**Reabilitar**](iscardfileaccess-rehabilitate.md).
...
[**Reabilitar**](iscardfileaccess-rehabilitate.md)
</dt> </dl>
