---
description: O método \_ APP Auth autentica o aplicativo. Ele permite que um aplicativo se autenttice (usando um protocolo de desafio/assinatura) quando a autenticação é solicitada por um cartão inteligente.
...
ms.locfileid: "120015546"
---
# <a name="iscardauthapp_auth-method"></a>Método ISCardAuth::APP \_ Auth

\[O **método \_ APP Auth** está disponível para uso nos sistemas operacionais especificados na seção Requisitos. Ele não está disponível para uso no Windows Server 2003 com Service Pack 1 (SP1) e posterior, Windows Vista, Windows Server 2008 e versões subsequentes do sistema operacional. Os [Módulos de Cartão Inteligente](/previous-versions/windows/desktop/secsmart/smart-card-modules) fornecem funcionalidade semelhante.\]

O **método \_ APP Auth** autentica o aplicativo. Ele permite que um aplicativo se autenttice (usando um protocolo de desafio/assinatura) quando a autenticação é solicitada por um [*cartão inteligente*](../secgloss/s-gly.md).
...
Um [**IByteBuffer que**](ibytebuffer.md) contém parâmetros específicos do fornecedor do processo de autenticação.
