...
Para anexar uma [*chamada de cartão*](../secgloss/s-gly.md) inteligente [**AttachByHandle**](iscardmanage-attachbyhandle.md).

Para liberar uma chamada de anexo [**Desconectar**](iscardmanage-detach.md).

Para se reconectar com o cartão inteligente sem chamar [**Detach**](iscardmanage-detach.md) e **AttachByIFD,** chame [**Reconectar**](iscardmanage-reconnect.md).
