...
Uma interface implementada pelo cliente que permite aos desenvolvedores fornecer suas próprias credenciais dinamicamente em tempo de execução para autenticar contêineres não ingressados no domínio com Active Directory. 
...
| Método                                           | Descrição                                                                                               |
|:-------------------------------------------------|:----------------------------------------------------------------------------------------------------------|
| [**GetPasswordCredentials**](iccgdomainauthcredentials-getpasswordcredentials.md)               | Retorna credenciais para autenticar um contêiner não ingressado no domínio com Active Directory.<br/>                                                              |
...
| parâmetro<br/>                   | <dl> <dt>ccgplugins. h</dt> </dl>   |
