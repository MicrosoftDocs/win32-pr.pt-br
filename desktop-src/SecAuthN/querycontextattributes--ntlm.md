...
A função **QueryContextAttributes (NTLM)** permite que um aplicativo de transporte consulte o [*pacote de segurança*](../secgloss/s-gly.md) NTLM para determinados [*atributos*](../secgloss/a-gly.md#_security_attribute_gly) de um [contexto de segurança](../secgloss/s-gly.md).
