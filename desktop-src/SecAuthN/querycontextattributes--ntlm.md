---
description: Permite que um aplicativo de transporte [](../secgloss/s-gly.md) consulte o pacote de segurança NTLM para determinados atributos de um [contexto de segurança](../secgloss/s-gly.md).
...
ms.locfileid: "118920094"
---
# <a name="querycontextattributes-ntlm-function"></a>Função QueryContextAttributes (NTLM)

A **função QueryContextAttributes (NTLM)** permite que um aplicativo de transporte [](../secgloss/a-gly.md#_security_attribute_gly) consulte o pacote de segurança NTLM [](../secgloss/s-gly.md) para determinados atributos de um contexto de [segurança](../secgloss/s-gly.md).
...
| Valor                                                                                                                                                                                                                                                                                          | Significado                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="SECPKG_ATTR_ACCESS_TOKEN"></span><span id="secpkg_attr_access_token"></span><dl> <dt>**SECPKG \_ TOKEN DE \_ ACESSO ATTR \_**</dt> <dt>18</dt> </dl>                                       | O *parâmetro pBuffer* contém um ponteiro para uma [**estrutura \_ AccessToken SecPkgContext.**](/windows/win32/api/sspi/ns-sspi-secpkgcontext_accesstoken)<br/> Retorna um alça para o token de acesso.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| <span id="SECPKG_ATTR_CLIENT_SPECIFIED_TARGET"></span><span id="secpkg_attr_client_specified_target"></span><dl> <dt>**SECPKG \_ CLIENTE ATTR \_ \_ DESTINO ESPECIFICADO \_**</dt> <dt>27</dt> </dl>     | O *parâmetro pBuffer* contém um ponteiro para uma estrutura [**\_ ClientSpecifiedTarget SecPkgContext**](/windows/win32/api/sspi/ns-sspi-secpkgcontext_clientspecifiedtarget) que representa o SPN (nome da entidade de serviço) do destino inicial fornecido pelo cliente. <br/> Esse valor só tem suporte ao usar vinculações de canal.<br/> **Windows Server 2008, Windows Vista, Windows Server 2003 e Windows XP:** Não há suporte para esse valor.<br/>                                                                                                                                                                                                                                                                                                                                                                    |
| <span id="SECPKG_ATTR_CREDS_2"></span><span id="secpkg_attr_creds_2"></span><dl> <dt>**SECPKG \_ ATTR \_ CREDS \_ 2**</dt> <dt>0x80000086</dt> </dl>                                              | O *parâmetro pBuffer* contém um ponteiro para uma estrutura [**\_ ClientCreds SecPkgContext**](/windows/win32/api/credssp/ns-credssp-secpkgcontext_clientcreds) que especifica as credenciais do cliente. <br/> Se a credencial do cliente for nome de usuário e senha, o buffer será uma estrutura [**DE \_ \_ LOGON INTERATIVA KERB**](/windows/win32/api/ntsecapi/ns-ntsecapi-kerb_interactive_logon) empacotada.<br/> Se a credencial do cliente for nome de usuário e PIN de cartão inteligente, o buffer será uma estrutura de [**\_ \_ LOGON**](/windows/win32/api/ntsecapi/ns-ntsecapi-kerb_certificate_logon) de CERTIFICADO KERB empacotada.<br/> Se a credencial do cliente for uma credencial de identidade online, o buffer será uma estrutura [**SEC \_ WINNT \_ AUTH \_ IDENTITY \_ EX2**](/windows/win32/api/sspi/ns-sspi-sec_winnt_auth_identity_ex2) com marshaled.<br/> Esse atributo só tem suporte no servidor CredSSP.<br/> **Windows Server 2008 R2, Windows 7, Windows Server 2008, Windows Vista, Windows Server 2003 e Windows XP:** Não há suporte para esse valor.<br/> |
...
| <span id="SECPKG_ATTR_LAST_CLIENT_TOKEN_STATUS"></span><span id="secpkg_attr_last_client_token_status"></span><dl> <dt>**SECPKG \_ STATUS DO \_ \_ ÚLTIMO TOKEN DO \_ \_ CLIENTE ATTR**</dt> <dt>30</dt> </dl> | O parâmetro *pBuffer* contém um ponteiro para uma estrutura [**\_ LastClientTokenStatus SecPkgContext**](/windows/win32/api/sspi/ns-sspi-secpkgcontext_lastclienttokenstatus) que especifica se o token da chamada mais recente para a função [**InitializeSecurityContext**](initializesecuritycontext--general.md) é o último token do cliente.<br/> **Windows Server 2008, Windows Vista, Windows Server 2003 e Windows XP:** Não há suporte para esse valor.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| <span id="SECPKG_ATTR_ROOT_STORE"></span><span id="secpkg_attr_root_store"></span><dl> <dt>**SECPKG \_ ATTR \_ ROOT \_ STORE**</dt> <dt>0x55</dt> </dl>                                           | O *parâmetro pBuffer* contém um ponteiro para **um HCERTCONTEXT.** <br/> Localiza um contexto de certificado que contém um certificado fornecido pelo armazenamento raiz.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
