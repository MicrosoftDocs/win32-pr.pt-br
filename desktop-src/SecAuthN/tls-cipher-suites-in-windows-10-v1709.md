...
---
# <a name="tls-cipher-suites-in-windows-10-v1709"></a>Conjuntos de codificação TLS no Windows 10 v1709
...
Para o Windows 10, versão 1709, os seguintes conjuntos de codificação estão habilitados e nesta ordem de prioridade por padrão usando o provedor Microsoft Schannel:
