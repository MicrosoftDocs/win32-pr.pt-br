---
description: saiba mais sobre os conjuntos de codificação TLS no Windows 10 v1709. Os conjuntos de codificação só podem ser negociados para versões de TLS que dão suporte a eles.
...
para Windows 10, versão 1709, os seguintes conjuntos de codificação estão habilitados e nesta ordem de prioridade por padrão usando o provedor Microsoft Schannel:
